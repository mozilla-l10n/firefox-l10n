...
family = Kómɨnɨrede
addresses = íyano
messages-sent = Óreka úai
messages-received = Já yɨnoga úia
bytes-sent = Óreka Bytes
bytes-received = Já yɨnoga Bytes
dns-lookup = Jénoka DNS
