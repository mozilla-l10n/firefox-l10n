...
settings-update-other-instance-handling-updates =
    .label = دویمِہ مثألِہ ذریعہ چُھ  اپڈیٹ کرنْہ یوان { -brand-short-name }
...
settings-update-unsupported = توہیہ ہیکیو نْہ یتھ سسٹمس پیٹھ مزید اپڈیٹ کْرتھ۔<a data-l10n-name="unsupported-link">مزید ہیچھیو</a>
