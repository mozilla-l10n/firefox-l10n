...
crashed-send-report-2 = Hantar laporan ranap automatik supaya kami dapat membaiki isu seperti ini
crashed-comment =
    .placeholder = Komen pilihan (komen disiarkan kepada umum)
crashed-include-URL-2 = Sertakan URL tapak yang anda lawati apabila { -brand-short-name } ranap
...
crashed-auto-submit-checkbox-2 = Kemas kini keutamaan untuk menghantar laporan secara automatik apabila { -brand-short-name } ranap
