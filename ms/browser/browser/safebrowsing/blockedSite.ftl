...
safeb-blocked-malware-page-error-desc-override = <span data-l10n-name='sitename'>{ $sitename }</span> telah dilaporkan <a data-l10n-name='error_desc_link'>mengandungi perisian hasad</a>. Anda boleh <a data-l10n-name='report_detection'>laporkan masalah yang dikesan ini</a> atau <a data-l10n-name='ignore_warning_link'>abaikan risiko</a> dan terus melayari laman yang tidak selamat ini.
safeb-blocked-malware-page-error-desc-no-override = <span data-l10n-name='sitename'>{ $sitename }</span> telah dilaporkan <a data-l10n-name='error_desc_link'>mengandungi perisian hasad</a>. Anda boleh <a data-l10n-name='report_detection'>laporkan masalah yang dikesan ini</a>.
safeb-blocked-malware-page-learn-more = Ketahui lebih lanjut perihal kandungan web berbahaya termasuk virus dan perisian hasad lain, dan cara melindungi komputer anda di <a data-l10n-name='learn_more_link'>StopBadware.org</a>. Ketahui lebih lanjut perihal Perlindungan Phishing dan Perisian Hasad { -brand-short-name } di <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
