...
main-context-menu-image-view-new-tab =
    .label = Buka Imej dalam Tab Baru
    .accesskey = I
main-context-menu-video-view-new-tab =
    .label = Buka Video dalam Tab Baru
    .accesskey = V
main-context-menu-image-copy =
    .label = Salin Imej
    .accesskey = n
main-context-menu-image-copy-link =
    .label = Salin Pautan Imej
    .accesskey = I
main-context-menu-video-copy-link =
    .label = Salin Pautan Video
    .accesskey = V
main-context-menu-audio-copy-link =
    .label = Salin Pautan Audio
    .accesskey = A
...
main-context-menu-image-set-image-as-background =
    .label = Tetapkan Imej sebagai Latar Belakang Desktop...
    .accesskey = B
...
main-context-menu-send-to-mobile-enable-sync3 = Hidupkan Sync untuk menghantar tab
main-context-menu-send-to-mobile-enable-sync-from-link = Hidupkan Sync untuk menghantar pautan
main-context-menu-send-to-mobile-enable-sync-from-page = Hidupkan Sync untuk menghantar halaman
...
main-context-menu-link-send-to-mobile =
    .label = Hantar Pautan ke Mudah Alih
    .accesskey = H
...
main-context-menu-open-link-in-container-tab =
    .label = Buka Pautan dalam Tab { $containerName } Baharu
    .accesskey = B
