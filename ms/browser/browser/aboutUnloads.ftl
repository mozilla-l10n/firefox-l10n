...
about-unloads-column-sortweight = Berat Sekunder
    .title = Jika tersedia, tab diisihkan mengikut nilai ini selepas diisihkan mengikut berat asas. Nilai diperoleh daripada penggunaan memori tab dan bilangan proses.
about-unloads-column-memory = Memori
    .title = Anggaran penggunaan memori tab
about-unloads-column-processes = ID Proses
    .title = ID proses yang mengehoskan kandungan tab
