...
refresh-profile-dialog-description = برای رفع مشکلات عملکردی، تازه‌سازی را شروع کنید. این کار افزونه‌ها و سفارشی‌سازی‌های شما را حذف می‌کند. شما اطلاعات ضروری مانند نشانک‌ها و گذرواژه‌ها را از دست نخواهید داد.
