...
permission-dialog-description-extension = آیا اجازه می‌دهید که افزونه { $extension } پیوند { $scheme } را باز کند؟
...
permission-dialog-description-extension-app = آیا اجازه می‌دهید که افزونه { $extension } پیوند { $scheme } را با { $appName } باز کند؟
permission-dialog-description-system-app = آیا می‌خواهید پیوند { $scheme } را با { $appName } باز کنید؟
permission-dialog-description-system-noapp = آیا می‌خواهید پیوند { $scheme } را باز کنید؟
...
permission-dialog-remember-extension = همیشه به این افزونه اجازه دهید تا پیوندهای <strong>{ $scheme }</strong> را باز کند.
