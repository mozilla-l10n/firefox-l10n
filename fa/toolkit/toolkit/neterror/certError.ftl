...
cert-error-inadequate-cert-type = { -brand-short-name } بازدید شما از این سایت را مسدود کرد زیرا گواهی ارائه شده برای { $hostname } اجازه استفاده توسط یک وب سرور را ندارد.
