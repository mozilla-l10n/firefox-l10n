...
fp-neterror-denied-port-access = این نشانی از درگاهِ شبکه‌ای استفاده می‌کند که به طور معمول برای اهداف دیگری غیر از مرور وب استفاده می‌شود. { -brand-short-name } به منظور حفظ امنیت شما درخواست را رد کرد.
