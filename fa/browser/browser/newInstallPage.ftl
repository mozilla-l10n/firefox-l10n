...
new-install-sync-first = اولین بار است که از همگام‌سازی استفاده می‌کنید؟ برای همگام‌سازی اطلاعات خود با سایر دستگاه‌ها، باید وارد حساب خود در آن دستگاه‌ها بشوید.
