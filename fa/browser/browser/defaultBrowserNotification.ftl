...
default-browser-guidance-notification-title = تبدیل { -brand-short-name } را به عنوان پیش فرض خود به پایان برسانید
# Quoted text are keywords to look for in the Windows Settings app.
default-browser-guidance-notification-body-instruction-win10 =
    مرحله ۱: به تنظیمات بروید > برنامه‌های پیش‌فرض
    مرحله ۲: به پایین پیمایش کنید تا به «مرورگر وب» برسید
    مرحله ۳: و { -brand-short-name } را  انتخاب کنید
# Quoted text are keywords to look for in the Windows Settings app.
