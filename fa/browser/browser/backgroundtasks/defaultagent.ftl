...
default-browser-notification-header-text = آیا می‌خواهید { -brand-short-name } را ادامه دهید؟
default-browser-notification-body-text = مرورگر پیش‌فرض شما به تازگی تغییر کرده است. برای بازگرداندن { -brand-short-name } به پیش‌فرض، ضربه بزنید.
default-browser-notification-yes-button-text = بله
default-browser-notification-no-button-text = خیر
