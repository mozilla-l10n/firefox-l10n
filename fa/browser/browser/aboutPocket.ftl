...
pocket-panel-signup-signup-email = نام‌نویسی با رایانامه
pocket-panel-signup-signup-cta = در { -pocket-brand-name } نام‌نویسی کنید. رایگان است.
pocket-panel-signup-signup-firefox = نام‌نویسی نام با { -brand-product-name }
...
pocket-panel-signup-cta-b-updated = برای ذخیره مقاله‌ها، ویدیوها و پیوندها، روی دکمه { -pocket-brand-name } کلیک کنید. ذخیره‌های خود را در هر دستگاه و در هر زمانی مشاهده کنید.
