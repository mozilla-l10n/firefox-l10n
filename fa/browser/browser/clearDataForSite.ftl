...
clear-data-for-site-title = تمام داده‌های این وبگاه پاک شود؟
# Variables:
...
clear-data-for-site-dialog-accept-button = پاک‌کردن داده‌ها
clear-data-for-site-dialog-cancel-button = لغو
