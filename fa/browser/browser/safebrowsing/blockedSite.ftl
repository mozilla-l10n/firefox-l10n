...
safeb-blocked-malware-page-error-desc-override = <span data-l10n-name='sitename'>{ $sitename }</span> به عنوان <a data-l10n-name='error_desc_link'>یک سایت با نرم‌افزارهای مخرب گزارش شده است</a>. شما می‌توانید <a data-l10n-name='report_detection'>یک گزارشِ تشخیصِ اشتباه ارسال کنید</a> یا <a data-l10n-name='ignore_warning_link'>این خطر را نادیده بگیرید</a> و به این صفحه ناامن بروید.
safeb-blocked-malware-page-error-desc-no-override = <span data-l10n-name='sitename'>{ $sitename }</span> به عنوان <a data-l10n-name='error_desc_link'>سایت با نرم‌افزارهای مخرب گزارش شده است</a>. شما می‌توانید<a data-l10n-name='report_detection'> یک گزارشِ تشخیصِ اشتباه ارسال کنید</a>.
safeb-blocked-malware-page-learn-more = در مورد محتوای مضر در وب شامل ویروس‌ها و جاسوس‌افزارها و نحوهٔ محافظت از رایانه خود در <a data-l10n-name='learn_more_link'>StopBadware.org</a> اطلاعات بیشتری کسب کنید. در مورد نحوه حفاظت { -brand-short-name } از فیشینگ و جاسوس‌افزارها در <a data-l10n-name='firefox_support'>support.mozilla.org</a> بیشتر اطلاعات کسب کنید.
