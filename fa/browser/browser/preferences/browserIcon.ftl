...
appearance-browser-icon-requirement =
    .message = برای شخصی‌سازی { -brand-short-name }، مراحل را تکمیل و آیکون‌های روباه هدیه را باز کنید.
...
appearance-browser-icon-momo =
    .description = اثر @heyheymomodraws
    .label = Momo
