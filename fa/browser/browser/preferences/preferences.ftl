...
preferences-ai-controls-pdfjs-control =
    .description = وقتی تصاویر را به فایل‌های PDF اضافه می‌کنید، توضیحاتی به آن‌ها اضافه می‌شود تا دسترسی به آن‌ها آسان‌تر شود.
    .label = متن جایگزین تصویر در نمایشگر PDF { -brand-short-name }
...
preferences-ai-controls-block-confirmation-pdfjs = متن جایگزین تصویر در نمایشگر PDF در { -brand-short-name }
