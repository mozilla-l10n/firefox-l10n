...
default-browser-notification-privacy-header-text = Fortsæt med { -brand-short-name }?
default-browser-notification-privacy-body-text = Din standardindstilling er blevet ændret. Kom tilbage til { -brand-short-name } for at få indbygget beskyttelse af dit privatliv.
