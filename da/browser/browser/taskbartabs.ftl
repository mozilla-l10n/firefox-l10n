...
taskbar-tab-urlbar-button-show = Vis sidehandling for web-apps
taskbar-tab-urlbar-button-hide = Skjul sidehandling for web-apps
...
# should be fine.)
taskbar-tab-shortcut-folder = Web-apps fra { -brand-short-name }
