...
genai-settings-chat-lechat-links-2 = Ved at vælge Mistral Vibe accepterer du Mistral AIs <a data-l10n-name="link1">tjenestevilkår</a> og <a data-l10n-name="link2">privatlivspolitik</a>.
...
genai-shortcut-button-2 =
    ...
    .tooltiptext = Spørg { $provider }
# $engine (string) - name of the search engine
# $selection (string) - the selected text, truncated
genai-shortcut-search-button =
    .aria-label = Søg med { $engine } efter "{ $selection }"
    .tooltiptext = Søg med { $engine } efter "{ $selection }"
genai-shortcut-copy-button =
    .aria-label = Kopier markeret tekst
    .tooltiptext = Kopier markeret tekst
