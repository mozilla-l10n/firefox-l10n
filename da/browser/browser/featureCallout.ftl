...
fx-view-discoverability-title = Lukkede du fanebladet ved en fejl?
fx-view-discoverability-subtitle = Find og åben det hurtigt igen. Vi gemmer en oversigt over dine senest lukkede faneblade.
fx-view-discoverability-primary-button-label = Åbn { -firefoxview-brand-name }
fx-view-discoverability-secondary-button-label = Afvis

## Split Dismiss Button Labels

# Blocks the message from showing again
split-dismiss-button-dont-show-option =
    .label = Vis ikke denne anbefaling igen
# Dismisses message and reduces frequency of message
split-dismiss-button-show-fewer-option =
    .label = Vis færre anbefalinger
# Opens about:preferences#general-cfrfeatures
split-dismiss-button-manage-settings-option =
    .label = Håndter indstillinger
...
fxa-adoption-passwords-title = Adgangskode gemt. Lad os lave en sikkerhedskopi af den.
fxa-adoption-passwords-subtitle = Beskyt dine adgangskoder ved at kryptere og synkronisere dem med dine andre enheder.
# Opens Mozilla accounts sign-up page
fxa-adoption-passwords-primary-button-label = Tilmeld dig
...
vertical-tabs-callout-1-subtitle = Prøv de nye lodrette faneblade for at få et bedre overblik. Folk som har testet funktionen siger, at den har gjort det nemmere for dem at holde styr på deres faneblade.  Skift når som helst.
...
pin-tabs-callout-3-title = Hav vigtige websteder inden for rækkevidde
pin-tabs-callout-4-title = Fastgør de faneblade, du bruger mest

## Sidebar Onboarding Strings

sidebar-customization-callout-1-title = Sidepanel: Dit overblik over funktioner og faneblade
...
sidebar-customization-callout-2-subtitle = Tilføj og fjern funktioner. Placer dine faneblade i sidepanelet. Prøv en AI-chatbot. Det er helt op til dig, hvad der skal være i sidepanelet.
...
sidebar-callout-survey-dissatisfied-2 = Utilfreds
sidebar-callout-survey-very-dissatisfied-2 = Meget utilfreds
...
sidebar-callout-survey-saved-websites-2 = Hurtig adgang til dine bogmærker
...
splitview-onboarding-callout-title-1 = Opdelt visning: En bedre måde at multitaske
