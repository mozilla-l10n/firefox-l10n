...
crashed-send-report = Indsend en automatisk fejlrapport, så vi kan løse problemer som dette.
...
crashed-include-URL = Inkluder adresserne til de sider, du var inde på, da { -brand-short-name } gik ned.
crashed-email-placeholder = Indtast din mailadresse her
crashed-email-me = Send mig en mail, når der er mere information om problemet
...
crashed-auto-submit-checkbox = Opdater dine indstillinger til automatisk at indsende fejlrapporter, når { -brand-short-name } går ned.
