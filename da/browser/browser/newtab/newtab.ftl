...
newtab-stocks-list-markets = Markeder
    .label = Markeder
...
newtab-stocks-list-watchlist = Overvågningsliste
    .label = Overvågningsliste
# Context menu item that opens the stock search (by company name or ticker symbol).
newtab-stocks-menu-search-stocks = Søg efter navn eller symbol
...
newtab-stocks-add-to-watchlist =
    .aria-label = Føj { $name } til overvågningsliste
    .title = Føj { $name } til overvågningsliste
# Tooltip and screen-reader label for the button that removes a stock from the watchlist.
# The button shows only an icon and never renders visible text.
# Variables:
#   $name (String) - the fund/ETF name.
newtab-stocks-remove-from-watchlist =
    .aria-label = Fjern { $name } fra overvågningsliste
    .title = Fjern { $name } fra overvågningsliste
...
# Variables:
#   $name (String) - the fund/ETF name.
newtab-stocks-in-watchlist = { $name } er på din overvågningsliste
# Announced to screen readers after a stock is added to the watchlist.
# Variables:
#   $name (String) - the fund/ETF name.
newtab-stocks-added-to-watchlist = Føjet { $name } til overvågningsliste
...
newtab-stocks-search-input =
    ...
    .placeholder = Søg efter navn eller symbol
...
newtab-stocks-search-no-results = Ingen resultater for "{ $query }"
# Shown while a ticker search is running; also announced to screen readers.
newtab-stocks-search-loading = Indlæser…
# Shown when a ticker search fails to reach the service.
newtab-stocks-search-error = Kunne ikke søge lige nu. Prøv igen senere.
...
newtab-spaces-tab-stories = Historier
...
newtab-carousel-pause =
    .aria-label = Sæt automatisk afspilning på pause
# Button that resumes autoplay on the carousel.
newtab-carousel-play =
    .aria-label = Genoptag automatisk afspilning
...
newtab-clock-city-ru-saint-petersburg = Sankt Petersborg
...
newtab-clock-city-dk-copenhagen = København
