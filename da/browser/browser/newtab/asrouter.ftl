...
launch-on-login-autostart-infobar-message = { -brand-short-name } starter nu, når du logger ind på Windows. Du kan altid ændre dette senere i indstillingerne.
launch-on-login-autostart-infobar-keep-button = Fortsæt
    .accesskey = F
launch-on-login-autostart-infobar-turn-off-button = Slå fra
    .accesskey = S
