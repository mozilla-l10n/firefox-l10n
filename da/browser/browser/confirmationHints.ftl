...
confirmation-hint-passport-created = Pas gemt
confirmation-hint-passport-updated = Pas opdateret
...
confirmation-hint-extensions-button-hidden = Flyttet til menu
