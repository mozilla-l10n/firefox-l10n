...
preonboarding-checklist-interaction-data-label = Send tekniske data og data om brug til { -vendor-short-name }
preonboarding-checklist-interaction-data-description = Data om din enhed, hardwarekonfiguration og hvordan du bruger { -brand-product-name } hjælper med at forbedre funktioner, ydeevne og stabilitet for brugere overalt.
preonboarding-checklist-crash-reports-label = Send automatisk fejlrapporter
