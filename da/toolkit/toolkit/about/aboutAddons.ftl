...
details-notification-softblocked-extension-disabled =
    .message = Denne udvidelse overtræder Mozillas politikker og er blevet deaktiveret. Du kan aktivere den, men det kan være risikabelt.
details-notification-softblocked-extension-enabled =
    .message = Denne udvidelse overtræder Mozillas politikker. Det kan være risikabelt at anvende den.
details-notification-softblocked-other-disabled =
    .message = Denne tilføjelse overtræder Mozillas politikker og er blevet deaktiveret. Du kan aktivere den, men det kan være risikabelt.
