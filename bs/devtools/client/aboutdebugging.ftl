...
about-debugging-browser-version-too-old-fennec = Ova verzija Firefoxa ne može otklanjati greške u Firefoxu za Android (68). Preporučujemo da instalirate Firefox za Android Nightly na svoj telefon radi testiranja. <a>Više detalja</a>
...
about-debugging-browser-version-too-recent = Povezani preglednik je noviji ({ $runtimeVersion }, buildID { $runtimeID }) od vašeg { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Ovo je nepodržana postavka i može uzrokovati neuspjeh DevToolsa. Molimo vas da ažurirate Firefox. <a>Rješavanje problema</a>
