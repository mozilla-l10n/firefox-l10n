...
more-from-moz-title2 = Više od { -vendor-short-name }a
    .title = Više od { -vendor-short-name }a
...
more-from-moz-solo-description = Kreirajte svoju web stranicu odmah i povežite vlastitu prilagođenu domenu besplatno.
more-from-moz-solo-button = Isprobajte { -solo-ai-brand-name }

## These strings are for the MDN card in about:preferences moreFromMozilla page

more-from-moz-mdn-description = Naučite web razvoj uz besplatne, sveobuhvatne vodiče i reference.
more-from-moz-mdn-button = Naučite web razvoj
