...
content-blocking-and-isolating-etp-warning-description-3 = Ova postavka može uzrokovati da neke web stranice ne prikazuju sadržaj ili ne funkcionišu ispravno. Pružamo opcionalne izuzetke za web stranice za koje znamo da mogu biti pogođene vašom konfiguracijom. Da biste smanjili mogućnost neispravnih web stranica, omogućite ove izuzetke za praćenje. Ako se čini da stranica ne radi, možete isključiti zaštitu od praćenja za tu stranicu kako biste učitali sav sadržaj i prijavili problem kako bismo mogli pomoći u rješavanju problema za sve.
...
content-blocking-baseline-exceptions =
    .label = Dozvoli { -brand-short-name }u da automatski primjenjuje izuzetke potrebne za izbjegavanje većih kvarova na web stranici.
content-blocking-convenience-exceptions =
    .label = Također automatski primijenite izuzetke koji su potrebni samo za rješavanje manjih problema i omogućavanje praktičnih funkcija.
