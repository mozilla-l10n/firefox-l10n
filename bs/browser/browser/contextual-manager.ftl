...
contextual-manager-passwords-origin-field-description = Unesite tačnu adresu putem koje ćete se prijaviti na ovu stranicu.
contextual-manager-passwords-username-field =
    .label = Korisničko ime
contextual-manager-passwords-username-field-description = Unesite korisničko ime, email adresu ili broj računa koji koristite za prijavu.
contextual-manager-passwords-password-field =
    .label = Lozinka
contextual-manager-passwords-password-field-description = Unesite lozinku za prijavu na ovaj račun.
