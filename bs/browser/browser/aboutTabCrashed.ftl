...
crashed-send-report = Šaljite automatski izvještaj o rušenju kako bismo mogli ispraviti probleme poput ovog.
...
crashed-include-URL = Uključite URL-ove stranica koje ste posjećivali kada se { -brand-short-name } srušio.
crashed-email-placeholder = Unesite vašu email adresu ovdje
crashed-email-me = Pošalji mi email kada više informacija bude dostupno
...
crashed-auto-submit-checkbox = Ažurirajte postavke da automatski šalju izvještaje kada se { -brand-short-name } sruši.
