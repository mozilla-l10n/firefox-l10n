...
mozilla-pkix-error-additional-policy-constraint-failed = Dodatno ograničenje pravila nije uspjelo prilikom validacije ovog certifikata.
mozilla-pkix-error-self-signed-cert = Certifikat nije od povjerenja jer je samopotpisan.
mozilla-pkix-error-issuer-no-longer-trusted = Tijelo za izdavanje certifikata koje je izdalo certifikat bilo je nepovjerljivo prije nego što je certifikat izdat.
