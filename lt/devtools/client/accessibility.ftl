...
accessibility-text-label-issue-fieldset-legend = Naudokite <code>legend</code> elementą, norėdami sužymėti <span>fieldset</span> elementus. <a>Sužinoti daugiau</a>
