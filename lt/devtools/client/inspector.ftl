...
colorpicker-tooltip-spectrum-dragger-title = Spektras
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = Pasirinkite spalvą tinklalapyje
...
colorpicker-tooltip-color-name-title = Panašiausia į: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Atspalvis
# A title text for the alpha slider in the color picker tooltip.
colorpicker-tooltip-alpha-slider-title = Nepermatomumas
