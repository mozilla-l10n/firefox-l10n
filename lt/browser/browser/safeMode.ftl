...
troubleshoot-mode-window =
    .title = Atverti „{ -brand-short-name }“ trikčių šalinimo režimu?
    .style = max-width: 400px
...
troubleshoot-mode-description = Jei kyla problemų, panaudokite šį specialų „{ -brand-short-name }“ režimą. Įdiegti priedai ir tinkinimai bus laikinai išjungti.
