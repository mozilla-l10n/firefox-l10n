...
primary-password-description = Pagrindinis slaptažodis apsaugo kai kurią slaptą informaciją šiame įrenginyje, pvz., prisijungimus ir slaptažodžius. Jeigu sukursite pagrindinį slaptažodį, tai jį pakaks surinkti vieną kartą visam „{ -brand-short-name }“ seansui ir turėsite prieigą prie jo saugomos informacijos.
remove-info =
