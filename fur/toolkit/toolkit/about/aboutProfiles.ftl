...
profiles-restart-title = Torne a començâ
profiles-restart-in-safe-mode = Torne a començâ cun lis zontis disabilitadis…
profiles-restart-normal = Torne a començâ normalmentri…
# Variables:
