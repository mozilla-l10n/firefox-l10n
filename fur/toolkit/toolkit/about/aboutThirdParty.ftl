...
third-party-detail-occurrences = Câs
    .title = Tropis voltis che chest modul al è stât cjariât.
third-party-detail-duration = Medie timp di bloc (ms)
...
third-party-tag-shellex = Estension shell
    .title = Chest gjenar di modul al ven cjariât cuant che tu vierzis il dialic dai file di sisteme.
third-party-tag-background = Sotfont
    .title =
...
third-party-loading-data =
    ...
    .title = Cjariament informazions dal sisteme…
third-party-button-reload = Torne cjame cun informazions di sisteme
