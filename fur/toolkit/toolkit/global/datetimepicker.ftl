...
datetime-picker-label =
    .aria-label = Sielç une date e une ore
...
time-spinner-hour-previous =
    .aria-label = Ore prime
time-spinner-hour-next =
    .aria-label = Ore sucessive
time-spinner-minute-previous =
    .aria-label = Minût prime
