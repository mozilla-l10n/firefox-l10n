...
text-action-strip-on-share =
    .label = Copie cence spiis
    .accesskey = n
text-action-paste =
    .label = Tache
    .accesskey = h
text-action-paste-no-formatting =
    .label = Tache cence formatazion
    .accesskey = m
...
text-action-spell-no-suggestions =
    .label = Nissun sugjeriment ortografic
text-action-spell-add-to-dictionary =
    .label = Zonte al dizionari
    .accesskey = o
text-action-spell-undo-add-to-dictionary =
    .label = Anule “Zonte al dizionari”
    .accesskey = n
text-action-spell-check-toggle =
    .label = Control ortografic
    .accesskey = g
text-action-spell-add-dictionaries =
    .label = Zonte dizionaris…
    .accesskey = a
...
text-action-copy-link-to-highlight =
    .label = Copie colegament al test evidenziât
...
text-action-copy-clean-link-to-highlight =
    .label = Copie colegament net al test evidenziât
# If the page has been loaded with a text fragment and text is
# visibly highlighted, this removes any highlighted sections on the page.
text-action-remove-highlight =
    .label = Gjave evidenziazion
# If the page has been loaded with a text fragment and text is
# visibly highlighted, this removes any highlighted sections on the page.
text-action-remove-all-highlights =
    .label = Gjave dutis lis evidenziazions
