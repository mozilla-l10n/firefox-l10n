...
create-profile-first-page-header =
    { PLATFORM() ->
        [macos] Introduzion
       *[other] Benvignût a { create-profile-window.title }
    }
...
profile-creation-explanation-4 =
    { PLATFORM() ->
        [macos] Par tacâ a creâ il to profîl, cjalcje su Va indevant.
       *[other] Par scomençâ a creâ un profîl, cjalcje su Indevant.
    }
