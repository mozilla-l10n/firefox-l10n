...
options-select-additional-tools-label = Struments pai svilupadôrs instalâts dai components adizionâi
...
options-screenshot-clipboard-only-label = Videadis caturadis dome intes notis
...
options-enable-chrome-label = Ative lis casselis dai imprescj pal debug dal navigadôr chrome e dai components adizionâi
options-enable-chrome-tooltip =
    .title = Ativâ cheste opzion ti permetarà di doprâ varis struments di svilup in mût diret dal navigadôr (vie Struments > Svilupadôr Web > Cassele dai imprescj dal navigadôr) e fâ il debug dai components adizionâi dal Gjestôr dai components adizionâi
...
options-enable-custom-formatters-tooltip =
    .title = Ativant cheste opzion si permetarà ai sîts di definî formatadôrs personalizâts pai ogjets DOM
