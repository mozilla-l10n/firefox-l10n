...
main-context-menu-image-view =
    .label = Viôt la figure
    .accesskey = g
main-context-menu-video-view =
    .label = Visualize video
    .accesskey = i
main-context-menu-image-copy =
    .label = Copie la figure
    .accesskey = o
main-context-menu-image-copy-location =
    .label = Copie la direzion de figure
    .accesskey = C
...
main-context-menu-image-save-as =
    .label = Salve la figure cul non…
    .accesskey = v
main-context-menu-image-email =
    .label = Mande figure par pueste...
    .accesskey = g
main-context-menu-image-set-as-background =
    .label = Impueste come daûr dal scritori…
    .accesskey = d
main-context-menu-image-info =
    .label = Viôt informazions imagjine
    .accesskey = f
main-context-menu-image-desc =
    .label = Viôt descrizion
    .accesskey = d
main-context-menu-video-save-as =
    .label = Salve video cul non…
    .accesskey = v
main-context-menu-audio-save-as =
    .label = Salve audio cul non…
    .accesskey = v
main-context-menu-video-image-save-as =
    .label = Salve istantanie...
    .accesskey = S
