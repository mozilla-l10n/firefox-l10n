...
webrtc-microphone-button =
    .title = Tu stâs condividint il to microfon. Fâs clic par controlâ la condivision.
webrtc-camera-button =
    .title = Tu stâs condividint la to fotocjamare. Fâs clic par controlâ la condivision.
