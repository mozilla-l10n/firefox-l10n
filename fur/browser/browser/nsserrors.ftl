...
sec-error-crl-expired = La CRL pal emitent dal certificât e je scjadude. Inzornile o controle la date e la ore dal to sisteme.
sec-error-crl-bad-signature = La CRL pal emitent dal certificât e à une firme no valide.
