...
ssl-error-socket-write-failure = Nol è stât pussibil scrivi i dâts cifrâts in chest socket.
...
sec-error-token-not-logged-in = Nol è stât pussibil eseguî la operazion par vie che il gjeton PKCS#11 nol è cjamât.
...
sec-error-failed-to-encode-data = Nol è stât pussibil codificâ i dâts cul codificadôr ASN1
