...
callout-primary-advance-button-label = Sucessîf
# Callout dialog primary button to complete the feature tour
callout-primary-complete-button-label = Capît!

## Firefox View feature tour strings

# "Tab pickup" refers to the section in Firefox View that displays open
# tabs from other devices
callout-firefox-view-tab-pickup-title = Passe di un dispositîf a chel altri cun Ripie schede
...
fx-view-discoverability-title = No intindevistu sierâ chê schede?
fx-view-discoverability-subtitle = Achì tu puedis cjatâle e tornâ a vierzile in tic e tac. O tignìn par to cont une cronologjie des schedis sieradis di resint.
fx-view-discoverability-primary-button-label = Vierç { -firefoxview-brand-name }
fx-view-discoverability-secondary-button-label = Siere
...
tab-groups-2026-onboarding-callout-title = Ridûs il disordin cui grups di schedis
...
tab-groups-2026-onboarding-callout-subtitle = Met adun lis tôs schedis par ativitât o par argoment. Tu puedis zontânt altris strissinantlis intant che tu navighis.
...
tab-groups-2026-onboarding-cta-button = Cree un grup
