...
edit-profile-page-desktop-shortcut-toggle-2 =
    .label = Cree scurte sul scritori
...
new-profile-page-title = Gnûf profîl
new-profile-page-header = Personalize il to gnûf profîl
new-profile-page-header-description = Ogni profîl al ten cont la sô univoche cronologjie di navigazion e lis sôs impostazions univochis, in maniere dal dut separade di chês di chei altris profîi. Sore, lis fuartis protezions pe riservatece di { -brand-short-name } a son ativis tant che impostazion predefinide.
new-profile-page-learn-more = Plui informazions
...
# Variables
#   $profilename (String) - The name of the profile.
delete-profile-page-title = Elimine il profîl { $profilename }
# Variables
#   $profilename (String) - The name of the profile.
...
sparkle-single-avatar-tooltip =
    .tooltiptext = Dopre la icone faliscje
star-avatar-tooltip =
    .tooltiptext = Dopre la icone stele
video-game-controller-avatar-tooltip =
    .tooltiptext = Dopre la icone controller par videozûcs
