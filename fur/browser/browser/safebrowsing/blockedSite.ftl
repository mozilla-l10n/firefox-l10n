...
safeb-blocked-addon-page-title = Sît blocât pe tô sigurece
safeb-blocked-phishing-page-short-desc = { -brand-short-name } al à blocât cheste pagjine par vie che al pues imbroiâti a fâ alc di pericolôs tant che instalâ software o palesâ informazions personâls come passwords o cjartis di credit.
