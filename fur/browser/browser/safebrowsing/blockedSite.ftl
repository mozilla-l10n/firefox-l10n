...
safeb-blocked-malware-page-error-desc-override = <span data-l10n-name='sitename'>{ $sitename }</span> al è stât <a data-l10n-name='error_desc_link'>segnalât che al conten software malevul</a>. Tu puedis <a data-l10n-name='report_detection'>segnalâ un erôr relatîf a chest avîs</a> opûr <a data-l10n-name='ignore_warning_link'>ignorâ il risi</a> e visitâ chest sît che nol è sigûr.
safeb-blocked-malware-page-error-desc-no-override = <span data-l10n-name='sitename'>{ $sitename }</span> al è stât <a data-l10n-name='error_desc_link'>segnalât che al conten software malevul</a>. Tu puedis <a data-l10n-name='report_detection'>segnalâ un erôr relatîf a chest avîs</a>.
safeb-blocked-malware-page-learn-more = Scuvierç di plui sui contignûts web danôs, includûts virus e altris malware e cemût protezi il to computer, su <a data-l10n-name='learn_more_link'>StopBadware.org</a>. Par vê plui informazions su la protezion di phishing e malware di { -brand-short-name } visite <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
...
safeb-blocked-malware-page-learn-more-sumo = Scuvierç di plui su la protezion di phishing e malware di { -brand-short-name } su <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
