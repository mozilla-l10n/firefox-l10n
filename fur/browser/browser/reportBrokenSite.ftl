...
report-broken-site-panel-description =
    .placeholder = Ce isal sucedût? Ce vevial di sucedi? Aie judât la disativazion de protezion da lis spiis?
...
report-broken-site-panel-blocked-trackers-label =
    .label = Fâs mandâ de protezion da lis spiis i URLs blocâts
