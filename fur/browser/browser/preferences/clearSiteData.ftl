...
clear-site-data-cookies-empty =
    ...
    .accesskey = S
clear-site-data-cookies-info = Se tu ju cancelis, al e pussibil che tu ti cjatis fûr dai sîts web
# The parameters in parentheses in this string describe disk usage
...
clear-site-data-cache-empty =
    ...
    .accesskey = W
clear-site-data-cache-info = I sîts web an di ricjariâ lis imagjinis e i dâts 
