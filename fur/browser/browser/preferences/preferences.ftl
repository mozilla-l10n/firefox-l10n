...
pane-ai-controls-title = Controi IA
...
applications-setting =
    .label = Aplicazions
    .description = Sielç cemût che { -brand-short-name } al à di gjestî i files che tu discjariis dal web o lis aplicazions che tu dopris intant che tu navighis.
