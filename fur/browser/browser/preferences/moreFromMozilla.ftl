...
more-from-moz-firefox-mobile-description-advanced = Dal bloc dai elements che ti spiin al fermâ i fastidiôs contignûts cun riproduzion automatiche, i navigadôrs mobii de famee { -brand-product-name } a fasin i straordenaris par garantîti la miôr navigazion pussibile su Internet.
more-from-moz-mozilla-vpn-title = { -mozilla-vpn-brand-name }
more-from-moz-mozilla-vpn-description = Scuvierç un nivel superiôr di protezion e navigazion anonime.
more-from-moz-mozilla-vpn-description-advanced = { -mozilla-vpn-brand-name } al zonte un nivel superiôr di navigazion anonime e di protezion. E, al contrari di cualchi altri VPN, al è sigûr e nol ten segnade la tô ativitât.
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-title = { -rally-brand-name }
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-description = Met in vore i tiei dâts par un internet miôr par ducj.
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-description-advanced = Done i tiei dâts pai studis di ricercje destinâts a creâ un internet plui sigûr e plui viert, che al judi la int e no lis grandis aziendis.
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-button-mozilla-rally-2 = Partecipe a { -rally-short-name }
