...
contextual-manager-passwords-origin-field =
    .label = Direzion sît web
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Inserìs la direzion precise là che tu fasis l’acès par chest sît.
contextual-manager-passwords-username-field =
    .label = Non utent
contextual-manager-passwords-username-field-description = Inserìs il non utent, la direzion e-mail o il numar di account che tu dopris par jentrâ.
contextual-manager-passwords-password-field =
    .label = Password
contextual-manager-passwords-password-field-description = Inserìs la password par jentrâ su chest account.
