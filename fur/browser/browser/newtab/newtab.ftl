...
newtab-topsites-use-custom-image-link = Dopre une imagjin personalizade
...
newtab-custom-stories-personalized-checkbox =
    .label = Storiis personalizadis in base ae tô ativitât
...
newtab-clock-city-us-new-york = Gnove York
...
newtab-clock-city-de-hamburg = Amburc
newtab-clock-city-fr-paris = Parîs
...
newtab-clock-city-kr-seoul = Seûl
newtab-clock-city-pt-lisbon = Lisbone
