...
firefoxview-just-now-timestamp = Juste cumò
# This is a headline for an area in the product where users can resume and re-open tabs they have previously viewed on other devices.
firefoxview-tabpickup-header = Ripie schede
firefoxview-tabpickup-description = Vierç lis pagjinis di un altri dispositîf.
# Variables:
#  $percentValue (Number): the percentage value for setup completion
firefoxview-tabpickup-progress-label = { $percentValue }% completât
...
firefoxview-tabpickup-sync-error-header = O vin dificoltât a sincronizâ
firefoxview-tabpickup-generic-sync-error-description = { -brand-short-name } nol pues rivâ al servizi di sincronizazion in chest moment. Torne prove chi di pôc.
firefoxview-tabpickup-sync-error-primarybutton = Torne prove
...
firefoxview-closed-tabs-placeholder-body2 = Cuant che tu sieris une schede, tu puedis simpri recuperâle di chi.
# Variables:
...
firefoxview-overview-header = Navigazion resinte
    .title = Navigazion resinte
...
firefoxview-recently-closed-nav = Schedis sieradis di resint
    .title = Schedis sieradis di resint
firefoxview-recently-closed-header = Schedis sieradis di resint

## Tabs from other devices refers in this context refers to synced tabs from other devices

firefoxview-synced-tabs-nav = Schedis di altris dispositîfs
    .title = Schedis di altris dispositîfs
firefoxview-synced-tabs-header = Schedis di altris dispositîfs
...
firefoxview-search-text-box-opentabs =
    .placeholder = Cîr tes schedis viertis
...
firefoxview-history-date-today = Vuê - { DATETIME($date, dateStyle: "full") }
