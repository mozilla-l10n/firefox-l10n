...
<html>
  <head>
    <title>Здаткі профілю JavaScript</title>
  </head>
  <style>
    .profile-file-title {
        font-size  : larger;
  ...
  <body>
    <h1>Здаткі профілю JavaScript</h1>
    <span class="label">Дата збірання:</span>
    <span class="value">$full-date</span><br>
    <span class="label">Дзеяч карыстальніка:</span>
    <span class="value">$user-agent</span><br>
    <span class="label">Версія наладчыка JavaScript:</span>
    <span class="value">$venkman-agent</span><br>
    <span class="label">Размеркавана згодна:</span>
...
@-range-start
      <span class="range-box">
        ...
        [ <a href="#section$section-number-prev">Папярэдні файл</a> |
        <a href="#section$section-number-next">Наступны файл</a> |
        <a href="#range$section-number:$range-number-prev">Папярэдні дыяпазон</a> |
        <a href="#range$section-number:$range-number-next">Наступны дыяпазон</a> ]
@-item-start
...
@-section-end
    <hr>
    <a href="http://www.mozilla.org/projects/venkman/">Няма працы занадта вялікай, няма аддзякі занадта вялікай.</a>
  </body>
</html>
