...
neterror-search-cta-title = Гэты сайт недаступны
...
neterror-sslkeylogging-warning =
    .heading = Ваша злучэнне можа быць непрыватным
    .message = Праграма або служба могуць бачыць ваш зашыфраваны трафік з гэтага сайта.
...
neterror-http-empty-response = Праверце, ці правільна вы ўвялі адрас вэб-сайта, і паспрабуйце зноў праз некалькі хвілін.
# Variables:
#   $hostname (String) - Hostname of the website to which the user was trying to connect.
neterror-http-empty-response-description = { $hostname } адправіў назад пустую старонку.
...
neterror-dns-not-found-hint-check-network-2 = Праверце падлучэнне да сеткі.
neterror-dns-not-found-hint-firewall-2 = Праверыць, ці мае { -brand-short-name } дазвол на доступ да Інтэрнэту (магчыма, вы падключаны, але за брандмаўарам).
...
neterror-file-not-found-what-can-you-do = Калі вы ўвялі адрас уручную, праверце наяўнасць памылак у назве файла ці шляху да яго, або няправільнага рэгістру літар. Калі вы перайшлі па захаванай закладцы ці спасылцы, файл мог быць перамешчаны, перайменаваны або выдалены пасля захавання. Паспрабуйце знайсці яго з дапамогай файлавага менеджара або функцыі пошуку.
...
fp-neterror-offline-intro-2 = { -brand-short-name } не можа падключыцца да сервера па адрасе <strong>{ $hostname }</strong>.
fp-neterror-net-timeout-intro = Сервер па адрасе <strong>{ $hostname }</strong> адказвае занадта доўга.
# Variables:
#   $hostname (String) - Hostname of the website to which the user was trying to connect.
...
fp-neterror-vpn-error-title = Не ўдалося падключыцца да VPN
fp-neterror-vpn-error-description = Паспрабуйце зноў праз некалькі хвілін.
fp-neterror-denied-port-access = Гэты адрас выкарыстоўвае порт, які звычайна ўжываецца не для аглядання ў Сеціве. { -brand-short-name } скасаваў запыт дзеля вашай аховы.
