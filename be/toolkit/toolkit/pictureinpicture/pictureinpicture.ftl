...
pictureinpicture-fullscreen-cmd =
    ...
    .title = Поўнаэкранны рэжым (падвойнае націсканне)
pictureinpicture-exit-fullscreen-cmd =
    .aria-label = Выйсці з поўнага экрана
    .title = Выйсці з поўнаэкраннага рэжыму (падвойнае націсканне)
...
pictureinpicture-fullscreen-btn =
    .aria-label = Увесь экран
    .tooltip = Поўнаэкранны рэжым (падвойнае націсканне)
pictureinpicture-exit-fullscreen-btn =
    .aria-label = Выйсці з поўнага экрана
    .tooltip = Выйсці з поўнаэкраннага рэжыму (падвойнае націсканне)
