...
pictureinpicture-fullscreen-cmd =
    ...
    .title = Поўнаэкранны рэжым (націснуць двойчы)
pictureinpicture-exit-fullscreen-cmd =
    .aria-label = Выйсці з поўнага экрана
    .title = Выйсці з поўнаэкраннага рэжыму (націснуць двойчы)
...
pictureinpicture-fullscreen-btn =
    .aria-label = Увесь экран
    .tooltip = Поўнаэкранны рэжым (націснуць двойчы)
pictureinpicture-exit-fullscreen-btn =
    .aria-label = Выйсці з поўнага экрана
    .tooltip = Выйсці з поўнаэкраннага рэжыму (націснуць двойчы)
