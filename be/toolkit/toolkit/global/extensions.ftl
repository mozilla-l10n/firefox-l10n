...
webext-site-perms-description-gated-perms-webserial =
    Гэта такія прылады, як мікракантролеры, 3D-прынтары і іншыя прылады, якія падключаюцца праз USB, паслядоўныя парты ці Bluetooth.
    
    Вы зможаце выбраць, да якіх прылад вэб-сайт можа атрымаць доступ.
    
    Сайтам звычайна не дазваляецца атрымліваць доступ да паслядоўных прылад. Няправільнае выкарыстанне можа прывесці да пашкоджання або парушэння бяспекі.
