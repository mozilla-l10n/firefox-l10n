...
experimental-features-firefox-100-description = Дазвольце { -brand-short-name } адпраўляць вэб-сайтам радок User-Agent, які выдае сябе за { -brand-product-name } версіі 100. Выкарыстоўвайце гэты параметр, каб праверыць, ці будуць вэб-сайты працаваць, калі { -brand-short-name } дасягне трохзначнага нумару версіі. Сапраўдны { -brand-product-name } 100 плануецца выпусціць у траўні 2022 года, таму пачынайце тэставаць свае вэб-сайты ўжо зараз!
