...
private-browsing-description = Тыпова, пашырэнням не дазволена працаваць у прыватных вокнах. Гэта азначае, што яны не працуюць, пакуль вы карыстаецеся прыватным агляданнем, і не маюць доступу да вашай сеціўнай актыўнасці ў ім. Каб дазволіць пашырэнне ў прыватных вокнах, выберыце картку пашырэння ніжэй і змяніце наладу. <label data-l10n-name="private-browsing-learn-more">Даведацца больш.</label>
