...
about-logging-preset-navigation = Навігацыя
about-logging-preset-navigation-description = Модулі журнала для дыягностыкі праблем з навігацыяй і гісторыяй сеансаў
