...
certificate-viewer-log-name = Назва журнала
# Log is a noun meaning a record of events.
...
certificate-viewer-surname = Прозвішча
...
certificate-viewer-given-name = Імя
...
certificate-viewer-unknown-file-name = сертыфікат
