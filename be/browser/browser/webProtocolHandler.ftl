...
protocolhandler-mailto-os-handler-notificationbox = Заўсёды выкарыстоўваць { -brand-short-name } для адкрыцця спасылак, якія адпраўляюць электронную пошту?
protocolhandler-mailto-os-handler-yes-confirm = { -brand-short-name } цяпер ваша прадвызначаная праграма для адкрыцця спасылак, якія адпраўляюць электронную пошту.
protocolhandler-mailto-os-handler-yes-button = Зрабіць прадвызначаным
...
protocolhandler-mailto-handler-yes-button = Зрабіць прадвызначаным
