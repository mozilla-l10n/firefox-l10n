...
report-broken-site-panel-description =
    .placeholder = Што здарылася? Што павінна было здарыцца? Ці дапамагло адключэнне аховы ад сачэння?
