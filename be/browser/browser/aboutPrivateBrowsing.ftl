...
about-private-browsing-info-searches = пашуковыя запыты
about-private-browsing-info-downloads = сцягванні
private-browsing-title = Прыватнае агляданне
about-private-browsing-info-saved = Але { -brand-short-name } <strong>захоўвае</strong> вашы:
about-private-browsing-info-myths = Шырокавядомыя забабоны пра прыватнае агляданне
about-private-browsing-info-clipboard = скапіяваны тэкст
about-private-browsing-info-temporary-files = часовыя файлы
about-private-browsing-info-cookies = кукі
tracking-protection-start-tour = Як гэта працуе?
about-private-browsing-note = Прыватнае агляданне <strong>не робіць вас ананімам</strong> у інтэрнэце. Ваш працадаўца і інтэрнэт-правайдар па-ранейшаму могуць ведаць, якія старонкі вы наведваеце.
