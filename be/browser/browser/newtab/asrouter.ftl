...
welcome-back-spotlight-title = Вярніцеся да ўбудаванай прыватнасці
welcome-back-spotlight-subtitle = Вітаем з вяртаннем у адзіны буйны браўзер, які падтрымліваецца некамерцыйнай арганізацыяй. Мы робім дадатковыя крокі для аховы вашых дадзеных, дзе б вы ні знаходзіліся.
welcome-back-embedded-import-title = Імпартуйце свае дадзеныя і адчувайце сябе як дома ў { -brand-short-name }
...
windows-10-eos-global-infobar-title = <strong>Microsoft больш не падтрымлівае Windows 10.</strong> Зрабіце рэзервовую копію сваёй інфармацыі, каб падрыхтаваць { -brand-product-name } да Windows 11.
...
relay-50-masks-announcement-subtitle = Цяпер вы атрымліваеце 50 бясплатных масак (раней было 5). Выкарыстоўвайце па адной для кожнага ўліковага запісу, каб захаваць прыватнасць сваёй сапраўднай электроннай пошты.
...
nova-early-access-infobar-title = <strong>{ -brand-product-name } атрымлівае новы выгляд.</strong> Вы знаёміцеся з ранняй, недапрацаванай версіяй перад запускам пазней у гэтым годзе.
nova-early-access-share-feedback-link = Падзяліцца водгукам
    .accesskey = в
...
lapsed-user-toast-title = { -brand-product-name } усё яшчэ прыкрывае вас
...
refresh-unused-profile-infobar-message = Выглядае, быццам вы вельмі даўно не запускалі { -brand-short-name }. Вы хочаце пачаць начыста, быццам нанава?
refresh-reinstalled-profile-infobar-message = Падобна на тое, што вы пераўсталявалі { -brand-short-name }. Хочаце, каб мы ачысцілі яго, каб ён пачаў працаваць як новенькі?
refresh-profile-infobar-button = Аднавіць { -brand-short-name }…
    .accesskey = в
