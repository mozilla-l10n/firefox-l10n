...
fx-view-discoverability-title = Не хацелі закрыць гэтую картку?
fx-view-discoverability-subtitle = Знайдзіце і зноў адкрыйце яе тут. Мы захоўваем гісторыю вашых нядаўна закрытых картак.
fx-view-discoverability-primary-button-label = Адкрыць { -firefoxview-brand-name }
fx-view-discoverability-secondary-button-label = Адхіліць
...
start-page-callout-title = Хочаце паспрабаваць новы пошук, арыентаваны на прыватнасць?
start-page-callout-subtitle = Паспрабуйце Startpage. Ён распрацаваны, каб зрабіць вашы пошукі больш прыватнымі з самага пачатку.
start-page-callout-primary-label = Паспрабаваць Startpage
start-page-callout-secondary-label = Адхіліць
...
link-preview-onboarding-callout-title = Новае: Націсніце і ўтрымлівайце для папярэдняга прагляду спасылак
link-preview-onboarding-callout-description = Каб вырашыць, ці варта націскаць на спасылку, паглядзіце кароткае апісанне, час чытання і іншыя звесткі. Таксама даступна па націсканні правай кнопкай мышы.
...
tab-groups-2026-onboarding-callout-title = Пазбаўцеся мітусні з дапамогай груп картак
...
tab-groups-2026-onboarding-callout-subtitle = Групуйце карткі па задачах ці тэмах. Перацягвайце больш па меры выкарыстання.
...
tab-groups-2026-onboarding-cta-button = Стварыць групу
...
vertical-tabs-callout-1-subtitle = Паспрабуйце наш новы вертыкальны выклад картак, каб хутка сканаваць свой спіс картак. Першыя выпрабавальнікі паведамляюць, што гэты выклад дапамагае ім адчуваць сябе больш арганізаванымі. Пераключайцеся ў любы час.
vertical-tabs-callout-1-cta-button = Паспрабуйце вертыкальныя карткі
vertical-tabs-callout-2-cta-button = Паспрабаваць зараз
vertical-tabs-callout-2-title = Трымаеце шмат картак адкрытымі? Паспрабуйце вертыкальныя карткі.
vertical-tabs-callout-2-subtitle = Гэты выклад дазваляе лёгка і хутка сканаваць спіс картак. Акрамя таго, вы можаце наладзіць шырыню, каб бачыць больш ці менш літар у загалоўках картак.
...
sidebar-callout-survey-dissatisfied-2 = Незадаволены
sidebar-callout-survey-very-dissatisfied-2 = Вельмі незадаволены
...
sidebar-callout-survey-saved-websites-2 = Хуткі доступ да вашых закладак
...
splitview-onboarding-callout-title-1 = Падзелены выгляд: лепшы спосаб шматзадачнасці
splitview-onboarding-callout-subtitle-1 = Націсніце правай кнопкай мышы на гэтай картцы і абярыце «Дадаць падзелены выгляд», каб бачыць дзве карткі адначасова.
splitview-onboarding-callout-cta-1 = Паспрабуйце цяпер
splitview-onboarding-callout-title-2 = Бачце дзве карткі адначасова ў падзеленым выглядзе
splitview-onboarding-callout-subtitle-2 = Ніякіх лішніх вокнаў. Ніякага пераключэння картак. Націсніце правай кнопкай мышы на гэтай картцы і абярыце «Дадаць падзелены выгляд».
splitview-onboarding-callout-cta-2 = Паспрабаваць падзелены выгляд
unified-search-callout-title = Пераключэнне паміж пошукавымі сістэмамі
unified-search-callout-subtitle = Выберыце тое, што лепш за ўсё працуе для вашага канкрэтнага пошуку.
unified-search-callout-primary-label = Далей
unified-search-callout-secondary-label = Адхіліць
unified-search-engines-callout-title = Пошук з дапамогай цэтліка
