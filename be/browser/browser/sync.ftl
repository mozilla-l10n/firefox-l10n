...
fxa-menu-send-to-device =
    .label =
        { $tabCount ->
            [1] Даслаць на прыладу
            [one] Даслаць { $tabCount } картку на прыладу
...
fxa-menu-manage-account-subtitle = Кіраванне ўліковым запісам
...
fxa-menu-sign-in-promo-heading = Увайсці ў сінхранізацыю
fxa-menu-sign-in-promo-message = Атрымлівайце свае дадзеныя ўсюды
...
fxa-menu-signed-out-message-login-failed = Вы выйшлі
# Reason shown when the remembered account still needs to verify their email.
fxa-menu-signed-out-message-unverified = Скончыць наладку
...
fxa-menu-signed-out-title = Увайсці ў сінхранізацыю
fxa-menu-signed-out-description = Вы выйшлі
