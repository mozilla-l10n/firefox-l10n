...
contextual-manager-passwords-import-success-message-2 = Новае: { $added }, Абноўлена: { $modified }, Дублікаты: { $no_change }, Памылкі: { $error }
...
contextual-manager-passwords-origin-field-description = Увядзіце дакладны адрас, дзе вы будзеце ўваходзіць на гэты сайт.
contextual-manager-passwords-username-field =
    .label = Імя карыстальніка
contextual-manager-passwords-username-field-description = Увядзіце імя карыстальніка, адрас электроннай пошты або нумар уліковага запісу, які вы выкарыстоўваеце для ўваходу.
contextual-manager-passwords-password-field =
    .label = Пароль
contextual-manager-passwords-password-field-description = Увядзіце пароль для ўваходу ў гэты ўліковы запіс.
