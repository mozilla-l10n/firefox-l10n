...
screenshots-notification-image-copied-title = Скрыншот скапіяваны
screenshots-notification-image-copied-details = Скрыншот скапіяваны ў буфер абмену. Націсніце { screenshots-meta-key }-V, каб уставіць.
