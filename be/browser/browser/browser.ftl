...
urlbar-searchmode-actions2 = Дзеянні
...
qrcode-save-button =
    .label = Захаваць
qrcode-save-success =
    .message = QR-код захаваны.
qrcode-save-error =
    .message = Не ўдалося захаваць QR-код.
qrcode-save-title = Захаваць QR-код
qrcode-save-filter-png = Выява PNG
