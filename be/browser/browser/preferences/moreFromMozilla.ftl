...
more-from-moz-title2 = Больш ад { -vendor-short-name }
    .title = Больш ад { -vendor-short-name }
...
more-from-moz-mozilla-vpn-box-link =
    .label = Атрымаць { -mozilla-vpn-brand-name }
more-from-moz-firefox-relay-box-link =
    .label = Атрымаць { -relay-brand-short-name }
more-from-moz-mdn-box-link =
    .label = Доступ да MDN
more-from-moz-thunderbird-box-link =
    .label = Атрымаць { -thunderbird-brand-short-name }
more-from-moz-solo-box-link =
    .label = Паспрабаваць { -solo-ai-brand-name }
more-from-moz-new-products-box-link =
    .label = Паглядзець новыя прадукты
