...
appearance-browser-icon-entry-group =
    .label = Значок браўзера
    .description = Выберыце карыстальніцкі значок для панэлі задач, працоўнага стала і меню «Пуск».
appearance-browser-icon-button =
    .label = Змяніць значок браўзера
