...
settings-tabs-drag-to-create-tab-groups =
    .label = Перацягвайце карткі, каб ствараць групы картак
...
applications-setting =
    .label = Праграмы
    .description = Выберыце, як { -brand-short-name } мусіць апрацоўваць сцягнутыя з Сеціва файлы або праграмы, якія вы выкарыстоўваеце ў часе аглядання.
