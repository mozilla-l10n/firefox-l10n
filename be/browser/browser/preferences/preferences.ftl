...
tls-key-logging-notice-nav =
    .label = Праграма або служба могуць бачыць ваш зашыфраваны трафік.
category-list =
...
containers-external-links-check =
    .label = Не ўжываць кантэйнеры для спасылак, адкрытых з знешніх праграм
    .accesskey = в
...
preferences-ai-controls-speech-recognition-control =
    .description = Транскрыбуйце маўленне лакальна.
    .label = Распазнаванне маўлення
preferences-ai-controls-sidebar-chatbot-group-3 =
    .description = Трымайце чат-бота ў полі зроку ў часе аглядання. Выбірайце з некалькіх пастаўшчыкоў і пераключайцеся ў любы час.
    .label = Пастаўшчыкі чат-ботаў са штучным інтэлектам у бакавой панэлі
preferences-ai-controls-sidebar-chatbot-group-2 =
    .description = Трымайце чат-бота ў полі зроку ў часе аглядання. Выбірайце паміж Anthropic Claude, ChatGPT, Copilot, Google Gemini і Mistral Vibe.
    .label = Пастаўшчыкі чат-ботаў са штучным інтэлектам у бакавой панэлі
...
preferences-ai-controls-block-confirmation-speech-recognition = Распазнаванне маўлення
...
preferences-etp-tracker-count-enabled =
    .label = Паказваць заблакаваныя трэкеры ў адрасным радку
...
preferences-etp-custom-cookie-behavior-block-cross-site-tracking-cookies =
    .label = Блакаваць міжсайтавыя кукі сачэння
...
security-privacy-issue-warning-doh2 =
    .description = DNS праз HTTPS дапамагае схаваць ад вашага інтэрнэт-правайдара, якія сайты вы збіраецеся наведаць.
    .label = DNS праз HTTPS адключаны
security-privacy-issue-warning-ech2 =
    .description = Зашыфраванае прывітанне кліента (Encrypted Client Hello) дапамагае схаваць ад вашага інтэрнэт-правайдара, якія сайты вы збіраецеся наведаць.
    .label = Encrypted Client Hello адключана
