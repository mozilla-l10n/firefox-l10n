...
genai-settings-chat-lechat-links-2 = Выбіраючы Mistral Vibe, вы згаджаецеся з <a data-l10n-name="link1">Умовамі абслугоўвання</a> і <a data-l10n-name="link2">Палітыкай прыватнасці</a> Mistral AI.
...
genai-shortcut-search-button =
    .aria-label = Шукаць «{ $selection }» у { $engine }
    .tooltiptext = Пошук па запыце «{ $selection }» у { $engine }
genai-shortcut-copy-button =
    .aria-label = Скапіяваць вылучаны тэкст
    .tooltiptext = Скапіяваць вылучаны тэкст
...
link-preview-error-message-v2 = { -brand-short-name } не можа папярэдне паглядзець гэту спасылку
# Text for the link to visit the original URL when in error state
link-preview-visit-link = Наведаць спасылку
# Error message when key points generation (summary highlights or main ideas of page content) fails for a page
link-preview-generation-error-missing-data-v2 = { -brand-short-name } не можа стварыць ключавыя пункты для гэтай вэб-старонкі.
