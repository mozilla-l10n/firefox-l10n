...
colorpicker-tooltip-eyedropper-title = Выбраць колер на старонцы
...
colorpicker-tooltip-color-name-title = Найбліжэйшы да: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Адценне
