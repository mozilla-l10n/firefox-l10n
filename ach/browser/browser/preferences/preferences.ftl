...
pane-privacy-title2 = Mung ki Ber bedo
...
applications-setting =
    .label = Purugram
    .description = Yer kit ma { -brand-short-name } tiyo ki pwail ma igamo ki i kakube onyo purugram ma itiyo kwedgi ka itye ka yeny.
