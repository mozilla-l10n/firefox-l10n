...
sec-error-ocsp-no-default-responder = Depes cunfigurare su serbidore de risposta predefinidu OCSP in antis de sighire cun custa operazione.
...
sec-error-busy = Impossibile essire dae NSS. Is ogetos si sunt ancora impreende.
