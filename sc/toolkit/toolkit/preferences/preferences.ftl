...
settings-pp-erased-ok = As cantzelladu sa crae printzipale. Is craes sarvadas e is craes privadas de is tzertificados gestidos dae { -brand-short-name } no ant a èssere amparadas.
settings-pp-not-wanted = Atentzione: as detzìdidu de no impreare una crae printzipale. Is craes sarvadas e is craes privadas de is tzertificados gestidos dae { -brand-short-name } no ant a èssere amparadas.
...
set-password-old =
    .label = Crae atuale:
set-password-new =
    .label = Inserta una crae noa:
set-password-reenter =
    .label = Cunfirma sa crae noa:
...
primary-password-required-by-policy = S’organizatzione tua rechedet chi tèngias una crae printzipale pro sarvare is craes.
