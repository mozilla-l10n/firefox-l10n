...
certmgr-people = Tenes tzertificados in s’archìviu chi identìficant custas persones
certmgr-server = Custas intradas identìficant is etzetziones de faddina de tzertificados de serbidore
certmgr-ca = Tenes tzertificados in s’archìviu chi identìficant custa entidades de tzertificatzione
...
certmgr-fingerprint-sha-256 =
    .label = Imprenta digitale SHA-256
certmgr-view =
    .label = Visualiza...
    .accesskey = V
certmgr-edit =
...
exception-mgr-extra-button =
    ...
    .accesskey = C
exception-mgr-supplemental-warning = Is bancas, butegas e àteros sitos pùblicos no t’ant a preguntare de fàghere custu.
...
exception-mgr-permanent =
    .label = Sarva custa etzetzione in manera permanente
    .accesskey = S
...
add-exception-branded-warning = Ses a canta de modificare sa manera comente { -brand-short-name } identìficat custu situ.
