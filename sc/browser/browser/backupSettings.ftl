...
turn-on-scheduled-backups-error-default-dir-denied = No at fatu a atzèdere a sa cartella de sa còpia de seguresa. Proa a seberare un’àtera positzione.
