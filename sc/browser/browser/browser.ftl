...
clear-search-history =
    .label = Cantzella cronologia de chirca
    .accesskey = c
...
urlbar-view-context-menu-open-in-private-window =
    ...
    .accesskey = p
urlbar-view-context-menu-open-in-tab2 = Aberi in un’ischeda noa
    .accesskey = w
urlbar-view-context-menu-open-in-container-tab2 = Aberi in un’ischeda cuntenidora noa
    .accesskey = i
urlbar-view-context-menu-open-in-window2 = Aberi in una ventana noa
    .accesskey = v
urlbar-view-context-menu-open-in-private-window2 = Aberi in una ventana privada noa
    .accesskey = p
