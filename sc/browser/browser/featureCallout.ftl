...
login-status-advisory-title = As serradu sa sessione. Incarca s’icona de su contu pro ti identificare.
...
taskbar-tabs-chat-callout-subtitle = Avia is tzarradas tuas comente un’aplicatzione in una ventana simplificada amparada dae { -brand-short-name }.
...
taskbar-tabs-media-callout-subtitle = Imprea is sitos de trasmissiones comente un’aplicatzione in una ventana simplificada amparada dae { -brand-short-name }.
...
windows-10-eos-sync-urgency-subtitle-2 = Fintzas si no impreas { -brand-short-name } ònnia die, sincroniza pro mantènnere is craes e is sinnalibros amparados e atzessìbiles.
...
tab-groups-2026-onboarding-cta-button = Crea unu grupu
