...
newtab-custom-stories-personalized-checkbox =
    .label = Istòrias personalizadas basadas subra de is atividades tuas
...
newtab-clock-city-de-munich = Monaco de Baviera
...
newtab-clock-city-br-brasilia = Brasìlia
...
newtab-clock-city-mx-mexico-city = Tzitade de su Mèssicu
newtab-clock-city-mx-guadalajara = Gadalassara
...
newtab-clock-city-es-madrid = Madrìd
newtab-clock-city-es-barcelona = Bartzellona
newtab-clock-city-nl-amsterdam = Amsterdam
newtab-clock-city-ch-zurich = Zurigu
...
newtab-clock-city-hu-budapest = Bùdapest
...
newtab-clock-city-tr-istanbul = Ìstanbul
newtab-clock-city-my-kuala-lumpur = Kuala Lumpur
newtab-clock-city-eg-cairo = Su Càiru
...
newtab-clock-city-kr-seoul = Seùl
newtab-clock-city-lt-vilnius = Vìlnius
