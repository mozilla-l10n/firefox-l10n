...
contextual-manager-passwords-vulnerable-password-heading-and-message =
    ...
    .message = Custa crae est fàtzile a intzertare. Modifica·dda pro amparare su contu tuo.
contextual-manager-passwords-vulnerable-password-link-message = Comente faghet { -brand-product-name } a ischire chi una crae est dèbile?
...
contextual-manager-passwords-origin-field =
    .label = Indiritzu de su situ
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Iscrie s’indiritzu giustu dae in ue t’as a identificare in custu situ.
contextual-manager-passwords-username-field =
    .label = Nòmine utente
contextual-manager-passwords-username-field-description = Inserta·nche su nòmine, s’indiritzu eletrònicu o su nùmeru de contu chi impreas pro ti identificare.
contextual-manager-passwords-password-field =
    .label = Crae
contextual-manager-passwords-password-field-description = Inserta·nche sa crae pro ti identificare in custu contu.
