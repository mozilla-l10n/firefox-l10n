...
firefoxview-syncedtabs-synctabs-header-2 = Sa sincronizatzione de ischedas est disativada
...
firefoxview-tabpickup-network-offline-header-2 = { -brand-short-name } non si podet connètere immoe
