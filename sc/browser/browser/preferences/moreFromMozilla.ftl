...
more-from-moz-firefox-mobile-description-advanced = Dae su blocu de is sighiduras a s'arressu de is cuntenutos chi istorbant riproduende·si in automàticu, is navigadores de { -brand-product-name } pro dispositivos mòbiles traballant de manera istraordinària pro chi tue tèngias sa mègius navigatzione possìbile.
more-from-moz-mozilla-vpn-title = { -mozilla-vpn-brand-name }
more-from-moz-mozilla-vpn-description = Iscoberi unu livellu in prus de navigatzione anònima e de amparu.
more-from-moz-mozilla-vpn-description-advanced = { -mozilla-vpn-brand-name } agiunghet un'àteru livellu de navigatzione anònima e de amparu. E, a su contràriu che a àteras VPN, est segura e non sighit s'atividade tua.
