...
appmenu-update-available2 =
    .label = Agiornamentu a disponimentu
...
appmenu-update-restart2 =
    .label = Agiornamentu a disponimentu
    .buttonlabel = Agiorna e torra a aviare
    .buttonaccesskey = G
    .secondarybuttonlabel = Iscarta
    .secondarybuttonaccesskey = s
...
appmenu-update-other-instance-message = Ddoe est un'agiornamentu nou de { -brand-shorter-name } a disponimentu, ma non faghet a ddu installare ca ddoe est un'àtera còpia de { -brand-shorter-name } in esecutzione. Serra·dda pro sighire cun s'agiornamentu, o sèbera de agiornare su pròpiu (podet dare chi s'àtera còpia no at a funtzionare fintzas a cando no dda torres a aviare).
