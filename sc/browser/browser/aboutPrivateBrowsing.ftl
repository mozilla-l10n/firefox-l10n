...
about-private-browsing-info-searches = chircas
about-private-browsing-info-downloads = iscarrigamentos
private-browsing-title = Sa navigatzione privada
about-private-browsing-info-saved = { -brand-short-name } <strong>at a sarvare</strong> :
about-private-browsing-info-temporary-files = archìvios temporales
