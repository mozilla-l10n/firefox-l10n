...
default-browser-notification-privacy-header-text = Boles abarrare cun { -brand-short-name }?
default-browser-notification-privacy-body-text = Su navigadore predefinidu tuo est cambiadu. Torra a { -brand-short-name } pro tènnere riservadesa e amparu de manera integrada.
...
default-browser-notification-privacy-no-button-text = No, gràtzias
