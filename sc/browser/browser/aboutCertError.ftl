...
csp-xfo-blocked-long-desc = Pro amparare sa seguresa tua, { $hostname } no at a permìtere a { -brand-short-name } de ammustrare sa pàgina si est inclùdida in un’àteru situ. Pro visualizare sa pàgina, depes abèrrere una ventana noa.
