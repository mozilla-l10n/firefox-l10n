...
helpus-referrals2 = Agiudare boles? <label data-l10n-name="helpus-donateLink">Faghe una donatzione</label>, <label data-l10n-name="helpus-shareFirefoxLink">cumpartzi { -brand-product-name }</label> o <label data-l10n-name="helpus-getInvolvedLink">collàbora!</label>
