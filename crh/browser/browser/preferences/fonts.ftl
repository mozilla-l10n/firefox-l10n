...
fonts-langgroup-header = Aşağıdakiler içün hurafatlar
    .accesskey = u
...
fonts-langgroup-simpl-chinese =
    .label = Basitleştirilgen Çince
fonts-langgroup-trad-chinese-hk =
    .label = Ananeviy Çince (Hong Kong)
fonts-langgroup-trad-chinese =
    .label = Ananeviy Çince (Tayvan)
...
fonts-langgroup-canadian =
    .label = Birleştirilgen Kanada Ecalaması
fonts-langgroup-other =
    .label = Diger Yazı Sistemleri
