...
pane-home-title = Ev
pane-search-title2 = Qıdırma
    .title = Qıdırma
pane-privacy-title3 = Hususiyat ve Emniyet
    .title = Hususiyat ve Emniyet
category-home =
    .tooltiptext = { pane-home-title }
pane-search-title = Qıdırma
category-search =
    .tooltiptext = { pane-search-title }
pane-privacy-title2 = Hususiyat ve Emniyet
pane-privacy-section =
    .heading = Hususiyat ve Emniyet
...
help-button-label2 = { -brand-short-name } Destegi
    .title = { -brand-short-name } Destegi
addons-button-label2 = Eklentiler ve Temalar
    .title = Eklentiler ve Temalar
...
download-save-where-3 =
    .aria-label = Dosylerniñ qayda saqlanacağı
downloads-header-2 =
    .label = Endirmeler
...
applications-setting =
    .label = Uyğulamalar
    .description = { -brand-short-name } kezicisiniñ Ağ’dan endirgeniñiz dosyelerni yaki kezingende qullanğanıñız uyğulamalarnı nasıl qollağanını sayla.
...
applications-type-column =
    .label = Muhteva Türü
    .accesskey = t
applications-type-heading = Muhteva Türü
applications-action-column =
    .label = Amel
    .accesskey = E
applications-action-heading = Amel
# Variables:
...
search-engine-group =
    .label = Ögbelgilengen Qıdırma Motorı
search-default-engine =
    .aria-label = Ögbelgilengen Qıdırma Motorı
