...
sync-disconnect-remove-other-data = Çörekler, zula, hat-tışı ağ-saytı verileri, vs.
# Shown while the disconnect is in progress
sync-disconnect-disconnecting = Bağlantı qoparıla…
...
sync-disconnect-confirm-disconnect-delete =
    .label = Bağlantını Qopar ve Sil
    .accesskey = o
sync-disconnect-confirm-disconnect =
    .label = Sadece Bağlantını Qopar
    .accesskey = S
