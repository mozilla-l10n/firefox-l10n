...
options-do-nothing = İç bir şey yapmazsanız { -brand-short-name } profil verileriniz diğer Firefox kurulumlarındaki profil verilerinden farklı olacaktır.
...
sync-first = İlk kez mi { -sync-brand-name } kullanıyorsunuz? Bilgilerinizi eşitlemek için tüm Firefox’larınızdan esabınıza giriş yapmalısınız.
