...
refresh-unused-profile-infobar-message = Bir müddettir { -brand-short-name } kezicisini başlatmağansıñız kibi körüle. Taze ve yañı-kibi bir tecribe içün onı temizlemege isteysiñizmi? Bu arada, keri hoş keldiñiz!
refresh-reinstalled-profile-infobar-message = { -brand-short-name } kezicisini kene qurğan olsıñız kibi körüne. Taze, yañı-kibi bir tecribe içün onı temizlememizni isteysiñizmi?
refresh-profile-infobar-button = { -brand-short-name } Tazertilsin…
    .accesskey = e
