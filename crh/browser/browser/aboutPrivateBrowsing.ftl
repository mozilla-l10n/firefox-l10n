...
about-private-browsing-info-bookmarks = saifeimleri
about-private-browsing-info-title = Hususiy bir Penceredesiz
about-private-browsing-info-searches = qıdırmalar
about-private-browsing-info-downloads = endirmeler
private-browsing-title = Hususiy Kezinüv
about-private-browsing-info-saved = { -brand-short-name } aşağıdakileriñizni <strong>saqlaycaq</strong>:
about-private-browsing-info-myths = Hususiy kezinüv ile alâqalı yayğın efsaneler
about-private-browsing-info-clipboard = kopiyalanğan metin
about-private-browsing-info-temporary-files = muvaqqat dosyeler
about-private-browsing-info-cookies = çörekler
tracking-protection-start-tour = Nasıl çalışqanını kör
about-private-browsing-note = Hususiy Kezinüv<strong>sizni İnternet üzerinde anonim yapmaz</strong>. İşbergeniñiz yaki İnternet hızmeti teminatçıñız kene de ziyaret etkeniñiz saifeni bilebilir.
