...
profiles-cannot-set-as-default-title = Ögbelgileme tesbit etilalmay
profiles-cannot-set-as-default-message = { -brand-short-name } içün ögbelgilengen profil deñiştirilalmay.
profiles-yes = ebet
profiles-no = hayır
