...
autofill-clear-form-label = Avto-toldur Formasını Temizle
...
autofill-phishing-warningmessage-extracategory = { $categories } te avtotoldurılır
# Variation when all are in the same category.
# Variables:
#   $categories - one or more of the categories
autofill-phishing-warningmessage = { $categories } avtotoldurılır
# Used in autofill drop down suggestion to indicate what other categories Form Autofill will attempt to fill.
autofill-category-address = adres
autofill-category-name = isim
