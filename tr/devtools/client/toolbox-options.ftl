...
options-netmonitor-body-limit-label = Maksimum istek ve yanıt gövdesi büyüklüğü (Sınırsız için 0 yapın):
options-netmonitor-body-limit-tooltip =
    .title = Belirtilen büyüklüğü aşan istek veya yanıt gövdeleri ağ izleyicisinde görüntülendiğinde veya indirildiğinde kısaltılacaktır. Sınırlama olmaması için 0 olarak ayarlayın.
