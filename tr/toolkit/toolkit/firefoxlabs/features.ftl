...
experimental-features-semantic-history-search-description = Doğal dil anlamaya dayalı yerel bir machine öğrenimi modeli kullanılarak, { -brand-product-name } adres çubuğunda geçmişe dayalı arama önerileri gösterilir. <a data-l10n-name="connect">Görüş bildirin</a>
