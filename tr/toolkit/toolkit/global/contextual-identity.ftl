...
user-context-shopping-panel-item = Alışveriş
    .accesskey = A
user-context-new-tab-panel-item = Yeni sekme
    .accesskey = Y
user-context-add-container-panel-item = Yeni kapsayıcı ekle
    .accesskey = Y
user-context-manage-containers-panel-item = Kapsayıcıları yönet
    .accesskey = K
