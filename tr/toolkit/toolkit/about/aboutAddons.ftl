...
details-notification-softblocked-extension-disabled =
    .message = Bu uzantı Mozilla’nın politikalarını ihlal ettiği için devre dışı bırakıldı. Uzantıyı etkinleştirebilirsiniz ama bu riskli olabilir.
...
details-notification-softblocked-other-disabled =
    .message = Bu eklenti Mozilla’nın politikalarını ihlal ettiği için devre dışı bırakıldı. Uzantıyı etkinleştirebilirsiniz ama bu riskli olabilir.
