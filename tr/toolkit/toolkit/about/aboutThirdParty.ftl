...
third-party-button-to-unblock-disabled =
    .title = Şu anda engelli olarak işaretlenmiş ama bu { -brand-short-name } oturumunda engelleme listesi devre dışı. Engeli kaldırmak için tıklayın.
    .aria-label = Şu anda engelli olarak işaretlenmiş ama bu { -brand-short-name } oturumunda engelleme listesi devre dışı. Engeli kaldırmak için tıklayın.
