...
url-classifier-content-classifier-loading-url-enabled = Loading URL’i etkinleştir
...
url-classifier-content-classifier-top-window-url-enabled = Top-window URL’i etkinleştir
...
url-classifier-content-classifier-probes = Testler
...
url-classifier-content-classifier-force-third-party = Üst çerçeveye göre üçüncü taraf olarak değerlendir
...
url-classifier-content-classifier-probe-blocking-btn = Engellemeyi test et
# Button: run the probe that reports whether the request would be annotated
# (labeled) as tracking without being blocked.
url-classifier-content-classifier-probe-annotate-btn = Etiketlemeyi test et
# Button: run the probe against a single classifier feature chosen in the
# adjacent dropdown.
url-classifier-content-classifier-probe-feature-btn = Özelliği test et
...
url-classifier-content-classifier-verdict-hit = Eşleşti
...
url-classifier-content-classifier-verdict-miss = Eşleşmedi
