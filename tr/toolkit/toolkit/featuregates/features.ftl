...
experimental-features-ime-search-description = IME (Giriş Yöntemi Düzenleyicisi), standart bir klavye kullanarak karmaşık sembolleri (ör. Doğu Asya veya Hint yazı dillerinde kullanılanlar) girmenize olanak tanıyan bir araçtır. Bu deneyi etkinleştirdiğinizde, metin girmek için IME’yi kullanırken adres çubuğu paneli açık kalarak arama sonuçlarını ve önerileri gösterecektir. Unutmayın ki IME, adres çubuğu sonuçlarını örten bir panel görüntüleyebilir. Bu nedenle bu tercih, yalnızca böyle bir panel kullanmayan IME’ler için önerilir.
