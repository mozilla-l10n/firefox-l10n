...
certmgr-server = Bu girdiler, sunucu sertifikası hata istisnalarını tanımlar
...
certmgr-add-exception =
    ...
    .accesskey = e
exception-mgr =
    .title = Güvenlik istisnası ekle
exception-mgr-extra-button =
    .label = Güvenlik istisnasını doğrula
    .accesskey = d
...
exception-mgr-permanent =
    .label = Bu istisnayı kalıcı olarak kaydet
    .accesskey = k
pk11-bad-password = Girilen parola yanlış.
pkcs12-decode-err = Dosya çözülemedi. Ya dosya PKCS #12 biçiminde değil, ya bozuk ya da girdiğiniz parola yanlış.
pkcs12-unknown-err-restore = PKCS #12 dosyası bilinmeyen sebeplerden dolayı geri yüklenemedi.
...
delete-ssl-override-title =
    .title = Sunucu sertifikası istisnasını sil
delete-ssl-override-confirm = Bu sunucu istisnasını silmek istediğinizden emin misiniz?
delete-ssl-override-impact = Bir sunucu istisnasını silerseniz o sunucu için olağan güvenlik kontrolleri geri yüklenir ve sunucunun geçerli bir sertifika kullanması zorunlu olur.
...
add-exception-valid-long = Bu site geçerli ve doğrulanmış tanımlama bilgisi sunuyor.  İstisna eklemeye gerek yok.
...
cert-format-base64-chain = Zincirli X.509 sertifikası (PEM)
cert-format-der = X.509 sertifikası (DER)
cert-format-pkcs7 = X.509 sertifikası (PKCS#7)
cert-format-pkcs7-chain = Zincirli X.509 sertifikası (PKCS#7)
