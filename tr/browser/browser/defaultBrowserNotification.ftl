...
default-browser-prompt-message-pin-msix = { -brand-short-name } tarayıcınızı varsayılan tarayıcınız yapıp görev çubuğuna ve başlat menüsüne sabitleyebilirsiniz.
