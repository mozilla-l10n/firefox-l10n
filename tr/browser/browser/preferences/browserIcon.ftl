...
appearance-browser-icon-entry-group =
    ...
    .description = Görev çubuğunuz, masaüstünüz ve Başlat menünüz için özel bir simge seçin.
appearance-browser-icon-button =
    .label = Tarayıcı simgesini değiştir
...
appearance-browser-icon-momo =
    .label = Momo
    .description = İllüstrasyon: @heyheymomodraws
