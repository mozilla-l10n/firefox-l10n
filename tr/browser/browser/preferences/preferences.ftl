...
permissions-addon-exceptions2 =
    .label = Hangi sitelerin uzantı yükleyebileceğini seçin
    .accesskey = H
...
nimbus-rollouts-enabled-description = Değişiklikler uzaktan uygulanacaktır.
...
preferences-ai-controls-pdfjs-control =
    ...
    .description = PDF’lere resim eklendiğinizde bu özellik, resimleri daha erişilebilir kılmak için onlara açıklama ekler.
preferences-ai-controls-tab-group-suggestions-control =
    .label = Sekme grubu önerileri
    .description = Sekmelerinizi adlandırmak ve organize etmek için öneriler alabilisiniz.
