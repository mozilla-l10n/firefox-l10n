...
tls-key-logging-notice-nav =
    .label = Şifrelenmiş trafiğiniz bir uygulama veya hizmet tarafından görülebilir.
category-list =
...
browsing-use-full-keyboard-navigation =
    .label = Form alanları ve bağlantılar arasında geçiş yapmak için sekme tuşunu kullan
    .accesskey = F
browsing-search-on-start-typing =
    .label = Yazmaya başladığımda metin araması yap
    .accesskey = z
settings-keyboard-shortcuts-group =
    .description = { -brand-short-name } tarayıcısında gezinmeyi ve işlem yapmayı kolaylaştırın.
...
containers-external-links-check =
    .label = Harici uygulamalardan açılan bağlantılar için kapsayıcı kullanma
    .accesskey = a
...
containers-sites-card-header =
    .description = Özel kapsayıcı seçtiğiniz siteleri her açtığınızda { -brand-short-name } bu kapsayıcıyı kullanır.
    .label = Siteye özel kapsayıcılar
...
autofill-personal-info-checkbox-message =
    .label = Kişisel bilgileri kaydet ve otomatik doldur
autofill-personal-info-manage-button =
    .label = Kişisel bilgileri yönet
...
passports-edit-passport-button-label =
    .aria-label = Düzenle
passports-delete-passport-prompt-title = Bu pasaport silinsin mi?
passports-delete-passport-prompt-confirm-button = Sil
passports-delete-passport-prompt-cancel-button = Vazgeç
autofill-passports-add-button = Yeni pasaport ekle
autofill-personal-info-manage-title =
    .heading = Kişisel bilgileri yönet
# This message is displayed when no passports are stored in Firefox
passports-no-passports-stored-message =
    .label = Hiç pasaport eklenmedi
...
space-alert-over-5gb-settings-button =
    .label = Ayarları aç
    .accesskey = A
space-alert-over-5gb-message2 = <strong>{ -brand-short-name } tarafından kullanılabilen disk alanı azaldı.</strong> Site içerikleri düzgün görüntülenemeyebilir. Depolanan verileri Ayarlar > Gizlilik ve Güvenlik > Çerezler ve site verileri kısmından temizleyebilirsiniz.
space-alert-under-5gb-message2 = <strong>{ -brand-short-name } tarafından kullanılabilen disk alanı azaldı.</strong> Site içerikleri düzgün görüntülenemeyebilir. Daha iyi bir gezinti deneyimi için disk kullanımınızı iyileştirmek isterseniz “Daha fazla bilgi al” sayfasını ziyaret edin.
certs-description3 =
...
appearance-window-density-group =
    .description = Araç çubuğu, sekmeler ve kenar çubuğu gibi pencere öğelerinin etrafındaki boşlukları ayarlayın.
    .label = Pencere yoğunluğu
appearance-window-density-radio-group =
    .aria-label = Pencere yoğunluğu
appearance-window-density-automatic =
    .description = Standart, kompakt veya dokunmatik yoğunluğu otomatik olarak uygulanır
    .label = Otomatik (varsayılan)
appearance-window-density-automatic-no-touch =
    .description = Standart ve kompakt yoğunluk otomatik olarak uygulanır
    .label = Otomatik (varsayılan)
appearance-window-density-standard =
    .description = Çoğu ekran için dengeli yoğunluk ayarı
    .label = Standart
...
appearance-window-density-compact =
    .description = Küçük ekranlar için daraltılmış boşluklar
    .label = Kompakt
appearance-window-density-touch =
    .description = Dokunmatik ekranlar için optimize edilmiş büyük pencere öğeleri ve tıklama hedefleri
    .label = Dokunmatik
...
preferences-ai-controls-on-device-group =
    .description = Bu özellikleri kullanırsanız cihazınıza indirilen küçük yapay zekâ modelleri kullanılır. Bu yaklaşım gizliliğinizin korunmasını sağlar.
...
preferences-ai-controls-speech-recognition-control =
    .description = Konuşmayı bu cihazda metne dönüştür.
    .label = Konuşma tanıma
preferences-ai-controls-sidebar-chatbot-group-3 =
    .description = Web’de gezinirken sohbet botunuz gözünüzün önünde olsun. Seçtiğiniz sağlayıcıyı istediğiniz zaman değiştirebilirsiniz.
    .label = Kenar çubuğunda yapay zekâ sohbet botu sağlayıcıları
preferences-ai-controls-sidebar-chatbot-group-2 =
    .description = Gezinirken bir sohbet botunu gözünüzün önünde tutun. Anthropic Claude, ChatGPT, Copilot, Google Gemini ve Mistral Vibe arasından seçim yapabilirsiniz.
    .label = Kenar çubuğunda yapay zekâ sohbet botu sağlayıcıları
...
preferences-etp-level-custom =
    .description = Hangi korumaları açmak veya kapatmak istediğinizi seçin.
    .label = Özel
preferences-etp-status-advanced-button =
    .label = Gelişmiş ayarlar
preferences-etp-tracker-count-enabled =
    .label = Engellenen takip kodu sayısını adres çubuğunda göster
...
preferences-etp-advanced-settings-group =
    .description = Siteler internette sizi takip etmek ve rahatsız edici reklamlar göstermek için takip kodlarını kullanır. { -brand-short-name }, internette gezinirken sizi korur ve çoğu takip kodunu otomatik olarak engelleyerek dijital izinizin kontrolünü size verir.
    .label = Gelişmiş ayarlar
...
preferences-etp-custom-cookie-behavior-block-cross-site-tracking-cookies =
    .label = Siteler arası takip çerezlerini engelle
...
security-privacy-issue-warning-doh2 =
    .description = HTTPS üzerinden DNS, ziyaret ettiğiniz siteleri ağ sağlayıcınızdan gizlemenize yardımcı olur.
    .label = HTTPS üzerinden DNS devre dışı
security-privacy-issue-warning-ech2 =
    .description = Encrypted Client Hello, ziyaret ettiğiniz siteleri ağ sağlayıcınızdan gizlemenize yardımcı olur.
