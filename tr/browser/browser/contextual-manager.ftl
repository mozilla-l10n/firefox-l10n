...
contextual-manager-passwords-origin-field-description = Bu siteye giriş yapacağınız tam adresi girin.
contextual-manager-passwords-username-field =
    .label = Kullanıcı adı
contextual-manager-passwords-username-field-description = Giriş yapmak için kullandığınız kullanıcı adını, e-posta adresini veya hesap numarasını girin.
contextual-manager-passwords-password-field =
    .label = Parola
contextual-manager-passwords-password-field-description = Bu hesaba giriş yapmak için kullandığınız parolayı girin.
