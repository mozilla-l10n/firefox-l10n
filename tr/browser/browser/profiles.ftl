...
original-profile-name = Başlangıç profili
...
edit-profile-page-desktop-shortcut-toggle-2 =
    .label = Masaüstü kısayolu oluştur
edit-profile-page-desktop-shortcut-header = Masaüstü kısayolu oluştur
edit-profile-page-desktop-shortcut-toggle =
    .aria-label = Masaüstü kısayolu oluştur
...
restored-profile-page-learn-more = Daha fazla bilgi al
