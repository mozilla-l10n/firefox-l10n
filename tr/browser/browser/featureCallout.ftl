...
callout-firefox-view-tab-pickup-title = Sekme taşıma özelliğiyle cihazlarınız arasında geçiş yapın
...
tab-groups-2026-onboarding-callout-title = Sekme gruplarıyla dağınıklığı azaltın
...
tab-groups-2026-onboarding-callout-subtitle = Sekmelerinizi göreve veya konuya göre gruplayın. Yeni sekmeleri sürükleyerek ekleyebilirsiniz.
...
tab-groups-2026-onboarding-cta-button = Grup oluştur
...
sidebar-callout-survey-dissatisfied-2 = Memnun değilim
sidebar-callout-survey-very-dissatisfied-2 = Hiç memnun değilim
...
sidebar-callout-survey-features-question = Aşağıda bazı potansiyel kenar çubuğu özelliklerini görüyorsunuz. Hangisi { -brand-short-name } tarayıcınızda verimliliğinizi en çok artırır?
sidebar-callout-survey-split-view = İstediğiniz iki web sitesini yan yana bölünmüş görünümde görüntüleme
sidebar-callout-survey-keep-website-open = İnternette gezinirken e-posta veya takvim gibi bir web sitesini kenar çubuğunda açık tutma
sidebar-callout-survey-saved-websites-2 = Yer imlerine hızlı erişim
...
splitview-onboarding-callout-title-1 = Ayrık görünüm: Aynı anda çok iş yapmanın daha iyi yolu
