...
newtab-topic-navigation-more-button = Daha fazla
...
newtab-shortcuts-highlight-title = Favori kısayollarınız parmaklarınızın ucunda
...
newtab-widget-section-show-widgets =
    .aria-label = Araçlar bölümünü göster
...
newtab-clock-city-us-chicago = Şikago
...
newtab-clock-city-de-munich = Münih
...
newtab-clock-city-pl-warsaw = Varşova
...
newtab-clock-city-ch-zurich = Zürih
newtab-clock-city-at-vienna = Viyana
newtab-clock-city-cz-prague = Prag
newtab-clock-city-ar-buenos-aires = Buenos Aires
newtab-clock-city-gr-athens = Atina
newtab-clock-city-hu-budapest = Budapeşte
newtab-clock-city-be-brussels = Brüksel
...
newtab-clock-city-eg-cairo = Kahire
newtab-clock-city-se-stockholm = Stokholm
newtab-clock-city-ro-bucharest = Bükreş
...
newtab-clock-city-pt-lisbon = Lizbon
newtab-clock-city-ir-tehran = Tahran
newtab-clock-city-bd-dhaka = Dakka
newtab-clock-city-ec-guayaquil = Guayaquil
newtab-clock-city-vn-ho-chi-minh-city = Ho Chi Minh Kenti
