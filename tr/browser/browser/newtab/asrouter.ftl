...
launch-on-login-autostart-infobar-message = { -brand-short-name } artık Windows’ta oturum açtığınızda başlatılıyor. Bunu istediğiniz zaman ayarlardan değiştirebilirsiniz.
launch-on-login-autostart-infobar-keep-button = Böyle kalsın
    .accesskey = B
launch-on-login-autostart-infobar-turn-off-button = Kapat
    .accesskey = K
...
launch-on-login-spotlight-restore-checkbox = Önceki pencereleri ve sekmeleri aç
launch-on-login-spotlight-primary-button = { -brand-short-name } tarayıcısını kaydet ve kapat
...
windows-10-eos-global-infobar-primary-button = Yedeklemeyi etkinleştir
    .accesskey = Y
windows-10-eos-global-infobar-learn-more-link = Daha fazla bilgi al
    .accessKey = D
...
set-default-menu-message-row-layout-title = { -brand-short-name } ana tarayıcınız olsun
set-default-menu-message-row-layout-title-variant = { -brand-short-name }’u varsayılan tarayıcım yap
...
lapsed-user-toast-title = { -brand-product-name } hâlâ sizinle
...
refresh-unused-profile-infobar-message = Bir süredir { -brand-short-name } tarayıcısını çalıştırmamışsınız. Taze ve yeni bir başlangıç yapmak için tarayıcıyı temizlemek ister misiniz? Bu arada, yeniden hoş geldiniz!
refresh-reinstalled-profile-infobar-message = { -brand-short-name } tarayıcısını yeniden yüklemişsiniz. Yepyeni bir başlangıç için eski verilerinizi silelim mi?
refresh-profile-infobar-button = { -brand-short-name } tarayıcısını yenile…
    .accesskey = e
