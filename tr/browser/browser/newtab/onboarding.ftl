...
onboarding-checklist-remove-2 = Kontrol listesini kaldır
...
onboarding-refresh-sync-title = İstediğiniz yere gidin, istediğiniz şeyi eşitleyin.
...
smartwindow-sidebar-auto-open-callout-body = Ne zaman ihtiyacınız olursa yeniden açabilirsiniz.
