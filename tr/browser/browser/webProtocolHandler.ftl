...
protocolhandler-mailto-os-handler-notificationbox = E-posta bağlantılarını açmak için her zaman { -brand-short-name } kullanılsın mı?
...
protocolhandler-mailto-handler-yes-button = Varsayılan yap
protocolhandler-mailto-handler-no-button = Şimdi değil
