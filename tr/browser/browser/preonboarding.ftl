...
preonboarding-privacy-notice-header-button-title = Gizlilik Bildirimimizi okuyun
...
preonboarding-checklist-interaction-data-label = Teknik verileri ve etkileşim verilerini { -vendor-short-name }’ya gönder
