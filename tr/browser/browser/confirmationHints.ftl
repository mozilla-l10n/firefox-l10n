...
confirmation-hint-login-removed = Hesap silindi!
...
confirmation-hint-passport-created = Pasaport kaydedildi
confirmation-hint-passport-updated = Pasaport güncellendi
...
confirmation-hint-extensions-button-hidden = Menüye taşındı
