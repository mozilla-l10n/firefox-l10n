...
report-broken-site-panel-intro-text = Raporunuz { -brand-product-name } tarayıcısındaki sorunları anlayıp düzeltmemize, böylece tarayıcıyı herkes için iyileştirmemize yardımcı oluyor.
