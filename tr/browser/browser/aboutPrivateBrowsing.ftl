...
about-private-browsing-info-downloads = indirdiğiniz dosyalar
private-browsing-title = Gizli Gezinti
about-private-browsing-info-saved = { -brand-short-name } şunları kaydetmeye <strong>devam eder</strong>:
...
tracking-protection-start-tour = Nasıl çalıştığını görün
about-private-browsing-note = Gizli Gezinti sizi internette <strong>anonim yapmaz.</strong> İşvereniniz veya internet servis sağlayıcınız hâlâ ziyaret ettiğiniz sayfaları takip edebilir.
