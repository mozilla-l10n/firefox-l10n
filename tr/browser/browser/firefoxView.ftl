...
firefoxview-syncedtabs-synctabs-header-2 = Sekme eşitleme kapalı
firefoxview-syncedtabs-synctabs-description-2 = Diğer cihazlardaki tüm sekmelerinize ulaşmak için eşitlemeyi yeniden açın.
...
firefoxview-tabpickup-network-offline-header-2 = { -brand-short-name } şu anda bağlantı kuramıyor
firefoxview-tabpickup-network-offline-description-2 = Çevrimdışı olabilirsiniz veya bağlantıyı engelleyen bir şey olabilir.
