...
qrcode-save-button =
    .label = Kaydet
qrcode-save-success =
    .message = QR kodu kaydedildi.
qrcode-save-error =
    .message = QR kodu kaydedilemedi.
qrcode-save-title = QR kodunu kaydet
qrcode-save-filter-png = PNG resmi
qrcode-save-filename = qrkodu.png
