...
safeb-blocked-addon-page-learn-more3 = <a data-l10n-name='firefox_support_harmful_addons'>{ -brand-short-name } tarayıcısının zararlı eklenti koruması hakkında daha fazla bilgi alın</a>.
