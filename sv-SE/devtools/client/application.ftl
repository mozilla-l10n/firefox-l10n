...
serviceworker-worker-updated = Uppdaterad <time>{ DATETIME($date, day: "numeric", hour: "numeric", minute: "numeric", month: "long", second: "numeric", year: "numeric") }</time>
...
sidebar-item-session-history = Sessionshistorik
    .alt = Ikon för sessionshistorik
