...
accessibility-text-label-issue-fieldset = <code>fieldset</code>-element måste vara märkta. <a>Läs mer</a>
accessibility-text-label-issue-fieldset-legend = Använd <code>legend</code>-element för att märka <span>fieldset</span>-element <a>Läs mer</a>
accessibility-text-label-issue-form = Form-element måste vara märkta. <a>Läs mer</a>
accessibility-text-label-issue-frame = <code>frame</code>-element måste vara märkta. <a>Läs mer</a>
...
accessibility-text-label-issue-iframe = Använd <code>title</code>-attributet för att beskriva innehållet i <span>iframe</span>. <a>Läs mer</a>
accessibility-text-label-issue-image = Innehåll med bilder måste vara markerade. <a>Läs mer</a>
accessibility-text-label-issue-interactive = Interaktiva element måste vara märkta. <a>Läs mer</a>
accessibility-text-label-issue-optgroup-label = Använd <code>label</code>-attributet för att märka <span>optgroup</span>-element. <a>Läs mer</a>
accessibility-text-label-issue-toolbar = Verktygsfält måste vara märkta när det finns mer än ett verktygsfält. <a>Läs mer</a>
