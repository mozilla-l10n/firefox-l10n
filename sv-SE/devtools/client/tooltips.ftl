...
inactive-css-not-absolutely-positioned-item = <strong>{ $property }</strong> har ingen effekt på det här elementet eftersom det inte är ett absolut positionerat element.
inactive-css-no-default-anchor = <strong>{ $property }</strong> har ingen effekt på det här elementet eftersom det inte har ett standardankareelement.
...
inactive-css-not-block-container = <strong>{ $property }</strong> har ingen effekt på det här elementet eftersom det endast gäller för blockcontainerelement.
inactive-css-not-block-flex-grid-container = <strong>{ $property }</strong> har ingen effekt på det här elementet eftersom det endast gäller block, flex och grid containerelement.
...
inactive-css-not-absolutely-positioned-item-fix = Försök lägga till <strong>position:absolute</strong> till elementet. { learn-more }
inactive-css-no-default-anchor-fix = Försök att lägga till <strong>position-anchor</strong> med ett giltigt ankarnamn. { learn-more }
...
inactive-css-not-block-container-fix = Testa att lägga till <strong>display:block</strong>, <strong>display:inline-block</strong> eller <strong>display:flow-root</strong>. { learn-more }
inactive-css-not-block-flex-grid-container-fix = Försök lägga till <strong>display:block</strong>, <strong>display:inline-block</strong>, <strong>display:flex</strong>, <strong>display:inline-flex</strong>, <strong>display:grid</strong>, <strong>display:inline-grid</strong> eller <strong>display:flow-root</strong>. { learn-more }
...
css-selector-warning-sibling-combinator-after-scope = Syskonselektorer efter <strong>:scope</strong> kommer aldrig att matcha någonting
...
css-selector-container-query-condition-no-container = Ingen behållare ‘{ $name }’ hittades
