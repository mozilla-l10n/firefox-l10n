...
colorpicker-tooltip-eyedropper-title = Välj färg på sidan
...
colorpicker-tooltip-color-name-title = Närmast till: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Nyans
...
# each other.
inspector-split-orientation-stacked = Staplad
