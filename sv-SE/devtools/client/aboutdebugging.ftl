...
about-debugging-sidebar-runtime-item-waiting-for-runtime = Väntar på runtime...
...
# runtimes.
about-debugging-runtime-profile-button = Profil runtime
...
about-debugging-runtime-version-too-old = Den anslutna runtime har en gammal version ({ $runtimeVersion }). Den minsta stödda versionen är ({ $minVersion }). Det här konfigurationen stöds inte och kan göra att DevTools misslyckas. Vänligen uppdatera den anslutna runtime. <a>Felsökning</a>
...
# { $runtimeVersion } is the version of the remote runtime (for instance "67.0a1")
about-debugging-runtime-version-too-old-67-debugger = Felsökningspanelen kanske inte fungerar med den anslutna runtime. Vänligen använd Firefox { $runtimeVersion } om du behöver använda felsökaren med den här runtime.
...
about-debugging-runtime-version-too-recent = Den anslutna runtime är senare ({ $runtimeVersion }, buildID { $runtimeID }) än ditt { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Det här konfigurationen stöds inte och kan göra att DevTools misslyckas. Vänligen uppdatera Firefox. <a>Felsökning</a>
...
about-debugging-profiler-dialog-title = Prestanda profiler
...
about-debugging-main-process-description = Huvudprocess för mål-runtime
