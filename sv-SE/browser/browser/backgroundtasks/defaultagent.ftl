...
default-browser-notification-privacy-header-text = Stanna med { -brand-short-name }?
default-browser-notification-privacy-body-text = Din standardwebbläsare ändrad. Kom tillbaka till { -brand-short-name } för inbyggd sekretess och skydd.
...
default-browser-notification-privacy-no-button-text = Nej tack
