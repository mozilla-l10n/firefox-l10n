...
fxa-menu-message-sync-devices-secondary-text = Få direkt din information — som bokmärken och lösenord — överallt där du använder { -brand-short-name }.
...
fxa-menu-message-backup-sync-secondary-text = Sync säkerhetskopierar det mesta av din data så att du kan komma åt den överallt där du använder { -brand-short-name }.
