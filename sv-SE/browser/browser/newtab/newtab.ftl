...
newtab-new-user-custom-wallpaper-subtitle = Få varje ny flik att kännas som ett hemma med egna bakgrundsbilder och färger.
newtab-new-user-custom-wallpaper-cta = Testa på en gång
