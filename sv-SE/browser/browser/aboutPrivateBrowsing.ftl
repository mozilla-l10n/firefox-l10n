...
about-private-browsing-nova-info-subheader2 = Vi kommer att radera varje sökning och inloggning när du stänger alla dina privata fönster. { -brand-short-name }:s inbyggda skydd finns här också, som att blockera spårare.
