...
extension-default-theme-description2 = En balanserad, bekant grålila för ett klassiskt { -brand-product-name }-utseende.
...
extension-nova-spark-name = Gnista
...
extension-nova-flare-name = Bloss
