...
identity-credential-policy-description = Att logga in på { $host } med ett { $provider }-konto omfattas av deras <label data-l10n-name="privacy-rl">sekretesspolicy</label> och <label data-l10n-name="tos-url">användarvillkor</label>.
