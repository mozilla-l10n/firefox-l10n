...
login-status-advisory-title = Du är utloggad. Klicka på kontoikonen för att logga in.

## Bookmarks toolbar callout strings

bookmarks-toolbar-callout-1-title = Vill du lägga till den här webbplatsen i ditt bokmärkesfält?
...
bookmarks-toolbar-callout-2b-title = Vill du behålla bokmärkesfältet öppet?
...
bookmarks-toolbar-callout-2b-primary-button-label = Behåll öppet
# Reverts the bookmarks toolbar to the default setting
bookmarks-toolbar-callout-2b-secondary-button-label = Nej tack
...
taskbar-tabs-value-prop-callout-title-v3 = Fäst dina favoritplatser i aktivitetsfältet
taskbar-tabs-value-prop-callout-subtitle-v3 = Starta en webbplats som en app i ett strömlinjeformat fönster som skyddas av { -brand-short-name }.
...
vertical-tabs-callout-2-title = Har du många flikar öppna? Prova vertikala flikar.
...
sidebar-callout-survey-dissatisfied-2 = Missnöjd
sidebar-callout-survey-very-dissatisfied-2 = Väldigt missnöjd
...
sidebar-callout-survey-saved-websites-2 = Snabb åtkomst till dina bokmärken
