...
tls-key-logging-notice-nav =
    .label = En app eller tjänst kan se din krypterade trafik.
category-list =
...
settings-keyboard-shortcuts-group =
    .description = Kontrollera hur du rör dig och interagerar med { -brand-short-name }.
...
autofill-personal-info-checkbox-message =
    .label = Spara och fyll i personlig information automatiskt
autofill-personal-info-manage-button =
    .label = Hantera personlig information
...
preferences-ai-controls-speech-recognition-control =
    .description = Transkribera tal lokalt.
    .label = Taligenkänning
preferences-ai-controls-sidebar-chatbot-group-3 =
    .description = Ha en chatbot i närheten medan du surfar. Välj mellan flera leverantörer och byt när som helst.
    .label = AI-chatbot-leverantörer i sidofältet
preferences-ai-controls-sidebar-chatbot-group-2 =
    .description = Ha en chatbot i närheten medan du surfar. Välj mellan Anthropic Claude, ChatGPT, Copilot, Google Gemini och Mistral Vibe.
    .label = AI-chatbot-leverantörer i sidofältet
...
preferences-ai-controls-block-confirmation-speech-recognition = Taligenkänning
...
preferences-etp-tracker-count-enabled =
    .label = Visa blockerade spårare i adressfältet
...
preferences-etp-custom-cookie-behavior-block-cross-site-tracking-cookies =
    .label = Blockera globala spårningskakor
...
security-privacy-issue-warning-doh2 =
    .description = DNS över HTTPS hjälper till att dölja vilka webbplatser du håller på att besöka från din nätleverantör.
    .label = DNS över HTTPS är inaktiverad
security-privacy-issue-warning-ech2 =
    .description = Krypterad klient Hello hjälper till att dölja vilka webbplatser du håller på att besöka från din nätleverantör.
