...
pane-downloads-title = Filhämtningar
pane-downloads =
...
preferences-text-zoom-override-warning2 =
    .message = Om Zooma endast text är på och din standardzoom inte är 100 %, kanske vissa webbplatser inte visar innehållet korrekt.
