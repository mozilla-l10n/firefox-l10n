...
backup-multi-profile-warning-message =
    .message = För att se till att den här ändringen ingår i dina säkerhetskopior, öppna varje profil och välj "Säkerhetskopiera nu" i inställningarna.
...
nimbus-rollouts-enabled-description = Ändringar kommer att tillämpas på distans.
