...
content-blocking-etp-warning-description = Blockering av spårare kan påverka funktionaliteten på vissa webbplatser. Ladda om en sida med trackers för att ladda allt innehåll.
