...
content-blocking-baseline-exceptions =
    .label = Tillåt { -brand-short-name } att automatiskt tillämpa undantag som krävs för att undvika större brott på webbplatsen.
content-blocking-convenience-exceptions =
    .label = Applicera också automatiskt undantag som bara krävs för att åtgärda mindre problem och göra bekvämlighetsfunktioner tillgängliga.
