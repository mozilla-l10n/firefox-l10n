...
appearance-window-density-automatic =
    ...
    .description = Standard, compact eller touch-avstånd tillämpas automatiskt
appearance-window-density-automatic-no-touch =
    .label = Automatisk (standard)
    .description = Standard eller kompakt avstånd tillämpas automatiskt
...
appearance-window-density-auto-touch-mode =
    .label = Använd pekutrymme för surfplattasläge
