...
appearance-browser-icon-entry-group =
    .description = Välj en egen ikon för aktivitetsfältet, skrivbordet och startmenyn.
    .label = Webbläsarikonen
appearance-browser-icon-button =
    .label = Ändra webbläsarikon
...
appearance-browser-icon-unlocked =
    .message = Du låste upp alla bonusikoner!
...
appearance-browser-icon-momo =
    .description = Skapad av @heyheymomomodraws
    .label = Momo
