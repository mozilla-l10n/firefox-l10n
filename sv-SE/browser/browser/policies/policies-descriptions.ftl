...
policy-GoToIntranetSiteForSingleWordEntryInAddressBar = Använd direkt intranätnavigation istället för att söka när ett enstaka ord skrivs i adressfältet.
