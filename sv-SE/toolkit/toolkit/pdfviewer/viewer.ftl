...
pdfjs-editor-alt-text-settings-editor-title = Alt textredigerare
pdfjs-editor-alt-text-settings-show-dialog-button-label = Visa redigeraren för alternativ text direkt när du lägger till en bild
