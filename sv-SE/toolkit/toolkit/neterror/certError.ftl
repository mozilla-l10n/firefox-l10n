...
# Variables:
#   $hostname (string) - Hostname of the website with cert error.
cert-error-revoked = Webbplatser bevisar sin identitet via certifikat. { -brand-short-name } litar inte på { $hostname } eftersom den använder ett certifikat som har dragits in.
