...
details-notification-hard-blocked-extension =
    .message = Detta tillägg är blockerad för att bryta mot Mozillas policyer och har inaktiverats.
...
details-notification-soft-blocked-extension-disabled =
    .message = Detta tillägg är begränsat för att bryta mot Mozillas policyer och har inaktiverats. Du kan aktivera det, men det kan vara riskabelt.
