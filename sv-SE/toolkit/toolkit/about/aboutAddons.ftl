...
details-notification-softblocked-extension-disabled =
    .message = Det här tillägget bryter mot Mozillas policyer och har inaktiverats. Du kan aktivera det, men det kan vara riskabelt.
details-notification-softblocked-extension-enabled =
    .message = Detta tillägg bryter mot Mozillas policyer. Att använda det kan vara riskabelt.
details-notification-softblocked-other-disabled =
    .message = Detta tillägg bryter mot Mozillas policyer och har inaktiverats. Du kan aktivera det, men det kan vara riskabelt.
