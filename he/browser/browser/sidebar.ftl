...
sidebar-resize-splitter =
    .aria-label = שינוי גודל של סרגל הצד
...
sidebar-opentabs-preview-heading = לשוניות אחרונות
...
sidebar-pins-promo-text = ניתן לגרור לשוניות חשובות לכאן כדי לשמור אותן בהישג יד
