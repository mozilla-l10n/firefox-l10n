...
browser-shortcut-description = גלישה מהירה ופרטית באינטרנט
# These are the default window titles everywhere except macOS.
# .data-title-default and .data-title-private are used when the web content
# opened has no title:
#
...
identity-description-tls-key-logging-heading = ייתכן שהחיבור שלך אינו פרטי
identity-description-tls-key-logging-message = ייתכן שיישומון או שירות יראו את התעבורה המוצפנת שלך מאתר זה.
...
#                    "11 months ago"
urlbar-result-explanation-last-visited-days-weeks-months-ago = ביקרת לאחרונה { $date }
# This explanation is used when the last-visited date is further in the past.
# The date will be formatted as an absolute date like: "11 May", "11 May 2026"
# Variables:
#   $date (string) - A localized absolute date string
...
urlbar-view-context-menu-open-in-private-window =
    ...
    .accesskey = ר
urlbar-view-context-menu-open-in-tab2 = פתיחה בלשונית חדשה
    .accesskey = ל
urlbar-view-context-menu-open-in-container-tab2 = פתיחה במגירת לשוניות חדשה
    .accesskey = מ
urlbar-view-context-menu-open-in-window2 = פתיחה בחלון חדש
    .accesskey = ח
