...
policy-ClearOnShutdown = מחיקת נתוני גלישה כאשר { -brand-short-name } נסגר.
...
policy-CNSA2KeyAgreementEnabled = הפעלת ההסכמה על המפתח CNSA 2.0 ML-KEM-1024 עבור TLS.
