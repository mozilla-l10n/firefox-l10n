...
contextual-manager-passwords-origin-field-description = יש להכניס את הכתובת המדויקת אליה נכנסים כדי להתחבר לאתר.
contextual-manager-passwords-username-field =
    .label = שם משתמש
contextual-manager-passwords-username-field-description = יש להכניס את שם המשתמש, כתובת הדוא״ל או מספר החשבון שבו משתמשים כדי להתחבר.
contextual-manager-passwords-password-field =
    .label = ססמה
contextual-manager-passwords-password-field-description = יש להכניס את הססמה שבה משתמשים כדי להתחבר לחשבון זה.
