...
genai-settings-chat-lechat-links-2 = בחירה ב־Mistral Vibe מהווה הסכמה ל<a data-l10n-name="link1">תנאי השירות</a> ול<a data-l10n-name="link2">מדיניות הפרטיות</a> של Mistral AI.
...
genai-shortcut-button-3 =
    .aria-label = שאלה לגבי הטקסט הזה
    .tooltiptext = שאלה לגבי הטקסט הזה
...
genai-shortcut-search-button =
    .aria-label = חיפוש ב־{ $engine } אחר ״{ $selection }״
    .tooltiptext = חיפוש ב־{ $engine } אחר ״{ $selection }״
genai-shortcut-copy-button =
    .aria-label = העתקת הטקסט הנבחר
    .tooltiptext = העתקת הטקסט הנבחר
