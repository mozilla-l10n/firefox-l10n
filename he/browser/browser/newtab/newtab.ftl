...
newtab-stocks-list-markets = שווקים
    .label = שווקים
...
newtab-stocks-list-watchlist = רשימת מעקב
    .label = רשימת מעקב
...
# Variables:
#   $name (String) - the fund/ETF name.
newtab-stocks-in-watchlist = ‏{ $name } נמצא ברשימת המעקב שלך
# Announced to screen readers after a stock is added to the watchlist.
# Variables:
#   $name (String) - the fund/ETF name.
newtab-stocks-added-to-watchlist = ‏{ $name } נוסף לרשימת המעקב
# Announced to screen readers after a stock is removed from the watchlist.
# Variables:
#   $name (String) - the fund/ETF name.
newtab-stocks-removed-from-watchlist = ‏{ $name } הוסר מרשימת המעקב
...
newtab-stocks-search-input =
    ...
    .placeholder = חיפוש לפי שם או סמל
...
newtab-stocks-search-no-results = אין תוצאות עבור ״{ $query }״
# Shown while a ticker search is running; also announced to screen readers.
newtab-stocks-search-loading = בטעינה…
# Shown when a ticker search fails to reach the service.
newtab-stocks-search-error = לא ניתן היה לחפש כרגע. נא לנסות שוב מאוחר יותר.
...
newtab-stocks-watchlist-full =
    { $limit ->
        [one] ניתן להוסיף עד { $limit } מניות. יש להסיר מניה כדי להוסיף מניה אחרת.
       *[other] ניתן להוסיף עד { $limit } מניות. יש להסיר מניה כדי להוסיף מניה אחרת.
    }
...
newtab-spaces-tab-stories = סיפורים
newtab-spaces-tab-widgets = ווידג’טים
newtab-spaces-tab-activity = פעילות
...
newtab-topsites-hover-card-header = התרעות מ־{ $site }
...
newtab-carousel-pause =
    .aria-label = השהיית הפעלה אוטומטית
# Button that resumes autoplay on the carousel.
newtab-carousel-play =
    .aria-label = המשך הפעלה אוטומטית
...
newtab-topic-navigation-more-button = עוד
...
newtab-widget-section-show-widgets =
    .aria-label = הצגת מדור הווידג’טים
    .title = הצגת ווידג’טים
...
newtab-nova-customization-callout-header = הוספת הטאץ’ הסופי ל־{ -brand-product-name }
newtab-nova-customization-callout-message = עיינו בערכות עיצוב בהירות או כהות וטפטים שיהפכו את { -brand-product-name } החדש לאישי יותר.
newtab-nova-customization-callout-primary-button =
    .label = בחירת המראה שלך
...
newtab-clock-widget-custom-zone-no-results = אין אזורי זמן תואמים
# Returns from the custom clock form back to the city search.
newtab-clock-widget-custom-back = חזרה
...
newtab-clock-city-us-new-york = ניו יורק
newtab-clock-city-us-los-angeles = לוס אנג'לס
newtab-clock-city-us-chicago = שיקגו
newtab-clock-city-us-san-francisco = סן פרנסיסקו
newtab-clock-city-us-san-diego = סן דייגו
newtab-clock-city-us-dallas = דאלאס
newtab-clock-city-us-houston = יוסטון
newtab-clock-city-us-philadelphia = פילדלפיה
newtab-clock-city-us-atlanta = אטלנטה
newtab-clock-city-us-washington-dc = וושינגטון די. סי.
newtab-clock-city-us-boston = בוסטון
newtab-clock-city-us-miami = מיאמי
newtab-clock-city-us-seattle = סיאטל
newtab-clock-city-us-denver = דנוור
newtab-clock-city-us-honolulu = הונולולו
newtab-clock-city-us-anchorage = אנקורג'
newtab-clock-city-de-berlin = ברלין
newtab-clock-city-de-munich = מינכן
newtab-clock-city-de-frankfurt = פרנקפורט על המיין
newtab-clock-city-de-hamburg = המבורג
newtab-clock-city-fr-paris = פריז
newtab-clock-city-fr-lyon = ליון
newtab-clock-city-fr-marseille = מרסיי
newtab-clock-city-fr-toulouse = טולוז
newtab-clock-city-in-kolkata = קולקטה
newtab-clock-city-in-mumbai = מומבאי
newtab-clock-city-in-delhi = דלהי
newtab-clock-city-in-bangalore = בנגלור
newtab-clock-city-cn-shanghai = שאנגחאי
newtab-clock-city-cn-beijing = בייג'ינג
newtab-clock-city-cn-shenzhen = שנג'ן
newtab-clock-city-br-sao-paulo = סאו פאולו
newtab-clock-city-br-rio-de-janeiro = ריו דה ז'ניירו
newtab-clock-city-br-brasilia = ברזיליה
newtab-clock-city-id-jakarta = ג'קרטה
newtab-clock-city-id-surabaya = סורבאיה
newtab-clock-city-id-makassar = מקאסאר
newtab-clock-city-ca-toronto = טורונטו
newtab-clock-city-ca-montreal = מונטריאול
newtab-clock-city-ca-vancouver = ונקובר
newtab-clock-city-au-sydney = סידני
newtab-clock-city-au-perth = פרת'
newtab-clock-city-au-adelaide = אדלייד
newtab-clock-city-pl-warsaw = ורשה
newtab-clock-city-pl-krakow = קרקוב
newtab-clock-city-jp-tokyo = טוקיו
newtab-clock-city-jp-osaka = אוסקה
newtab-clock-city-mx-mexico-city = מקסיקו סיטי
newtab-clock-city-mx-guadalajara = גוודלחרה
newtab-clock-city-it-rome = רומא
newtab-clock-city-it-milan = מילאנו
newtab-clock-city-ru-moscow = מוסקבה
newtab-clock-city-ru-saint-petersburg = סנקט פטרבורג
newtab-clock-city-gb-london = לונדון
newtab-clock-city-gb-birmingham = ברמינגהאם
newtab-clock-city-es-madrid = מדריד
newtab-clock-city-es-barcelona = ברצלונה
newtab-clock-city-nl-amsterdam = אמסטרדם
newtab-clock-city-ch-zurich = ציריך
newtab-clock-city-at-vienna = וינה
newtab-clock-city-cz-prague = פראג
newtab-clock-city-ar-buenos-aires = בואנוס איירס
newtab-clock-city-gr-athens = אתונה
newtab-clock-city-hu-budapest = בודפשט
newtab-clock-city-be-brussels = בריסל
newtab-clock-city-ua-kyiv = קייב
newtab-clock-city-fi-helsinki = הלסינקי
newtab-clock-city-co-bogota = בוגוטה
newtab-clock-city-ph-manila = מנילה
newtab-clock-city-tr-istanbul = איסטנבול
newtab-clock-city-my-kuala-lumpur = קואלה לומפור
newtab-clock-city-eg-cairo = קהיר
newtab-clock-city-se-stockholm = סטוקהולם
newtab-clock-city-ro-bucharest = בוקרשט
newtab-clock-city-th-bangkok = בנגקוק
newtab-clock-city-ng-lagos = לאגוס
newtab-clock-city-tw-taipei = טאיפיי
newtab-clock-city-za-johannesburg = יוהנסבורג
newtab-clock-city-cl-santiago = סנטיאגו
newtab-clock-city-pk-karachi = קראצ'י
newtab-clock-city-bg-sofia = סופיה
newtab-clock-city-sg-singapore = סינגפור
newtab-clock-city-hk-hong-kong = הונג קונג
newtab-clock-city-sa-riyadh = ריאד
newtab-clock-city-dk-copenhagen = קופנהגן
newtab-clock-city-pe-lima = לימה
newtab-clock-city-ke-nairobi = ניירובי
newtab-clock-city-nz-auckland = אוקלנד
newtab-clock-city-kr-seoul = סיאול
newtab-clock-city-lt-vilnius = וילנה
newtab-clock-city-ie-dublin = דבלין
newtab-clock-city-ae-dubai = דובאי
newtab-clock-city-lv-riga = ריגה
newtab-clock-city-pt-lisbon = ליסבון
newtab-clock-city-ir-tehran = טהראן
newtab-clock-city-bd-dhaka = דאקה
newtab-clock-city-ec-guayaquil = גואיאקיל
newtab-clock-city-vn-ho-chi-minh-city = הו צ׳י מין סיטי
newtab-clock-city-np-kathmandu = קטמנדו
newtab-clock-city-mm-yangon = יאנגון
