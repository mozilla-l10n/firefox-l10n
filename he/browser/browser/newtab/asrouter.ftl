...
welcome-back-spotlight-title = קפיצה חזרה לפרטיות מובנית
welcome-back-spotlight-subtitle = ברוכים השבים לדפדפן העיקרי היחיד הנתמך על־ידי עמותה ללא מטרות רווח. אנו נוקטים צעדים נוספים כדי להגן על הנתונים שלך בכל מקום אליו גולשים.
welcome-back-embedded-import-title = ניתן לייבא את הנתונים שלך וגרום ל־{ -brand-short-name } להרגיש כמו בבית
...
lapsed-user-toast-title = ‏{ -brand-product-name } עדיין מגן עליך
...
refresh-unused-profile-infobar-message = נראה שלא הפעלת את { -brand-short-name } זמן מה. האם ברצונך לנקות אותו לחוויה רעננה, דמוי חדשה? ודרך אגב, ברוך שובך!
refresh-reinstalled-profile-infobar-message = נראה כאילו התקנת מחדש את { -brand-short-name }. שנתאים לך חוויית שימוש רעננה כחדשה?
refresh-profile-infobar-button = ריענון { -brand-short-name }…
    .accesskey = ר
