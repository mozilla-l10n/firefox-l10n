...
fxa-menu-manage-account-subtitle = ניהול חשבון
...
fxa-menu-sign-in-promo-heading = כניסה כדי לסנכרן
fxa-menu-sign-in-promo-message = קבלת הנתונים שלך בכל מקום
...
fxa-menu-signed-out-message-login-failed = נותקת מהחשבון
# Reason shown when the remembered account still needs to verify their email.
fxa-menu-signed-out-message-unverified = סיום ההגדרה
...
fxa-menu-signed-out-title = כניסה כדי לסנכרן
fxa-menu-signed-out-description = נותקת מהחשבון
