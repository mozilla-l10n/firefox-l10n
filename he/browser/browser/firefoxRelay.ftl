...
firefox-relay-and-fxa-popup-notification-first-sentence = ניתן להגן על הדואר הנכנס שלך מפני דואר זבל על־ידי שימוש ב<label data-l10n-name="firefox-relay-learn-more-url">מסכת דוא״ל { -relay-brand-name }</label> חינמית כדי להסתיר את הכתובת האמיתית שלך. הודעות דוא״ל שיתקבלו מ<label data-l10n-name="firefox-fxa-and-relay-offer-domain">אתר זה</label> עדיין יגיעו לדואר הנכנס שלך, אך כתובת הדוא״ל שלך תהיה מוסתרת.
