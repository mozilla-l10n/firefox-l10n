...
fxa-menu-sync-your-data = סנכרון הנתונים שלך
...
appmenu-fxa-sign-in-promo-heading2 = סנכרון הנתונים שלך בכל מקום
appmenu-fxa-sign-in-promo-link = כניסה
...
appmenuitem-share-firefox-title2 = שיתוף { -brand-product-name }
