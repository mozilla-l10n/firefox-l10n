...
neterror-search-cta-intro2 = לא ניתן היה להתחבר לשרת ב־<strong>{ $hostname }</strong>.
...
neterror-search-cta-hint-search-query = לחפש באינטרנט אחר <strong>״{ $query }״</strong>
