...
details-notification-softblocked-extension-disabled =
    .message = הרחבה זו מפרה את המדיניות של Mozilla ולכן הושבתה. באפשרותך להפעיל אותה, אבל ייתכן שזה יהיה כרוך בסיכון.
...
details-notification-softblocked-other-disabled =
    .message = תוספת זו מפרה את המדיניות של Mozilla ולכן הושבתה. באפשרותך להפעיל אותה, אבל ייתכן שזה יהיה כרוך בסיכון.
