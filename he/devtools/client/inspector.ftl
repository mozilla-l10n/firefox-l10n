...
colorpicker-tooltip-spectrum-dragger-title = רצף צבעים
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = בחירת צבע מהדף
...
colorpicker-tooltip-color-name-title = הכי קרוב ל: { $colorName }
