...
credit-card-doorhanger-options-button =
    .title = Opcions d'autorrepleno d'os formularios
...
autofill-insecure-field-warning-description = { -brand-short-name } ha detectau un puesto inseguro. L'autorreplenau de formularios s'ha desactivau temporalment.
