...
protections-panel-not-blocking-why-etp-on-tooltip = Bloquiar esto podría romper los elementos de dalgunos sitios web. Ensin los rastrexadores, dalgunos botones, formularios y anicios de sesión quiciabes dexen de funcionar.
