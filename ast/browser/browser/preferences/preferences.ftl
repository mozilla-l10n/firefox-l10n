...
pane-privacy-title2 = Privacidá y seguranza
...
applications-setting =
    .label = Aplicaciones
    .description = Escueyi cómo remana { -brand-short-name } los ficheros que baxes de la web o les aplicaciones qu'uses menanto restoles.
