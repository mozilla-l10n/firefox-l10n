...
import-permissions-description = macOS rique esplicitamente que permitas a { -brand-short-name } acceder a los marcadores de Safari. Calca «Siguir» y esbilla'l ficheru «Bookmarks.plist» nel panel d'apertura de ficheros que va apaecer.
