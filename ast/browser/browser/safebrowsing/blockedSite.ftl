...
safeb-blocked-phishing-page-learn-more = Deprendi más tocante a los sitios engañoso y el phishing en <a data-l10n-name='learn_more_link'>www.antiphishing.org</a>. Por embargu, si tamién quies deprender más tocante a la proteición escontra'l malware y phishing de { -brand-short-name }, visita <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
