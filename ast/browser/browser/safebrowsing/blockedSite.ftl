...
safeb-blocked-phishing-page-learn-more = Deprendi más tocante a los sitios engañosos y el phishing en <a data-l10n-name='learn_more_link'>www.antiphishing.org</a>. Por embargu, si tamién quies deprender más tocante a la proteición escontra'l malware y phishing de { -brand-short-name }, visita <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
...
safeb-blocked-malware-page-learn-more = Visita <a data-l10n-name='learn_more_link'>StopBadware.org</a> pa deprender más tocante al conteníu web peligrosu qu'inclúi virus y otru malware, y tocante a cómo protexer l'ordenador escontra ello. Por embargu, si tamién quies deprender más tocante a la proteición escontra'l malware y phishing de { -brand-short-name }, visita <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
...
safeb-blocked-malware-page-learn-more-sumo = Deprendi más tocante a la proteición escontra'l malware y phishing de { -brand-short-name } en <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
...
safeb-blocked-unwanted-page-learn-more = Deprendi más tocante al sofware peligrosu y non deseáu na <a data-l10n-name='learn_more_link'>política de software non deseáu</a>. Por embargu, si tamién quies deprender más tocante a la proteición escontra'l malware y phishing de { -brand-short-name }, visita <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
...
safeb-blocked-harmful-page-learn-more = Deprendi más tocante a la proteición escontra'l malware y phishing de { -brand-short-name } en <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
