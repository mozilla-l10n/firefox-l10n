...
tab-groups-onboarding-dismiss = సరే

## Fx Backup onboarding: Create Backup spotlight

create-backup-back-button-label = వెనుకకు

## Fx Backup confirmation screen strings

fx-backup-confirmation-screen-close-button = మూసివేయి

## Restored from Backup spotlight

restored-from-backup-success-no-checklist-primary-button = కొనసాగించు
restored-from-backup-error-primary-button = మూసివేయి

## Onboarding Personalization Screen
## A screen shown to users during the onboarding process that asks them two qualifying questions about their use of the browser

onboarding-personalization-use-case-personal-option = వ్యక్తిగతం
onboarding-personalization-use-case-school-option = బడి
onboarding-personalization-use-case-work-option = ఉద్యోగం
onboarding-personalization-motivation-privacy-option = అంతరంగికత, భద్రత
