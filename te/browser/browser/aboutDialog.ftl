...
settings-update-checking-for-updates =
    .label = తాజాకరణల కొరకు చూస్తున్నాం…
...
settings-update-unsupported = ఈ వ్యవస్థపై మీరు ఇంకేమీ తాజాకరణలు చెయ్యలేరు. <a data-l10n-name="unsupported-link">ఇంకా తెలుసుకోండి</a>
update-restarting = పునఃప్రారంభమవుతోంది…
settings-update-restarting =
    .label = పునఃప్రారంభమవుతోంది…
...
settings-update-internal-error = అంతర్గత లోపం వల్ల తాజాకరణ కోసం చూడలేకపోయాం.తాజాకరణలు <a data-l10n-name="manual-link">{ $displayUrl }</a> వద్ద అందుబాటులో ఉన్నాయి
