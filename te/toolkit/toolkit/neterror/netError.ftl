...
fp-neterror-denied-port-access = ఈ చిరునామా మాములుగా జాల విహారణకు వాడని నెట్‌వర్కు పోర్టుని వాడుతోంది. మీ భద్రత కొరకు { -brand-short-name } ఈ అభ్యర్థనను రద్దుచేసింది.
