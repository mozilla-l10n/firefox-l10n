...
support-printing-prefs-name = పేరు
support-printing-prefs-value = విలువ

## Remote Settings sections

support-remote-settings-status = స్థితి
support-remote-settings-status-ok = సరే
support-remote-settings-sync-history = చరిత్ర
support-remote-settings-sync-history-status = స్థితి
support-remote-settings-sync-history-datetime = తేదీ

## Normandy sections

support-remote-features-name = పేరు
support-remote-features-status = స్థితి
