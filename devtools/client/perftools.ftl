...
perftools-intro-description = 記録したデータは新規タブの profiler.firefox.com で開きます。データはすべてローカルに保存されますが、アップロードして共有することもできます。
...
perftools-description-intro = 記録したデータは新規タブの <a>profiler.firefox.com</a> で開きます。データはすべてローカルに保存されますが、アップロードして共有することもできます。
...
perftools-thread-jvm-default-dispatcher =
    .title = Kotlin コルーチンライブラリーのデフォルトディスパッチャーです
