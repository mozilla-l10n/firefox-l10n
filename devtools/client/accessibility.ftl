...
accessibility-text-label-issue-fieldset-legend = <code>legend</code> 요소를 사용하여 <span>fieldset</span> 요소에 레이블을 지정합니다. <a>더 알아보기</a>
...
accessibility-text-label-issue-iframe = <code>title</code> 속성을 사용하여 <span>iframe</span> 콘텐츠를 설명하십시오. <a>더 알아보기</a>
