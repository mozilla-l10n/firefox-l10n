...
accessibility-text-label-issue-fieldset-legend = Use el elemento <code>leyenda</code> para etiquetar elementos <span>fieldset</span>. <a>Conocer más</a>
...
accessibility-text-label-issue-optgroup-label = Usá el atributo <code>label</code> para etiquetar elementos <span>optgroup</span>. <a>Aprender más</a>
