...
accessibility-text-label-issue-fieldset-legend = Wužiwajće element <code>legend</code>, zo byšće elementy <span>fieldset</span> woznamjenił. <a>Dalše informacije</a>
accessibility-text-label-issue-form = Formularne elementy dyrbja so woznamjenić. <a>Dalše informacje</a>
accessibility-text-label-issue-form-visible = Formularne elementy měli widźomny tekstowe woznamjenjenje měć. <a>Dalše informacije</a>
...
accessibility-text-label-issue-image = Wobsah z wobrazami dyrbja so woznamjenić. <a>Dalše informacije</a>
accessibility-text-label-issue-interactive = Interaktiwne elementy dyrbja so woznamjenić. <a>Dalše informacije</a>
accessibility-text-label-issue-optgroup-label = Wužiwajće atribut <code>label</code>, zo byšće elementy <span>optgroup</span> woznamjenił. <a>Dalše informacije</a>
