...
serviceworker-worker-debug = Depanare
    .title = Numai service workerii activi pot fi depanați
...
serviceworker-empty-suggestions-debugger = Execută pas cu pas înregistrarea service workerilor și caută excepții. <a>Deschide depanatorul</a>
# Suggestion to go to about:debugging in order to see Service Workers for all domains.
# Clicking on the link will open about:debugging in a new tab.
serviceworker-empty-suggestions-aboutdebugging = Inspectează service workeri de pe alte domenii. <a>Deschide about:debugging</a>
