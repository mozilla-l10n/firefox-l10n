...
options-disable-http-cache-label = Kache HTTP ñemonge (tembiporu ryru ijuruja jave)
...
options-enable-service-workers-http-label = Mba’epytyvõrã mba’apohára moheñói HTTP rupi (tembiporu ryru ijurujáramo)
options-enable-service-workers-http-tooltip =
    .title = Emyandývo ko poravopyrã omoneĩta mba’apoharakuéra mba’epytyvõrãva HTTP rupi opavave tenda’ípe g̃uarã oguerekóva tembiporu ryru ijurujáva.
