...
storage-table-type-localstorage-hint = Shihni dhe përpunoni depozitim vendor duke përzgjedhur një strehë. <a data-l10n-name="learn-more-link">Mësoni më tepër</a>
# Hint shown when the session storage type is selected. Clicking the link will open
# https://developer.mozilla.org/docs/Tools/Storage_Inspector/Local_Storage_Session_Storage
storage-table-type-sessionstorage-hint = Shihni dhe përpunoni depozitim sesioni duke përzgjedhur një strehë. <a data-l10n-name="learn-more-link">Mësoni më tepër</a>
...
storage-table-type-cache-hint = Shihni dhe fshini zëra depozitim në fshehtinë duke përzgjedhur një depozitë. <a data-l10n-name="learn-more-link">Mësoni më tepër</a>
