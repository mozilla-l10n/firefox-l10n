...
about-debugging-setup-usb-step-enable-dev-menu = Attiva il menu “Sviluppo” sul dispositivo Android. <a>Scopri come</a>
about-debugging-setup-usb-step-enable-debug = Attiva “Debug USB” nel menu “Sviluppo” sul dispositivo Android. <a>Scopri come</a>
