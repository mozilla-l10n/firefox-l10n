...
footer-title = Firefox֊ի Ծրագրավորողի թողարկում
...
welcome-message = Դուք հաջողությամբ միացրել եք մշակողի գործիքները։ Սկսելու համար ուսումնասիրեք վեբ ծրագրավորողի ցանկը կամ բացեք գործիքները { $shortcut }-ով։
