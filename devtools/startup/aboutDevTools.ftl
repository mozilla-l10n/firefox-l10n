...
enable-about-debugging-message = Desenvolva e depure WebExtensions, web workers, service workers e muito mais com o Firefox Developer Tools.
enable-key-shortcut-message = Você ativou um atalho do Developer Tools. Se foi por engano, pode fechar esta aba.
enable-menu-message = Aperfeiçoe HTML, CSS e JavaScript do seu site com ferramentas como Inspector e Debugger.
enable-common-message = O Firefox Developer Tools é desativado por padrão para dar a você mais controle sobre seu navegador.
...
welcome-message = Você ativou com sucesso o Developer Tools! Para começar, explore o menu do Web Developer ou abra as ferramentas com { $shortcut }.
