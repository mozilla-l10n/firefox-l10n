...
fp-neterror-denied-port-access = આ સરનામું નેટવર્ક પોર્ટ વાપરે છે કે જે સામાન્ય રીતે વેબ બ્રાઉઝીંગ સિવાયના અન્ય હેતુ માટે વપરાય છે. { -brand-short-name }ે તમારી સુરક્ષા માટેની અરજી રદ કરી છે.
