...
path-dd = <span data-l10n-name="path">लामा:</span> { $pluginFullPath }
version-dd = <span data-l10n-name="version">लिरस्लायनाय:</span> { $version }
...
state-dd-enabled = <span data-l10n-name="state">राइजो:</span> मावथि खालामबाय
