...
devtools-tooltip-learn-more = Meer info
...
inactive-css-not-grid-or-flex-or-absolutely-positioned-item = <strong>{ $property }</strong> heeft geen effect op dit element, aangezien het geen grid- of flexitem is, en ook geen absoluut gepositioneerd element.
inactive-css-not-grid-or-absolutely-positioned-item = <strong>{ $property }</strong> heeft geen effect op dit element, aangezien het geen griditem is, en ook geen absoluut gepositioneerd element.
inactive-css-not-absolutely-positioned-item = <strong>{ $property }</strong> heeft geen effect op dit element aangezien het geen absoluut gepositioneerd element is.
inactive-css-no-default-anchor = <strong>{ $property }</strong> heeft geen effect op dit element aangezien het geen standaard ankerelement heeft.
...
inactive-css-not-block-container = <strong>{ $property }</strong> heeft geen effect op dit element, omdat dit alleen van toepassing is op blokcontainer-elementen.
inactive-css-not-block-flex-grid-container = <strong>{ $property }</strong> heeft geen effect op dit element, omdat dit alleen van toepassing is op blok-, flex- en gridcontainer-elementen.
...
inactive-css-at-position-try-not-supported = <strong>{ $property }</strong> wordt niet ondersteund <strong>@position-try</strong>-regels:
# Variables:
...
inactive-css-no-principal-box = <strong>{ $property }</strong> heeft geen effect op dit element, omdat het geen primair veld maakt.
...
inactive-css-not-grid-or-absolutely-positioned-item-fix = Probeer <strong>position:absolute</strong> aan het element toe te voegen, of <strong>display:grid</strong> of <strong>display:inline-grid</strong> aan het bovenliggende element. { learn-more }
inactive-css-not-absolutely-positioned-item-fix = Probeer <strong>position:absolute</strong> aan het element toe te voegen. { learn-more }
inactive-css-no-default-anchor-fix = Probeer <strong>position-anchor</strong> met een geldige ankernaam toe te voegen. { learn-more }
...
inactive-css-not-grid-or-absolutely-positioned-item-fix-1 = Probeer <strong>position:absolute</strong> aan het element toe te voegen, of <strong>display:grid</strong> of <strong>display:inline-grid</strong> aan het bovenliggende element.
inactive-css-not-absolutely-positioned-item-fix-1 = Probeer <strong>position:absolute</strong> aan het element toe te voegen.
inactive-css-no-default-anchor-fix-1 = Probeer <strong>position-anchor</strong> met een geldige ankernaam toe te voegen.
...
inactive-css-not-block-flex-grid-container-fix-1 = Probeer <strong>display:block</strong>, <strong>display:inline-block</strong>, <strong>display:flex</strong>, <strong>display:inline-flex</strong>, <strong>display:grid</strong>, <strong>display:inline-grid</strong> of <strong>display:flow-root</strong> toe te voegen.
inactive-css-not-floated-fix-1 = Probeer de eigenschap <strong>float</strong> toe te voegen met een andere waarde dan <strong>none</strong>.
inactive-css-position-property-on-unpositioned-box-fix-1 = Probeer de eigenschap <strong>position</strong> op iets anders dan <strong>static</strong> in te stellen.
inactive-css-only-replaced-elements-fix-1 = Zorg ervoor dat u de eigenschap aan een vervangen element toevoegt.
inactive-text-overflow-when-no-overflow-fix-1 = Probeer <strong>overflow:hidden</strong> toe te voegen.
inactive-css-no-size-containment-fix-1 = Probeer de property <strong>display</strong> op iets anders dan <strong>none</strong>, <strong>contents</strong>, <strong>table</strong> of <strong>inline-table</strong> in te stellen en zorg ervoor dat deze niet binnen een tabel of rubysegment staat.
inactive-css-not-for-internal-table-elements-fix-1 = Probeer de property <strong>display</strong> op iets anders dan <strong>table-cell</strong>, <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong> of <strong>table-footer-group</strong> in te stellen.
inactive-css-not-for-internal-table-elements-except-table-cells-fix-1 = Probeer de property <strong>display</strong> op iets anders dan <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong> of <strong>table-footer-group</strong> in te stellen.
inactive-css-not-table-fix-1 = Probeer <strong>display:table</strong> of <strong>display:inline-table</strong> toe te voegen.
inactive-css-collapsed-table-borders-fix-1 = Probeer <strong>border-collapse:separate</strong> toe te voegen.
inactive-css-not-table-cell-fix-1 = Probeer <strong>display:table-cell</strong> toe te voegen.
inactive-scroll-padding-when-not-scroll-container-fix-1 = Probeer <strong>overflow:auto</strong>, <strong>overflow:scroll</strong> of <strong>overflow:hidden</strong> toe te voegen.
inactive-css-border-image-fix-1 = Verwijder in het bovenliggende tabelelement de eigenschap, of wijzig de waarde van <strong>border-collapse</strong> in een andere waarde dan <strong>collapse</strong>.
...
inactive-css-ruby-element-fix-1 = Probeer de <strong>lettergrootte</strong> van de Ruby-tekst te wijzigen.
...
css-selector-warning-sibling-combinator-after-scope = Verwante selectors na <strong>:scope</strong> zullen nooit ergens mee overeenkomen
...
css-selector-container-query-condition-no-container = Container ‘{ $name }’ niet gevonden
