...
firefox-relay-opt-in-confirmation-postpone =
    .label = Niet nu
    .accesskey = N
firefox-relay-offer-what-fxa-and-relay-provides = Een account ontgrendelt toegang tot meer privacybeschermende producten. Alle e-mailberichten die naar uw e-mailmaskers worden verzonden, worden doorgestuurd naar uw echte e-mailadres (tenzij u besluit ze te blokkeren).
...
firefox-relay-offer-legal-notice-with-domain-and-value-prop = Door een e-mailmasker aan te maken, gaat u akkoord met de <label data-l10n-name="tos-url">Servicevoorwaarden</label> en <label data-l10n-name="privacy-url">Privacyverklaring</label>.
