...
confirmation-hint-passport-created = Paspoort opgeslagen
confirmation-hint-passport-updated = Paspoort bijgewerkt
...
confirmation-hint-extensions-button-hidden = Verplaatst naar menu
