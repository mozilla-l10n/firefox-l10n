...
contextual-manager-passwords-origin-field-description = Voer het exacte adres in waar u zich bij deze website zult aanmelden.
contextual-manager-passwords-username-field =
    .label = Gebruikersnaam
contextual-manager-passwords-username-field-description = Voer de gebruikersnaam, het e-mailadres of het accountnummer in dat u gebruikt om u aan te melden.
contextual-manager-passwords-password-field =
    .label = Wachtwoord
contextual-manager-passwords-password-field-description = Voer het wachtwoord in om u aan te melden bij deze account.
