...
newtab-privacy-empty-state-tally = Bekijk hier een lopend overzicht.

## Privacy widget — Enhanced Tracking Protection off state

# Shown when the user has turned off the Enhanced Tracking Protection setting.
newtab-privacy-etp-off-faster-browsing = Sneller surfen. Minder trackers.
newtab-privacy-etp-off-turn-on-tracking = Schakel bescherming tegen volgen in in uw instellingen om met blokkeren te beginnen.
...
newtab-privacy-message-milestone-week =
    { $count ->
        [one] { $count } tracker geblokkeerd deze week. Bekijk wat { -brand-short-name } bij u weghoudt
       *[other] { $count } trackers geblokkeerd deze week. Bekijk wat { -brand-short-name } bij u weghoudt
    }
...
newtab-privacy-message-milestone-month =
    { $count ->
        [one] { $count } tracker deze maand geblokkeerd. Een kleine stap voor privacy. Een grote stap voor gemoedsrust.
       *[other] { $count } trackers deze maand geblokkeerd. Een kleine stap voor privacy. Een grote stap voor gemoedsrust.
    }
...
newtab-privacy-message-milestone-year =
    { $count ->
        [one] { $count } tracker geblokkeerd dit jaar. Dat is een krachtig jaar voor de bescherming van uw privacy.
       *[other] { $count } trackers geblokkeerd dit jaar. Dat is een krachtig jaar voor de bescherming van uw privacy.
    }
...
newtab-privacy-message-milestone-total =
    { $count ->
        [one] { $count } tracker geblokkeerd. Dat is een grote stap op weg naar privacy onder uw voorwaarden.
       *[other] { $count } trackers geblokkeerd. Dat is een grote stap op weg naar privacy onder uw voorwaarden.
    }
newtab-privacy-message-milestone-total-cta = Beschermingen bekijken
# Shown when today's blocked-tracker count reaches the display cap ("100+").
newtab-privacy-message-daily-cap = (Meer dan 100 trackers geblokkeerd vandaag.) Minder trackers betekent meer privacy.
...
newtab-privacy-message-first-protection = Blijf surfen, { -brand-short-name } blijft blokkeren.
...
newtab-stocks-search-button =
    .label = Zoeken
    .title = Zoeken op naam of symbool
...
newtab-stocks-watchlist-full =
    { $limit ->
        [one] U kunt maximaal { $limit } aandeel toevoegen. Verwijder er een om een andere toe te voegen.
       *[other] U kunt maximaal { $limit } aandelen toevoegen. Verwijder er een om een andere toe te voegen.
    }
...
newtab-recent-searches-tab-recent = Recente zoekopdrachten
...
newtab-recent-searches-just-now = Zojuist
...
newtab-recent-searches-empty-recent = Recente zoekopdrachten worden hier weergegeven, zodat u ze altijd kunt ophalen.
...
newtab-spaces-tab-stories = Verhalen
newtab-spaces-tab-widgets = Widgets
newtab-spaces-tab-activity = Activiteit
...
newtab-topsites-hover-card-header = Meldingen van { $site }
# Relative time shown for a notification posted less than a minute ago.
newtab-topsites-hover-card-just-now = Zojuist
...
newtab-carousel-pause =
    .aria-label = Automatisch afspelen pauzeren
# Button that resumes autoplay on the carousel.
newtab-carousel-play =
    .aria-label = Automatisch afspelen hervatten
...
newtab-custom-web-notifications-toggle =
    .description = Meldingen van uw websites via hun snelkoppelingen tonen
    .label = Webnotificaties
...
newtab-custom-stories-personalized-checkbox =
    .label = Gepersonaliseerde verhalen op basis van uw activiteit
...
newtab-customize-panel-back-button =
    .aria-label = Terug naar Aanpassen
    .title = Terug naar Aanpassen
...
newtab-appearance-more-themes-button =
    .label = Meer thema’s bekijken
# Title of the full theme selection sub-panel, also used as its back button label.
newtab-appearance-manage-title = { -brand-product-name }-thema’s
# Header for the list of the user's already-installed themes in the full theme panel.
newtab-appearance-your-themes-header = Uw thema’s
...
newtab-appearance-explore-more-themes-button = Meer thema’s verkennen
...
newtab-wallpaper-your-images = Uw afbeeldingen
...
newtab-wallpaper-your-images-folder =
    .aria-label = Uw opgeslagen afbeeldingen en achtergronden
...
newtab-wallpaper-your-images-item-numbered = Afbeelding { $number }
...
newtab-topic-navigation-more-button = Meer
...
newtab-widget-section-show-widgets =
    .aria-label = De widgetsectie tonen
    .title = Widgets tonen
...
newtab-sports-widget-world-cup-champions-short = Kampioen van 2026
# Variables:
...
newtab-clock-city-eg-cairo = Caïro
