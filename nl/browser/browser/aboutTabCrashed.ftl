...
crashed-send-report = Een automatisch crashrapport verzenden, zodat we problemen als deze kunnen verhelpen
...
crashed-include-URL = De URL’s bijvoegen van de websites die u bezocht toen { -brand-short-name } crashte
crashed-email-placeholder = Voer hier uw e-mailadres in
crashed-email-me = Mij een e-mailbericht sturen zodra er meer informatie beschikbaar is
...
crashed-auto-submit-checkbox = Voorkeuren aanpassen om automatisch rapporten te verzenden wanneer { -brand-short-name } crasht
