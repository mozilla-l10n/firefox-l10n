...
extension-default-theme-description2 = Een uitgebalanceerd, vertrouwd grijspaars voor een klassieke { -brand-product-name }-uitstraling.
...
extension-nova-dusk-name = Schemer
...
extension-nova-pine-name = Den
# Name for a soft teal theme. Refers to ocean tides.
extension-nova-tide-name = Getij
...
extension-nova-smoke-name = Rook
