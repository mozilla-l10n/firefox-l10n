...
about-private-browsing-info-bookmarks = bladwijzers
about-private-browsing-info-title = U bevindt zich in een privévenster
about-private-browsing-info-searches = zoekopdrachten
about-private-browsing-info-downloads = downloads
private-browsing-title = Privénavigatie
about-private-browsing-info-saved = { -brand-short-name } zal het volgende <strong>wel opslaan</strong>:
about-private-browsing-info-myths = Veelgehoorde mythes over privénavigatie
about-private-browsing-info-clipboard = gekopieerde tekst
about-private-browsing-info-temporary-files = tijdelijke bestanden
about-private-browsing-info-cookies = cookies
tracking-protection-start-tour = Zien hoe het werkt
about-private-browsing-note = Privénavigatie <strong>maakt u niet anoniem</strong> op het internet. Uw werkgever of internetserviceprovider kan nog steeds zien welke pagina’s u bezoekt.
