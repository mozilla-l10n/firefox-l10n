...
profile-window-checkbox-label-2 =
    .label = Kies een profiel wanneer { -brand-short-name } wordt geopend
...
profiles-marigold-theme = Goudsbloem
...
profiles-lichen-theme = Korstmos
