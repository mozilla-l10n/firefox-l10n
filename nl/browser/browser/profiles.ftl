...
edit-profile-page-desktop-shortcut-toggle-2 =
    .label = Bureaubladsnelkoppeling maken
edit-profile-page-desktop-shortcut-header = Bureaubladsnelkoppeling maken
edit-profile-page-desktop-shortcut-toggle =
    .aria-label = Bureaubladsnelkoppeling maken
...
restored-profile-page-header-description = Elk profiel houdt zijn unieke navigatiegeschiedenis en instellingen gescheiden van uw andere profielen. Bovendien zijn de sterke privacybeschermingen van { -brand-short-name } standaard ingeschakeld.
restored-profile-page-learn-more = Meer info
...
# Variables
#   $profilename (String) - The name of the profile.
delete-profile-header-2 = Profiel ‘{ $profilename }’ verwijderen?
