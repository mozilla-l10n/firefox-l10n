...
item-site-prefs =
    ...
    .accesskey = i
item-formdata-prefs =
    .label = Opgeslagen formuliergegevens
    .accesskey = o
item-formdata-description = Wist zaken als namen, e-mailadressen en andere items die u in formulieren invoert
