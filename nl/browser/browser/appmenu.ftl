...
fxa-menu-sync-your-data = Uw gegevens synchroniseren
...
fxa-menu-sync-status-turn-on-button =
    .label = Inschakelen
fxa-menu-sync-status-turn-on-button-aria-label = Inschakelen
...
appmenu-sync-promo-signin =
    .heading = Blijf op verschillende apparaten gesynchroniseerd
appmenu-sync-promo-signin-cta = Aanmelden
appmenu-sync-promo-turnonsync =
    .heading = Uw tabbladen en geschiedenis synchroniseren
appmenu-sync-promo-turnonsync-cta = Synchronisatie inschakelen
# This refers to getting tabs from your mobile device via sync
appmenu-sync-promo-connectdevice =
    .heading = Pak uw mobiele tabbladen
appmenu-sync-promo-connectdevice-cta = Een apparaat verbinden
appmenu-bookmarks-sync-promo-turnonsync =
    .heading = Neem uw bladwijzers met u mee
...
appmenuitem-vpn-description5 = Ontvang extra bescherming op verschillende apparaten
# Shown in place of appmenuitem-vpn-title2 when the user has signed up for VPN.
appmenuitem-vpn-title-signed-in1 = { -mozilla-vpn-brand-name } downloaden
...
appmenuitem-share-firefox-title2 = { -brand-product-name } delen
# Button in the account menu that links to the Referrals page
