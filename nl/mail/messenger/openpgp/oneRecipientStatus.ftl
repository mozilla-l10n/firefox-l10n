...
openpgp-one-recipient-status-instruction1 = Om een end-to-end-versleuteld bericht naar een ontvanger te sturen, dient u diens openbare OpenPGP-sleutel te verkrijgen en deze als geaccepteerd te markeren.
