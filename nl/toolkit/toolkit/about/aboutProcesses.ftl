...
about-processes-web-isolated-property-jit-disabled = JIT uitgeschakeld
about-processes-web-isolated-property-with-coop-coep = cross-origin geïsoleerd
...
about-processes-utility-actor-pkcs11-module = Beveiligingsmodulehelper
about-processes-utility-actor-hw-inference = Hardware-versnelde inferentie
