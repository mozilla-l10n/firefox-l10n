...
details-notification-softblocked-extension-disabled =
    .message = Deze extensie schendt het beleid van Mozilla en is uitgeschakeld. U kunt hem inschakelen, maar dit kan riskant zijn.
...
details-notification-softblocked-other-disabled =
    .message = Deze add-on schendt het beleid van Mozilla en is uitgeschakeld. U kunt hem inschakelen, maar dit kan riskant zijn.
