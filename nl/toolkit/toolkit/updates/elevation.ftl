...
elevation-more-elevated =
    ...
    update weigeren.
sandbox-missing-unprivileged-namespaces = Sommige beveiligingsfuncties van { -brand-short-name } bieden mogelijk minder bescherming op uw huidige besturingssysteem.
