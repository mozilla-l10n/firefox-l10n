...
colorpicker-tooltip-eyedropper-title = ເລືອກສີໃນຫນ້າ
...
colorpicker-tooltip-color-name-title = ໃກ້ທີ່ສຸດກັບ: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = ສີສັນ
# A title text for the alpha slider in the color picker tooltip.
colorpicker-tooltip-alpha-slider-title = ຄວາມໂປ່ງໃສ
