...
ssl-error-rx-malformed-certificate = SSL ໄດ້ຮັບຂໍ້ຄວາມຈັບມືໃບຮັບຮອງທີ່ບໍ່ຖືກຕ້ອງ.
ssl-error-rx-malformed-server-key-exch = SSL ໄດ້ຮັບຂໍ້ຄວາມຈັບມື Exchange Key ເຊີບເວີທີ່ບໍ່ຖືກຕ້ອງ.
ssl-error-rx-malformed-cert-request = SSL ໄດ້ຮັບຂໍ້ຄວາມຈັບມືຂໍໃບຮັບຮອງທີ່ບໍ່ຖືກຕ້ອງ.
ssl-error-rx-malformed-hello-done = SSL ໄດ້ຮັບຂໍ້ຄວາມການຈັບມືຂອງເຊີບເວີ Hello Done ທີ່ບໍ່ຖືກຕ້ອງ.
ssl-error-rx-malformed-cert-verify = SSL ໄດ້ຮັບຂໍ້ຄວາມການຈັບມືຢືນຢັນທີ່ບໍ່ຖືກຕ້ອງ.
ssl-error-rx-malformed-client-key-exch = SSL ໄດ້ຮັບຂໍ້ຄວາມຈັບມືແລກປ່ຽນລະຫັດລູກຄ້າທີ່ບໍ່ຖືກຕ້ອງ.
ssl-error-rx-malformed-finished = SSL ໄດ້ຮັບຂໍ້ຄວາມຈັບມືທີ່ສໍາເລັດຮູບທີ່ບໍ່ຖືກຕ້ອງ.
ssl-error-rx-malformed-change-cipher = SSL ໄດ້ຮັບບັນທຶກການປ່ຽນແປງລະຫັດລັບທີ່ບໍ່ຖືກຕ້ອງ.
ssl-error-rx-malformed-alert = SSL ໄດ້ຮັບບັນທຶກການແຈ້ງເຕືອນທີ່ບໍ່ຖືກຕ້ອງ.
ssl-error-rx-malformed-handshake = SSL ໄດ້ຮັບບັນທຶກ Handshake ທີ່ບໍ່ຖືກຕ້ອງ.
ssl-error-rx-malformed-application-data = SSL ໄດ້ຮັບບັນທຶກຂໍ້ມູນແອັບພລິເຄຊັນທີ່ບໍ່ຖືກຕ້ອງ.
ssl-error-rx-unexpected-hello-request = SSL ໄດ້ຮັບຂໍ້ຄວາມຈັບມື Hello Request ທີ່ບໍ່ຄາດຄິດ.
ssl-error-rx-unexpected-client-hello = SSL ໄດ້ຮັບຂໍ້ຄວາມການຈັບມືສະບາຍດີລູກຄ້າທີ່ບໍ່ຄາດຄິດ.
...
ssl-error-rx-unexpected-server-key-exch = SSL ໄດ້ຮັບຂໍ້ຄວາມຈັບມື Exchange Key ເຊີບເວີທີ່ບໍ່ຄາດຄິດ.
ssl-error-rx-unexpected-cert-request = SSL ໄດ້ຮັບຂໍ້ຄວາມຈັບມືຂໍໃບຮັບຮອງທີ່ບໍ່ຄາດຄິດ.
ssl-error-rx-unexpected-hello-done = SSL ໄດ້ຮັບຂໍ້ຄວາມຈັບມືເຊີບເວີ Hello Done ທີ່ບໍ່ຄາດຄິດ.
ssl-error-rx-unexpected-cert-verify = SSL ໄດ້ຮັບຂໍ້ຄວາມຢືນຢັນການຈັບມືທີ່ບໍ່ຄາດຄິດ.
ssl-error-rx-unexpected-client-key-exch = SSL ໄດ້ຮັບຂໍ້ຄວາມຈັບມືແລກປ່ຽນລະຫັດລູກຄ້າທີ່ບໍ່ຄາດຄິດ.
ssl-error-rx-unexpected-finished = SSL ໄດ້ຮັບຂໍ້ຄວາມຈັບມືທີ່ສໍາເລັດແລ້ວທີ່ບໍ່ຄາດຄິດ.
ssl-error-rx-unexpected-change-cipher = SSL ໄດ້ຮັບບັນທຶກການປ່ຽນແປງ Cipher Spec ທີ່ບໍ່ຄາດຄິດ.
ssl-error-rx-unexpected-alert = SSL ໄດ້ຮັບບັນທຶກການແຈ້ງເຕືອນທີ່ບໍ່ຄາດຄິດ.
ssl-error-rx-unexpected-handshake = SSL ໄດ້ຮັບບັນທຶກການຈັບມືທີ່ບໍ່ຄາດຄິດ.
ssl-error-rx-unexpected-application-data = SSL ໄດ້ຮັບບັນທຶກຂໍ້ມູນແອັບພລິເຄຊັນທີ່ບໍ່ຄາດຄິດ.
ssl-error-rx-unknown-record-type = SSL ໄດ້ຮັບບັນທຶກທີ່ມີປະເພດເນື້ອຫາທີ່ບໍ່ຮູ້ຈັກ.
ssl-error-rx-unknown-handshake = SSL ໄດ້ຮັບຂໍ້ຄວາມຈັບມືດ້ວຍປະເພດຂໍ້ຄວາມທີ່ບໍ່ຮູ້ຈັກ.
ssl-error-rx-unknown-alert = SSL ໄດ້ຮັບບັນທຶກການແຈ້ງເຕືອນທີ່ມີຄໍາອະທິບາຍການແຈ້ງເຕືອນທີ່ບໍ່ຮູ້ຈັກ.
ssl-error-close-notify-alert = SSL peer ໄດ້ປິດການເຊື່ອມຕໍ່ນີ້.
ssl-error-handshake-unexpected-alert = SSL peer ບໍ່ໄດ້ຄາດຫວັງຂໍ້ຄວາມຈັບມືທີ່ມັນໄດ້ຮັບ.
ssl-error-decompression-failure-alert = SSL peer ບໍ່ສາມາດບີບອັດບັນທຶກ SSL ທີ່ມັນໄດ້ຮັບສຳເລັດໄດ້.
ssl-error-handshake-failure-alert = SSL peer ບໍ່ສາມາດເຈລະຈາຊຸດຕົວກໍານົດຄວາມປອດໄພທີ່ຍອມຮັບໄດ້.
ssl-error-illegal-parameter-alert = SSL peer ປະຕິເສດຂໍ້ຄວາມຈັບມືສໍາລັບເນື້ອຫາທີ່ບໍ່ສາມາດຍອມຮັບໄດ້.
ssl-error-unsupported-cert-alert = SSL peer ບໍ່ຮອງຮັບໃບຢັ້ງຢືນປະເພດທີ່ມັນໄດ້ຮັບ.
ssl-error-certificate-unknown-alert = ມິດສະຫາຍ SSL ມີບັນຫາທີ່ບໍ່ໄດ້ລະບຸກັບໃບຢັ້ງຢືນທີ່ມັນໄດ້ຮັບ.
ssl-error-generate-random-failure = SSL ປະສົບຄວາມລົ້ມເຫລວຂອງເຄື່ອງສ້າງຕົວເລກແບບສຸ່ມຂອງມັນ.
...
sec-error-crl-unknown-critical-extension = ລາຍຊື່ການຖອນໃບຢັ້ງຢືນ V2 ຂອງຜູ້ອອກໃບປະກາດມີສ່ວນຂະຫຍາຍທີ່ສຳຄັນທີ່ບໍ່ຮູ້ຈັກ.
