...
about-logins-edit-password-tooltip = ໃຫ້ແນ່ໃຈວ່າທ່ານກໍາລັງບັນທຶກລະຫັດຜ່ານປະຈຸບັນຂອງທ່ານສໍາລັບເວັບໄຊທ໌ນີ້. ການປ່ຽນລະຫັດຜ່ານຢູ່ທີ່ນີ້ບໍ່ໄດ້ປ່ຽນມັນກັບ { $webTitle }.
