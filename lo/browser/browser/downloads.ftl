...
downloading-file-opens-in-hours-and-minutes = ເປີດໃນ { $hours }h { $minutes }m…
downloading-file-opens-in-minutes = ເປີດໃນ { $minutes }m…
downloading-file-opens-in-minutes-and-seconds = ເປີດໃນ { $minutes }m { $seconds }s…
