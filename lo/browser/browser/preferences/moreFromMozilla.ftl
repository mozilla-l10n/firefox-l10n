...
more-from-moz-firefox-mobile-title-1 = { -brand-product-name } ສຳລັບມືຖື
...
more-from-moz-title2 = ເພີ່ມເຕີມຈາກ { -vendor-short-name }
    .title = ເພີ່ມເຕີມຈາກ { -vendor-short-name }
