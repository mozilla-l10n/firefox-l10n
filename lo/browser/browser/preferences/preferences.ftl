...
pane-privacy-title2 = ຄວາມເປັນສ່ວນຕົວ & ຄວາມປອດໄພ
...
pane-experimental-reset =
    ...
    .accesskey = R
help-button-label2 = ການສະຫນັບສະຫນູນ { -brand-short-name }
...
applications-type-column =
    .label = ປະເພດເນື້ອຫາ
    .accesskey = ປ
applications-type-heading = ປະເພດເນື້ອຫາ
applications-action-column =
    .label = ການກະທຳ
    .accesskey = ກ
applications-action-heading = ການກະທຳ
# Variables:
