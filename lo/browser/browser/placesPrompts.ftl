...
places-bookmarks-restore-title = ເລືອກຂໍ້ມູນສຳຮອງບຸກມາກ
places-bookmarks-restore-filter-name = JSON
places-bookmarks-restore-format-error = ບໍ່ຮອງຮັບປະເພດໄຟລ໌.
places-bookmarks-restore-parse-error = ບໍ່ສາມາດປະມວນຜົນໄຟລ໌ຂໍ້ມູນສຳຮອງໄດ້.
places-bookmarks-import = ນຳເຂົ້າໄຟລ໌ບຸກມາກ
places-bookmarks-export = ສົ່ງອອກໄຟລ໌ບຸກມາກ
