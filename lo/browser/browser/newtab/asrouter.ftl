...
cfr-cookiebanner-body = ອະນຸຍາດໃຫ້ { -brand-short-name } ປະຕິເສດການຮ້ອງຂໍປ້າຍໂຄສະນາຄຸກກີໂດຍອັດຕະໂນມັດເມື່ອເປັນໄປໄດ້.
cfr-cookiebanner-accept-button-v2 = ປະຕິເສດການຮ້ອງຂໍ
    .accesskey = R
cfr-cookiebanner-reject-button = ບໍ່​ແມ່ນ​ຕອນ​ນີ້
    .accesskey = N
cfr-cookiebanner-header-variant-1 = ເບິ່ງປັອບອັບຄຸກກີໜ້ອຍລົງ
cfr-cookiebanner-body-variant-1 = ໃຫ້ { -brand-short-name } ຕອບຄຸກກີ້ປັອບອັບໃຫ້ທ່ານໂດຍອັດຕະໂນມັດ ເພື່ອໃຫ້ເຈົ້າສາມາດກັບຄືນສູ່ການທ່ອງເວັບແບບບໍ່ມີສິ່ງລົບກວນໄດ້. { -brand-short-name } ຈະປະຕິເສດການຮ້ອງຂໍທັງໝົດຖ້າເປັນໄປໄດ້.
cfr-cookiebanner-accept-button-variant-1 = ປິດປັອບອັບ
    .accesskey = D
cfr-cookiebanner-reject-button-variant-1 = ບໍ່, ຂອບໃຈ
    .accesskey = N
cfr-cookiebanner-header-variant-2 = ການຫຼຸດປ້າຍໂຄສະນາຄຸກກີ
cfr-cookiebanner-body-variant-2 = ຫຼຸດຈໍານວນປ້າຍໂຄສະນາຄຸກກີທີ່ເຈົ້າເຫັນໂດຍການອະນຸຍາດໃຫ້ { -brand-short-name } ປະຕິເສດຄໍາຮ້ອງຂໍການຍິນຍອມຂອງຄຸກກີຂອງເວັບໄຊທ໌ຖ້າເປັນໄປໄດ້.
cfr-cookiebanner-accept-button-variant-2 = ອະນຸຍາດ
    .accesskey = A
