...
contextual-manager-passwords-origin-field =
    .label = ທີ່ຢູ່ເວັບໄຊທ໌
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = ໃສ່ທີ່ຢູ່ທີ່ແນ່ນອນທີ່ທ່ານຈະເຂົ້າສູ່ລະບົບເວັບໄຊນີ້.
contextual-manager-passwords-username-field =
    .label = ຊື່ຜູ້ໃຊ້
contextual-manager-passwords-username-field-description = ໃສ່ຊື່ຜູ້ໃຊ້, ທີ່ຢູ່ອີເມວ ຫຼື ເລກບັນຊີທີ່ທ່ານໃຊ້ເພື່ອເຂົ້າສູ່ລະບົບ.
contextual-manager-passwords-password-field =
    .label = ລະຫັດຜ່ານ
contextual-manager-passwords-password-field-description = ໃສ່ລະຫັດຜ່ານເພື່ອເຂົ້າສູ່ລະບົບບັນຊີນີ້.
