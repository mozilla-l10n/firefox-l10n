...
places-bookmarks-restore-format-error = Naatbaļsteits faila tips.
places-bookmarks-restore-parse-error = Navar apstruoduot gruomotzeimju rezerves puorspīdumi failu.
places-bookmarks-import = Importeit gruomotzeimju failu
places-bookmarks-export = Eksporteit gruomotzeimju failu
