...
private-browsing-title = Privatuo puorlūkuošona
about-private-browsing-info-saved = { -brand-short-name } <strong>saglobuos</strong> jiusu:
about-private-browsing-info-temporary-files = pagaidu failus
about-private-browsing-info-cookies = seikdatnes
