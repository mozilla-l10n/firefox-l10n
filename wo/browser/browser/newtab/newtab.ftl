...
newtab-clock-city-gb-london = Londar
...
newtab-clock-city-at-vienna = Wiyen
newtab-clock-city-cz-prague = Prag
newtab-clock-city-gr-athens = Aten
newtab-clock-city-hu-budapest = Budapest
newtab-clock-city-be-brussels = Burusel
newtab-clock-city-ua-kyiv = Kiyew
newtab-clock-city-fi-helsinki = Elsinki
newtab-clock-city-eg-cairo = Xayra
newtab-clock-city-se-stockholm = Stokolm
newtab-clock-city-ro-bucharest = Bukarest
newtab-clock-city-cl-santiago = Santiag
newtab-clock-city-bg-sofia = Sofiya
newtab-clock-city-sg-singapore = Singapoor
newtab-clock-city-hk-hong-kong = Ooŋ Koŋ
newtab-clock-city-dk-copenhagen = Kopenagen
newtab-clock-city-ke-nairobi = Nairobi
newtab-clock-city-lt-vilnius = Wilniyus
