...
deniedPortAccess-title = དྲ་གནས་འདི་ནི་བཀག་འགོག་བྱས་ཟིན
...
# "Hmm" is a sound made when considering or puzzling over something.
# You don't have to include it in your translation if your language does not have a written word like this.
malformedURI-title = འོ་ཡ། དྲ་གནས་དེ་འགྲིག་མེད་པ་ཟོལ་འདྲ་འདུག
netInterrupt-title = སྦྲེལ་མཐུད་བཅད་སོང
notCached-title = Document Expired
netOffline-title = དྲ་མེད་པའི་རྣམ་པ
contentEncodingError-title = ནང་དོན་གྱི་ཨང་སྒྲིག་ནོར་འཁྲུལ
unsafeContentType-title = Unsafe File Type
netReset-title = སྦྲེལ་མཐུད་བསྐྱར་སྒྲིག་བྱས་སོང
netTimeout-title = སྦྲེལ་མཐུད་ཀྱི་དུས་ཚོད་ཡོལ་སོང
unknownProtocolFound-title = དྲ་གནས་དེ་ཤེས་ཐུབ་མ་སོང
...
clockSkewError-title = ཁྱེད་ཀྱི་རྩིས་འཁོར་གྱི་ཆུ་ཚོད་ནོར་འདུག
