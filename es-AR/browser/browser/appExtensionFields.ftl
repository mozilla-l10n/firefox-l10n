...
extension-default-theme-description2 = Un gris-púrpura balanceado y familiar para un look clásico de { -brand-product-name }.
...
extension-default-theme-name2 = Predeterminado
...
extension-nova-dusk-name = Atardecer
