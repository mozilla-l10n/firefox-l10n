...
genai-prompts-quiz =
    .label = Juguemos
    .value = Por favor, pregúnteme sobre esta selección. Pregúnteme una variedad de tipos de preguntas, por ejemplo multiple choice, verdadero o falso y respuestas cortas. Espere mi respuesta antes de seguir con la próxima pregunta.
...
genai-shortcut-button-3 =
    .aria-label = Preguntar sobre este texto
    .tooltiptext = Preguntar sobre este texto
...
genai-shortcut-search-button =
    .aria-label = Buscar “{ $selection }” en { $engine }
    .tooltiptext = Buscar “{ $selection }” en { $engine }
...
link-preview-first-time-setup-message = Esto puede tomar un momento. La próxima vez verá los puntos clave más rápidamente.
