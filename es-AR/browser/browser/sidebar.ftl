...
sidebar-show-preview-on-hover =
    .label = Mostrar vista previa al pasar el mouse
...
sidebar-opentabs-preview-heading = Pestañas recientes
...
sidebar-pins-promo-text = Arrastre las pestañas importantes acá para tenerlas al alcance
