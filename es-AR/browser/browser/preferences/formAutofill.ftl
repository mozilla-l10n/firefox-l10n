...
autofill-country-warning-message-2 = El autocompletado de formularios por ahora está disponible solo para algunos países.
...
autofill-passport-expiry-date = Fecha de vencimiento
...
passport-capture-save-doorhanger-description = Guarde información en { -brand-short-name } para poder completar formularios rápidamente.
