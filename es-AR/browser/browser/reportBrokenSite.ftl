...
report-broken-site-panel-url-label = URL del sitio roto
...
report-broken-site-panel-reason-checkout-moz-box-button =
    .label = No se puede pagar, finalizar la compra o comprar
report-broken-site-panel-reason-slow-moz-box-button =
    .label = El sitio es lento
report-broken-site-panel-reason-media-moz-box-button =
    .label = El video no se reproduce o carga
...
report-broken-site-panel-reason-account-moz-box-button =
    .label = No se puede iniciar sesión o registrarse
...
report-broken-site-panel-description =
    .placeholder = ¿Qué pasó? ¿Qué debería haber pasado? ¿Desactivar la protección de rastreo ayudó?
...
report-broken-site-panel-blocked-trackers-description = La protección de rastreo aumentada puede bloquear rastreadores y scripts que algunos sitios web necesitan para funcionar correctamente.
