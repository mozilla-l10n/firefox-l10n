...
set-default-menu-message-row-layout-subtitle = Velocidad, seguridad y privacidad cada vez que navegue.
...
set-default-menu-message-split-layout-subtitle =
    { PLATFORM() ->
        [macos] Hágalo predeterminado y manténgalo en el Dock
       *[other] Tenga una navegación más rápida y protección automática de la privacidad.
    }
...
relay-50-masks-announcement-title = 50 máscaras de correo electrónico, gratis
...
launch-options-spotlight-title-launch-on-login = ¿Abrir { -brand-short-name } cada vez que inicie sesión en Windows?
launch-options-spotlight-title-session-restore = ¿Reabrir la sesión cuando se reinicie { -brand-short-name }?
launch-options-spotlight-checkbox-launch-on-login = Abrir { -brand-short-name } al iniciar
...
lapsed-user-toast-title = { -brand-product-name } todavía lo protege
...
refresh-unused-profile-infobar-message = Parece que no ha iniciado { -brand-short-name } hace un tiempo. ¿Quiere limpiarlo para una experiencia fresca, como nueva? A propósito, ¡bienvenido de nuevo!
refresh-reinstalled-profile-infobar-message = Parece que se reinstaló { -brand-short-name }. ¿Desea limpiarlo para una experiencia renovada, como arrancar de cero?
