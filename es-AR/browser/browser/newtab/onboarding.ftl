...
onboarding-live-language-subtitle = { -brand-short-name } está usando { $appLanguage } mientras el sistema está usando { $systemLanguage }.
...
onboarding-live-language-waiting-subtitle = Parece que el sistema y { -brand-short-name } están usando diferentes idiomas.
...
onboarding-live-language-not-now-button-label = No ahora
