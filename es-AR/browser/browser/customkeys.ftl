...
customkeys-new-key = Presionar nueva tecla:
customkeys-reset-all = Restablecer todos los atajos a los predeterminados
# Variables
...
customkeys-view-add-split-view = Agregar vista dividida
# Separate is a verb
...
customkeys-conflict-unusable-title = La clave no puede ser usada
# Variables
# $conflict (string) - The title of the conflicting shortcut.
customkeys-conflict-unusable-body = Esta clave ya está usada por “{ $conflict }” y no puede usarse.
...
customkeys-description = Controlar cómo se mueve e interactúa con { -brand-short-name }.
