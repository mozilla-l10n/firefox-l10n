...
policy-ClearOnShutdown = Borrar datos de navegación cuando se cierre { -brand-short-name }.
...
policy-CNSA2KeyAgreementEnabled = Habilitar el establecimiento de claves CNSA 2.0 ML-KEM-1024 para TLS.
...
policy-DisableRemoteSettingsAndAcceptSecurityConsequences = Deshabilitar configuración remota.
...
policy-SitePolicies = Políticas específicas del sitio.
