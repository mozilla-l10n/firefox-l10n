...
taskbar-tab-urlbar-button-show = Mostrar acción de página para aplicación web
taskbar-tab-urlbar-button-hide = Ocultar acción de página para aplicación web
