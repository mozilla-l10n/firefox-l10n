...
site-permission-install-first-prompt-serial-header = Este sitio está solicitando acceso a sus dispositivos seriales. El acceso al dispositivo se puede habilitar instalando un complemento.
