...
default-browser-notification-privacy-header-text = ¿Quedarse con { -brand-short-name }?
default-browser-notification-privacy-body-text = El navegador predeterminado cambió. Vuelva a { -brand-short-name } para tener privacidad y protección integradas.
default-browser-notification-yes-button-text = Sí
default-browser-notification-privacy-no-button-text = No, gracias
