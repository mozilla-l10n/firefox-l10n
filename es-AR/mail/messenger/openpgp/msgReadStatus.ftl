...
openpgp-sig-valid-unverified = Este mensaje incluye una firma digital válida de una clave que había sido aceptaba previamente. Sin embargo, no se ha verificado que la clave sea realmente propiedad del remitente.
