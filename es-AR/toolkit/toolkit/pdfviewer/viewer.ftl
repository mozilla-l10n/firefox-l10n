...
pdfjs-views-manager-paste-button-after-label = Pegar después de la página { $page }
pdfjs-views-manager-paste-button-before-label = Pegar antes de la primera página
