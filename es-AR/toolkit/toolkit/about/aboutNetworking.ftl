...
about-networking-ssl-tokens-summary-certs = Certificados almacenados: { $references } ({ $totalBytes } B), únicos: { $distinct } ({ $distinctBytes } B)
...
about-networking-ssl-tokens-new =
    .alt = Nuevo esta sesión
    .title = Nuevo esta sesión
...
about-networking-dns-https-rrs-lookup-table-column = RRs HTTPS
