...
details-notification-softblocked-extension-disabled =
    .message = Esta extensión viola las políticas de Mozilla y ha sido deshabilitada. Se puede habilitar, pero podría ser riesgoso.
...
details-notification-softblocked-other-disabled =
    .message = Este complemento viola las políticas de Mozilla y ha sido deshabilitado. Se puede habilitar, pero podría ser riesgoso.
