...
about-logging-preset-networking-http3-upload-speed-description = Módulos de registro para diagnosticar problemas de velocidad de subida de HTTP/3
...
about-logging-preset-webcodecs-description = Módulos de registro para diagnosticar problemas con decodificadores y codificadores de audio/video de WebCodecs y decodificadores de imágenes
...
about-logging-preset-webgpu-description = Módulos de registro para diagnosticar problemas con WebGPU
