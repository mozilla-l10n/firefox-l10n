...
pane-privacy-title2 = গোপনীয়তা & নিরাপত্তা
...
applications-setting =
    .label = অ্যাপ্লিকেশন
    .description = চয়ন করুন কিভাবে { -brand-short-name } ওয়েব থেকে ডাউনলোড করা ফাইলগুলিকে বা ব্রাউজ করার সময় আপনার ব্যবহৃত অ্যাপ্লিকেশানগুলিকে পরিচালনা করে।
