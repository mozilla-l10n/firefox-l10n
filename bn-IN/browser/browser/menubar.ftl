...
menu-tools-sync-sign-in =
    .label = { -sync-brand-short-name } সাইন ইন করুন…
    .accesskey = Y
menu-tools-sync-now =
    .label = অবিলম্বে সুসংগত করুন
    .accesskey = S
menu-tools-sync-re-auth =
    .label = { -sync-brand-short-name } সংযোগ করুন…
    .accesskey = R
...
menu-help-keyboard-shortcuts =
    .label = এবং কিবোর্ড শর্টকাট সমূহ
    .accesskey = K
