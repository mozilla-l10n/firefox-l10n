...
download-cert-message-desc = কোনো ধরনের কর্মের জন্য এই CA-টি বিশ্বাস করার পূর্বে এর সার্টিফিকেট, নিয়মনীতি ও কর্ম প্রণালী (উপলব্ধ হলে) পরীক্ষা করা বাঞ্ছনীয়।
...
set-password-window =
    .title = সার্টিফিকেট ব্যাক-আপ পাসওয়ার্ড নির্বাচন করুন
set-password-message = এই স্থানে স্থাপিত সার্টিফিকেট ব্যাক-আপ পাসওয়ার্ডের দ্বারা যে ব্যাক-আপ ফাইলটি নির্মাণ করা হবে তা সুরক্ষিত রাখা হবে।  ব্যাক-আপ কর্মে এগিয়ে যেতে হলে এই পাসওয়ার্ডটি নির্ধারণ করা আবশ্যক।
set-password-backup-pw =
    .value = সার্টিফিকেট ব্যাক-আপ পাসওয়ার্ড:
set-password-repeat-backup-pw =
    .value = সার্টিফিকেট ব্যাক-আপ পাসওয়ার্ড (পুনরায়):
set-password-reminder = গুরুত্বপূর্ণ: সার্টিফিকেট ব্যাক-আপ পাসওয়ার্ড হারিয়ে গেলে আপনি এই ব্যাক-আপ পুনরুদ্ধার করতে সক্ষম হবেন না। অনুগ্রহ করে এই পাসওয়ার্ডটি কোনো সুরক্ষিত স্থানে সংরক্ষণ করুন।
