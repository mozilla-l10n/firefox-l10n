...
default-browser-notification-message = <strong>Kas määrata { -brand-short-name } vaikebrauseriks?</strong> Kasuta kiiret, turvalist ja privaatset veebilehitsejat igal pool.
