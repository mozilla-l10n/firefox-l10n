...
default-browser-notification-privacy-header-text = Kas jääd { -brand-short-name }iga?
default-browser-notification-privacy-body-text = Sinu vaike-eelistus on muutunud. Sisseehitatud privaatsuse ja kaitse tagamiseks naase valiku { -brand-short-name } juurde.
...
default-browser-notification-privacy-no-button-text = Ei soovi
