...
fxa-menu-sync-your-data = Cydweddwch Eich Data
...
fxa-menu-sync-status-turn-on-button =
    .label = Troi Ymlaen
fxa-menu-sync-status-turn-on-button-aria-label = Troi Ymlaen
...
appmenuitem-monitor-title-signed-in = Rhybuddion Tor-data { -monitor-brand-short-name }
...
appmenuitem-relay-title-signed-in = Gweld Arallenwau E-bost
...
appmenuitem-vpn-description5 = Cael diogelwch ychwanegol ar draws dyfeisiau
...
appmenuitem-share-firefox-title2 = Rhannu { -brand-product-name }
# Button in the account menu that links to the Referrals page
