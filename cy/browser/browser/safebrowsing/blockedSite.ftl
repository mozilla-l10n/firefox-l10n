...
safeb-blocked-malware-page-short-desc = Mae { -brand-short-name } wedi atal y dudalen hon gan y gall geisio gosod meddalwedd drwg er mwyn drwyn neu ddileu manylion personol ar eich cyfrifiadur.
...
safeb-blocked-addon-page-learn-more3 = <a data-l10n-name='firefox_support_harmful_addons'>Dysgu rhagor am Ddiogelwch Ychwanegion Niweidiol { -brand-short-name }</a>.
