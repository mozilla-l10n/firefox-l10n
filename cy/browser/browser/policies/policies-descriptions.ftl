...
policy-DisableFormHistory = Peidio cofniio chwilio a hanes ffurflenni.
...
policy-Extensions = Gaosod, dadosod neu gloi estyniadau. Mae'r dewis gosod yn cymryd URL neu lwybrau fel paramedrau. Mae'r dewisiadau Dadosod a Chloi yn cymryd dynodiad estyniadau.
policy-FlashPlugin = Caniatau neu wrthod defnydd o'r ychwanegyn Flash.
...
policy-OfferToSaveLogins = Gorfodi'r gosodiad i ganiatau i { -brand-short-name } gynnig cofio mewngofnodion a chyfrineiriau wedi eu cadw. Mae gwerthoedd gwir a gau'n cael eu derbyn.
