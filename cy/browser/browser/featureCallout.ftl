...
fx-view-discoverability-title = Heb fwriadu cau'r tab hwnnw?
fx-view-discoverability-subtitle = Dewch o hyd iddo a'i ailagor yn gyflym yma. Rydym yn cadw hanes eich tabiau a gaewyd yn ddiweddar ar eich cyfer.
fx-view-discoverability-primary-button-label = Agor { -firefoxview-brand-name }
fx-view-discoverability-secondary-button-label = Cau
...
split-dismiss-button-show-fewer-option =
    .label = Dangos llai o argymhellion
...
login-status-advisory-title = Rydych wedi allgofnodi. Cliciwch ar eicon y cyfrif i fewngofnodi.

## Bookmarks toolbar callout strings

bookmarks-toolbar-callout-1-title = Ychwanegu'r wefan hon at eich bar offer nodau tudalen?
bookmarks-toolbar-callout-1-subtitle = Bydd eich nod tudalen yn cael ei gadw ychydig o dan y bar cyfeiriad ar gyfer mynediad cyflym.
bookmarks-toolbar-callout-1-primary-button-label = Ychwanegu nod tudalen
...
windows-10-eos-sync-new-device-subtitle-2 = Faint bynnag rydych yn defnyddio { -brand-short-name }, mae cydweddu'n diogelu eich nodau tudalen, cyfrineiriau a'ch gosodiadau.
...
tab-groups-2026-onboarding-callout-title = Twtio'r blerwch gyda grwpio tabiau
...
tab-groups-2026-onboarding-callout-subtitle = Grwpiwch eich tabiau yn ôl tasg neu bwnc. Llusgwch fwy i mewn wrth fynd.
...
tab-groups-2026-onboarding-cta-button = Cychwyn grŵp
...
sidebar-deprecation-callout-subtitle = Rydyn ni'n dod a'r bar ochr rydych chi'n ei ddefnyddio ar hyn o bryd i ben. Rhowch gynnig ar y bar ochr newydd. Mae'n gyflymach ac rydych chi'n cael mynediad at fwy o offer.
sidebar-deprecation-cta-button = Rhowch gynnig arno
...
pin-tabs-callout-1-title = Cadwch dabiau pwysig o fewn cyrraedd
pin-tabs-callout-1-subtitle = Llusgwch dab i ddechrau'r stribed tab i'w binio. Neu de-gliciwch a dewis Pinio Tab.
pin-tabs-callout-cta-1-button = Pinio'r tab hwn
...
sidebar-callout-survey-dissatisfied-2 = Anfodlon
sidebar-callout-survey-very-dissatisfied-2 = Anfodlon iawn
...
sidebar-callout-survey-saved-websites-2 = Mynediad cyflym i'ch nodau tudalen
