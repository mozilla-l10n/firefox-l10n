...
screenshots-connection-error-details = Gwiriwch eich cysylltiad Rhyngrwyd. Os ydych yn gallu cysylltu â'r Rhyngrwyd, efallai bod anhawster dros dro gyda gwasanaeth lluniau sgrin, Firefox Screnshots.
...
screenshots-private-window-error-title = Mae Screenshot wedi ei analluogi yn y Modd Pori Preifat
