...
upgrade-dialog-new-item-menu-description = Blaenoriaethu'r pethau pwysig i chi.
upgrade-dialog-new-item-tabs-title = Tabiau modern
upgrade-dialog-new-item-tabs-description = Cynnwys gwybodaeth yn daclus, cynnal ffocws a symudiadau hyblyg.
upgrade-dialog-new-item-icons-title = Eiconau ffres a negeseuon cliriach
upgrade-dialog-new-item-icons-description = Eich helpu chi i ddod o hyd i'ch ffordd gyda chyffyrddiad ysgafnach.
