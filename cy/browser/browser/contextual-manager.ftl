...
contextual-manager-passwords-origin-field =
    .label = Cyfeiriad Gwefan
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Rhowch yr union gyfeiriad lle byddwch yn mewngofnodi i'r wefan hon.
contextual-manager-passwords-username-field =
    .label = Enw Defnyddiwr
contextual-manager-passwords-username-field-description = Rhowch yr enw defnyddiwr, cyfeiriad e-bost, neu rif cyfrif rydych chi'n ei ddefnyddio i fewngofnodi.
contextual-manager-passwords-password-field =
    .label = Cyfrinair
contextual-manager-passwords-password-field-description = Rhowch y cyfrinair i fewngofnodi i'r cyfrif hwn.
