...
newtab-privacy-etp-off-faster-browsing = Pori cyflym. Llai o dracwyr.
newtab-privacy-etp-off-turn-on-tracking = Troi diogelwch rhag tracwyr ymlaen yn y gosodiadau i ddechrau rhwystro.
...
newtab-appearance-more-themes-button =
    .label = Gweld rhagor o themâu
# Title of the full theme selection sub-panel, also used as its back button label.
newtab-appearance-manage-title = Themâu { -brand-product-name }
# Header for the list of the user's already-installed themes in the full theme panel.
newtab-appearance-your-themes-header = Eich themâu
...
newtab-appearance-explore-more-themes-button = Edrych ar ragor o themâu
...
newtab-clock-city-us-new-york = Efrog Newydd
...
newtab-clock-city-mx-mexico-city = Dinas Mecsico
newtab-clock-city-mx-guadalajara = Guadalajara
newtab-clock-city-it-rome = Rhufain
newtab-clock-city-it-milan = Milan
newtab-clock-city-ru-moscow = Moscfa
newtab-clock-city-ru-saint-petersburg = St Petersburg
newtab-clock-city-gb-london = Llundain
...
newtab-clock-city-at-vienna = Fienna
...
newtab-clock-city-be-brussels = Brwsel
...
newtab-clock-city-sg-singapore = Singapôr
...
newtab-clock-city-ie-dublin = Dulyn
...
newtab-clock-city-vn-ho-chi-minh-city = Dinas Hô Chi Minh
