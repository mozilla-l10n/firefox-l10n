...
appearance-browser-icon-entry-group =
    .description = Dewiswch eicon cyfaddas ar gyfer eich bar tasgau, bwrdd gwaith a dewislen cychwyn.
    .label = Eicon porwr
appearance-browser-icon-button =
    .label = Newid eicon porwr
...
appearance-browser-icon-unlocked =
    .message = Rydych wedi datgloi pob un o'r eiconau bonws!
