...
settings-tabs-drag-to-create-tab-groups =
    .label = Llusgwch y tabiau at ei gilydd i greu grwpiau tabiau
...
data-collection-health-report-disabled =
    .label = Anfon data technegol a rhyngweithio at { -vendor-short-name }
    .accesskey = d
    .description = Mae adrodd ar ddata wedi ei atal ar gyfer ffurfweddiad y fersiwn yma.
...
data-collection-backlogged-crash-reports =
    .label = Anfon adroddiadau chwalu'n awtomatig
    .description = Mae hyn yn helpu i { -vendor-short-name } i ddarganfod a chywiro gwallau'r porwr. Gall adroddiadau gynnwys data personol neu sensitif.
    .accesskey = c
