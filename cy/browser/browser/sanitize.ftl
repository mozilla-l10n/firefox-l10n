...
item-site-prefs =
    ...
    .accesskey = G
item-formdata-prefs =
    .label = Manylion ffurflen wedi'i chadw
    .accesskey = M
item-formdata-description = Yn clirio pethau fel enwau, e-byst, ac eitemau eraill rydych chi'n eu nodi ar ffurflenni
...
sanitize-calculating-size = Wrthi'n cyfrifo…
