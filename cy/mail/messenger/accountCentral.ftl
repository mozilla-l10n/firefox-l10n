...
addressbook-description = Mae { -brand-short-name } yn caniatáu i chi drefnu'ch holl gysylltiadau mewn llyfr cyfeiriadau. Gallwch hefyd gysylltu â llyfr cyfeiriadau o bell i gydweddu'ch holl gysylltiadau.
feeds-label = Llif
    .aria-label = Cysylltu â llifau
feeds-description = Mae { -brand-short-name } yn gadael i chi gysylltu â phorthwyr RSS / Atom i gael newyddion a diweddariadau o bob man.
newsgroups-label = Grwpiau Newyddion
    .aria-label = Cysylltu â grŵp newyddion
newsgroups-description = Mae { -brand-short-name } yn gadael i chi gysylltu â'r holl grwpiau newyddion yr hoffech chi
import-title = Mewnforio o Raglen Arall
import-paragraph = Mae { -brand-short-name } yn caniatáu i chi fewnforio negeseuon e-bost, cofnodion llyfr cyfeiriadau, tanysgrifiadau llif, dewisiadau, a/neu hidlwyr o raglenni e-bost eraill a fformatau llyfrau cyfeiriadau cyffredin.
...
about-paragraph-2 = Mae <b>Thunderbird yn cael ei ariannu gan ddefnyddwyr fel chi! Os ydych chi'n hoff o Thunderbird, ystyriwch roi rhodd.</b> Y ffordd orau i chi sicrhau bod Thunderbird yn parhau i fod ar gael yw
about-donation = i wneud rhodd
