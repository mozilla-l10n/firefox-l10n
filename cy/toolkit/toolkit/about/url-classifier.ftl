...
url-classifier-cache-title = Storfa
url-classifier-cache-refresh-btn = Adnewyddu
url-classifier-cache-clear-btn = Clirio
url-classifier-cache-table-name = Enw tabl
url-classifier-cache-ncache-entries = Nifer o gofnodion storfa negyddol
url-classifier-cache-pcache-entries = Nifer o gofnodion storfa negyddol
url-classifier-cache-show-entries = Dangos y cofnodion
url-classifier-cache-entries = Cofnodion Storfa
url-classifier-cache-prefix = Rhagddodiad
url-classifier-cache-ncache-expiry = Storfa negyddol yn dod i ben
url-classifier-cache-fullhash = Hash llawn
url-classifier-cache-pcache-expiry = Storfa positif yn dod i ben
