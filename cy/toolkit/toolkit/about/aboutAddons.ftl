...
plugins-openh264-description = Mae'r ategyn hwn yn cael ei osod yn awtomatig gan Mozilla er mwyn cyd-fynd â manyleb y WebRTC ac i alluogi galwadau WebRTC gyda dyfeisiau sydd angen y codec fideo H.264. Ewch i https://www.openh264.org/ i weld y cod ffynhonnell a darllen rhagor am ei ddefnyddio.
...
find-more-addons-promo =
    .heading = Siapio { -brand-product-name } yn l eich angen
...
aboutaddons-linux-theme-colors-checkbox-label =
    .label = Defnyddio thema system Linux
