...
# Warning given to the user that the current page is trying to open their digital wallet app
wallet-custom-scheme-warning-host = Mae agor dolen <strong>{ $scheme }</strong> yn caniatáu i <strong>{ $host }</strong> ofyn am eich hunaniaeth go iawn gyda <strong>{ $appName }</strong>. Ewch yn eich blaen dim ond os ydych yn ymddiried yn y wefan hon.
# Warning given to the user that the current page is trying to open their digital wallet app
