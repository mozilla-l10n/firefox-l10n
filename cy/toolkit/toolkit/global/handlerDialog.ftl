...
# Warning given to the user that the current page is trying to open their digital wallet app
wallet-custom-scheme-warning-host = Mae agor dolen <strong>{ $scheme }</strong> yn caniatáu i'r wefan hon ofyn am eich hunaniaeth go iawn gyda <strong>{ $host }</strong>. Ewch yn eich blaen dim ond os ydych yn ymddiried yn y wefan hon.
# Warning given to the user that the current page is trying to open their digital wallet app
wallet-custom-scheme-warning = Mae agor dolen <strong>{ $scheme }</strong> yn caniatáu i'r wefan hon ofyn am eich hunaniaeth go iawn o'ch waled ddigidol. Ewch yn eich blaen dim ond os ydych yn ymddiried yn y wefan hon.
...
mailto-handler-picker-window =
    .style = min-width: 26em; min-height: 26em;
    .title = Dewiswch eich ap e-bost
mailto-handler-picker-subtitle = Dewiswch yr ap yr hoffech ei ddefnyddio ar gyfer dolenni e-bost. Gallwch newid hyn yn ddiweddarach yn y Gosodiadau.
...
mailto-handler-picker-always-ask = Gofyn i mi bob amser pan fyddaf yn clicio ar ddolen e-bost
