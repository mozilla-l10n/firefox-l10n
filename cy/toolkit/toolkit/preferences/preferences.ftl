...
set-password-old =
    .label = Cyfrinair cyfredol:
set-password-new =
    .label = Rhoi'r cyfrinair newydd:
set-password-reenter =
    .label = Rhoi'r cyfrinair eto:
...
remove-primary-password-info =
    .value = Rhaid i chi roi'ch cyfrinair presennol i fynd yn eich blaen.
remove-info =
