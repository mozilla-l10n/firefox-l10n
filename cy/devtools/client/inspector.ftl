...
colorpicker-tooltip-spectrum-dragger-title = Sbectrwm
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = Dewiswch liw ar y dudalen
...
colorpicker-tooltip-color-name-title = Yr agosaf at: { $colorName }
