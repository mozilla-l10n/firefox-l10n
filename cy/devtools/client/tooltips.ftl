...
inactive-css-not-absolutely-positioned-item = Dyw <strong>{ $property }</strong> ddim yn effeithio ar yr elfen hon gan nad yw'n elfen wedi'i lleoli'n llwyr.
inactive-css-no-default-anchor = Does gan <strong>{ $property }</strong> ddim effaith ar yr elfen hon gan nad oes ganddi elfen angori rhagosodedig.
...
inactive-css-not-absolutely-positioned-item-fix = Ceisiwch ychwanegu <strong>position:absolute</strong> i'r elfen. { learn-more }
inactive-css-no-default-anchor-fix = Ceisiwch ychwanegu <strong>position-anchor</strong> gydag enw angor dilys. { learn-more }
