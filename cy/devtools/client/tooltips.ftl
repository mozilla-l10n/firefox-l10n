...
inactive-css-not-block-flex-grid-container = Does gan <strong>{ $property }</strong> ddim effaith ar yr elfen hon oherwydd ei fod yn berthnasol i elfennau lefel bloc, fflecs a chynhwysydd grid yn unig yn unig.
