...
about-debugging-page-title-runtime-page = නිදොස්කරණය - ධාවන කාලය / { $selectedRuntimeId }
...
about-debugging-sidebar-this-firefox2 = මෙම { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = මෙම { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = පිහිටුවීම
