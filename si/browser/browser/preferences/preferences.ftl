...
httpsonly-description2 = { -brand-short-name } ඔබ ගොඩවදින අඩවි වලට ආරක්‍ෂිත සහ සංකේතිත සම්බන්ධතා සාදයි. HTTPS-පමණි සක්‍රිය විට සම්බන්ධතාවක් ආරක්‍ෂිත නැතිනම් { -brand-short-name } ඔබට අනතුරු අඟවයි.
