...
ssl-error-feature-not-supported-for-ssl2 = SSL 2.0 සම්බන්ධතා සඳහා SSL විශේෂාංගය සහය නොදක්වයි.
ssl-error-feature-not-supported-for-servers = සේවාදායක සඳහා SSL විශේෂාංගය සහය නොදක්වයි.
ssl-error-feature-not-supported-for-clients = අනුග්‍රාහක සඳහා SSL විශේෂාංගය සහය නොදක්වයි.
...
ssl-error-feature-not-supported-for-version = කෙටුම්පත් අනුවාදය සඳහා SSL විශේෂාංගය සහය නොදක්වයි.
ssl-error-rx-unexpected-cert-status = අතට අත දීමේ සහතික තත්ත්‍වයක අනපේක්‍ෂිත පණිවිඩයක් SSL වෙත ලැබුණි.
sec-error-bad-data = ආරක්‍ෂණ පුස්තකාලය: නරක දත්ත ලැබුණි.
sec-error-output-len = ආරක්‍ෂණ පුස්තකාලය: ප්‍රතිදාන දිගහි දොෂයකි.
...
sec-error-invalid-key = යතුර ඉල්ලා සිටින මෙහෙයුමට සහය නොදක්වයි.
...
sec-error-not-fortezza-issuer = ෆෝර්ට්සා සාමාන දාමයට ෆෝර්ට්සා නොවන සහතිකයක් ඇත.
