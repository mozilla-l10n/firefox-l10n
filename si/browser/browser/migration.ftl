...
import-from-opera-gx =
    .label = ඔපෙරා GX
    .accesskey = G
no-migration-sources = පොත්යොමු, ඉතිහාසය හෝ මුරපද දත්ත අඩංගු කිසිදු වැඩසටහනක් හමු නොවුණි.
...
imported-safari-reading-list = කියවීමේ ලැයිස්තුව (සෆාරි වෙතින්)
imported-edge-reading-list = කියවීමේ ලැයිස්තුව (එඩ්ගේ වෙතින්)
