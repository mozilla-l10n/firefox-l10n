...
screenshots-connection-error-details = ඔබගේ අන්තර්ජාල සම්බන්ධතාව පරීක්‍ෂා කරන්න. සම්බන්ධ වීමට හැකි නම්, { -screenshots-brand-name } තිරසේයා සේවාවේ තාවකාලික ගැටලුවක් විය හැකිය.
