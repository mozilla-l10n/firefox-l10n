...
refresh-unused-profile-infobar-message = ඔබ කලකින් { -brand-short-name } විවෘත කර නැති සෙයකි. ඔබට නැවුම් සහ අළුත් අත්දැකීමක් සඳහා පිරිසිදු කිරීමට වුවමනා ද? කෙසේ වුවත්, නැවත සාදරයෙන් පිළිගන්නෙමු!
