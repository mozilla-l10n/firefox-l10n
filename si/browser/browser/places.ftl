...
places-forget-domain-data =
    .label = මෙම අඩවිය අමකත කරන්න
    .accesskey = F
places-sortby-name =
    .label = නම අනුව වර්ගනය
    .accesskey = r
...
places-locked-prompt = පොත්යොමු හා ඉතිහාස පද්ධතිය ක්‍රියාකාරී නොවනු ඇත. මන්ද, වෙනත් යෙදුමක් { -brand-short-name } ගොනු වලින් එකක් භාවිතා කරයි. සමහර ආරක්‍ෂණ මෘදුකාංග මෙයට හේතු වේ.
