...
settings-update-checking-for-updates =
    .label = යාවත්කාල පරීක්‍ෂා කෙරෙමින්...
...
settings-update-unsupported = ඔබට මෙම පද්ධතිය මත තවදුරටත් යාවත්කාල කිරීමට නොහැකිය. <a data-l10n-name="unsupported-link">තව දැනගන්න</a>
...
settings-update-internal-error = අභ්‍යන්තර දෝෂයක් හේතුවෙන් යාවත්කාල පරීක්‍ෂා කිරීමට නොහැකිය. <a data-l10n-name="manual-link">{ $displayUrl }</a> හි යාවත්කාල තිබේ
