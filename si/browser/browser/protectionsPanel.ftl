...
protections-panel-tracking-content = ලුහුබැඳීමේ කේත සමඟින් අඩවි බාහිර දැන්වීම්, දෘශ්‍යක සහ අනෙකුත් අන්තර්ගත පූරණය කරනු ඇත. ලුහුබැඳීමේ අන්තර්ගත අවහිර කිරීමෙන් අඩවි වේගයෙන් පූරණය වීමට උපකාරී වේ, නමුත් ඇතැම් බොත්තම්, ආකෘතිපත්‍ර හා පිවිසුම් ක්‍ෂේත්‍ර ක්‍රියා නොකරනු ඇත.
