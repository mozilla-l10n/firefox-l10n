...
profile-creation-explanation-2 = ඔබ මෙම { -brand-short-name } පිටපත තවත් අය සමඟ හවුලේ භාවිතා කරයි නම්, පරිශ්‍රීලක තොරතුරු වෙන්ව තබා ගැනීම සඳහා ඔබට පැතිකඩ භාවිතා කළ හැකිය. ඒ සඳහා සෑම අයෙක්ම තමන්ගේ පැතිකඩක් සෑදිය යුතුය.
...
profile-default-name =
    .value = පෙරනිමි පරිශ්‍රීලක
profile-directory-explanation = ඔබගේ පරිශ්‍රීලක සැකසුම්, අභිප්‍රේත සහ අනෙකුත් පරිශ්‍රීලක-ආශ්‍රිත දත්ත ගබඩා වන්නේ:
