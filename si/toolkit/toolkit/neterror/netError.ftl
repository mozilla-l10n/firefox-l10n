...
fp-neterror-denied-port-access = මෙම ලිපිනය වියමන පිරික්සීමට සාමාන්‍යයෙන් භාවිතා නොකරන තොටක් භාවිතා කරයි. ඔබගේ ආරක්‍ෂාව සඳහා { -brand-short-name } එම ඉල්ලීම අවලංගු කරන ලදි.
