...
ssl-error-close-notify-alert = SSL සාමානය මෙම සම්බන්ධතාව වසා ඇත.
...
ssl-error-session-not-found = අනුග්‍රාහකයේ SSL වාර හැඳු. සේවාදායකයේ වාර නිහිතයේ හමු නොවුණි.
...
ssl-error-user-canceled-alert = සාමානය පරිශ්‍රීලකයා අතට අත දීම අවලංගු කළා.
...
sec-error-untrusted-issuer = පරිශ්‍රීලකයා විසින් සාමානයේ සහතික නිකුත්කරු විශ්වාස නොකරන බව යොදා ඇත.
sec-error-untrusted-cert = පරිශ්‍රීලකයා විසින් සාමානයේ සහතිකය විශ්වාස නොකරන බව යොදා ඇත.
...
sec-error-no-key = මෙම සහතිකය සඳහා පෞද්. යතුර ප්‍රධාන දත්ත සමුදායේ හමු නොවුණි
...
sec-error-not-a-recipient = විසංකේතනය කළ නොහැකිය: ඔබ ලබන්නෙකු නොවේ, හෝ ගැළපෙන සහතිකය හා පෞද්. යතුර හමු නොවුණි.
...
sec-error-no-krl = මෙම අඩවියේ සහතිකය සඳහා KRL හමු නොවුණි.
...
sec-error-user-cancelled = පරිශ්‍රීලකයා අවලංගු කිරීම ඔබා ඇත.
...
sec-error-unknown-cert = ඉල්ලූ සහතිකය හමු නොවුණි.
sec-error-unknown-signer = අත්සන්කරුගේ සහතිකය හමු නොවුණි.
...
mozilla-pkix-error-inadequate-key-size = සේවාදායකය ආරක්‍ෂිත සම්බන්‍ධතාවක් පිහිටුවීමට ප්‍රමාණවත් නොවන යතුරක් සහිත සහතිකයක් ඉදිරිපත් කර ඇත.
