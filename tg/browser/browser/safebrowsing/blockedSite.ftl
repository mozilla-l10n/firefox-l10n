...
safeb-blocked-phishing-page-short-desc = { -brand-short-name } ин саҳифаро манъ кард, зеро ки он метавонад шуморо фиреб карда, чизе хатарнокро иҷро намояд, масалан, насб кардани нармафзор ё ошкор кардани маълумоти шахсӣ монанди ниҳонвожаҳо ё кортҳои қарзӣ.
...
safeb-blocked-harmful-page-short-desc = { -brand-short-name } ин саҳифаро манъ кард, зеро ки он метавонад барномаҳои хатарнокеро насб намояд, ки метавонанд маълумоти шуморо дуздӣ кунанд ё нест намоянд (барои мисол, суратҳо, ниҳонвожаҳо, паёмҳо ва кортҳои қарзӣ).
...
safeb-blocked-malware-page-learn-more-sumo = Дар бораи Муҳофизати { -brand-short-name } аз иттиоъдуздӣ ё нармафзори зарарнок аз сомонаи <a data-l10n-name='firefox_support'>support.mozilla.org</a> маълумоти бештар гиред.
