...
safeb-blocked-malware-page-title = Тамошобинии ин сомона метавонад ба компютери шумо зарар расонад
...
safeb-blocked-addon-page-title = Сомона барои бехатарии шумо манъ шудааст
...
safeb-blocked-unwanted-page-short-desc = «{ -brand-short-name }» ин саҳифаро манъ кард, зеро ки он метавонад шуморо фиреб карда, нармафзореро насб намояд, ки метавонад ба таҷрибаи тамошобинии шумо ҳалал расонад (барои мисол, саҳифаи асосии шуморо иваз кунад ё рекламаи иловагиро дар сомонаҳое, ки шумо тамошо мекунед, нишон диҳад).
...
safeb-blocked-addon-page-short-desc = Браузери «{ -brand-short-name }» ин саҳифаро манъ кард, зеро яке аз ҷузъҳои иловагии насбшуда кӯшиш кард, ки онро кушояд. Ин сомона метавонад барои ба даст овардани маълумоти шахсии шумо, аз он ҷумла, ниҳонвожаҳо ё рақамҳои кортҳои бонкӣ, истифода карда шавад.
# Variables:
