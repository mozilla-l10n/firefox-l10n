...
tabbrowser-tab-label-tab-split-view-left = { $label }, Намоиши тақсимшуда аз тарафи чап
# Split view tabs display their respective contents side by side
...
# Variables:
#   $label (String): the text label of the tab visible in the tab strip
tabbrowser-tab-label-tab-split-view-right = { $label }, Намоиши тақсимшуда аз тарафи рост
