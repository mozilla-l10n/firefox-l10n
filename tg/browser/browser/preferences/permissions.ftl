...
permissions-site-notification-disable-desc = Ин амал ҳамаи сомонаҳоеро, ки дар рӯйхати бодо вуҷуд надоранд, аз дархости иҷозат барои фиристодани огоҳиномаҳо пешгирӣ мекунад. Амали манъкунии огоҳиномаҳо метавонад баъзе хусусиятҳои сомонаро вайрон кунад.
