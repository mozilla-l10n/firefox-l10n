...
settings-update-checking-for-updates =
    .label = Дар ҳоли санҷиши навсозиҳо…
...
settings-update-unsupported = Шумо дар низоми ҷорӣ навсозиҳои дигар иҷро карда наметавонед. <a data-l10n-name="unsupported-link">Маълумоти бештар</a>
update-restarting = Дар ҳоли бозоғозӣ…
settings-update-restarting =
    .label = Дар ҳоли бозоғозӣ…
...
settings-update-internal-error = Ба сабаби хатои дохилӣ, тафтиш кардани навсозиҳо имконнопазир аст. Навсозиҳо дар <a data-l10n-name="manual-link">{ $displayUrl }</a> дастрасанд.
...
helpus-referrals2 = Мехоҳед, ки ба мо кумак расонед? <label data-l10n-name="helpus-donateLink">Хайрия кунед</label>, браузери «<label data-l10n-name="helpus-shareFirefoxLink">{ -brand-product-name }</label>»-ро мубодила кунед, ё <label data-l10n-name="helpus-getInvolvedLink">дар лоиҳаҳои мо иштирок намоед!</label>
