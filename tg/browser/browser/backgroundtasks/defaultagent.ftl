...
default-browser-notification-privacy-header-text = Бо «{ -brand-short-name }» идома медиҳед?
default-browser-notification-privacy-body-text = Браузери пешфарзи шумо иваз карда шуд. Барои махфияти дарунсохт ва муҳофизат, браузери «{ -brand-short-name }»-ро аз нав ба кор дароред.
...
default-browser-notification-privacy-no-button-text = Не, ташаккур
