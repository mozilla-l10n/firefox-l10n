...
preonboarding-checklist-crash-reports-label = Ба таври худкор фиристодани гузоришҳо дар бораи вайронӣ
preonboarding-checklist-crash-reports-description = Гузоришҳо дар бораи вайронӣ ба мо барои ташхис ва ислоҳ кардани хатоҳои браузер имкон медиҳанд. Гузоришҳо метавонанд маълумоти шахсӣ ва махфиро дар бар гиранд.
