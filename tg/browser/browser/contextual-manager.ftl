...
contextual-manager-passwords-origin-field =
    .label = Нишонии сомона
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Нишонии дақиқеро, ки шумо аз он ба ин сомона ворид мешавед, ворид намоед.
contextual-manager-passwords-username-field =
    .label = Номи корбар
contextual-manager-passwords-username-field-description = Номи корбар, нишонии почтаи электронӣ ё рақами ҳисоберо, ки шумо барои воридшавӣ истифода мебаред, ворид намоед.
contextual-manager-passwords-password-field =
    .label = Ниҳонвожа
contextual-manager-passwords-password-field-description = Барои ворид шудан ба ин ҳисоб ниҳонвожаро ворид намоед.
