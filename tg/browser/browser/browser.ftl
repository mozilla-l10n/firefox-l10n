...
browser-shortcut-description = Тамошобинии тезкор ва хусусӣ дар Интернет
# These are the default window titles everywhere except macOS.
# .data-title-default and .data-title-private are used when the web content
# opened has no title:
#
...
urlbar-view-context-menu-open-in-private-window =
    ...
    .accesskey = К
urlbar-view-context-menu-open-in-tab2 = Кушодан дар варақаи нав
    .accesskey = К
urlbar-view-context-menu-open-in-container-tab2 = Кушодан дар варақаи нави дарбаргиранда
    .accesskey = К
urlbar-view-context-menu-open-in-window2 = Кушодан дар равзанаи нав
    .accesskey = К
urlbar-view-context-menu-open-in-private-window2 = Кушодан дар равзанаи хусусии нав
    .accesskey = К
