...
monitor-header-content-no-account = Барномаи { -monitor-brand-name } озмоед ва бинед, агар маълумоти шумо байни маълумоти дуздида бошад, ва дар бораи вайронкуниҳои нав бохабар бошед.
