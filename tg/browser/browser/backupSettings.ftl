...
settings-data-backup-toggle-off2 =
    .label = Хомӯш кардани нусхаи эҳтиётӣ
...
settings-data-backup-scheduled-backups-on2 =
    .label = Нусхаи эҳтиётӣ «ФАЪОЛ» аст
settings-data-backup-scheduled-backups-off2 =
    .label = Нусхаи эҳтиётӣ «ҒАЙРИФАЪОЛ» аст
# "Location" refers to the folder where backups are being written to.
settings-data-backup-last-backup-location2 =
    .label = Ҷойгиршавии нусхаи эҳтиётӣ
...
restore-from-backup-support-link1 = Кадом маълумот барқарор карда мешавад?
