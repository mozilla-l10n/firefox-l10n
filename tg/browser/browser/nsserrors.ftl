...
ssl-error-encryption-failure = Алгоритми рамзгузории маҷмуи маълумот дар маҷмӯаи рамзҳои интихобшуда иҷро карда натавонист.
ssl-error-decryption-failure = Алгоритми рамзкушоии маҷмуи маълумот дар маҷмӯаи рамзҳои интихобшуда иҷро карда натавонист.
