...
policy-BackgroundAppUpdate2 = Хизмати навсозии пасзаминаиро фаъол ё ғайрифаъол мекунад.
...
policy-DisablePocket = Хусусиятро барои нигоҳ доштани саҳифаҳои сомона ба «Pocket» ғайрифаъол мекунад.
...
policy-Preferences = Қиматро барои зермаҷмӯи хусусиятҳо танзим ва бетағйир мекунад.
