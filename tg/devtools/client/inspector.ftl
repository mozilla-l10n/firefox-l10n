...
colorpicker-tooltip-eyedropper-title = Рангеро аз саҳифа интихоб намоед
...
colorpicker-tooltip-color-name-title = Наздиктарин ба: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Тобиши ҷило
# A title text for the alpha slider in the color picker tooltip.
colorpicker-tooltip-alpha-slider-title = Шаффофӣ
