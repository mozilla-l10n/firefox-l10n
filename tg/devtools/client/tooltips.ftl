...
devtools-tooltip-learn-more = Маълумоти бештар
...
inactive-css-not-grid-or-absolutely-positioned-item-fix = Кӯшиш кунед, ки «<strong>position:absolute</strong>»-ро ба унсур илова кунед ё «<strong>display:grid</strong>» ё «<strong>display:inline-grid</strong>» -ро ба асли унсур илова намоед. { learn-more }
...
inactive-css-not-grid-or-flex-container-fix-1 = Кӯшиш кунед, ки <strong>display:grid</strong> ё <strong>display:flex</strong>-ро илова намоед.
inactive-css-not-grid-or-flex-or-block-container-fix-1 = Кӯшиш кунед, ки <strong>display:grid</strong>, <strong>display:flex</strong> ё <strong>display:block</strong>-ро илова намоед.
...
inactive-text-overflow-when-no-overflow-fix-1 = Кӯшиш кунед, ки <strong>overflow:hidden</strong>-ро илова намоед.
inactive-css-no-size-containment-fix-1 = Кӯшиш кунед, ки хусусияти <strong>display</strong>-и онро ба ягон хусусияти дигар, ба ғайр аз <strong>none</strong>, <strong>contents</strong>, <strong>table</strong> ё <strong>inline-table</strong> таъин кунед ва боварӣ ҳосил кунед, ки он дар ҳудуди ҷадвали «table» ё қисмати «ruby» намебошад.
inactive-css-not-for-internal-table-elements-fix-1 = Кӯшиш кунед, ки хусусияти <strong>display</strong>-и онро ба хусусияте танзим кунед, ки аз <strong>table-cell</strong>, <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong> ё <strong>table-footer-group</strong> фарқ мекунад.
inactive-css-not-for-internal-table-elements-except-table-cells-fix-1 = Кӯшиш кунед, ки хусусияти <strong>display</strong>-и онро ба хусусияте танзим кунед, ки аз <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong> ё <strong>table-footer-group</strong> фарқ мекунад.
inactive-css-not-table-fix-1 = Кӯшиш кунед, ки <strong>display:table</strong> ё <strong>display:inline-table</strong>-ро илова намоед.
inactive-css-collapsed-table-borders-fix-1 = Кӯшиш кунед, ки <strong>border-collapse:separate</strong>-ро илова намоед.
inactive-css-not-table-cell-fix-1 = Кӯшиш кунед, ки «<strong>display:table-cell</strong>»-ро илова намоед.
inactive-scroll-padding-when-not-scroll-container-fix-1 = Кӯшиш кунед, ки <strong>overflow:auto</strong>, <strong>overflow:scroll</strong> ё <strong>overflow:hidden</strong>-ро илова намоед.
inactive-css-border-image-fix-1 = Дар унсури ҷадвали аслӣ, хусусиятро тоза кунед ё қимати <strong>border-collapse</strong>-ро ба қимате иваз кунед, ки аз <strong>collapse</strong> фарқ мекунад.
inactive-css-resize-fix-1 = Кӯшиш кунед, ки <strong>overflow</strong>-ро ба қимати ғайр аз <strong>visible</strong> таъин кунед ё унсури ивазшудаеро, ки онро дастгирӣ мекунад, равона кунед.
