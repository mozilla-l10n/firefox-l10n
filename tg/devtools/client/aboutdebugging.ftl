...
about-debugging-sidebar-this-firefox2 = Ин { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Ин { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Танзимкунӣ
...
# runtimes.
about-debugging-runtime-profile-button2 = Профили самаранокӣ
