...
third-party-warning-icon =
    .title = «{ -brand-short-name }» дар ин рамз аз ин модул вайрон шудааст
...
third-party-requires-restart = «{ -brand-short-name }» бояд аз нав оғоз карда шавад, то ки вазъияти модулҳои тарафҳои сеюми манъшуда иваз карда шавад.
...
third-party-should-restart-ok = «{ -brand-short-name }» ҳозир аз нав оғоз карда шавад
