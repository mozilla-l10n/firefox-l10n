...
certerror-expired-cert-second-para = Чунин менамояд, ки муҳлати гувоҳиномаи сомона ба анҷом расид, ва аз ин сабаб ба { -brand-short-name } барои танзими пайвасти бехатар имкон намедиҳад. Агар шумо ба ин сомона ворид шавед, ҳамлакунандагон метавонанд маълумоти шуморо монанди ниҳонвожаҳо, нишониҳои почтаи электронӣ ё тафсилоти корти кредитӣ дуздӣ кунанд.
certerror-expired-cert-sts-second-para = Чунин менамояд, ки муҳлати гувоҳиномаи сомона ба анҷом расид, ва аз ин сабаб ба { -brand-short-name } барои танзими пайвасти бехатар имкон намедиҳад.
