...
neterror-dns-not-found-trr-third-party-warning = Шумо метавонед кори худро бо ҳалкунандаи DNS, ки бехатар намебошад, идома диҳед. Аммо, дар ин ҳолат, тарафи сеюм метавонад ҳамаи он сомонаҳоеро, ки шумо тамошо мекунед, аз назар гузаронад.
