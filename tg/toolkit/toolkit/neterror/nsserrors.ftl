...
ssl-error-bad-cert-hash-value-alert = Ҳамсони SSL дар бораи қимати нодурусти маълумоти тасодуфии гувоҳинома гузориш дод.
...
sec-error-libpkix-internal = Ҳангоми санҷиши эътибори гувоҳинома хатои дохилии «Libpkix» ба миён омад.
...
sec-error-bad-info-access-method = Тарзи номаълум барои дастрасӣ ба иттилоот дар васеъшавии гувоҳинома.
...
sec-error-cert-signature-algorithm-disabled = Гувоҳинома ба воситаи алгоритми имзое, ки аз боиси хатарнокии он ғайрифаъол шуд, ба имзо расид.
mozilla-pkix-error-key-pinning-failure = Сервер аз васлгарии калидҳо (HPKP) истифода мебарад, аммо ягон занҷири гувоҳиномаҳои боэътиборе, ки ба маҷмӯаи васлгарӣ мувофиқат мекунад, эҷод карда нашуд. Номувофиқат дар васлгарии калидҳо ба кор бурда намешавад.
mozilla-pkix-error-ca-cert-used-as-end-entity = Сервер аз гувоҳинома бо васеъшавии маҳдудиятҳои асосӣ истифода мебарад ва онро ҳамчун мақомоти иҷозатномадиҳанда муайян мекунад. Гувоҳиномаи баровардашудаи дуруст ҳамин хел бояд набошад.
mozilla-pkix-error-inadequate-key-size = Сервер гувоҳиномаеро пешниҳод кард, ки андозаи калиди он барои таъсис кардани пайвасти бехатар хеле хурд аст.
mozilla-pkix-error-v1-cert-used-as-ca = Гувоҳиномаи X.509 бо версияи 1, ки лангари боэътимод намебошад, барои баровардани гувоҳиномаи сервер истифода шудааст. Гувоҳиномаҳои X.509 бо версияи 1 аллакай куҳна шудаанд ва барои имзо кардани гувоҳиномаҳои дигар бояд истифода карда нашаванд.
mozilla-pkix-error-not-yet-valid-certificate = Сервер гувоҳиномаеро пешниҳод кард, ки то ҳол беэътибор аст.
mozilla-pkix-error-not-yet-valid-issuer-certificate = Гувоҳиномае, ки то ҳол беэътибор аст, барои баровардани гувоҳиномаи сервер истифода шудааст.
mozilla-pkix-error-signature-algorithm-mismatch = Алгоритми имзо дар сатри имзои гувоҳинома ба алгоритм дар сатри он бо қимати «signatureAlgorithm» мувофиқат намекунад.
