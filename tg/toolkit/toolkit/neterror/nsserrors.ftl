...
mozilla-pkix-error-key-pinning-failure = Сервер аз васлгарии калидҳо (HPKP) истифода мебарад, аммо ягон занҷири гувоҳномаҳои боэътиборе, ки ба маҷмӯаи васлгарӣ мувофиқат мекунад, эҷод карда нашуд. Номувофиқат дар васлгарии калидҳо ба кор бурда намешавад.
