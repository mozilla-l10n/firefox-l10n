...
reset-primary-password-text = Агар шумо ниҳонвожаи асосии худро аз нав танзим кунед, ҳамаи ниҳонвожаҳои нигоҳдошташудаи шумо барои сомонаҳо ва почтаи электронӣ, гувоҳиномаҳои шахсӣ ва калидҳои махфӣ гум карда мешаванд. Шумо мутмаин ҳастед, ки мехоҳед ниҳонвожаи асосии худро аз нав танзим кунед?
...
download-cert-message-desc = Пеш аз он ки шумо бо ягон мақсад ба ин мақомоти иҷозатномадиҳанда бовар кунед, шумо бояд гувоҳиномаи он, сиёсати он ва равандҳои онро (агар дастрас бошанд) тафтиш кунед.
...
set-password-message = Ниҳонвожаи нусхаи эҳтиётии гувоҳиномае, ки шумо дар ин ҷо танзим кардед, файли нусхаи эҳтиётиеро, ки шумо эҷод мекунед, муҳофизат мекунад. Барои эҷод кардани нусхаи эҳтиётӣ шумо бояд ин ниҳонвожаро танзим кунед.
set-password-backup-pw =
    .value = Ниҳонвожаи нусхаи эҳтиётии гувоҳинома:
set-password-repeat-backup-pw =
    .value = Ниҳонвожаи нусхаи эҳтиётии гувоҳинома (такроран):
set-password-reminder = Диққат: Агар шумо ниҳонвожаи нусхаи эҳтиётии гувоҳиномаи худро фаромӯш кунед, шумо дигар наметавонед, ки ин нусхаи эҳтиётиро барқарор созед. Лутфан, онро сабт карда, дар ҷойи бехатар нигоҳ доред.
...
protected-auth-alert = Лутфан, санҷиши ҳаққониятро бо токени «{ $tokenName }» иҷро намоед. Тазри иҷрокунии ин амал аз токен вобаста аст (барои мисол, ба воситаи хонандаи изи ангуштон ё воридкунии рамз ба воситаи клавиатураи рақамӣ).
