...
pkcs12-info-no-smartcard-backup = Эҷод кардани нусхаи эҳтиётии гувоҳиномаҳо аз дастгоҳи амнияти сахтафзор, монанди корти ҳушманд, имконнопазир аст.
pkcs12-dup-data = Гувоҳинома ва калиди махфӣ аллакай дар дастгоҳи амният вуҷуд дорад.
...
import-ca-certs-prompt = Файлеро, ки дорои гувоҳинома(ҳо)и маркази иҷозатномадиҳӣ мебошад, барои воридот интихоб намоед
import-email-cert-prompt = Файлеро, ки дорои гувоҳиномаи почтаи электронӣ мебошад, барои воридот интихоб намоед

## For editing certificates trust

# Variables:
#   $certName: the name of certificate
edit-trust-ca = Гувоҳиномаи «{ $certName }» мақомоти иҷозатномадиҳандаро ифода мекунад.
