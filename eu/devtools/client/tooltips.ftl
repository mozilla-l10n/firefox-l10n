...
inactive-css-not-absolutely-positioned-item = <strong>{ $property }</strong> propietateak ez du eraginik elementu honetan ez delako modu absolutuan kokatutako elementua.
inactive-css-no-default-anchor = <strong>{ $property }</strong> propietateak ez du eraginik elementu honetan ez duelako aingura-elementu lehenetsirik.
...
inactive-css-not-absolutely-positioned-item-fix = Saiatu elementuari <strong>position:absolute</strong> gehitzen. { learn-more }
inactive-css-no-default-anchor-fix = Saiatu <strong>position-anchor</strong> gehitzen baliozko aingura-izen batekin. { learn-more }
...
css-selector-container-query-condition-no-container = Ez da '{ $name }' izeneko edukiontzirik aurkitu
