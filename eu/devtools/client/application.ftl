...
serviceworker-worker-updated = Eguneratuta <time>{ DATETIME($date, day: "numeric", hour: "numeric", minute: "numeric", month: "long", second: "numeric", year: "numeric") }</time>
...
session-history-navigate-button-title = Nabigatu saioaren historiaren { $index }. sarrerara
