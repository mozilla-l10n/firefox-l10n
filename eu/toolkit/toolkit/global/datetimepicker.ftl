...
datetime-picker-label =
    .aria-label = Aukeratu data eta ordua
...
time-spinner-hour-previous =
    .aria-label = Aurreko ordua
time-spinner-hour-next =
    .aria-label = Hurrengo ordua
time-spinner-minute-previous =
    .aria-label = Aurreko minutua
time-spinner-minute-next =
    .aria-label = Hurrengo minutua
time-spinner-second-previous =
    .aria-label = Aurreko segundoa
time-spinner-second-next =
    .aria-label = Hurrengo segundoa
time-spinner-millisecond-previous =
    .aria-label = Aurreko milisegundoa
time-spinner-millisecond-next =
    .aria-label = Hurrengo milisegundoa
time-spinner-day-period-previous =
    .aria-label = Egunaren aurreko periodoa
time-spinner-day-period-next =
    .aria-label = Egunaren hurrengo periodoa
