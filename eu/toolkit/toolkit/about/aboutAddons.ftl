...
# the user.
addon-permissions-managed-by-policy = Zenbait baimen zure erakundeak kudeatzen ditu.
...
plugins-openh264-description = Plugin hau Mozillak automatikoki installatu du WebRTC espezifikazioa bete eta H.264 bideo-kodeka behar duten gailuekin WebRTC deiak egin ahal izateko. Bisitatu https://www.openh264.org/ helbidea kodekaren iturburu-kodea ikusi eta inplementazioari buruzko argibide gehiago jakiteko.
