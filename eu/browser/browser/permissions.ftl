...
perm-persistent-storage-remember = Gogoratu erabakia
speech-recognition-model-download-header = Konfiguratu hizketa-ezagutzea?
# $sizeMB (Number) - the model download size in MB.
speech-recognition-model-download-message = { -brand-short-name }(e)k hizketa-ezagutza modu lokalean exekutatzen du, beraz audioak inoiz ez du zure gailua uzten. Hau konfiguratzeko, { $sizeMB } MB inguruko deskarga bat hasiko da jarraitzen duzunean.
