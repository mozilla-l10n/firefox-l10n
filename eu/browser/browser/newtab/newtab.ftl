...
newtab-privacy-widget-menu-button =
    .aria-label = Pribatutasun-aukerak
    .title = Pribatutasun-aukerak
...
newtab-privacy-trackers-blocked-today =
    { $count ->
        [one] Jarraipen-elementu blokeatuta gaur
       *[other] Jarraipen-elementu blokeatuta gaur
    }
...
newtab-privacy-message-info-1 = { -brand-short-name }(e)k jarraipen-elementuak automatikoki blokeatzen ditu zuk nabigatu ahala.
newtab-privacy-message-info-1-cta = Ikusi babesak
newtab-privacy-message-info-2 = Jarraipen-elementuak blokeatzeak enpresek linean jarrai zaitzaten saihesten laguntzen du.
newtab-privacy-message-info-2-cta = Ikusi babesak
newtab-privacy-message-info-3 = Gune askok jarraipen-elementuak dituzte, beraz inoiz bisitatu ez dituzun enpresek zure lineako jarraipena egin lezakete.
...
newtab-spaces-tab-stories = Istorioak
newtab-spaces-tab-widgets = Widgetak
newtab-spaces-tab-activity = Jarduera
...
newtab-carousel-pause =
    .aria-label = Pausatu erreprodukzio automatikoa
...
newtab-appearance-more-themes-button =
    .label = Ikusi itxura gehiago
# Title of the full theme selection sub-panel, also used as its back button label.
newtab-appearance-manage-title = { -brand-product-name } itxurak
# Header for the list of the user's already-installed themes in the full theme panel.
newtab-appearance-your-themes-header = Zure itxurak
...
newtab-appearance-install-theme-button =
    .label = Instalatu itxura
# Button/link on the full theme panel that opens the complete list of available themes.
newtab-appearance-explore-more-themes-button = Arakatu itxura gehiago
...
newtab-wallpaper-your-images-folder =
    .aria-label = Gordeta dituzun zure irudiak eta horma-paperak
...
newtab-wallpaper-your-images-item-numbered = { $number }. irudia
...
newtab-topic-navigation-more-button = Gehiago
...
newtab-widget-section-show-widgets =
    .aria-label = Erakutsi widgeten atala
    .title = Erakutsi widgetak
...
newtab-sports-widget-loading-more = Partida gehiago kargatzen…
...
newtab-clock-widget-custom-zone-no-results = Bat datorren ordu-zonarik ez
# Returns from the custom clock form back to the city search.
newtab-clock-widget-custom-back = Atzera
# "Clock options" is an icon-only button in the widget toolbar — the
# attributes are consumed as tooltip/screen-reader label only. The button
# never renders visible text.
newtab-clock-widget-menu-button2 =
    .aria-label = Erlojuaren aukerak
    .title = Erlojuaren aukerak
...
newtab-clock-city-us-san-francisco = San Frantzisko
...
newtab-clock-city-de-hamburg = Hanburgo
newtab-clock-city-fr-paris = Paris
newtab-clock-city-fr-lyon = Lyon
newtab-clock-city-fr-marseille = Marseilla
...
newtab-clock-city-pl-krakow = Krakovia
newtab-clock-city-jp-tokyo = Tokio
newtab-clock-city-jp-osaka = Osaka
newtab-clock-city-mx-mexico-city = Mexiko Hiria
newtab-clock-city-mx-guadalajara = Guadalajara
newtab-clock-city-it-rome = Erroma
...
newtab-clock-city-es-madrid = Madril
newtab-clock-city-es-barcelona = Bartzelona
...
newtab-clock-city-be-brussels = Brusela
...
newtab-clock-city-pk-karachi = Karatxi
...
newtab-clock-city-dk-copenhagen = Kopenhage
