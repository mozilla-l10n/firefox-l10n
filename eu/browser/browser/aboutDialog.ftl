...
helpus-referrals2 = Lagundu nahi duzu? <label data-l10n-name="helpus-donateLink">Egin dohaintza</label>, <label data-l10n-name="helpus-shareFirefoxLink">Partekatu { -brand-product-name }</label> edo <label data-l10n-name="helpus-getInvolvedLink">hartu parte!</label>
