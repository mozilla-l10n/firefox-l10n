...
preferences-ai-controls-on-device-group =
    .description = Eginbidea erabiltzen baduzu, hauek zure gailura deskargatzen diren AA eredu txikiak erabiliko dituzte. Metodo honek zure pribatutasuna babesten laguntzen du.
    .label = Gailuko AA
...
preferences-ai-controls-state-description-blocked = <strong>Blokeatuta:</strong> Ezingo duzu eginbidea ikusi eta erabili. Gailuko AAri dagokionez, lehendik deskargatuta zeuden ereduak kendu egingo dira.
