...
appearance-browser-icon-entry-group =
    .label = Nabigatzailearen ikonoa
    .description = Aukeratu ikono pertsonalizatua zure ataza-barra, mahaigain eta hasiera-menurako.
appearance-browser-icon-button =
    .label = Aldatu nabigatzailearen ikonoa
...
appearance-browser-icon-momo =
    .label = Momo
    .description = @heyheymomodraws-ek sortua
