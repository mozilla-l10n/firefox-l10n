...
contextual-manager-passwords-origin-field-description = Idatzi gune honetan saioa hasiko duzun helbide zehatza.
contextual-manager-passwords-username-field =
    .label = Erabiltzaile-izena
contextual-manager-passwords-username-field-description = Idatzi saioa hasteko erabiltzen duzun erabiltzaile-izena, helbide elektronikoa edo kontu-zenbakia.
contextual-manager-passwords-password-field =
    .label = Pasahitza
contextual-manager-passwords-password-field-description = Idatzi kontu honetara sartzeko pasahitza.
