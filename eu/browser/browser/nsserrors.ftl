...
sec-error-extension-value-invalid = Ziurtagiri hedapena balioa baliogabea da.
sec-error-extension-not-found = Ziurtagiri hedapena ez da aurkitu.
...
sec-error-bad-info-access-method = Informazioa atzitzeko metodo ezezaguna ziurtagiriaren luzapenean.
