...
about-networking-ssl-tokens-summary-certs = Składowane certifikaty: { $references } ({ $totalBytes } B), jednozmyslne: { $distinct } ({ $distinctBytes }) B)
...
about-networking-ssl-tokens-handshake-certs = Certifikaty rukuzawdaća ({ $count })
