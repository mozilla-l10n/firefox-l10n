...
details-notification-softblocked-extension-disabled =
    .message = Tute rozšěrjenje so přećiwo prawidłam přeńdźe a je so znjemóžniło. Móžeće jo zmóžnić, ale to je snano riskantne.
...
details-notification-softblocked-other-disabled =
    .message = Tutón přidatk so přećiwo prawidłam přeńdźe a je so znjemóžnił. Móžeće jón zmóžnić, ale to je snano riskantne.
