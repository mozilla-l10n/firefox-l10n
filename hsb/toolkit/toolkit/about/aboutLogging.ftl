...
about-logging-preset-navigation-description = Module za diagnosticěrowanje problemow z nawigaciju a posedźenskej historiju protokolować
about-logging-preset-vpn-label = VPN
about-logging-preset-vpn-description = Protokolowe module za diagnosticěrowanje problemow IP-škita (VPN)
