...
webext-perms-host-description-file-urls = Přistup k lokalnym datajam na wašim ličaku
# Variables:
...
webext-site-perms-description-gated-perms-webserial =
    Te su graty kaž mikrokontrolery, 3D-ćišćaki a druhe graty, kotrež so přez USB, serijowe porty abo Bluetooth zwjazuja.
