...
login-status-advisory-title = Sće wotzjewjeny. Klikńće na kontowy symbol, zo byšće so přizjewił.

## Bookmarks toolbar callout strings

bookmarks-toolbar-callout-1-title = Swojej symbolowej lajsće zapołožkow tute sydło přidać?
bookmarks-toolbar-callout-1-subtitle = Waša zapołožka budźe so direktnje pod adresowej lajstu za spěšny přistup składować.
bookmarks-toolbar-callout-1-primary-button-label = Zapołožku přidać
...
start-page-callout-title = Chceće pytanje z fokusom na priwatnosć spytać?
start-page-callout-subtitle = Wupruwujće Startpage. Je so wuwił, zo by waše pytanja wot spočatka priwatniše činił.
start-page-callout-primary-label = Startpage wupruwować
start-page-callout-secondary-label = Zaćisnyć
...
taskbar-tabs-value-prop-callout-title-v3 = Připniće swoje najlubše sydła k swojej nadawkowej lajsće
...
windows-10-eos-sync-urgency-subtitle-1 = Synchronizujće nětko, zo bychu waše zapołožki, hesła a nastajenja { -brand-short-name } wěste a lochko wobnowjomne wostali.
...
sidebar-callout-survey-dissatisfied-2 = Njespokojny
sidebar-callout-survey-very-dissatisfied-2 = Jara njespokojny
...
sidebar-callout-survey-saved-websites-2 = Spěšny přistup k wašim zapołožkam
