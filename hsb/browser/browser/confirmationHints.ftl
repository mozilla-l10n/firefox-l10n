...
confirmation-hint-passport-created = Pućowanski pas je so składował
confirmation-hint-passport-updated = Pućowanski pas je so aktualizował
...
confirmation-hint-extensions-button-hidden = Do menija přesunjeny
