...
content-blocking-baseline-label = Wulke sydłowe problemy porjedźić (doporučene)
content-blocking-convenience-label = Snadne sydłowe problemy porjedźić
content-blocking-exceptions-subheader = Sydłowe problemy porjedźić
