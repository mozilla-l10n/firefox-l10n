...
sitedata-option-block-cross-site-and-social-media-trackers =
    .label = Sydła přesahowace přesćěhowaki a přesćěhowaki socialnych medijow
sitedata-option-block-cross-site-tracking-cookies-including-social-media =
    .label = Sydła přesahowace slědowace placki – wobsahuje placki socialnych medijow
sitedata-option-block-cross-site-cookies-including-social-media =
    .label = Sydła přesahowace placki – wowobsahuje placki socialnych medijow
...
sitedata-option-block-cross-site-and-social-media-trackers-plus-isolate =
    .label = Sydła přesahowace přesćěhowaki a přesćěhowaki socialnych medijow a izolowanje zbytnych plackow
