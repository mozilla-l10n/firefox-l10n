...
firefox-relay-opt-in-confirmation-postpone =
    .label = Nic nětko
    .accesskey = N
firefox-relay-offer-what-fxa-and-relay-provides = Konto přistup k dalšim priwatnosć škitacym produktam dopušća. Wšě mejlki, kotrež so na wašu e-mejlowu masku sćelu, so na wašu woprawdźitu e-mejlowu adresu dale sposrědkuja (chibazo rozsudźeće so je blokować).
