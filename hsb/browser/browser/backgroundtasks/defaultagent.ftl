...
default-browser-notification-privacy-header-text = Chceće při { -brand-short-name } wostać?
default-browser-notification-privacy-body-text = Waš standard je so změnił. Wróćće so k { -brand-short-name } za zatwarjenu priwatnosć a škit.
...
default-browser-notification-privacy-no-button-text = Ně, dźakuju so
