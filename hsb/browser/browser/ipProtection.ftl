...
ipprotection-summer-promo-offramp-generic-description = Wužiwajće swoje { $maxUsage } GB a 6 stejnišćow za přidatnu priwatnosć, zo byšće slědowanje swojeho přehladowanja poćežił.
...
# Variables
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
ipprotection-summer-promo-offramp-generic-description-default-browser-users-no-upgrade = Wužiwajće swoje { $maxUsage } GB a přez 20 stejnišćow za přidatnu priwatnosć, zo byšće slědowanje swojeho přehladowanja poćežił.
...
ipprotection-summer-promo-offramp-subscriber-title = Waš zatwarjeny VPN budźe samo lěpši
ipprotection-summer-promo-offramp-subscriber-description = Dóstawaće nětko njewobmjezowanu šěrokosć pasma a dalše stejnišća jako abonent { -mozilla-vpn-brand-name }.
...
ipprotection-locations-unavailable-label-1 = Nic k dispoziciji
    .aria-label = Nic k dispoziciji, znjemóžnjeny
# Label shown next to a VPN location that the user cannot select.
ipprotection-locations-unavailable-label = Njesteji k dispoziciji
...
ipprotection-connection-status-blocked-error-description-1 = Lokalne zakonje a zamjezowanja wobmjezuja, hdźež móžeće VPN wužiwać. <a data-l10n-name="learn-more-link">Dalše informacije</a>
...
#   $usageLeft (string) - The amount of data a user has left in a month (in GB)
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
ip-protection-bandwidth-left-gb-1 = <span data-l10n-name="usage">{ $usageLeft } GB</span> z { $maxUsage } GB wyše
# Variables
#   $usageLeft (string) - The amount of data a user has left in a month (in GB)
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
...
#   $usageLeft (number) - The amount of data a user has left in a month (in MB)
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
ip-protection-bandwidth-left-mb-1 = <span data-l10n-name="usage">{ $usageLeft } MB</span> z { $maxUsage } GB wyše
# Variables
#   $usageLeft (number) - The amount of data a user has left in a month (in MB)
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
...
ip-protection-bandwidth-header-1 = Měsačny datowy limit
