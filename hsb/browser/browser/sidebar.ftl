...
sidebar-resize-splitter =
    .aria-label = Wulkosć bóčnicy změnić
...
sidebar-show-preview-on-hover =
    .label = Přehlad při přejězdźenju z cursorom pokazać
...
sidebar-opentabs-preview-heading = Najnowše rajtarki
...
sidebar-bookmarks-folder-menu = Meni zapołožkow
sidebar-bookmarks-folder-toolbar = Lajsta zapołožkow
sidebar-bookmarks-folder-other = Druhe zapołožki
sidebar-bookmarks-folder-mobile = Mobilne zapołožki
...
sidebar-pins-promo-text = Ćehńće wažne rajtarki sem, zo byšće je k ruce měł
