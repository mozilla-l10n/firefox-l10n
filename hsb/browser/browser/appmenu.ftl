...
fxa-menu-sync-status-turn-on-button =
    .label = Zmóžnić
fxa-menu-sync-status-turn-on-button-aria-label = Zmóžnić
...
appmenu-fxa-sign-in-promo-heading2 = Synchronizujće swoje daty wšudźe
appmenu-fxa-sign-in-promo-link = Přizjewić
appmenu-fxa-sign-in-promo-dismiss-button =
    .aria-label = Přizjewjenske wabjenje zaćisnyć
    .title = Zaćisnyć
# Sign-in promo shown in the app menu when signed out and no menu message or
...
appmenu-bookmarks-sync-promo-connectdevice =
    .heading = Wzmiće swoje zapołožki na puću
