...
fxa-menu-send-to-mobile =
    .label =
        { $tabCount ->
            ...
            [one] Na { $tabCount } mobilny grat pósłać
            [two] Na { $tabCount } mobilnej grataj pósłać
...
fxa-menu-manage-account-subtitle = Konto rjadować
...
fxa-menu-signed-out-message-login-failed = Sće wotzjewjeny
# Reason shown when the remembered account still needs to verify their email.
fxa-menu-signed-out-message-unverified = Konfiguraciju dokónčić
...
fxa-menu-signed-out-title = Za synchronizaciju přizjewić
fxa-menu-signed-out-description = Sće wotzjewjeny
