...
newtab-privacy-etp-off-faster-browsing = Spěšniše přehladowanje. Mjenje přesćěhowakow.
newtab-privacy-etp-off-turn-on-tracking = Zmóžńće škit slědowanja w nastajenjach, zo byšće blokowanje započał.
...
newtab-privacy-message-promo-vpn-2 = Wužiwaće WLAN na lětanišću? Zmóžńće zatwarjeny VPN, zo byšće swoje přehladowanje škitał.
newtab-privacy-message-promo-vpn-2-cta = VPN wočinić
newtab-privacy-message-promo-vpn-3 = Zmóžńće zatwarjeny VPN, zo byšće pomhał, zo waše stejnišćo priwatniše wostawa.
newtab-privacy-message-promo-vpn-3-cta = VPN wočinić
newtab-privacy-message-promo-private-window-1 = Wupruwujće priwatne wokno, zo byšće priwatnišo přehladował, hdyž zhromadny ličak wužiwaće.
...
newtab-custom-appearance-section-title = Napohlad
# Button that opens the full browser theme selection view.
newtab-appearance-more-themes-button =
    .label = Dalše drasty pokazać
# Title of the full theme selection sub-panel, also used as its back button label.
newtab-appearance-manage-title = Drasty { -brand-product-name }
# Header for the list of the user's already-installed themes in the full theme panel.
newtab-appearance-your-themes-header = Waše drasty
...
newtab-appearance-install-theme-button =
    .label = Drastu instalować
# Button/link on the full theme panel that opens the complete list of available themes.
newtab-appearance-explore-more-themes-button = Wuslědźće dalše drasty
...
newtab-wallpaper-your-images = Waše wobrazy
...
newtab-wallpaper-your-images-folder =
    .aria-label = Waše wobrazy, pozadkowe wobrazy, kotrež sće składował
...
newtab-wallpaper-your-images-item-numbered = Wobraz { $number }
...
newtab-wallpaper-remove-image-numbered =
    .aria-label = Wobraz { $number } wotstronić
    .title = Wobraz { $number } wotstronić
newtab-wallpaper-remove-image-title = Wobraz wotstronić?
# "This action" refers to removing a saved wallpaper image.
newtab-wallpaper-remove-image-body = Tuta akcija njeda so cofnyć.
newtab-wallpaper-remove-image-confirm = Wotstronić
newtab-wallpaper-remove-image-cancel = Přetorhnyć
...
newtab-wallpaper-firefox-sky-light = Swětłe hórki pod miłym njebjom
...
newtab-topic-navigation-more-button = Wjace
...
newtab-widget-lists-change-list =
    .aria-label = Lisćinu změnić
    .title = Lisćinu změnić
...
newtab-widget-section-show-widgets =
    .aria-label = Wotrězk asistentow pokazać
    .title = Asistenty pokazać
...
newtab-clock-widget-add-custom = “{ $city }” jako swójski časnik přidać
# Text field for the display name of a user-added custom clock.
newtab-clock-widget-custom-city-input =
    .aria-label = Mjeno města
    .label = Mjeno města
    .placeholder = Mjeno tutoho časnika
# Searchable time-zone field shown when adding a custom clock. The user
# types a city they know and picks it to set the clock's time zone.
newtab-clock-widget-custom-timezone-input =
    .aria-label = Časowe pasmo
    .label = Časowe pasmo
    .placeholder = Po měsće, časowym pasmje abo wotchilenju UTC pytać
newtab-clock-widget-custom-zone-results =
    .aria-label = Wuslědki časoweho pasma
# Shown in the time-zone picker when the search matches no time zones.
newtab-clock-widget-custom-zone-no-results = Žane wotpowědne časowe pasma
# Returns from the custom clock form back to the city search.
newtab-clock-widget-custom-back = Wróćo
...
newtab-clock-city-de-munich = Mnichow
newtab-clock-city-de-frankfurt = Frankobrod nad Mohanom
...
newtab-clock-city-pl-warsaw = Waršawa
newtab-clock-city-pl-krakow = Krakow
newtab-clock-city-jp-tokyo = Tokio
newtab-clock-city-jp-osaka = Osaka
newtab-clock-city-mx-mexico-city = Mexiko-město
newtab-clock-city-mx-guadalajara = Guadalajara
newtab-clock-city-it-rome = Rom
newtab-clock-city-it-milan = Mailand
newtab-clock-city-ru-moscow = Moskwa
newtab-clock-city-ru-saint-petersburg = Pětrohród
...
newtab-clock-city-tw-taipei = Taipeh
...
newtab-clock-city-vn-ho-chi-minh-city = Ho Chi Minhowe město
