...
report-broken-site-panel-description =
    .placeholder = Što je so stało? Što dyrbjało so stać? Je znjemóžnjenje přesćěhanskeho škita pomhało?
...
report-broken-site-panel-preview-header2 =
    .title = Přehlad rozprawy pokazać
