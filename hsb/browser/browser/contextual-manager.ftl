...
contextual-manager-passwords-origin-field =
    .label = Adresa websydła
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Zapodajće eksaktnu adresu, hdźež so pola tutoho sydła přizjewjeće.
contextual-manager-passwords-username-field =
    .label = Wužiwarske mjeno
contextual-manager-passwords-username-field-description = Zapodajće wužiwarske mjeno, e-mejlowu adresu abo kontowe čisło, kotrež wužiwaće, zo byšće so přizjewił.
contextual-manager-passwords-password-field =
    .label = Hesło
contextual-manager-passwords-password-field-description = Zapodajće hesło, zo byšće so pola tutoho konta přizjewił.
