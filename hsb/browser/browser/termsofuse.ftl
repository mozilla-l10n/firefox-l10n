...
tou-existing-user-spotlight-body = Smy <a data-l10n-name="terms-of-use">wužiwanske wuměnjenja</a> zawjedowali a naše <a data-l10n-name="privacy-notice">zdźělenje priwatnosće</a> zaktualizowali.<br><br> Prošu bjerće sej wokomik čas, zo byšće pohódnoćił a akceptował. <a data-l10n-name="learn-more">Dalše informacije</a>.
