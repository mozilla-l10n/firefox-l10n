...
browser-shortcut-description = Spěšne a priwatne přehladowanje
...
#                    "11 months ago"
urlbar-result-explanation-last-visited-days-weeks-months-ago = Posledni wopyt { $date }
# This explanation is used when the last-visited date is further in the past.
# The date will be formatted as an absolute date like: "11 May", "11 May 2026"
# Variables:
#   $date (string) - A localized absolute date string
...
urlbar-searchmode-bookmarks4 = Zapołožki
urlbar-searchmode-tabs4 = Rajtarki
...
urlbar-searchmode-popup-search-settings2 = Pytanske nastajenja
...
urlbar-view-context-menu-open-in-private-window =
    ...
    .accesskey = p
urlbar-view-context-menu-open-in-tab2 = W nowym rajtarku wočinić
    .accesskey = n
urlbar-view-context-menu-open-in-container-tab2 = W nowym kontejnerowym rajtarku wočinić
    .accesskey = k
urlbar-view-context-menu-open-in-window2 = W nowym woknje wočinić
    .accesskey = W
