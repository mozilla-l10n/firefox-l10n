...
urlbar-result-dates-ongoing =
    { $daysUntilEnd ->
        [one] { $name } · Skónči so za { $daysUntilStart } dźeń
        [two] { $name } · Skónči so za { $daysUntilStart } dnjej
        [few] { $name } · Skónči so za { $daysUntilStart } dny
       *[other] { $name } · Skónči so za { $daysUntilStart } dnjow
    }
