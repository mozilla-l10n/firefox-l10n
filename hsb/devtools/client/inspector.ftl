...
colorpicker-tooltip-eyedropper-title = Barbu na stronje wubrać
...
colorpicker-tooltip-color-name-title = Najbliše při: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Barbowy wotsćin
...
inspector-split-orientation-button-title = Wuhotowanje wobłukow
...
inspector-emulation-panel-toggle =
    .aria-label = Emulaciske funkcije CSS přepinać
    .title = Emulaciske funkcije CSS přepinać
