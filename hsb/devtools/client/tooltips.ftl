...
inactive-css-no-default-anchor = <strong>{ $property }</strong> so na tutón element njewuskutkuje, dokelž standardny kótwicowy element nima.
...
inactive-css-not-absolutely-positioned-item-fix = Spytajće elementej <strong>position:absolute</strong> přidać. { learn-more }
inactive-css-no-default-anchor-fix = Spytajće <strong>position-anchor</strong> z płaćiwym kótwicowym mjenom přidać. { learn-more }
...
inactive-css-not-grid-or-flex-container-fix-1 = Spytajće <strong>display:grid</strong> abo <strong>display:flex</strong> přidać.
inactive-css-not-grid-or-flex-or-block-container-fix-1 = Spytajće <strong>display:grid</strong>, <strong>display:flex</strong> abo <strong>display:block</strong> přidać.
inactive-css-not-grid-or-flex-container-or-multicol-container-fix-1 = Spytajće <strong>display:grid</strong>, <strong>display:flex</strong> abo <strong>columns:2</strong> přdać.
inactive-css-not-multicol-container-fix-1 = Spytajće pak <strong>column-count</strong> abo <strong>column-width</strong> přidać.
...
inactive-css-not-grid-or-flex-or-absolutely-positioned-item-fix-1 = Spytajće elementej <strong>postion:absolute</strong> přidać abo nadrjadowanemu elementej elementa <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong> abo <strong>display:inline-flex</strong> přidać.
inactive-css-not-grid-or-absolutely-positioned-item-fix-1 = Spytajće elementej  <strong>position:absolute</strong> přidać, abo <strong>display:grid</strong> abo <strong>display:inline-grid</strong> nadrjadowanemu elementej.
inactive-css-not-absolutely-positioned-item-fix-1 = Spytajće elementej <strong>position:absolute</strong> přidać.
inactive-css-no-default-anchor-fix-1 = Spytajće <strong>position-anchor</strong> z płaćiwym kótwicowym mjenom přidać.
...
inactive-css-not-block-flex-grid-container-fix-1 = Spytajće <strong>display:block</strong>, <strong>display:inline-block</strong>, <strong>display:flex</strong>, <strong>display:inline-flex</strong>, <strong>display:grid</strong>, <strong>display:inline-grid</strong> abo <strong>display:flow-root</strong> přidać.
inactive-css-not-floated-fix-1 = Spytajće kajkosć <strong>float</strong> z druhej hódnotu hač <strong>none</strong> přidać.
inactive-css-position-property-on-unpositioned-box-fix-1 = Spytajće jeho kajkosć <strong>position</strong> na něšto druhe hač <strong>static</strong> nastajić.
inactive-css-only-replaced-elements-fix-1 = Zawěsćće, zo kajkosć wuměnjenemu elementej přidawaće.
inactive-text-overflow-when-no-overflow-fix-1 = Spytajće <strong>overflow:hidden</strong> přidać.
