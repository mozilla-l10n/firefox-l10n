...
perftools-menu-more-actions-copy-for-startup = Copiar variables de entorno para o perfilado ao inicio
perftools-menu-more-actions-copy-for-perf-tests = Copiar parámetros para probas de rendemento
