...
colorpicker-tooltip-eyedropper-title = Escolla a cor na páxina
...
colorpicker-tooltip-color-name-title = Máis próximo a: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Matiz
