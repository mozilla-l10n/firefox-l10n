...
contextual-manager-passwords-origin-field =
    .label = Enderezo do sitio web
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Introduce o enderezo exacto onde iniciarás sesión neste sitio.
contextual-manager-passwords-username-field =
    .label = Nome de usuario
contextual-manager-passwords-username-field-description = Introduce o nome de usuario, o enderezo de correo electrónico ou o número de conta que utilizas para iniciar sesión.
contextual-manager-passwords-password-field =
    .label = Contrasinal
contextual-manager-passwords-password-field-description = Introduce o contrasinal para iniciar sesión nesta conta.
