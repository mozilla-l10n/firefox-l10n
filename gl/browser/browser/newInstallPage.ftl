...
new-install-sync-first = É a primeira vez que utiliza a sincronización? Ten que iniciar sesión en todas as instalacións de Firefox para sincronizar a súa información.
