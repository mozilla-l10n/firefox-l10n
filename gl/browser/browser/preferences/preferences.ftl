...
content-blocking-convenience-exceptions =
    .label = Aplica tamén excepcións automaticamente que só son necesarias para solucionar problemas menores e facer que as funcións de conveniencia estean dispoñibles.
content-blocking-convenience-label = Corrixir problemas menores do sitio
content-blocking-exceptions-subheader = Corrixir problemas do sitio
