...
more-from-moz-firefox-mobile-title-1 = { -brand-product-name } para móbil
...
more-from-moz-title2 = Máis contido de { -vendor-short-name }
    .title = Máis contido de { -vendor-short-name }
