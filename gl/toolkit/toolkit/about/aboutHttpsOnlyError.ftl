...
about-httpsonly-insecure-title = Conexión segura non dispoñible

# Variables:
#   $websiteUrl (String) - Url of the website that failed to load. Example: www.example.com
about-httpsonly-insecure-explanation-unavailable = Está navegando en modo só HTTPS e non está dispoñible unha versión HTTPS segura de <em>{ $websiteUrl }</em>.
