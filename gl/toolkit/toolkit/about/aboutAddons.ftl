...
# pref is set.
addon-install-or-update-from-file = Instalar ou actualizar o complemento desde o ficheiro...
    .accesskey = I
...
plugins-openh264-description = Este engadido instalouse automaticamente por Mozilla para cumprir coa especificación WebRTC e para permitir chamadas WebRTC con dispositivos que requiren o códec de vídeo H.264. Visite https://www.openh264.org/ para ver o código fonte do códec e obter máis información sobre a implementación.
...
mlmodel-addon-detail-model-card = Ficha do modelo
