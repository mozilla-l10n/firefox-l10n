...
theme-monochromatic-heading = Combinacións de cores
theme-monochromatic-subheading = Novas cores vibrantes de { -brand-product-name }. Dispoñíbel por un tempo limitado.
