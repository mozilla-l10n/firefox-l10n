...
SeaMonkey est sujet aux termes détaillés de l'accord de licence qui
l'accompagne.

Ce fichier lisez-moi contient des informations sur les pré-requis système et
les instructions d'installation pour les compilations Windows de SeaMonkey.

Pour plus d'informations sur SeaMonkey, consultez
http://www.seamonkey-project.org/.
Pour soumettre des bogues ou des retours d'utilisation, consultez
http://www.seamonkey-project.org/dev/get-involved et vérifiez dans Bugzilla
sur https://bugzilla.mozilla.org/ pour des liens vers des bogues connus,
des recommandations d'écriture de rapport de bogue, et bien plus.
Vous pouvez aussi obtenir de l'aide sur Bugzilla avec un client
IRC sur le canal #mozillazine du serveur irc.mozilla.org.
...
Vous pouvez télécharger les "nightlies" des compilations de SeaMonkey sur le
...
Assurez-vous de lire les notes de version de SeaMonkey indiquées sur la page des
versions pour des informations sur les problèmes connus et les solutions pour
l'installation de SeaMonkey.
...
privilèges administrateur.
   ...
   3. Extrayez le fichier .zip dans un répertoire tel que
        C:\Program Files\mozilla.org\SeaMonkey.

   4. Pour démarrer SeaMonkey, rendez-vous dans le répertoire où vous avez extrait
      SeaMonkey et double-cliquez sur l'icône de seamonkey.exe.
