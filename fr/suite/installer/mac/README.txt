  ...
  quand vous exécutez SeaMonkey pour la première fois, un dossier « SeaMonkey »
  est créé dans

  ~/Library/Application Support/ (où ~ est le répertoire d'accueil).

  Vos paramètres personnels, marque-pages, courriels, mots de passe, etc. sont
  stockés dans un dossier de profil dans le dossier SeaMonkey. Le dossier de
  profil est situé dans

  ~/Library/Application Support/SeaMonkey/Profiles/[ChaîneAléatoire.NomDeProfil].

  SeaMonkey stocke son cache dans ~/Library/Cache/SeaMonkey. Certains paramètres
  (comme la dernière racine de dossier utilisé par le dialogue « Enregistrer »)
  sont stockés dans
  ...
  Pour plus d'informations sur SeaMonkey, visitez http://www.seamonkey-project.org/.
  Pour soumettre des bogues ou un retour d'expérience, visitez
  http://www.seamonkey-project.org/dev/get-involved et vérifiez dans Bugzilla
  sur https://bugzilla.mozilla.org/ les bogues connus, les recommandations pour
  rapporter un bogue, et plus. Vous pouvez aussi obtenir de l'aide en dirigeant
  votre client IRC sur le salon #mozillazine de irc.mozilla.org.


  Licence
  -------

  SeaMonkey est soumis aux termes détaillés dans l'accord de licence disponible
  sur http://www.mozilla.org/legal/eula/seamonkey-en.html.