...
inactive-css-not-grid-or-flex-or-absolutely-positioned-item-fix = Essayez d’ajouter <strong>position:absolute</strong> à l’élément, ou <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong >, ou <strong>display:inline-flex</strong> au parent de l’élément. { learn-more }
