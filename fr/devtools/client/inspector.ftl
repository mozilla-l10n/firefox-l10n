...
colorpicker-tooltip-spectrum-dragger-title = Spectre
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = Sélectionner une couleur sur la page
...
colorpicker-tooltip-color-name-title = Couleur la plus proche : { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Teinte
...
inspector-emulation-panel-reduced-motion-reduce = Réduire
