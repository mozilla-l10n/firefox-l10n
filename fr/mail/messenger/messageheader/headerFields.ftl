...
message-header-to-field = Pour<span data-l10n-name="field-separator"> :</span>
message-header-from-field = De<span data-l10n-name="field-separator"> :</span>
message-header-sender-field = Expéditeur<span data-l10n-name="field-separator"> :</span>
...
message-header-reply-to-field = Répondre à<span data-l10n-name="field-separator"> :</span>
message-header-subject-field = Objet<span data-l10n-name="field-separator"> :</span>
message-header-cc-field = Copie<span data-l10n-name="field-separator"> :</span>
message-header-bcc-field = Copie cachée à<span data-l10n-name="field-separator"> :</span>
message-header-newsgroups-field = Groupes de discussion<span data-l10n-name="field-separator"> :</span>
message-header-followup-to-field = Faire suivre à<span data-l10n-name="field-separator"> :</span>
message-header-tags-field = Étiquettes<span data-l10n-name="field-separator"> :</span>
