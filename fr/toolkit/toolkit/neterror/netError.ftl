...
neterror-dns-not-found-hint-firewall-2 = Vérifiez que { -brand-short-name } a l’autorisation d’accéder au Web (vous êtes peut-être connecté mais derrière un pare-feu).
