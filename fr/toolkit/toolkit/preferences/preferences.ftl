...
pw-change-ok = Le mot de passe principal a été changé. { pw-empty-warning }
...
pw-not-wanted = Attention ! Vous avez décidé de ne pas utiliser de mot de passe principal.
