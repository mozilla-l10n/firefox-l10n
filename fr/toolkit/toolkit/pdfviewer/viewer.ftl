...
pdfjs-views-manager-outlines-title = Structure du document
pdfjs-views-manager-attachments-title = Pièces jointes
pdfjs-views-manager-layers-title = Calques
pdfjs-views-manager-pages-option-label = Pages
pdfjs-views-manager-outlines-option-label = Structure du document
...
pdfjs-views-manager-pages-status-waiting-ready-label = La préparation de votre fichier…
...
pdfjs-views-manager-status-warning-delete-label = Impossible de supprimer. Actualisez la page et essayez à nouveau.
