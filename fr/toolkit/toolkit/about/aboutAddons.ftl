...
details-notification-soft-blocked-other-disabled2 =
    .message = Ce module complémentaire est protégé et a été désactivé. Vous pouvez l’activer, mais cela peut être risqué.
details-notification-soft-blocked-other-enabled2 =
    .message = Ce module est protégé. Son utilisation peut être risqué.
