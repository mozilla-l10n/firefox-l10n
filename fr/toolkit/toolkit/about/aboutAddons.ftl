...
details-notification-softblocked-extension-disabled =
    .message = Cette extension enfreint les politiques de Mozilla et a été désactivée. Vous pouvez l’activer, mais son utilisation comporte des risques.
...
details-notification-softblocked-other-disabled =
    .message = Ce module enfreint les politiques de Mozilla et a été désactivé. Vous pouvez l’activer, mais son utilisation comporte des risques.
