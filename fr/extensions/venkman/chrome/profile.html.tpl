...
<html>
  <head>
    <title>Donn&eacute;es de Profilage JavaScript</title>
  </head>
  <style>
    .profile-file-title {
        font-size  : larger;
  ...
  <body>
    <h1>Donn&eacute;es de profilage JavaScript</h1>
    <span class="label">Date de la collection&nbsp;:</span>
    <span class="value">$full-date</span><br>
    <span class="label">Agent utilisateur&nbsp;:</span>
    <span class="value">$user-agent</span><br>
    <span class="label">Version du d&eacute;bogueur JavaScript&nbsp;:</span>
    <span class="value">$venkman-agent</span><br>
    <span class="label">Class&eacute;es par&nbsp;:</span>
...
@-range-start
      <span class="range-box">
        ...
        [ <a href="#section$section-number-prev">Fichier pr&eacute;c&eacute;dent</a> |
        <a href="#section$section-number-next">Fichier suivant</a> |
        <a href="#range$section-number:$range-number-prev">Intervalle pr&eacute;c&eacute;dent</a> |
        <a href="#range$section-number:$range-number-next">Intervalle suivant</a> ]
@-item-start
