...
more-from-moz-title2 = Autres produits de { -vendor-short-name }
    .title = Autres produits de { -vendor-short-name }
...
more-from-moz-mozilla-vpn-box-link =
    .label = Obtenir { -mozilla-vpn-brand-name }
more-from-moz-firefox-relay-box-link =
    .label = Obtenir { -relay-brand-short-name }
more-from-moz-mdn-box-link =
    .label = Accéder à MDN
more-from-moz-thunderbird-box-link =
    .label = Obtenir { -thunderbird-brand-short-name }
more-from-moz-solo-box-link =
    .label = Essayer { -solo-ai-brand-name }
more-from-moz-new-products-box-link =
    .label = Voir les nouveaux produits
