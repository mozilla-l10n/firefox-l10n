...
appearance-window-density-group =
    ...
    .description = Ajustez l’espacement autour des éléments de la fenêtre tels que la barre d’outils, les onglets et la barre latérale.
...
appearance-window-density-automatic-no-touch =
    .label = Automatique (par défaut)
    .description = Un espacement standard ou compact est appliqué automatiquement
...
appearance-window-density-auto-touch-mode =
    .label = Utiliser l’espacement des écrans en mode tablette
appearance-window-density-compact =
    .label = Compacte
    .description = Espacement réduit pour les petits écrans
appearance-window-density-touch =
    .label = Tactile
    .description = Des éléments de fenêtre et des cibles de clic plus grands, optimisés pour les écrans tactiles
