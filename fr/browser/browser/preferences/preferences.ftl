...
autofill-personal-info-checkbox-message =
    .label = Enregistrer et remplir automatiquement vos informations personnelles
...
preferences-ai-controls-sidebar-chatbot-group-2 =
    ...
    .description = Gardez un œil sur un chatbot pendant votre navigation. Faites votre choix parmi Antropic Claude, ChatGPT, Copilot, Google Gemini et Misral Vibe.
