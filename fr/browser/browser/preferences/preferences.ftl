...
security-privacy-issue-warning-doh2 =
    ...
    .description = Le DNS via HTTPS vous permet de masquer les sites que vous vous apprêtez à visiter à votre fournisseur réseau.
security-privacy-issue-warning-ech2 =
    .label = Le client chiffré Hello est désactivé
    .description = Encrypted Client Hello aide à masquer les sites que vous vous apprêtez à visiter à votre fournisseur d’accès.
