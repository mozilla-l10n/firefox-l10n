...
tls-key-logging-notice-nav =
    .label = Une application ou un service pourrait accéder à votre trafic chiffré.
category-list =
...
containers-external-links-check =
    .label = Ne pas utiliser de conteneurs pour les liens ouverts depuis des applications externes
    .accesskey = N
...
containers-sites-card-header =
    ...
    .label = Conteneurs spécifiques à des sites
...
autofill-personal-info-checkbox-message =
    .label = Enregistrer et renseigner automatiquement vos informations personnelles
autofill-personal-info-manage-button =
    .label = Gérer les informations personnelles
...
passports-edit-passport-button-label =
    .aria-label = Modifier
passports-delete-passport-prompt-title = Supprimer ce passeport ?
passports-delete-passport-prompt-confirm-button = Supprimer
passports-delete-passport-prompt-cancel-button = Annuler
autofill-passports-add-button = Ajouter un nouveau passeport
autofill-personal-info-manage-title =
    .heading = Gérer les informations personnelles
# This message is displayed when no passports are stored in Firefox
passports-no-passports-stored-message =
    .label = Aucun passeport ajouté
...
preferences-ai-controls-speech-recognition-control =
    .description = Transcription vocale en local.
    .label = Reconnaissance vocale
preferences-ai-controls-sidebar-chatbot-group-3 =
    .description = Gardez un œil sur un chatbot pendant votre navigation. Choisissez parmi plusieurs fournisseurs et changez de fournisseur à tout moment.
    .label = Fournisseurs de chatbots IA dans le panneau latéral
preferences-ai-controls-sidebar-chatbot-group-2 =
    .description = Gardez un œil sur un chatbot tout en naviguant. Faites votre choix parmi Anthropic Claude, ChatGPT, Copilot, Google Gemini et Mistral Vibe.
    .label = Fournisseurs de chatbots IA dans le panneau latéral
...
preferences-ai-controls-block-confirmation-speech-recognition = Reconnaissance vocale
...
preferences-etp-tracker-count-enabled =
    .label = Afficher les traqueurs bloqués dans la barre d’adresse
...
preferences-etp-custom-cookie-behavior-block-cross-site-tracking-cookies =
    .label = Bloquer les cookies de pistage intersites
...
security-privacy-issue-warning-doh2 =
    .description = Le DNS via HTTPS empêche votre fournisseur d’accès de connaître les sites que vous vous apprêtez à visiter.
    .label = Le DNS via HTTPS est désactivé
security-privacy-issue-warning-ech2 =
    .description = Le client chiffré Hello empêche votre fournisseur d’accès de connaître les sites que vous vous apprêtez à visiter.
