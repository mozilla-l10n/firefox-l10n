...
helpus-referrals2 = Vous souhaitez aider ? Vous pouvez <label data-l10n-name="helpus-donateLink">faire un don</label>, <label data-l10n-name="helpus-shareFirefoxLink">partager { -brand-product-name }</label> ou bien <label data-l10n-name="helpus-getInvolvedLink">participer</label>.
...
bottom-links-terms = Conditions d’utilisation
