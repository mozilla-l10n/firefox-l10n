...
safeb-blocked-addon-page-title = Site bloqué pour votre sécurité
...
safeb-blocked-addon-page-learn-more3 = <a data-l10n-name='firefox_support_harmful_addons'>En savoir plus sur la protection contre les modules complémentaires malveillants de { -brand-short-name }</a>.
