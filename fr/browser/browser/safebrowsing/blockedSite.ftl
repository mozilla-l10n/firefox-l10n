...
safeb-blocked-addon-page-learn-more3 = <a data-l10n-name='firefox_support_harmful_addons'>En savoir plus sur la protection de { -brand-short-name } contre les modules complémentaires malveillants</a>.
