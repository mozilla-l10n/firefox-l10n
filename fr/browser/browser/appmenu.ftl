...
fxa-menu-sync-your-data = Synchroniser vos données
...
fxa-menu-sync-status-turn-on-button =
    .label = Activer
fxa-menu-sync-status-turn-on-button-aria-label = Activer
...
fxa-menu-sync-device-now = Synchroniser { $deviceName } maintenant
...
# use the browser. "Share" here means recommending or referring the browser
appmenu-referrals2 =
    .label = Recommander { -brand-product-name }
    .accesskey = R
# This menu item opens the referral page, where the user can invite others to
# use the browser. "Share" here means recommending or referring the browser
appmenu-referrals =
...
appmenuitem-monitor-title-signed-in = Alertes de fuites de données { -monitor-brand-short-name }
...
appmenuitem-share-firefox-title2 = Partager { -brand-product-name }
# Button in the account menu that links to the Referrals page
appmenuitem-share-firefox-title = Partager { -brand-short-name }
appmenuitem-share-firefox-description = Inviter quelqu’un à choisir le navigateur qui privilégie la confidentialité
appmenu-profiles-2 =
    .label = Profils
