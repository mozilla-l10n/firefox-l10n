...
policy-ClearOnShutdown = Effacer les données de navigation à la fermeture de { -brand-short-name }.
...
policy-CNSA2KeyAgreementEnabled = Activer l’accord de clé CNSA 2.0 ML-KEM-1024 pour TLS.
...
policy-DefaultBrowserSettingEnabled = Déterminer si l’utilisateur peut définir { -brand-short-name } comme navigateur par défaut.
