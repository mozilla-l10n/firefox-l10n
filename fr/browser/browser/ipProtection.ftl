...
ipprotection-connection-status-blocked-error-description = Les lois locales nous empêchent de fournir un service VPN dans cette région. <a data-l10n-name="learn-more-link">En savoir plus</a>
# Variables
