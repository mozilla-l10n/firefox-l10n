...
site-permission-install-first-prompt-serial-header = Ce site demande l’accès à vos appareils série. L’accès aux périphériques peut être activé par l’installation d’un module complémentaire.
