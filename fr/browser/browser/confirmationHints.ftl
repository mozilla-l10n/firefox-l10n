...
confirmation-hint-passport-created = Passeport enregistré
confirmation-hint-passport-updated = Passeport mis à jour
...
confirmation-hint-extensions-button-hidden = Déplacé vers le menu
