...
share-panel-heading = Partager la page
...
confirmation-hint-link-copied = Lien copié
...
share-panel-os-share-2 =
    .label =
        { PLATFORM() ->
            [windows] Partager avec Windows…
            [macos] Partager avec le Mac…
           *[other] Partager avec…
        }
