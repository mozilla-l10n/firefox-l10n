...
split-dismiss-button-dont-show-option =
    .label = Ne plus afficher cette recommandation
...
perplexity-callout-theme-1-title = Besoin de la bonne réponse, tout de suite ?
perplexity-callout-theme-2-title = Essayez Perplexity : une nouvelle façon de rechercher
perplexity-callout-theme-1-subtitle-1 = Essayez Perplexity. Choisissez-le via le bouton de recherche lorsque vous souhaitez des réponses complètes et sourcées.
perplexity-callout-theme-1-subtitle-2 = Posez des questions. Obtenez des réponses complètes et correctement sourcées. Pour essayer Perplexity, sélectionnez-le via le bouton de recherche.
perplexity-callout-theme-2-subtitle-1 = Demandez à Perplexity. Vous obtiendrez des réponses complètes et correctement sourcées.
perplexity-callout-theme-2-subtitle-2 = Posez des questions. Obtenez des réponses complètes et correctement sourcées.
perplexity-callout-primary-label = Demandez à Perplexity
...
taskbar-tabs-value-prop-callout-subtitle-v3 = Ouvrez n’importe quel site sous forme d’application dans une fenêtre épurée et sécurisée par { -brand-short-name }.
taskbar-tabs-gaming-callout-title-v3 = Continuez à jouer depuis la barre des tâches
taskbar-tabs-gaming-callout-subtitle-v3 = Ouvrez vos sites de jeux sous forme d’application dans une fenêtre épurée et sécurisée par { -brand-short-name }.
...
sidebar-callout-survey-dissatisfied-2 = Insatisfait·e
...
sidebar-callout-survey-features-question = Voici les fonctionnalités potentielles du panneau latéral. Lesquelles améliorent le plus votre productivité dans { -brand-short-name } ?
sidebar-callout-survey-split-view = Afficher deux sites web à la fois, côte à côte, dans une vue scindée
sidebar-callout-survey-keep-website-open = Garder ouvert dans le panneau latéral un site web, comme une messagerie ou un agenda, pendant que vous poursuivez votre navigation
sidebar-callout-survey-saved-websites-2 = Accéder rapidement à vos marque-pages
sidebar-callout-survey-none-of-above = Aucune de ces propositions
...
actions-callout-title = Effectuez des tâches courantes ou accédez aux paramètres de base
