...
newtab-privacy-message-info-4-cta = Afficher les protections
newtab-privacy-message-info-5 = Les traqueurs bloqués signifient que moins d’entreprises peuvent vous suivre d’un site à l’autre.
newtab-privacy-message-info-5-cta = Afficher les protections
newtab-privacy-message-info-6 = Conservez vos données avec { -brand-short-name }. Nous ne les vendons jamais, mais d’autres navigateurs pourraient le vendre.
...
newtab-privacy-message-info-7-cta = Afficher les protections
...
newtab-privacy-message-info-10 = Enregistrez les mots de passe dans { -brand-short-name } pour utiliser partout des identifiants forts et uniques.
newtab-privacy-message-info-10-cta = Aller aux mots de passe
newtab-privacy-message-info-11 = Découvrez comment { -brand-short-name } vous aide à garder votre navigation privée.
