...
preonboarding-primary-cta-v2 = Continuer
...
preonboarding-manage-and-read-header-v2 = Consultez les conditions d’utilisation et la politique de confidentialité. Gérez les paramètres supplémentaires.
# Label for header style button that toggles showing the Terms of Use
preonboarding-terms-of-use-header-button-title = Consulter nos conditions d’utilisation
...
preonboarding-terms-of-use-header-button-title-b-v2 = Conditions d’utilisation
...
preonboarding-privacy-notice-header-button-title-b-v2 = Politique de confidentialité
...
preonboarding-checklist-crash-reports-label = Envoyer automatiquement les rapports de plantage
preonboarding-checklist-crash-reports-description = Les rapports de plantage nous permettent de diagnostiquer et de corriger des problèmes avec le navigateur. Les rapports peuvent contenir des données personnelles ou sensibles.
