...
settings-update-downloading-2 =
    .label = புதிய பதிப்புகளைப் பதிவிறக்குகிறது — { $transfer }
...
settings-update-unsupported = இந்த கணினியில் நீங்கள் மேலும் புதுப்பித்தல்களை மேற்கொள்ள முடியாது. <a data-l10n-name="unsupported-link">மேலும் அறிய</a>
update-restarting = மீள்துவக்குகிறது…
settings-update-restarting =
    .label = மீள்துவக்குகிறது…
...
settings-update-internal-error = உள் பிழை காரணமாக புதுப்பிப்புகளைச் சரிபார்க்க முடியவில்லை. புதுப்பிப்புகள் <a data-l10n-name="manual-link">{ $displayUrl }</a> இல் கிடைக்கின்றன.
