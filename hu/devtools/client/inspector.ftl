...
colorpicker-tooltip-eyedropper-title = Válasszon színt az oldalon
...
colorpicker-tooltip-color-name-title = Legközelebbi: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Árnyalat
...
inspector-emulation-panel-color-scheme-dark = Sötét
    .aria-label = Sötét színséma emulációjának engedélyezése
# A label text for the no color scheme emulation radio button option (uses user's preference).
inspector-emulation-panel-color-scheme-none = Nincs emuláció
    .aria-label = Színséma-emuláció letiltása
