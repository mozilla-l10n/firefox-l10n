...
contextual-manager-passwords-origin-field-description = Írja be a pontos címet, ahol bejelentkezik ezen az oldalon.
contextual-manager-passwords-username-field =
    .label = Felhasználónév
contextual-manager-passwords-username-field-description = Adja meg a bejelentkezéshez használt felhasználónevet, e-mail-címet vagy fiókszámot.
contextual-manager-passwords-password-field =
    .label = Jelszó
contextual-manager-passwords-password-field-description = Adja meg a jelszót, hogy bejelentkezzen ebbe a fiókba.
