...
clear-data-for-site-title = Törli a webhely összes adatát?
# Variables:
...
clear-data-for-site-dialog-accept-button = Adatok törlése
clear-data-for-site-dialog-cancel-button = Mégse
