...
confirmation-hint-passport-created = Útlevél elmentve
confirmation-hint-passport-updated = Útlevél frissítve
...
confirmation-hint-extensions-button-hidden = Áthelyezve a menübe
