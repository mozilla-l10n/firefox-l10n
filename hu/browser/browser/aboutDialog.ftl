...
helpus-referrals2 = Szeretne segíteni? <label data-l10n-name="helpus-donateLink">Adományozzon</label>, <label data-l10n-name="helpus-shareFirefoxLink">Ossza meg a { -brand-product-name }ot</label>, vagy <label data-l10n-name="helpus-getInvolvedLink">kapcsolódjon be!</label>
