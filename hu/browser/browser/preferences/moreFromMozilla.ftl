...
more-from-moz-solo-card =
    ...
    .description = Fedezze fel a legfrissebb ötleteinket és kísérleti technológiáinkat.
more-from-moz-new-products-card =
    .label = Új { -vendor-short-name } termékek
    .description = Fedezze fel a { -vendor-short-name } legújabb termékeit.
