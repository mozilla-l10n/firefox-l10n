...
fx-view-discoverability-title = Nem akarta bezárni ezt a lapot?
fx-view-discoverability-subtitle = Találja meg és nyissa meg újra itt. Megtartjuk a nemrég bezárt lapok előzményeit.
fx-view-discoverability-primary-button-label = A { -firefoxview-brand-name } megnyitása
fx-view-discoverability-secondary-button-label = Eltüntetés
...
login-status-advisory-title = Kijelentkezve. A bejelentkezéshez kattintson a fiók ikonra.
...
sidebar-callout-survey-satisfaction-question = Mennyire elégedett az oldalsávval kapcsolatos tapasztalatával a { -brand-short-name }ban?
...
sidebar-callout-survey-dissatisfied-2 = Elégedetlen
sidebar-callout-survey-very-dissatisfied-2 = Nagyon elégedetlen
...
sidebar-callout-survey-features-question = A következők lehetséges oldalsáv-funkciók. Melyik javítaná a leginkább a hatékonyságát a { -brand-short-name }ban?
...
sidebar-callout-survey-saved-websites-2 = Gyors hozzáférés a könyvjelzőkhöz
