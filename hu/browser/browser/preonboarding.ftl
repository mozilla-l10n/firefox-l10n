...
preonboarding-checklist-crash-reports-label = Összeomlás-jelentések automatikus elküldése
preonboarding-checklist-crash-reports-description = Az összeomlás-jelentések lehetővé teszik számunkra, hogy diagnosztizáljuk és megoldjuk a böngészőhibákat. A jelentések személyes vagy bizalmas adatokat tartalmazhatnak.
