...
screenshots-connection-error-details = Ellenőrizze az internetkapcsolatot. Ha tud kapcsolódni az internetre, akkor lehet, hogy ideiglenes probléma van a Firefox képernyőképek szolgáltatással.
screenshots-login-error-details = Nem tudtuk elmenteni a képét, mert probléma lépett fel a Firefox képernyőképek szolgáltatással. Próbálja újra később.
...
screenshots-private-window-error-title = A képernyőképek le vannak tiltva Privát böngészésben
