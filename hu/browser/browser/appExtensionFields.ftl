...
extension-default-theme-description2 = Kiegyensúlyozott, ismerős szürke-lila a { -brand-product-name } klasszikus megjelenéséhez.
...
extension-default-theme-name2 = Alapértelmezett
