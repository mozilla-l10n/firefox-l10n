...
firefoxview-syncedtabs-synctabs-header-2 = Lapszinkronizálás kikapcsolva
firefoxview-syncedtabs-synctabs-description-2 = Kapcsolja be újra a szinkronizálást, hogy átvegye az összes lapját a többi eszközről.
...
firefoxview-syncedtabs-loading-header-2 = Lapok lekérése…
firefoxview-syncedtabs-loading-description-2 = Szinkronizálás folyamatban. A lapok hamarosan elérhetőek lesznek.
...
firefoxview-tabpickup-fxa-admin-disabled-header-2 = Lapszinkronizálás kikapcsolva
firefoxview-tabpickup-fxa-disabled-by-policy-description-2 = A szervezete blokkolta ezt a funkciót.
...
firefoxview-tabpickup-network-offline-header-2 = A { -brand-short-name } most nem tud kapcsolódni
firefoxview-tabpickup-network-offline-description-2 = Lehet, hogy offline állapotban van, vagy valami blokkolja a kapcsolatot.
...
firefoxview-tabpickup-signed-out-description-2 = Újrakapcsolódás a többi eszközről származó lapok megjelenítéséhez.
