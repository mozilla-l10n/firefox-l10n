...
webext-default-search-description = A(z) { $addonName } szeretné megváltoztatni az alapértelmezett keresőszolgáltatást erről: { $currentEngine }, erre: { $newEngine }. Ez így rendben van?
