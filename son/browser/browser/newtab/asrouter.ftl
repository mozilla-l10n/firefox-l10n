...
refresh-reinstalled-profile-infobar-message = A ga hima sanda war na n' ka { -brand-short-name } sinji taaga. War ga boona k'a haabu ka goy taaga alhaali maate?
refresh-profile-infobar-button = { -brand-short-name } yeeti…
    .accesskey = e
