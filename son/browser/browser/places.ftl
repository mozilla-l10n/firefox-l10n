...
places-view-sortby-date =
    .label = Fay naarumi kokorante bande
    .accesskey = n
places-view-sortby-visit-count =
    .label = Fay narumi kabu bande
    .accesskey = k
places-view-sortby-date-added =
    .label = Fay tontoni bande
    .accesskey = o
places-view-sortby-last-modified =
    .label = Fay barmay koraw bande
    .accesskey = m
places-view-sortby-tags =
    .label = Fay kanji bande
    .accesskey = j
places-cmd-find-key =
    .key = f
places-back-button =
...
places-locked-prompt = Doo-šilbawey nda taariki dabariɲaŋoo ši hin ka goy zama { -brand-short-name } tukey affoo goo goy ra porogaram foo da ra. A ga hin ka tee kaŋ saajaw goyjinay ti šendaa woo aššiloo.
