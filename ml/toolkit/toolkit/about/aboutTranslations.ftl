...
about-translations-title = { -brand-short-name } മൊഴിമാറ്റങ്ങൾ
# The brief description of the Translations functionality on the page.
about-translations-description = താങ്ങളുടെ സ്വകാര്യത മാനിക്കുന്ന ഉടനടി മൊഴിമാറ്റങ്ങൾ
about-translations-learn-more-link = കൂടുതല്‍ അറിയുക
...
about-translations-input-placeholder =
    .placeholder = മൊഴിമാറ്റാൻ എഴുത്തു ചേൎക്കുക
