...
return-to-amo-addon-title = ഇപ്പോൾ താങ്ങളോടു് കൊണ്ടുവരാം
...
tab-groups-onboarding-saved-groups-title = ടാബുക്കൂട്ടത്തിനെ താങ്ങൾ അടച്ചാലെങ്കിലും താങ്ങൾക്കു് അതിനെ എപ്പോൾ വേണമെങ്കിലും ഇവിടെ പിന്നെയും തുറക്കാം.
