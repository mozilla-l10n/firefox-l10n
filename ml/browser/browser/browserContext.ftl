...
main-context-menu-send-to-device-2 =
    .label = ഉപകരണത്തിലേക്കു് അയയ്ക്കുക
    .accesskey = ഉ
main-context-menu-send-to-mobile-2 =
    .label = മൊബൈലിലേക്കു് അയയ്ക്കുക
    .accesskey = മ
main-context-menu-send-to-mobile-enable-sync2 = ടാബയയ്ക്കാൻ സമന്വയം പ്രവൎത്തനക്ഷമമാക്കുക
main-context-menu-send-to-mobile-sign-in-from-link = കണ്ണി അയയ്ക്കാൻ പ്രവേശിക്കുക
main-context-menu-send-to-mobile-sign-in-from-page = താൾ അയയ്ക്കാൻ പ്രവേശിക്കുക
...
main-context-menu-pdfjs-cut-page =
    .label = താളു മുറിക്കുക
main-context-menu-pdfjs-delete-page =
    .label = താളു മായ്ക്കുക
main-context-menu-pdfjs-save-page =
    .label = തിരഞ്ഞെടുത്തതു പേരോടെ കരുതിവയ്ക്കക…
