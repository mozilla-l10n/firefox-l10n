...
contextual-manager-passwords-command-create = ഒളിവാക്കു് ചേർക്കുക
...
contextual-manager-passwords-export-os-auth-dialog-message-win = താങ്ങളുടെ ഒളിവാക്കുകളെ കയറ്റുമതിക്കാനായി വിണ്ടോസു് പ്രവേശണവിശദാംശങ്ങളെ നൽകുക.ഇത് താങ്ങളുടെ സുരക്ഷയെ സംരക്ഷിക്കാൻ സഹായിക്കുന്നു.
# This message can be seen when attempting to export a password in about:logins
# The macOS strings are preceded by the operating system with "Firefox is trying to "
# and includes subtitle of "Enter password for the user "xxx" to allow this." These
# notes are only valid for English. only provide the reason that account verification is needed. Do not put a complete sentence here.
contextual-manager-passwords-export-os-auth-dialog-message-macosx = കരുതിവച്ച ഒളിവാക്കുകൾ കയറ്റുമതിക്കുക
# This message can be seen when attempting to reveal a password in contextual password manager on Windows
contextual-manager-passwords-reveal-password-os-auth-dialog-message-win = താങ്ങളുടെ ഒളിവാക്കു് കാണാനായി വിണ്ടോസു് പ്രവേശണവിശദാംശങ്ങളെ നൽകുക.ഇത് താങ്ങളുടെ സുരക്ഷയെ സംരക്ഷിക്കാൻ സഹായിക്കുന്നു.
# The MacOS string is preceded by the operating system with "Firefox is trying to ".
# Only provide the reason that account verification is needed. Do not put a complete sentence here.
contextual-manager-passwords-reveal-password-os-auth-dialog-message-macosx = കരുതിവച്ച ഒളിവാക്കു് കാണിക്കുക
# This message can be seen when attempting to edit a login in contextual password manager on Windows.
contextual-manager-passwords-edit-password-os-auth-dialog-message-win = താങ്ങളുടെ ഒളിവാക്കു് തിരുത്താനായി വിണ്ടോസു് പ്രവേശണവിശദാംശങ്ങളെ നൽകുക.ഇത് താങ്ങളുടെ സുരക്ഷയെ സംരക്ഷിക്കാൻ സഹായിക്കുന്നു.
# The MacOS string is preceded by the operating system with "Firefox is trying to ".
# On MacOS, only provide the reason that account verification is needed. Do not put a complete sentence here.
contextual-manager-passwords-edit-password-os-auth-dialog-message-macosx = കരുതിവച്ച ഒളിവാക്കു് തിരുത്തുക
# This message can be seen when attempting to copy a password in contextual password manager on Windows.
contextual-manager-passwords-copy-password-os-auth-dialog-message-win = താങ്ങളുടെ ഒളിവാക്കു് പകൎത്താനായി വിണ്ടോസു് പ്രവേശണവിശദാംശങ്ങളെ നൽകുക.ഇത് താങ്ങളുടെ സുരക്ഷയെ സംരക്ഷിക്കാൻ സഹായിക്കുന്നു.
# The MacOS string is preceded by the operating system with "Firefox is trying to ".
# Only provide the reason that account verification is needed. Do not put a complete sentence here.
contextual-manager-passwords-copy-password-os-auth-dialog-message-macosx = കരുതിവച്ച ഒളിവാക്കു് പകർത്തുക
contextual-manager-passwords-import-file-picker-title = ഒളിവാക്കുകൾ ഇറക്കിമതിക്കുക
...
contextual-manager-passwords-import-learn-more = ഒളിവാക്കുകൾ കയറ്റുമതി ചെയ്യുന്നതിനെക്കുറിച്ചു് കൂടുതലറിയുക
contextual-manager-passwords-export-success-heading =
    .heading = ഒളിവാക്കുകൾ കയറ്റുമതിച്ചു
contextual-manager-passwords-export-success-button = ചെയ്തു
# Export passwords to file dialog
contextual-manager-export-passwords-dialog-title = ഫയലേക്കു് ഒളിവാക്കുകളെ കയറ്റുമതിക്കണോ?
contextual-manager-export-passwords-dialog-confirm-button = കയറ്റുമതി തുടരുക
# Title of the file picker dialog
contextual-manager-passwords-export-file-picker-title = { -brand-short-name } നിന്നു് ഒളിവാക്കുകൾ കയറ്റുമതി ചെയ്യുക
# The default file name shown in the file picker when exporting saved logins.
# The resultant filename will end in .csv (added in code).
contextual-manager-passwords-export-file-picker-default-filename = ഒളിവാക്കുകൾ
...
contextual-manager-passwords-remove-all-title =
    { $total ->
        [1] ഒളിവാക്കു് മാറ്റട്ടെ?
        [one] { $total } ഒളിവാക്കുകളാകെ മാറ്റണോ?
       *[other] { $total } ഒളിവാക്കുകളാകെ മാറ്റണോ?
    }
...
contextual-manager-passwords-username-label = ഉപയോക്തൃപ്പേരു്
    .data-after = പകൎത്തി
# The attribute .data-after describes the text that should be displayed for the ::after pseudo-selector
contextual-manager-passwords-password-label = ഒളിവാക്കു്
    .data-after = പകൎത്തി
contextual-manager-passwords-radiogroup-label =
    .aria-label = ഒളിവാക്കുകൾ അരിയ്ക്കുക
# Variables
#   $url (string) - The url associated with the new login
contextual-manager-passwords-add-password-success-heading =
    .heading = { $url }-നെ ഒളിവാക്കു് ചേൎത്തു
contextual-manager-passwords-add-password-success-button = കാണുക
# Variables
#   $url (string) - The url associated with the existing login
contextual-manager-passwords-password-already-exists-error-heading =
    .heading = { $url }-ൽ ഒരു ഒളിവാക്കും ഉപയോക്തൃപ്പേരും നിലവിലുണ്ടു്.
contextual-manager-passwords-password-already-exists-error-button = ഒളിവാക്കിലേക്കു് ചെല്ലുക
contextual-manager-passwords-update-password-success-heading =
    .heading = ഒളിവാക്കു് കരുതിവച്ചു
...
contextual-manager-passwords-delete-password-success-heading =
    .heading =
        { $total ->
            [1] ഒളിവാക്കു് മാറ്റി
            [one] ഒളിവാക്കുകൾ മാറ്റി
           *[other] ഒളിവാക്കുകൾ മാറ്റി
        }
...
contextual-manager-passwords-remove-login-card-title = ഒളിവാക്കു് മായ്ക്കുക?
...
contextual-manager-passwords-alert-card =
    .aria-label = ഒളിവാക്കറിയിപ്പുകൾ
contextual-manager-passwords-alert-back-button =
    .label = പിന്നോട്ട്
contextual-manager-passwords-alert-list =
    .aria-label = അറിയിപ്പു് പട്ടിക
contextual-manager-passwords-change-password-button = ഒളിവാക്കു് മാറ്റുക
contextual-manager-passwords-vulnerable-password-link-message = { -brand-product-name }-നു് മുരട്ടില്ലാത്ത ഒളിവാക്കുകളെക്കുറിച്ചു് എങ്ങനെ അറിയാം?
...
contextual-manager-passwords-origin-field =
    .label = വെബ്സൈറ്റ് വിലാസം
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = താങ്ങൾ പ്രവേശിക്കാൻ പോവുന്ന തിട്ടമായ വിലാസം നൽകുക
contextual-manager-passwords-username-field =
    .label = ഉപയോക്തൃനാമം
contextual-manager-passwords-username-field-description = താങ്ങൾ പ്രവേശിക്കാൻ ഉപയോഗിക്കുന്ന ഉപയോക്തൃപ്പേരും ഇ-തപാലും അക്കൗണ്ടക്കവും നൽകുക
...
contextual-manager-password-login-line =
    .aria-label = ഒളിവാക്കു് പകൎത്തുക
    .title = ഒളിവാക്കു് പകൎത്തുക
# "(Warning)" indicates that a login's password field has an alert icon.
contextual-manager-password-login-line-with-alert =
    .aria-label = ഒളിവാക്കു് പകൎത്തുക (മുന്നറിയിപ്പു്)
...
contextual-manager-hide-password-button =
    .aria-label = ഒളിവാക്ക് മറയ്ക്കുക
    .title = ഒളിവാക്ക് മറയ്ക്കുക
