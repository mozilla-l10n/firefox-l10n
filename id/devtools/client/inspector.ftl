...
colorpicker-tooltip-eyedropper-title = Pilih warna di laman
...
colorpicker-tooltip-color-name-title = Terdekat dengan: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Rona
# A title text for the alpha slider in the color picker tooltip.
colorpicker-tooltip-alpha-slider-title = Keburaman
