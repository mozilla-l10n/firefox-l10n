...
simple-highlighters-message = Saat prefers-reduced-motion aktif, sorotan yang lebih sederhana dapat diaktifkan di panel pengaturan untuk menghindari efek warna berkedip.
