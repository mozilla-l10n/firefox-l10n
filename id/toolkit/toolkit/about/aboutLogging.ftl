...
about-logging-preset-ml-label = Pembelajaran Mesin
about-logging-preset-ml-description = Log modul untuk mendiagnosis masalah pembelajaran mesin
about-logging-preset-web-compat-label = Kompat Web
about-logging-preset-web-compat-description = Modul log untuk mendiagnosis masalah kompatibilitas web
about-logging-preset-navigation = Navigasi
about-logging-preset-navigation-description = Log modul untuk mendiagnosis masalah navigasi dan riwayat sesi
