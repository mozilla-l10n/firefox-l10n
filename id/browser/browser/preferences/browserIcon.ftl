...
appearance-browser-icon-entry-group =
    .label = Ikon peramban
    .description = Pilih suatu ikon ubahan bagi bilah tugas, desktop, dan menu mulai Anda.
appearance-browser-icon-button =
    .label = Ubah ikon peramban
...
appearance-browser-icon-requirement =
    .message = Lengkapi dan buka ikon rubah bonus untuk mempersonalisasi { -brand-short-name }.
...
appearance-browser-icon-momo =
    .label = Momo
    .description = Dibuat oleh @heyheymomodraws
