...
extension-default-theme-description2 = Abu-abu-ungu yang seimbang dan familiar untuk tampilan { -brand-product-name } klasik.
...
extension-nova-dusk-name = Senja
