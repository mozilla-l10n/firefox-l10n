...
ipprotection-feature-introduction-text-summer-promo-1 = Nyalakan untuk menjaga penjelajahan Anda lebih pribadi. <a data-l10n-name="summer-promo-link">Dapatkan bandwidth tak terbatas</a> dan lebih banyak lokasi tempat asal menjelajah. Sekarang hingga 31 Agustus.
ipprotection-feature-introduction-title-summer-promo = Punya rencana perjalanan? Bawa privasi bersama Anda.
...
ipprotection-feature-introduction-link-text-captive-portal-1 = Dapatkan <a data-l10n-name="learn-more-vpn">privasi ekstra</a> dengan memilih dari beberapa lokasi untuk menyembunyikan tempat Anda menjelajah.
ipprotection-feature-introduction-button-primary = Selanjutnya
ipprotection-feature-introduction-button-secondary-not-now = Jangan sekarang
ipprotection-feature-introduction-button-secondary-not-now-menuitem =
    .label = Jangan sekarang
ipprotection-feature-introduction-button-secondary-no-thanks = Tidak, terima kasih
ipprotection-feature-introduction-button-secondary-no-thanks-menuitem =
    .label = Tidak, terima kasih
ipprotection-feature-introduction-button-secondary-remove = Hapus VPN dari bilah alat
