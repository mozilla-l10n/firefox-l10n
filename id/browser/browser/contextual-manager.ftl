...
contextual-manager-passwords-origin-field =
    .label = Alamat Situs Web
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Masukkan alamat yang tepat untuk masuk ke situs ini.
contextual-manager-passwords-username-field =
    .label = Nama Pengguna
contextual-manager-passwords-username-field-description = Masukkan nama pengguna, alamat surel, atau nomor akun yang Anda gunakan untuk masuk.
contextual-manager-passwords-password-field =
    .label = Sandi
contextual-manager-passwords-password-field-description = Masukkan sandi untuk masuk ke akun ini.
