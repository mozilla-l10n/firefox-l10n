...
helpus-referrals2 = Ingin membantu? <label data-l10n-name="helpus-donateLink">Menyumbang</label>, <label data-l10n-name="helpus-shareFirefoxLink">Bagikan { -brand-product-name }</label>, atau <label data-l10n-name="helpus-getInvolvedLink">terlibat!</label>
