...
contextual-manager-passwords-origin-field =
    .label = Ñanduti kundaharape
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Ehai kundaharape emoñepyrũtaha tembiapo ko tendápe.
contextual-manager-passwords-username-field =
    .label = Poruhára réra
contextual-manager-passwords-username-field-description = Ehai poruhára réra, ñanduti veve kundaharape térã mba’ete papapy eike hag̃ua.
contextual-manager-passwords-password-field =
    .label = Ñe’ẽñemi
contextual-manager-passwords-password-field-description = Ehai ñe’ẽñemi eiporúva eike hag̃ua ko mba’etépe.
