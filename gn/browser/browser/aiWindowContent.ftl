...
smart-window-opened-tabs-summary-group =
    { $count ->
        [one] Heñóima aty “{ $label }” ha ijurujáma { $count } tendayke.
       *[other] Heñóima aty “{ $label }” ha ijurujáma { $count } tendaykeita.
    }
...
# should not be translated. The <a> wraps "Exa" as a link to a support
# article explaining the third-party web search integration.
action-log-searched-web-with-exa = Ojeheka ñandutípe <a data-l10n-name="exa-link">Exa</a> ndive
...
smartwindow-assistant-citations-more-label = +{ $count } hetave
