...
crashed-single-offer-help-message = Eiporavo { crashed-restore-tab-button } oñemyanyhẽjey hag̃ua togue.
crashed-multiple-offer-help-message = Eiporavo { crashed-restore-tab-button } ýrõ { crashed-restore-all-button } oñemyanyhẽjey hag̃ua togue /pages.
