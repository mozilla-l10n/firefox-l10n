...
newtab-privacy-empty-state-tally = Ápe oñembohekopyahupáta.
...
newtab-stocks-list-markets = Ñemuhaguasu
    .label = Ñemuhaguasu
...
newtab-stocks-list-watchlist = Tapykuehoha rysýi
...
newtab-clock-city-fr-paris = Parĩ
newtab-clock-city-fr-lyon = Liõ
newtab-clock-city-fr-marseille = Marsella
newtab-clock-city-fr-toulouse = Toulouse
newtab-clock-city-in-kolkata = Kalkuta
newtab-clock-city-in-mumbai = Mumbái
newtab-clock-city-in-delhi = Ndéli
newtab-clock-city-in-bangalore = Bangalore
newtab-clock-city-cn-shanghai = Changái
newtab-clock-city-cn-beijing = Pekĩ
...
newtab-clock-city-id-jakarta = Jakáta
...
newtab-clock-city-ca-vancouver = Vangúve
newtab-clock-city-au-sydney = Sínei
...
newtab-clock-city-mx-mexico-city = Méjiko táva
newtab-clock-city-mx-guadalajara = Guadalajara
newtab-clock-city-it-rome = Rróma
newtab-clock-city-it-milan = Milã
newtab-clock-city-ru-moscow = Mosuku
newtab-clock-city-ru-saint-petersburg = San Petersburgo
newtab-clock-city-gb-london = Londye
...
newtab-clock-city-be-brussels = Vuruséla
...
newtab-clock-city-eg-cairo = Káiro
newtab-clock-city-se-stockholm = Etohom
newtab-clock-city-ro-bucharest = Mbukaréte
newtab-clock-city-th-bangkok = Vãkoke
...
newtab-clock-city-pk-karachi = Karáchi
...
newtab-clock-city-dk-copenhagen = Kopenihage
newtab-clock-city-pe-lima = Lima
newtab-clock-city-ke-nairobi = Nairóvi
