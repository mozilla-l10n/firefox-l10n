...
personal-info-group =
    .label = Marandu nderehegua
autofill-personal-info-checkbox-message =
    .label = Eñongatu ha emyanyhẽ marandu nderehegua
autofill-personal-info-manage-button =
    .label = Emongu’e marandu nderehegua
...
passports-edit-passport-button-label =
    .aria-label = Mbosako’i
passports-delete-passport-prompt-title = ¿Embogue ko pasaporte?
passports-delete-passport-prompt-confirm-button = Mboguete
passports-delete-passport-prompt-cancel-button = Eheja
...
preferences-doh-radio-group =
    .aria-label = Emyandy DNS HTTPS ári eiporúvo:
...
preferences-etp-tracker-count-enabled =
    .label = Ejechauka tapykuehoha jokopyre kundaharendápe
