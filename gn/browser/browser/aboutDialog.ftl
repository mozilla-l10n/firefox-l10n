...
helpus-referrals2 = ¿Eipytyvõsepa? <label data-l10n-name="helpus-donateLink">Embojopói</label>, <label data-l10n-name="helpus-shareFirefoxLink">Emoherakuã { -brand-product-name }</label>, térã <label data-l10n-name="helpus-getInvolvedLink">¡eike pype!</label>
