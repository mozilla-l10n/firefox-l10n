...
safeb-blocked-malware-page-error-desc-override = <span data-l10n-name='sitename'>{ $sitename }</span> oñemomarandúkuri ivaiha <a data-l10n-name='error_desc_link'>oreko rupi software mba’evai aposeha</a>. Remomarandukuaa avei <a data-l10n-name='report_detection'>ojejavyhague</a> ýrõ <a data-l10n-name='ignore_warning_link'>epena’ỹkuaa kóvare</a> ha eike tenda hekorosã’ỹvape.
...
safeb-blocked-malware-page-error-desc-no-override-sumo = <span data-l10n-name='sitename'> ha’e <a data-l10n-name='error_desc_link'>oñemomarandúva oguerekoha software mba’evaiapoha</a>.
