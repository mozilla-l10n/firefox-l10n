...
ssl-error-wrong-certificate = Ñemuhára reraite oiko’ỹva: ñe’ẽ ñemiguáva mba’ekuaarã ñemíva ndojueheguái pe ñe’ẽ opavaveguáva ndive mba’ekuaarã mboajepyréva ryepýpe.
...
ssl-error-handshake-failure-alert = Pe ambue SSL jeikekatu apýra ndaikatúi ombohekoporã peteĩ aty rehegua moneĩpýva tekorosãrã mba'aporã.
...
ssl-error-extract-public-key-failure = SSL ndaikatumo'ãi oguenohẽ ñemigua opavavépe g̃uarãva pe mboajepyre ambue apýra jeikekatu pegua.
...
ssl-error-iv-param-failure = Pe ayvu PKCS11 nomoneĩri emoñe'ẽasávo peteĩ IV mba'aporãme.
...
ssl-error-rx-malformed-hello-verify-request = Og̃uahẽ peteĩ marandu ñomongetarãva Hola Verifique mba'ejerure ijysaja oĩporã'ỹva reheve.
ssl-error-rx-unexpected-hello-verify-request = SSL-pe og̃uahẽ peteĩ marandu ñomongetarãva Hola Verifique Mba'ejerure reha'ãrõ'ỹva.
...
sec-error-no-module = aranduka'aty rekorosãrã: mba'evéichagua tekorosãrã ra'ãha ndaikatumo'ãi ombohape pe tembiapo ojerurepyre.
...
sec-error-baggage-not-created = oiko jejavy emoheñóivo mba'e guerahaha (baggage object)
...
sec-error-not-fortezza-issuer = FORTEZZA joajuha ambue hendaguáva oguereko peteĩ mboajepyréva ndaha'éiva FORTEZZA mba'etéva.
...
sec-error-bad-template = Ndaikatúikuri oñembopapapy'o umi mba'ekuaarã ASN.1. Pe kuatiaite moha'eñopyréva ndoikói.
...
sec-error-extra-input = Pe ñe'ẽmondo DER ndivegua mbopapapypyréva oguereko mba'ekuaarã ykepegua ojepuru'ỹva.
...
sec-error-crl-invalid-version = Pe mbojevyjey rysýi mboajepyréva guenohẽhára rehegua oguereko peteĩ papapy peteĩchagua ojekuaa'ỹva.
...
sec-error-failed-to-encode-data = Jejavy embopapapykuévo mba’ekuaarã pe ASN1 mbopapapyha ndive
