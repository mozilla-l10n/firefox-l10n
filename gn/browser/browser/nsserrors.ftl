...
ssl-error-sign-hashes-failure = Ndaikatumo'ãi emboheraguapy ñanduti rupi umi mba'ekuarã jerupyréva ehechajey hag̃ua imboajepyre.
...
sec-error-failed-to-encode-data = Jejavy embopapapykuévo mba'ekuarã pe ASN1 mbopapapyha ndive
