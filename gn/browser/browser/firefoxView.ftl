...
firefoxview-tabpickup-network-offline-header-2 = { -brand-short-name }-pe ndaikatúi eike ko’ag̃aite
firefoxview-tabpickup-network-offline-description-2 = Ikatu oĩ hína jeikekuaa’ỹre térã oĩ peteĩ mba’e ojokóva upe jeike.
...
firefoxview-tabpickup-generic-sync-error-description-2 = { -brand-short-name }-pe ndaikatúi ojeike. Eha’arõ sapy’ami ha eha’ã jey
...
firefoxview-search-text-box-bookmarks =
    .placeholder = Eheka techaukahápe
