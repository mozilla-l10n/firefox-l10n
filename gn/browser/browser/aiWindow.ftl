...
aiwindow-history-menu-chat-history = Jechatea rembiasakue
aiwindow-history-menu-back =
    .aria-label = Tapykue
    .tooltiptext = Tapykue
aiwindow-history-menu-view-all-chats = Ehechapaite jechateakue
aiwindow-history-menu-settings = { -smart-window-brand-name } ñemboheko
