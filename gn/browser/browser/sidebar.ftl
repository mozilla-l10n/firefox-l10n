...
sidebar-show-preview-on-hover =
    .label = Jehechaha ypy tojekuaa ohasávo anguja
...
sidebar-opentabs-preview-heading = Tendayke ramovéva
...
sidebar-menu-open-tabs-header =
    .heading = Embojuruja tendaykeita
