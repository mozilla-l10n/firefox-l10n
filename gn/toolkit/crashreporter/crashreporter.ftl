...
crashreporter-crashed-and-restore = { -brand-short-name } iñapañuái ha ndoikói. Roñeha’ãta romyatyrõ tendayke ha ovetãnguéra oñepyrũjey vove.
crashreporter-plea = Orepytyvõ hag̃ua rojuhu ha romyatyrõ ko apañuái, ikatu egueruka oréve marandu’i jejavy rehegua.
...
crashreporter-submit-failure = Iñapysẽ peteĩ apañuái emondokuévo nemarandu.
...
crashreporter-crash-details = Ehechakuaa ko apañuái rehegua { $url } ndive.
