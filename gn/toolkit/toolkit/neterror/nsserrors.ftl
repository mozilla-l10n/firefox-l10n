...
sec-error-retry-password = Ñe’ẽñemi pyahu emoingéva ndoikói. Ikatu eha’ã jey ag̃ave.
...
sec-error-retry-old-password = Ymaguare ñe’ẽñemi emoingéva hekope’ỹ. Ikatu eha’ã jey ag̃ave.
...
sec-error-ocsp-try-server-later = Mohendahavusu OCSP oipota eha’ã jey ag̃ave.
