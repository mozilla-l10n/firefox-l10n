...
plugins-openh264-description = Ko mba’ejoajurã Mozilla oñemohendáta ijeheguiete ojapo hag̃ua WebRTC ojeruréva ha omoneĩta WebRTC ohenói mba’e’oka ndive oikotevẽva ta’ãngamýi H.264 codec. Eike https://www.openh264.org/ ehecha codec ayvu reñoiha ha eikuaave hag̃ua ko tembiporu’i rehegua.
...
find-more-addons-promo-open-amo-button = Eheka jepysokue ha temakuéra

## Promo footer shown in the about:addons extensions list view when
## Project Nova styles are enabled.
## In the message, "tools" refers to Firefox extensions.

find-more-extensions-promo-open-amo-button = Ejeporeka jepysokuére
