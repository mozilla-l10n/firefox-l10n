...
certmgr-cert-detail-cn =
    .value = Téra heta oĩva (CN)
certmgr-cert-detail-o =
    .value = Atyguasu (O)
certmgr-cert-detail-ou =
    .value = Joaju ñembohekokatu (OU)
certmgr-cert-detail-serialnumber =
    .value = Papapy syryry
certmgr-cert-detail-sha256-fingerprint =
    .value = SHA-256 kuã rapykuere
certmgr-cert-detail-sha1-fingerprint =
    .value = SHA1 kuã rapykuere
...
delete-ca-cert-impact = Emboguetéramo, térã nderejeroviavéiramo pe, mboajepyréva moakãha omboajéva rehe (CA), ko tembipuru'i ndojeroviamo'ãvéima oikmeraẽva mboajepyréva oguenohẽva ko CA.
