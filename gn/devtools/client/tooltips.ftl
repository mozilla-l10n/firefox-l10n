...
inactive-css-no-default-anchor = <strong>{ $property }</strong> ndojapói mba’evete ko mba’eporúpe ndorekói rupi peteĩ mbojuajuha ijypykuéva.
...
inactive-css-not-block-flex-grid-container = <strong>{ $property }</strong> ndorekói mba’evéichagua mba’evai ko mba’eporúpe ndaha’éi rupi mba’eporu ikatúva block, flex ha grid.
...
inactive-css-not-grid-or-flex-or-absolutely-positioned-item-fix = Embojuaju <strong>position:absolute</strong> mba’eporúpe, térã <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong> térã <strong>display:inline-flex</strong>pe mba’eporu túvape. { learn-more }
inactive-css-not-grid-or-absolutely-positioned-item-fix = Embojuaju <strong>position:absolute</strong> mba’eporúpe, térã <strong>display:grid</strong> térã <strong>display:inline-grid</strong> pe mba’eporu rúpe. { learn-more }
inactive-css-not-absolutely-positioned-item-fix = Eñeha’ã embojuaju <strong>position:absolute</strong> mba’eporúpe. { learn-more }
inactive-css-no-default-anchor-fix = Eñeha’ã embojuaju <strong>position-anchor</strong> téra oikóva ndive. { learn-more }
