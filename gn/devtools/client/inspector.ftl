...
colorpicker-tooltip-spectrum-dragger-title = Rete’ã
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = Eiporavo sa’y kuatiaroguépe
...
colorpicker-tooltip-color-name-title = Hi’ag̃uive: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Sa’yvera
