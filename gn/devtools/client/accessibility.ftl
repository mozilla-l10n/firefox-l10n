...
accessibility-text-label-issue-area = Eiporu pe tekome’ẽ <code>alt</code> embohéra hag̃ua mba’epuru <div>area</div> oguerekóvan tekome’ẽ <span>href</span>. <a>Eikuaave</a>
...
accessibility-text-label-issue-fieldset-legend2 = Eiporu mba’epuru <code>legend</code> emboheramoĩvo <span>fieldset</span>. <a>Eikuaave</a>
...
accessibility-text-label-issue-glyph = Eiporu tekome’ẽ <code>alt</code> emboheramoĩ hag̃ua mba’epuru <span>mglyph</span>. <a>Eikuaave</a>
...
accessibility-text-label-issue-optgroup-label2 = Eiporu mba’epuru <code>label</code> emboheramoĩvo <span>optgroup</span>. <a>Eikuaave</a>
