...
serviceworker-worker-updated = Hekopyahupyre <time>{ DATETIME($date, day: "numeric", hour: "numeric", minute: "numeric", month: "long", second: "numeric", year: "numeric") }</time>
...
session-history-navigate-button-title = Eikundaha { $index } jeikeha tembiaporã rembiasakuépe
# Header for the Session History page when session history diagrams are unavailable
session-history-unavailable = Ediagrama jeike rembiasakue ojeporukuaa’ỹva
# Text displayed for when the target does not support showing session history diagrams
session-history-target-unsupported = Jehoha nomoneĩri ojehechávo diagrama jeike rembiasakuegua
