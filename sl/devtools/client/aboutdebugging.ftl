...
about-debugging-sidebar-this-firefox2 = Ta { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Ta { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Namestitev
