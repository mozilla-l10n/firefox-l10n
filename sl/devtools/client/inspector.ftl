...
colorpicker-tooltip-spectrum-dragger-title = Paleta
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = Izberite barvo na strani
...
colorpicker-tooltip-color-name-title = Najbližje: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Odtenek
