...
details-notification-softblocked-extension-disabled =
    .message = Ta razširitev krši Mozilline pravilnike, zato je bila onemogočena. Lahko jo omogočite, vendar je to morda nevarno.
...
details-notification-softblocked-other-disabled =
    .message = Ta dodatek krši Mozilline pravilnike, zato je bil onemogočen. Lahko ga omogočite, vendar je to morda nevarno.
