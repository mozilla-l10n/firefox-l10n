...
details-notification-hard-blocked-extension =
    .message = Ta razširitev je zavrnjena, ker krši Mozilline pravilnike, in je bila onemogočena.
details-notification-hard-blocked-other =
    .message = Ta dodatek je zavrnjen, ker krši Mozilline pravilnike, in je bil onemogočen.
...
details-notification-soft-blocked-extension-disabled =
    .message = Ta razširitev je omejena, ker krši Mozilline pravilnike, in je bila onemogočena. Lahko jo omogočite, vendar je to morda nevarno.
details-notification-soft-blocked-extension-enabled =
    .message = Ta razširitev krši Mozilline pravilnike. Njena uporaba je morda nevarna.
details-notification-soft-blocked-other-disabled =
    .message = Ta dodatek je omejen, ker krši Mozilline pravilnike, in je bil onemogočen. Lahko ga omogočite, vendar je to morda nevarno.
