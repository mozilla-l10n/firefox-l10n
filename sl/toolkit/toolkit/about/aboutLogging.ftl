...
about-logging-preset-navigation = Krmarjenje
about-logging-preset-navigation-description = Beleženje modulov za diagnosticiranje težav s krmarjenjem in z zgodovino seje
