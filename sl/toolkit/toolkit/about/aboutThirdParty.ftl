...
third-party-requires-restart = Za spremembo blokad modulov tretjih ponudnikov se mora { -brand-short-name } znova zagnati.
third-party-should-restart-title = Znova zaženi { -brand-short-name(sklon: "tozilnik") }
third-party-should-restart-ok = Znova zaženi { -brand-short-name(sklon: "tozilnik") } zdaj
