...
datetime-picker-label =
    .aria-label = Izberite datum in uro
...
time-spinner-hour-previous =
    .aria-label = Prejšnja ura
time-spinner-hour-next =
    .aria-label = Naslednja ura
time-spinner-minute-previous =
    .aria-label = Prejšnja minuta
time-spinner-minute-next =
    .aria-label = Naslednja minuta
time-spinner-second-previous =
    .aria-label = Prejšnja sekunda
time-spinner-second-next =
    .aria-label = Naslednja sekunda
time-spinner-millisecond-previous =
    .aria-label = Prejšnja milisekunda
time-spinner-millisecond-next =
    .aria-label = Naslednja milisekunda
time-spinner-day-period-previous =
    .aria-label = Prejšnji del dneva
time-spinner-day-period-next =
    .aria-label = Naslednji del dneva
