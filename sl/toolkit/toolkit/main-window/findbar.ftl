...
findbar-match-diacritics =
    ...
    .accesskey = i
    .tooltiptext = Pri iskanju razlikuj med črkami z diakritičnimi znamenji in brez njih (na primer, pri iskanju besede »kokos« ne bo upoštevan zadetek »kokoš«)
findbar-entire-word =
    .label = Cele besede
    .accesskey = C
    .tooltiptext = Išči samo cele besede
findbar-not-found = Iskanega ni mogoče najti
findbar-wrapped-to-top = Doseženo dno strani, nadaljevanje od vrha
