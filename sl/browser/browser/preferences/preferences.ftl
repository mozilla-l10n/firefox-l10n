...
tls-key-logging-notice-nav =
    .label = Aplikacija ali storitev lahko vidi vaš šifriran promet.
category-list =
...
applications-save-for-new-types2 =
    .label = Samodejno shranjuj datoteke
    .accesskey = S
...
browsing-picture-in-picture-toggle-enabled-2 =
    .label = Uporabljaj pogled slike v sliki
    .accesskey = e
...
forms-primary-pw-on-2 = Glavno geslo je <strong>VKLJUČENO</strong>
forms-primary-pw-on =
...
preferences-doh-radio-group =
    .aria-label = Omogoči DNS preko HTTPS. Raven zaščite:
...
related-settings-accessibility-link =
    .label = Prilagodi povečavo in pisavo v zavihku Dostopnost
...
preferences-ai-controls-speech-recognition-control =
    .description = Na napravi pretvarjajte govor v besedilo.
...
preferences-ai-controls-block-confirmation-key-points = Glavni poudarki v predogledih povezav
...
preferences-etp-level-radio-group =
    .aria-label = Izboljšana zaščita pred sledenjem
...
preferences-etp-custom-cookie-behavior-block-cross-site-tracking-cookies =
    .label = Blokiraj piškotke za sledenje med spletnimi mesti
