...
sync-disconnect-heading = Ali želite odstraniti tudi podatke brskalnika na tem računalniku? Vaši podatki za { -sync-brand-name } bodo v vsakem primeru ostali v vašem računu.
