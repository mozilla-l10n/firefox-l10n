...
appearance-browser-icon-entry-group =
    .label = Ikona brskalnika
    .description = Izberite ikono za opravilno vrstico, namizje in meni Start.
appearance-browser-icon-button =
    .label = Zamenjaj ikono brskalnika
...
appearance-browser-icon-requirement =
    .message = Opravite spodnja dejanja in odklenite dodatne ikone, s katerimi si boste prilagodili { -brand-short-name(sklon: "tozilnik") }.
...
appearance-browser-icon-unlocked =
    .message = Odklenili ste vse dodatne ikone!
appearance-browser-icon-set-default-button =
    .label = Nastavi kot privzeti brskalnik
appearance-browser-icon-pin-button =
    .label = Pripni v opravilno vrstico
...
appearance-browser-icon-momo =
    .label = Momo
    .description = Avtor: @heyheymomodraws
