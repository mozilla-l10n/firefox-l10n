...
safe-mode-window =
    .title = { -brand-short-name }: Varni način
    .style = max-width: 400px
start-safe-mode =
    .label = Začni v varnem načinu
troubleshoot-mode-window =
    .title = Ali želite odpreti { -brand-short-name } v načinu za odpravljanje težav?
    .style = max-width: 400px
...
safe-mode-description-details = Vaši dodatki in prilagojene nastavitve bodo začasno onemogočene, nekatere funkcije { -brand-short-name }a pa morda ne bodo delovale kot trenutno.
