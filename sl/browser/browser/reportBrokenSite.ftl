...
report-broken-site-mainview-title = Prijavi nedelujočo stran
...
report-broken-site-panel-url = Spletni naslov
report-broken-site-panel-reason-label = Kaj je narobe?
report-broken-site-panel-reason-optional-label = Kaj je narobe? (neobvezno)
report-broken-site-panel-reason-choose =
    .label = Izberite razlog
...
report-broken-site-panel-reason-other =
    .label = Nekaj drugega
report-broken-site-panel-description-label = Opišite težavo
report-broken-site-panel-description =
    .placeholder = Kaj se je zgodilo? Kaj bi se moralo zgoditi? Ali se je stanje popravilo po izklopu zaščite pred sledenjem?
report-broken-site-panel-description-optional-label = Opišite težavo (neobvezno)
report-broken-site-panel-send-more-info-link = Pošlji več informacij
