...
#                    site.
taskbar-tab-shortcut-description = Spletna aplikacija { $name }
...
taskbar-tab-title-default = { $name } v { -brand-full-name(sklon: "mestnik") }
taskbar-tab-title-container = { $name } ({ $container }) v { -brand-full-name(sklon: "mestnik") }
