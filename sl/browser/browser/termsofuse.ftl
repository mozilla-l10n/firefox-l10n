...
existing-user-tou-accept = Sprejmi
...
tou-existing-user-spotlight-body = Uvedli smo <a data-l10n-name="terms-of-use">pogoje uporabe</a>  in posodobili <a data-l10n-name="privacy-notice">obvestilo o zasebnosti</a>.<br><br> Vzemite si trenutek, da jih pregledate in sprejmete. <a data-l10n-name="learn-more">Več o tem</a>.
tou-existing-user-spotlight-remind-me-later = Opomni me pozneje
