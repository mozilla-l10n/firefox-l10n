...
windows-10-eos-global-infobar-title = <strong>Sistema Windows 10 Microsoft ne podpira več.</strong> Varnostno kopirajte svoje podatke { -brand-product-name(sklon: "rodilnik") }, da bodo pripravljeni na selitev v Windows 11.
windows-10-eos-global-infobar-primary-button = Vklopi varnostno kopiranje
    .accesskey = V
windows-10-eos-global-infobar-learn-more-link = Več o tem
    .accessKey = V
...
lapsed-user-toast-title = { -brand-product-name } vam še vedno krije hrbet
lapsed-user-toast-subtitle = Spoznajte nove načine brskanja z več izbire, zasebnosti in nadzora.
lapsed-user-toast-whats-new-button = Oglejte si, kaj je novega
lapsed-user-toast-dismiss-button = Skrij
...
refresh-unused-profile-infobar-message = Že nekaj časa niste zagnali { -brand-short-name }a. Ga želite očistiti navlake, da bo deloval kot nov? In mimogrede: dobrodošli nazaj!
