...
crashed-request-help-message = Poročila o sesutju nam pomagajo prepoznati težave in izboljšati { -brand-short-name(sklon: "tozilnik") }.
crashed-request-report-title = Poročilo o tem zavihku
crashed-send-report-2 = Pošlji avtomatizirano poročilo o sesutju, da lahko popravimo težave, kot je ta
crashed-comment =
