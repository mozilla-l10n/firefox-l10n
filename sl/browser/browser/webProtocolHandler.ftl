...
protocolhandler-mailto-handler-set = Želite uporabiti <strong>{ -brand-short-name(sklon: "tožilnik") } za odpiranje { $url }</strong> vsakič, ko kliknete povezavo do e-pošte?
