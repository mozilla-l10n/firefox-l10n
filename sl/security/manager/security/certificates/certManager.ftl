...
certmgr-delete-builtin =
    ...
    .accesskey = Z
certmgr-backup =
    .label = Varnostno kopiraj …
    .accesskey = K
certmgr-backup-all =
    .label = Varnostno kopiraj vse …
    .accesskey = v
certmgr-restore =
    .label = Uvozi …
    .accesskey = u
...
pkcs12-decode-err = Datoteke ni mogoče dekodirati. Morda ni v formatu PKCS #12, morda je poškodovana ali pa vneseno geslo ni bilo pravilno.
