...
reset-password-window =
    .title = ମୂଖ୍ୟ ପ୍ରବେଶ ସଂକେତକୁ ପୁନଃସ୍ଥାପନ କରନ୍ତୁ
    .style = width: 40em
reset-password-button-label =
    .label = ପୁନଃସ୍ଥାପନ କରନ୍ତୁ
reset-password-text = ଯଦି ଆପଣ ମୂଖ୍ୟ ପ୍ରବେଶ ସଂକେତକୁ ପୁନଃସ୍ଥାପନ କରନ୍ତି, ଆପଣଙ୍କର ସମସ୍ତ ସଞ୍ଚିତ ୱେବ ଏବଂ ଇମେଲ ପ୍ରବେଶ ସଂକେତ, ଫର୍ମ ତଥ୍ୟ, ବ୍ୟକ୍ତିଗତ ପ୍ରମାଣ ପତ୍ର, ଏବଂ ନିଜସ୍ୱ କିଗୁଡ଼ିକୁ ଭୁଲିଯିବ. ଆପଣ ନିଶ୍ଚିତ କି ଆପଣ ମୂଖ୍ୟ ପ୍ରବେଶ ସଂକେତକୁ ପୁନଃସ୍ଥାପନ କରିବାକୁ ଚାହୁଁଛନ୍ତି?
