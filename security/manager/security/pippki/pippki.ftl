...
set-password-reminder = Važno: ako zaboravite svoju sigurnosnu kopiju lozinke certifikata, kasnije nećete moći vratiti ovu sigurnosnu kopiju. Molim spremite lozinku na sigurno mjesto.
