...
certmgr-servers = आपल्याकडे फाइलवर असे प्रमाणपत्र आहेत जे हे सर्व्हर ओळखते
...
certmgr-fingerprints-label =
    .value = ठसा
certmgr-subject-label = प्रति
certmgr-issuer-label = प्रषेक
certmgr-period-of-validity = वैधता कालावधी
certmgr-fingerprints = ठसा
certmgr-cert-detail =
...
certmgr-cert-detail-sha-256-fingerprint = SHA-256 ठसा
...
certmgr-token-name =
    .label = सुरक्षा साधन
certmgr-begins-on = यावेळी सुरू
certmgr-begins-label =
    .label = यावेळी सुरू
certmgr-begins-value =
    .value = { certmgr-begins-label.label }
certmgr-expires-on = यावेळी वेळ समाप्त
...
delete-ssl-cert-title =
    .title = सर्व्हर प्रमाणपत्र अपवाद काढूण टाका
delete-ssl-cert-confirm = आपणास नक्की या सर्व्हर अपवाद काढायच्या आहेत?
delete-ssl-cert-impact = सर्व्हरअपवाद काढल्यास, सर्व्हरवरील सुरक्षा तपास पुनर्स्थापित करू शकता व वैध प्रमाणत्राचे वापर करेल याची काळजी घ्या.
...
cert-viewer-title =
    .title = प्रमाणपत्र दृश्यक: “{ $certName }”
not-present =
...
verify-ssl-server =
    .value = SSL सर्व्हर प्रमाणपत्र
verify-ssl-ca =
    .value = SSL प्रमाणपत्र प्राधिकरण
verify-email-signer =
    .value = ईमेल स्वाक्षरी प्रमाणपत्र
verify-email-recip =
    .value = ईमेल उपभोक्ता प्रमाणपत्र
# Cert verification
cert-not-verified-cert-revoked = परवानगी रद्द केल्यामुळे हे प्रमाणपत्र तपासल्या जाऊ शकले नाही.
cert-not-verified-cert-expired = वेळसमाप्तिमुळे हे प्रमाणपत्र तपासल्या जाऊ शकले नाही.
