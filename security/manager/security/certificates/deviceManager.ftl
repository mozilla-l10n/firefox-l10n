...
fips-nonempty-primary-password-required = FIPS-moduset krev at du har eit primærpassord for kvar tryggingseining. Lag eit passord før du slår på FIPS-modus.
