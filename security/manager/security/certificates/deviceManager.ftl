...
fips-nonempty-primary-password-required = FIPS-modus krever at du har et primærpassord for hver sikkerhetsenhet. Lag et passord før du slår på FIPS-modus.
