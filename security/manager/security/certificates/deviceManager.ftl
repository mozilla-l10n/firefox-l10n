...
fips-nonempty-primary-password-required = FIPS-modus krever at du har et primært passord for hver sikkerhetsenhet. Lag et passord før du slår på FIPS-modus.
