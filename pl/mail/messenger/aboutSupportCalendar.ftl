...
calendars-table-cache-enabled = Pamięć podręczna jest włączona
calendars-table-imip-identity = Tożsamość iMIP
calendars-table-imip-identity-disabled = iMIP jest wyłączone
...
calendars-table-capabilities-alarms-popup-supported = Wyskakujące przypomnienia są obsługiwane
calendars-table-capabilities-alarms-oninviations-supported = Przypomnienia o zaproszeniu są obsługiwane
calendars-table-capabilities-alarms-maxcount = Maksymalna liczba przypomnień na wydarzenie
calendars-table-capabilities-attachments-supported = Załącznik jest obsługiwany
calendars-table-capabilities-categories-maxcount = Maksymalna liczba kategorii
calendars-table-capabilities-privacy-supported = Stan prywatności jest obsługiwany
calendars-table-capabilities-priority-supported = Priorytet jest obsługiwany
calendars-table-capabilities-events-supported = Wydarzenie jest obsługiwane
