...
profile-window-title = { -brand-short-name } — wybierz profil użytkownika
...
profile-window-checkbox-label =
    .label = Pokazuj po włączeniu { -brand-short-name(case: "gen") }
...
edit-profile-page-theme-header = Motyw
