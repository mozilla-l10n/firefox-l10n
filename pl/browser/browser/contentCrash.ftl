...
pending-crash-reports-message-new =
    { $reportCount ->
        [one] Nieprzesłane zgłoszenie niedawnej awarii
        [few] { $reportCount } nieprzesłane zgłoszenia niedawnych awarii
       *[many] { $reportCount } nieprzesłanych zgłoszeń niedawnych awarii
    }
