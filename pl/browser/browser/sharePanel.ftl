...
share-panel-heading = Udostępnij stronę
...
confirmation-hint-link-copied = Skopiowano odnośnik
...
share-panel-os-share-2 =
    .label =
        { PLATFORM() ->
            [windows] Udostępnij w systemie Windows…
            [macos] Udostępnij w systemie macOS…
           *[other] Udostępnij za pomocą…
        }
share-panel-os-share =
    .label = Udostępnij za pomocą…
share-panel-mail =
    .label = Wyślij e-mail
