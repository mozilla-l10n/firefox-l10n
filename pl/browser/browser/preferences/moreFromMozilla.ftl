...
more-from-moz-title2 = Więcej od { -vendor-short-name(case: "gen") }
    .title = Więcej od { -vendor-short-name(case: "gen") }
...
more-from-moz-solo-description = Błyskawicznie utwórz swoją witrynę internetową i bezpłatnie podłącz własną domenę.
more-from-moz-solo-button = Wypróbuj { -solo-ai-brand-name }
more-from-moz-solo-title-2 = Kreator SI stron internetowych { -solo-ai-brand-name }
...
more-from-moz-solo-card-1 =
    .description = Błyskawicznie utwórz swoją witrynę internetową i bezpłatnie podłącz własną domenę.
    .label = { -solo-ai-brand-name }
more-from-moz-new-products-card2 =
    .description = Poznaj nasze najnowsze pomysły oraz eksperymentalne technologie.
