...
tls-key-logging-notice-nav =
    .label = Aplikacja lub usługa może podejrzeć zaszyfrowany ruch.
category-list =
...
home-prefs-content-description2 = Wybierz, co wyświetlać na { -firefox-home-brand-name(capitalization: "lower", case: "loc") }.
...
containers-sites-card-header =
    .description = Wybierz kontener dla witryny, a { -brand-short-name } będzie go używać przy każdym jej otwarciu.
    .label = Kontenery dla konkretnych witryn
...
containers-site-container-select = Kontener dla witryny { $site }
...
autofill-personal-info-checkbox-message =
    .label = Zachowuj i automatycznie wypełniaj dane osobowe
autofill-personal-info-manage-button =
    .label = Zarządzaj danymi osobowymi
...
passports-edit-passport-button-label =
    .aria-label = Edytuj
passports-delete-passport-prompt-title = Czy usunąć ten paszport?
passports-delete-passport-prompt-confirm-button = Usuń
passports-delete-passport-prompt-cancel-button = Anuluj
autofill-passports-add-button = Dodaj nowy paszport
autofill-personal-info-manage-title =
    .heading = Zarządzaj danymi osobowymi
# This message is displayed when no passports are stored in Firefox
passports-no-passports-stored-message =
    .label = Nie dodano żadnych paszportów
...
history-clear-on-close-option =
    .label = Czyść historię po zamknięciu { -brand-short-name(case: "gen") }
    .accesskey = z
...
sitedata-allow-cookies-option =
    .label = Akceptuj ciasteczka i dane witryn
    .accesskey = A
sitedata-disallow-cookies-option =
    .label = Blokuj ciasteczka i dane witryn
    .accesskey = B
...
sitedata-option-block-all =
    .label = Wszystkie ciasteczka (spowoduje niepoprawne działanie stron)
sitedata-clear2 =
...
addressbar-header-firefox-suggest = Pasek adresu — { -firefox-suggest-brand-name(capitalization: "lower", case: "nom") }
...
preferences-doh-radio-group =
    .aria-label = Włącz serwer DNS poprzez HTTPS:
...
related-settings-home-link =
    .label = Dostosuj { -firefox-home-brand-name(capitalization: "lower", case: "acc") }
...
preferences-ai-controls-speech-recognition-control =
    .description = Zamienia głos na tekst na urządzeniu.
    .label = Rozpoznawanie mowy
preferences-ai-controls-sidebar-chatbot-group-3 =
    .description = Wyświetla czatbota na wierzchu podczas przeglądania. Wybierz spośród wielu dostawców i zmień go, kiedy chcesz.
    .label = Czatboty SI w panelu bocznym
preferences-ai-controls-sidebar-chatbot-group-2 =
    .description = Wyświetla czatbota na wierzchu podczas przeglądania. Wybierz spośród Anthropic Claude, ChatGPT, Copilot, Google Gemini i Mistral Vibe.
    .label = Czatboty SI w panelu bocznym
...
preferences-ai-controls-block-confirmation-sidebar-chatbot = Czatboty w panelu bocznym
preferences-ai-controls-block-confirmation-speech-recognition = Rozpoznawanie mowy
...
preferences-etp-tracker-count-enabled =
    .label = Liczba zablokowanych elementów śledzących na pasku adresu
...
preferences-etp-custom-cookie-behavior-block-cross-site-tracking-cookies =
    .label = Blokuj ciasteczka śledzące między witrynami
...
referrals-section-header =
    ...
    .label = Podziel się { -brand-short-name(case: "ins") }
