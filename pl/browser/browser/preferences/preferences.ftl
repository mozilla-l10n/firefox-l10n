...
pane-ai-controls-title = Sterowanie SI
...
applications-setting =
    .label = Aplikacje
    .description = Wybierz, jak { -brand-short-name } będzie obsługiwać pobierane z sieci pliki i aplikacje używane podczas przeglądania.
...
data-collection-run-studies =
    ...
    .description = { -brand-short-name } losowo wybiera użytkowników do testowania funkcji, co pomaga zwiększyć jakość dla wszystkich.
...
preferences-etp-status-protections-dashboard-link =
    .label = Wyświetl spersonalizowany panel ochrony
