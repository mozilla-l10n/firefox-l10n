...
preonboarding-primary-cta-v2 = Kontynuuj
...
preonboarding-manage-and-read-header-v2 = Przeczytaj warunki korzystania i zasady ochrony prywatności. Zarządzaj dodatkowymi ustawieniami.
...
preonboarding-terms-of-use-header-button-title-b-v2 = Warunki korzystania
...
preonboarding-privacy-notice-header-button-title-b-v2 = Zasady ochrony prywatności
...
preonboarding-checklist-interaction-data-description = Informacje o Twoim urządzeniu, konfiguracji sprzętowej i sposobie korzystania z { -brand-product-name(case: "gen") } pomagają ulepszać jego funkcje oraz zwiększać wydajność i stabilność dla wszystkich użytkowników.
