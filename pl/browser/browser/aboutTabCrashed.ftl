...
crashed-header = Karta uległa awarii
...
crashed-request-help-message = Zgłoszenia awarii pomagają nam diagnozować problemy i ulepszać { -brand-short-name(case: "acc") }.
crashed-request-report-title = Zgłaszanie problematycznej karty
crashed-send-report-2 = Wyślij automatyczne zgłoszenie awarii, abyśmy mogli naprawiać problemy takie jak ten
crashed-comment =
