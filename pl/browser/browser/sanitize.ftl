...
item-site-prefs =
    ...
    .accesskey = U
item-formdata-prefs =
    .label = Zachowane dane formularzy
    .accesskey = Z
item-formdata-description = Usuwa nazwiska, adresy e-mail i inne dane wprowadzone w formularzach
...
sanitize-calculating-size = Obliczanie…
