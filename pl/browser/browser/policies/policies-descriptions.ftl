...
policy-ClearOnShutdown = Czyszczenie danych przeglądania po zamknięciu { -brand-short-name(case: "gen") }.
...
policy-DisableRemoteImprovements = Uniemożliwienie { -brand-short-name(case: "dat") } stosowania zmian wydajności, stabilności i funkcji pomiędzy aktualizacjami.
...
policy-FirefoxHome2 = Konfiguracja { -firefox-home-brand-name(capitalization: "lower", case: "gen") }.
policy-FirefoxSuggest = Konfiguracja { -firefox-suggest-brand-name(capitalization: "lower", case: "gen") }.
...
policy-ShowHomeButton = Wyświetlanie przycisku strony startowej na pasku narzędzi.
