...
helpus-referrals2 = Chcesz pomóc? <label data-l10n-name="helpus-donateLink">Przekaż datek</label>, <label data-l10n-name="helpus-shareFirefoxLink">podziel się { -brand-product-name(case: "ins") }</label> lub <label data-l10n-name="helpus-getInvolvedLink">dołącz do nas</label>.
helpus-referrals = Chcesz pomóc? <label data-l10n-name="helpus-donateLink">Przekaż datek</label>, <label data-l10n-name="helpus-shareFirefoxLink">podziel się { -brand-short-name(case: "ins") }</label> lub <label data-l10n-name="helpus-getInvolvedLink">dołącz do nas</label>.
