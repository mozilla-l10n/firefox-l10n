...
safeb-blocked-addon-page-learn-more3 = <a data-l10n-name='firefox_support'>Więcej informacji o ochronie { -brand-short-name(case: "gen") } przed szkodliwymi dodatkami</a>.
