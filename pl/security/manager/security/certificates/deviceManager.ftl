...
devmgr-devlist =
    .label = Urządzenia i moduły zabezpieczeń
...
load-device-info = Wprowadź informacje o module, który ma zostać dodany.
load-device-modname =
    .value = Nazwa modułu:
    .accesskey = m
...
unable-to-toggle-fips = Nie udało się zmienić trybu FIPS dla urządzenia zabezpieczającego. Zaleca się zakończenie pracy i ponowne uruchomienie tego programu.
...
del-module-warning = Czy na pewno usunąć wybrany moduł zabezpieczeń?
