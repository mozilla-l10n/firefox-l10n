...
pkcs12-unknown-err-restore = Nie udało się przywrócić pliku PKCS #12 z nieznanych powodów.
pkcs12-unknown-err-backup = Nie udało się utworzyć pliku kopii zapasowej PKCS #12 z nieznanych powodów.
...
add-exception-domain-mismatch-long = Certyfikat należy do innej witryny, co może wskazywać na podszywanie się pod tę witrynę.
add-exception-expired-short = Informacje nieaktualne
add-exception-expired-long = Certyfikat nie jest obecnie aktualny. Mógł zostać zagubiony lub skradziony i może być wykorzystywany do podszywania się pod tę witrynę.
