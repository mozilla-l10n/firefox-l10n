...
newsletter-privacy-label=Pozwalam Mozilli wykorzystywać te informacje w sposób opisany w <a data-l10n-name="privacy-policy">polityce prywatności</a>.
...
newsletter-error-common=Żądanie subskrypcji nie powiodło się ({ $errorDescription }).
