...
serviceworker-worker-updated = Uaktualniono <time>{ DATETIME($date, day: "numeric", hour: "numeric", minute: "numeric", month: "numeric", second: "numeric", year: "numeric") }</time>
...
session-history-navigate-button-title = Przejdź do { $index }. wpisu historii sesji
