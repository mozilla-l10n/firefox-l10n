...
experimental-features-group-customize-browsing-description = Jeśli wypróbujesz te funkcje, <a data-l10n-name="connect">podziel się swoją opinią w serwisie Connect</a>
