...
webext-perms-description-trialML = Pobieranie i uruchamianie modeli sztucznej inteligencji na urządzeniu użytkownika
webext-perms-description-userScripts = Zezwalanie niezweryfikowanym skryptom zewnętrznym na dostęp do danych użytkownika
...
webext-perms-description-data-long-personallyIdentifyingInfo = Udostępnianie informacji identyfikujących osobę autorom rozszerzenia
webext-perms-description-data-long-searchTerms = Udostępnianie wyszukiwanych słów autorom rozszerzenia
webext-perms-description-data-long-technicalAndInteraction = Udostępnianie danych technicznych i o interakcjach autorom rozszerzenia
webext-perms-description-data-long-websiteActivity = Udostępnianie działań użytkownika na witrynach autorom rozszerzenia
webext-perms-description-data-long-websiteContent = Udostępnianie treści witryn autorom rozszerzenia
