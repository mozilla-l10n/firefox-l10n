...
time-spinner-minute-previous =
    .aria-label = Poprzednia minuta
time-spinner-minute-next =
    .aria-label = Następna minuta
time-spinner-second-previous =
    .aria-label = Poprzednia sekunda
time-spinner-second-next =
    .aria-label = Następna sekunda
time-spinner-millisecond-previous =
    .aria-label = Poprzednia milisekunda
time-spinner-millisecond-next =
    .aria-label = Następna milisekunda
time-spinner-day-period-previous =
    .aria-label = Poprzednia pora dnia
time-spinner-day-period-next =
    .aria-label = Następna pora dnia
