...
mozilla-pkix-error-invalid-integer-encoding = Serwer przedstawił certyfikat zawierający nieprawidłowe kodowanie liczb. Typowe przyczyny to ujemne numery seryjne, ujemne moduły RSA i niepotrzebne już kodowania.
