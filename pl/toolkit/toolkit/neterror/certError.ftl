...
cert-error-invalid-integer-encoding = { -brand-short-name } zablokował otwarcie tej witryny, ponieważ certyfikat dostarczony dla adresu { $hostname } zawiera nieprawidłowe kodowanie liczb. Typowe przyczyny to ujemne numery seryjne, ujemne moduły RSA i niepotrzebne już kodowania.
...
netReset-title = Zresetowane połączenie
