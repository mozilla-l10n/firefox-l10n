...
inactive-css-not-grid-or-flex-or-block-container-fix-1 = Покушајте да додате <strong>display:grid</strong>, <strong>display:flex</strong> или <strong>display:block</strong>.
...
inactive-css-not-multicol-container-fix-1 = Покушајте да додате или <strong>column-count</strong> или <strong>column-width</strong>.
inactive-css-column-span-fix-1 = Покушајте да додате <strong>column-count</strong> или <strong>column-width</strong> неком од његових надређених елемената.
inactive-css-not-grid-or-flex-or-absolutely-positioned-item-fix-1 = Покушајте да додате <strong>position:absolute</strong> елементу, или <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong> или <strong>display:inline-flex</strong> родитељу елемента.
inactive-css-not-grid-or-absolutely-positioned-item-fix-1 = Покушајте да додате <strong>position:absolute</strong> елементу, или <strong>display:grid</strong> или <strong>display:inline-grid</strong> родитељу елемента.
inactive-css-not-absolutely-positioned-item-fix-1 = Покушајте да додате <strong>position:absolute</strong> елементу.
inactive-css-no-default-anchor-fix-1 = Покушајте да додате <strong>position-anchor</strong> са важећим називом сидра.
...
inactive-css-only-non-grid-or-flex-item-fix-1 = Покушајте да промените вредност <strong>display</strong> садржаоца елемента на нешто друго осим <strong>flex</strong>, <strong>grid</strong>, <strong>inline-flex</strong> или <strong>inline-grid</strong>, или уклоните <strong>float</strong>.
inactive-css-not-block-fix-1 = Покушајте да додате својства као што су <strong>display:block</strong> или <strong>float:left</strong>.
inactive-css-not-block-container-fix-1 = Покушајте да додате <strong>display:block</strong>, <strong>display:inline-block</strong> или <strong>display:flow-root</strong>.
inactive-css-not-block-flex-grid-container-fix-1 = Покушајте са додавањем <strong>display:block</strong>, <strong>display:inline-block</strong>, <strong>display:flex</strong>, <strong>display:inline-flex</strong>, <strong>display:grid</strong>, <strong>display:inline-grid</strong> или <strong>display:flow-root</strong>.
inactive-css-not-floated-fix-1 = Покушајте да додате својство <strong>float</strong> са вредношћу која није <strong>none</strong>.
...
inactive-css-only-replaced-elements-fix-1 = Осигурајте да додајете својство замењеном елементу.
inactive-text-overflow-when-no-overflow-fix-1 = Try adding <strong>overflow:hidden</strong>.
inactive-css-no-size-containment-fix-1 = Покушајте да поставите својство <strong>display</strong> на нешто друго осим <strong>none</strong>, <strong>contents</strong>, <strong>table</strong> или <strong>inline-table</strong> и уверите се да није унутар табеле или ruby сегмента.
...
inactive-css-collapsed-table-borders-fix-1 = Покушајте са додавањем <strong>border-collapse:separate</strong>.
inactive-css-not-table-cell-fix-1 = Покушајте са додавањем <strong>display:table-cell</strong>.
...
inactive-css-resize-fix-1 = Покушајте да поставите <strong>overflow</strong> на вредност која није <strong>visible</strong> или циљајте замењени елемент који га подржава.
inactive-css-ruby-element-fix-1 = Try changing the <strong>font-size</strong> of the ruby text.
inactive-css-text-wrap-balance-lines-exceeded-fix-1 = Покушајте да смањите број редова.
inactive-css-text-wrap-balance-fragmented-fix-1 = Избегавајте дељење садржаја елемента, нпр. уклањањем колона или коришћењем <strong>page-break-inside:avoid</strong>.
inactive-css-no-principal-box-fix-1 = Покушајте да додате вредност <strong>display</strong> која прави главни оквир, као што је <strong>block</strong>, <strong>inline-block</strong>, <strong>flex</strong> или <strong>grid</strong>.
...
css-selector-container-query-condition-no-container = Није пронађен контејнер „{ $name }“
