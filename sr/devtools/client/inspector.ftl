...
inspector-color-scheme-emulation-dark =
    .title = Прекидач за опонашање тамне шеме боја за страницу
...
inspector-emulation-panel-print = Омогући
    .aria-label = Омогући опонашање медија за штампу
# A label text for the light color scheme emulation radio button option.
inspector-emulation-panel-color-scheme-light = Светло
    .aria-label = Омогући опонашање светле шеме боја
# A label text for the dark color scheme emulation radio button option.
inspector-emulation-panel-color-scheme-dark = Тамно
    .aria-label = Омогући опонашање тамне шеме боја
# A label text for the no color scheme emulation radio button option (uses user's preference).
inspector-emulation-panel-color-scheme-none = Без опонашања
    .aria-label = Онемогући опонашање шеме боја
# A label text for the reduced motion emulation radio button option.
inspector-emulation-panel-reduced-motion-reduce = Умањи
    .aria-label = Омогући опонашање смањеног покрета
# A label text for the no preference for reduced motion emulation radio button option.
inspector-emulation-panel-reduced-motion-no-preference = Без поставки
    .aria-label = Омогући опонашање смањеног покрета без посебних поставки
# A label text for the no reduced motion emulation radio button option (uses user's preference).
inspector-emulation-panel-reduced-motion-none = Без опонашања
    .aria-label = Онемогући опонашање смањеног покрета
