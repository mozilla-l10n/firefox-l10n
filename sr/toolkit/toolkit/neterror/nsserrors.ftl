...
sec-error-pkcs11-device-error = PKCS #11 модул је вратио CKR_DEVICE_ERROR, што значи да је дошло до проблема са жетоном или слотом.
...
mozilla-pkix-error-issuer-no-longer-trusted = Сертификационо тело које је издало овај сертификат није било поуздано пре издавања сертификата.
