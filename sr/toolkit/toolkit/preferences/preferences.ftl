...
primary-password-required-by-policy = Ваша организација захтева да имате постављену главну лозинку да бисте могли сачувати пријаве и лозинке.
...
remove-primary-password-info =
    .value = Морате унети своју тренутну лозинку да бисте наставили.
remove-info =
