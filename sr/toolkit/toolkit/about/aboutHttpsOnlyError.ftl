...
about-httpsonly-explanation-risk = Могуће је и да је то дело нападача. Ако одлучите да посетите ову веб страницу, не уносите никакве осетљиве податке као што су лозинке, е-адресе или податке о кредитној картици.
about-httpsonly-explanation-continue = Ако наставите, режим „Само HTTPS” ће бити привремено искључен за овај сајт.
about-httpsonly-explanation-iframe = Због блокирања мешовитог садржаја, није могуће ручно дозволити учитавање овог оквира.
