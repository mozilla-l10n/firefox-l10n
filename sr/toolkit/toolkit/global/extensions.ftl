...
webext-perms-host-description-file-urls = Приступите локалним датотекама на рачунару
# Variables:
...
webext-site-perms-description-gated-perms-webserial =
    То су уређаји попут микроконтролера, 3Д штампача и других уређаја који се повезују путем УСБ-а, серијских портова или Блутута.
    
    Моћи ћете да изаберете којим уређајима веб страница може приступити.
    
    Веб страницама обично није дозвољен приступ серијским уређајима. Неправилна употреба може проузроковати оштећење или угрозити безбедност.
