...
sandbox-missing-unprivileged-namespaces = Неки од { -brand-short-name } безбедносних функција могу да понуде слабију заштиту на вашем тренутном оперативном систему.
