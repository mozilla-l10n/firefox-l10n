...
sec-error-pkcs12-invalid-mac = Увоз није успео. Неважећа MAC адреса. Лозинка је погрешна или је датотека оштећена.
...
sec-error-pkcs12-unsupported-version = Увоз није успео. Верзија датотеке није подржана.
