...
pending-crash-reports-message-new =
    { $reportCount ->
        [one] Имате недавно непослати извештај о паду
        [few] Имате { $reportCount } недавно непослата извештаја о паду
       *[other] Имате { $reportCount } недавно непослатих извештаја о паду
    }
