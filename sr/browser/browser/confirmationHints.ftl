...
confirmation-hint-passport-created = Пасош сачуван
confirmation-hint-passport-updated = Пасош ажуриран
confirmation-hint-pin-tab = Закачен!
confirmation-hint-pin-tab-description = Откачите језичак десним кликом на њега.
...
confirmation-hint-duplicate-tabs-closed =
    { $tabCount ->
        [one] Затворен { $tabCount } језичак
        [few] Затворена { $tabCount } језичка
       *[other] Затворено { $tabCount } језичака
    }
