...
options-use-sync = Уколико желите да све инсталације Firefox-а користе исте податке из профила, користите { -fxaccount-brand-name } да бисте их синхронизовали.
resources = Ресурси:
