...
contextual-manager-passwords-remove-all-message-sync =
    { $total ->
        [1] Ово ће уклонити лозинку сачувану у { -brand-short-name(case: "loc") } на свим вашим усклађеним уређајима и сва упозорења о цурењу података. Не можете поништити ову радњу.
        [one] Ово ће уклонити лозинку сачувану у { -brand-short-name(case: "loc") } на свим вашим усклађеним уређајима и сва упозорења о цурењу података. Не можете поништити ову радњу.
        [few] Ово ће уклонити лозинке сачуване у { -brand-short-name(case: "loc") } на свим вашим усклађеним уређајима и сва упозорења о цурењу података. Не можете поништити ову радњу.
       *[other] Ово ће уклонити лозинки сачуваних у { -brand-short-name(case: "loc") } на свим вашим усклађеним уређајима и сва упозорења о цурењу података. Не можете поништити ову радњу.
    }
...
contextual-manager-passwords-origin-field =
    .label = Адреса веб-сајта
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Унесите тачну адресу са које ћете се пријавити на овај сајт.
contextual-manager-passwords-username-field =
    .label = Корисничко име
contextual-manager-passwords-username-field-description = Унесите корисничко име, адресу е-поште или број налога који користите за пријаву.
contextual-manager-passwords-password-field =
    .label = Лозинка
contextual-manager-passwords-password-field-description = Унесите лозинку да бисте се пријавили на овај налог.
...
# This string encourages the user to save their passwords in Firefox (the "safe spot").
contextual-manager-passwords-no-passwords-header-2 = Чувајте своје лозинке на безбедном месту
...
contextual-manager-primary-password-reauth-header = Да бисте видели своје сачуване лозинке, унесите своју главну лозинку.
# This string informs the user their primary password is used to authenticate and access their passwords
contextual-manager-primary-password-reauth-button = Унесите главну лозинку
contextual-manager-primary-password-learn-more-link = Сазнајте више
