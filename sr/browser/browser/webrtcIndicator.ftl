...
webrtc-sharing-menu =
    .label = Уређаји са приступом језичцима
    .accesskey = ј
...
webrtc-indicator-menuitem-sharing-camera-with-n-tabs =
    .label =
        { $tabCount ->
            [one] { $tabCount } језичак има приступ камери
            [few] { $tabCount } језичка имају приступ камери
           *[other] { $tabCount } језичака има приступ камери
        }
...
webrtc-indicator-menuitem-sharing-microphone-with-n-tabs =
    .label =
        { $tabCount ->
            [one] { $tabCount } језичак има приступ микрофону
            [few] { $tabCount } језичка имају приступ микрофону
           *[other] { $tabCount } језичака има приступ микрофону
        }
...
webrtc-indicator-menuitem-sharing-application-with-n-tabs =
    .label =
        { $tabCount ->
            [one] { $tabCount } језичак има приступ апликацији
            [few] { $tabCount } језичка имају приступ апликацијама
           *[other] { $tabCount } језичака има приступ апликацијама
        }
...
webrtc-indicator-menuitem-sharing-screen-with-n-tabs =
    .label =
        { $tabCount ->
            [one] { $tabCount } језичак има приступ садржају екрана
            [few] { $tabCount } језичка имају приступ садржају екрана
           *[other] { $tabCount } језичака има приступ садржају екрана
        }
...
webrtc-indicator-menuitem-sharing-window-with-n-tabs =
    .label =
        { $tabCount ->
            [one] { $tabCount } језичак има приступ прозору
            [few] { $tabCount } језичка имају приступ прозору
           *[other] { $tabCount } језичака има приступ прозору
        }
webrtc-indicator-menuitem-sharing-browser-with =
    .label = „{ $streamTitle }” има приступ језичку
# This message is shown when the contents of a tab is shared during a WebRTC
# session, which currently is only possible with Loop/Hello.
webrtc-indicator-menuitem-sharing-browser-with-n-tabs =
    .label =
        { $tabCount ->
            [one] { $tabCount } језичак има приступ језичку
            [few] { $tabCount } језичка имају приступ језичцима
           *[other] { $tabCount } језичака има приступ језичцима
        }

## Variables:
##   $origin (String): the website origin (e.g. www.mozilla.org).

webrtc-allow-share-audio-capture = Дозволити { $origin } да слуша звук овог језичка?
...
webrtc-allow-share-camera-and-audio-capture = Дозволити { $origin } да користи вашу камеру и слуша звук овог језичка?
webrtc-allow-share-screen-and-microphone = Дозволити да { $origin } приступа микрофону и садржају екрана?
webrtc-allow-share-screen-and-audio-capture = Дозволити да { $origin } приступа звуку овог језичка и садржају екрана?

## Special phrasing for sharing devices when the origin is a file url.

webrtc-allow-share-audio-capture-with-file = Дозволити овој локалној датотеци да слуша звук овог језичка?
...
webrtc-allow-share-camera-and-audio-capture-with-file = Дозволити овој локалној датотеци да користи вашу камеру и слуша звук овог језичка?
webrtc-allow-share-screen-and-microphone-with-file = Дозволити овој локалној датотеци да користи микрофон и види ваш екран?
webrtc-allow-share-screen-and-audio-capture-with-file = Дозволити овој локалној датотеци да слуша звук овог језичка и види ваш екран?
...
webrtc-allow-share-camera-and-audio-capture-unsafe-delegation = Дозволити { $origin } да одобри { $thirdParty } приступ камери и звуку овог језичка?
...
webrtc-allow-share-screen-and-audio-capture-unsafe-delegation = Дозволити { $origin } да одобри { $thirdParty } приступ звуку овог језичка и садржају екрана?
...
webrtc-reason-for-no-permanent-allow-audio = { -brand-short-name } мора да зна ком језичку желите да дозволите трајни приступ звуку језичка.
