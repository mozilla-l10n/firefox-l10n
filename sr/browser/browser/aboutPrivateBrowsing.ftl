...
about-private-browsing-info-searches = претраге
about-private-browsing-info-downloads = преузимања
private-browsing-title = Приватно прегледање
about-private-browsing-info-saved = { -brand-short-name } <strong>ће сачувати</strong>:
about-private-browsing-info-myths = Чести митови о приватном прегледању
about-private-browsing-info-clipboard = текст копиран
about-private-browsing-info-temporary-files = привремене датотеке
about-private-browsing-info-cookies = колачиће
tracking-protection-start-tour = Сазнајте како ради
about-private-browsing-note = Приватно прегледање <strong>вас не чини анонимним</strong> на интернету. Ваш послодавац или интернет провајдер и даље могу да виде које странице посећујете.
about-private-browsing =
    .title = Претражи веб
about-private-browsing-not-private = Тренутно нисте у прозору за приватно прегледање.
