...
about-logins-confirm-remove-all-sync-dialog-message =
    { $count ->
        [1] Ово ће уклонити пријаву коју сте сачували у { -brand-short-name }-у на свим уређајима синхронизованим с вашим { -fxaccount-brand-name }. Такође ће уклонити упозорења о цурењу података која се појављују овде. Ову радњу није могуће поништити.
        [one] Ово ће уклонити пријаву коју сте сачували у { -brand-short-name }-у на свим уређајима синхронизованим с вашим { -fxaccount-brand-name }. Такође ће уклонити упозорења о цурењу података која се појављују овде. Ову радњу није могуће поништити.
        [few] Ово ће уклонити пријаве које сте сачували у { -brand-short-name }-у на свим уређајима синхронизованим с вашим { -fxaccount-brand-name }. Такође ће уклонити упозорења о цурењу података која се појављују овде. Ову радњу није могуће поништити.
       *[other] Ово ће уклонити пријава које сте сачували у { -brand-short-name }-у на свим уређајима синхронизованим с вашим { -fxaccount-brand-name }. Такође ће уклонити упозорења о цурењу података која се појављују овде. Ову радњу није могуће поништити.
    }
