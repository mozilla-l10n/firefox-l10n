...
firefoxview-tabpickup-sync-disconnected-primarybutton = Укључите усклађивање у подешавањима
...
firefoxview-opentabs-nav = Отворени језичци
    .title = Отворени језичци
firefoxview-opentabs-header = Отворени језичци

## Recently closed tabs in this context refers to recently closed tabs from all windows

firefoxview-recently-closed-nav = Недавно затворени језичци
    .title = Недавно затворени језичци
firefoxview-recently-closed-header = Недавно затворени језичци

## Tabs from other devices refers in this context refers to synced tabs from other devices

firefoxview-synced-tabs-nav = Језичци са других уређаја
    .title = Језичци са других уређаја
firefoxview-synced-tabs-header = Језичци са других уређаја
...
firefoxview-search-text-box-bookmarks =
    .placeholder = Претражи обележиваче
# Placeholder for the input field to search in recently closed tabs ("search" is a verb).
firefoxview-search-text-box-recentlyclosed =
    .placeholder = Претражи недавно затворене језичке
# Placeholder for the input field to search in tabs from other devices ("search" is a verb).
firefoxview-search-text-box-tabs =
    .placeholder = Претражи језичке
# Placeholder for the input field to search in open tabs ("search" is a verb).
firefoxview-search-text-box-opentabs =
    .placeholder = Претражи отворене језичке
...
firefoxview-sort-history-by-date-label = Поређај по датуму
firefoxview-sort-history-by-site-label = Поређај према страници
firefoxview-sort-open-tabs-by-recency-label = Поређај према недавној активности
firefoxview-sort-open-tabs-by-order-label = Поређај према редоследу језичака
...
firefoxview-recentlyclosed-empty-header = Прерано сте затворили језичак?
firefoxview-recentlyclosed-empty-description = Овде ћете пронаћи недавно затворене језичке, тако да их можете брзо поново отворити.
firefoxview-recentlyclosed-empty-description-two = Да пронађете старије језичке, погледајте вашу <a data-l10n-name="history-url">историју прегледања</a>.

## This message is displayed below the name of another connected device when it doesn't have any open tabs.

firefoxview-syncedtabs-device-notabs = Нема отворених језичака на овом уређају
