...
callout-firefox-view-tab-pickup-title = Жонглирајте између уређаја без губитка картица
callout-firefox-view-tab-pickup-subtitle = Картице отворене на мобилном могу се овде прегледати и слободно се пребацивати.
callout-firefox-view-recently-closed-title = Брзо вратите затворене картице
callout-firefox-view-recently-closed-subtitle = Ваше затворене картице ће се магично појавити овде. Више не морате да бринете да ћете грешком затворити картице.
...
sidebar-callout-survey-features-question = Следе могуће функције бочног панела. Које би вам највише поспешиле продуктивност у { -brand-short-name }-у?
sidebar-callout-survey-split-view = Истовремено гледајте два различита сајта један поред другог
sidebar-callout-survey-keep-website-open = Држите сајт, као што су инбокс или календар, отвореним у бочном панелу док прегледате
...
sidebar-genai-survey-satisfaction-question = Колико сте задовољни тиме што имате приступ AI чет-боту у бочном панелу?
sidebar-genai-survey-productive-question = До које мере се слажете или не слажете са овом изјавом:<br/>“AI чет-бот у бочном панелу ми помаже да будем продиктивнији/а”?
