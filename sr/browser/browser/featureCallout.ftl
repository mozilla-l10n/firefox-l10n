...
sidebar-callout-survey-keep-website-open = Држите сајт, као што су инбокс или календар, отвореним на бочној траци док прегледате
...
sidebar-genai-survey-satisfaction-question = Колико сте задовољни тиме што имате приступ AI чет-боту у у бочној траци?
sidebar-genai-survey-productive-question = До које мере се слажете или не слажете са овом изјавом:<br/>“AI чет-бот у бочној траци ми помаже да будем продиктивнији/а”?
