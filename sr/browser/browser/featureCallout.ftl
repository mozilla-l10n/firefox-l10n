...
sidebar-genai-survey-satisfaction-question = Колико сте задовољни тиме што имате приступ AI помоћнику у бочној траци?
sidebar-genai-survey-productive-question = До које мере се слажете или не слажете са овом изјавом:<br/>“AI помоћник у бочној траци ми помаже да будем продиктивнији/а”?
