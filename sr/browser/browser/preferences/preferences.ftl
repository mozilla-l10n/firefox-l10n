...
tls-key-logging-notice-nav =
    .label = Програм или услуга могу видети ваш шифровани саобраћај.
category-list =
...
containers-external-links-check =
    .label = Не употребљавај контејнере за везе отворене из спољних програма
    .accesskey = ј
...
containers-sites-card-header =
    .description = Изаберите контејнер за страницу и { -brand-short-name } ће га користити сваки пут када се страница отвори.
    .label = Наменски контејнери за страницу
containers-sites-add-button =
    .label = Додај веб страницу
    .accesskey = Д
# The dropdown that picks which container a site opens in.
# Variables:
#   $site (string) - Domain of the website, for example “example.com”.
containers-site-container-select = Контејнер за { $site }
...
preferences-ai-controls-speech-recognition-control =
    .description = Транскрибуј говор локално.
    .label = Препознавање говора на мрежи
preferences-ai-controls-sidebar-chatbot-group-3 =
    .description = Задржите чет-бота видљивим док разгледате. Изаберите једног од више пружаоца и пребаците се у било ком тренутку.
    .label = Пружаоци чет-бота са ВИ у бочној површи
...
preferences-ai-controls-block-confirmation-speech-recognition = Препознавање говора на мрежи
...
preferences-etp-custom-cookie-behavior-block-cross-site-tracking-cookies =
    .label = Вишестранични колачићи-пратиоци
preferences-etp-custom-cookie-behavior-block-cross-site-cookies =
    .label = Блокирај више-страничне колачиће
preferences-etp-custom-cookie-behavior-isolate-cross-site-cookies =
    .label = Изолуј више-страничне колачиће
