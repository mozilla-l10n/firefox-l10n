...
accessibility-text-label-issue-figure = 带有可选说明文字的图应附有文本标签。<a>详细了解</a>
...
accessibility-text-label-issue-form-visible = 表单元素应该有一个可见的文本标签。<a>详细了解</a>
accessibility-text-label-issue-frame = <code>frame</code>（框架）元素必须附有文本标签。<a>详细了解</a>
