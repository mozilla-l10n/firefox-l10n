...
webext-perms-description-notifications = 向您显示通知
...
webext-perms-description-data-short-personallyIdentifyingInfo = 识别个人身份的信息
...
webext-perms-description-data-long-personallyIdentifyingInfo = 与扩展开发者分享识别个人身份的信息
