...
plugins-openh264-description = 此插件由 Mozilla 自动安装，以遵从 WebRTC 技术标准，满足设备进行 WebRTC 通话所需要的 H.264 视频编解码器。访问 https://www.openh264.org/ 可查看编解码器的源代码和详细了解其实现。
...
list-empty-get-extensions-promo =
    .heading = 小小扩展，大有妙用
    .message = 我们为您提供了一些建议可帮助您更专注、更隐私、更安全。
