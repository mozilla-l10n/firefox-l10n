...
contextual-manager-passwords-origin-field-description = 输入此网站的准确登录地址。
contextual-manager-passwords-username-field =
    .label = 用户名
contextual-manager-passwords-username-field-description = 输入用于登录的用户名、邮箱地址或账号。
contextual-manager-passwords-password-field =
    .label = 密码
contextual-manager-passwords-password-field-description = 输入密码以登录此账户。
