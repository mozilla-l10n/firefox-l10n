...
existing-user-privacy-notice-update-message = 我们更新了<a data-l10n-name="privacy-notice-link">隐私声明</a>，使之符合 { -brand-short-name } 功能的最新实际情况。
...
tou-existing-user-spotlight-body = 我们制定了<a data-l10n-name="terms-of-use">使用条款</a>，并更新了<a data-l10n-name="privacy-notice">隐私声明</a>。<br><br>请花些时间来阅读并接受。<a data-l10n-name="learn-more">详细了解</a>。
tou-existing-user-spotlight-remind-me-later = 稍后提醒
