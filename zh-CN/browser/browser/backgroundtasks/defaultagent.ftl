...
default-browser-notification-privacy-header-text = 要继续使用 { -brand-short-name } 吗？
default-browser-notification-privacy-body-text = 您的默认浏览器已更改。建议继续使用 { -brand-short-name }，享受内置的隐私及更多保护。
