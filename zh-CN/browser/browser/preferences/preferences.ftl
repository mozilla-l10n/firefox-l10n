...
is-not-default-browser-2 =
    .message = 咦？{ -brand-short-name } 不是您的默认浏览器。
...
preferences-ai-controls-block-ai-description = 阻止后，{ -brand-short-name } 将不再显示新的及现有的 AI 增强功能，也不会再弹出相关提醒。<a data-l10n-name="link">详细了解</a>涉及的项目，以及传统机器学习功能（例如搜索建议和功能建议）的控制方法。
...
preferences-ai-controls-block-confirmation-features-after = 阻止后，使用由 { -brand-short-name } 提供的 AI 的扩展也将受影响。
