...
fxa-qrcode-pair-step2-signin = 2. 打开菜单（iOS 上的 <img data-l10n-name="ios-menu-icon"/> 或 Android 上的 <img data-l10n-name="android-menu-icon"/>），点按<strong>同步并保存数据</strong>
