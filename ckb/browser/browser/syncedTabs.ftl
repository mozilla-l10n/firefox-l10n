...
synced-tabs-sidebar-open-settings = Open هاوکاتکردن settings
synced-tabs-sidebar-tabsnotsyncing = هاوکاتگەری بازدەر چالاک بکە بۆ ئەوەی لیستی هەموو بازدەرەکان ببینیت لە ئامێرەکەی ترەوە.
synced-tabs-sidebar-connect-another-device = پەیوەندی بکە بە ئامێرێکی تر
synced-tabs-sidebar-search = بگەڕێ لەناو بازدەرە هاوکاتگەری کراوەکان
    .placeholder = بگەڕێ لەناو بازدەرە هاوکاتگەری کراوەکان
