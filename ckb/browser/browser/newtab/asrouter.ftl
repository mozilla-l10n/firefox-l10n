...
cfr-whatsnew-search-shortcuts-header = قەدبڕەکانی گەڕان لە تووڵی ناونیشان
cfr-whatsnew-search-shortcuts-body = ئێستا، کاتێک بزوێنەرێکی گەڕان یان ماڵپەڕێک دەنووسی لە توڵی ناونیشان، قەدبڕێکی شین دەردەکەوێت لە ژێرەوەی پیشنیارەکانی گەران. ئەو قەدبڕە هەڵبژێرە بۆ تەواوکردنی گەڕانەکەت لە تووڵی ناونیشانەوە.
