...
more-from-moz-mozilla-vpn-title = Mozilla VPN
...
more-from-moz-learn-more-link = زیاتر بزانە
...
more-from-moz-solo-title-2 = { -solo-ai-brand-name } AI وێبsite Creator

## These strings are for the MDN card in about:preferences moreFromMozilla page

more-from-moz-mdn-title = MDN وێب Docs
