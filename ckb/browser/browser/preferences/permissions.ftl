...
permissions-address = ناونیشانی ماڵپەڕ
    .accesskey = ڕ
permissions-block = بلۆک
    .label = بلۆک
    .accesskey = د
permissions-disable-etp =
    .label = Add Exception
    .accesskey = د
permissions-session = ڕێگەدان بۆ دانیشتن
    .label = ڕێگەدان بۆ دانیشتن
    .accesskey = پ
permissions-allow = ڕێگەبدە
    .label = ڕێگەبدە
    .accesskey = A
permissions-add =
    .label = زیادکردن
...
permissions-button-off-temporarily =
    ...
    .accesskey = ئ
permissions-site-name = ماڵپەڕ
    .label = ماڵپەڕ
permissions-status = دۆخ
    .label = دۆخ
permissions-remove = ماڵپەڕ بسڕەوە
    .label = ماڵپەڕ بسڕەوە
    .accesskey = R
permissions-remove-all = هەموو ماڵپەڕەکان بسڕەوە
...
permissions-capabilities-autoplay-allow = ڕێگە بدە بە دەنگ و ڤیدیۆ
    .label = ڕێگە بدە بە دەنگ و ڤیدیۆ
permissions-capabilities-autoplay-block = دەنگ بلۆک بکە
    .label = دەنگ بلۆک بکە
permissions-capabilities-autoplay-blockall = دەنگ و ڤیدیۆ بلۆک بکە
    .label = دەنگ و ڤیدیۆ بلۆک بکە
permissions-capabilities-allow = ڕێگەبدە
    .label = ڕێگەبدە
permissions-capabilities-block = بلۆک
    .label = بلۆک
permissions-capabilities-prompt = هەموو کات پرسیار بکە
    .label = هەموو کات پرسیار بکە
permissions-capabilities-listitem-allow = ڕێگەبدە
    .value = ڕێگەبدە
permissions-capabilities-listitem-block = بلۆک
    .value = بلۆک
permissions-capabilities-listitem-allow-session = ڕێگەدان بۆ دانیشتن
    .value = ڕێگەدان بۆ دانیشتن
permissions-capabilities-listitem-off = .value = ناچالاک
    .value = ناکارا
...
permissions-doh-add-exception =
    .label = زیادکردن
    .accesskey = A
permissions-doh-col = .label = دۆمەین
    .label = دۆمەین
