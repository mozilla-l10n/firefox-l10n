...
existing-user-tou-message = <strong>Update</strong> We’ve introduced a { -brand-short-name } <a data-l10n-name="terms-of-use-link">Terms of Use</a> and updated our <a data-l10n-name="privacy-notice-link">تایبەتمەندی Notice</a>. Please take a moment to review and accept.
# Infobar message for when the Privacy Notice is updated.
existing-user-privacy-notice-update-message = We’ve updated our <a data-l10n-name="privacy-notice-link">تایبەتمەندی Notice</a> to reflect the latest features in { -brand-short-name }.
