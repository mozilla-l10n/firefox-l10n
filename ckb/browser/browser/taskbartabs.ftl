...
#                    site.
taskbar-tab-shortcut-description = { $name } وێب App
...
# should be fine.)
taskbar-tab-shortcut-folder = { -brand-short-name } وێب Apps

## These strings are used as the tooltip for the mute/unmute button.

taskbar-tab-audio-mute = .tooltiptext = Mute تاب
    .tooltiptext = بازدەر بێدەنگ بکە
taskbar-tab-audio-unmute = .tooltiptext = Unmute تاب
    .tooltiptext = بازدەر لە بێدەنگی لابە
