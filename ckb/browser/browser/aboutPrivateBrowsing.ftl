...
about-private-browsing-info-description-private-window = پەنجەرەی تایبەت: Firefox مێژووی گەڕان و بینینت دەسڕێتەوە کاتێک هەموو پەنجەرە تایبەتەکان دادەخەیت. ئەمە ناتکات بە نادیار.
about-private-browsing-info-description-simplified = Firefox مێژووی گەڕان و بینینت دەسڕێتەوە کاتێک هەموو پەنجەرە تایبەتەکان دادەخەیت، بەڵام ئەمە ناتکات بە نادیار.
...
about-private-browsing-hide-activity-1 = چالاکی گەڕان و شوێنەکەت بشارەوە بە Mozilla VPN. بە یەک کلیک پەیوەندییەکی پارێزراو دروست بکە، تەنانەت لەسەر Wi-Fiـی گشتیش.
about-private-browsing-prominent-cta = بە تایبەت بمێنەرەوە بە Mozilla VPN
about-private-browsing-focus-promo-cta = دابەزاندنی Firefox فۆکەس
...
about-private-browsing-focus-promo-text-b = Firefox فۆکەس بەکاربهێنە بۆ ئەو گەڕانە تایبەتانەی کە ناتەوێت وێبگەڕی سەرەکی مۆبایلەکەت بیبینێت.
about-private-browsing-focus-promo-header-c = ئاستێکی باڵای تایبەتمەندی لەسەر مۆبایل
about-private-browsing-focus-promo-text-c = Firefox فۆکەس مێژووەکەت هەموو جارێک دەسڕێتەوە لە کاتی بلۆککردنی ڕیکلامەکان و شوێنپێهەڵگرەکاندا.
...
about-private-browsing-cookie-banners-promo-message = ڕێگە بدە Firefox بە شێوەیەکی خۆکار وەڵامی پەنجەرە بازدەرەکانی کوکی بۆ تۆ بداتەوە بۆ ئەوەی بگەڕێیتەوە بۆ گەڕانێکی بێ دەستوەردان. Firefox هەموو داواکارییەکان ڕەت دەکاتەوە ئەگەر بوار هەبێت.
# Simplified version of the headline if the original text doesn't work
# in your language: `{ -brand-short-name } will show fewer cookie requests`
about-private-browsing-cookie-banners-promo-heading = Firefox ئاگاداری بانەرەکانی کوکی دەبێت بۆ تۆ
...
about-private-browsing-felt-privacy-v1-info-body = Firefox کوکییەکان، مێژوو و زانیارییەکانی ماڵپەڕەکەت دەسڕێتەوە کاتێک هەموو پەنجەرە تایبەتەکان دادەخەیت.
