...
origin-controls-no-access = .label = Extension Can’t Read and Change زانیاری
    .label = Extension Can’t Read and Change Data
origin-controls-quarantined = .label = Extension Not Allowed to Read and Change زانیاری
    .label = Extension Not Allowed to Read and Change Data
origin-controls-quarantined-status = .label = Extension Not Allowed on Restricted ماڵپەڕs
    .label = Extension Not Allowed on Restricted Sites
origin-controls-quarantined-allow = .label = Allow on Restricted ماڵپەڕs
    .label = Allow on Restricted Sites
origin-controls-options = .label = Extension Can Read and Change زانیاری:
    .label = Extension Can Read and Change Data:
origin-controls-option-all-domains = .label = On All ماڵپەڕs
    .label = On All Sites
