...
rights-webservices-header = { -brand-full-name } وێب-Based Information Services
rights-webservices =
...
rights-safebrowsing-term-1 = هەڵبژاردنەکانی داوانامە بکەرەوە
rights-safebrowsing-term-2 = Select the ئاسایش selection
...
rights-locationawarebrowsing-term-1 = In the URL bar, type <code>دەربارەی ڕێکخستنەکان</code>
