...
install-failed-title = { -brand-short-name } دامەزراندن سەرکەوتوو نەبوو.
install-failed-message = { -brand-short-name } نەتوانرا دابمزەنرێت بەڵام هەر بەردەوام دەبێت لە کارکردن.
