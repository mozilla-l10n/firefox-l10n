...
profile-selection-delete-button =
    ...
    .accesskey = D
profile-selection-conflict-message = لەبەرگیراوێکی نوێ ی { -brand-product-name } گۆڕانکاری لە پەڕە کەسیەکەتدا کرد. دەبێت { -brand-short-name } دووبارە پێبکەیتەوە پێش ئەنجامدانی گۆڕانکاری دیکە.
