...
compatibility-settings-button-label = ڕێکخستنەکان
compatibility-settings-button-title = .title = ڕێکخستنەکان
    .title = ڕێکخستنەکان

## Messages used as headers in settings pane

compatibility-settings-header = ڕێکخستنەکان
compatibility-target-browsers-header = Target وێبگەڕs
