...
add-exception-domain-mismatch-long = El certificado pertenece a un sitio distinto, lo cual podría significar que alguien está intentando suplantar este sitio.
