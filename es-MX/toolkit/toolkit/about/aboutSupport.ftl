...
off-main-thread-paint-enabled = Visualización habilitada en subprocesos
off-main-thread-paint-worker-count = Recuento de workers de visualización en subprocesos
...
support-remote-settings-status-broken = Fuera de servicio
