...
about-networking-rcwn-cache-won-count = Cuenta de caché ganada
...
about-networking-rcwn-cache-slow = Conteo de caché lenta
about-networking-rcwn-cache-not-slow = Conteo de caché no lento
