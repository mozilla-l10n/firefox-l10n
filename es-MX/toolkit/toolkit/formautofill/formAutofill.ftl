...
autofill-insecure-field-warning-description = { -brand-short-name } ha detectado un sitio web inseguro. El llenado automático de formularios está deshabilitado temporalmente
