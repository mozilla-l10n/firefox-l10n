...
settings-pp-not-wanted = ¡Advertencia! Has decidido no usar una contraseña principal. Contraseñas almacenadas y las claves privadas de certificados administradas por { -brand-short-name } ya no estarán protegidas.
...
primary-password-required-by-policy = Tu organización requiere que tengas configurada una contraseña maestra para guardar los inicios de sesión y las contraseñas.
...
remove-primary-password-info =
    .value = Es necesario ingresar la contraseña actual para continuar.
remove-info =
