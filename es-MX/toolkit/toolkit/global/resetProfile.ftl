...
refresh-profile-dialog-description = Empieza de cero para solucionar problemas de rendimiento. Esto eliminará tus complementos y personalizaciones. No perderás información esencial como marcadores y contraseñas.
refresh-profile = Dar un repaso a { -brand-short-name }
refresh-profile-button = Restablecer { -brand-short-name }…
refresh-profile-learn-more = Más información
