...
webrtc-allow-share-camera-with-file = ¿Permitir que este archivo local use tu cámara?
webrtc-allow-share-microphone-with-file = ¿Permitir que este archivo local use tu micrófono?
webrtc-allow-share-screen-with-file = ¿Permitir que esté archivo local vea tu pantalla?
# "Speakers" is used in a general sense that might include headphones or
# another audio output connection.
...
# "Speakers" is used in a general sense that might include headphones or
# another audio output connection.
webrtc-allow-share-speaker-unsafe-delegation = ¿Permitir que { $origin } dé acceso a los altavoces alternativos a { $thirdParty }?
