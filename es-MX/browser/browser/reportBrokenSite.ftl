...
report-broken-site-panel-url-label = URL del sitio con fallas
...
report-broken-site-panel-reason-checkout-moz-box-button =
    .label = No puedo pagar, salir o comprar
...
report-broken-site-panel-reason-media-moz-box-button =
    .label = El video no se reproduce ni se carga
...
report-broken-site-panel-reason-account-moz-box-button =
    .label = No puedo iniciar sesión ni registrarme
...
report-broken-site-panel-description =
    .placeholder = ¿Qué pasó? ¿Qué debería haber pasado? ¿Ayudó desactivar la protección contra el rastreo?
