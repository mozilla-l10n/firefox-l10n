...
preonboarding-subtitle = Al continuar, aceptas las { -brand-product-name } Condiciones de uso y nuestro Aviso de privacidad. Para ayudar a mejorar el navegador, { -brand-product-name } envía datos de diagnóstico e interacción a { -vendor-short-name }.
...
preonboarding-manage-and-read-header-v2 = Leer los Términos de uso y el Aviso de privacidad. Administra configuraciones adicionales.
...
preonboarding-checklist-interaction-data-description = Los datos sobre tu dispositivo, la configuración del hardware y cómo utilizas { -brand-product-name } ayudan a mejorar las funciones, el rendimiento y la estabilidad para usuarios de todo el mundo.
