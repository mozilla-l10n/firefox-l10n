...
protocolhandler-mailto-handler-set = ¿Usar <strong>{ -brand-short-name } para abrir { $url }</strong> cada vez que hagas clic en un enlace que abra el correo electrónico?
