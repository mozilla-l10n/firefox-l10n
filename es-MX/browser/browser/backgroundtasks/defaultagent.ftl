...
default-browser-notification-privacy-header-text = ¿Quieres seguir usando { -brand-short-name }?
default-browser-notification-privacy-body-text = Tu configuración predeterminada cambió. Regresa a { -brand-short-name } para contar con privacidad y protección integradas.
