...
unexpected-script-load-detail-2 = Incluso si permite este script, debes de informar { -vendor-short-name } para ayudar a comprender cómo y por qué se cargó. <em>Sin esta información, la funcionalidad dejará de funcionar en el futuro.</em>
