...
pane-privacy-title2 = Privacidad y seguridad
...
applications-setting =
    .label = Aplicaciones
    .description = Decide cómo { -brand-short-name } gestiona los archivos que descargas de la Web o las aplicaciones que utilizas mientras navegas.
