...
appearance-browser-icon-entry-group =
    ...
    .description = Elige un ícono personalizado para la barra de tareas, el escritorio y el menú de inicio.
...
appearance-browser-icon-requirement =
    .message = Completa las acciones para desbloquear iconos de zorro adicionales para personalizar { -brand-short-name }.
...
appearance-browser-icon-unlocked =
    .message = ¡Has desbloqueado todos los iconos adicionales!
appearance-browser-icon-set-default-button =
    .label = Establecer como predeterminado
appearance-browser-icon-pin-button =
    .label = Fijar en la barra de tareas
