...
fx-view-discoverability-subtitle = Búscala y ábrela de nuevo rápido aquí. Guardamos un historial de las pestañas que cerraste recientemente para ti.
...
split-dismiss-button-dont-show-option =
    .label = No mostrar esta recomendación otra vez.
...
link-preview-onboarding-callout-description = Consulta una breve descripción, el tiempo de lectura y más información para decidir si vale la pena hacer clic en un enlace. También disponible con el botón derecho.
...
tab-groups-2026-onboarding-callout-title = Mantén el orden con los grupos de pestañas
...
tab-groups-2026-onboarding-callout-subtitle = Agrupa tus pestañas por tarea o tema. Arrastra más conforme las utilices.
...
sidebar-deprecation-callout-subtitle = Estamos eliminando gradualmente la versión de la barra lateral que usas actualmente. Prueba la barra lateral actualizada. Es más rápida y te da acceso a más herramientas.
...
sidebar-callout-survey-features-question = Las siguientes son características potenciales de la barra lateral. ¿Qué mejoraría más tu productividad en { -brand-short-name }?
...
sidebar-callout-survey-saved-websites-2 = Acceso rápido a tus marcadores
sidebar-callout-survey-none-of-above = Ninguna de las anteriores
sidebar-callout-survey-submit = Enviar
sidebar-callout-survey-thank-you = ¡Gracias por tus comentarios!
sidebar-genai-survey-satisfaction-question = ¿En qué medida estás satisfecho con tener acceso a un chatbot de IA en la barra lateral?
...
splitview-onboarding-callout-subtitle-1 = Haz clic derecho en esta pestaña y elige “Agregar vista dividida” para ver dos pestañas a la vez.
...
splitview-onboarding-callout-subtitle-2 = Sin ventanas adicionales. Sin cambio de pestañas. Haz clic derecho en esta pestaña y selecciona “Agregar vista dividida”.
