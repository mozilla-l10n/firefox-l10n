...
smartwindow-assistant-error-budget-header = Has alcanzado el límite diario de chats.
...
# should not be translated. The <a> wraps "Exa" as a link to a support
# article explaining the third-party web search integration.
action-log-searched-web-with-exa = Búsqueda en la web con <a data-l10n-name="exa-link">Exa</a>
...
action-log-checked-world-cup-live = Revisión de partidos del Mundial en vivo
# Variables
...
smartwindow-search-loader-text = Resultados cargados en esta pestaña. Analizando…
...
smartwindow-assistant-citations-more-label = +{ $count } más
