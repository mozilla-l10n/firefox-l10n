...
opensearch-error-duplicate-desc = { -brand-short-name } no ha podido instalar el plugin de búsqueda de "{ $location-url }" porque ya existe un motor con el mismo nombre.
...
opensearch-error-download-desc = { -brand-short-name } no pudo descargar el plugin de búsqueda de: { $location-url }
