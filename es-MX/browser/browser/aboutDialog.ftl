...
update-failed = La actualización falló. <label data-l10n-name="failed-link">Descarga la última versión</label>
...
settings-update-unsupported = No puedes realizar más actualizaciones en este sistema. <a data-l10n-name="unsupported-link">Más información</a>
...
helpus-referrals2 = ¿Quieres ayudar? <label data-l10n-name="helpus-donateLink">Haz una donación</label>, <label data-l10n-name="helpus-shareFirefoxLink">Comparte { -brand-product-name }</label> o <label data-l10n-name="helpus-getInvolvedLink">¡Participa!</label>
helpus-referrals = ¿Quieres ayudar? <label data-l10n-name="helpus-donateLink">Haz una donación</label>, <label data-l10n-name="helpus-shareFirefoxLink">Comparte { -brand-short-name }</label> o <label data-l10n-name="helpus-getInvolvedLink">¡Participa!</label>
