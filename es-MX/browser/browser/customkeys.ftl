...
customkeys-clear = Borrar
customkeys-new-key = Presiona la nueva tecla:
customkeys-reset-all = Restablecer todos los accesos directos a los valores predeterminados
# Variables
# $conflict (string) - The title of the conflicting shortcut.
customkeys-conflict-confirm = Esta clave ya está asignada a { $conflict }. ¿Quieres reemplazarla?
...
customkeys-view-bookmarks-toolbar = Mostrar u ocultar la barra de marcadores
...
customkeys-nav-toggle-mute = Desactivar/Activar sonido
...
customkeys-shortcut-unassigned =
    .placeholder = Agregar acceso directo
# Variables:
# $keyLabel (string) - The name of the shortcut, e.g. “New Tab”.
customkeys-shortcut-input = Atajo: { $keyLabel }
customkeys-key-edit =
    .aria-label = Editar
    .tooltiptext = Editar
...
customkeys-conflict-confirm-title = ¿Quieres eliminar otro atajo?
# Variables
# $conflict (string) - The title of the conflicting shortcut.
