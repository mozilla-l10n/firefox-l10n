...
new-profile-page-header-description = Cada perfil es único, así que tu historial de navegación y configuraciones se mantienen separados de cada perfil. Además, la fuerte protección de tu privacidad en { -brand-short-name } viene de manera predeterminada.
...
copied-profile-page-header-2 = Tu copia de “{ $profilename }” está lista para personalizarse
copied-profile-page-header-description = Copiamos tus datos y configuración en un nuevo perfil. Ahora, dale un nombre, elige un estilo y personalízalo.
restored-profile-page-header = Personaliza tu perfil restaurado
restored-profile-page-header-description = Cada perfil es único, así que tu historial de navegación y configuraciones se mantienen separados de cada perfil. Además, la fuerte protección de tu privacidad en { -brand-short-name } viene de manera predeterminada.
...
present-avatar-tooltip =
    .tooltiptext = Aplicar avatar de presente
