...
avatar-selector-save-button =
    .label = Guardar
avatar-selector-upload-file = Sube un archivo
...
edit-profile-page-no-name = Dale un nombre a este perfil para identificarlo fácilmente. Puedes cambiarle el nombre cuando quieras.
...
new-profile-page-header-description = Cada perfil es único y su historial de navegación y configuraciones se mantendrán separados de otros perfiles. Además, la protección de privacidad avanzada de { -brand-short-name } estará activada por defecto.
new-profile-page-learn-more = Más información
...
copied-profile-page-header-2 = Tu copia de “{ $profilename }” está lista para personalizar
copied-profile-page-header-description = Copiamos tus datos y configuración a un nuevo perfil. Ahora, puedes darle un nombre, elegir un estilo y personalizarlo.
restored-profile-page-header = Personaliza tu perfil restaurado
restored-profile-page-header-description = Cada perfil es único y su historial de navegación y configuraciones se mantendrán separados de otros perfiles. Además, la protección de privacidad avanzada de { -brand-short-name } estará activada por defecto.
restored-profile-page-learn-more = Más información
...
profiles-appmenu-callout-tour-title = Tu nuevo perfil está listo para funcionar
# "Spin up another" means creating another profile, “Hop between your digital lives" is referring to switching between different profiles such as work, personal, etc.
profiles-appmenu-callout-tour-subtitle = En el menú ☰, toca el nombre de tu perfil para crear otro, editar este o alternar entre tus vidas digitales.
