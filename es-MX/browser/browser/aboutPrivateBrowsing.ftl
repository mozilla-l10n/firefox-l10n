...
about-private-browsing-info-saved = { -brand-short-name } <strong>guardará</strong> tus:
...
about-private-browsing-info-temporary-files = los archivos temporales
about-private-browsing-info-cookies = las cookies
