...
firefox-relay-and-fxa-popup-notification-second-sentence-control = Primero, regístrate o inicia sesión en tu cuenta para usar una máscara de correo electrónico
...
firefox-relay-and-fxa-popup-notification-second-sentence-basic-info = Primero, regístrate o inicia sesión en tu cuenta para usar una máscara de correo electrónico
...
firefox-relay-and-fxa-popup-notification-second-sentence-with-domain = Primero, regístrate o inicia sesión en tu cuenta para usar una máscara de correo electrónico
...
firefox-relay-and-fxa-popup-notification-second-sentence-with-domain-and-value-prop = Primero, regístrate o inicia sesión en tu cuenta para usar una máscara de correo electrónico
