...
sidebar-item-session-history = Historial de la sesión
    .alt = Icono de historial de la sesión
...
session-history-navigate-button-title = Ir a la entrada { $index } del historial de la sesión
