...
devtools-tooltip-learn-more = Más información
...
inactive-css-not-floated-fix = Prueba a agregar la propiedad <strong>float</strong> con un valor distinto de <strong>none</strong>. { learn-more }
...
inactive-css-not-for-internal-table-elements-except-table-cells-fix = Prueba establecer su propiedad <strong>display</strong> a algo diferente de <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong> o <strong>table-footer-group</strong>. { learn-more }
...
inactive-scroll-padding-when-not-scroll-container-fix = Intenta agregar <strong>overflow:auto</strong>,<strong>overflow:scroll</strong>, o<strong>overflow:hidden</strong>. { learn-more }
...
inactive-css-ruby-element-fix = Intenta cambiar el <strong>font-size</strong> del texto rubí. { learn-more }
...
inactive-css-not-grid-or-flex-container-fix-1 = Intenta agregar <strong>display:grid</strong> o <strong>display:flex</strong>.
inactive-css-not-grid-or-flex-or-block-container-fix-1 = Intenta agregar <strong>display:grid</strong>, <strong>display:flex</strong>, o <strong>display:block</strong>.
inactive-css-not-grid-or-flex-container-or-multicol-container-fix-1 = Intenta agregar <strong>display:grid</strong>, <strong>display:flex</strong>, o <strong>columns:2</strong>.
inactive-css-not-multicol-container-fix-1 = Intenta agregar <strong>column-count</strong> o <strong>column-width</strong>.
inactive-css-column-span-fix-1 = Intenta agregar <strong>column-count</strong> o <strong>column-width</strong> a uno de sus elementos antecesores.
inactive-css-not-grid-or-flex-or-absolutely-positioned-item-fix-1 = Intenta agregar <strong>position:absolute</strong> al elemento, o <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong> o <strong>display:inline-flex</strong> al elemento primario.
inactive-css-not-grid-or-absolutely-positioned-item-fix-1 = Intenta agregar <strong>position:absolute</strong> al elemento, o <strong>display:grid</strong> o <strong>display:inline-grid</strong> al elemento primario.
inactive-css-not-absolutely-positioned-item-fix-1 = Intenta agregar <strong>position:absolute</strong> al elemento.
inactive-css-no-default-anchor-fix-1 = Intenta agregar <strong>position-anchor</strong> con un nombre de anclaje (anchor name) válido.
...
inactive-css-not-floated-fix-1 = Prueba a agregar la propiedad <strong>float</strong> con un valor distinto de <strong>none</strong>.
...
inactive-css-not-for-internal-table-elements-except-table-cells-fix-1 = Prueba establecer su propiedad <strong>display</strong> a algo diferente de <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong> o <strong>table-footer-group</strong>.
...
inactive-scroll-padding-when-not-scroll-container-fix-1 = Intenta agregar <strong>overflow:auto</strong>,<strong>overflow:scroll</strong>, o<strong>overflow:hidden</strong>.
...
inactive-css-ruby-element-fix-1 = Intenta cambiar el <strong>font-size</strong> del texto rubí.
...
css-selector-container-query-condition-no-container = No se encontró el contenedor ‘{ $name }’
