...
xslt-parse-failure = Nabigo ang pag-parse ng XSLT stylesheet.
xpath-parse-failure = Nabigo ang pag-parse ng XPath expression.
xslt-execution-failure = Nabigo ang pag-tratansporm ng XSLT.
xpath-unknown-function = Hindi balido ang XSLT/XPath na pangsyon.
...
xslt-wrong-mime-type = Walang XML mimetype ang isang XSLT stylesheet:
...
xslt-unknown-error = May unknown error ({ $errorCode })
