...
pw-empty-warning = Ang iyong naka-imbak na web at email password, form data, at private key ay hindi protektado.
pw-erased-ok = Binurahin mo ang Master Password mo. { pw-empty-warning }
pw-not-wanted = Babala! Ang iyong desisyon ay huwag gumamit ng Master Password. { pw-empty-warning }
...
pw-change-success-title = Matagumpay ang Pagpalit ng Lihim na Susi
...
set-password-reenter-password = Ilagay-ulit and password:
set-password-meter = Metro para sa kalidad ng password
...
master-password-warning = Mangyaring tiyakin na natandaan mo ang Master Password na itinakda mo. Kung nakalimutan mo ang iyong Password sa Master, hindi muna maaring ma-access ang anumang impormasyon na protektado sa pamamagitan nito.
remove-password =
    .title = Tanggalin and Master Password
remove-info =
