...
fp-neterror-denied-port-access = Gumagamit ang address na ito ng network port na hindi karaniwang ginagamit sa pag-browse ng Web. Kinansela ng { -brand-short-name } ang request na ito para sa iyong proteksyon.
