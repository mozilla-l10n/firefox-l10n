...
inactive-css-not-grid-or-flex-container-or-multicol-container-fix-1 = Subukang magdagdag ng <strong>display:grid</strong>, <strong>display:flex</strong>, o <strong>columns:2</strong>.
inactive-css-not-grid-item-fix-3 = Subukang magdagdag ng <strong>display:grid</strong> o <strong>display:inline-grid</strong> sa parent ng element.
inactive-css-not-grid-container-fix-1 = Subukang magdagdag ng <strong>display:grid</strong> o <strong>display:inline-grid</strong>.
