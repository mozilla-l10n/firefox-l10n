...
restart-required-intro-brand = Katatapos lang mag-update ng { -brand-short-name } sa background. I-click ang Restart { -brand-short-name } para makumpleto ang update.
