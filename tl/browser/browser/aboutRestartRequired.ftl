...
restart-required-title = Kailangan mag-Restart
restart-required-header = Paumanhin. Kinailangan lang naming gawin ang kaunting bagay upang makapag-patuloy.
restart-required-intro = Kakalagay lang namin ng update na hindi namamalayan. Paki-click ang Restart { -brand-short-name } upang magpatuloy ito sa pag-lagay update.
