...
policy-CaptivePortal = Paganahin o hindi ang captive portal support.
...
policy-DisableMasterPasswordCreation = Kung tama,hindi na maaari pang lumikha ng master password.
