...
callout-primary-complete-button-label = Nakuha ko!

## Firefox View feature tour strings

# "Tab pickup" refers to the section in Firefox View that displays open
# tabs from other devices
callout-firefox-view-tab-pickup-title = Lumipat sa mga ibang device gamit ang tab pickup
...
callout-firefox-view-colorways-reminder-subtitle = Kulayan ang iyong browser gamit ang mga sikat na shade, inspirasyon galing sa mga independiyenteng boses. Sa { -brand-product-name } lamang.
