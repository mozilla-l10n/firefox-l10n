...
certmgr-server = Diese Einträge identifizieren Ausnahmeregeln für Serverzertifikatsfehler
...
delete-ssl-override-title =
    .title = Server-Zertifikat-Ausnahmeregel löschen
delete-ssl-override-confirm = Soll diese Server-Ausnahmeregel wirklich gelöscht werden?
delete-ssl-override-impact = Wenn Sie eine Server-Ausnahmeregel löschen, werden die normalen Sicherheitsüberprüfungen für diesen Server wiederhergestellt und er muss ein gültiges Zertifikat vorweisen.
