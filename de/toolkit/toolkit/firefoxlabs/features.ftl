...
experimental-features-group-customize-browsing-description = Wenn Sie diese Funktionen ausprobieren, <a data-l10n-name="connect">teilen Sie Ihre Meinung auf Connect</a>
