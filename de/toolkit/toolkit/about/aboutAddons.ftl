...
extensions-warning-check-compatibility = Die Add-on-Kompatibilitäts-Prüfung ist deaktiviert. Sie könnten inkompatible Add-ons haben.
extensions-warning-safe-mode2 =
    .message = Alle Add-ons wurden durch den Abgesicherten Modus deaktiviert.
extensions-warning-check-compatibility2 =
    .message = Die Add-on-Kompatibilitäts-Prüfung ist deaktiviert. Sie könnten inkompatible Add-ons haben.
extensions-warning-check-compatibility-button = Aktivieren
    .title = Add-on-Kompatibilitäts-Prüfung aktivieren
...
addon-badge-recommended4 =
    .title = Firefox empfiehlt nur Erweiterungen, die Sicherheits- und Leistungsstandards entsprechen
...
plugins-openh264-description = Dieses Plugin wird automatisch von Mozilla installiert, um die WebRTC-Spezifikation zu befolgen und WebRTC-Anrufe mit Geräten zu ermöglichen, die das H.264-Codec benötigen. Besuchen Sie https://www.openh264.org/ um den Quelltext des Plugins zu sehen und mehr über die Implementierung zu erfahren.
...
list-empty-get-extensions-promo =
    .heading = Schon wenige Erweiterungen können viel bewirken
    .message = Wir haben Empfehlungen, mit denen Sie sich besser konzentrieren, Ihre Privatsphäre und mehr verbessern können.
