...
about-networking-ssl-tokens-summary-certs = Gespeicherte Zertifikate: { $references } ({ $totalBytes } B), davon eindeutig: { $distinct } ({ $distinctBytes } B)
...
about-networking-ssl-tokens-built-in-root = Integriertes Stammzertifikat
