...
certificate-viewer-given-name = Vorname
...
certificate-viewer-extended-key-usages = Erweiterte Schlüsselverwendung
...
certificate-viewer-unknown-file-name = Zertifikat
