...
login-item-tooltip-message = Stellen Sie sicher, dass dies mit der genauen Adresse der Website übereinstimmt, auf der Sie sich anmelden.
login-item-origin =
...
about-logins-import-dialog-error-conflicting-values-description = Zum Beispiel: mehrere Benutzernamen, Passwörter, URLs usw. für Zugangsdaten.
about-logins-import-dialog-error-file-format-title = Dateiformatproblem
about-logins-import-dialog-error-file-format-description = Falsche oder fehlende Spaltenüberschriften. Bitte stellen Sie sicher, dass die Datei Spalten für Benutzername, Passwort und URL enthält.
