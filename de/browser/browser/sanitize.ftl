...
item-site-prefs =
    ...
    .accesskey = W
item-formdata-prefs =
    .label = Gespeicherte Formularinformationen
    .accesskey = F
item-formdata-description = Löscht Namen, E-Mail-Adressen und andere Einträge, die Sie in Formularen eingeben
