...
profiler-popup-presets-graphics-description = Voreinstellung zur Untersuchung von Grafikfehlern in { -brand-shorter-name }.
profiler-popup-presets-graphics-label =
    .label = Grafik
profiler-popup-presets-media-description2 = Voreinstellung für die Untersuchung von Audio- und Videofehlern in { -brand-shorter-name }.
