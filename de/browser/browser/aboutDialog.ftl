...
settings-update-applying =
    .label = Update wird durchgeführt…
...
settings-update-policy-disabled =
    .label = Ihre Organisation hat Updates deaktiviert
update-noUpdatesFound = { -brand-short-name } ist aktuell
settings-update-no-updates-found =
    .label = { -brand-short-name } ist aktuell
...
helpus-referrals2 = Möchten Sie helfen? <label data-l10n-name="helpus-donateLink">Spenden Sie</label>, <label data-l10n-name="helpus-shareFirefoxLink">Teilen Sie { -brand-product-name }</label>, oder <label data-l10n-name="helpus-getInvolvedLink">machen Sie mit!</label>
helpus-referrals = Möchten Sie helfen? <label data-l10n-name="helpus-donateLink">Spenden Sie</label>, <label data-l10n-name="helpus-shareFirefoxLink">Teilen Sie { -brand-short-name }</label>, oder <label data-l10n-name="helpus-getInvolvedLink">machen Sie mit!</label>
bottomLinks-license = Informationen zur Lizenzierung
bottom-links-terms = Nutzungsbedingungen
bottom-links-privacy = Datenschutzhinweis
