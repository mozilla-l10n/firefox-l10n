...
genai-settings-chat-lechat-links-2 = Indem Sie sich für Mistral Vibe entscheiden, stimmen Sie den <a data-l10n-name="link1">Nutzungsbedingungen</a> und der <a data-l10n-name="link2">Datenschutzerklärung</a> von Mistral KI zu.
...
genai-shortcut-button-3 =
    .aria-label = Frage zu diesem Text
    .tooltiptext = Frage zu diesem Text
# $provider (string) - name of the AI chat provider
genai-shortcut-button-2 =
    .aria-label = { $provider } fragen
    .tooltiptext = { $provider } fragen
# $engine (string) - name of the search engine
# $selection (string) - the selected text, truncated
genai-shortcut-search-button =
    .aria-label = { $engine } nach "{ $selection }" durchsuchen
    .tooltiptext = { $engine } nach "{ $selection }" durchsuchen
genai-shortcut-copy-button =
    .aria-label = Ausgewählten Text kopieren
    .tooltiptext = Ausgewählten Text kopieren
genai-shortcut-more-actions-button =
    .aria-label = Weitere Optionen
    .tooltiptext = Weitere Optionen
# $provider (string) - name of the AI chat provider
