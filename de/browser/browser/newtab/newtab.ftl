...
newtab-privacy-etp-off-faster-browsing = Schneller surfen. Weniger Elemente zur Aktivitätenverfolgung.
newtab-privacy-etp-off-turn-on-tracking = Aktivieren Sie den Schutz vor Aktivitätenverfolgung in den Einstellungen, um mit der Blockierung zu beginnen.
...
newtab-stocks-watchlist-empty = Beobachten Sie Aktien, die für Sie wichtig sind
...
# has searched.
newtab-stocks-search-hint = Suchen Sie nach Symbolen oder Unternehmen, um diese zu Ihrer Beobachtungsliste hinzuzufügen
...
newtab-spaces-tab-stories = Artikel
newtab-spaces-tab-widgets = Widgets
newtab-spaces-tab-activity = Aktivität
...
newtab-topsites-hover-card-header = Benachrichtigungen von { $site }
# Relative time shown for a notification posted less than a minute ago.
newtab-topsites-hover-card-just-now = Gerade eben
...
newtab-menu-add-topsite = Neue Verknüpfung hinzufügen
...
newtab-carousel-play =
    .aria-label = Automatische Wiedergabe fortsetzen
...
newtab-custom-web-notifications-toggle =
    .description = Benachrichtigungen von Ihren Websites auf deren Verknüpfungen anzeigen
    .label = Web-Benachrichtigungen
...
newtab-customize-panel-back-button =
    ...
    .title = Zurück zum Bereich "Anpassen"
...
newtab-topic-navigation-more-button = Mehr
...
newtab-widget-section-show-widgets =
    .aria-label = Abschnitt für Widgets anzeigen
    .title = Widgets anzeigen
...
newtab-sports-widget-suspended = Unterbrochen
newtab-sports-widget-cancelled = Abgesagt
...
newtab-clock-widget-add-custom = "{ $city }" als benutzerdefinierte Uhr hinzufügen
# Text field for the display name of a user-added custom clock.
newtab-clock-widget-custom-city-input =
    .aria-label = Name der Stadt
    .label = Name der Stadt
    .placeholder = Name für diese Uhr
# Searchable time-zone field shown when adding a custom clock. The user
# types a city they know and picks it to set the clock's time zone.
newtab-clock-widget-custom-timezone-input =
    .aria-label = Zeitzone
    .label = Zeitzone
    .placeholder = Nach Stadt, Zeitzone oder Versatz zu UTC suchen
newtab-clock-widget-custom-zone-results =
    .aria-label = Ergebnisse für die Zeitzone
# Shown in the time-zone picker when the search matches no time zones.
newtab-clock-widget-custom-zone-no-results = Keine übereinstimmenden Zeitzonen
# Returns from the custom clock form back to the city search.
newtab-clock-widget-custom-back = Zurück
...
newtab-clock-city-ua-kyiv = Kiew
...
newtab-clock-city-vn-ho-chi-minh-city = Ho-Chi-Minh-Stadt
