...
profile-window-title = { -brand-short-name } - Benutzerprofil wählen
...
profile-window-checkbox-label =
    .label = Anzeigen, wenn { -brand-short-name } geöffnet wird
...
profiles-marigold-theme = Ringelblume
