...
sidebar-open-tools-from-sidebar =
    .label = Werkzeuge über Sidebar öffnen
...
sidebar-show-preview-on-hover =
    .label = Vorschau beim Darüberfahren anzeigen
...
sidebar-opentabs-preview-heading = Zuletzt geöffnete Tabs
