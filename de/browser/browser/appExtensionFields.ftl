...
extension-default-theme-description2 = Ein ausgewogenes, vertrautes Grau-Lila für einen klassischen { -brand-product-name }-Look.
...
extension-nova-sun-name = Sonne
# Name for a warm orange theme. Refers to a small burst of fire.
extension-nova-spark-name = Funke
...
extension-nova-flare-name = Fackel
...
extension-nova-dusk-name = Abendrot
