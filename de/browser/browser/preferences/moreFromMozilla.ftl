...
more-from-moz-title2 = Mehr von { -vendor-short-name }
    .title = Mehr von { -vendor-short-name }
...
more-from-moz-thunderbird-description = Gratis E-Mail, Kalender und Kontakte – nach Ihren Wünschen organisiert.
more-from-moz-thunderbird-button = Holen Sie sich { -thunderbird-brand-short-name }

## These strings are for the Mozilla New Products card in about:preferences moreFromMozilla page

more-from-moz-new-products-title = { -vendor-short-name } neue Produkte
more-from-moz-new-products-description = Entdecken Sie die neuesten Produkte von { -vendor-short-name }.
more-from-moz-new-products-button = Neue Produkte ansehen
...
more-from-moz-firefox-mobile-qr-promo =
    .message = Scannen Sie mit der Kamera Ihres Handys oder Tablets, um die App herunterzuladen. Tippen Sie auf den Link, wenn er angezeigt wird.
more-from-moz-firefox-mobile-email-link = Download-Link per E-Mail an Ihr Handy senden
...
more-from-moz-mozilla-vpn-box-link =
    .label = Holen Sie sich { -mozilla-vpn-brand-name }
more-from-moz-firefox-relay-box-link =
    .label = Holen Sie sich { -relay-brand-short-name }
more-from-moz-mdn-box-link =
    .label = Auf MDN zugreifen
more-from-moz-thunderbird-box-link =
    .label = Holen Sie sich { -thunderbird-brand-short-name }
more-from-moz-solo-box-link =
    .label = { -solo-ai-brand-name } ausprobieren
more-from-moz-new-products-box-link =
    .label = Neue Produkte ansehen
