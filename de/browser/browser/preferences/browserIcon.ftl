...
appearance-browser-icon-entry-group =
    ...
    .description = Wählen Sie ein benutzerdefiniertes Symbol für Taskleiste, Desktop und Startmenü.
appearance-browser-icon-button =
    .label = Browser-Symbol ändern
...
appearance-browser-icon-momo =
    .label = Momo
    .description = Erstellt von @heyheymomodraws
