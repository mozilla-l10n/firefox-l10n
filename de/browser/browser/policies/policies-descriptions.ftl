...
policy-AutoLaunchProtocolsFromOrigins = Eine Liste externer Protokolle festlegen, die von aufgelisteten Ursprüngen verwendet werden können, ohne den Benutzer zu fragen
