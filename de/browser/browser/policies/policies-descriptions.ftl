...
policy-CNSA2KeyAgreementEnabled = CNSA-2.0-ML-KEM-1024-Schlüsselvereinbarung für TLS aktivieren.
...
policy-DefaultBrowserSettingEnabled = Entscheiden, ob der Benutzer { -brand-short-name } als Standardbrowser festlegen kann.
...
policy-GenerativeAI = Generative KI-Funktionen konfigurieren.
...
policy-NewTabPage = Firefox-Startseite aktivieren oder deaktivieren
