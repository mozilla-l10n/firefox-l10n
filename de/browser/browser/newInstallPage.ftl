...
title = Wichtige Neuigkeiten
heading = Änderungen an Ihrem { -brand-short-name }-Profil
...
options-do-nothing = Wenn Sie nichts tun, werden sich Ihre Profildaten in { -brand-short-name } von anderen Firefox-Installationen unterscheiden.
