...
safeb-blocked-addon-page-learn-more3 = <a data-l10n-name='firefox_support_harmful_addons'>Weitere Informationen über den Schutz vor schädlichen Add-ons in { -brand-short-name }</a>.
