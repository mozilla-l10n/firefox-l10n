...
neterror-http-error-page = Уверете се, че сте въвели правилно адреса на уеб сайта.
neterror-http-empty-response = Уверете се, че сте въвели правилно адреса на уеб сайта и опитайте отново след малко.
neterror-captive-portal = Трябва да се впишете в тази мрежа, за да получите достъп до интернет.
neterror-dns-not-found-hint-header = <strong>Ако сте въвели верен адрес, следвайте стъпките по-долу:</strong>
...
neterror-dns-not-found-hint-check-network-2 = Проверете мрежовата си връзка.
...
fp-neterror-offline-body-title = Изглежда, че има проблем с вашия интернет
