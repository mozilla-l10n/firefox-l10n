...
policy-PrimaryPassword = Изискване или забраняване на използването на главна парола.
...
policy-TranslateEnabled = Включване или изключване на превода на уебстраници.
