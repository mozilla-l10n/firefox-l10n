...
browser-languages-window =
    ...
    .style = width: 40em
browser-languages-description = { -brand-short-name } ще използва първия език от списъка като език по подразбиране а останалите при необходимост в реда, в който са.
