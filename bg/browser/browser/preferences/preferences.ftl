...
tabs-browsing-section =
    .heading = Раздели и браузване
pane-tabs-browsing-title2 = Раздели и браузване
    .title = Раздели и браузване
tabs-group-header2 =
    .label = Раздели
...
history-custom-description4 =
    .aria-label = { history-group.label }
    .description = { -brand-short-name } ще използва потребителските настройки за вашето браузване, изтеглянията на файлове, формите и историята на търсенията.
