...
about-unloads-column-weight = Основна оценка
    .title = Разделите първо биват подредени по тази стойност, която зависи от това дали се изпълнява звук от раздела, има ли WebRTC и др.
about-unloads-column-sortweight = Допълнителна оценка
    .title = Ако е зададена, разделите биват подредени и по този параметър, след като са били подредени по основната оценка. Допълнителната оценка зависи от използваната от раздела памет и броя на процесите.
