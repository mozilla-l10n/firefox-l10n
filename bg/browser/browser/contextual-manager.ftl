...
contextual-manager-passwords-remove-login-card-message = Не може да отмените това.
...
contextual-manager-passwords-origin-field-description = Въведете точния адрес, откъдето ще се вписвате към този сайт.
contextual-manager-passwords-username-field =
    .label = Потребителско име
contextual-manager-passwords-username-field-description = Въведете потребителското име, имейл адреса или номера на профила, които използвате за вход.
