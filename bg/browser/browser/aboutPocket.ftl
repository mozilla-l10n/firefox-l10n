...
pocket-panel-signup-cta-a-fix = Вашият бутон за запазване в интернет
...
pocket-panel-signup-cta-c-updated = Преглеждайте запазените неща на всяко устройство и по всяко време.
...
pocket-panel-home-most-recent-saves-loading = Последно запазените неща се зареждат…
