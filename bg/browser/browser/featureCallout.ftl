...
continuous-onboarding-firefox-view-tab-pickup-title = Ускорете разглеждането като избирате разделите
...
callout-pdfjs-edit-body-a = Попълвайте формуляри, добавяйте коментари или си правете бележки директно в { -brand-short-name }.
callout-pdfjs-edit-body-b = Пропуснете търсенето на безплатни онлайн редактори. Попълвайте формуляри, добавяйте коментари или си правете бележки директно в { -brand-short-name }.
...
callout-pdfjs-draw-body-a = Маркирайте PDF файлове, след което запазете промените.
# “Mark up” refers to the process of “annotating” or adding free hand text or diagramming to the document.
...
windows-10-eos-sync-tour-title-1 = Имате твърде много раздели? Облекчете работата си като ги групирате.
