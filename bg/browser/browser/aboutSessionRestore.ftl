...
welcome-back-page-info-link = Добавките и персонализирането бяха премахнати, а настройките на браузъра бяха върнати до стандартните. Ако това не оправи проблема, <a data-l10n-name="link-more">научете повече, какво може да направите.</a>
