...
welcome-back-page-info-link = Добавките и приспособленията бяха премахнати, а настройките на уеб-четеца бяха върнати до заводските. <a data-l10n-name="link-more">научете какво още може да направите.</a>, ако това не оправи проблема.
