...
site-permission-install-first-prompt-serial-header = Този сайт иска достъп до вашите серийни устройства. Достъпът до устройството може да бъде активиран чрез инсталиране на добавка.
