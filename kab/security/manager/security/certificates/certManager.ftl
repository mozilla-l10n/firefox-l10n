...
certmgr-pending-label =
    .value = Asenqed n iselkan imiranen…
certmgr-subject-info-label =
    .value = Ittusgel i:
certmgr-issuer-info-label =
    .value = Yessuffeɣ-it-id:
certmgr-period-of-validity-label =
    .value = Tawala n tneɣbalt
...
certmgr-cert-detail =
    .title = Talɣut leqqayen n uselkin
...
certmgr-cert-detail-ou =
    .value = Aferdis asuddsan (OU)
certmgr-cert-detail-serialnumber =
    .value = Uṭṭun n umazrar
certmgr-cert-detail-sha256-fingerprint =
    .value = Adsil umḍin SHA-256
certmgr-cert-detail-sha1-fingerprint =
    .value = Adsil umḍin SHA1
certmgr-cert-detail-commonname = Isem unnim (CN)
certmgr-cert-detail-org = Tuddsa (O)
certmgr-cert-detail-orgunit = Aferdis asuddsan (OU)
certmgr-cert-detail-serial-number = Uṭṭun n umazrar
certmgr-cert-detail-sha-256-fingerprint = Adsil umḍin SHA-256
certmgr-cert-detail-sha-1-fingerprint = Adsil umḍin SHA1
...
certmgr-begins-on = Ad ikker di
certmgr-begins-label =
    .label = Ad ikker di
certmgr-begins-value =
    .value = { certmgr-begins-label.label }
certmgr-expires-on = Ad ifak di
...
certmgr-restore =
    ...
    .accesskey = r
certmgr-details =
    .value = Urtan n uselkin
    .accesskey = U
certmgr-fields =
    .value = Azal n wurti
    .accesskey = z
certmgr-hierarchy =
    .value = Amyellel n iselkan
    .accesskey = H
...
not-present =
    .value = <Ur ittekki ara ɣeṛ uselkin>
# Cert verification
cert-verified = Aselkin-agi ittusenqed i weseqdec-agi:
# Add usage
verify-ssl-client =
    .value = Aselkin amsaɣ SSL
verify-ssl-server =
    .value = Aqeddac n uselkin SSL
verify-ssl-ca =
    .value = Adabu n uselken SSL
verify-email-signer =
    .value = Aselkin n uzmul n yimayl
verify-email-recip =
    .value = Aselkin n urmas n yimayl
# Cert verification
cert-not-verified-cert-revoked = D awezɣi asenqed n uselkin-agi acku ittwaḥwi.
cert-not-verified-cert-expired = Ur izmir ara ad isenqed aselkin-agi acku izri.
cert-not-verified-cert-not-trusted = Ur izmir ara ad isenqed aselkin-agi acku mačči d anelkan.
cert-not-verified-issuer-not-trusted = Ur izmir ara ad isenqed aselkin-agi acku adabu amazan ur ɣur-s ara taflest.
cert-not-verified-issuer-unknown = Ur izmir ara ad isenqed aselkin-agi acku adabu amazan d arussin.
