...
colorpicker-tooltip-eyedropper-title = Fren ini deg usebter
...
colorpicker-tooltip-color-name-title = Ini iqerben: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Meqqer aṭas
# A title text for the alpha slider in the color picker tooltip.
colorpicker-tooltip-alpha-slider-title = Tebrek
