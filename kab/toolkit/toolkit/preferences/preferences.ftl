...
settings-pp-not-wanted = Ɣur-k! Tgemneḍ ur tesseqdaceḍ ara awal n uεeddi agejdan. Awalen n uεeddi akked tsura tusligin n yiselkinen i yettwasferken sɣur { -brand-short-name } ur ttwammestnen ara.
...
remove-primary-password-info =
    .value = Issefk ad muddeḍ awal-ik n uɛeddi agejdan akken ad tedduḍ ɣer zdat.
remove-info =
