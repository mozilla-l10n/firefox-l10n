...
fx-view-discoverability-title = Ur nwiɣ ara amdal n yiccer-a?
fx-view-discoverability-primary-button-label = Mdel { -firefoxview-brand-name }
fx-view-discoverability-secondary-button-label = Zgel
