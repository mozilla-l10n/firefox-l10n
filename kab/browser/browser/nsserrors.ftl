...
ssl-error-handshake-not-completed = Ur yezmir ara ad iwennez tuqqna SSL imi win iteddun akka tura ur ikuf ara.
...
sec-error-retry-password = Ur d-sekcemeḍ ara awal uffir akken iwata. Ma ulac aɣilif, ɛreḍ tikelt nniḍen.
...
sec-error-retry-old-password = Ur d-sekcemeḍ ara awal uffir akken iwata. Ma ulac aɣilif, ɛreḍ tikelt-nniḍen.
...
sec-error-ocsp-try-server-later = Aqeddac OCSP isumer aɛraḍ tikelt nniḍen ticki.
...
sec-error-ocsp-not-enabled = Isefk ad tremreḍ OCSP sen aselken n temhelt-agi.
...
sec-error-pkcs11-function-failed = Azegrir PKCS #1 yerra-d CKR_FUNCTION_FAILED, immalen d akken tawuri ittusuteren ur tezmir ara ad teddu. Aɛreḍ tikelt nniḍen n temhelt-agi tezmer ad teddu.
