...
certmgr-delete-builtin =
    .label = Fuortsmite of net fertrouwe…
    .accesskey = F
certmgr-backup =
...
delete-ca-cert-impact = As jo in sertifikaat fan in sertifikaatautoriteit (CA) fuortsmite of net fertrouwe, sil dizze tapassing gjin inkeld sertifikaat mear fertrouwe dat troch dy CA útjûn is.
