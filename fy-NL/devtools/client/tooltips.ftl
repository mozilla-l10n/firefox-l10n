...
inactive-css-not-absolutely-positioned-item = <strong>{ $property }</strong> hat gjin effekt op dit elemint, omdat it gjin absolút posisjonearre elemint is.
inactive-css-no-default-anchor = <strong>{ $property }</strong> hat gjin effekt op dit elemint, omdat it gjin standert ankerelemint hat.
...
inactive-css-not-absolutely-positioned-item-fix = Probearje <strong>position:absolute</strong> oan it elemint ta te foegjen. { learn-more }
inactive-css-no-default-anchor-fix = Probearje <strong>position-anchor</strong> mei in jildige ankernamme ta te foegjen. { learn-more }
...
inactive-css-not-table-fix = Probearje <strong>display:table</strong> of <strong>display:inline-table</strong> ta te foegjen. { learn-more }
...
inactive-css-not-grid-or-flex-container-fix-1 = Probearje <strong>display:grid</strong> of <strong>display:flex</strong> ta te foegjen.
inactive-css-not-grid-or-flex-or-block-container-fix-1 = Probearje <strong>display:grid</strong>, <strong>display:flex</strong> of <strong>display:block</strong> ta te foegjen.
inactive-css-not-grid-or-flex-container-or-multicol-container-fix-1 = Probearje <strong>display:grid</strong>, of <strong>display:flex</strong>, of <strong>colums:2</strong> ta te foegjen.
inactive-css-not-multicol-container-fix-1 = Probearje <strong>column-count</strong> of <strong>column-width</strong> ta te foegjen.
inactive-css-column-span-fix-1 = Probearje <strong>column-count</strong> of <strong>column-width</strong> oan ien fan de foarrinnende eleminten ta te foegjen.
inactive-css-not-grid-or-flex-or-absolutely-positioned-item-fix-1 = Probearje <strong>position:absolute</strong> oan it elemint ta te foegjen, of <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong> of <strong>display:inline-flex</strong> oan it boppelizzende nivo fan it elemint.
inactive-css-not-grid-or-absolutely-positioned-item-fix-1 = Probearje <strong>position:absolute</strong> oan it elemint ta te foegjen, of <strong>display:grid</strong> of <strong>display:inline-grid</strong> oan it boppelizzende elemint.
inactive-css-not-absolutely-positioned-item-fix-1 = Probearje <strong>position:absolute</strong> oan it elemint ta te foegjen.
inactive-css-no-default-anchor-fix-1 = Probearje <strong>position-anchor</strong> mei in jildige ankernamme ta te foegjen.
...
inactive-css-not-block-container-fix-1 = Probearje <strong>display:block</strong>, <strong>display:inline-block</strong> of <strong>display:flow-root</strong> ta te foegjen.
inactive-css-not-block-flex-grid-container-fix-1 = Probearje <strong>display:block</strong>, <strong>display:inline-block</strong>, <strong>display:flex</strong>, <strong>display:inline-flex</strong>, <strong>display:grid</strong>, <strong>display:inline-grid</strong> of <strong>display:flow-root</strong> ta te foegjen.
inactive-css-not-floated-fix-1 = Probearje de eigenskip <strong>float</strong> ta te foegjen mei in oare wearde as <strong>none</strong>.
inactive-css-position-property-on-unpositioned-box-fix-1 = Probearje de eigenskip <strong>position</strong> op wat oars as <strong>static</strong> yn te stellen.
...
inactive-css-not-table-fix-1 = Probearje <strong>display:table</strong> of <strong>display:inline-table</strong> ta te foegjen.
...
css-selector-container-query-condition-no-container = Kontener ‘{ $name }’ net fûn
