...
share-panel-os-share =
    .label = Diele mei…
share-panel-mail =
    .label = E-mailberjocht ferstjoere
share-panel-screenshot =
    .label = In skermôfbylding meitsje
share-panel-qr-code-2 =
    .label = QR-koade meitsje
share-panel-qr-code =
    .label = QR-koade diele
