...
fxa-menu-sync-your-data = Jo gegevens syngronisearje
...
fxa-menu-sync-status-turn-on-button =
    .label = Ynskeakelje
fxa-menu-sync-status-turn-on-button-aria-label = Ynskeakelje
...
profiler-popup-presets-networking-description = Foarynstelling foar it ûndersykjen fan netwurkbugs yn { -brand-shorter-name }.
...
appmenuitem-share-firefox-title2 = { -brand-product-name } diele
