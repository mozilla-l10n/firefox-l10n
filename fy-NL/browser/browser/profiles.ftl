...
edit-profile-page-desktop-shortcut-toggle-2 =
    .label = Buroblêdfluchkeppeling meitsje
edit-profile-page-desktop-shortcut-header = Buroblêdfluchkeppeling meitsje
edit-profile-page-desktop-shortcut-toggle =
    .aria-label = Buroblêdfluchkeppeling meitsje
edit-profile-page-avatar-header-2 =
    .label = Avatar
edit-profile-page-delete-button =
    .label = Fuortsmite
edit-profile-page-avatar-selector-opener-button =
    .title = Avatar bewurkje
...
restored-profile-page-learn-more = Mear ynfo
...
# Variables
#   $profilename (String) - The name of the profile.
delete-profile-header-2 = Profyl ‘{ $profilename }’ fuortsmite?
...
multiprofile-data-collection-message = <strong>Ynstellingen foar gegevenssamling binne wizige.</strong> De wizigingen dy’t yn in oar profyl makke wurde, jilde foar alle profilen op dit apparaat.
# Primary button label to open the Data collection section in Settings
multiprofile-data-collection-view-settings = Ynstellingen besjen
# Secondary button label to dismiss the infobar without action
multiprofile-data-collection-dismiss = Slute
...
custom-avatar-crop-view =
    .aria-label = Ofbyldingswerjefte bysnije
custom-avatar-crop-area =
    .aria-label = Bysnijgebiet oanpasse
custom-avatar-drag-handle =
    .aria-label = Grutte fan bysnijgebiet wizigje
profiles-appmenu-callout-tour-title = Jo nije profyl is klear om te brûken
# "Spin up another" means creating another profile, “Hop between your digital lives" is referring to switching between different profiles such as work, personal, etc.
profiles-appmenu-callout-tour-subtitle = Tik yn it ☰-menu op jo profylnamme om in oare te iepenjen, dizze te bewurkjen of tusken jo digitale libbens te springen.
...
heart-rate-avatar-tooltip =
    .tooltiptext = Hertslachavatar tapasse
