...
containers-name-label2 =
    .label = Namme
    .placeholder = Foegje in namme ta
...
containers-site-invalid-error = Fier in jildige, befeilige website yn
# Shown below the website field when the typed website is already bound to a
# container.
containers-site-duplicate-error = Dizze website stiet al yn jo list

## Container creation panel, anchored to the URL bar.

containers-panel-title = Nije kontener tafoegje
