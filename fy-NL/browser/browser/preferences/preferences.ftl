...
pane-privacy-title2 = Privacy & Befeiliging
...
nimbus-rollouts-enabled =
    .label = { -brand-short-name } tastean om funksjes, prestaasjes en stabiliteit tusken fernijingen te ferbetterjen
nimbus-rollouts-enabled-description = Wizigingen wurde op ôfstân tapast.
...
preferences-etp-level-warning-message =
    ...
    .message = Guon websites bouwe trackers yn harren funksjes of ynhâld. Wannear { -brand-short-name } se blokkearret, sjocht de website er defekt út. Probearje ‘Websiteprobleem oplosse’ te brûken of beskerming tsjin folgjen foar dy website út te skeakeljen.
