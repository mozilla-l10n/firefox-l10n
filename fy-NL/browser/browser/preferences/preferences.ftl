...
tls-key-logging-notice-nav =
    .label = In app of tsjinst kin jo fersifere ferkear sjen.
category-list =
...
preferences-ai-controls-speech-recognition-control =
    .description = Spraak lokaal transkribearje.
    .label = Spraakwerkenning
preferences-ai-controls-sidebar-chatbot-group-3 =
    .description = Hâld in chatbot yn sicht wylst jo sneupe. Kies út meardere providers en wikselje op elk winske momint.
    .label = AI-chatbotsproviders yn de sydbalke
...
preferences-ai-controls-block-confirmation-speech-recognition = Spraakwerkenning
...
preferences-etp-custom-cookie-behavior-block-cross-site-tracking-cookies =
    .label = Cross-site-trackingcookies blokkearje
