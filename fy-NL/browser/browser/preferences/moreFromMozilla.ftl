...
more-from-moz-title2 = Mear fan { -vendor-short-name }
    .title = Mear fan { -vendor-short-name }
...
more-from-moz-mozilla-vpn-box-link =
    .label = { -mozilla-vpn-brand-name } downloade
more-from-moz-firefox-relay-box-link =
    .label = { -relay-brand-short-name } downloade
more-from-moz-mdn-box-link =
    .label = MDN benaderje
more-from-moz-thunderbird-box-link =
    .label = { -thunderbird-brand-short-name } downloade
more-from-moz-solo-box-link =
    .label = { -solo-ai-brand-name } probearje
more-from-moz-new-products-box-link =
    .label = Nije produkten besjen
