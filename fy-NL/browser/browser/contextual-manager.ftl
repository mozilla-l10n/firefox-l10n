...
contextual-manager-passwords-origin-field-description = Fier it krekte adres yn wêr’t jo jo op dizze website oanmelde sille.
contextual-manager-passwords-username-field =
    .label = Brûkersnamme
contextual-manager-passwords-username-field-description = Fier de brûkersnamme, it e-mailadres of it accountnûmer yn dat jo brûke om jo oan te melden.
contextual-manager-passwords-password-field =
    .label = Wachtwurd
contextual-manager-passwords-password-field-description = Fier it wachtwurd yn om jo oan te melden by dizze account.
