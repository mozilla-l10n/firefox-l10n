...
firefoxview-syncedtabs-synctabs-description-2 = Skeakelje syngronisaasje wer yn om al jo ljepblêden fan oare apparaten op te heljen.
...
firefoxview-tabpickup-network-offline-header-2 = { -brand-short-name } kin op dit stuit gjin ferbining meitsje
firefoxview-tabpickup-network-offline-description-2 = Mooglik binne jo offline, of eat blokkearret de ferbining.
...
firefoxview-tabpickup-sync-error-header-2 = Syngronisaasje rûn tsjin in probleem oan
firefoxview-tabpickup-generic-sync-error-description-2 = { -brand-short-name } kin gjin ferbining meitsje. Wachtsje efkes en probearje it dan opnij
