...
tab-devtools-splitter =
    .aria-label = Formaat fan it paniel Untwikkelersark wizigje
...
tab-group-editor-color-selector2-yellow = Giel
    .title = Giel
tab-group-editor-color-selector2-pink = Rôs
    .title = Rôs
...
tab-groups-list-title = Ljepblêdgroepen
...
tab-group-editor-action-copy-links =
    .label =
        { $linkCount ->
            [1] Keppeling yn groep kopiearje
            [one] Keppeling yn groep kopiearje
           *[other] { $linkCount } keppelingen yn groep kopiearje
        }
...
tabbrowser-tab-label-tab-split-view-left = { $label }, splitste werjefte links
# Split view tabs display their respective contents side by side
...
# Variables:
#   $label (String): the text label of the tab visible in the tab strip
tabbrowser-tab-label-tab-split-view-right = { $label }, splitste werjefte rjochts
