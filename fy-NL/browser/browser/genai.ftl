...
genai-settings-chat-lechat-links-2 = Troch Mistral Vibe te kiezen, geane jo akkoard mei de <a data-l10n-name="link1">Tsjinstbetingsten</a> en it <a data-l10n-name="link2">Privacybelied</a> fan Mistral AI.
...
genai-shortcut-search-button =
    .aria-label = Mei { $engine } sykje nei ‘{ $selection }’
    .tooltiptext = Mei { $engine } sykje nei ‘{ $selection }’
genai-shortcut-copy-button =
    .aria-label = Selektearre tekst kopiearje
    .tooltiptext = Selektearre tekst kopiearje
...
link-preview-first-time-setup-title = Earste ynstallaasje
# Message for the first-time setup modal
link-preview-first-time-setup-message = Dit kin in momint duorje. Jo sjogge de wichtichste punten de folgjende kear flugger.
