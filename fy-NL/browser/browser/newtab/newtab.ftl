...
newtab-wallpaper-hot-air-balloons = Hjitteluchtballonnen yn ferskate kleuren oerdeis
...
newtab-clock-widget-add-custom = ‘{ $city }’ as in oanpaste klok tafoegje
# Text field for the display name of a user-added custom clock.
newtab-clock-widget-custom-city-input =
    .label = Plaknamme
    .aria-label = Plaknamme
    .placeholder = Dizze klok in namme jaan
# Searchable time-zone field shown when adding a custom clock. The user
# types a city they know and picks it to set the clock's time zone.
newtab-clock-widget-custom-timezone-input =
    .label = Tiidsône
    .aria-label = Tiidsône
    .placeholder = Sykje op plak, tiidsône of UTC-ferskil
newtab-clock-widget-custom-zone-results =
    .aria-label = Tiidsôneresultaten
# Shown in the time-zone picker when the search matches no time zones.
newtab-clock-widget-custom-zone-no-results = Gjin oerienkommende tiidsônen
# Returns from the custom clock form back to the city search.
newtab-clock-widget-custom-back = Tebek
...
newtab-clock-city-de-berlin = Berlyn
newtab-clock-city-de-munich = München
newtab-clock-city-de-frankfurt = Frankfurt am Main
newtab-clock-city-de-hamburg = Hamburch
newtab-clock-city-fr-paris = Parys
...
newtab-clock-city-cn-shanghai = Sjanghai
...
newtab-clock-city-at-vienna = Wenen
newtab-clock-city-cz-prague = Praach
