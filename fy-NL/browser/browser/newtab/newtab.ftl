...
newtab-clock-city-de-hamburg = Hamboarch
...
newtab-clock-city-ca-vancouver = Fankoever
...
newtab-clock-city-hu-budapest = Bûdapest
...
newtab-clock-city-ro-bucharest = Bûkarest
...
newtab-clock-city-ke-nairobi = Nairoby
newtab-clock-city-nz-auckland = Auckland
newtab-clock-city-kr-seoul = Seoul
newtab-clock-city-lt-vilnius = Vilnjûs
