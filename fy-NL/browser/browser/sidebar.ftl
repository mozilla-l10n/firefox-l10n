...
sidebar-resize-splitter =
    .aria-label = Formaat sydbalke wizigje
...
sidebar-open-tools-from-sidebar =
    .label = Ark fan sydbalke út iepenje
...
sidebar-show-preview-on-hover =
    .label = Foarbyld toane by oanwizen
...
sidebar-opentabs-preview-heading = Resinte ljepblêden
...
sidebar-opentabs-title = Iepen ljeplêden
