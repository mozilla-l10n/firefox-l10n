...
confirmation-hint-passport-created = Paspoart bewarre
confirmation-hint-passport-updated = Paspoart bywurke
...
confirmation-hint-extensions-button-hidden = Ferpleatst nei menu
