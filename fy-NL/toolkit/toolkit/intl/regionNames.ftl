...
region-name-ba = Bosnië en Hertsegowina
...
region-name-bl = Sint Barthélemy
...
region-name-pg = Papoea-Nij-Guinea
region-name-ph = Filipinen
...
region-name-st = Sao Tomee en Prinsyp
...
region-name-vi = Maagdeneilannen, Amerikaanske
