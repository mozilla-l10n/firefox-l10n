...
set-password-new =
    .label = Nij wachtwurd ynfiere:
set-password-reenter =
    .label = Wachtwurd opnij ynfiere:
...
remove-primary-password-warning2 = As jo jo haadwachtwurd fuortsmite, wurde jo gegevens net mear beskerme as de kontrôle oer jo kompjûter oernommen wurdt.
remove-password-old =
    .label = Aktueel wachtwurd:
