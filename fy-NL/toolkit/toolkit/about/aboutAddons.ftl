...
recommended-theme-1 = Fiele jo jo kreatyf? <a data-l10n-name="link">Bou jo eigen tema mei Firefox Color.</a>
...
mlmodel-speech-recognition = { -brand-short-name } brûkt dit foar spraakwerkenning op apparaten
...
find-more-addons-promo =
    .heading = Foarmje { -brand-product-name } op jo manier
    .message = Foegje ark en stilen ta om oan jo behoeften en smaak te foldwaan.
find-more-addons-promo-open-amo-button = Utwreidingen en tema’s ferkenne
...
find-more-extensions-promo =
    .heading = Jo folgjende favorite útwreiding fine
