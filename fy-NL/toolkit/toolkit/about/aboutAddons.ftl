...
details-notification-softblocked-extension-disabled =
    .message = Dizze útwreiding skeint it belied fan Mozilla en is útskeakele. Jo kinne it ynskeakelje, mar dit kin gefaarlik wêze.
...
details-notification-softblocked-other-disabled =
    .message = Dizze add-on skeint it belied fan Mozilla en is útskeakele. Jo kinne it ynskeakelje, mar dit kin gefaarlik wêze.
