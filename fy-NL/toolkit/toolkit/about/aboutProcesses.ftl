...
about-processes-web-isolated-property-private = privee
about-processes-web-isolated-property-serviceworker = serviceworker
about-processes-web-isolated-property-jit-disabled = JIT útskeakele
about-processes-web-isolated-property-with-coop-coep = cross-origin isolearre
