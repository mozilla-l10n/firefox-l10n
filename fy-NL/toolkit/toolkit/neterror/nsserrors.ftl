...
ssl-error-rx-malformed-handshake = SSL ûntfong in ûnjildich Handshake-record.
...
ssl-error-socket-write-failure = Besykjen om fersifere gegevens nei ûnderlizzende socket te skriuwen mislearre.
...
sec-error-bad-signature = Sertifikaat fan peer hat in ûnjildige ûndertekening.
...
sec-error-crl-bad-signature = De CRL foar de sertifikaatútjouwer hat in ûnjildige ûndertekening.
...
sec-error-no-recipient-certs-query = Net fersifere: jo hawwe noch gjin sertifikaten foar elke ûntfanger.
...
sec-error-exporting-certificates = Flater by besykjen ta eksportearjen fan sertifikaten.
sec-error-importing-certificates = Flater by besykjen ta ymportearjen fan sertifikaten.
...
sec-error-pkcs12-unable-to-import-key = Kin net ymportearje. Flater by besykjen ta ymportearjen fan priveekaai.
sec-error-pkcs12-importing-cert-chain = Kin net ymportearje. Flater by besykjen ta ymportearjen fan sertifikaatketen.
...
sec-error-pkcs12-unable-to-read = Kin net ymportearje. Kin it ymportbestân net lêze.
...
sec-error-retry-old-password = Alde wachtwurd ferkeard ynfierd. Probearje it opnij.
...
sec-error-incompatible-pkcs11 = PKCS #11-stjoerprogramma skeint de spesifikaasje op in ynkompatibele manier.
...
sec-error-ocsp-responder-cert-invalid = Sertifikaat fan konfigurearre OCSP-responder is ûnjildich.
...
sec-error-crl-import-failed = Flater by besykjen CRL te ymportearjen.
...
xp-sec-fortezza-bad-card = Fortezza-kaart is net goed inisjalisearre. Smyt de kaart fuort en stjoer dizze nei jo útjouwer werom.
