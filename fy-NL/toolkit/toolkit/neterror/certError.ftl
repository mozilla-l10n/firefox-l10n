...
cert-error-intro = { $hostname } brûkt in ûnjildich befeiligingssertifikaat.
...
cert-error-mitm-connection = { -brand-short-name } brûkt it CA-argyf fan Mozilla om te ferifiearjen dat in ferbining befeilige is yn stee fan sertifikaten dy’t troch it bestjoeringssysteem fan de brûker levere wurde. As in antifirusprogramma of in netwurk dus in ferbining ûnderskept mei in troch in CA útjûn befeiligingssertifikaat dat net yn it CA-argyf fan Mozilla stiet, wurdt de ferbining as ûnfeilich beskôge.
...
fp-certerror-revoked-why-dangerous-body = { -brand-short-name } warskôget jo foar dizze website, omdat it sertifikaat levere foar { $hostname } ynlutsen is en net mear fertroud wurdt.
# This string appears after the following string: "What can you do about it?" (fp-certerror-what-can-you-do)
fp-certerror-revoked-what-can-you-do-body = Wierskynlik neat, omdat der wierskynlik in probleem is mei de website sels. Jo kinne kontakt opnimme mei de eigener fan de website om te sjen oft se oan it probleem wurkje.
# This string appears after the following string: "What makes the site look dangerous?" (fp-certerror-why-site-dangerous)
# Variables:
#   $hostname (String) - Hostname of the website to which the user was trying to connect.
...
# Variables:
#   $hostname (String) - Hostname of the website to which the user was trying to connect.
fp-certerror-invalid-cert-why-dangerous = De eigener fan { $hostname } hat dizze net goed ynsteld en der kin gjin feilige ferbining makke wurde.
# Variables:
#   $hostname (String) - Hostname of the website to which the user was trying to connect.
#   $now (Date) - The current datetime, to be formatted as a date
fp-certerror-clock-skew-intro = Jo kompjûter tinkt dat it { DATETIME($now, dateStyle: "medium") } is, wêrtroch { -brand-short-name } gjin befeilige ferbining mei <strong>{ $hostname }</strong> meitsje kin. Stel jo kompjûterklok yn nei de aktuele datum, tiid en tiidsône yn jo systeemynstellingen, en fernij dêrnei de side.
# This string appears after the following string: "What can you do about it?" (fp-certerror-what-can-you-do)
# Variables:
#   $now (Date) - The current datetime, to be formatted as a date
fp-certerror-clock-skew-what-can-you-do-body = Wurkje jo kompjûterklok yn jo systeemynstellingen by nei de aktuele datum, tiid en tiidsône. Jo kompjûter tinkt dat it { DATETIME($now, dateStyle: "medium") } is.
