...
protocolhandler-mailto-os-handler-notificationbox = Электрондық поштаны жіберетін сілтемелерді ашу үшін әрқашан { -brand-short-name } пайдалану керек пе?
protocolhandler-mailto-os-handler-yes-confirm = { -brand-short-name } енді электрондық поштаны жіберетін сілтемелерді ашуға арналған үнсіз келісім бойынша қолданбаңыз болып табылады.
protocolhandler-mailto-os-handler-yes-button = Үнсіз келісім ретінде орнату
protocolhandler-mailto-os-handler-no-button = Қазір емес
