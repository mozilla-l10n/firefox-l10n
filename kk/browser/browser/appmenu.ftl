...
appmenu-nova-update-title = { -brand-short-name } жаңарту үшін қайта іске қосу
appmenu-nova-update-description = Сіздің беттеріңіз қайта ашылады.
...
fxa-menu-sync-status-on = Синхрондау іске қосулы
fxa-menu-sync-status-off = Синхрондау сөндірулі тұр
# Shown in place of "Sync is Off" on the sync status button when the user has
# never signed in. Sync is a verb, short for synchronize.
fxa-menu-sync-your-data = Деректеріңізді синхрондаңыз
# Shown as a secondary label under "Sync is Off" when the user is signed in but
# sync is turned off.
fxa-menu-sync-off-data-description = Деректеріңіз синхрондалмайды
# Button shown next to "Sync is Off" when the user is signed in but sync is
# turned off. Turns syncing on by opening sync preferences.
fxa-menu-sync-status-turn-on-button =
    .label = Іске қосу
fxa-menu-sync-status-turn-on-button-aria-label = Іске қосу
# Shown as a secondary label under "Sync is Off" when the user needs to sign in
# (again) for sync to work.
fxa-menu-sync-off-signin-description = Синхрондау үшін кіріңіз
# Sync is a verb, short for synchronize.
# Variables:
#   $deviceName (String): The name of the local device.
fxa-menu-sync-device-now = { $deviceName } қазір синхрондау
fxa-menu-manage-sync-settings =
    .label = Синхрондау баптауларын басқару
fxa-menu-add-device =
    .label = Құрылғыны қосу
fxa-menu-manage-devices =
    .label = Құрылғыларыңызды басқару
...
appmenu-fxa-sign-in-promo-heading2 = Деректеріңізді барлық жерде синхрондаңыз
appmenu-fxa-sign-in-promo-link = Кіру
appmenu-fxa-sign-in-promo-dismiss-button =
    .aria-label = Кіру жарнамасын жабу
    .title = Елемеу
# Sign-in promo shown in the app menu when signed out and no menu message or
...
appmenu-sync-promo-signin =
    .heading = Құрылғылар арасында синхрондалған күйде болу
appmenu-sync-promo-signin-cta = Кіру
appmenu-sync-promo-turnonsync =
    .heading = Беттер мен тарихыңызды синхрондаңыз
appmenu-sync-promo-turnonsync-cta = Синхрондауды іске қосу
# This refers to getting tabs from your mobile device via sync
appmenu-sync-promo-connectdevice =
    .heading = Мобильді беттеріңізді алыңыз
appmenu-sync-promo-connectdevice-cta = Құрылғыны байланыстыру
appmenu-bookmarks-sync-promo-turnonsync =
    .heading = Бетбелгілеріңізді өзіңізбен бірге алып жүріңіз
# This refers to having your bookmarks available on your mobile device via sync
appmenu-bookmarks-sync-promo-connectdevice =
    .heading = Бетбелгілеріңізді алып жүріңіз
...
fxa-menu-create-profile-heading = Шолу деңгейіңізді жаңа профильмен жақсартыңыз
fxa-menu-create-profile-description = Жұмыс және жеке шолу үшін бетбелгілер, парольдер және тарихыңызды бөлек сақтаңыз.
fxa-menu-create-profile-confirm =
    .label = Жаңа профильді жасау
fxa-menu-create-profile-learn-more =
    .label = Профильдер дегеніміз не?
# Button in the account menu that links to the Referrals page
appmenuitem-share-firefox-title2 = { -brand-product-name } бөлісу
