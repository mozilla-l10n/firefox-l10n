...
policy-CNSA2KeyAgreementEnabled = TLS үшін CNSA 2.0 ML-KEM-1024 кілт келісімін іске қосу.
...
policy-DefaultBrowserSettingEnabled = Пайдаланушының { -brand-short-name } браузерін негізгі браузер ретінде орнату мүмкіндігін басқарады.
