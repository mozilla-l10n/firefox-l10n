...
more-from-moz-firefox-relay-description = Кіріс жәшігіңізді және жеке басыңызды тегін электрондық пошта маскасымен қорғаңыз.
...
more-from-moz-new-products-card =
    ...
    .description = { -vendor-short-name } ұсынған соңғы өнімдерді зерттеңіз.
more-from-moz-mozilla-monitor-box-link =
    .label = { -monitor-brand-short-name } алу
more-from-moz-mozilla-vpn-box-link =
    .label = { -mozilla-vpn-brand-name } алу
more-from-moz-firefox-relay-box-link =
    .label = { -relay-brand-short-name } алу
