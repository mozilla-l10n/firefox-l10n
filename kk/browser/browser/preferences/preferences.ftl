...
tls-key-logging-notice-nav =
    .label = Қолданба немесе қызмет сіздің шифрленген трафигіңізді көруі мүмкін.
category-list =
    .aria-label = Санаттар
...
containers-external-links-check =
    .label = Сыртқы қолданбалардан ашылған сілтемелер үшін контейнерлерді қолданбау
    .accesskey = С
...
preferences-ai-controls-speech-recognition-control =
    .description = Сөйлеуді жергілікті жерде транскрипциялау.
    .label = Сөйлеуді тану
preferences-ai-controls-sidebar-chatbot-group-3 =
    .description = Шолу кезінде чатботты көрсетіп тұру. Бірнеше провайдердің ішінен таңдап, кез келген уақытта ауысыңыз.
    .label = Бүйірлік панельдегі ЖИ чатбот провайдерлері
preferences-ai-controls-sidebar-chatbot-group-2 =
    .description = Веб-беттерді шолу барысында чат-ботты әрдайым көз алдыңызда ұстаңыз. Anthropic Claude, ChatGPT, Copilot, Google Gemini және Mistral Vibe ішінен қалауыңызды таңдаңыз.
    .label = Бүйірлік панельдегі ЖИ чатбот провайдерлері
...
preferences-ai-controls-block-confirmation-speech-recognition = Сөйлеуді тану
...
preferences-etp-tracker-count-enabled =
    .label = Блокталған трекерлерді адрестік жолағында көрсету
...
preferences-etp-custom-cookie-behavior-block-cross-site-tracking-cookies =
    .label = Сайтаралық бақылау cookie файлдарын бұғаттау
...
security-privacy-issue-warning-doh2 =
    .description = HTTPS арқылы DNS желілік провайдеріңізден қай сайттарға кіргелі жатқаныңызды жасыруға көмектеседі.
    .label = HTTPS арқылы DNS сөндірілген
security-privacy-issue-warning-ech2 =
    .description = Шифрленген клиенттік сәлемдесу желілік провайдеріңізден қай сайттарға кіргелі жатқаныңызды жасыруға көмектеседі.
