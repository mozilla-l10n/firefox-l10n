...
newtab-privacy-empty-state-tally = Жалпы қорытындыны мына жерден қараңыз.

## Privacy widget — Enhanced Tracking Protection off state

# Shown when the user has turned off the Enhanced Tracking Protection setting.
newtab-privacy-etp-off-faster-browsing = Жылдамырақ шолу. Азырақ трекерлер.
newtab-privacy-etp-off-turn-on-tracking = Блоктауды бастау үшін баптауларда бақылау қорғанысын іске қосыңыз.
...
newtab-stocks-list-markets = Нарықтар
    .label = Нарықтар
...
newtab-stocks-list-watchlist = Бақылау тізімі
...
newtab-stocks-add-to-watchlist =
    .aria-label = { $name } бақылау тізіміне қосу
    .title = { $name } бақылау тізіміне қосу
# Tooltip and screen-reader label for the button that removes a stock from the watchlist.
# The button shows only an icon and never renders visible text.
# Variables:
#   $name (String) - the fund/ETF name.
newtab-stocks-remove-from-watchlist =
    .aria-label = { $name } бақылау тізімінен өшіру
    .title = { $name } бақылау тізімінен өшіру
...
# Variables:
#   $name (String) - the fund/ETF name.
newtab-stocks-in-watchlist = { $name } сіздің бақылау тізіміңізде
# Announced to screen readers after a stock is added to the watchlist.
# Variables:
#   $name (String) - the fund/ETF name.
newtab-stocks-added-to-watchlist = { $name } бақылау тізіміне қосылды
# Announced to screen readers after a stock is removed from the watchlist.
# Variables:
#   $name (String) - the fund/ETF name.
newtab-stocks-removed-from-watchlist = { $name } бақылау тізімінен өшірілді
...
newtab-spaces-tab-stories = Әңгімелер
newtab-spaces-tab-widgets = Виджеттер
newtab-spaces-tab-activity = Белсенділік
...
newtab-carousel-pause =
    .aria-label = Автоматты ойнатуды кідірту
...
newtab-customize-panel-back-button =
    ...
    .title = Баптауларға оралу

## New Tab Appearance (browser theme picker)

# Title of the browser theme ("Appearance") section in the customize panel.
newtab-custom-appearance-section-title = Сыртқы түрі
# Button that opens the full browser theme selection view.
newtab-appearance-more-themes-button =
    .label = Көбірек темаларды қарау
# Title of the full theme selection sub-panel, also used as its back button label.
newtab-appearance-manage-title = { -brand-product-name } темалары
# Header for the list of the user's already-installed themes in the full theme panel.
newtab-appearance-your-themes-header = Сіздің темаларыңыз
...
newtab-appearance-explore-more-themes-button = Көбірек темаларды шолу
...
newtab-topic-navigation-label =
    .aria-label = Тақырыптар
# Opens a menu listing the topics that did not fit in the row.
newtab-topic-navigation-more-button = Көбірек
...
newtab-widget-section-show-widgets =
    .aria-label = Виджеттер бөлімін көрсету
    .title = Виджеттерді көрсету
...
newtab-clock-city-us-los-angeles = Лос Анжелес
newtab-clock-city-us-chicago = Чикаго
newtab-clock-city-us-san-francisco = Сан Франсиско
...
newtab-clock-city-de-frankfurt = Майндағы Франкфурт
...
newtab-clock-city-ru-moscow = Мәскеу
...
newtab-clock-city-gr-athens = Афина
...
newtab-clock-city-tr-istanbul = Ыстанбұл
