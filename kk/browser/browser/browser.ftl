...
#                    "11 months ago"
urlbar-result-explanation-last-visited-days-weeks-months-ago = Соңғы рет кірген: { $date }
# This explanation is used when the last-visited date is further in the past.
# The date will be formatted as an absolute date like: "11 May", "11 May 2026"
# Variables:
#   $date (string) - A localized absolute date string
...
urlbar-searchmode-bookmarks4 = Бетбелгілер
urlbar-searchmode-tabs4 = Беттер
urlbar-searchmode-history4 = Тарих
urlbar-searchmode-actions4 = Әрекеттер
urlbar-searchmode-bookmarks3 = Бетбелгілер
    .accesskey = Б
urlbar-searchmode-tabs3 = Беттер
    .accesskey = р
...
urlbar-searchmode-popup-search-settings2 = Іздеу баптаулары
urlbar-searchmode-popup-settings2 = Баптаулар
...
urlbar-trust-icon-trackers-blocked-longform-label =
    { $count ->
        [one] { $count } трекер блокталды
       *[other] { $count } трекер блокталды
    }
