...
safeb-blocked-addon-page-title = Бұл сайт сіздің қауіпсіздігіңіз үшін бұғатталған
...
safeb-blocked-addon-page-short-desc = { -brand-short-name } бұл бетті бұғаттады, себебі қосымшаларыңыздың бірі оны ашуға әрекеттенді. Бұл сайт құпия ақпаратты — мысалы, парольдер немесе несие карталарының нөмірлерін ұрлау үшін пайдаланылуы мүмкін.
# Variables:
...
safeb-blocked-addon-page-learn-more3 = <a data-l10n-name='firefox_support_harmful_addons'>{ -brand-short-name } бағдарламасының зиянды қосымшалардан қорғау функциясы туралы көбірек біліңіз</a>.
