...
details-notification-softblocked-extension-disabled =
    .message = Бұл кеңейтуMozilla саясаттарын бұзады және сөндірілді. Оны іске қосуға болады, бірақ бұл қауіпті болуы мүмкін.
...
details-notification-softblocked-other-disabled =
    .message = Бұл қосымша Mozilla саясаттарын бұзады және сөндірілді. Оны іске қосуға болады, бірақ бұл қауіпті болуы мүмкін.
