...
pictureinpicture-playback-rate-panel-accessible = Ойнату жылдамдығының баптаулары
pictureinpicture-playback-rate-label = Ойнату жылдамдығы
