...
fp-certerror-transparency-intro = Біреу өзін { $hostname } ретінде көрсетіп, несие картасының деректері, парольдер немесе электрондық пошта сияқты ақпаратты ұрлауға әрекет жасауы мүмкін.
