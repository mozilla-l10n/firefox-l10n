...
pdfjs-views-manager-paste-button-after-label = { $page } бетінен кейін кірістіру
pdfjs-views-manager-paste-button-before-label = Бірінші беттің алдына кірістіру
