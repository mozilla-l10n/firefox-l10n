...
serviceworker-worker-updated = Жаңартылған <time>{ DATETIME($date, day: "numeric", hour: "numeric", minute: "numeric", month: "long", second: "numeric", year: "numeric") }</time>
...
session-history-navigate-button-title = Сеанс тарихындағы { $index } жазбасына өту
