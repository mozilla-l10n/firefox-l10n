...
colorpicker-tooltip-eyedropper-title = Беттегі түсті таңдау
...
colorpicker-tooltip-color-name-title = Жақын элементі: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Реңі
...
inspector-split-orientation-side-by-side = Қатарынан
# A label for the split orientation menu item that locks the panels on top of
# each other.
inspector-split-orientation-stacked = Қабатталған
