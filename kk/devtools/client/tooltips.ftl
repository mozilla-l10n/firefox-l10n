...
inactive-css-not-grid-or-flex-or-absolutely-positioned-item = <strong>{ $property }</strong> осы элементке әсер етпейді, өйткені ол grid немесе flex элементі емес және абсолютті орналастырылған емес.
inactive-css-not-grid-or-absolutely-positioned-item = <strong>{ $property }</strong> осы элементке әсер етпейді, өйткені ол grid элементі емес және абсолютті орналастырылған емес.
inactive-css-not-absolutely-positioned-item = <strong>{ $property }</strong> бұл элементке әсер етпейді, өйткені ол орны абсолютті бекітілген элементі емес.
inactive-css-no-default-anchor = <strong>{ $property }</strong> бұл элементке әсер етпейді, өйткені оның негізгі зәкір элементі жоқ.
...
inactive-css-not-block-container = <strong>{ $property }</strong> бұл элементке әсер етпейді, өйткені ол тек блоктық контейнер элементтері үшін іске асырылуы мүмкін.
inactive-css-not-block-flex-grid-container = <strong>{ $property }</strong> осы элементке әсер етпейді, өйткені ол тек block, flex және grid контейнер элементтерінде қолданылады.
...
inactive-css-no-size-containment = <strong>{ $property }</strong> осы элементке әсер етпейді, өйткені оның өлшемдерін қамтитын шектеу жоқ.
...
inactive-css-not-absolutely-positioned-item-fix = Элементке <strong>position:absolute</strong> қосып көріңіз. { learn-more }
inactive-css-no-default-anchor-fix = Жарамды зәкір атауымен бірге <strong>position-anchor</strong> қосып көріңіз. { learn-more }
