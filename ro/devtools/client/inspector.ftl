...
colorpicker-tooltip-spectrum-dragger-title = Spectru
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = Alege culoarea de pe pagină
...
colorpicker-tooltip-color-name-title = Cea mai apropiată de: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Tentă
...
inspector-split-orientation-button-title = Dispunerea panourilor
...
inspector-split-orientation-side-by-side = Unul lângă altul
# A label for the split orientation menu item that locks the panels on top of
# each other.
inspector-split-orientation-stacked = Suprapuse
