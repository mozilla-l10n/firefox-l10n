...
devtools-tooltip-learn-more = Află mai multe
...
inactive-css-not-absolutely-positioned-item = <strong>{ $property }</strong>nu are niciun efect asupra acestui element pentru că nu este element poziționat absolut.
inactive-css-no-default-anchor = <strong>{ $property }</strong> nu are niciun efect asupra acestui element pentru că nu are un element de ancorare implicit.
...
inactive-css-not-block-flex-grid-container = <strong>{ $property }</strong> nu are niciun efect asupra acestui element pentru că se aplică numai la elemente de container în bloc, flex și de grilă.
...
inactive-css-not-absolutely-positioned-item-fix = Încearcă să adaugi <strong>position:absolute</strong> la element. { learn-more }
inactive-css-no-default-anchor-fix = Încearcă să adaugi <strong>position-anchor</strong> cu o denumire validă a ancorei. { learn-more }
...
inactive-css-not-block-flex-grid-container-fix = Încearcă să adaugi <strong>display:block</strong>, <strong>display:inline-block</strong>, <strong>display:flex</strong>, <strong>display:inline-flex</strong>, <strong>display:grid</strong>, <strong>display:inline-grid</strong> sau <strong>display:flow-root</strong>. { learn-more }
...
inactive-css-not-grid-or-flex-container-fix-1 = Încearcă să adaugi <strong>display:grid</strong> sau <strong>display:flex</strong>.
inactive-css-not-grid-or-flex-or-block-container-fix-1 = Încearcă să adaugi <strong>display:grid</strong>, <strong>display:flex</strong> sau <strong>display:block</strong>.
inactive-css-not-grid-or-flex-container-or-multicol-container-fix-1 = Încearcă să adaugi <strong>display:grid</strong>, <strong>display:flex</strong> sau <strong>columns:2</strong>.
inactive-css-not-multicol-container-fix-1 = Încearcă să adaugi ori <strong>column-count</strong>, ori <strong>column-width</strong>.
inactive-css-column-span-fix-1 = Încearcă să adaugi <strong>column-count</strong> sau <strong>column-width</strong> la unul dintre elementele-părinte.
inactive-css-not-grid-or-flex-or-absolutely-positioned-item-fix-1 = Încearcă să adaugi <strong>position:absolute</strong> la element sau <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong> sau <strong>display:inline-flex</strong> la părintele elementului.
inactive-css-not-grid-or-absolutely-positioned-item-fix-1 = Încearcă să adaugi <strong>position:absolute</strong> la element sau <strong>display:grid</strong> sau<strong>display:inline-grid</strong> la părintele elementului.
inactive-css-not-absolutely-positioned-item-fix-1 = Încearcă să adaugi <strong>position:absolute</strong> la element.
inactive-css-no-default-anchor-fix-1 = Încearcă să adaugi <strong>position-anchor</strong> cu o denumire validă a ancorei.
inactive-css-not-grid-or-flex-item-fix-4 = Încearcă să adaugi <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong> sau <strong>display:inline-flex</strong> la părintele elementului.
inactive-css-not-grid-item-fix-3 = Încearcă să adaugi <strong>display:grid</strong> or <strong>display:inline-grid</strong> la părintele elementului.
inactive-css-not-grid-container-fix-1 = Încearcă să adaugi <strong>display:grid</strong> sau <strong>display:inline-grid</strong>.
inactive-css-not-flex-item-fix-3 = Încearcă să adaugi <strong>display:flex</strong> sau <strong>display:inline-flex</strong> la părintele elementului.
inactive-css-not-flex-container-fix-1 = Încearcă să adaugi <strong>display:flex</strong> sau <strong>display:inline-flex</strong>.
inactive-css-not-inline-or-tablecell-fix-1 = Încearcă să adaugi <strong>display:inline</strong> sau <strong>display:table-cell</strong>.
...
inactive-css-only-non-grid-or-flex-item-fix-1 = Încearcă să modifici valoarea <strong>display</strong> containerului elementului în altceva decât  <strong>flex</strong>, <strong>grid</strong>, <strong>inline-flex</strong> sau <strong>inline-grid</strong> ori eliminând <strong>float</strong>.
inactive-css-not-block-fix-1 = Încearcă să adaugi proprietăți precum <strong>display:block</strong> sau <strong>float:left</strong>.
inactive-css-not-block-container-fix-1 = Încearcă să adaugi <strong>display:block</strong>, <strong>display:inline-block</strong> sau <strong>display:flow-root</strong>.
inactive-css-not-block-flex-grid-container-fix-1 = Încearcă să adaugi <strong>display:block</strong>, <strong>display:inline-block</strong>, <strong>display:flex</strong>, <strong>display:inline-flex</strong>, <strong>display:grid</strong>, <strong>display:inline-grid</strong> sau <strong>display:flow-root</strong>.
inactive-css-not-floated-fix-1 = Încearcă să adaugi proprietatea <strong>float</strong> cu o valoare diferită de <strong>none</strong>.
inactive-css-position-property-on-unpositioned-box-fix-1 = Încearcă să îi setezi proprietatea <strong>poziție</strong> pe altceva decât <strong>static</strong>.
inactive-css-only-replaced-elements-fix-1 = Asigură-te că adaugi proprietatea la un element înlocuit.
inactive-text-overflow-when-no-overflow-fix-1 = Încearcă să adaugi <strong>overflow:hidden</strong>.
inactive-css-no-size-containment-fix-1 = Încearcă să-i setezi proprietatea <strong>display</strong> în altceva decât <strong>none</strong>, <strong>contents</strong>, <strong>table</strong> sau <strong>inline-table</strong> și asigură-te că nu e într-un tabel sau într-un segment ruby.
inactive-css-not-for-internal-table-elements-fix-1 = Încearcă să-i setezi proprietatea <strong>display</strong> în altceva decât <strong>table-cell</strong>, <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong> sau <strong>table-footer-group</strong>.
inactive-css-not-for-internal-table-elements-except-table-cells-fix-1 = Încearcă să-i setezi proprietatea <strong>display</strong> în altceva decât <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong> sau <strong>table-footer-group</strong>.
inactive-css-not-table-fix-1 = Încearcă să adaugi <strong>display:table</strong> sau <strong>display:inline-table</strong>.
inactive-css-collapsed-table-borders-fix-1 = Încearcă să adaugi <strong>border-collapse:separate</strong>.
inactive-css-not-table-cell-fix-1 = Încearcă să adaugi <strong>display:table-cell</strong>.
inactive-scroll-padding-when-not-scroll-container-fix-1 = Încearcă să adaugi <strong>overflow:auto</strong>, <strong>overflow:scroll</strong> sau <strong>overflow:hidden</strong>.
inactive-css-border-image-fix-1 = În elementul-părinte din tabel, elimină proprietatea sau modifică valoarea <strong>border-collapse</strong> în alta decât <strong>collapse</strong>.
inactive-css-resize-fix-1 = Încearcă să setezi <strong>overflow</strong> la altă valoare decât <strong>visible</strong> sau ca să țintească un element înlocuit care acceptă valoarea respectivă.
inactive-css-ruby-element-fix-1 = Încearcă să modifici <strong>font-size</strong> pentru textul ruby.
inactive-css-text-wrap-balance-lines-exceeded-fix-1 = Încercați să reduceți numărul de rânduri.
inactive-css-text-wrap-balance-fragmented-fix-1 = Evită fragmentarea conținutului elementului, de ex. prin eliminarea coloanelor sau folosind <strong>page-break-inside:avoid</strong>.
inactive-css-no-principal-box-fix-1 = Încearcă să adaugi o valoare de <strong>display</strong>, care creează o cutie principală, cum ar fi <strong>block</strong>, <strong>inline-block</strong>, <strong>flex</strong> sau <strong>grid</strong>.
...
css-selector-container-query-condition-no-container = Nu s-a găsit niciun container { $name }
