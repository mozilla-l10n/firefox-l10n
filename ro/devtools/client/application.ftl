...
serviceworker-worker-updated = Actualizat <time>{ DATETIME($date, day: "numeric", hour: "numeric", minute: "numeric", month: "long", second: "numeric", year: "numeric") }</time>
...
session-history-navigate-button-title = Navighează în istoricul sesiunilor la intrarea { $index }
