...
contextual-manager-passwords-export-os-auth-dialog-message-win = Pentru a exporta parolele, introdu credențialele în Windows. Acest lucru ajută la protejarea securității conturilor tale.
...
contextual-manager-passwords-reveal-password-os-auth-dialog-message-win = Pentru a vedea parola, introdu credențialele în Windows. Acest lucru ajută la protejarea securității conturilor tale.
...
contextual-manager-passwords-edit-password-os-auth-dialog-message-win = Pentru a edita parola, introdu credențialele în Windows. Acest lucru ajută la protejarea securității conturilor tale.
# The MacOS string is preceded by the operating system with "Firefox is trying to ".
...
contextual-manager-passwords-copy-password-os-auth-dialog-message-win = Pentru a copia parola, introdu credențialele în Windows. Acest lucru ajută la protejarea securității conturilor tale.
# The MacOS string is preceded by the operating system with "Firefox is trying to ".
# Only provide the reason that account verification is needed. Do not put a complete sentence here.
