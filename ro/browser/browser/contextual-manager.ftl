...
contextual-manager-passwords-export-os-auth-dialog-message-win = Pentru exportul parolelor, introdu datele de autentificare în Windows. Te ajută la protejarea securității conturilor.
...
contextual-manager-passwords-reveal-password-os-auth-dialog-message-win = Pentru a vedea parola, introdu datele de autentificare în Windows. Te ajută la protejarea securității conturilor.
...
contextual-manager-passwords-edit-password-os-auth-dialog-message-win = Pentru editarea parolei, introdu datele de autentificare în Windows. Te ajută la protejarea securității conturilor.
# The MacOS string is preceded by the operating system with "Firefox is trying to ".
...
contextual-manager-passwords-copy-password-os-auth-dialog-message-win = Pentru copierea parolei, introdu datele de autentificare în Windows. Te ajută la protejarea securității conturilor.
# The MacOS string is preceded by the operating system with "Firefox is trying to ".
# Only provide the reason that account verification is needed. Do not put a complete sentence here.
...
contextual-manager-passwords-origin-field =
    .label = Adresa site-ului web
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Introdu adresa exactă de la unde te vei autentifica pe acest site.
contextual-manager-passwords-username-field =
    .label = Nume de utilizator
contextual-manager-passwords-username-field-description = Introdu numele de utilizator, adresa de e-mail sau numărul de cont pe care îl/o utilizezi pentru autentificare.
contextual-manager-passwords-password-field =
    .label = Parolă
contextual-manager-passwords-password-field-description = Introdu parola ca să intri în cont.
