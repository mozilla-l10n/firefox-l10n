...
upgrade-dialog-new-item-menu-title = Bara de unelte și meniurile simplificate
...
upgrade-dialog-new-primary-pin-button = Fixează { -brand-short-name } în bara mea de activități
