...
sidebar-opentabs-preview-heading = File recente
...
sidebar-opentabs-current-window-header =
    .heading = Fereastra { $winID } (actuală)
...
sidebar-pins-promo-text = Trage filele importante aici ca să le ai la îndemână
