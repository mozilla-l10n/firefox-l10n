...
connection-proxy-option-wpad =
    .label = Folosește setarea sistemului de descoperire automată a proxyului web
    .accesskey = g
...
connection-proxy-autologin =
    ...
    .accesskey = i
    .tooltip = Această opțiune te autentifică silențios la proxyurile pentru care ai date de autentificare salvate. Dacă eșuează, ți se vor cere datele de autentificare.
connection-proxy-autologin-checkbox =
    .label = Nu solicita autentificarea dacă parola este salvată
    .accesskey = i
    .tooltiptext = Această opțiune te autentifică silențios la proxyurile pentru care ai date de autentificare salvate. Dacă eșuează, ți se vor cere datele de autentificare.
