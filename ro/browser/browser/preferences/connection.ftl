...
connection-proxy-autologin =
    ...
    .accesskey = i
    .tooltip = Această opțiune te autentifică silențios la proxyurile pentru care ai credențiale salvate. Îți va fi solicitată autentificarea dacă aceasta eșuează.
