...
appearance-browser-icon-entry-group =
    .label = Pictogramă browser
    .description = Alege o pictogramă personalizată pentru bara de sarcini, desktop și meniul de pornire.
appearance-browser-icon-button =
    .label = Schimbă pictograma browserului
...
appearance-browser-icon-pin-button =
    .label = Fixează în bara de sarcini
...
appearance-browser-icon-momo =
    .label = Momo
    .description = Creat de @heyheymomodraws
