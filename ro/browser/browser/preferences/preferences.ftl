...
update-application-manual =
    ...
    .accesskey = N
update-application-warning-cross-user-setting = Setarea se aplică pentru toate conturile Windows și profilele { -brand-short-name } care folosesc această instalare de { -brand-short-name }.
