...
monitor-sign-up-link = Înscrie-te pentru alerte privind încălcări ale securității datelor
    .title = Înscrie-te pentru alerte privind încălcări ale securității datelor pe { -monitor-brand-name }
