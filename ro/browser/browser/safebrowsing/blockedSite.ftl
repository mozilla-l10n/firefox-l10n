...
safeb-blocked-addon-page-learn-more3 = <a data-l10n-name='firefox_support_harmful_addons'>Află mai multe despre Protecția împotriva suplimentelor dăunătoare din { -brand-short-name }</a>.
