...
safeb-blocked-phishing-page-title = Urmează un site înșelător
...
safeb-blocked-malware-page-error-desc-override = <span data-l10n-name='sitename'>{ $sitename }</span> a fost <a data-l10n-name='error_desc_link'>raportat ca având programe rău intenționate</a>. Poți <a data-l10n-name='report_detection'>raporta o problemă de detectare</a> sau <a data-l10n-name='ignore_warning_link'>ignoră riscul</a> și mergi pe acest site nesigur.
safeb-blocked-malware-page-error-desc-no-override = <span data-l10n-name='sitename'>{ $sitename }</span> a fost <a data-l10n-name='error_desc_link'>raportat ca având conținut de programe rău intenționate</a>. Poți <a data-l10n-name='report_detection'>să raportezi o problemă de detectare</a>.
safeb-blocked-malware-page-learn-more = Află mai multe despre conținuturi web dăunătoare, inclusiv viruși și alte programe rău intenționate și despre cum să îți protejezi calculatorul la <a data-l10n-name='learn_more_link'>StopBadware.org</a>. Află mai multe despre protecția împotriva furtului de date prin e-mail și a programelor rău intenționate în { -brand-short-name } la <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
