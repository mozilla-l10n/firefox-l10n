...
firefoxview-tabpickup-sync-disconnected-primarybutton = Pornește sincronizarea în setări
firefoxview-tabpickup-password-locked-header = Introdu parola primară ca să vezi filele
firefoxview-tabpickup-password-locked-description = Pentru a-ți prelua filele, va trebui să introduci parola primară pentru { -brand-short-name }.
...
firefoxview-recently-closed-nav = File închise recent
    .title = File închise recent
firefoxview-recently-closed-header = File închise recent

## Tabs from other devices refers in this context refers to synced tabs from other devices

firefoxview-synced-tabs-nav = File de pe alte dispozitive
...
firefoxview-search-text-box-recentlyclosed =
    .placeholder = Caută în filele închise recent
...
firefoxview-recentlyclosed-empty-header = Ai închis o filă prea devreme?
firefoxview-recentlyclosed-empty-description = Aici îți vei găsi toate filele închise recent ca să le poți redeschide cât mai repede.
firefoxview-recentlyclosed-empty-description-two = Pentru file mai vechi, intră în <a data-l10n-name="history-url">istoricul de navigare</a>.

## This message is displayed below the name of another connected device when it doesn't have any open tabs.

firefoxview-syncedtabs-device-notabs = Nicio filă deschisă pe acest dispozitiv
firefoxview-syncedtabs-connect-another-device = Conectează alt dispozitiv
...
firefoxview-opentabs-pinned-tab =
    .title = Treci la { $tabTitle }
# This tooltip will be shown for a pinned tab whose URL is currently bookmarked.
firefoxview-opentabs-bookmarked-pinned-tab =
    .title = Treci la { $tabTitle } (marcat)
