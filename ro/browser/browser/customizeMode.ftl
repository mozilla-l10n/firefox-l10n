...
customize-mode-uidensity-menu-compact-unsupported =
    .label = Compact (neacceptat)
    .accesskey = C
    .tooltiptext = Compact (neacceptat)
customize-mode-undo-cmd =
    .label = Anulează
customize-mode-uidensity-link = Setări densitate ferestre
customize-mode-lwthemes-link-2 = Gestionează temele
