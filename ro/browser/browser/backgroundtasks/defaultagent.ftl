...
default-browser-notification-privacy-header-text = Rămâi pe { -brand-short-name }?
default-browser-notification-privacy-body-text = Setările implicite au fost modificate. Revino la { -brand-short-name } pentru confidențialitate și protecție integrate.
...
default-browser-notification-privacy-no-button-text = Nu, mulțumesc
