...
onboarding-screenshots-text = Fă, salvează și partajează capturi de ecran - fără să ieși din { -brand-short-name }. Fă o captură cu o regiune sau cu o pagină întreagă în timp ce navighezi. Apoi salveaz-o pe web pentru acces și partajare ușoare.
