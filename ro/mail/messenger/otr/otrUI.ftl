...
auth-successThem = Contactul ți-a verificat cu succes identitatea. Ar trebui să îi verifici și tu identitatea adresându-i întrebarea ta.
...
# Variables:
#   $name (String) - the screen name of a chat contact person
alert-gone_insecure = Conversația criptată cu { $name } a luat sfârșit.
...
state-not_private = Conversația curentă nu este privată.
