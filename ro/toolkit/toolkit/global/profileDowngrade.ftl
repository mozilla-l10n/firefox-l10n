...
profiledowngrade-sync2 = Folosirea unei versiuni mai vechi de { -brand-product-name } poate corupe marcajele și istoricul de navigare deja salvate într-un profil { -brand-product-name } existent. Pentru a-ți proteja informațiile, creează un profil nou pentru această instalare { -brand-short-name }. Te poți oricum autentifica oricând cu un cont pentru a sincroniza marcajele și istoricul de navigare între profiluri.
