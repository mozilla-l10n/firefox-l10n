...
datetime-picker-label =
    .aria-label = Alege o dată și o oră
...
date-picker-label =
    .aria-label = Alege o dată
date-spinner-label =
    .aria-label = Alege o lună și un an

## Text of the clear button

date-picker-clear-button = Șterge
...
time-spinner-hour-previous =
    .aria-label = Ora anterioară
time-spinner-hour-next =
    .aria-label = Ora următoare
...
time-spinner-day-period-next =
    .aria-label = Perioada următoare din zi
