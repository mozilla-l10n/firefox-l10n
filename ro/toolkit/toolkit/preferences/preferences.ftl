...
settings-pp-erased-ok = Ți-ai șters parola principală. Parolele stocate și cheile private ale certificatelor gestionate de { -brand-short-name } nu vor fi protejate.
settings-pp-not-wanted = Avertisment! Ai decis să nu folosești o parolă principală. Parolele stocate și cheile private ale certificatelor gestionate de { -brand-short-name } nu vor fi protejate.
...
primary-password-required-by-policy = Organizația ta impune să ai o parolă principală pentru salvarea credențialelor și a parolelor.
primary-password-description = Parola primară este folosită pentru a proteja unele informații sensibile, precum credențialele și parolele, de pe acest dispozitiv. În cazul în care creezi o parolă primară, ți se va cere să o introduci o dată per sesiune când { -brand-short-name } recuperează informațiile salvate protejate de parolă.
