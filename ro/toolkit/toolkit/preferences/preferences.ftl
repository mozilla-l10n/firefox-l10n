...
primary-password-required-by-policy = Organizația ta impune să ai o parolă principală pentru salvarea datelor de autentificare și a parolelor.
...
remove-primary-password-info =
    .value = Trebuie să introduci parola actuală ca să continui.
remove-info =
