...
about-webauthn-list-credentials-button = Afișează lista de date de autentificare
...
about-webauthn-auth-info-remaining-discoverable-credentials = Date de autentificare depistabile rămase
