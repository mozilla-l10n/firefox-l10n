...
learn-more = <span data-l10n-name="link">詳細情報</span>
devtools-tooltip-learn-more = 詳細情報
...
inactive-css-not-absolutely-positioned-item = これは絶対位置指定の要素ではないため、<strong>{ $property }</strong> はこの要素に効果がありません。
inactive-css-no-default-anchor = これはデフォルトのアンカー要素を持たないため、<strong>{ $property }</strong> はこの要素に効果がありません。
...
inactive-text-overflow-when-no-overflow = <strong>overflow:hidden</strong> が設定されていないため、<strong>{ $property }</strong> はこの要素に効果がありません。
...
inactive-css-not-absolutely-positioned-item-fix = <strong>position:absolute</strong> を要素に追加してみてください。{ learn-more }
inactive-css-no-default-anchor-fix = <strong>position-anchor</strong> を正しいアンカー名で追加してみてください。{ learn-more }
...
inactive-css-not-for-internal-table-elements-fix = <strong>table-cell</strong>、<strong>table-column</strong>、<strong>table-row</strong>、<strong>table-column-group</strong>、<strong>table-row-group</strong> または <strong>table-footer-group</strong> 以外の要素に <strong>display</strong> プロパティを設定してみてください。{ learn-more }
inactive-css-not-for-internal-table-elements-except-table-cells-fix = <strong>table-column</strong>、<strong>table-row</strong>、<strong>table-column-group</strong>、<strong>table-row-group</strong> または <strong>table-footer-group</strong> 以外の要素に <strong>display</strong> プロパティを設定してみてください。{ learn-more }
...
inactive-css-border-image-fix = 親テーブル要素のプロパティを削除するか <strong>border-collapse</strong> を <strong>collapse</strong> 以外の値に変更してみてください。{ learn-more }
...
inactive-css-not-for-internal-table-elements-fix-1 = <strong>table-cell</strong>、<strong>table-column</strong>、<strong>table-row</strong>、<strong>table-column-group</strong>、<strong>table-row-group</strong> または <strong>table-footer-group</strong> 以外の要素に <strong>display</strong> プロパティを設定してみてください。
inactive-css-not-for-internal-table-elements-except-table-cells-fix-1 = <strong>table-column</strong>、<strong>table-row</strong>、<strong>table-column-group</strong>、<strong>table-row-group</strong> または <strong>table-footer-group</strong> 以外の要素に <strong>display</strong> プロパティを設定してみてください。
...
inactive-css-border-image-fix-1 = 親テーブル要素のプロパティを削除するか <strong>border-collapse</strong> を <strong>collapse</strong> 以外の値に変更してみてください。
