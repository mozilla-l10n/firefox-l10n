...
# Variables:
#   $agent - The name of the DLP agent doing the analysis
contentanalysis-slow-agent-dialog-body-clipboard = { $agent } が所属組織のデータポリシーに従って、ユーザーがペーストしたものをレビューしています。しばらくお待ちください。
...
# Variables:
#   $agent - The name of the DLP agent doing the analysis
contentanalysis-slow-agent-dialog-body-print = { $agent } が所属組織のデータポリシーに従って、ユーザーがプリントしたものをレビューしています。しばらくお待ちください。
contentanalysis-operationtype-clipboard = クリップボード
contentanalysis-operationtype-dropped-text = ドロップされたテキスト
contentanalysis-operationtype-print = プリント
...
contentanalysis-error-message-clipboard = ペーストが拒否されました。
contentanalysis-error-message-print = プリントが拒否されました。
# Variables:
#   $agent - The name of the DLP agent doing the analysis
...
contentanalysis-block-dialog-title-clipboard = このコンテンツのペーストは許可されていません
contentanalysis-block-dialog-body-clipboard = 所属組織のデータ保護ポリシーの下では、このコンテンツのペーストが許可されていません。詳細は組織の管理者に問い合わせてください。
...
contentanalysis-block-dialog-title-print = この文書のプリントは許可されていません
contentanalysis-block-dialog-body-print = 所属組織のデータ保護ポリシーの下では、この文書のプリントが許可されていません。詳細は組織の管理者に問い合わせてください。
