...
contentanalysis-block-dialog-body-clipboard = 所属組織のデータ保護ポリシーの下では、このコンテンツのペーストが許可されていません。詳細は組織の管理者にお問い合わせください。
...
contentanalysis-block-dialog-body-print = 所属組織のデータ保護ポリシーの下では、この文書のプリントが許可されていません。詳細は組織の管理者にお問い合わせください。
