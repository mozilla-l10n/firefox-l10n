...
experimental-features-custom-wallpaper =
    .label = 新規タブの壁紙や背景カラーを選べます
experimental-features-custom-wallpaper-description = 新規タブの背景に自分だけの壁紙をアップロードするか、お好きなカラーを選べます。
...
experimental-features-newtab-sections-follow-block =
    .label = 新規タブストーリーのトピックセクションとフォロー/ブロック
experimental-features-newtab-sections-follow-block-description = 新規タブページのストーリーを簡単に見つけられるように、分類された各トピック (スポーツ、食べ物、娯楽など) のセクションに整理しましょう。新しいフォロー/ブロックのコントロールで、表示されるコンテンツをカスタマイズできます。<a data-l10n-name="connect">フィードバックを共有してください</a>。
# Firefox Web Apps
experimental-features-fx-web-apps =
    .label = タスクバーにサイトを追加
# “Add tab to taskbar” is found in the tooltip text of `-taskbar-tab-urlbar-button-open`.
experimental-features-fx-web-apps-description = よく訪れるサイトをウェブアプリとしてタスクバーから開きます。アドレスバー右端の “タブをタスクバーに追加” アイコンをクリックして、そのサイトを { -brand-product-name } の保護機能下にあるウインドウとして起動できます。<a data-l10n-name="connect">フィードバックを共有してください</a>。
...
experimental-features-newtab-widget-lists-description = 新規タブを開いたら ToDo リストを見て思い出しましょう。旅行の荷造りから買い物リストまで、{ -brand-product-name } で計画を立てられます。<a data-l10n-name="connect">フィードバックを共有してください</a>。
# Timer Widget
...
experimental-features-newtab-widget-lists-and-timer-description = 新規タブを開いたら ToDo リストを見て思い出しましょう。旅行の荷造りから買い物リストまで、{ -brand-product-name } で計画を立てられます。タイマーをセットしたら、よそ見をしないで作業に集中。休憩も忘れずに。<a data-l10n-name="connect">フィードバックを共有してください</a>。
