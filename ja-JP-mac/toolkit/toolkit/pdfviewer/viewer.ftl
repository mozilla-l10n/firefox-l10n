...
pdfjs-editor-signature-add-signature-button =
    .title = 新規署名を追加します
pdfjs-editor-signature-add-signature-button-label = 新規署名を追加
...
pdfjs-editor-undo-bar-undo-button =
    .title = 取り消す
pdfjs-editor-undo-bar-undo-button-label = 取り消す
...
pdfjs-views-manager-layers-title1 = レイヤー
    .title = レイヤー (ダブルクリックですべてのレイヤーをデフォルト状態にリセット)
...
pdfjs-views-manager-pages-status-cut-button-label = カット
pdfjs-views-manager-pages-status-delete-button-label = 削除
pdfjs-views-manager-pages-status-export-selected-button-label = 選択したページを書き出す...
# Variables:
#   $count (Number) - the number of selected pages to be cut.
pdfjs-views-manager-status-undo-cut-label = { $count } ページをカットしました
# Variables:
...
pdfjs-views-manager-status-warning-cut-label = カットできませんでした。ページを更新してもう一度試してください。
...
pdfjs-views-manager-status-undo-button-label = 取り消す
pdfjs-views-manager-status-done-button-label = 完了
pdfjs-views-manager-status-close-button =
    .title = 閉じる
pdfjs-views-manager-status-close-button-label = 閉じる
pdfjs-views-manager-paste-button-label = ペースト
pdfjs-views-manager-paste-button-before =
    .title = 最初のページの前にペーストします
# Variables:
#   $page (Number) - the page number after which the paste button is.
pdfjs-views-manager-paste-button-after =
    .title = { $page } ページの後にペーストします
...
pdfjs-digital-signature-properties-button =
    .title = デジタル署名の情報を見る
    .aria-label = デジタル署名の情報を見る
pdfjs-digital-signature-properties-button-label = デジタル署名の情報を見る
