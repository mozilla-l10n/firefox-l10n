...
download-ui-confirm-leave-private-browsing-windows-cancel-downloads = プライベートブラウジングウインドウを今すぐ閉じると、{ $downloadsCount } 個のダウンロードがキャンセルされます。プライベートブラウジングモードを終了してもよろしいですか？
