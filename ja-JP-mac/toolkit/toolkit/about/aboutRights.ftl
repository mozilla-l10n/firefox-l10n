...
rights-intro-point-3 = クラッシュレポータなど { -brand-short-name } の一部の機能には、{ -vendor-short-name } へフィードバックを送信するオプションがあります。あなたがフィードバックの送信を選択することにより、{ -vendor-short-name } がそのフィードバックを製品の改善および { -vendor-short-name } ウェブサイトでの公開、配布のために使用する許可を { -vendor-short-name } に与えるものとします。
...
rights-webservices-term-1 = { -vendor-short-name } ならびにその貢献者、ライセンサ、およびパートナーは、最も正確かつ最新のサービス提供に努めています。ただし、この情報が完全で誤りがないことは保証できません。例えば、セーフブラウジングサービスが危険なサイトを適切に識別しない、または安全なサイトを誤って危険なサイトとして識別する可能性があります。また、位置情報検出サービスによるすべての位置情報は評価のためだけに使用され、提供された位置の正確さを保証するものではありません。
rights-webservices-term-2 = { -vendor-short-name } は、独自の判断に基づいて本サービスを変更または中止することがあります。
rights-webservices-term-3 = 本サービスは、{ -brand-short-name } に付属するバージョンとともにご利用いただけます。{ -vendor-short-name } は、そのための権利をあなたに与えます。{ -vendor-short-name } およびそのライセンサは、本サービスに関するそれ以外のすべての権利を留保しています。本利用規約の規定は、{ -brand-short-name } および { -brand-short-name } のソースコードについて、オープンソースライセンスにより許諾される権利を何ら制限するものではありません。
rights-webservices-term-4 = <strong>本サービスは、「現状のまま」で提供されるものです。{ -vendor-short-name } ならびにその貢献者、ライセンサ、およびディストリビュータは、あらゆる明示的および黙示的な保証を否認します。否認される保証には、本サービスに商業性があること、および本サービスが特定の目的に適合することの保証が含まれますが、これらに限定されません。目的に対するサービスの選択、ならびにサービスの品質および性能に関するリスクは、すべてあなたが負います。国や地域によっては黙示的な保証の除外または制限が法律上認められない場合がありますが、その場合にはこの条項は適用されません。</strong>
rights-webservices-term-5 = <strong>法の定めによる場合を除き、{ -vendor-short-name } ならびにその貢献者、ライセンサ、およびディストリビュータは、{ -brand-short-name }、または本サービスの使用もしくは使用できないことに起因またはいかなる形においても関連して生じた、間接的損害、特別損害、付随的損害、派生的損害、または懲罰的損害に関して一切責任を負いません。本利用規約に基づく責任の総額は、500 米ドルを上限とします。国や地域によっては特定の損害の除外または制限が法律上認められない場合がありますが、その場合にはこの条項は適用されません。</strong>
