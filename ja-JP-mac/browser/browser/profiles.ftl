...
edit-profile-page-desktop-shortcut-toggle-2 =
    .label = デスクトップショートカットを作成
edit-profile-page-desktop-shortcut-header = デスクトップショートカットを作成
edit-profile-page-desktop-shortcut-toggle =
    .aria-label = デスクトップショートカットを作成
...
new-profile-page-header-description = 各プロファイルには、それぞれ独立した閲覧履歴と設定が保持されています。さらに、{ -brand-short-name } の強力なプライバシー保護がデフォルトで有効です。
...
copied-profile-page-header-description = 既存のデータと設定を新規プロファイルにコピーしました。プロファイルに名前を付け、お好みのテーマを選んで設定してください。
restored-profile-page-header = 復元したプロファイルのカスタマイズ
restored-profile-page-header-description = 各プロファイルには、それぞれ独立した閲覧履歴や設定が保持されています。さらに、{ -brand-short-name } の強力なプライバシー保護機能がデフォルトで有効です。
...
delete-profile-windows = 開いているウインドウ
...
profiles-appmenu-callout-tour-title = 新規プロファイルの準備ができています
# "Spin up another" means creating another profile, “Hop between your digital lives" is referring to switching between different profiles such as work, personal, etc.
profiles-appmenu-callout-tour-subtitle = メニュー ☰ でプロファイル名をクリックすると、新規プロファイルの作成やプロファイルの編集、別のプロファイルへの切り替えができます。
