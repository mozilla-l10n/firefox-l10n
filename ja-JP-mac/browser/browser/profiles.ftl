...
copied-profile-page-header-2 = “{ $profilename }” のコピーのカスタマイズが準備できました
# Variables
#   $profilename (String) - The name of the copied profile.
...
restored-profile-page-header-description = 各プロファイルは他のプロファイルと分けて保存されたユニークな閲覧履歴と設定を保持しています。さらに、{ -brand-short-name } の強力なプライバシー保護はデフォルトでオンになっています。
