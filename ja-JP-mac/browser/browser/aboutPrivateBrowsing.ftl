...
about-private-browsing-info-description-private-window = プライベートウインドウ: プライベートウインドウをすべて閉じると、{ -brand-short-name } が検索履歴と閲覧履歴を消去しますが、匿名化はされません。
about-private-browsing-info-description-simplified = { -brand-short-name } のプライベートウインドウをすべて閉じると、検索履歴と閲覧履歴が消去されますが、匿名化はされません。
...
about-private-browsing-nova-info-body = すべてのプライベートウインドウを閉じると、Cookie、履歴、サイトデータが削除されます。
...
about-private-browsing-nova-info-subheader2 = すべてのプライベートウインドウを閉じると、検索履歴とログイン状態がリセットされます。トラッカーのブロックなど { -brand-short-name } に組み込まれた防護機能はここでも有効です。
about-private-browsing-nova-info-subheader = このウインドウを閉じると、検索履歴とログイン状態がリセットされます。トラッカーのブロックなど { -brand-short-name } に組み込まれた防護機能はここでも有効です。
