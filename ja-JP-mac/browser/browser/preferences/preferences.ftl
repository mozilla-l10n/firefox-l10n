...
pane-experimental-description4 = 実験的な機能をお試しください！ 現在開発中ですが、{ -brand-short-name } の動作にインパクトを与えることでしょう。私たちは <a data-l10n-name="data-collection">技術データと対話データの送信</a> をオンにしている場合のみ、これらの機能の使用データを受け取ります。
