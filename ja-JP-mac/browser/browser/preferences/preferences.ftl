...
preferences-colors-description = ウェブサイトのテキスト、背景、リンクを、{ -brand-short-name } のデフォルトカラーで上書きします。
...
appearance-window-density-touch =
    .label = タッチ
    .description = 大きなウインドウ要素とクリック対象のタッチ画面用に最適化されます
...
preferences-ai-controls-blocked-message =
    .message = 今後の AI 支援がデフォルトでブロックされます。特定の機能のブロック解除は、以下から設定してください。
