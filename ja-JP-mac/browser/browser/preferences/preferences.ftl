...
# is being controlled by an extension.
extension-controlled-new-tab-url = 拡張機能 <img data-l10n-name="icon"/> { $name } により新規タブページが変更されています。
...
# is being controlled by an extension.
extension-controlled-default-search = 拡張機能 <img data-l10n-name="icon"/> { $name } によりデフォルト検索エンジンが変更されています。
...
switch-links-to-new-tabs =
    .label = リンクを新規タブで開いたとき、すぐにそのタブに切り替える
    .accesskey = h
...
search-engine-default-private-desc = プライベートウインドウで使用する検索エンジンを選択してください。
...
content-blocking-private-trackers = 既知のトラッカー (プライベートウインドウのみ)
...
content-blocking-all-windows-trackers = 既知のトラッカー (すべてのウインドウ)
content-blocking-all-windows-tracking-content = トラッキングコンテンツ (すべてのウインドウ)
