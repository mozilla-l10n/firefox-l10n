...
contextual-manager-passwords-command-import-from-browser = 他のブラウザーから読み込む...
contextual-manager-passwords-command-import = ファイルから読み込む...
contextual-manager-passwords-command-export = パスワードを書き出す
...
contextual-manager-passwords-export-os-auth-dialog-message-win = パスワードを書き出すには、Windows でのあなたの資格情報を入力してください。これはあなたのアカウントのセキュリティを保護します。
# This message can be seen when attempting to export a password in about:logins
# The macOS strings are preceded by the operating system with "Firefox is trying to "
# and includes subtitle of "Enter password for the user "xxx" to allow this." These
# notes are only valid for English. only provide the reason that account verification is needed. Do not put a complete sentence here.
contextual-manager-passwords-export-os-auth-dialog-message-macosx = 保存したパスワードを書き出す
...
contextual-manager-passwords-import-file-picker-title = パスワードを読み込む
contextual-manager-passwords-import-file-picker-import-button = 読み込む
...
contextual-manager-passwords-import-learn-more = パスワードの読み込みについての詳細
contextual-manager-passwords-export-success-heading =
    .heading = パスワードを書き出しました
contextual-manager-passwords-export-success-button = 完了
# Export passwords to file dialog
contextual-manager-export-passwords-dialog-title = パスワードをファイルに書き出しますか？
# This string recommends to the user that they delete the exported password file that is saved on their local machine.
contextual-manager-export-passwords-dialog-message = 書き出し後は、この端末を使用する他者がパスワードを見ることがないようにファイルを削除しておくことをおすすめします。
contextual-manager-export-passwords-dialog-confirm-button = 書き出しを続ける
# Title of the file picker dialog
contextual-manager-passwords-export-file-picker-title = パスワードを { -brand-short-name } から書き出す
# The default file name shown in the file picker when exporting saved logins.
# The resultant filename will end in .csv (added in code).
contextual-manager-passwords-export-file-picker-default-filename = passwords
contextual-manager-passwords-export-file-picker-export-button = 書き出す
# A description for the .csv file format that may be shown as the file type
# filter by the operating system.
...
contextual-manager-passwords-origin-field-description = このサイトにログインするための正確なアドレスを入力してください。
contextual-manager-passwords-username-field =
    .label = ユーザー名
contextual-manager-passwords-username-field-description = ログインに使用するユーザー名またはメールアドレス、アカウント番号などを入力してください。
