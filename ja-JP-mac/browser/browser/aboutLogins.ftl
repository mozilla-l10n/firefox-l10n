...
about-logins-menu-menuitem-export-logins2 = パスワードを書き出す...
...
about-logins-intro-import3 = 上のプラス記号のボタンをクリックしてパスワードを追加しましょう。パスワードは <a data-l10n-name="import-browser-link">別のブラウザー</a> や <a data-l10n-name="import-file-link">ファイルから</a> も読み込めます。
...
# This message can be seen when attempting to export a password in about:logins on Windows.
about-logins-export-password-os-auth-dialog-message2-win = パスワードを書き出すには、Windows でのあなたの資格情報を入力してください。これはアカウントのセキュリティ保護に役立ちます。
# This message can be seen when attempting to export a password in about:logins
# On MacOS, only provide the reason that account verification is needed. Do not put a complete sentence here.
about-logins-export-password-os-auth-dialog-message2-macosx = 保存したパスワードを書き出す
...
about-logins-confirm-export-dialog-title = ログイン情報とパスワードの書き出す
...
about-logins-confirm-export-dialog-title2 = パスワードの書き出すについて
about-logins-confirm-export-dialog-message2 = 
    パスワードを書き出すと、人の読めるテキスト形式でファイルに保存されます。
    このファイルを使用した後は必ず削除して、この端末を使用する他者にあなたのパスワードが見られないようにしてください。
about-logins-confirm-export-dialog-confirm-button2 = 書き出すを続ける
...
# Title of the file picker dialog
about-logins-export-file-picker-title2 = パスワードを { -brand-short-name } から書き出す
# The default file name shown in the file picker when exporting saved logins.
# This must end in .csv
...
# Title of the file picker dialog
about-logins-import-file-picker-title2 = パスワードを { -brand-short-name } に読み込む
...
about-logins-import-dialog-items-no-change =
    { NUMBER($count) ->
       *[other] <span>重複したログイン情報:</span> <span data-l10n-name="count">{ $count }</span> <span data-l10n-name="meta">(読み込まれませんでした)</span>
    }
about-logins-import-dialog-items-added2 =
    { NUMBER($count) ->
       *[other] <span>新規パスワードの追加:</span> <span data-l10n-name="count">{ $count }</span>
    }
...
about-logins-import-report-description2 = パスワードが { -brand-short-name } に読み込まれました。
#
# Variables:
...
about-logins-import-report-row-description-added2 = 新規パスワードを追加しました
...
about-logins-import-report-added =
    { NUMBER($count) ->
       *[other] <div data-l10n-name="count">{ $count }</div> <div data-l10n-name="details">新規ログイン情報を追加しました</div>
    }
...
about-logins-import-report-no-change =
    { NUMBER($count) ->
       *[other] <div data-l10n-name="count">{ $count }</div> <div data-l10n-name="details">ログイン情報が重複</div> <div data-l10n-name="not-imported">(読み込まれませんでした)</div>
    }
about-logins-import-report-added2 =
    { NUMBER($count) ->
        *[other] <div data-l10n-name="count">{ $count }</div> <div data-l10n-name="details">新規パスワードを追加しました</div>
    }
...
about-logins-import-report-no-change2 =
    { NUMBER($count) ->
        *[other] <div data-l10n-name="count">{ $count }</div> <div data-l10n-name="details">エントリーが重複</div> <div data-l10n-name="not-imported">(読み込まれませんでした)</div>
    }
