...
cfr-total-cookie-protection-body = 包括的 Cookie 保護機能はこれまでにない最も強力なプライバシー保護機能です。すべての { -brand-short-name } ユーザーのデフォルト設定になりました。あなたのような早期アクセス参加者がなければ実現できなかったでしょう。より良いインターネットの構築への協力に感謝します。
