...
annotations-make-default-pdf-handler-title = { -brand-short-name } をデフォルト PDF エディターにしませんか？
annotations-make-default-pdf-handler-subtitle = PDF を開くと毎回 { -brand-short-name } のツールが使用できるようになります。
annotations-make-default-pdf-primary-cta-label = デフォルトに設定
...
launch-on-login-spotlight-restore-checkbox = 前回のウインドウとタブを開く
...
welcome-back-embedded-import-title = あなたの個人データを読み込んで { -brand-short-name } を自分だけのブラウザーにしてください。
...
multi-cta-fox-doodle-set-default-checkbox = { -brand-short-name } をデフォルトウェブブラウザーに設定する
...
multi-cta-fox-doodle-privacy-focused-subtitle =
    { PLATFORM() ->
        [macos] クリック 1 回でプライバシーを重視するお気に入りのブラウザーを使い続けましょう。{ -brand-short-name } をリンクを開くデフォルトウェブブラウザーに設定したり、Dock に追加したりしませんか。
       *[other] クリック 1 回でプライバシーを重視するお気に入りのブラウザーを使い続けましょう。{ -brand-short-name } をリンクを開くデフォルトウェブブラウザーに設定したり、タスクバーにピン留めしたりしませんか。
    }
multi-cta-fox-doodle-msix-privacy-focused-subtitle = クリック 1 回でプライバシーを重視するお気に入りのブラウザーを使い続けましょう。{ -brand-short-name } をリンクを開くデフォルトウェブブラウザーに設定したり、タスクバーやスタートメニューにピン留めしたりしませんか。
...
set-default-menu-message-simple-layout-title = { -brand-short-name } がデフォルトウェブブラウザーに設定されていません
...
set-default-menu-message-row-layout-title-variant = { -brand-short-name } をデフォルトウェブブラウザーにしましょう
set-default-menu-message-row-layout-subtitle = いつものブラウジングに速さと安全性、プライバシー保護がもたらされます。
set-default-menu-message-row-layout-subtitle-variant =
    { PLATFORM() ->
        [macos] { -brand-short-name } を手元に — デフォルトに設定して Dock に入れましょう。
       *[other] { -brand-short-name } を手元に — デフォルトに設定してタスクバーにピン留めしましょう。
    }
...
set-default-menu-message-split-layout-subtitle =
    { PLATFORM() ->
        [macos] デフォルトに設定して Dock に入れましょう。
       *[other] 高速ブラウジングと自動プライバシー保護を手に入れましょう。
    }
set-default-menu-message-primary-button = デフォルトに設定
set-default-menu-message-primary-button-variant = 優先ブラウザーに設定
set-default-menu-message-primary-button-short-variant = { -brand-short-name } をデフォルトに設定
...
launch-options-spotlight-checkbox-restore-current = 現在のウインドウとタブを再び開く
# Shown on the browser-launch prompt only
launch-options-spotlight-checkbox-restore-previous = 以前のウインドウとタブを再び開く
...
refresh-unused-profile-infobar-message = お久しぶりです！ { -brand-short-name } はしばらく使われていないようです。プロファイルを掃除して新品のようにきれいにしますか？
refresh-reinstalled-profile-infobar-message = { -brand-short-name } が再インストールされ前回のプロファイルが残っています。新品の状態にリフレッシュしますか？
