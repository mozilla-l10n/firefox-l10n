...
ipprotection-feature-introduction-link-text-private-browsing = 新たな <a data-l10n-name="learn-more-vpn">組み込み VPN</a> を利用すると、プライベートウインドウであっても、あなたの現在位置を隠し、追加の暗号化でユーザーデータを保護します。
