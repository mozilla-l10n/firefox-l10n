...
ipprotection-feature-introduction-link-text-private-browsing-2 = 新たな <a data-l10n-name="learn-more-vpn">組み込み VPN</a> を利用すると、プライベートウインドウであっても、あなたの現在位置を隠してユーザーデータを保護します。
ipprotection-feature-introduction-description-private-browsing = プライベートウインドウであっても、ユーザーの現在位置を隠してブラウジングのプライバシー保護を強化します。
...
vpn-error-page-new-session = 新規セッションを開始する
