...
# “Mark up” refers to the process of “annotating” or adding free hand text or diagramming to the document.
callout-pdfjs-draw-body-b = プリントやスキャンは必要ありません。PDF に注釈を入れて、変更を保存できます。
...
taskbar-tabs-social-callout-subtitle = ソーシャルサイトをアプリのように、{ -brand-short-name } で保護されたウインドウで起動します。
taskbar-tabs-chat-callout-title = タスクバーからチャット
taskbar-tabs-chat-callout-subtitle = チャットサイトをアプリのように、{ -brand-short-name } で保護されたウインドウで起動します。
taskbar-tabs-email-callout-title = ウェブメールをタスクバーから
taskbar-tabs-email-callout-subtitle = ウェブメールをアプリのように、{ -brand-short-name } で保護されたウインドウで起動します。
taskbar-tabs-media-callout-title = タスクバーからストリーミングに接続
taskbar-tabs-media-callout-subtitle = ストリーミングサイトをアプリのように、{ -brand-short-name } で保護されたウインドウで起動します。
taskbar-tabs-value-prop-callout-title = このサイトをタスクバーに追加
taskbar-tabs-value-prop-callout-subtitle = クリック一つでウェブサイトを簡易インターフェイスのウインドウに開きます。
...
taskbar-tabs-chat-callout-title-v3 = タスクバーから接続
taskbar-tabs-email-callout-title-v3 = タスクバーに受信トレイ
taskbar-tabs-email-callout-subtitle-v3 = ウェブメールを { -brand-short-name } により保護されたウインドウでアプリのように起動します
taskbar-tabs-media-callout-title-v3 = タスクバーから動画をストリーミング再生
taskbar-tabs-media-callout-subtitle-v3 = 動画サイトを { -brand-short-name } により保護されたウインドウでアプリのように起動します
taskbar-tabs-value-prop-callout-title-v3 = お気に入りのサイトをタスクバーにピン留め
taskbar-tabs-value-prop-callout-subtitle-v3 = どんなウェブサイトでも  { -brand-short-name } により保護されたウインドウでアプリのように起動します
taskbar-tabs-gaming-callout-title-v3 = タスクバーからいつでもゲームサイトへ
taskbar-tabs-gaming-callout-subtitle-v3 = ゲームサイトを { -brand-short-name } により保護されたウインドウでアプリのように起動します
# Button that pins the current site to the taskbar as a taskbar tab
taskbar-tabs-callout-primary-button-v3 = タスクバーにピン留め
...
sidebar-callout-survey-dissatisfied-2 = 不満
sidebar-callout-survey-very-dissatisfied-2 = 非常に不満
...
splitview-onboarding-callout-subtitle-2 = 追加のウインドウもタブを切り替える必要もありません。このタブを右クリックして “分割ビューを追加” を選んでください。
...
actions-callout-subtitle = “print” と入力するとページをプリント、“clear” と入力すると履歴を消去できます。
