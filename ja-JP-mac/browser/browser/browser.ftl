...
sharing-warning-window = { -brand-short-name } を共有しています。新規タブに切り替えると、他の人にも見えます。
sharing-warning-screen = 全画面を共有しています。新規タブに切り替えると、他の人にも見えます。
...
urlbar-view-context-menu-open-in-private-window =
    ...
    .accesskey = P
urlbar-view-context-menu-open-in-tab2 = 新規タブで開く
    .accesskey = w
urlbar-view-context-menu-open-in-container-tab2 = 新規コンテナータブで開く
    .accesskey = i
urlbar-view-context-menu-open-in-window2 = 新規ウインドウで開く
    .accesskey = N
urlbar-view-context-menu-open-in-private-window2 = 新規プライベートウインドウで開く
    .accesskey = P
...
fullscreen-keyboardlock-exit-button = フルスクリーンモードを終了 (Esc を長押し)
# "esc" is lowercase on mac keyboards, but uppercase elsewhere.
fullscreen-keyboardlock-exit-mac-button = フルスクリーンモードを終了 (esc を長押し)
# Please ensure that the domain stays in the `<span data-l10n-name="domain">` markup.
# Variables
...
private-browsing-info-panel-title = 現在プライベートウインドウです
...
reset-pbm-panel-description2 = これはプライベートウインドウを閉じずに、履歴、Cookie、その他すべてのサイトデータを削除します。
...
popup-notification-addon-privatebrowsing-checkbox2 =
    .label = プライベートウインドウで拡張機能の実行を許可する
    .accesskey = p
...
popup-warning-message =
    { $popupCount ->
        [1] { -brand-short-name } がこのサイトでポップアップウインドウをブロックしました。
       *[other] { -brand-short-name } がこのサイトで { $popupCount } 個のポップアップウインドウをブロックしました。
    }
# Variables:
#   $popupCount (Number): the number of pop-ups blocked.
redirect-warning-with-popup-message =
    { $popupCount ->
        ...
        [1] { -brand-short-name } がこのサイトでポップアップウインドウとリダイレクトをブロックしました。
       *[other] { -brand-short-name } がこのサイトで { $popupCount } 個のポップアップウインドウとリダイレクトをブロックしました。
    }
...
popup-warning-exceeded-with-redirect-message =
    { $popupCount ->
       *[other] { -brand-short-name } がこのサイトで { $popupCount } 個以上のポップアップウインドウとリダイレクトをブロックしました。
    }
...
file-picker-failed-save-nowhere = Windows のファイルダイアログを開けませんでした。デフォルトフォルダーが見つからないためファイルは保存されません。
