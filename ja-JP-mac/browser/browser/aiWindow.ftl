...
main-context-menu-open-link-new-smart-window =
    .label = リンクを新規{ -smart-window-brand-name }で開く
    .accesskey = S
appmenuitem-new-ai-window =
    .label = 新規{ -smart-window-brand-name }
    .value = 新規{ -smart-window-brand-name }
...
smartwindow-document-title = 新規タブ

## Smart Window Toggle Button

toolbar-button-ai-window-toggle =
    .label = ウインドウの形式
    .tooltiptext = スマートウインドウとクラシックウインドウを切り替えます。
...
ai-window-toggleview-status-label-inactive = クラシックウインドウ
...
aiwindow-firstrun-default-subtitle = 閲覧、検索、尋ねることが一か所でできます。プライベートウインドウやクラシックウインドウもいつでも開けます。
...
fxa-signout-dialog-body-aiwindow = 同期したデータはアカウントに残ります。{ -smart-window-brand-name(plural-form: "true") }を開くとクラシックウインドウに切り替わります。
...
smart-window-default-promo-heading = { -smart-window-brand-name }をデフォルトに設定しますか？
