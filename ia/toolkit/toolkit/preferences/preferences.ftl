...
primary-password-description = Un contrasigno primari es usate pro proteger alcun informationes sensibile, como credentiales e contrasignos, sur iste apparato. Si tu crea un contrasigno primari, te sera demandate de inserer lo un vice per session quando { -brand-short-name } recupera informationes salvate protegite per le contrasigno.
