...
primary-password-description = Un contrasigno primari es usate pro proteger certe informationes sensibile, como credentiales e contrasignos, sur iste apparato. Si tu crea un contrasigno primari, te essera demandate de inserer lo un vice per session quando { -brand-short-name } recupera informationes salvate protegite per le contrasigno.
...
remove-primary-password-info =
    .value = Tu debe inserer tu contrasigno actual pro proceder.
remove-info =
