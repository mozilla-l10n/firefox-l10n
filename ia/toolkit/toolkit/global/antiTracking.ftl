...
btp-warning-tracker-classified =
    { $gracePeriodSeconds ->
       *[other] “{ $siteHost }” ha essite classificate como un traciator bounce. Si illo non recipe activation de usator in le proxime { $gracePeriodSeconds } secundas illo habera su stato purgate.
    }
...
btp-warning-tracker-purged = Le stato de “{ $siteHost }” era recentemente purgate perque illo era disvelate como traciator saltante.
