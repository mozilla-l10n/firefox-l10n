...
neterror-try-again-button-2 = Retentar
    .accesskey = R
...
neterror-search-cta-intro2 = Impossibile connecter se al servitor a <strong>{ $hostname }</strong>.
...
neterror-search-cta-learn-more = Pro saper plus
...
neterror-sslkeylogging-warning =
    .heading = Tu connexion pote non esser private
    .message = Un application o servicio pote vider tu traffico cryptate ab iste sito.
...
neterror-http-empty-response = Controla pro verificar que tu ha typate le adresse del sito web correctemente e retenta tosto.
# Variables:
#   $hostname (String) - Hostname of the website to which the user was trying to connect.
neterror-http-empty-response-description = { $hostname } restitueva un pagina vacue.
...
neterror-dns-not-found-hint-check-network-2 = Controla tu connexion de rete.
neterror-dns-not-found-hint-firewall-2 = Verifica que { -brand-short-name } ha permission pro acceder al web (tu poterea esser connectite, ma detra un firewall).
...
neterror-unknown-socket-type-client-config = Isto poterea esser debite a un error de configuration de tu application.
...
fp-neterror-offline-intro-2 = { -brand-short-name } non pote connecter se al servitor a <strong>{ $hostname }</strong>
...
# Variables:
#   $hostname (String) - Hostname of the website to which the user was trying to connect.
fp-neterror-invalid-header-value-intro = <strong>{ $hostname }</strong> restitueva un titulo con characteres vacue non permittite per le standards de securitate del Web.
...
fp-neterror-vpn-error-title = Impossibile connecter se al VPN
fp-neterror-vpn-error-description = Retenta in alcun minutas.
fp-neterror-denied-port-access = Iste adresse usa un porta de rete que es normalmente usate pro propositos que non es le navigation web. { -brand-short-name } ha cancellate le requesta pro tu protection.
