...
abuse-report-broken-suggestions-sitepermission =
    Il pare que tu ha identificate un defecto. In addition a inviar un reporto ci, le melior maniera
    de resolver un problema de functionalitate es de contactar le disveloppator del thema.
    <a data-l10n-name="support-link">Visita le sito web del thema</a> pro obtener su informationes.
