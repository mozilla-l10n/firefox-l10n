...
about-processes-utility-actor-pkcs11-module = Assistente del modulo de securitate
about-processes-utility-actor-hw-inference = Inferentia accelerate per hardware
