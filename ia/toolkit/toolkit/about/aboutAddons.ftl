...
details-notification-softblocked-extension-disabled =
    .message = Iste extension viola le directivas de Mozilla e ha essite disactivate. Tu pote activar illo, ma isto pote esser riscose.
...
details-notification-softblocked-other-disabled =
    .message = Iste additivo viola le directivas de Mozilla e ha essite disactivate. Tu pote activar illo, ma isto pote esser riscose.
