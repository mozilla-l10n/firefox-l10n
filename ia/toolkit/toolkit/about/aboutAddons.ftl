...
find-more-addons-promo =
    .heading = Personalisa { -brand-product-name } a tu maniera
    .message = Adde utensiles e stilos pro satisfacer tu besonios e gustos.
find-more-addons-promo-open-amo-button = Explora extensiones e themas
...
find-more-extensions-promo =
    .heading = Trova tu proxime extension favorite
