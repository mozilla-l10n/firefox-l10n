...
colorpicker-tooltip-spectrum-dragger-title = Spectro
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = Selige un color in le pagina
...
colorpicker-tooltip-color-name-title = Plus simile a: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Tonalitate
...
inspector-split-orientation-button-title = Disposition de quadro
...
inspector-split-orientation-side-by-side = Latere a latere
# A label for the split orientation menu item that locks the panels on top of
# each other.
inspector-split-orientation-stacked = Impilate
