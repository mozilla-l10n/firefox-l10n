...
openpgp-import-success-description = Pro initiar usar tu clave OpenPGP importate pro cryptation email, claude iste fenestra de dialogo e accede a tu parametros de conto pro eliger lo.
