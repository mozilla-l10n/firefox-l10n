...
message-header-to-field = A<span data-l10n-name="field-separator">:</span>
message-header-from-field = Ab<span data-l10n-name="field-separator">:</span>
message-header-sender-field = Mittente<span data-l10n-name="field-separator">:</span>
...
message-header-reply-to-field = Responde a<span data-l10n-name="field-separator">:</span>
...
message-header-bcc-field = Ccn<span data-l10n-name="field-separator">:</span>
message-header-newsgroups-field = Gruppos de novas<span data-l10n-name="field-separator">:</span>
