...
ipprotection-feature-introduction-title-1 = Essaya le VPN integrate de { -brand-product-name }
...
ipprotection-feature-introduction-link-text-captive-portal-1 = Obtene <a data-l10n-name="learn-more-vpn">ulterior confidentialitate</a> seligente de plure positiones pro celar ubi tu naviga.
...
ipprotection-android-promo-callout-title = Porta le VPN integrate con te sur Android
ipprotection-android-promo-callout-description = Scande le codice QR al volo pro obtener { -brand-product-name } pro Android e activar le VPN integrate pro plus de confidentialitate.
...
ipprotection-locations-unavailable-label-1 = Non disponibile
    .aria-label = non disponibile, disactivate
# Label shown next to a VPN location that the user cannot select.
...
ipp-activator-breakage-turn-off-warning = <strong>Iste sito web pote non functionar con un VPN.</strong> Tenta disactivar le VPN durante que tu usa iste sito web.
