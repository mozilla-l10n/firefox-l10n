...
default-browser-prompt-message-pin-msix = Tene { -brand-short-name } sempre a portata de mano: rende predefinite tu navigator e fixalo lo al barra de applicationes e al menu Initiar.
