...
policy-ClearOnShutdown = Vacuar le datos de navigation quando { -brand-short-name } claude
...
policy-CNSA2KeyAgreementEnabled = Activar le accordo de clave CNSA 2.0 ML-KEM-1024 pro TLS.
...
policy-DefaultBrowserSettingEnabled = Controlar si le usator pote configurar { -brand-short-name } como le navigator predefinite.
