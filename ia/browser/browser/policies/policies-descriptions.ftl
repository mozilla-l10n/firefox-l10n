...
policy-AutoLaunchProtocolsFromOrigins = Defini un lista de protocollos externe que pote ser usate, ex fontes approbate, sin besoniar confirmation del usator.
