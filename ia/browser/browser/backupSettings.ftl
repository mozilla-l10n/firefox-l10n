...
backup-file-restore-file-validation-error = Iste file non functiona. Tenta eliger un file differente. <a data-l10n-name="restore-problems">Ancora problemas?</a>
