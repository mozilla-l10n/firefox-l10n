...
appmenu-addon-post-install-incognito-checkbox =
    .label = Consentir a iste extension de fluer in fenestras anonyme
    .accesskey = A
appmenu-addon-private-browsing =
    .label = Cambios al extensiones in fenestra private
    .buttonlabel = Gerer extensiones
    .buttonaccesskey = G
    .secondarybuttonlabel = OK, io lo comprende
    .secondarybuttonaccesskey = O
appmenu-addon-private-browsing-message = Ulle nove extensiones que tu adde a { -brand-shorter-name } non functiona in Fenestras anonyme a minus que tu lo consentir in le parametros.
