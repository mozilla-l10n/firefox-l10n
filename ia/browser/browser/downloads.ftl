...
downloading-file-opens-in-hours-and-minutes = Apertura in { $horas }h { $minutas }m…
downloading-file-opens-in-minutes = Apertura in { $minutas }m…
downloading-file-opens-in-minutes-and-seconds = Apertura in { $minutas }m { $secundas }s…
downloading-file-opens-in-seconds = Apertura in { $secundas }s…
