...
fxa-menu-send-to-mobile =
    .label =
        { $tabCount ->
            [1] Inviar a apparato mobile
            [one] Inviar { $tabCount } scheda a apparato mobile
           *[other] Inviar { $tabCount } schedas a apparato mobile
        }
fxa-menu-send-to-mobile-device-missing2 = Non vide tu tu apparato?
fxviewtabrow-send-to-mobile-not-verified = Conto non verificate
fxviewtabrow-send-to-mobile-verify-account = Verifica tu conto
...
fxa-menu-manage-account-subtitle = Gerer conto
...
fxa-menu-sign-in-promo-heading = Aperi session pro synchronisar
fxa-menu-sign-in-promo-message = Accede a tu datos ubique
...
fxa-menu-signed-out-message-login-failed = Tu es disconnexe
# Reason shown when the remembered account still needs to verify their email.
fxa-menu-signed-out-message-unverified = Completa le configuration
...
fxa-menu-signed-out-title = Accede pro synchronisar
fxa-menu-signed-out-description = Tu es disconnexe
