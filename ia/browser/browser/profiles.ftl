...
edit-profile-page-desktop-shortcut-toggle-2 =
    .label = Crear accesso directe sur le scriptorio
...
edit-profile-page-desktop-shortcut-toggle =
    .aria-label = Crear accesso directe sur le scriptorio
...
edit-profile-page-avatar-selector-opener-link = Modificar
avatar-selector-icon-tab = Icone
avatar-selector-custom-tab = Personalisate
...
copied-profile-page-header-2 = Tu copia de “{ $profilename }” es preste a esser personalisate
...
# Variables
#   $profilename (String) - The name of the profile.
delete-profile-page-title-2 = Deler profilo “{ $profilename }”
# Variables
#   $profilename (String) - The name of the profile.
delete-profile-header-2 = Deler le profilo { $profilename }?

##

# Button label
delete-profile-cancel = Cancellar
# Button label
delete-profile-confirm = Deler
...
paw-print-avatar = Vestigio de pata
