...
remove-search-engine-message = <strong>Tu motor de recerca predefinite ha essite cambiate.</strong> { -brand-short-name } non supporta plus { $oldEngine }. { $newEngine } es ora tu motor de recerca predefinite. Pro cambiar a un altere predefinite motor de recerca, vade a parametros. data-l10n-name="remove-search-engine-article">Pro saper plus</label>
