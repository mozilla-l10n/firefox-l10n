...
windows-10-eos-sync-callout-privacy-screen-2-subtitle = Preservar { -brand-shorter-name } rende facile apportar con te tu datos e parametros de confidentialitate.
