...
newtab-stocks-search-button =
    ...
    .label = Cercar
    .title = Cercar per nomine o symbolo
# Shown on the Watchlist while the user has no stocks in it, above a button that
# opens the stock search.
newtab-stocks-watchlist-empty = Initia a observar le actiones que te interessa
...
# has searched.
newtab-stocks-search-hint = Cerca symbolos o companias a adder a tu lista de surveliantia
...
# Widget heading; also the widget's accessible name.
newtab-search-widget-title = Cercar
# Screen reader label for the widget's icon-only menu button.
