...
identity-credential-policy-description = Le accesso a { $host } con un conto { $provider } es subjecte a lor <label data-l10n-name="privacy-url">politica de confidentialitate</label> e <label data-l10n-name="tos-url">conditiones de uso del servicio</label>.
