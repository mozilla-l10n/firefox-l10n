...
contextual-manager-passwords-origin-field-description = Insere le adresse exacte ubi tu aperira session sur iste sito.
contextual-manager-passwords-username-field =
    .label = Nomine de usator
contextual-manager-passwords-username-field-description = Insere le nomine de usator, adresse de e-mail, o numero de conto que tu usa pro aperir session.
contextual-manager-passwords-password-field =
    .label = Contrasigno
contextual-manager-passwords-password-field-description = Insere le contrasigno usate pro aperir session in iste conto.
