...
sidebar-open-tools-from-sidebar =
    .label = Aperi utensiles ab le barra lateral
...
sidebar-show-preview-on-hover =
    .label = Monstrar previsualisation al survolo
sidebar-manage-extensions2 = Gerer tote le extensiones
...
sidebar-opentabs-preview-heading = Schedas recente
...
sidebar-bookmarks-folder-menu = Menu de marcapaginas
sidebar-bookmarks-folder-toolbar = Barra de marcapaginas
sidebar-bookmarks-folder-other = Altere marcapaginas
sidebar-bookmarks-folder-mobile = Marcapaginas mobile
...
sidebar-opentabs-title = Schedas aperte
...
sidebar-bookmarks-title = Marcapaginas
