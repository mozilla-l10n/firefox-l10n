...
ssl-error-unknown-cipher-suite = Un incognite suite de cryptographia SSL era requirite.
ssl-error-no-ciphers-supported = Nulle suite de cryptographia es presente in iste programma.
...
ssl-error-rx-unexpected-change-cipher = SSL recipeva un registration de Change Cipher Spec inexpectate.
...
ssl-error-encryption-failure = Le algorithmo de ciframento de datos in volumine falleva in le suite de cifra.
ssl-error-decryption-failure = Le algorithmo de deciframento de datos in volumine falleva in le suite de cifra.
ssl-error-socket-write-failure = Le tentativa de scriber datos cifrate al socket subjacente falleva.
...
ssl-error-pub-key-size-limit-exceeded = Le servitor SSL ha tentate usar un clave public de grado domestic con un suite de cryptographia de exportation.
ssl-error-iv-param-failure = Le codice PKCS11 falleva a traducer un IV in un parametro.
ssl-error-init-cipher-suite-failure = Falta a initialisar le suite de cryptographia seligite.
...
ssl-error-insufficient-security-alert = Le servitor require cryptographias plus secur que illos supportate per le cliente.
...
ssl-error-cipher-disallowed-for-version = Le par SSL eligeva un suite de cryptographia non autorisate pro la version eligite del protocollo.
...
ssl-error-rx-short-dtls-read = Il non ha satis de spatio in le tampon pro le registro DTLS.
...
sec-error-no-email-cert = Non cifrate o signate: tu non ha ancora un certificato de email.
sec-error-no-recipient-certs-query = Non cifrate: tu non ha certificatos pro cata uno del destinatarios.
sec-error-not-a-recipient = Il non se ha potite decifrar: tu non es un destinatario, o le certificato e le clave private correspondente non ha essite trovate.
sec-error-pkcs7-keyalg-mismatch = Il non se ha potite decifrar: le algorithmo de ciframento de claves non corresponde a tu certificato.
...
sec-error-decryption-disallowed = Il non se ha potite decifrar: cifrate usante un algorithmo o dimension de clave non permittite.
...
sec-error-pkcs12-unsupported-pbe-algorithm = Incapace de importar. Algorithmo de ciframento non compatibile.
