...
firefox-relay-offer-legal-notice-control = Si tu te inscribe e crea un “masca de e-mail”, tu accepta le <label data-l10n-name="tos-url">conditiones de uso del servicio</label> e le <label data-l10n-name="privacy-url">aviso de confidentialitate</label>.
