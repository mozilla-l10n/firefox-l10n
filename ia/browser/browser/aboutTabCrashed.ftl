...
crashed-send-report-2 = Invia un reporto de crash automatic a fin que nos pote corriger problemas simile a isto
crashed-comment =
...
crashed-include-URL-2 = Include le URLs del sitos que tu visitava quando { -brand-short-name } collabeva
...
crashed-auto-submit-checkbox-2 = Actualisa le preferentias pro inviar automaticamente le reportos del crashes { -brand-short-name }
