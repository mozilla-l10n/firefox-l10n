...
extension-default-theme-description2 = Un gris-purpura balanciate, familiar pro un apparentia classic de { -brand-product-name }.
...
extension-default-theme-name2 = Predefinite
...
extension-nova-dusk-name = Crepusculo
...
extension-nova-ash-name = Cinere
