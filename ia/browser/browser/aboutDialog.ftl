...
settings-update-checking-for-updates =
    .label = Cercante actualisationes…
...
settings-update-unsupported = Tu non pote facer plus actualisationes in iste systema. <a data-l10n-name="unsupported-link">Saper plus</a>
...
settings-update-internal-error = Impossibile verificar le presentia de actualisationes a causa de un error interne. Actualisationes disponibile a <a data-l10n-name="manual-link">{ $displayUrl }</a>
...
helpus-referrals2 = Vole tu adjutar? <label data-l10n-name="helpus-donateLink">Face un donation</label>, <label data-l10n-name="helpus-shareFirefoxLink">Condivide { -brand-product-name }</label>, o <label data-l10n-name="helpus-getInvolvedLink">participa!</label>
helpus-referrals = Vole tu adjutar? <label data-l10n-name="helpus-donateLink">Face un donation</label>, <label data-l10n-name="helpus-shareFirefoxLink">Condivide { -brand-short-name }</label>, o <label data-l10n-name="helpus-getInvolvedLink">participa!</label>
bottomLinks-license = Informationes de licentia
bottom-links-terms = Conditiones de uso
bottom-links-privacy = Aviso de confidentialitate
