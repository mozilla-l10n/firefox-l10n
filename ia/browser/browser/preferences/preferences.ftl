...
tls-key-logging-notice-nav =
    .label = Un application o servicio pote vider tu traffico cryptate.
category-list =
...
settings-translations-subpage-speed-up-translation-header =
    .description = Discarga linguas complete pro traductiones plus rapide e foras de linea.
...
containers-sites-card-header =
    .description = Elige un contentor pro un sito e { -brand-short-name } lo usara quandocunque le sito es aperite.
    .label = Contentores specific pro un sito
...
personal-info-group =
    .label = Informationes personal
autofill-personal-info-checkbox-message =
    .label = Salvar e auto-compilar informationes personal
autofill-personal-info-manage-button =
    .label = Gerer informationes personal
...
passports-edit-passport-button-label =
    .aria-label = Rediger
passports-delete-passport-prompt-title = Deler iste passaporto?
passports-delete-passport-prompt-confirm-button = Deler
passports-delete-passport-prompt-cancel-button = Cancellar
autofill-passports-add-button = Adder nove passaporto
autofill-personal-info-manage-title =
    .heading = Gerer informationes personal
# This message is displayed when no passports are stored in Firefox
passports-no-passports-stored-message =
    .label = Necun passaporto addite
...
preferences-ai-controls-speech-recognition-control =
    .description = Transcribe le voce localmente.
    .label = Recognition vocal
preferences-ai-controls-sidebar-chatbot-group-3 =
    .description = Mantene un robot confabulator in vista quando tu naviga. Elige de plure fornitores e muta lo quandocunque tu vole.
    .label = Fornitores de robots confabulator IA in barra lateral
preferences-ai-controls-sidebar-chatbot-group-2 =
    .description = Mantene un robot confabulator in vista quando tu naviga. Elige inter Anthropic Claude, ChatGPT, Copilot, Google Gemini, e Mistral Vibe.
    .label = Fornitores de robots confabulator IA in barra lateral
...
preferences-ai-controls-block-confirmation-speech-recognition = Recognition vocal
...
preferences-etp-level-radio-group =
    .aria-label = Protection contra-traciamento reinfortiate
...
preferences-etp-tracker-count-enabled =
    .label = Monstrar traciatores blocate in barra del adresses
...
preferences-etp-custom-cookie-behavior-block-cross-site-tracking-cookies =
    .label = Blocar le cookie de traciamento inter sitos
...
security-privacy-issue-warning-doh2 =
    .description = DNS sur HTTPS adjuta celar ille sitos que tu va visitar ab tu fornitor de rete.
    .label = DNS sur HTTPS es disactivate
security-privacy-issue-warning-ech2 =
    .description = Cryptate Application Hallo adjuta celar ille sitos que tu va visitar ab tu fornitor de rete.
