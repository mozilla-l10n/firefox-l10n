...
address-capture-never-save-addresses-button =
    .label = Jammais salvar le adresses
    .accessKey = v
address-capture-never-save-button =
    .label = Jammais salvar
    .accessKey = v
...
autofill-country-warning-message-2 = Le auto-compilation de formulario es actualmente solo disponibile pro certe paises
