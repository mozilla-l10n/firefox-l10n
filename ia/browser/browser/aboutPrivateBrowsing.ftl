...
privatebrowsingpage-open-private-window-label = Aperir un fenestra private
    .accesskey = P
about-private-browsing-info-notsaved = Quando tu naviga in un fenestra private, { -brand-short-name } <strong>non salvar lo</strong>:
...
content-blocking-description = Alcun sitos web usa traciatores que pote controlar tu activitate trans internet. In le fenestras private { -brand-short-name } Content Blocking bloca automaticamente plure traciatores que pote coliger informationes re tu comportamento in navigation.
