...
safeb-blocked-unwanted-page-learn-more = Apprende plus super le software malefic e indesiderate a <a data-l10n-name='learn_more_link'>Regulas del software indesiderate</a>. Apprende plus sur le protection de { -brand-short-name } contra phishing e malware a <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
