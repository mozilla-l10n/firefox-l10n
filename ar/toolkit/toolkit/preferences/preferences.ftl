...
set-password-old-password = كلمة السر الحالية:
set-password-new-password = أدخل كلمة السر الجديدة:
set-password-reenter-password = أعد إدخال كلمة السر:
...
primary-password-required-by-policy = تتطلب مؤسستك تعيين كلمة سر أساسية حتى تتمكن من حفظ عمليات الولوج وكلمات السر.
