...
datetime-picker-label =
    .aria-label = اختر تاريخًا ووقتًا
...
time-spinner-hour-previous =
    .aria-label = الساعة الماضية
time-spinner-hour-next =
    .aria-label = الساعة القادمة
...
time-spinner-day-period-next =
    .aria-label = الفترة التالية من اليوم
