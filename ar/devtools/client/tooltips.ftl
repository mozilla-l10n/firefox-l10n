...
devtools-tooltip-learn-more = اطّلع على المزيد
...
inactive-css-not-grid-or-flex-container-fix-1 = جرّب إضافة <strong>display:grid</strong> أو <strong>display:flex</strong>.
inactive-css-not-grid-or-flex-container-or-multicol-container-fix-1 = جرّب إضافة <strong>display:grid</strong> أو <strong>display:flex</strong> أو <strong>columns:2</strong>.
inactive-css-not-grid-item-fix-3 = جرّب إضافة <strong>display:grid</strong> أو <strong>display:inline-grid</strong> إلى العنصر الأب.
inactive-css-not-grid-container-fix-1 = جرّب إضافة <strong>display:grid</strong> أو <strong>display:inline-grid</strong>.
inactive-css-not-flex-item-fix-3 = جرّب إضافة <strong>display:flex</strong> أو <strong>display:inline-flex</strong> إلى العنصر الأب.
inactive-css-not-flex-container-fix-1 = جرّب إضافة <strong>display:flex</strong> أو <strong>display:inline-flex</strong>.
inactive-css-not-inline-or-tablecell-fix-1 = جرّب إضافة <strong>display:inline</strong> أو <strong>display:table-cell</strong>.
inactive-css-non-replaced-inline-or-table-row-or-row-group-fix-1 = جرّب إضافة <strong>display:inline-block</strong> أو <strong>display:block</strong>.
