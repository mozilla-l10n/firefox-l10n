...
ipprotection-feature-introduction-link-text-privacy = تساعدك خدمة VPN المدمجة من { -brand-product-name } على حماية تصفحك. اختر من بين 5 مواقع للحفاظ على خصوصية تصفحك.
...
ipprotection-location-selection-callout-description = تتيح لك خدمة VPN المدمجة من { -brand-product-name } الاختيار من بين 5 مواقع تصفح، أو دعنا نختار لك الأسرع.
