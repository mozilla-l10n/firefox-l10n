...
# Variables
#   $usageLeft (number) - The amount of data a user has left in a month (in GB)
ip-protection-bandwidth-warning-infobar-message-90 = لقد أوشكت بيانات VPN الخاصة بك على النفاد. لديك { $usageLeft } ج.بايت متبقية. بمجرد استهلاكها بالكامل، سيتوقف VPN مؤقتًا حتى تُصفَّر بياناتك في الأول من الشهر القادم.
# Variables
#   $usageLeft (number) - The amount of data a user has left in a month (in MB)
ip-protection-bandwidth-warning-infobar-message-90-mb = لقد أوشكت بيانات VPN الخاصة بك على النفاد. لديك { $usageLeft } م.بايت متبقية. بمجرد استهلاكها بالكامل، سيتوقف VPN مؤقتًا حتى تُصفَّر بياناتك في الأول من الشهر القادم.
