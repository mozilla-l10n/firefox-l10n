...
onboarding-gratitude-security-and-privacy-subtitle = شكرًا لاستخدامك { -brand-short-name }، بدعم من مؤسسة Mozilla. بدعمكم، نعمل على جعل الإنترنت أكثر أمانًا وسهولةً للجميع.
