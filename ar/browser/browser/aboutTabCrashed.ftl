...
crashed-send-report = أرسل تقرير انهيار آلي لتمكيننا من إصلاح هذا النوع من المشاكل.
...
crashed-include-URL = ضمّن روابط المواقع التي كانت مفتوحة عندما انهار { -brand-short-name }.
crashed-email-placeholder = أدخل عنوان بريدك الإلكتروني هنا
crashed-email-me = أرسل لي بريدًا عندما تتوفر مزيد من المعلومات
...
crashed-auto-submit-checkbox = حدّث التفضيلات لإرسال التقارير تلقائيا عندما ينهار { -brand-short-name }.
