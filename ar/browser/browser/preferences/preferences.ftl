...
pane-experimental-description4 = جرّب ميزاتنا التجريبية! إنها قيد التطوير والتحديث، مما قد يؤثر على طريقة عمل { -brand-short-name } . لا نتلقى بيانات حول استخدامك لهذه الميزات إلا إذا كنت قد فعّلت <a data-l10n-name="data-collection">البيانات التقنية وبيانات التفاعل</a>.
