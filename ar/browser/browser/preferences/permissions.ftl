...
permissions-site-notification-window2 =
    ...
    .style = { permissions-window2.style }
permissions-site-notification-desc = طلبت المواقع الآتية إرسال التنبيهات. يمكنك تحديد أي المواقع مسموح لها إرسال التنبيهات، ويمكنك أيضًا حجب الطلبات الجديدة التي تطلب السماح بالتنبيهات.
