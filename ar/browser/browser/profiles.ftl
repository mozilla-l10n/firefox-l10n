...
edit-profile-page-desktop-shortcut-toggle-2 =
    .label = أنشئ اختصار على سطح المكتب
...
new-profile-page-header-description = يحتفظ كل ملف شخصي بسجل تصفحه وإعداداته الخاصة بشكل منفصل عن الملفات الشخصية الأخرى. بالإضافة إلى ذلك، تُفعّل ميزات حماية الخصوصية القوية لـ { -brand-short-name } مبدئيًا.
new-profile-page-learn-more = اطّلع على المزيد
new-profile-page-input-placeholder =
    .placeholder = اختر اسمًا مثل "عمل" أو "شخصي".
...
delete-profile-history = التأريخ (الصفحات التي زُرتها، ملفات تعريف الارتباط، بيانات الموقع)
...
profiles-pink-theme = وردي
profiles-pink-theme-title =
    .title = طبّق السمة الوردية
profiles-purple-theme = أرجواني
profiles-purple-theme-title =
    .title = طبّق السمة الأرجوانية
profiles-violet-theme = بنفسجي
profiles-violet-theme-title =
    .title = طبّق السمة البنفسجية
profiles-blue-theme = أزرق
profiles-blue-theme-title =
    .title = طبّق السمة الزرقاء
profiles-green-theme = أخضر
profiles-green-theme-title =
    .title = طبّق السمة الخصراء
profiles-cyan-theme = سماوي
profiles-cyan-theme-title =
    .title = طبّق السمة السماوية
profiles-custom-theme-title =
    .title = طبّق السمة المخصّصة

## Data collection settings changed (multi-profile)

# Full infobar message with inline bold title followed by body text
multiprofile-data-collection-message = <strong>غُيّرت إعدادات جمع البيانات.</strong> تنطبق التغييرات التي اُجريت في ملف شخصي آخر على جميع ملفات الشخصية الموجودة على هذا الجهاز.
...
star-avatar-tooltip =
    .tooltiptext = تطبيق صورة رمزية نجمية
video-game-controller-avatar-tooltip =
    .tooltiptext = تطبيق صورة رمزية لوحدة تحكم ألعاب الفيديو
