...
profile-window-title = { -brand-short-name } - اختر ملف المستخدم الشخصي
...
profiles-marigold-theme = القطيفة
...
profiles-lavender-theme = الخزامى
...
profiles-magnolia-theme = ماغنوليا
