...
extension-default-theme-description2 = Сбалансированный, знакомый серо-фиолетовый для классического образа { -brand-product-name }.
...
extension-default-theme-name2 = По умолчанию
# Name for a warm yellow-gold theme. Refers to the color of sunlight.
extension-nova-sun-name = Солнце
...
extension-nova-flame-name = Пламя
# Name for a bright pink theme. Refers to a burst of light or fire.
extension-nova-flare-name = Сияние
...
extension-nova-dusk-name = Закат
