...
confirmation-hint-address-updated = Адрес обновлён
confirmation-hint-credit-card-created = Карта сохранена
confirmation-hint-credit-card-updated = Карта обновлена
confirmation-hint-passport-created = Паспорт сохранён
confirmation-hint-passport-updated = Паспорт обновлён
