...
cclear-data-for-site-permissions = Разрешения и настройки
clear-data-for-site-exceptions = Закладки и сохранённые пароли не будут удалены
clear-data-for-site-dialog-accept-button = Очистить данные
clear-data-for-site-dialog-cancel-button = Отмена
