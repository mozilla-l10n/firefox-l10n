...
helpus-referrals2 = Хотите помочь? <label data-l10n-name="helpus-donateLink">Сделайте пожертвование</label>, <label data-l10n-name="helpus-shareFirefoxLink">Поделитесь { -brand-product-name }</label>, или <label data-l10n-name="helpus-getInvolvedLink">присоединяйтесь!</label>
