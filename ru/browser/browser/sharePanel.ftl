...
urlbar-share-button =
    .aria-label = Поделиться этой страницей
    .tooltiptext = Поделиться этой страницей
share-panel-heading = Поделиться страницей
...
confirmation-hint-link-copied = Ссылка скопирована
