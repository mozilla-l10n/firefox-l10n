...
appmenuitem-update-banner3 =
    .label-update-downloading = Загрузка обновления { -brand-shorter-name }
    .label-update-available = Доступно обновление — загрузите сейчас
    .label-update-manual = Доступно обновление — загрузите сейчас
    .label-update-unsupported = Невозможно выполнить обновление — система не совместима
    .label-update-restart = Доступно обновление — перезапустите сейчас
