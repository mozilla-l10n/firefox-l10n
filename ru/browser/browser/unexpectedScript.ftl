...
unexpected-script-load-message = <strong>{ -brand-short-name } обнаружил неожиданный привилегированный скрипт с { $origin }</strong>
...
unexpected-script-load-message-button-block =
    .label = Заблокировать
    .accesskey = И
unexpected-script-load-title = Неожиданная загрузка скрипта
unexpected-script-load-detail-1-allow = { -brand-short-name } будет <strong>РАЗРЕШАТЬ</strong> загрузку неожиданных привилегированных скриптов, включая показанный ниже. Это сделает вашу установку { -brand-short-name } <strong>менее</strong> безопасной.
unexpected-script-load-detail-1-block = { -brand-short-name } будет <strong>БЛОКИРОВАТЬ</strong> неожиданные привилегированные скрипты, включая показанный ниже, от загрузки. Это сделает вашу установку { -brand-short-name } <strong>более</strong> безопасной.
...
unexpected-script-load-detail-2 = Даже если вы разрешаете этот скрипт, пожалуйста, сообщите об этом { -vendor-short-name }, чтобы помочь понять, как и почему он был загружен. <em>Без этой информации в будущем функциональность будет нарушена.</em>
unexpected-script-load-report-checkbox =
    .label = Сообщить об URL-адресе этого скрипта в { -vendor-short-name }
