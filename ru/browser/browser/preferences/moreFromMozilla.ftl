...
more-from-moz-title2 = Больше от { -vendor-short-name }
    .title = Больше от { -vendor-short-name }
...
more-from-moz-solo-title-2 = Создатель ИИ-веб-сайта { -solo-ai-brand-name }
...
more-from-moz-solo-card-1 =
    ...
    .description = Создайте свой веб-сайт мгновенно и подключите свой собственный пользовательский домен бесплатно.
more-from-moz-new-products-card2 =
    .label = Новые продукты { -vendor-short-name }
    .description = Ознакомьтесь с нашими новейшими идеями и экспериментальными технологиями.
...
more-from-moz-mdn-box-link =
    .label = Получить доступ к MDN
more-from-moz-thunderbird-box-link =
    .label = Скачать { -thunderbird-brand-short-name }
more-from-moz-solo-box-link =
    .label = Попробовать { -solo-ai-brand-name }
more-from-moz-new-products-box-link =
    .label = Посмотреть новые продукты
