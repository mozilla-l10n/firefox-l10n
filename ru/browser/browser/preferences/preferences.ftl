...
appearance-window-density-group =
    .label = Плотность окон
    .description = Отрегулируйте расстояние между элементами окна, такими как панель инструментов, вкладки и боковая панель.
appearance-window-density-radio-group =
    .aria-label = Плотность окон
