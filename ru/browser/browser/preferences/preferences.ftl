...
containers-sites-card-header =
    .description = Выберите контейнер для определённого сайта, и { -brand-short-name } будет использовать его при каждом открытии этого сайта.
    .label = Контейнеры для сайтов
...
preferences-etp-tracker-count-enabled =
    .label = Показывать количество заблокированных трекеров в адресной строке
