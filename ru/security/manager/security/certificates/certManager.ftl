...
certmgr-fingerprints-label =
    .value = Отпечатки
certmgr-subject-label = Кому выдано
certmgr-issuer-label = Кем выдано
...
pkcs12-info-no-smartcard-backup = Невозможно создать резервную копию сертификатов, находящихся в аппаратном устройстве защиты, таком как смарт-карта.
