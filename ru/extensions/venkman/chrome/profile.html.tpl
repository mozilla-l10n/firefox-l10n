...
<html>
  <head>
    <title>Данные профиля JavaScript</title>
  </head>
  <style>
    .profile-file-title {
        font-size  : larger;
  ...
  <body>
    <h1>Данные профиля JavaScript</h1>
    <span class="label">Дата создания:</span>
    <span class="value">$full-date</span><br>
    <span class="label">Пользовательский агент:</span>
    <span class="value">$user-agent</span><br>
    <span class="label">Версия Отладчика JavaScript:</span>
...
@-range-start
      <span class="range-box">
        ...
        <h3>$range-min - $range-max мс</h3>
        [ <a href="#section$section-number-prev">Предыдущий файл</a> |
        <a href="#section$section-number-next">Следующий файл</a> |
        <a href="#range$section-number:$range-number-prev">Предыдущий диапазон</a> |
        <a href="#range$section-number:$range-number-next">Следующий диапазон</a> ]
@-item-start
...
@-section-end
    <hr>
    <a href="http://www.mozilla.org/projects/venkman/">Работы, как и денег, много не бывает.</a>
  </body>
</html>
