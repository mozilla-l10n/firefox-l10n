...
openpgp-broken-exchange-info = Это сообщение OpenPGP, которое, судя по всему, было искажено MS-Exchange. Если содержимое сообщения не отображается должным образом, вы можете попробовать автоматическое восстановление.
