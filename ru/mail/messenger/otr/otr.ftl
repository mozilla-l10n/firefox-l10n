...
# Variables:
#   $name (String) - the screen name of a chat contact person
msgevent-connection_ended = { $name } уже закрыл(а) зашифрованное соединение с вами. Чтобы случайно не отправить сообщение без шифрования, ваше сообщение не было отправлено. Пожалуйста, завершите зашифрованный разговор или перезапустите его.
# Variables:
#   $name (String) - the screen name of a chat contact person
