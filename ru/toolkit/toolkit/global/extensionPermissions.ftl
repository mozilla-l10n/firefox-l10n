...
webext-perms-description-downloads-open = Открытие файлов, скачанных на ваш компьютер
...
webext-perms-description-trialML = Скачайте и запускайте ИИ-модели на вашем устройстве
...
webext-perms-description-data-long-financialAndPaymentInfo = Поделиться финансовой и платёжной информацией с разработчиком расширения
