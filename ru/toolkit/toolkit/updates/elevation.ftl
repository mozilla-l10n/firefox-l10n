...
elevation-details-link-label =
    .value = Подробности
elevation-error-manual = Вы можете обновить { -brand-short-name } вручную, перейдя по следующей ссылке и скачав его последнюю версию:
elevation-finished-page = Обновление готово для установки
elevation-finished-background-page = Обновление стабильности и безопасности для { -brand-short-name } успешно скачано и готово для установки.
