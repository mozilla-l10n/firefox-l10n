...
pdfjs-views-manager-paste-button-after-label = Вставить после страницы { $page }
pdfjs-views-manager-paste-button-before-label = Вставить перед первой страницей
