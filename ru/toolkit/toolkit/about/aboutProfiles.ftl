...
profiles-delete-profile-confirm =
    ...
    Вы можете также удалить файлы данных профиля, включая ваши настройки, сертификаты и другие пользовательские данные. Выбор этого параметра приведёт к удалению папки «{ $dir }», что не может быть отменено.
