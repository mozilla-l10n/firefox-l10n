...
find-more-addons-promo =
    .heading = Формируйте { -brand-product-name } по своему вкусу
    .message = Добавляйте инструменты и стили на основе ваших потребностей и вкуса.
find-more-addons-promo-open-amo-button = Ознакомьтесь с расширениями и темами
...
find-more-extensions-promo =
    .heading = Найдите ещё одно любимое расширение
    .message = Настройте { -brand-product-name } под себя с помощью инструментов для фокусировки, приватности, покупок и многого другого.
find-more-extensions-promo-open-amo-button = Откройте для себя расширения
...
find-more-themes-promo =
    .heading = Найти больше новых стилей
    .message = Выберите стиль, который сделает { -brand-product-name } похожим на ваш.
find-more-themes-promo-open-amo-button = Просмотрите темы
...
list-empty-get-extensions-promo =
    .heading = Даже несколько расширений могут многое изменить
    .message = У нас есть рекомендации, которые помогут вам улучшить фокусировку, приватность и многое другое.
list-empty-get-extensions-promo-button = Найдите свое первое расширение
...
aboutaddons-themes-picker-heading =
    .heading = Темы { -brand-product-name }
# Show more / show less button at the bottom of the themes picker
aboutaddons-themes-picker-see-more = Показать больше
aboutaddons-themes-picker-see-less = Показать меньше
...
aboutaddons-themes-picker-error-message =
    .message = Не удалось обновить вашу тему. Проверьте подключение и повторите попытку.
