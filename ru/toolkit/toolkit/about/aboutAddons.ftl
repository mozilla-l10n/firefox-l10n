...
details-notification-softblocked-extension-disabled =
    .message = Это расширение нарушает политики Mozilla и было отключено. Вы можете включить его, но это может быть рискованно.
...
details-notification-softblocked-other-disabled =
    .message = Это дополнение нарушает политики Mozilla, поэтому было отключено. Вы можете включить её, но это может быть рискованно.
