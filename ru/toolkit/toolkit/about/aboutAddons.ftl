...
private-browsing-description =
    По умолчанию расширениям не разрешено запускаться в приватных окнах. Это означает, что они не будут работать
    во время приватного просмотра, и у них не будет доступа к вашей онлайн-активности в этом режиме. Чтобы разрешить
    расширению запускаться в приватных окнах, выберите карточку расширения ниже и измените его настройки.
    <label data-l10n-name="private-browsing-learn-more">Подробнее.</label>
