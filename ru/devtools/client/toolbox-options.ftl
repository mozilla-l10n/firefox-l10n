...
options-disable-http-cache-tooltip =
    .title = Включение этой опции отключит HTTP-кэш для всех вкладок, в которых открыта панель инструментов. Эта опция не влияет на Service Workers.
...
options-enable-service-workers-http-label = Включить Service Workers поверх HTTP (когда открыта панель инструментов)
options-enable-service-workers-http-tooltip =
    .title = Включение этой опции включит service workers поверх HTTP для всех вкладок, в которых открыта панель инструментов.
