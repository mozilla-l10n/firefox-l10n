...
serviceworker-worker-updated = Обновлён <time>{ DATETIME($date, day: "numeric", hour: "numeric", minute: "numeric", month: "long", second: "numeric", year: "numeric") }</time>
...
sidebar-item-session-history = История сессий
    .alt = Значок истории сессий
...
session-history-navigate-button-title = Перейти к записи истории сессий { $index }
