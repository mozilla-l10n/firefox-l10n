...
warn-on-send-accel-key =
    ...
    .accesskey = i
add-link-previews =
    .label = Přidat náhledy vložených odkazů
    .accesskey = i
spellcheck-label =
...
compose-send-automatic-option =
    .label = Automaticky
compose-send-automatic-description = Pokud není text zprávy nijak formátovaný, odeslat jako prostý text. Jinak jako HTML a prostý text.
