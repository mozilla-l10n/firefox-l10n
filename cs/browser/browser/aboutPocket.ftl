...
pocket-panel-saved-error-generic = Při pokusu o uložení do služby { -pocket-brand-name } došlo k chybě.
...
pocket-panel-saved-page-saved = Uloženo do služby { -pocket-brand-name }
...
pocket-panel-signup-already-have = Používáte už službu { -pocket-brand-name }?
...
pocket-panel-home-paragraph = Službu { -pocket-brand-name } můžete použít k objevování a ukládání webových stránek, článků, videí a podcastů, a také k pozdějšímu návratu k rozečtenému obsahu.
