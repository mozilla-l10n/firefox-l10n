...
extension-default-theme-description2 =
    { -brand-product-name.case-status ->
        [with-cases] Vyvážená, známá šedo-fialová pro klasický vzhled { -brand-product-name(case: "gen") }.
       *[no-cases] Vyvážená, známá šedo-fialová pro klasický vzhled aplikace { -brand-product-name }.
    }
