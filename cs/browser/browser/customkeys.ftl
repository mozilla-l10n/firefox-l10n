...
customkeys-title = Klávesové zkratky
customkeys-search = Hledat:
customkeys-change = Změnit
...
customkeys-file-focus-search = Přejít do vyhledávacího pole
...
# Separate is a verb
customkeys-view-separate-split-view = Zrušit rozdělené zobrazení
...
customkeys-dev-debugger = Debugger JavaScriptu
customkeys-dev-network = Monitor síťové aktivity
customkeys-dev-style = Editor stylů
customkeys-dev-performance = Výkon
customkeys-dev-storage = Průzkumník úložiště
customkeys-dev-dom = DOM
customkeys-dev-accessibility = Přístupnost
customkeys-dev-profiler-toggle = Spuštění nebo zastavení profileru výkonu
customkeys-dev-profiler-capture = Zaznamenat profil výkonu
customkeys-category-navigation = Navigace
customkeys-nav-back = Zpět
...
customkeys-nav-select-tab-1 = Přejít na panel 1
customkeys-nav-select-tab-2 = Přejít na panel 2
customkeys-nav-select-tab-3 = Přejít na panel 3
customkeys-nav-select-tab-4 = Přejít na panel 4
customkeys-nav-select-tab-5 = Přejít na panel 5
customkeys-nav-select-tab-6 = Přejít na panel 6
customkeys-nav-select-tab-7 = Přejít na panel 7
customkeys-nav-select-tab-8 = Přejít na panel 8
customkeys-nav-select-last-tab = Přejít na poslední panel
customkeys-nav-toggle-mute = Vypnout/Zapnout zvuk
customkeys-edit-find-previous = Najít předchozí
customkeys-tools-screenshot = Pořídit snímek stránky
