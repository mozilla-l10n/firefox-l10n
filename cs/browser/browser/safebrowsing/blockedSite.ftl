...
safeb-blocked-phishing-page-learn-more = Zjistěte více o klamavých stránkách a phishingu na <a data-l10n-name='learn_more_link'>www.antiphishing.org</a>. Zjistěte více ochraně proti phishingu a malwaru v aplikaci { -brand-short-name } na <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
...
safeb-blocked-malware-page-learn-more = Zjistěte více o škodlivém webovém obsahu, včetně virů, malwaru a jak chránit svůj počítač na <a data-l10n-name='learn_more_link'>StopBadware.org</a>. Zjistěte více ochraně proti phishingu a malwaru v aplikaci { -brand-short-name } na <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
...
safeb-blocked-unwanted-page-learn-more = Zjistěte více o škodlivém a nežádoucím softwaru na stránce <a data-l10n-name='learn_more_link'>Unwanted Software Policy</a>. Zjistěte více ochraně proti phishingu a malwaru v aplikaci { -brand-short-name } na <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
