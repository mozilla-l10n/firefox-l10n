...
windows-10-eos-sync-callout-privacy-screen-1-title = { -brand-product-name } blokuje těžbu kryptoměn, sledovací prvky sociálních sítí a vytváření otisků prohlížeče.
