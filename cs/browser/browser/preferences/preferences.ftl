...
content-blocking-fastblock-option-disabled =
    .label = Neblokovat
content-blocking-tracking-protection-label = Sledovací prvky
    .accesskey = S
content-blocking-tracking-protection-description = Známé sledovací prvky (pozn.: blokování může omezit funkce některých stránek)
