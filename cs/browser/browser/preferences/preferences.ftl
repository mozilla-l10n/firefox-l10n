...
is-not-default-browser-2 =
    .message = { -brand-short-name } není vaším výchozím webovým prohlížečem.
...
addressbar-suggestions-settings = Nastavit návrhy od vyhledávačů
...
preferences-etp-status-protections-dashboard-link =
    ...
    .description = Podívejte se, kolik skrytých sledovacích prvků vám { -brand-short-name } zablokoval, včetně sledovacích prvků sociálních sítí, nástrojů pro identifikaci zařízení a programů na těžbu kryptoměn.
