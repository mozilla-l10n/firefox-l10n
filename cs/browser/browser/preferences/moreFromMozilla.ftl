...
more-from-moz-solo-card =
    ...
    .description = Seznamte se s našimi nejnovějšími nápady a experimentálními technologiemi.
more-from-moz-new-products-card =
    .label = Nové produkty společnosti { -vendor-short-name }
    .description = Seznamte se s nejnovějšími produkty od společnosti { -vendor-short-name }.
