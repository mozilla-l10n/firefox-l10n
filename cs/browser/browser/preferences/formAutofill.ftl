...
autofill-add-passport-title = Přidat pas
# The dialog title for editing a passport in browser preferences.
autofill-edit-passport-title = Upravit pas
...
autofill-passport-issue-date = Datum vydání
# Heading shown above the passport expiration date fields.
autofill-passport-expiry-date = Datum platnosti
