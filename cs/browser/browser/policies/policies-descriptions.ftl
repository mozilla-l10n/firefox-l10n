...
policy-AutofillCreditCardEnabled = Povolí automatické vyplňování platebních metod.
...
policy-ClearOnShutdown =
    { -brand-short-name.case-status ->
        [with-cases] Při ukončení { -brand-short-name(case: "gen") } vymaže údaje o prohlížení.
       *[no-cases] Při ukončení aplikace { -brand-short-name } vymaže údaje o prohlížení.
    }
...
policy-XSLTEnabled = Zapněte nebo vypněte podporu pro rozhraní JavaScript API XSLTProcessor a instrukci zpracování XSLT.
