...
credit-card-doorhanger-options-button =
    .title = Možnosti automatického vyplňování formulářů
...
credit-card-doorhanger-details-cvv = CVV uloženo
credit-card-doorhanger-details-name-cvv = { $name } | CVV uloženo
