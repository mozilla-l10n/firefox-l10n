...
about-telemetry-firefox-data-doc =
    { "" }
    <a data-l10n-name="data-doc-link">Dokumentace dat Firefoxu</a> obsahuje návody pro práci s našimi datovými nástroji.
    { "" }
about-telemetry-telemetry-client-doc =
    { "" }
    <a data-l10n-name="client-doc-link">Dokumentace klienta telemetrie Firefoxu</a> obsahuje definice pojmů, dokumentaci API a popisy dat.
    { "" }
about-telemetry-telemetry-dashboard =
    { "" }
    <a data-l10n-name="dashboard-link">Nástěnky telemetrie</a> umožňují zobrazovat data, které Mozilla získává z telemetrie.
    { "" }
about-telemetry-show-in-Firefox-json-viewer =
    { "" }
    Otevřít v zobrazení JSONu
    { "" }
