...
rights-intro-point-1 =
    { -brand-short-name.gender ->
        [masculine] { -brand-short-name } je dostupný za podmínek stanovených licencí <a data-l10n-name="mozilla-public-license-link">Mozilla Public License</a> (MPL). Ta vám umožňuje aplikaci { -brand-short-name } používat, kopírovat a šířit. Pokud potřebujete, můžete také pozměnit zdrojový kód aplikace { -brand-short-name } podle vašich potřeb. MPL vám dává také právo šířit vámi pozměněné verze.
        [feminine] { -brand-short-name } je dostupná za podmínek stanovených licencí <a data-l10n-name="mozilla-public-license-link">Mozilla Public License</a> (MPL). Ta vám umožňuje aplikaci { -brand-short-name } používat, kopírovat a šířit. Pokud potřebujete, můžete také pozměnit zdrojový kód aplikace { -brand-short-name } podle vašich potřeb. MPL vám dává také právo šířit vámi pozměněné verze.
        [neuter] { -brand-short-name } je dostupné za podmínek stanovených licencí <a data-l10n-name="mozilla-public-license-link">Mozilla Public License</a> (MPL). Ta vám umožňuje aplikaci { -brand-short-name } používat, kopírovat a šířit. Pokud potřebujete, můžete také pozměnit zdrojový kód aplikace { -brand-short-name } podle vašich potřeb. MPL vám dává také právo šířit vámi pozměněné verze.
       *[other] Aplikace { -brand-short-name } je dostupná za podmínek stanovených licencí <a data-l10n-name="mozilla-public-license-link">Mozilla Public License</a> (MPL). Ta vám umožňuje aplikaci { -brand-short-name } používat, kopírovat a šířit. Pokud potřebujete, můžete také pozměnit zdrojový kód aplikace { -brand-short-name } podle vašich potřeb. MPL vám dává také právo šířit vámi pozměněné verze.
    }
rights-intro-point-2 = Nejsou vám však postoupena žádná práva ani licence k ochranným známkám Mozilla Foundation, či třetích stran, a to zejména k logu a názvu Firefox. Podrobnější informace o ochranných známkách jsou dostupné <a data-l10n-name="mozilla-trademarks-link">zde</a>.
