...
colorpicker-tooltip-eyedropper-title = Vybrat barvu na stránce
...
colorpicker-tooltip-color-name-title = Nejbližší: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Odstín
...
inspector-split-orientation-side-by-side = Vedle sebe
