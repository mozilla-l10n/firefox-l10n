...
certmgr-servers = თქვენ გაქვთ სერტიფიკატები, რომლებითაც შემდეგი სერვერების ამოცნობა ხდება
...
# Cert verification
cert-not-verified-cert-revoked = ამ სერტიფიკატის შემოწმება ვერ მოხერხდა, რადგან იგი ძალადაკარგულია.
