...
import-email-cert-prompt = ელფოსტის სერთიფიკატის შემოსატანად ფაილის არჩევა

## For editing certificates trust

# Variables:
#   $certName: the name of certificate
edit-trust-ca = სერტიფიკატი “{ $certName }” წარმოადგენს სერთიფიკატის გამცემს.

## For Deleting Certificates

delete-user-cert-title =
    .title = საკუთარი სერთიფიკატის წაშლა
delete-user-cert-confirm = ნამდვილად გსურთ ვებსაიტის სერთიფიკატების წაშლა?
...
delete-ca-cert-title =
    .title = CA სერთიფიკატების წაშლა ან უნდობლობა
delete-ca-cert-confirm = თქვენ ამ CA სერთიფიკატების წაშლა მოითხოვეთ. ჩაშენებული სერთიფიკატებისთვის ყველა ნდობა გაუქმდება, რასაც იგივე შედეგი აქვს. ნამდვილად გსურთ წაშლა, ან უნდობლობის გამოცხადება?
delete-ca-cert-impact = თუ სერთიფიკატების ავტორიტეტის (CA) სერთიფიკატს წაშლით ან უნდობლობას გამოუცხადებთ, ეს პროგრამა ამ CA-ს მიერ გაცემულ არც ერთ სერთიფიკატს აღარ ენდობა.
delete-email-cert-title =
    .title = ელფოსტის სერთიფიკატების წაშლა
delete-email-cert-confirm = ნამდვილად გსურთ ამ პირების ელფოსტის სერთიფიკატების წაშლა?
...
cert-with-serial =
    .value = სერთიფიკატი სერიული ნომრით: { $serialNumber }
