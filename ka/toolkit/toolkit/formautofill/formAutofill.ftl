...
credit-card-doorhanger-options-button =
    .title = ველების თვითშევსების პარამეტრები
...
autofill-insecure-field-warning-description = { -brand-short-name } გადააწყდა დაუცველ საიტს. ველების თვითშევსება დროებით გამოირთვება.
