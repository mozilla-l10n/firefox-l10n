...
profile-has-selectable-profiles-message = ამ პროფილის წასაშლელად, ჯერ გახსენით და შემდეგ აირჩიეთ „პროფილების მართვა“ პროფილების განყოფილებიდან, რომელსაც { -brand-short-name } გთავაზობთ მენიუში. აქედანვე შექმნილი დამატებითი პროფილების წაშლის შემდეგ შეგეძლებათ დაუბრუნდეთ გვერდს about:profiles და წაშალოთ ეს პროფილი.
