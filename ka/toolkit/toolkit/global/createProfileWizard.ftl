...
profile-creation-explanation-3 = თუ ეს { -brand-short-name } მხოლოდ თქვენ განკარგულებაშია, უნდა გაგაჩნდეთ ერთი პროფილი მაინც. სურვილისამებრ შეგიძლიათ შექმნათ სხვადასხვა პროფილებიც განსხვავებული პარამეტრებით. მაგალითად, სამუშაოდ და პირადი სარგებლობისთვის.
