...
webext-site-perms-header-with-gated-perms-serial = ამ დამატებით { $hostname } წვდომას მიიღებს თქვენს მიმდევრობითი შეერთების მოწყობილობებთან.
...
webext-site-perms-description-gated-perms-webserial =
    წარმოადგენს მოწყობილობებს, მათ შორის მიკროკონტროლერებს, 3D-პრინტერებსა და სხვა სახის აპარატურას, რომელთა დასაკავშირებლად გამოიყენება USB-, მიმდევრობითი შესაერთებლები ან Bluetooth.
    
    შეგეძლებათ აირჩიოთ, რომელ მოწყობილობებთან ჰქონდეს ვებსაიტს წვდომა.
    
    ჩვეულებრივ, ვებსაიტებს არ აქვთ ხოლმე მიმდევრობითი შეერთების მოწყობილობებთან წვდომის უფლება. არასათანადო გამოყენებამ შესაძლოა დააზიანოს ან ხელყოს თქვენი უსაფრთხოება.
webext-site-perms-description-gated-perms-serial =
    წარმოადგენს მოწყობილობებს, როგორებიცაა მიკროკონტროლერები, 3D-პრინტერები და სხვა სახის აპარატურა, რომელთა დასაკავშირებლად გამოიყენება USB- ან მიმდევრობითი შესაერთებლები.
...
webext-site-perms-serial = წვდომა მიმდევრობითი შეერთების მოწყობილობასთან
