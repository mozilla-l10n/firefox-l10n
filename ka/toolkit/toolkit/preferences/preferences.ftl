...
master-password-description = მთავარი პაროლი იცავს ისეთ მნიშვნელოვან ინფორმაციას, როგორიცაა მაგალითად, საიტის ანგარიშის პაროლები. მთავარი პაროლის შექმნის შემთხვევაში, მისი მითითება საჭირო ერთხელ, ყოველი გაშვებისას, როცა { -brand-short-name } იღებს წვდომას პაროლით დაცულ მონაცემებზე.
