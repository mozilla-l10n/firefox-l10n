...
pw-empty-warning = თქვენ მიერ შენახული საიტების და ელფოსტების პაროლები, ასევე, ველების მონაცემები და პირადი გასაღებები დაუცველი დარჩება.
...
master-password-description = მთავარი პაროლი იცავს ისეთ მნიშვნელოვან ინფორმაციას, როგორიცაა მაგალითად, საიტის ანგარიშის პაროლები.  მთავარი პაროლის შექმნის შემთხვევაში, მისი მითითება საჭირო იქნება { -brand-short-name }-ის ყოველი გაშვებისას ხელახლა, პაროლით დაცულ მონაცემებზე წვდომის მისაღებად.
...
remove-warning1 = თქვენი მთავარი პაროლი გამოიყენება, მნიშვნელოვანი მონაცემების დასაცავად, მაგალითად, ანგარიშების პაროლები.
remove-warning2 = თუ მთავარ პაროლს ამოიღებთ თქვენი მონაცემები დაუცველი დარჩება, რაც შეიძლება მათი ხელყოფის მიზეზი გახდეს.
