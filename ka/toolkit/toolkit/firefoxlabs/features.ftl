...
experimental-features-ime-search-description = IME (შეყვანის დამხმარე საშუალება) არის ხელსაწყო, რომელიც შესაძლებელს ხდის რთული ასონიშნების შეტანას, მათ შორის აღმოსავლურ აზიური ენებიდან ან ინდური დამწერლობებიდან, ჩვეულებრივი კლავიატურით. ამ საცდელი შესაძლებლობის ჩართვა მისამართის ზოლს დატოვებს გახსნილს ძიების შედეგებითა და შემოთავაზებებით, როცა გამოიყენება ხოლმე IME. გაითვალისწინეთ, რომ IME და მისი არე ზოგჯერ ფარავს მისამართების ზოლის შედეგებს, ამიტომ ეს პარამეტრი გამოსადეგია, როცა ისეთი IME გამოიყენება, რომელიც არ გააჩნია ამგვარი არე.
