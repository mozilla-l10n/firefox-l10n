...
experimental-features-group-customize-browsing =
    .label = გვერდების მოხერხებულად მონახულება
...
experimental-features-link-previews-description =
    { PLATFORM() ->
        [macos] თუ გსურთ გაეცნოთ ვებგვერდს დაწკაპებამდე, გადაატარეთ მაჩვენებელი ბმულს და დააჭირეთ Shift (⇧) და Option (⌥) ან Alt. შეთვალიერება მოიცავს სათაურსა და სრულად წაკითხვისთვის საჭირო დროს, AI აგრეთვე შეძლებს, თავად წაიკითხოს გვერდი და გამოარჩიოს საკვანძო საკითხები. AI უფრო მეტად ინგლისურ ტექსტზეა მორგებული. პირადულობისთვის AI გაეშვება ადგილობრივად თქვენს კომპიუტერშივე. <a data-l10n-name="connect">გამოგვეხმაურეთ</a>
       *[other] თუ გსურთ გაეცნოთ ვებგვერდს დაწკაპებამდე, გადაატარეთ მაჩვენებელი ბმულს და დააჭირეთ Shift + Alt. შეთვალიერება მოიცავს სათაურსა და სრულად წაკითხვისთვის საჭირო დროს, AI აგრეთვე შეძლებს, თავად წაიკითხოს გვერდი და გამოარჩიოს საკვანძო საკითხები. AI უფრო მეტად ინგლისურ ტექსტზეა მორგებული. პირადულობისთვის AI გაეშვება ადგილობრივად თქვენს კომპიუტერშივე. <a data-l10n-name="connect">გამოგვეხმაურეთ</a>
    }
...
experimental-features-newtab-widget-weather =
    .label = მოსალოდნელი ამინდი
experimental-features-newtab-widget-weather-description = გაეცანით დღევანდელი დღის მოსალოდნელ ამინდს საათობრივად. <a data-l10n-name="connect">გამოგვეხმაურეთ</a>
# Picture of the Day Widget
experimental-features-newtab-widget-picture-of-the-day =
    .label = დღის სურათი
experimental-features-newtab-widget-picture-of-the-day-description = შემატეთ ყოველდღიურობას მცირე მოულოდნელობა. მიიღეთ ახალი სურათი, შეისწავლეთ რამე საგულისხმო და განათავსეთ ცინცხალი ფონი დაუყოვნებლივ. <a data-l10n-name="connect">გამოგვეხმაურეთ</a>
# Clocks Widget
experimental-features-newtab-widget-clocks =
    .label = საათები
experimental-features-newtab-widget-clocks-description = დაამატეთ ოთხამდე საათი მორგებული მეტსახელებით დროის შემოწმებისთვის თქვენთვის მნიშვნელოვანი ადგილებიდან. <a data-l10n-name="connect">გამოგვეხმაურეთ</a>
# Semantic History Search
experimental-features-semantic-history-search =
    .label = შინაარსობრივი ძიების ისტორია
experimental-features-semantic-history-search-description = მანქანური დასწავლის ადგილობრივი მოდელის გამოყენებით მონახულებული გვერდების ისტორიიდან თქვენს ძიებასთან დაკავშირებული ჩანაწერების შემოთავაზება ბუნებრივი ენის აღქმაზე დაყრდნობით, როცა { -brand-product-name } იყენებს მისამართების ველს. <a data-l10n-name="connect">გამოგვეხმაურეთ</a>
# Tab Notes
experimental-features-tab-notes =
    .label = ჩანართის შენიშვნები
experimental-features-tab-notes-description = ჩანართის შენიშვნები საცდელი შესაძლებლობაა, რომლითაც შეძლებთ მიაკროთ ჩანაწერები ბრაუზერის ჩანართზე. დაიწერეთ მასალები, შეხსენებები ან მომდევნო ნაბიჯები, რომ დაბრუნებისას მოგაგონდეთ, რისთვის გახსენით. მოხარულები ვიქნებით თქვენი გამოხმაურებით ამ შესაძლებლობის დასახვეწად. <a data-l10n-name="connect">გაგვიზიარეთ მოსაზრება</a>
