...
contentanalysis-block-dialog-body-dropped-text = თქვენი დაწესებულების მონაცემთა დაცვის დებულებების მიხედვით არ გაქვთ უფლება, რომ ჩავლებით გადაიტანოთ და განათავსოთ მოცემული მასალა. მიმართეთ ხელმძღვანელობას დამატებითი ინფორმაციისთვის.
contentanalysis-block-dialog-title-print = არ გაქვთ ამ დოკუმენტის ბეჭდვის ნებართვა.
contentanalysis-block-dialog-body-print = თქვენი დაწესებულების მონაცემთა დაცვის დებულებების მიხედვით არ გაქვთ უფლება, რომ ამობეჭდოთ ეს დოკუმენტი. მიმართეთ ხელმძღვანელობას დამატებითი ინფორმაციისთვის.
