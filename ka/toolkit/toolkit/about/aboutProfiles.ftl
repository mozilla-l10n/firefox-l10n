...
profiles-restart-in-safe-mode = კვლავ გაშვება დამატებების გარეშე…
...
profiles-delete-profile-confirm =
    ...
    ასევე შეგიძლიათ წაშალოთ პროფილის მონაცემთა ფაილებიც, რომლებიც შეიცავს თქვენს პარამეტრებს, სერტიფიკატებს და მომხმარებლის სხვა მონაცემებს. ამ შემთხვევაში, სრულად წაიშლება საქაღალდე „{ $dir }“ და ვეღარ აღდგება.
