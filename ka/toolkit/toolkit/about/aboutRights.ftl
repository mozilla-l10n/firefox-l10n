...
rights-intro-point-1 =
    ...
    რაც გულისხმობს, რომ შეგიძლიათ { -brand-short-name } გამოიყენოთ, გაამრავლოთ და გაავრცელოთ. ასევე შეგიძლიათ შეცვალოთ პირველწყარო კოდიც,
    რომ თქვენს საჭიროებებს მოარგოთ { -brand-short-name }. აგრეთვე, Mozilla Public
