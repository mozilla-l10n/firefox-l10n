...
about-logging-copy-as-url = მიმდინარე პარამეტრების ასლი URL-ბმულად
about-logging-url-copied = აღრიცხვის პარამეტრების ასლი აღებულია გასამართი URL-ბმულის სახით
...
about-logging-preset-webcodecs-description = აღრიცხვის მოდულები ხარვეზების გამოსავლენად, რომლითაც შეიძლება იყოს წარმოდგენილი WebCodecs ხმის/ვიდეოს გამშიფრავები და დამშიფრავები, აგრეთვე გამოსახულების გამშიფრავებიც.
about-logging-preset-ml-label = მანქანური სწავლება
about-logging-preset-ml-description = აღრიცხვის მოდულები მანქანური სწავლების ხარვეზების გამოსავლენად
about-logging-preset-web-compat-label = ვებთავსებადობა
