...
about-translations-title = { -brand-short-name } – თარგმანები
...
about-translations-translating-message = ითარგმნება…
