...
crashes-title = ავარიული დახურვის მოხსენებები
crashes-id = ანგარიშგების ID
crashes-send-date = გადაიგზავნა
crashes-all-reports = ავარიული დახურვის ყველა მოხსენება
crashes-no-config = ეს პროგრამა ავარიული დახურვის მოხსენებების საჩვენებლად არაა გამართული.
...
features-title = { -brand-short-name } -ის შესაძლებლობები
...
app-basics-key-google = Google გასაღები
...
sandbox-sys-call-proc-type = პროცესის ტიპი
...
report-crash-for-days =
    { $days ->
        [one] ავარიული დახურვის მოხსენებები, ბოლო ერთ დღეში
       *[other] ავარიული დახურვის მოხსენებები, ბოლო { $days } დღეში
    }
# Variables
