...
app-basics-remote-processes-count = დაშორებულად მართული
...
gpu-process-kill-button = გრაფიკ. დამუშავების შეწყვეტა
...
has-privileged-user-namespaces = მომხ. სახელთა სივრცეები აღმატებული პროცესებისთვის
# Variables
...
can-sandbox-content = შიგთავსის პროცესის გამხოლოება
can-sandbox-media = მედიამოდულის გამიჯვნა
content-sandbox-level = შიგთავსის პროცესის გამხოლოების დონე
effective-content-sandbox-level = შიგთავსის პროცესის გამხოლოების ეფექტიანი დონე
