...
# Variables:
#   $hostname (string) - Hostname of the website with cert error.
cert-error-revoked = ვებსაიტები საკუთარ ნამდვილობას სერტიფიკატებით ადასტურებენ. { -brand-short-name } მიიჩნევს, რომ არასანდოა { $hostname }, რადგან იყენებს სერტიფიკატს, რომელიც გაუქმებულია.
...
internet-connection-offline-title = როგორც ჩანს, რაღაც ხარვეზია ქსელთან კავშირისას.
