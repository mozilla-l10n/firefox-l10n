...
neterror-search-cta-title = ეს საიტი მიუწვდომელია
...
neterror-search-cta-hint-search = მოიძიეთ ვებსივრცეში მოცემული საიტი
...
neterror-search-cta-hint-search-query = მოძებნეთ ინტერნეტში <strong>„{ $query }“</strong>
...
neterror-search-cta-error-code = შეცდომის კოდი: { $error }
# The search CTA's own "Learn more" link text (no trailing ellipsis).
neterror-search-cta-learn-more = ვრცლად
...
neterror-load-error-firewall = თუ თქვენი ქსელი ან კომპიუტერი ფარით ან შუამავლითაა დაცული, გადაამოწმეთ არის თუ არა { -brand-short-name } ინტერნეტთან წვდომის უფლების მქონე.
...
neterror-dns-not-found-offline-hint-header = <strong>რისი გაკეთება შეიძლება?</strong>
...
neterror-file-not-found-intro = { -brand-short-name } ვერ პოულობს ფაილს მდებარეობით <strong>{ $path }</strong>. ან არ არსებობს, ან მდებარეობა უმართებულოა.
neterror-file-not-found-what-can-you-do = თუ მისამართი ხელით აკრიფეთ, შეამოწმეთ მთავრული ან მცდარბეჭდილი ხომ არ ურევია ფაილის სახელსა ან მდებარეობაში. თუ შენახულ სანიშნს ან ბმულს მიჰყევით, შესაძლოა, ფაილი გადაადგილებული, გადარქმეული ან წაშლილი იყოს შენახვის შემდგომ. სცადეთ მისი მონახვა ფაილების სამართავიდან ან ბოლოს მოძიებულებში.
...
neterror-proxy-resolve-failure-firewall = თუ თქვენი ქსელი ან კომპიუტერი ფარით ან შუამავლითაა დაცული, გადაამოწმეთ, აქვს თუ არა { -brand-short-name } პროგრამას ინტერნეტთან წვდომის უფლება.
...
cert-error-trust-certificate-transparency-what-can-you-do-about-it = შესაძლოა, არც არაფრის და თავად საიტის მხრიდან იყოს ხარვეზი.
