...
neterror-disable-native-feedback-warning = ყოველთვის გაგრძელება
...
neterror-dns-not-found-trr-unknown-host = მისამართს ამ ვებსაიტისთვის ვერ ნახულობს { $trrDomain }.
