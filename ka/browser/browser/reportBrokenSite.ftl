...
report-broken-site-panel-reason-deceptive-moz-box-button =
    .label = საიტი თაღლითურია
report-broken-site-panel-reason-other-moz-box-button =
    .label = სხვა
report-broken-site-panel-instructions-other = აღწერეთ ხარვეზი დაწვრილებით, რაც დაგვეხმარება საკითხის გამოკვლევაში.
report-broken-site-panel-instructions-other-optional = აღწერეთ ხარვეზი დაწვრილებით, რაც დაგვეხმარება საკითხის გამოკვლევაში. (არასავალდებულო)
report-broken-site-panel-description2 =
    .placeholder = რა მოხდა? და რა შედეგ ელოდით? გთხოვთ, მიუთითოთ ხარვეზის გამომწვევი ნაბიჯები, რომ ჩვენც შევძლოთ გამეორება შესამოწმებლად.
...
report-broken-site-panel-url-input-label =
    .aria-label = მოხსენებული იქნება გვერდის URL-ბმული
