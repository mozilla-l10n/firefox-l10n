...
translations-panel-intro-description = პირადულობის დასაცავად თარგმანი მოწყობილობას არ ტოვებს. თანდათან დაემატება ახალი ენებიც და დაიხვეწება!
...
translations-panel-revisit-to-label = ნათარგმნი
