...
about-logins-confirm-remove-all-sync-dialog-message2 =
    { $count ->
        ...
        [one] შედეგად წაიშლება შესვლის ყველა მონაცემი, რომელთაც ინახავს { -brand-short-name } და ასინქრონებს ყველა მოწყობილობაზე თქვენი ანგარიშით. აგრეთვე მოცილდება მიტაცებებზე შეტყობინებებიც. ეს ქმედება შეუქცევადია.
       *[other] { "" }
    }
