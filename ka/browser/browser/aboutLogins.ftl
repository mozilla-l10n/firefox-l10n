...
login-intro-instruction-faq = იხილეთ { -lockwise-brand-short-name } – <a data-l10n-name="faq">ხშირად დასმული კითხვები</a> დამატებითი დახმარებისთვის.
...
login-item-origin-label = საიტის მისამართის
login-item-origin =
    .placeholder = https://www.example.com
login-item-open-site-button = გაშვება
