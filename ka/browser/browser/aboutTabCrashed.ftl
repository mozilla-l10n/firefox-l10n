...
crashed-include-URL = მათ შორის საიტების URL-ბმულები, რომელზეც იმყოფებოდით { -brand-short-name }-ის უეცარი გათიშვისას.
crashed-email-placeholder = შეიყვანეთ თქვენი ელფოსტის მისამართი
crashed-email-me = მომწერეთ, როდესაც მეტი ინფრომაცია გახდება ცნობილი
...
crashed-auto-submit-checkbox = შეცვალეთ პარამეტრები, რომ ავტომატურად გაიგზავნოს მოხსენებები, { -brand-short-name }-ს ავარიულად დახურვისას.
