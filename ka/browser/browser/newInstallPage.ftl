...
changed-desc-profiles = { -brand-short-name }-ის ამ დაყენებულ ვერსიას ახალი პროფილი აქვს. პროფილი წარმოადგენს ფაილების კრებულს, სადაც Firefox ინახავს ისეთ მონაცემებს, როგორიცაა სანიშნები, პაროლები და მომხმარებლის პარამეტრები.
