...
settings-update-checking-for-updates =
    .label = მიმდინარეობს განახლებების შემოწმება...
...
settings-update-unsupported = თქვენ ამ სისტემაზე დამატებითი განახლებების შესრულებაც შეგიძლიათ. <a data-l10n-name="unsupported-link">ვრცლად</a>
update-restarting = ეშვება ხელახლა…
settings-update-restarting =
    .label = ეშვება ხელახლა…
...
settings-update-internal-error = ვერ მოწმდება განახლებებზე შიდა შეცდომის გამო. ხელით განახლებისთვის იხილეთ <a data-l10n-name="manual-link">{ $displayUrl }</a>
