...
preonboarding-privacy-notice-header-button-title-b-v2 = პირადულობის განაცხადი
# Description under label for header style buttons
preonboarding-header-button-description = ვრცლად
# New user onboarding checklist
preonboarding-checklist-interaction-data-label = გაიგზავნოს ტექნიკური და გამოყენების მონაცემები, რომელთაც გაეცნობა { -vendor-short-name }
