...
genai-settings-chat-chatgpt-links = ვინაიდან აირჩიეთ ChatGPT, ეთანხმებით <a data-l10n-name="terms">მომსახურების პირობებსა</a> და <a data-l10n-name="privacy">პირადულობის დაცვის განაცხადს</a>, რომელსაც ადგენს OpenAI.
