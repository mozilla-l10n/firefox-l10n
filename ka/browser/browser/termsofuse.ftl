...
tou-existing-user-spotlight-body = ახლახან წარვადგინეთ შესწორებული <a data-l10n-name="terms-of-use">გამოყენების პირობები</a> და განახლებული <a data-l10n-name="privacy-notice">პირადულობის განაცხადი</a>.<br><br> გთხოვთ, დრო დაუთმოთ მის განხილვას და დაეთანხმოთ. <a data-l10n-name="learn-more">ვრცლად</a>.
tou-existing-user-spotlight-remind-me-later = მოგვიანებით შეხსენება
