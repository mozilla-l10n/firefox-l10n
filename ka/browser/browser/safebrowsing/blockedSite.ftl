...
safeb-blocked-phishing-page-short-desc = { -brand-short-name }-მა შეზღუდა ეს გვერდი, რადგან შესაძლოა მოტყუებით დაგაყენებინოთ პროგრამა ან ხელყოს თქვენი პირადი მონაცემები, როგორიცაა პაროლები ან საკრედიტო ბარათების ნომრები.
safeb-blocked-malware-page-short-desc = { -brand-short-name }-მა შეზღუდა ეს გვერდი, რადგან ცდილობდა მავნე პროგრამის დაყენებას, რომელსაც შეეძლო მოეპარა ან გაენადგურებინა პირადი მონაცემები თქვენს კომპიუტერში.
safeb-blocked-unwanted-page-short-desc = { -brand-short-name }-მა შეზღუდა ეს გვერდი, რადგან შესაძლოა მოტყუებით დაგაყენებინოთ პროგრამა, რომელიც ხელყოფს თქვენს ბრაუზერს (მაგალითად, შეგიცვლით საწყის გვერდს, ამოგიგდებთ დამატებით რეკლამებს საიტებზე და ა.შ.).
safeb-blocked-harmful-page-short-desc = { -brand-short-name }-მა შეზღუდა ეს გვერდი, რადგან შესაძლოა სახიფათო პროგრამას აყენებდეს და იპარავდეს ან აზიანებდეს თქვენს პირად მონაცემებს (როგორიცაა ფოტოები, პაროლები, შეტყობინებები და საკრედიტო ბარათები).
...
safeb-blocked-phishing-page-learn-more = იხილეთ ვრცლად, თაღლითური და ყალბი საიტების შესახებ ბმულზე <a data-l10n-name='learn_more_link'>www.antiphishing.org</a>. გაეცანით ინფორმაციას { -brand-short-name }-ის ყალბი და სახიფათო გვერდებისგან დაცვის შესახებ საიტზე <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
...
safeb-blocked-malware-page-learn-more = შეიტყვეთ მეტი სახიფათო ვებშიგთავსის შესახებ, როგორიცაა ვირუსები, მავნე კოდი და გაეცანით მისგან თავდაცვის გზებს ბმულზე <a data-l10n-name='learn_more_link'>StopBadware.org</a>. დამატებით იხილეთ { -brand-short-name }-ის თაღლითური და მავნე გვერდებისგან დაცვის შესახებ ინფორმაცია საიტზე <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
...
safeb-blocked-unwanted-page-learn-more = გაეცანით საზიანო და არასასურველ პროგრამებზე ინფორმაციას <a data-l10n-name='learn_more_link'>არასასურველი პროგრამების დებულებაში</a>. იხილეთ ვრცლად, { -brand-short-name }-ის ყალბი და მავნე საიტებისგან დაცვის შესახებ ბმულზე <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
...
safeb-blocked-harmful-page-learn-more = იხილეთ ვრცლად, { -brand-short-name }-ის ყალბი და სახიფათო გვერდებისგან დაცვის შესახებ საიტზე <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
