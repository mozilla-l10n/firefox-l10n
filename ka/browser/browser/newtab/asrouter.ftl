...
set-default-menu-message-simple-layout-title = { -brand-short-name } ნაგულისხმევი ბრაუზერი არაა
set-default-menu-message-simple-layout-title-variant = { -brand-short-name } თქვენი ძირითადი ბრაუზერი არაა
...
app-exit-spotlight-title = გაეშვას { -brand-short-name } ყოველ ჯერზე, როცა ჩაირთვება Windows?
app-exit-spotlight-checkbox-launch-on-login = გაეშვას { -brand-short-name } ჩართვისას
app-exit-spotlight-checkbox-pin-to-taskbar = სამუშაო ზოლზე მიმაგრება
app-exit-spotlight-primary-button = შეინახოს და დაიხუროს { -brand-short-name }
