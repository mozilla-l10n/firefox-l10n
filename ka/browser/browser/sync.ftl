...
fxa-signout-dialog-heading = გამოითიშოს { -fxaccount-brand-name }?
...
fxa-signout-checkbox =
    .label = წაიშალოს მონაცემები ამ მოწყობილობიდან (ანგარიშები, პაროლები, ისტორია, სანიშნები და სხვ.)
fxa-signout-dialog =
    .title = გამოითიშოს { -fxaccount-brand-name }
    .style = min-width: 375px;
    .buttonlabelaccept = გამოთიშვა
