...
policy-ClearOnShutdown = წაიშალოს დათვალიერების მონაცემები, როცა { -brand-short-name } დაიხურება.
...
policy-CNSA2KeyAgreementEnabled = ამოქმედდეს CNSA 2.0 ML-KEM-1024 გასაღების შეთანხმება TLS-ისთვის.
