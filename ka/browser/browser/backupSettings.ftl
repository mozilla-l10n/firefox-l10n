...
backup-file-moz-browser-restore-step-2-1 = დაწკაპეთ „თქვენი მონაცემების აღდგენა“ და მიუთითეთ ეს ფაილი
...
backup-file-other-browser-restore-step-3-1 = დაწკაპეთ „თქვენი მონაცემების აღდგენა“ და მიუთითეთ ეს ფაილი
