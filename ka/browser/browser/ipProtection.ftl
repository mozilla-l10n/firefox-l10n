...
ipprotection-feature-introduction-link-text-captive-portal-1 = ისარგებლეთ <a data-l10n-name="learn-more-vpn">დამატებითი პირადულობა</a> არაერთი მდებარეობის შერჩევით საკუთარი ადგილსამყოფლის დასაფარად.
...
ipprotection-location-selection-callout-description-1 = <a data-l10n-name="learn-more-vpn">{ -brand-product-name } ჩაშენებული VPN-ით</a> საშუალებას გაძლევთ აირჩიოთ არაერთი სასურველი მდებარეობიდან რომელიმე ან თავად შეგირჩევთ უსწრაფესს.
...
ipprotection-connection-status-connected-1 = VPN ჩართ.
    .aria-label = VPN ჩართ.
ipprotection-connection-status-disconnected-1 = VPN გამორთ.
    .aria-label = VPN გამორთ.
ipprotection-connection-status-excluded-1 = VPN გამორთულია ამ საიტზე
    .aria-label = VPN გამორთულია ამ საიტზე
ipprotection-connection-status-connecting-1 = VPN უკავშირდება…
    .aria-label = VPN უკავშირდება…
...
ipprotection-connection-status-paused-title-2 = VPN შეჩერებულია
    .aria-label = VPN შეჩერებულია
...
ipprotection-connection-status-network-error-title-1 = შეამოწმეთ ქსელთან კავშირი
    .aria-label = შეამოწმეთ ქსელთან კავშირი
...
ip-protection-not-opted-in-4 =
    ...
    .message = ინახულეთ გვერდები მეტად უსაფრთხოდ მდებარეობის დაფარვით.
...
ip-protection-site-rules-button =
    .description = მიუთითეთ წესები საიტებს, რომლებიც საჭიროებს დამატებით პირადულობას ან გამორთულ VPN-ს.
    .label = საიტის წესების მართვა
