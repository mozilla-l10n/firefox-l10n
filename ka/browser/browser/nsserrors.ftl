...
ssl-error-unsupported-hash-algorithm = TLS ტოლი გამოიყენებს მხარდაუჭერელ ჰეშ ალგორითმს.
...
ssl-error-unsupported-signature-algorithm = ტოლმა ხელმოწერის და ჰეშ ალგორითმის მხარდაუჭერელი ალგორითმი გამოიყენა,
ssl-error-missing-extended-master-secret = ტოლმა არასწორი extended_master_secret გაფართოებით ცადა გაგრძელება.
ssl-error-unexpected-extended-master-secret = ტოლმა მოულოდნელი extended_master_secret გაფართოებით ცადა გაგრძელება.
