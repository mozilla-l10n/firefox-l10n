...
appearance-browser-icon-entry-group =
    .label = ბრაუზერის ხატულა
    .description = აირჩიეთ სასურველი ხატულა ამოცანათა ზოლისთვის, სამუშაო ეკრანისა და საწყისი მენიუსთვის.
appearance-browser-icon-button =
    .label = ბრაუზერის ხატულას შეცვლა
...
appearance-browser-icon-retro2004 =
    .label = ძველებური 2004
appearance-browser-icon-retro2017 =
    .label = ძველებური 2017
...
appearance-browser-icon-momo =
    .label = Momo
    .description = შემქმნელია @heyheymomodraws
