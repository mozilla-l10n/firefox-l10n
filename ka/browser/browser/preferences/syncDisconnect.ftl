...
sync-disconnect-heading = ამასთან, გნებავთ წაიშალოს ბრაუზერის მონაცემები ამ კომპიუტერიდან? თქვენი { -sync-brand-name }-ის მონაცემები, მაინც დარჩება თქვენს ანგარიშზე.
sync-disconnect-remove-sync-caption = { -sync-brand-name }-ის მონაცემების წაშლა
