...
permissions-exceptions-popup-window3 =
    .title = ნებადართული ვებსაიტები – ამომხტომები და გარეშე მხარის მიერ გადამისამართებები
    .style = { permissions-window2.style }
...
permissions-site-localhost-disable-desc = შედეგად, ყველა ვებსაიტს, რომელიც ზემოთ არ იქნება მითითებული, შეეზღუდება წვდომის უფლება პროგრამებსა და მომსახურებებთან ამ მოწყობილობაზე. ამის გამო შესაძლოა, ვებსაიტის ზოგიერთმა შესაძლებლობამ ვერ იმუშაოს.
...
permissions-site-local-network-disable-desc = შედეგად, ყველა ვებსაიტს, რომელიც ზემოთ არ იქნება მითითებული, შეეზღუდება წვდომის უფლება პროგრამებსა და მომსახურებებთან თქვენს ადგილობრივ ან WiFi-ქსელში ჩართულ მოწყობილობებზე. ამის გამო შესაძლოა, ვებსაიტის ზოგიერთმა შესაძლებლობამ ვერ იმუშაოს.
