...
content-blocking-convenience-exceptions =
    .label = აგრეთვე, თავადვე მიუთითებს ის გამონაკლისებსაც, რომლებიც მხოლოდ მცირე ხარვეზების აღმოფხვრისა და მოსახერხებელი შესაძლებლობების ხელმისაწვდომობისთვისაა საჭირო.
