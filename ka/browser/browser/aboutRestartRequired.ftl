...
restart-required-heading = ხელახლა გაუშვით, რომ გამოიყენოთ { -brand-short-name }
restart-required-intro = { -brand-short-name } ფონურად ფონურად. დასასრულებლად საჭიროა გადატვირთვა.
