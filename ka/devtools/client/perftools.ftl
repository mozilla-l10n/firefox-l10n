...
perftools-presets-ml-label = მანქანური სწავლება
perftools-presets-ml-description2 = მზა პარამეტრები მანქანური სწავლების ხარვეზების გამოსავლენად – { -brand-shorter-name }.
