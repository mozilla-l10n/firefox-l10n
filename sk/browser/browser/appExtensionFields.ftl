...
extension-default-theme-description2 = Vyvážená, známa sivofialová farba pre klasický vzhľad { -brand-product-name(case: "gen") }.
...
extension-default-theme-name2 = Predvolená
# Name for a warm yellow-gold theme. Refers to the color of sunlight.
extension-nova-sun-name = Slnko
