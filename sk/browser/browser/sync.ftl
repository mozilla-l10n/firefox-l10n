...
fxa-signout-dialog-heading = Odhlásiť sa z { -fxaccount-brand-name(capitalization: "sentence") }?
fxa-signout-dialog2-title = Odhlásiť sa z { -fxaccount-brand-name(capitalization: "sentence") }?
