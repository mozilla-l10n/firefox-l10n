...
annotations-make-default-pdf-primary-cta-label = Nastaviť ako predvolený
annotations-make-default-pdf-next-label = Ďalej
...
launch-on-login-spotlight-title = Spustiť { -brand-short-name(case: "acc") } pri ďalšom spustení počítača?
launch-on-login-spotlight-startup-checkbox = Spúšťať { -brand-short-name(case: "acc") } pri štarte
launch-on-login-spotlight-pin-taskbar-checkbox = Pripnúť na panel úloh
# This checkbox label intentionally matches “startup-restore-windows-and-tabs”
# in the Settings (preferences.ftl). Localizers can reuse the existing
# translation suggested by translation memory.
launch-on-login-spotlight-restore-checkbox = Načítať naposledy otvorené okná a karty
launch-on-login-spotlight-primary-button = Uložiť a zavrieť { -brand-short-name(case: "acc") }
...
lapsed-user-toast-title = { -brand-product-name } vám stále kryje chrbát
...
refresh-unused-profile-infobar-message = Zdá sa, že aplikácia { -brand-short-name } nebola dlhšiu dobu spustená. Chcete ju obnoviť do pôvodných nastavení s cieľom ponúknuť vám čo najlepší zážitok? Mimochodom, vitajte späť!
refresh-reinstalled-profile-infobar-message = Zdá sa, že ste aplikáciu { -brand-short-name } preinštalovali. Chcete ju vyčistiť, aby fungovala ako nová?
refresh-profile-infobar-button = Obnoviť { -brand-short-name }…
    .accesskey = b
