...
onboarding-live-language-subtitle = { -brand-short-name } používa jazyk { $appLanguage }, zatiaľ čo váš systém používa jazyk { $systemLanguage }.
onboarding-live-language-switch-button-label = Prepnúť na jazyk { $negotiatedLanguage }
onboarding-live-language-button-label-downloading = Sťahuje sa jazykový balík { $negotiatedLanguage }…
onboarding-live-language-waiting-subtitle = Zdá sa, že váš systém a { -brand-short-name } používajú rôzne jazyky.
...
onboarding-live-language-not-now-button-label = Teraz nie
...
fx100-upgrade-thanks-keep-body = Je to naše 100. vydanie! Ďakujeme, že ste súčasťou našej komunity. Jediným kliknutím si môžete { -brand-short-name } ponechať na ďalšiu stovku.
