...
report-broken-site-panel-reason-slow =
    .label = Stránka je pomalá alebo nefunguje
report-broken-site-panel-reason-media =
    .label = Obrázky alebo videá
report-broken-site-panel-reason-content =
    .label = Tlačidlá, odkazy a ďalší obsah
report-broken-site-panel-reason-account =
    .label = Prihlásenie alebo odhlásenie
report-broken-site-panel-reason-adblockers =
    .label = Blokovače reklám
...
report-broken-site-panel-button-send =
    .label = Odoslať
report-broken-site-panel-unspecified = Nešpecifikovaný
