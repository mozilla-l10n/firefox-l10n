...
customize-mode-overflow-list-description = Sem môžete presunúť položky, ktoré chcete mať na dosah, ale mimo panela s nástrojmi…
...
customize-mode-undo-cmd =
    .label = Späť
customize-mode-uidensity-link = Nastavenia hustoty okien
customize-mode-lwthemes-link-2 = Spravovať témy
