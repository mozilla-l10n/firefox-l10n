...
contextual-manager-passwords-origin-field =
    .label = Adresa webovej stránky
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Zadajte presnú adresu, na ktorej sa budete prihlasovať na túto stránku.
contextual-manager-passwords-username-field =
    .label = Používateľské meno
contextual-manager-passwords-username-field-description = Zadajte používateľské meno, e‑mailovú adresu alebo číslo účtu, ktoré používate na prihlásenie.
contextual-manager-passwords-password-field =
    .label = Heslo
contextual-manager-passwords-password-field-description = Zadajte heslo na prihlásenie do tohto účtu.
