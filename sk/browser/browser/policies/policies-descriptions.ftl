...
policy-CNSA2KeyAgreementEnabled = Povolí dohodu o kľúčoch CNSA 2.0 ML-KEM-1024 pre TLS.
...
policy-NoDefaultBookmarks = Vypne vytváranie predvolených a inteligentných záložiek (Najobľúbenejšie, Nedávno použité štítky) v prehliadači { -brand-short-name }. Poznámka: toto pravidlo možno efektívne využiť len vtedy, ak bude nastavené pred prvým spustením.
