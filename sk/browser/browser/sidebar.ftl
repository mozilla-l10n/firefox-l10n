...
sidebar-open-tools-from-sidebar =
    .label = Otvoriť nástroje z bočného panela
...
sidebar-show-preview-on-hover =
    .label = Zobraziť ukážku pri podržaní kurzora myši
...
sidebar-opentabs-preview-heading = Nedávne karty
...
sidebar-opentabs-title = Otvorené karty
