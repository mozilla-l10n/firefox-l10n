...
appearance-browser-icon-entry-group =
    .label = Ikona prehliadača
    .description = Vyberte si vlastnú ikonu pre panel úloh, pracovnú plochu a ponuku Štart.
appearance-browser-icon-button =
    .label = Zmeniť ikonu prehliadača
