...
more-from-moz-firefox-relay-button = Získať { -relay-brand-short-name(case: "acc") }
...
more-from-moz-thunderbird-button = Získať { -thunderbird-brand-short-name(case: "acc") }
...
more-from-moz-mozilla-vpn-box-link =
    .label = Získať { -mozilla-vpn-brand-name(case: "acc") }
more-from-moz-firefox-relay-box-link =
    .label = Získať { -relay-brand-short-name(case: "acc") }
more-from-moz-mdn-box-link =
    .label = Prejsť na MDN
more-from-moz-thunderbird-box-link =
    .label = Získať { -thunderbird-brand-short-name(case: "acc") }
more-from-moz-solo-box-link =
    .label = Vyskúšať { -solo-ai-brand-name(case: "acc") }
