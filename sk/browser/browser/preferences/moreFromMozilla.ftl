...
more-from-moz-solo-button = Vyskúšajte { -solo-ai-brand-name }
...
more-from-moz-new-products-card =
    ...
    .description = Objavte najnovšie produkty od { -vendor-short-name(case: "gen") }.
...
more-from-moz-solo-box-link =
    .label = Vyskúšajte { -solo-ai-brand-name(case: "acc") }
