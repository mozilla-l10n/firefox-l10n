...
tls-key-logging-notice-nav =
    .label = Aplikácia alebo služba môže sledovať vašu šifrovanú komunikáciu.
category-list =
...
passports-edit-passport-button-label =
    .aria-label = Upraviť
passports-delete-passport-prompt-title = Odstrániť tento pas?
passports-delete-passport-prompt-confirm-button = Odstrániť
passports-delete-passport-prompt-cancel-button = Zrušiť
autofill-passports-add-button = Pridať nový pas
autofill-personal-info-manage-title =
    .heading = Spravovať osobné údaje
# This message is displayed when no passports are stored in Firefox
passports-no-passports-stored-message =
    .label = Nie sú uložené žiadne pasy
...
preferences-doh-radio-group =
    .aria-label = Zapnúť DNS cez HTTPS s použitím:
...
preferences-ai-controls-speech-recognition-control =
    .description = Prepisujte reč na text lokálne.
    .label = Rozpoznávanie reči
preferences-ai-controls-sidebar-chatbot-group-3 =
    .description = Počas prehliadania majte na očiach chatbota. Vyberte si z viacerých poskytovateľov a kedykoľvek ich prepnite.
    .label = Poskytovatelia chatbotov s umelou inteligenciou v bočnom paneli
preferences-ai-controls-sidebar-chatbot-group-2 =
    .description = Počas prehliadania webu majte na očiach chatbota. Vyberte si z možností Anthropic Claude, ChatGPT, Copilot, Google Gemini a Mistral Vibe.
    .label = Poskytovatelia chatbotov s umelou inteligenciou v bočnom paneli
...
preferences-ai-controls-block-confirmation-speech-recognition = Rozpoznávanie reči
...
preferences-etp-level-radio-group =
    .aria-label = Rozšírená ochrana pred sledovaním
...
preferences-etp-tracker-count-enabled =
    .label = Zobrazovať počet zablokovaných sledovacích prvkov v paneli s adresou
...
preferences-etp-custom-cookie-behavior-block-cross-site-tracking-cookies =
    .label = Blokovať sledovacie cookies tretích strán
...
security-privacy-issue-warning-doh2 =
    .description = DNS cez HTTPS pomáha skryť pred vaším poskytovateľom siete, ktoré stránky sa chystáte navštíviť.
    .label = DNS cez HTTPS je vypnuté
security-privacy-issue-warning-ech2 =
    .description = Funkcia Encrypted Client Hello pomáha skryť pred poskytovateľom siete, ktoré stránky sa chystáte navštíviť.
