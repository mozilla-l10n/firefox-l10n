...
autofill-card-expires-month-2 =
    .label = Mesiac konca platnosti
autofill-card-expires-year-2 =
    .label = Rok konca platnosti
...
autofill-card-search-term-credit-cards = kreditné karty, kredit, karty, debetné karty, debet, peňaženka, pokladňa
...
autofill-add-passport-title = Pridať pas
# The dialog title for editing a passport in browser preferences.
autofill-edit-passport-title = Upraviť pas
...
autofill-passport-issue-date = Dátum vydania
# Heading shown above the passport expiration date fields.
autofill-passport-expiry-date = Dátum vypršania platnosti
...
passport-capture-save-doorhanger-header = Uložiť pas?
passport-capture-save-doorhanger-description = Uložte si informácie do { -brand-short-name(case: "gen") }, aby ste mohli rýchlo vypĺňať formuláre.
