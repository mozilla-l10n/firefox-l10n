...
lost = <b>Neprišli ste o žiadne osobné údaje alebo prispôsobenia.</ b> Ak ste už v tomto počítači uložili informácie do { -brand-product-name(case: "gen") }, sú stále dostupné v inej inštalácii { -brand-product-name(case: "gen") }.
