...
inactive-css-not-absolutely-positioned-item = Vlastnosť <strong>{ $property }</strong> nemá na tento prvok žiadny vplyv, pretože nie je prvkom s absolútnou pozíciou.
inactive-css-no-default-anchor = Vlastnosť <strong>{ $property } </strong> nemá na tento prvok žiadny vplyv, pretože tento nemá predvolený kotviaci prvok.
...
inactive-css-not-block-container = Vlastnosť <strong>{ $property }</strong> nemá na tento prvok žiadny vplyv, pretože sa vzťahuje iba na prvky blokového kontajnera.
inactive-css-not-block-flex-grid-container = Vlastnosť <strong>{ $property }</strong> nemá na tento prvok žiadny vplyv, pretože sa vzťahuje iba na kontajnerové prvky typu block, flex a grid.
...
inactive-css-not-absolutely-positioned-item-fix = Skúste prvku priradiť<strong>position:absolute</strong>. { learn-more }
inactive-css-no-default-anchor-fix = Skúste pridať <strong>position-anchor</strong> s platným názvom kotvy. { learn-more }
...
inactive-css-not-block-container-fix = Skúste pridať <strong>display:block</strong>, <strong>display:inline-block</strong> alebo <strong>display:flow-root</strong>. { learn-more }
inactive-css-not-block-flex-grid-container-fix = Skúste pridať <strong>display:block</strong>, <strong>display:inline-block</strong>, <strong>display:flex</strong>, <strong>display:inline-flex</strong>, <strong>display:grid</strong>, <strong>display:inline-grid</strong> alebo <strong>display:flow-root</strong>. { learn-more }
...
inactive-css-not-grid-or-flex-item-fix-4 = Skúste definovať <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong> alebo <strong>display:inline-flex</strong> pre rodiča tohto prvku.
inactive-css-not-grid-item-fix-3 = Skúste pridať <strong>display:grid</strong> alebo <strong>display:inline-grid</strong> do nadradenej položky.
inactive-css-not-grid-container-fix-1 = Skúste pridať <strong>display:grid</strong> alebo <strong>display:inline-grid</strong>.
inactive-css-not-flex-item-fix-3 = Skúste pridať <strong>display:flex</strong> alebo <strong>display:inline-flex</strong> do nadradenej položky.
inactive-css-not-flex-container-fix-1 = Skúste pridať <strong>display:flex</strong> alebo <strong>display:inline-flex</strong>.
inactive-css-not-inline-or-tablecell-fix-1 = Skúste pridať <strong>display:inline</strong> alebo <strong>display:table-cell</strong>.
inactive-css-non-replaced-inline-or-table-row-or-row-group-fix-1 = Skúste pridať <strong>display:inline-block</strong> alebo <strong>display:block</strong>.
inactive-css-non-replaced-inline-or-table-column-or-column-group-fix-1 = Skúste pridať <strong>display:inline-block</strong>.
...
css-selector-container-query-condition-no-container = Nenašiel sa žiadny kontajner ‘{ $name }’
