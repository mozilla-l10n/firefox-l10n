...
mailto-handler-picker-window =
    .title = Zvoľte svoju e‑mailovú aplikáciu
    .style = min-width: 26em; min-height: 26em;
mailto-handler-picker-subtitle = Vyberte aplikáciu, ktorú chcete použiť na odosielanie odkazov do e‑mailov. Toto nastavenie môžete neskôr zmeniť v Nastaveniach.
...
mailto-handler-picker-always-ask = Opýtať sa vždy pri kliknutí na odkaz s e‑mailovou adresou
