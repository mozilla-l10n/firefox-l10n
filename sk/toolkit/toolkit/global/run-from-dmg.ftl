...
install-failed-message = { -brand-short-name(case: "acc") } sa nepodarilo nainštalovať, ale bude naďalej fungovať.
...
prompt-to-launch-existing-app-message = Aplikáciu { -brand-short-name } už máte nainštalovanú. Použite nainštalovanú aplikáciu, aby ste boli vždy aktuálni a predišli strate údajov.
