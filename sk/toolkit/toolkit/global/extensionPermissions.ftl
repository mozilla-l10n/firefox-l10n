...
webext-perms-description-clipboardRead = Získať údaje zo schránky
...
webext-perms-description-find = Prístup k textu všetkých otvorených kariet
webext-perms-description-geolocation = Prístup k údajom o polohe
webext-perms-description-history = Prístup k histórii prehliadania
...
webext-perms-description-proxy = Kontrola nad nastavením proxy
webext-perms-description-sessions = Prístup k nedávno zavretým kartám
webext-perms-description-tabs = Prístup ku kartám prehliadača
webext-perms-description-tabHide = Skrývať a zobrazovať karty prehliadača
webext-perms-description-topSites = Prístup k histórii prehliadania
webext-perms-description-webNavigation = Prístup k aktivitám prehliadača v priebehu prehliadania
