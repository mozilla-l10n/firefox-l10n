...
refresh-profile-dialog-title = Obnoviť { -brand-short-name(case: "acc") } na pôvodné nastavenia?
...
refresh-profile = Poupratuje si { -brand-short-name(case: "acc") }
refresh-profile-button = Obnoviť { -brand-short-name(case: "acc") }…
