...
details-notification-softblocked-extension-disabled =
    .message = Toto rozšírenie porušuje pravidlá Mozilly a bolo zakázané. Môžete ho povoliť, ale môže to byť riskantné.
...
details-notification-softblocked-other-disabled =
    .message = Tento doplnok porušuje pravidlá Mozilly a preto bol zakázaný. Môžete ho povoliť, ale môže to byť riskantné.
