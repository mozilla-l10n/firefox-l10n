...
details-notification-soft-blocked-extension-enabled2 =
    .message = Toto rozšírenie je obmedzené. Jeho používanie môže byť riskantné.
...
plugins-openh264-description = Tento zásuvný modul je automaticky inštalovaný Mozillou na zabezpečenie súladu so špecifikáciou pre WebRTC za účelom umožnenia hovorov prostredníctvom WebRTC so zariadeniami, ktoré vyžadujú videokodek H.264. Ďalšie informácie o implementácii a zdrojové kódy kodeku nájdete na stránkach https://www.openh264.org/.
