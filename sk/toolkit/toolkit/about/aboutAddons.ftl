...
details-notification-unsigned-and-disabled2 =
    .message = Doplnok { $name } nemohol byť overený pre použitie v prehliadači { -brand-short-name } a bol preto zakázaný.
...
details-notification-unsigned2 =
    .message = Doplnok { $name } nemohol byť overený pre použitie v prehliadači { -brand-short-name }. Pokračujte opatrne.
