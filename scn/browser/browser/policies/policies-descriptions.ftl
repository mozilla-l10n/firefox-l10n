...
policy-DisableFormHistory = Nun ricurdari a crunuluggìa di ricerca e dî mòduli.
...
policy-DisablePrivateBrowsing = Disabbìlita a Navigazzioni privata.
...
policy-SanitizeOnShutdown2 = Cancella i dati di navigazzioni chiujennu.
