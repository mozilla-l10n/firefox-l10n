...
safe-mode-window =
    .title = Mudalità sicura di { -brand-short-name }
...
refresh-profile-instead = Po' macari sautari a risuluzziuni dî prubblemi e pruvari a ricarricari { -brand-short-name }.
