...
safeb-blocked-malware-page-error-desc-override = <span data-l10n-name='sitename'>{ $sitename }</span> fu <a data-l10n-name='error_desc_link'>signalatu comu un situ cu prugrammi nun sicuri</a>. Po' <a data-l10n-name='report_detection'>signalari un prubblema di rilevamentu</a>, o <a data-l10n-name='ignore_warning_link'>nun tèniri cuntu dû rìsicu</a> e visitari stu situ nun sicuru.
safeb-blocked-malware-page-error-desc-no-override = <span data-l10n-name='sitename'>{ $sitename }</span> fu <a data-l10n-name='error_desc_link'>signalatu comu un situ cu prugrammi nun sicuri</a>. Po' <a data-l10n-name='report_detection'>signalari un prubblema di rilevamentu</a>.
safeb-blocked-malware-page-learn-more = Vìsita <a data-l10n-name='learn_more_link'>StopBadware.org</a> pi sapiri soccu è u cuntinutu web piriculusu, nchiusi virus e autri prugrammi, e comu prutèggiri u to computer. Vai nne <a data-l10n-name='firefox_support'>support.mozilla.org</a> pi aviri cchiù nfurmazziuna supra i prutizziuna di { -brand-short-name }.
