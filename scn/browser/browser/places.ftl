...
places-open-all-bookmarks =
    .label = Grapi tutti i nzingalibbra
    .accesskey = G
places-history =
    .aria-label = Crunuluggìa
places-bookmarks-search =
    .placeholder = Riscedi nnî nzingalibbra
places-delete-domain-data =
    .label = Scòrdati stu situ
    .accesskey = S
# Managed bookmarks are created by enterprise policy and cannot be changed by the user.
managed-bookmarks =
    .label = Nzingalibbra manijati
...
places-manage-bookmarks =
    .label = Manija nzingalibbra
    .accesskey = M
places-organize-button =
    .label = Urganizza
    .tooltiptext = Urganizza i to nzingalibbra
    .accesskey = U
