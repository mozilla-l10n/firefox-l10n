...
fp-certerror-bad-domain-what-can-you-do-body = Capaci nenti, picchì è pussìbbili chi cc'è un prubblema cû situ stissu. I siti ùsanu cirtificati criati d'auturità di cirtificazzioni pi virificari chi sunnu cu' dìcinu di èssiri. Ma si sì cullijatu a na riti di n'azzienna, a to squatra di supportu ti po' dari cchiù assai nfurmazzioni. Si stai usannu un prugramma antivirus, prova a circari si cci sunnu cunflitti o prubblemi già canusciuti.
