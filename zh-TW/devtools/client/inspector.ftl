...
colorpicker-tooltip-spectrum-dragger-title = 色暈
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = 從頁面挑選顏色
...
colorpicker-tooltip-hue-slider-title = 色調
...
inspector-split-orientation-button-title = 面板版面
...
inspector-split-orientation-side-by-side = 並排
# A label for the split orientation menu item that locks the panels on top of
# each other.
inspector-split-orientation-stacked = 堆疊
