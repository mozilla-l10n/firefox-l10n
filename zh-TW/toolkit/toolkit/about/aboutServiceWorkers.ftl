...
about-service-workers-title = 關於 Service Worker
about-service-workers-main-title = 註冊的 Service Worker
about-service-workers-warning-not-enabled = 未啟用 Service Worker。
about-service-workers-warning-no-service-workers = 未註冊 Service Worker。
