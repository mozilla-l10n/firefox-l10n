...
contextual-manager-passwords-origin-field-description = 請輸入用於登入此網站的完整網址。
contextual-manager-passwords-username-field =
    .label = 使用者名稱
contextual-manager-passwords-username-field-description = 請輸入用於登入此網站的帳號、使用者名稱，或電子郵件地址。
contextual-manager-passwords-password-field =
    .label = 密碼
contextual-manager-passwords-password-field-description = 請輸入登入此網站的密碼。
