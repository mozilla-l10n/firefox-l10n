...
content-blocking-and-isolating-etp-warning-description-3 = 此設定可能會造成某些網站無法顯示內容或無法正常運作。我們會提供可能受您設定影響的網站清單，讓您可決定是否排除。若要減少網站故障的機會，請將這些追蹤器列入例外清單放行。若某個網站看起來異常，也可以針對該網站關閉追蹤保護功能，讓網站載入所有內容，並且回報給我們，為所有人修正問題。
...
content-blocking-baseline-exceptions =
    .label = 允許 { -brand-short-name } 自動套用必要的例外清單，以避免主要網站故障。
content-blocking-convenience-exceptions =
    .label = 也自動套用只有在修正小問題、並提供各種方便功能所需的例外清單。
