...
more-from-moz-thunderbird-description = 免費的電子郵件、行事曆、聯絡人軟體 — 用您的方式管理。
...
more-from-moz-firefox-mobile-qr-promo =
    .message = 用您手機或平板電腦的攝影機掃描，在鏈結出現時點擊，即可下載應用程式。
...
more-from-moz-solo-card =
    ...
    .description = 探索我們最新的創意與實驗性技術。
more-from-moz-new-products-card =
    .label = { -vendor-short-name } 的新產品
    .description = 探索來自 { -vendor-short-name } 的新產品。
