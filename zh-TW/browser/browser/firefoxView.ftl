...
firefoxview-syncedtabs-synctabs-description-2 = 重新開啟同步，即可快速存取您其他裝置上的分頁。
...
firefoxview-tabpickup-network-offline-description-2 = 可能是您的網路中斷，或某些問題影響連線。
...
firefoxview-tabpickup-signed-out-description-2 = 重新連線即可檢視其他裝置的分頁。
