...
welcome-back-spotlight-title = 回到內建隱私保護功能
welcome-back-spotlight-subtitle = 歡迎回到唯一一套由非營利組織在背後全力相挺的主流瀏覽器。無論您身在何處，我們都會採取額外措施來保護您的資料。
welcome-back-embedded-import-title = 匯入您的資料，讓使用 { -brand-short-name } 像是回到家一樣
...
etp-strict-exceptions-infobar-message = <strong>嚴格追蹤保護可能會造成網站故障。</strong>取消封鎖一些可能包含追蹤器的重要網頁元素，可修正常見問題。
...
refresh-unused-profile-infobar-message = 歡迎回來！看來您好一陣子沒有開啟 { -brand-short-name } 了，您想要清理一下設定檔，讓您能有彷彿全新安裝一般的體驗嗎？
