...
clear-data-for-site-title = 要清除此網站的所有資料嗎？
# Variables:
...
clear-data-for-site-exceptions = 不會清除書籤與網站密碼
clear-data-for-site-dialog-accept-button = 清除資料
clear-data-for-site-dialog-cancel-button = 取消
