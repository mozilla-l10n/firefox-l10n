...
shopping-message-bar-thanks-for-reporting-message = 我們將在約 24 小時後提供更新過的分析資訊，請稍候再回來。
shopping-message-bar-warning-product-not-available-reported-title = 即將提供分析資訊
shopping-message-bar-warning-product-not-available-reported-message = 將在約 24 小時後提供更新過的分析資訊，請稍候再回來。
