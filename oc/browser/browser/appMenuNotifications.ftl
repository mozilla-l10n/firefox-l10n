...
appmenu-addon-post-install-message-with-data-collection = Podètz actualizar las autorizacions e preferéncias de donadas quand volgatz dins los <a data-l10n-name="settings-link">paramètres d’exetension</a>.
