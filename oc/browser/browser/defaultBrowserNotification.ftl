...
default-browser-prompt-button-primary-set = Definir coma navegador principal
...
default-browser-guidance-notification-title = Definir { -brand-short-name } coma navegador per defaut
