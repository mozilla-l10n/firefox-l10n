...
about-httpsonly-title = { -brand-short-name } a detectat un problèma de seguretat potencial
# Variables:
#   $websiteUrl (String) - Url of the website that failed to load. Example: www.example.com
about-httpsonly-explanation-unavailable = Vòstre navegador es en mòde HTTPS-Only e cap de version de HTTPS securizada de <em>{ $websiteUrl }</em> es pas disponibla.
