...
plugins-openh264-description = Aqueste plugin es automaticament installat per Mozilla per complir las especificacions WebRTC e permetre las cridas WebRTC amb los periferics que lor cal lo codec vidèo H.264. Anatz sus https://www.openh264.org/ per consultar lo còde font del codec e ne saber mai sus son implementacion.
