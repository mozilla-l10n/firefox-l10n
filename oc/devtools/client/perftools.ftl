...
perftools-onboarding-message = <b>Novetat</b> : { -profiler-brand-name } es ara integrat a las aisinas de desvolopaire. <a>Ne saber mai</a> a prepaus d’aquesta aisina novèla.
