...
colorpicker-tooltip-spectrum-dragger-title = Espèctre
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = Seleccionar una color per la pagina
...
colorpicker-tooltip-color-name-title = Color mai prèp : { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Tinta
