...
connection-proxy-https-sharing =
    .label = এছাড়াও HTTPS এর জন্য এই প্রক্সি ব্যবহার করুন
    .accesskey = s
...
connection-proxy-noproxy-localhost-desc-2 = লোকালহোস্ট, 127.0.0.1/8, এবং ::1 এর সাথে সংযোগগুলি কখনই প্রক্সি করা হয় না।
