...
devinfo-serialnum =
    .label = ক্রমিক সংখ্যা
fips-nonempty-primary-password-required = FIPS মোডের জন্য আপনার প্রতিটি নিরাপত্তা ডিভাইসের জন্য একটি প্রাথমিক পাসওয়ার্ড সেট থাকা প্রয়োজন। FIPS মোড সক্রিয় করার চেষ্টা করার আগে পাসওয়ার্ড সেট করুন.
...
load-module-help-root-certs-module-name =
    .value = 'রুট সার্টিস' সংরক্ষিত এবং মডিউল নাম হিসাবে ব্যবহার করা যাবে না।
