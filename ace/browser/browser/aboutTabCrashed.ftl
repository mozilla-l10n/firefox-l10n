...
crashed-title = Bri thèe na reulöh tab
...
crashed-request-help-message = Laporan peu-peu nyang reuleh that meubantu  jeut kamoe paréksa peu na masalah, ngon mangat kamoe peugèt { -brand-short-name } keu leubèh get lom.
...
crashed-email-me = Neu kirém Email keu ulôn pajan mantong na haba
