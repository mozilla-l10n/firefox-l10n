...
restore-page-window-label = Tingkap { $windowNumber }

restore-page-restore-header =
    .label = Peuriwang

restore-page-list-header =
    .label = Tingkap ngon Tab

restore-page-try-again-button =
    .label = Peuriwang Sesi
    .accesskey = R

restore-page-close-button =
    .label = Mula Sesi Barô
    .accesskey = N

## The following strings are used in about:welcomeback

welcome-back-tab-title = Meuhasé!
welcome-back-page-title = Meuhasé!
welcome-back-page-info = { -brand-short-name } ka bèrèh.
