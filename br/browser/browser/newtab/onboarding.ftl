...
onboarding-live-language-subtitle = { -brand-short-name } a zo e { $appLanguage } padal ez eo e { $systemLanguage } ho reizhiad.
onboarding-live-language-switch-button-label = Dibab { $negotiatedLanguage }
onboarding-live-language-button-label-downloading = O pellgargañ ar pakad yezh evit { $negotiatedLanguage }...
onboarding-live-language-waiting-subtitle = War a-seblant e vez implijet yezhoù disheñvel gant { -brand-short-name } hag ho reizhiad.
...
onboarding-live-language-not-now-button-label = Ket bremañ
