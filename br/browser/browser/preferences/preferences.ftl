...
pane-privacy-title2 = Buhez prevez & Diogelroez
...
applications-setting =
    .label = Arloadoù
    .description = Dibab penaos eo meret ar restroù pellgarget war ar web pe an arloadoù arveret p’emaoc’h o verdeiñ gant { -brand-short-name }.
