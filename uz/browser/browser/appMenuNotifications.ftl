...
appmenu-update-restart =
    ...
    .secondarybuttonlabel = Hozir emas
    .secondarybuttonaccesskey = H
appmenu-update-restart-message = Tezkor qayta ishga tushirishdan keyin { -brand-shorter-name } barcha ochiq qolgan oyna va ichki oynalarni tiklaydi. Faqatgina Maxfiy koʻrish rejimidagi oynalarni tiklay olmaydi.
