...
certmgr-tab-ca =
    .label = Autoritete
certmgr-mine = Keni dëshmi që ju identifikojnë prej këtyre organizmave
...
certmgr-period-of-validity-label =
    .value = Periudhë Vlefshmërie
certmgr-fingerprints-label =
    .value = Shenja gishtash
certmgr-cert-detail =
    .title = Hollësi Dëshmie
    .buttonlabelaccept = Mbylleni
    .buttonaccesskeyaccept = M
certmgr-cert-detail-cn =
    .value = Emër i Rëndomtë (ER)
certmgr-cert-detail-o =
    .value = Organizëm (O)
certmgr-cert-detail-ou =
    .value = Njësi Organizative (OU)
certmgr-cert-detail-serialnumber =
    .value = Numër Serial
certmgr-cert-detail-sha256-fingerprint =
    .value = Shenja gishtash SHA-256
certmgr-cert-detail-sha1-fingerprint =
    .value = Shenja gishtash SHA1
...
pkcs12-decode-err = Dështoi në shkodimin e kësaj kartele. Ose nuk është në format PKCS #12, ose është dëmtuar, ose fjalëkalimi që dhatë nuk qe i saktë.
pkcs12-unknown-err-restore = Dështoi në rikthimin e kartelës PKCS #12 për arsye të panjohura.
pkcs12-unknown-err-backup = Për arsye të panjohura, dështoi në krijimin e kartelës kopjeruajtëse PKCS #12.
