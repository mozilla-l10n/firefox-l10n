...
master-password-description = Fjalëkalimi i Përgjithshëm përdoret për të mbrojtur të dhëna me zarar, si p.sh. fjalëkalime sajtesh.  Nëse krijoni një Fjalëkalim të Përgjithshëm, do t'ju kërkohet ta jepni atë një herë për çdo sesion, sa herë që { -brand-short-name }-i merr të dhënat e ruajtura të mbrojtura me fjalëkalim.
