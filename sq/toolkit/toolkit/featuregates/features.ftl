...
experimental-features-accessibility-cache-description = Ruaj në fshehtinë krejt informacionin lidhur me përdorim nga persona me aftësi të kufizuara, nga krejt dokumentet te procesi kryesor { -brand-short-name }. Kjo përmirëson funksionimin për lexues ekrani dhe aplikacione të tjera që përdorin API përdorimi nga persona me aftësi të kufizuara.
