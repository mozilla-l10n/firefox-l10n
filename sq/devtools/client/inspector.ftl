...
colorpicker-tooltip-spectrum-dragger-title = Spektër
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = Merrni ngjyrë në faqe
...
colorpicker-tooltip-color-name-title = Më e afërta te: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Ngjyresë
# A title text for the alpha slider in the color picker tooltip.
colorpicker-tooltip-alpha-slider-title = Patejdukshmëri
