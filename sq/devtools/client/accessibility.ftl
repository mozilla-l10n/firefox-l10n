...
accessibility-text-label-issue-fieldset-legend = Përdorni elementin <code>legend</code> që të etiketoni elementë <span>fieldset</span>. <a>Mësoni më tepër</a>
...
accessibility-text-label-issue-optgroup-label = Për të etiketuar elementë <span>optgroup</span> përdorni atributin <code>label</code>. <a>Mësoni më tepër</a>
