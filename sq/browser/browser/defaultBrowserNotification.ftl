...
default-browser-prompt-message-pin-msix = Kijeni { -brand-short-name }-in në majë të gishtave — bëjeni shfletuesin tuaj parazgjedhje dhe fiksojeni te paneli juaj i punëve dhe te menuja e nisjes.
...
default-browser-prompt-button-primary-set = Vëre si shfletuesin parësor
