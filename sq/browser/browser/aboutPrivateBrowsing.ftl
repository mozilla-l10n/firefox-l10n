...
about-private-browsing-info-saved = { -brand-short-name }-i <strong>do të ruajë</strong>:
...
about-private-browsing-note = Shfletimi Privat <strong>nuk ju bën anonim</strong> në Internet. Punëdhënësi juaj apo furnizuesi juaj i shërbimit internet mundet prapëseprapë të mësojë se cilat faqe vizitoni.
