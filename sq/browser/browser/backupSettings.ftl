...
restore-from-backup-type-group-label =
    .label = Të zëvendësohet profili i tanishëm?
...
backup-file-creation-metadata = { $profileName } Krijuar më { DATETIME($date, year: "numeric", month: "numeric", day: "numeric") } te { $machineName }
# Variables:
