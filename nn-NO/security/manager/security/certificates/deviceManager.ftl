...
fips-nonempty-primary-password-required = FIPS-moduset krev at du har eit hovudpassord instilt for kvar tryggingseining. Lag passord før du slår på FIPS-modus.
