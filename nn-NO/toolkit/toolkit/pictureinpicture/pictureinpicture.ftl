...
pictureinpicture-playback-rate-btn =
    .tooltip = Avspelingsfart
    .aria-label = Avspelingsfart
...
pictureinpicture-playback-rate-panel-accessible = Innstillingar for avspelingsfart
pictureinpicture-playback-rate-label = Avspelingsfart
