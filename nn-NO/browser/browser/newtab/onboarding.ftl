...
smartwindow-existing-user-fx-tou-body = For å bruke { -smart-window-brand-name }, må du godta <a data-l10n-name="terms_of_use">bruksvilkårene</a> og den oppdaterte <a data-l10n-name="privacy_notice">personvernfråsegna</a>.
