...
newtab-privacy-etp-off-faster-browsing = Raskare nettlesing. Færre sporarar.
newtab-privacy-etp-off-turn-on-tracking = Slå på sporingsvern i innstillingane for å starte blokkering.
...
newtab-privacy-message-info-9 = Gjer { -brand-short-name } til din føretrekte nettlesar med innebygd personvern.
newtab-privacy-message-info-9-cta = Bruk som standard
newtab-privacy-message-info-10 = Lagre passord i { -brand-short-name } for å bruke sterke, unike innloggingar overalt.
...
newtab-spaces-tab-stories = Artiklar
...
newtab-nova-customization-callout-header = Set prikken over i-en på { -brand-product-name }
newtab-nova-customization-callout-message = Utforsk lyse eller mørke tema og bakgrunnar som får den nye { -brand-product-name } til å kjennast meir som din.
newtab-nova-customization-callout-primary-button =
    .label = Vel utsjånaden din
...
newtab-clock-city-mx-mexico-city = Mexico by
...
newtab-clock-city-vn-ho-chi-minh-city = Ho Chi Minh-byen
