...
smart-window-confirm-open-tab = Opne
# Button label - "Open" is a verb (action to open, then group, tabs)
smart-window-confirm-open-tabs =
    { $count ->
        [one] Opne { $count } fane
       *[other] Opne { $count } faner
    }
...
action-log-searching-web-with-exa = Søk på nettet med <a data-l10n-name="exa-link">Exa</a>
# Exa is the name of a third-party web search API and a brand name that
# should not be translated. The <a> wraps "Exa" as a link to a support
# article explaining the third-party web search integration.
action-log-searched-web-with-exa = Søkte på nettet med <a data-l10n-name="exa-link">Exa</a>
...
smartwindow-assistant-citations-more-label = +{ $count } til
