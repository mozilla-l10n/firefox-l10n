...
tls-key-logging-notice-nav =
    .label = Ein app eller ei teneste kan sjå den krypterte trafikken din.
category-list =
...
containers-external-links-check =
    .label = Ikkje bruk behaldarar for lenker opna frå eksterne appar
    .accesskey = I
...
containers-sites-card-header =
    .description = Vel ein behaldar for ein nettstad, og { -brand-short-name } vil bruke den kvar gong nettstaden blir opna.
    .label = Stadsspesifikke behaldarar
containers-sites-add-button =
    .label = Legg til nettstad
    .accesskey = L
...
personal-info-group =
    .label = Personleg informasjon
autofill-personal-info-checkbox-message =
    .label = Lagre og fyll ut personleg informasjon automatisk
autofill-personal-info-manage-button =
    .label = Handsam personleg informasjon
...
autofill-personal-info-manage-title =
    .heading = Handsam personleg informasjon
...
preferences-ai-controls-speech-recognition-control =
    ...
    .label = Taleattkjenning
preferences-ai-controls-sidebar-chatbot-group-3 =
    .description = Ha ein chatbot i sikte medan du surfar. Vel mellom fleire leverandørar og byt når som helst.
    .label = KI-chatbotleverandørar i sidestolpen
preferences-ai-controls-sidebar-chatbot-group-2 =
    .description = Hald ein chatbot synleg medan du surfar. Vel mellom Anthropic Claude, ChatGPT, Copilot, Google Gemini og Mistral Vibe.
    .label = KI-chatbotleverandørar i sidestolpen
...
preferences-etp-tracker-count-enabled =
    .label = Vis blokkerte sporarar i adressefeltet
...
preferences-etp-custom-cookie-behavior-block-cross-site-tracking-cookies =
    .label = Blokker sporingsinfokapslar på tvers av nettstadar
...
security-privacy-issue-warning-doh2 =
    .description = DNS-over-HTTPS bidreg til å skjule kva nettstadar du er i ferd med å besøkje, frå nettverksleverandøren din.
    .label = DNS-over-HTTPS er slått av
security-privacy-issue-warning-ech2 =
    .description = Encrypted Client Hello bidreg til å skjule kva nettstadar du er i ferd med å besøkje, frå nettverksleverandøren din.
