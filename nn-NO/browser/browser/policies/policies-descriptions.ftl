...
policy-AIControls = Konfigurer KI-kontrollar.
...
policy-Backup = Deaktiver sikkerheitskopiering eller gjenoppretting av profildata.
...
policy-ClearOnShutdown = Fjernt nettlesardata når { -brand-short-name } vert attlaten.
...
policy-DisableRemoteImprovements = Hindre { -brand-short-name } i å bruke endringar i yting, stabilitet og funksjonar mellom oppdateringar.
policy-DisableRemoteSettingsAndAcceptSecurityConsequences = Slå av fjerninnstillingar.
...
policy-GenerativeAI = Konfigurer generative KI-funksjonar.
...
policy-SitePolicies = Nettstadspesifikke policyar.
