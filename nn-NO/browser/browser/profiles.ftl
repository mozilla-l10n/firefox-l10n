...
edit-profile-page-desktop-shortcut-toggle-2 =
    .label = Opprett snarveg på skrivebordet
...
copied-profile-page-header-2 = Kopien din av «{ $profilename }» er klar for tilpassing
...
# Variables
#   $profilename (String) - The name of the profile.
delete-profile-header-2 = Slette profilen «{ $profilename }»?
...
barbell-avatar-tooltip =
    .tooltiptext = Bruk vektstong-avatar
bike-avatar-tooltip =
...
craft-avatar-tooltip =
    .tooltiptext = Bruk handverks-avatar
# Globe refers to the generic globe/world icon that appears in browser tabs when a website doesn't have its own favicon.
...
hammer-avatar-tooltip =
    .tooltiptext = Bruk hammar-avatar
heart-avatar-tooltip =
    .tooltiptext = Bruk hjarte-avatar
heart-rate-avatar-tooltip =
    .tooltiptext = Bruk hjartefrekvens-avatar
...
video-game-controller-avatar-tooltip =
    .tooltiptext = Bruk videospelkontrollar-avatar
