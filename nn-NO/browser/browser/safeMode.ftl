...
troubleshoot-mode-description = Bruk denne spesielle modusen i { -brand-short-name } for å diagnostisere problem. Utvidingane og tilpassingane dine vert mellombels deaktiverte.
