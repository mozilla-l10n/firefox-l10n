...
fxa-menu-sync-your-data = Synkroniser dataa dine
...
appmenuitem-monitor-title-signed-in = { -monitor-brand-short-name } Varslar om datalekkasjar
...
appmenuitem-vpn-description4 = Få ekstra vern på tvers av appar og einingar
