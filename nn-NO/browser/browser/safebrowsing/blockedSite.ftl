...
safeb-blocked-addon-page-learn-more3 = <a data-l10n-name='firefox_support_harmful_addons'>Les meir om { -brand-short-name } sitt vern mot skadelege tillegg</a>.
safeb-blocked-addon-page-learn-more = <a data-l10n-name='firefox_support'>Les meir om vern mot nettfisking og skadeprogram i { -brand-short-name }</a>.
