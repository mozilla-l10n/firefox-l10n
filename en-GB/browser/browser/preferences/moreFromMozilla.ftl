...
more-from-moz-solo-description = Create your web site instantly and connect your own custom domain for free.
more-from-moz-solo-button = Try { -solo-ai-brand-name }
more-from-moz-solo-title-2 = { -solo-ai-brand-name } AI Web Site Creator
...
more-from-moz-thunderbird-description = Free email, calendar and contacts — organised your way.
...
more-from-moz-solo-card-1 =
    ...
    .description = Create your web site instantly and connect your own custom domain for free.
