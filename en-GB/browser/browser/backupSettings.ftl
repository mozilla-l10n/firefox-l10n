...
password-rules-email-description2 = Not an email address
...
# application menu.
backup-file-moz-browser-restore-step-1 = Open the application menu ☰ and go to Settings > Synchronisation
...
# The ☰ character is intended as a visual icon representing the Firefox
# application menu.
backup-file-other-browser-restore-step-2 = Start { -brand-short-name }, open the application menu ☰ and go to Settings > Synchronisation
...
backup-file-creation-metadata2 = <b>{ $profileName }</b> created on { DATETIME($date, day: "numeric", month: "numeric", year: "numeric") } on { $machineName }
# Variables:
#   $deviceName (String) - The name of the device from which the backup was created.
#   $date (Number) - The epoch timestamp of the restore.
backup-restored-profile-name = Restored from { $deviceName } on { DATETIME($date, day: "numeric", month: "numeric", year: "numeric") } at { DATETIME($date, hour: "2-digit", minute: "2-digit") }
