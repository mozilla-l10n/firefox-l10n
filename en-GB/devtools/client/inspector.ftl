...
colorpicker-tooltip-eyedropper-title = Pick colour on page
...
inspector-color-scheme-emulation-light =
    .title = Toggle light colour scheme emulation for the page
# A title text for the dark color scheme emulation options
inspector-color-scheme-emulation-dark =
    .title = Toggle dark colour scheme emulation for the page
...
inspector-emulation-panel-color-scheme = Colour scheme emulation
...
inspector-emulation-panel-color-scheme-none = No emulation
    .aria-label = Disable colour scheme emulation
