...
# Variables:
#   $hostname (string) - Hostname of the website with cert error.
cert-error-revoked = Web sites prove their identity via certificates. { -brand-short-name } doesn’t trust { $hostname } because it uses a certificate that has been revoked.
