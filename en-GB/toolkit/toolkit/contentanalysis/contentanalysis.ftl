...
contentanalysis-slow-agent-dialog-body-file-and-more =
    { $count ->
        [one] { $agent } is reviewing “{ $filename }” and { $count } additional item against your organisation’s data policies. This may take a moment.
       *[other] { $agent } is reviewing “{ $filename }” and { $count } additional items against your organisation’s data policies. This may take a moment.
    }
# Variables:
#   $agent - The name of the DLP agent doing the analysis
...
# Variables:
#   $agent - The name of the DLP agent doing the analysis
contentanalysis-slow-agent-dialog-body-clipboard-copy = { $agent } is reviewing what you copied against your organisation’s data policies. This may take a moment.
...
contentanalysis-clipboard-copy-blocked-replacement = Copying this content is restricted by your organisation.
...
# Variables:
#   $filename - Name of the file that was blocked, such as "aFile.txt"
contentanalysis-block-dialog-body-download-file = Under your organisation’s data protection policies, you’re not permitted to download the file “{ $filename }”. Contact your administrator for more info.
...
contentanalysis-block-dialog-body-clipboard-copy = Under your organisation’s data protection policies, you’re not permitted to copy this content. Contact your administrator for more info.
