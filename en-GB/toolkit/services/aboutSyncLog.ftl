...
about-sync-log-title = Synchronisation logs
about-sync-log-page-header =
    .description = Diagnostic logs written by synchronisation.
    .heading = Synchronisation logs
...
about-sync-log-row-success =
    .heading = Success — { DATETIME($date, dateStyle: "medium", timeStyle: "medium") }
# Variables:
#   $date (number) - Timestamp of when the log was written.
about-sync-log-row-error =
    .heading = Error — { DATETIME($date, dateStyle: "medium", timeStyle: "medium") }
...
about-sync-log-empty = No synchronisation logs have been recorded.
...
about-sync-log-clear-confirm-title = Clear synchronisation logs?
# Variables:
