...
find-more-addons-promo =
    .heading = Mukauta { -brand-product-name }ia omalla tavallasi
    .message = Lisää työkaluja ja tyylejä tarpeidesi sekä makusi mukaan.
find-more-addons-promo-open-amo-button = Selaa laajennuksia ja teemoja
...
find-more-extensions-promo =
    .heading = Löydä seuraava suosikkilaajennuksesi
    .message = Mukauta { -brand-product-name }ia työkaluilla keskittymiseen, yksityisyyteen, ostosten tekemiseen ja muuhun.
find-more-extensions-promo-open-amo-button = Selaa laajennuksia
...
find-more-themes-promo =
    .heading = Löydä lisää raikkaita tyylejä
    .message = Valitse tyyli, joka saa { -brand-product-name }in tuntumaan omaltasi.
...
list-empty-get-extensions-promo =
    .heading = Muutamalla laajennuksella pääsee pitkälle
    .message = Meillä on suosituksia, jotka auttavat sinua parantamaan keskittymistä, yksityisyyttä ja paljon muuta.
list-empty-get-extensions-promo-button = Löydä ensimmäinen laajennuksesi
...
aboutaddons-themes-picker-heading =
    .heading = { -brand-product-name }-teemat
# Show more / show less button at the bottom of the themes picker
aboutaddons-themes-picker-see-more = Näytä enemmän
aboutaddons-themes-picker-see-less = Näytä vähemmän
...
aboutaddons-themes-picker-error-message =
    .message = Teeman päivittäminen epäonnistui. Tarkista verkkoyhteys ja yritä uudelleen.
...
aboutaddons-linux-theme-colors-checkbox-label =
    .label = Käytä Linux-järjestelmän teemaa
