...
third-party-requires-restart = { -brand-short-name } on käynnistettävä uudestaan, jotta kolmannen osapuolen moduulien estojen muutokset tulevat voimaan.
...
third-party-should-restart-ok = Käynnistä { -brand-short-name } uudestaan nyt
