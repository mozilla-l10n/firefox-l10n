...
autofill-insecure-field-warning-description = { -brand-short-name } on havainnut suojaamattoman sivuston. Lomakkeiden automaattitäyttö on väliaikaisesti pois käytöstä.
