...
newtab-menu-add-topsite = Lisää uusi oikotie
...
newtab-clock-city-de-berlin = Berliini
newtab-clock-city-de-munich = München
newtab-clock-city-de-frankfurt = Frankfurt am Main
newtab-clock-city-de-hamburg = Hampuri
newtab-clock-city-fr-paris = Pariisi
...
newtab-clock-city-pl-warsaw = Varsova
...
newtab-clock-city-ru-saint-petersburg = Pietari
newtab-clock-city-gb-london = Lontoo
...
newtab-clock-city-ua-kyiv = Kiova
...
newtab-clock-city-se-stockholm = Tukholma
...
newtab-clock-city-dk-copenhagen = Kööpenhamina
...
newtab-clock-city-lv-riga = Riika
...
newtab-clock-city-vn-ho-chi-minh-city = Hồ Chí Minhin kaupunki
