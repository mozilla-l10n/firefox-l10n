...
launch-on-login-autostart-infobar-message = { -brand-short-name } käynnistyy jatkossa, kun kirjaudut Windowsiin. Voit muuttaa tätä myöhemmin asetuksista.
launch-on-login-autostart-infobar-keep-button = Pidä käytössä
    .accesskey = P
launch-on-login-autostart-infobar-turn-off-button = Poista käytöstä
    .accesskey = o
...
welcome-back-spotlight-title = Palaa sisäänrakennetun yksityisyyden pariin
welcome-back-spotlight-subtitle = Tervetuloa takaisin ainoaan voittoa tavoittelemattoman järjestön tukemaan merkittävään selaimeen. Ryhdymme lisätoimenpiteisiin suojataksemme tietojasi missä tahansa olet.
welcome-back-embedded-import-title = Tuo tietosi ja tee { -brand-short-name }ista kotoisa
...
launch-options-spotlight-title-launch-on-login = Käynnistetäänkö { -brand-short-name } aina, kun kirjaudut Windowsiin?
launch-options-spotlight-title-session-restore = Haluatko avata istunnon uudelleen, kun { -brand-short-name } käynnistyy uudelleen?
launch-options-spotlight-checkbox-launch-on-login = Avaa { -brand-short-name } käynnistyksen yhteydessä
launch-options-spotlight-checkbox-pin-to-taskbar = Kiinnitä tehtäväpalkkiin
# Shown on the browser-close prompt only
launch-options-spotlight-checkbox-restore-current = Avaa nykyiset ikkunat ja välilehdet uudelleen
# Shown on the browser-launch prompt only
launch-options-spotlight-checkbox-restore-previous = Avaa uudelleen edelliset ikkunat ja välilehdet
# Primary button on the browser-close prompt
launch-options-spotlight-primary-button-close = Tallenna ja sulje { -brand-short-name }
# Primary button on the browser-launch prompt
launch-options-spotlight-primary-button-launch = Tallenna ja jatka
...
lapsed-user-toast-title = { -brand-product-name } on yhä tukenasi
lapsed-user-toast-subtitle = Tutustu uusiin selaustapoihin, jotka tarjoavat enemmän valinnanvaraa, yksityisyyttä ja hallintaa.
lapsed-user-toast-whats-new-button = Tutustu uutuuksiin
lapsed-user-toast-dismiss-button = Hylkää
...
refresh-unused-profile-infobar-message = Näyttää siltä, että { -brand-short-name }ia ei ole käynnistetty aikoihin. Siivotaanko asetuksia niin, että käyttökokemus on varmasti näpsäkkä ja uudenveroinen? Ja tervetuloa muuten takaisin!
refresh-reinstalled-profile-infobar-message = Näyttää siltä, että olet asentanut { -brand-short-name }in uudestaan. Siivotaanko asetuksia niin, että käyttökokemus on varmasti näpsäkkä ja uudenveroinen?
refresh-profile-infobar-button = Palauta { -brand-short-name } uudenveroiseksi…
    .accesskey = P
