...
about-private-browsing-info-saved = { -brand-short-name } <strong>tallentaa</strong>
...
about-private-browsing-note = Yksityinen selaus <strong>ei tee sinusta anonyymiä</strong> Internetissä. Työnantajasi tai Internet-palveluntarjoajasi voi edelleen tietää, millä sivuilla on vierailtu.
