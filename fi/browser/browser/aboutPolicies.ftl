...
no-specified-policies-message = Yrityskäytännöt-palvelu on aktiivinen, mutta käytäntöjä ei ole käytössä.
inactive-message = Yrityskäytännöt-palvelu ei ole aktiivinen.
