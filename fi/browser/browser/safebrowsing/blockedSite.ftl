...
safeb-blocked-malware-page-error-desc-override = Sivuston <span data-l10n-name='sitename'>{ $sitename }</span> on <a data-l10n-name='error_desc_link'>ilmoitettu sisältävän haittaohjelmia</a>. Voit <a data-l10n-name='report_detection'>ilmoittaa tunnistusongelmasta</a> tai <a data-l10n-name='ignore_warning_link'>jättää riskin huomiotta</a> ja siirtyä turvattomalle sivustolle.
safeb-blocked-malware-page-error-desc-no-override = Sivuston <span data-l10n-name='sitename'>{ $sitename }</span> on <a data-l10n-name='error_desc_link'>ilmoitettu sisältävän haittaohjelmia</a>. Voit <a data-l10n-name='report_detection'>ilmoittaa tunnistusongelmasta</a>.
