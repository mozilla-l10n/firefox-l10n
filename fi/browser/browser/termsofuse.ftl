...
tou-existing-user-spotlight-body = Olemme esitelleet <a data-l10n-name="terms-of-use">käyttöehdot</a> ja päivittäneet <a data-l10n-name="privacy-notice">tietosuojakäytäntömme</a>.<br><br> Käytä hetki aikaa lukeaksesi ja hyväksyäksesi ehdot. <a data-l10n-name="learn-more">Lisätietoja</a>.
tou-existing-user-spotlight-remind-me-later = Muistuta myöhemmin
