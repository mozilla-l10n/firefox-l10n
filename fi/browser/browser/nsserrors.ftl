...
ssl-error-token-insertion-removal = PKCS#11-vuoromerkki lisättiin tai poistettiin kesken toiminnon.
ssl-error-token-slot-not-found = No PKCS#11-vuoromerkkiä tarvittavan toiminnon tekemiseen ei löytynyt.
...
sec-error-no-token = Tietoturvakorttia tai -vuoromerkkiä ei ole olemassa, täytyy alustaa tai on poistettu.
sec-error-read-only = tietoturvakirjasto: tietokanta, johon on vain lukuoikeus.
sec-error-no-slot-selected = Yhtäkään paikkaa tai vuoromerkkiä ei ole valittu.
