...
options-use-sync = Jos haluat, että profiilitietosi ovat samat kaikissa Firefoxin asennuksissa, voit käyttää { -fxaccount-brand-name }-palvelua pitääksesi ne synkronoituna.
resources = Resurssit:
