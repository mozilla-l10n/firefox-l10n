...
address-capture-never-save-addresses-button =
    .label = Älä koskaan tallenna osoitteita
    .accessKey = o
...
autofill-card-expires-month-2 =
    .label = Vanhenemiskuukausi
autofill-card-expires-year-2 =
    .label = Vanhenemisvuosi
...
autofill-card-search-term-credit-cards = maksukortit, luottokortit, luotto, credit, kortit, pankkikortit, debit, lompakko, kassa
...
autofill-add-passport-title = Lisää passi
# The dialog title for editing a passport in browser preferences.
autofill-edit-passport-title = Muokkaa passia
...
autofill-passport-issue-date = Myöntämispäivä
# Heading shown above the passport expiration date fields.
autofill-passport-expiry-date = Vanhenemispäivä
...
passport-capture-save-doorhanger-header = Tallennetaanko passi?
passport-capture-save-doorhanger-description = Tallenna tiedot { -brand-short-name }iin, jotta voit täyttää lomakkeita nopeasti.
