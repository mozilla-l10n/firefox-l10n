...
appearance-browser-icon-entry-group =
    ...
    .description = Valitse mukautettu kuvake tehtäväpalkkiin, työpöydälle ja käynnistysvalikkoon.
appearance-browser-icon-button =
    .label = Vaihda selaimen kuvake
...
appearance-browser-icon-pin-button =
    .label = Kiinnitä tehtäväpalkkiin
