...
callout-pdfjs-edit-title = Muokkaa PDF-tiedostoja uudella tekstityökalullamme
callout-pdfjs-edit-body-a = Täytä lomakkeita, lisää kommentteja tai tee muistiinpanoja suoraan { -brand-short-name }issa.
callout-pdfjs-edit-body-b = Lopeta ilmaisten verkkoeditorien etsiminen. Täytä lomakkeita, lisää kommentteja tai tee muistiinpanoja suoraan { -brand-short-name }issa.
callout-pdfjs-edit-button = Seuraava
callout-pdfjs-draw-title = Allekirjoita asiakirjat uudella piirtotyökalullamme
# “Mark up” refers to the process of “annotating” or adding free hand text or diagramming to the document.
callout-pdfjs-draw-body-a = Tee merkintöjä PDF-tiedostoihin ja tallenna muutokset.
# “Mark up” refers to the process of “annotating” or adding free hand text or diagramming to the document.
callout-pdfjs-draw-body-b = Ei enää tulostamista ja skannausta. Tee merkintöjä PDF-tiedostoihin ja tallenna muutokset.
callout-pdfjs-draw-button = Selvä!

## Firefox View Discoverability Strings

fx-view-discoverability-title = Eikö ollut tarkoitus sulkea sitä välilehteä?
fx-view-discoverability-subtitle = Etsi ja avaa se uudelleen täältä. Pidämme historiaa äskettäin suljetuista välilehdistä.
fx-view-discoverability-primary-button-label = Avaa { -firefoxview-brand-name }
fx-view-discoverability-secondary-button-label = Hylkää
...
tab-groups-2026-onboarding-callout-title = Karsi sotkua välilehtiryhmillä
...
tab-groups-2026-onboarding-callout-subtitle = Ryhmittele välilehdet tehtävän tai aiheen mukaan. Vedä lisää välilehtiä ryhmään, kun välilehtien määrä kasvaa.
...
tab-groups-2026-onboarding-cta-button = Luo ryhmä
...
sidebar-callout-survey-split-view = Katsele kahta verkkosivustoa kerralla, vierekkäin jaettuna
sidebar-callout-survey-keep-website-open = Pidä verkkosivusto, kuten sähköposti tai kalenteri, auki sivupalkissa selaamisen aikana
sidebar-callout-survey-saved-websites-2 = Nopea pääsy kirjanmerkkeihin
...
unified-search-engines-callout-title = Haku pikakomentoa käyttäen
