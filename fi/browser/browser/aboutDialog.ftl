...
helpus-referrals2 = Haluatko auttaa? <label data-l10n-name="helpus-donateLink">Lahjoita</label>, <label data-l10n-name="helpus-shareFirefoxLink">Jaa { -brand-product-name }</label> tai <label data-l10n-name="helpus-getInvolvedLink">osallistu!</label>
