...
fp-neterror-denied-port-access = یہ پتہ ایسا نیٹ ورک پورٹ استعمال کرتا ہے جو عمومی طور پر ویب براوزنگ کے علاوہ اور مقاصد کے لیے استعمال ہوتا ہے۔ { -brand-short-name } نے آپ کی حفاظت کے لیے درخواست منسوخ کر دی ہے۔
