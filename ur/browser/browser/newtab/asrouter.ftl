...
refresh-unused-profile-infobar-message = لگتا ہے کہ آپ نے { -brand-short-name } کافی دیر سے نہیں چلایا۔ کیا آپ اس کو ایک نئے، تازہ ترین تجربے کے لیے صاف کرنا چاہتے ہیں؟ اور ہاں، واپس آنے پر خوش آمدیدآ
