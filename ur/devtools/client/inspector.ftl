...
colorpicker-tooltip-eyedropper-title = صفحے پر رنگ کا انتخاب کریں
...
colorpicker-tooltip-color-name-title = کے  قریب ترین: { $colorName }
# A title text for the alpha slider in the color picker tooltip.
colorpicker-tooltip-alpha-slider-title = ‏‏دُھندلا پن
