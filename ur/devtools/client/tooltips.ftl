...
devtools-tooltip-learn-more = مزید  سیکھیں
...
inactive-css-not-inline-or-tablecell-fix-1 = شامل کرنے کی کوشش کریں<strong>display:inline</strong> or <strong>display:table-cell</strong>.
inactive-text-overflow-when-no-overflow-fix-1 = <strong> overflow:hidden </strong> شامل کرنے کی کوشش کریں۔
