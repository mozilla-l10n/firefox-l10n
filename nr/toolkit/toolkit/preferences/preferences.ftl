...
pw-remove-button =
    .label = Susa
set-password-old =
    .label = Inomboro yokungena Yanje:
set-password-new =
    .label = Tlola inomboro Yokungena Etja:
set-password-reenter =
    .label = Tloga Godu Inomboro Yokungena:
