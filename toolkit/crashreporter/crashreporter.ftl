...
crashreporter-title = Hlášení pádů
crashreporter-crash-message = Aplikace { -brand-short-name } zaznamenala neočekávaný problém a spadla. Po jejím restartu se pokusíme obnovit všechna okna a panely do původního stavu.
crashreporter-plea = Pokud nám chcete pomoci odhalit a opravit problém, který vedl k jejímu pádu, zašlete nám prosím hlášení o pádu.
...
crashreporter-button-quit = Ukončit aplikaci { -brand-short-name }
crashreporter-button-restart = Restartovat aplikaci { -brand-short-name }
