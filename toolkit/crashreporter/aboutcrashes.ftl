...
clear-all-reports-label = Ջնջել բոլոր զեկուցումները
delete-confirm-title = Դուք համոզվա՞ծ էք
delete-confirm-description = Սա կոչնչացնի բոլոր հաղորդագրությունները և ալյևս հնարավոր չի լինի վերականգնել:
