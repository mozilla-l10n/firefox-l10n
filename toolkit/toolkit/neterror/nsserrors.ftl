...
ssl-error-rx-unknown-record-type = SSL отримав запис з невідомим типом вмісту.
...
ssl-error-init-cipher-suite-failure = Не вдалося ініціювати вибраний набір шифрів.
...
ssl-error-unsupported-extension-alert = Вузол SSL не підтримує запитане розширення привітання TLS.
...
ssl-error-rx-malformed-new-session-ticket = SSL отримав неправильне повідомлення рукостискання New Session Ticket.
...
ssl-error-weak-server-ephemeral-dh-key = SSL отримав слабкий ефемерний ключ Діффі-Хеллмана в повідомленні рукостискання обміну ключами сервера.
