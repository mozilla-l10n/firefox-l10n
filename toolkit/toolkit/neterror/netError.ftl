...
neterror-dns-not-found-trr-only-could-not-connect = { -brand-short-name } не зміг з'єднатися з { $trrDomain }.
neterror-dns-not-found-trr-only-timeout = З'єднання з { $trrDomain } тривало довше, ніж очікувалося.
neterror-dns-not-found-trr-offline = У вас немає з'єднання з інтернетом.
