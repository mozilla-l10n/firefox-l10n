...
neterror-dns-not-found-trr-third-party-warning = ’S urrainn dhut leantainn air adhart le fuasglaiche DNS nach eil tèarainte. Ge-tà, dh’fhaoidte gum faic treas-phàrtaidh na làraichean-lìn air an tadhail thu.
...
neterror-dns-not-found-trr-unknown-host = Cha d’fhuair { $trrDomain } lorg air seòladh na làraich-lìn seo.
