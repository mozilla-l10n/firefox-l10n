...
neterror-not-cached-intro = Das angefragte Dokument ist nicht im Browser-Cache verfügbar.
neterror-not-cached-sensitive = Als Sicherheitsmaßnahme fordert der Browser vertrauliche Dokumente nicht automatisch erneut an.
