...
dns-not-found-trr-only-title = Ristga da segirezza potenziala per { $hostname }.
# Variables:
#   $hostname (string) - Hostname of the website to which the user was trying to connect.
dns-not-found-native-fallback-title = Ristga da segirezza potenziala per { $hostname }.
