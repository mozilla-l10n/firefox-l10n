...
profile-creation-explanation-2 = თუ თქვენ { -brand-short-name }–ს სხვა მომხმარებლებთან საზიაროდ იყენებთ, შეგიძლიათ პროფილების გამოყენება თითოეულის პარამეტრების ცალკე შესანახად.  ამისთვის თითოეულმა მომხმარებელმა საკუთარი პროფილი უნდა შექმნას.
profile-creation-explanation-3 = თუ თქვენ { -brand-short-name }–ს ერთადერთი მომხმარებელი ხართ, უნდა გაგაჩნდეთ ერთი პროფილი მაინც.  სურვილისამებრ შეგიძლიათ შექმნათ სხვადასხვა პროფილებიც განსხვავებული პარამეტრებით.  მაგალითად, სამუშაოდ და პირადი სარგებლობისთვის.
