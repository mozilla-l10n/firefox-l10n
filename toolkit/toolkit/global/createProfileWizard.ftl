...
profile-creation-explanation-1 = { -brand-short-name } захоўвае звесткі пра вашы налады і параметры ў вашым асабістым профілі.
...
profile-creation-explanation-3 = Калі вы адзін карыстаецеся гэтай копіяй { -brand-short-name }, вы мусіце мець, прынамсі, адзін профіль. Вы можаце стварыць, калі хочаце, некалькі профіляў для сябе, каб захаваць розныя наборы налад. Напрыклад, вы можаце мець розныя профілі для працы і для асабістага карыстання.
...
profile-directory-explanation = Вашы карыстальніцкія налады, параметры і іншыя ўласныя звесткі будуць захоўвацца ў:
