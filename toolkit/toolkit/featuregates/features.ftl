...
experimental-features-cookie-samesite-lax-by-default =
    .label = 既定で Cookies: SameSite=lax
experimental-features-cookie-samesite-lax-by-default-description = Cookie に “sameSite” 属性が指定されていない場合、既定で “sameSite=lax” として扱います。開発者は、“sameSite=none” が暗黙的に濫用されている現状に状態をオプトインする必要があります。

# The title of the experiment should be kept in English as it may be referenced
# by various online articles and is technical in nature.
experimental-features-cookie-samesite-none-requires-secure =
    .label = Cookies: SameSite=none は secure 属性を必要とします
experimental-features-cookie-samesite-none-requires-secure-description = “sameSite=none” 属性が指定された Cookie は secure 属性を必要とします。この機能は、“既定で Cookies: SameSite=lax” の必要があります。
