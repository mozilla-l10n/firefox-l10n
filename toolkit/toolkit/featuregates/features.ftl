...
experimental-features-web-gpu =
    .label = WebGPU
experimental-features-web-gpu-description = Eksperimenta API por grafikaĵoj kaj komputiko en la teksaĵo.
# The title of the experiment should be kept in English as it may be referenced
# by various online articles and is technical in nature.
experimental-features-avif =
    .label = AVIF
experimental-features-avif-description = Eksperimenta subteno por la bilda dosierformo AVIF: AV1
# The title of the experiment should be kept in English as it may be referenced
# by various online articles and is technical in nature.
