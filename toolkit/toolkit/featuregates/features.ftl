...
experimental-features-win32k-lockdown-description = გამორთავს Win32k API-ებს ბრაუზერის ჩანართებში. აუმჯობესებს უსაფრთხოებას, თუმცა შეიძლება გამოიწვიოს არამდგრადობა და უეცარი გათიშვები. (მხოლოდ Windows-ზე)
# JS JIT Warp project
