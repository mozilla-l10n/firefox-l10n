...
experimental-features-accessibility-cache-description = Pufrujo wšykne informacije bźezbariernosći ze wšych dokumentow w głownem procesu { -brand-short-name }. To wugbaśe za cytaki wobrazowkow a druge nałoženja, kótarež API bźezbariernosći wužywaju, pólěpšujo.
