...
experimental-features-ime-search-description = IME (Input Method Editor) on työkalu, jonka avulla voit kirjoittaa tavallisella näppäimistöllä monimutkaisia symboleja, kuten itäaasialaisia tai intialaisia symboleja. Tämän kokeilun ottaminen käyttöön pitää osoiterivin auki näyttäen hakutulokset ja -ehdotukset samalla, kun käytät tekstinsyöttöä IME:n avulla. Huomaa, että IME saattaa näyttää paneelin, peittäen osoiterivin hakutulokset, joten tätä asetusta suositellaan vain IME:lle, joka ei käytä tämäntyyppistä paneelia.
