...
experimental-features-cookie-samesite-lax-by-default2-description = Тыпова трактаваць кукі як "SameSite=Lax", калі не вызначаны атрыбут "SameSite". Каб працаваць у рэжыме бягучага статус-кво неабмежаванага выкарыстання, распрацоўшчыкі павінны відавочна зацвердзіць "SameSite=None".
# Do not translate 'SameSite', 'Lax' and 'None'.
...
experimental-features-accessibility-cache =
    .label = Кэш падтрымкі даступнасці
experimental-features-accessibility-cache-description = Кэшуе ўсю інфармацыю аб даступнасці з усіх дакументаў у галоўным працэсе { -brand-short-name }. Гэта павышае прадукцыйнасць праграм чытання з экрана і іншых праграм, якія выкарыстоўваюць API падтрымкі даступнасці.
