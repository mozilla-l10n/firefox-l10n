...
experimental-features-web-gpu-description3 = La <a data-l10n-name="wikipedia-webgpu">WebGPU API</a> provizas malaltnivelan subtenon por kalkuloj kaj montro de grafikaĵoj per la <a data-l10n-name="wikipedia-gpu">grafika procesoro (GPU)</a> en la aparato aŭ komputilo de la uzanto. La unua version de la <a data-l10n-name="spec">specifo</a> estas preskaŭ kompleta. Vizitu la <a data-l10n-name="bugzilla">problemon 1616739</a> por havi pli da informo.
# The title of the experiment should be kept in English as it may be referenced
# by various online articles and is technical in nature.
