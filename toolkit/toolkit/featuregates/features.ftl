...
experimental-features-accessibility-cache =
    .label = Caché de accesibilidade
experimental-features-accessibility-cache-description = Garda en caché a información de accesibilidade de todos os documentos do proceso principal de { -brand-short-name }. Isto mellora o rendemento de lectores de pantalla e doutras aplicacións que usan APIs de accesibilidade.
