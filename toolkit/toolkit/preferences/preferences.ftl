...
master-password-description = Hlavní heslo se používá k ochraně citlivých informací, jako jsou například hesla stránek. Pokud si vytvoříte hlavní heslo, budete na něj dotázáni jednou během každé relace, pokud { -brand-short-name } bude potřebovat pracovat s uloženými informacemi chráněnými tímto heslem.
