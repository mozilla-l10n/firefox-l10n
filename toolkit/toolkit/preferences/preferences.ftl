...
pw-empty-warning = Nun van protexese les contraseñes y los datos de los formularios y les claves privaes qu'atroxares.
...
pw-change2empty-in-fips-mode = Anguaño tas nel mou FIPS. FIPS rique una contraseña maestra que nun tea balera.
...
pw-remove-button =
    .label = Quitar
set-password =
    .title = Cambéu de la contraseña maestra
...
remove-password =
    .title = Desaniciu de la contraseña maestra
