...
master-password-warning = Por favor, certifique-se de que memoriza a palavra-passe mestra definida.  Se se esquecer da sua palavra-passe mestra, não conseguirá aceder a quaisquer informações protegidas pela mesma.
remove-password =
    .title = Remover palavra-passe mestra
remove-info =
    .value = Tem de introduzir a palavra-passe atual para continuar:
remove-warning1 = A palavra-passe mestra é utilizada para proteger informações sensíveis como, por exemplo, as palavras-passe dos sites.
