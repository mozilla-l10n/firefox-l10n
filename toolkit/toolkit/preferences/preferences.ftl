...
remove-warning1 = Parola generală este folosită pentru a proteja datele sensibile precum parolele de la site-uri.
remove-warning2 = Dacă elimini parola generală, aceste informații nu vor fi protejate în cazul în care calculatorul este compromis.
