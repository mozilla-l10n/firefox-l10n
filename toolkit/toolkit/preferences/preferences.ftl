...
pp-erased-ok = Sguab thu às am prìomh fhacal-faire agad.  { pw-empty-warning }
pp-not-wanted = Rabhadh! Chuir thu romhad gun a bhith a' cleachdadh prìomh fhacal-faire. { pw-empty-warning }
