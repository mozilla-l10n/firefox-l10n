...
password-not-set =
    .value = (net ynsteld)
failed-pw-change = Net yn steat it haadwachtwurd te wizigjen.
incorrect-pw = Jo ha net it korrekte haadwachtwurd ynfierd. Probearje it opnij.
pw-change-ok = Haadwachtwurd suksesfol wizige. { pw-empty-warning }
