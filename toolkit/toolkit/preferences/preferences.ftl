...
master-password-admin = Správca vášho systému vyžaduje pred ukladaním hesiel nastavenie hlavného hesla.
...
remove-warning1 = Hlavné heslo chráni citlivé údaje, napríklad heslá webových stránok.
remove-warning2 = Ak odstránite hlavné heslo, súkromné údaje nebude možné v prípade prieniku do počítača chrániť.
