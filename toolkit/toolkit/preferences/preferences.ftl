...
master-password-admin = Waš administrator se pomina, až głowne gronidło nastajaśo, aby gronidła składował.
...
master-password-warning = Pšosym zawěsććo, až markujośo se głowne gronidło, kótarež sćo stajił. Jolic zabydnjośo swójo głowne gronidło, njamóžośo na z tym šćitane informacije pśistup měś.
remove-password =
