...
master-password-warning = Խնդրում ենք չմոռանալ Հիմնական գաղտնաբառը, այլապես ի վիճակի չեք լինի օգտագործել դրանով պաշտպանված տեղեկությունները:
remove-password =
    .title = Հեռացնել Հիմնական գաղտնաբառը
remove-info =
    .value = Շարունակելու համար պիտի մուտքագրեք Ձեր առկա գաղտնաբառը.
