...
incorrect-pw = 현재 마스터 비밀번호를 올바르게 입력하지 않았습니다. 다시 시도하세요.
pw-change-ok = 마스터 비밀번호가 성공적으로 변경되었습니다.
...
pw-change2empty-in-fips-mode = 현재 FIPS 모드입니다. FIPS는 마스터 비밀번호가 설정되어야 합니다.
