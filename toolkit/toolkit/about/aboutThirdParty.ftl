...
third-party-icon-warning =
    .title = Даны модуль выклікаў збой у { -brand-short-name }
    .alt = Даны модуль выклікаў збой у { -brand-short-name }
...
third-party-button-to-unblock-disabled =
    .title = У цяперашні час пазначаны як заблакаваны, хоць спіс блаковак адключаны для гэтага запуску { -brand-short-name }. Націсніце, каб разблакаваць яго.
    .aria-label = У цяперашні час пазначаны як заблакаваны, хоць спіс блаковак адключаны для гэтага запуску { -brand-short-name }. Націсніце, каб разблакаваць яго.
third-party-button-expand =
    .title = Паказаць падрабязную інфармацыю
third-party-button-collapse =
    .title = Згарнуць падрабязную інфармацыю
third-party-requires-restart = Каб змяніць блакоўку старонніх модуляў, неабходна перазапусціць { -brand-short-name }.
third-party-should-restart-title = Перазапусціць { -brand-short-name }
third-party-should-restart-ok = Перазапусціць { -brand-short-name } зараз
