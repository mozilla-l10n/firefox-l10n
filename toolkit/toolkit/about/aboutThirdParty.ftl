...
third-party-warning-icon =
    .title = { -brand-short-name } ਇਸ ਮੋਡੀਊਲ ਤੋਂ ਕੋਡ ਵਿੱਚ ਕਰੈਸ਼ ਹੋਇਆ
...
third-party-requires-restart = ਤੀਜੀ ਧਿਰ ਮੋਡੀਊਲਾਂ ਉੱਤੇ ਪਾਬੰਦੀ ਲਾਉਣ ਨੂੰ ਲਾਗੂ ਕਰਨ ਵਾਸਤੇ { -brand-short-name } ਨੂੰ ਮੁੜ-ਚਾਲੂ ਕਰਨਾ ਪਵੇਗਾ।
third-party-should-restart-title = { -brand-short-name } ਨੂੰ ਮੁੜ-ਚਾਲੂ ਕਰੋ
third-party-should-restart-ok = { -brand-short-name } ਨੂੰ ਹੁਣੇ ਮੁੜ-ਚਾਲੂ ਕਰੋ
