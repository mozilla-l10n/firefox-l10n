...
third-party-requires-restart = { -brand-short-name } sa musí reštartovať, aby sa prejavili zmeny v blokovaní modulov tretích strán.
third-party-should-restart-title = Reštartovať { -brand-short-name }
third-party-should-restart-ok = Reštartovať { -brand-short-name } teraz
