...
refresh = రీఫ్రెష్
auto-refresh = ప్రతి 3 క్షణాలకు స్వయంచాలకరీఫ్రెష్
hostname = అతిధేయపేరు
port = పోర్టు
http2 = HTTP/2
...
trr = TRR
addresses = చిరునామా
expires = గడువుతీరును (క్షణాలు)
messages-sent = పంపిన సందేశాలు
messages-received = స్వీకరించిన సందేశాలు
bytes-sent = పంపిన బైట్లు
bytes-received = స్వీకరించిన బైట్లు
logging = నమోదుపరుచు
log-tutorial = ఈ పనిముట్టును ఎలా వాడుకోవాలో సూచనల కోసం <a data-l10n-name="logging">HTTP లాగింగ్</a>‌ను చూడండి.
...
rcwn = RCWN గణాంకాలు
rcwn-status = RCWN స్థితి
total-network-requests = మొత్తం నెట్‌వర్క్ అభ్యర్థనల లెక్క
rcwn-operation = క్యాషేఆపరేషన్
rcwn-perf-open = తెరువు
rcwn-perf-read = చదువు
