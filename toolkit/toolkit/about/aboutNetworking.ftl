...
title = Rreth Punimit në Rrjet
warning = Kjo është tejet eksperimentale. Mos e përdorni pa mbikëqyrje nga të rriturit.
show-next-time-checkbox = Shfaqe këtë sinjalizim herës tjetër
ok = OK
http = HTTP
sockets = Socket-e
dns = DNS
...
dns-lookup-table-column = IP-ra
rcwn = Gjendje RCWN
rcwn-status = Gjendje RCWN
total-network-requests = Numër gjithsej kërkesash rrjeti
rcwn-operation = Veprim Fshehtine
rcwn-perf-open = Hape
rcwn-perf-read = Lexim
rcwn-perf-write = Shkrim
