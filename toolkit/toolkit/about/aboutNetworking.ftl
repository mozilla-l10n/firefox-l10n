...
title = Sobre rede
warning = Isso é muito experimental. Não use sem a supervisão de um adulto.
show-next-time-checkbox = Sempre mostrar este aviso
ok = OK
http = HTTP
sockets = Sockets
dns = DNS
dnssuffix = Sufixo DNS
...
rcwn-avg-short = Média de operações curtas
rcwn-avg-long = Média de operações longas
