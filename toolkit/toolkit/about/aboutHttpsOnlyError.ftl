...
about-httpsonly-insecure-explanation-exception = Embora o risco à segurança seja baixo, se você decidir visitar a versão HTTP do site, não deve inserir nenhuma informação sensível, como senhas, emails ou detalhes de cartões de crédito.
