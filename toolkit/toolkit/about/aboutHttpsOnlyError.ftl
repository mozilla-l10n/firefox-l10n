...
about-httpsonly-insecure-explanation-unavailable = 您正在以纯 HTTPS 模式浏览，但 <em>{ $websiteUrl }</em> 无法提供安全的 HTTPS 版本。
about-httpsonly-insecure-explanation-reasons = 该网站很可能不支持 HTTPS，但也有可能是攻击者拦截了 HTTPS 版本。
about-httpsonly-insecure-explanation-exception = 虽然安全风险较低，但若您还是决定访问此网站的 HTTP 版本，就不该输入密码、邮箱或信用卡等敏感信息。
...
about-httpsonly-explanation-risk = 也可能是有人正企图攻击您。若您还是决定访问此网站的 HTTP 版本，就不该在网站中输入密码、邮箱或信用卡等敏感信息。
