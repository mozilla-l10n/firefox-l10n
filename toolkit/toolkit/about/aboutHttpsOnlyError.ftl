...
about-httpsonly-insecure-explanation-unavailable = Yalnızca HTTPS modunu kullanıyorsunuz ve <em>{ $websiteUrl }</em> sitesinin güvenli bir HTTPS sürümü mevcut değil.
