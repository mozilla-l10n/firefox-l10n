...
about-httpsonly-suggestion-box-www-text = Есть защищённая версия <em>www.{ $websiteUrl }</em>. Вы можете посетить эту страницу вместо перехода на <em>{ $websiteUrl }<em>.
