...
about-httpsonly-insecure-explanation-unavailable = Navighezi în modul doar HTTPS și versiunea HTTPS securizată de <em>{ $websiteUrl }</em> nu este disponibilă.
...
about-httpsonly-title = { -brand-short-name } a depistat o potențială problemă de securitate
# Variables:
#   $websiteUrl (String) - Url of the website that failed to load. Example: www.example.com
about-httpsonly-explanation-unavailable = Navighezi în modul doar HTTPS și versiunea HTTPS securizată de <em>{ $websiteUrl }</em> nu este disponibilă.
about-httpsonly-explanation-question = Care ar putea fi cauza?
about-httpsonly-explanation-nosupport = Cel mai probabil, site-ul web pur și simplu nu acceptă HTTPS.
