...
about-httpsonly-insecure-explanation-unavailable = Přehladujeće w jenož-HTTPS-modusu a wěsta HTTPS-wersija <em>{ $websiteUrl }</em> k dispoziciji njeje.
...
about-httpsonly-title = { -brand-short-name } je potencielny wěstotny problem wotkrył
# Variables:
#   $websiteUrl (String) - Url of the website that failed to load. Example: www.example.com
about-httpsonly-explanation-unavailable = Přehladujeće w jenož-HTTPS-modusu a wěsta HTTPS-wersija <em>{ $websiteUrl }</em> k dispoziciji njeje.
