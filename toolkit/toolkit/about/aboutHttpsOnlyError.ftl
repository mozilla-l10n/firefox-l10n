...
about-httpsonly-title = Aplikácia { -brand-short-name } zistila potenciálny bezpečnostný problém
# Variables:
#   $websiteUrl (String) - Url of the website that failed to load. Example: www.example.com
about-httpsonly-explanation-unavailable = Webové stránky prehliadate v režime HTTPS-Only, a zabezpečená verzia stránky <em>{ $websiteUrl }</em> nie je k dispozícii.
...
about-httpsonly-button-accept-and-continue = Rozumiem riziku a chcem pokračovať
