...
rights-intro-point-3 = Některé funkce aplikace { -brand-short-name }, jako např. hlášení pádů, vám umožní odeslat zpětnou vazbu organizaci { -vendor-short-name }. Odesláním zpětné vazby poskytujete organizaci { -vendor-short-name } povolení k jejímu použití pro vylepšování produktů, zveřejnění na stránkách a distribuci.
