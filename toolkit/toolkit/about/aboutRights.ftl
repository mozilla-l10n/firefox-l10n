...
rights-intro-point-4 = 저희가 { -vendor-short-name }부터 { -brand-short-name }에 제출된 사용자의 개인 정보 및 의견을 사용하는 방법은 <a data-l10n-name="mozilla-privacy-policy-link">{ -brand-short-name } 개인정보 보호정책</a>을 참고하세요.
