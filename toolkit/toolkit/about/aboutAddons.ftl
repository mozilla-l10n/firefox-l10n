...
install-addon-from-file =
    .label = ଫାଇଲରୁ ଏଡ-ଅନକୁ ସ୍ଥାପନ କରନ୍ତୁ…
    .accesskey = I
tools-menu =
    .tooltiptext = ସମସ୍ତ ଏଡ-ଅନ ପାଇଁ ସାଧନ
cmd-show-details =
...
discover-title = ଏଡ-ଅନଗୁଡ଼ିକ କ'ଣ?
discover-description = ଏଡ-ଅନଗୁଡ଼ିକ ହେଉଛି ଗୋଟିଏ ପ୍ରକାର ପ୍ରୟୋଗ ଯାହାକି ଆପଣଙ୍କ { -brand-short-name } କୁ ଅତିରିକ୍ତ ବିଶେଷତା କିମ୍ବା ଶୈଳୀ ସହିତ ବ୍ୟକ୍ତିଗତ କରିବା ପାଇଁ ସହାୟତା କରିଥାଏ। ଗୋଟିଏ ସମୟ-ସଂରକ୍ଷଣ ପାର୍ଶ୍ୱପଟି, ଗୋଟିଏ ପାଣିପାଗ ବିଜ୍ଞପ୍ତି, କିମ୍ବା ଗୋଟିଏ ପ୍ରସଙ୍ଗମୟ ଦୃଶ୍ୟକୁ ନିଜର { -brand-short-name } କରିବା ପାଇଁ ଚେଷ୍ଟାକରନ୍ତୁ।
discover-footer = ଯେତେବେଳେ ଆପଣ ଇଣ୍ଟରନେଟରେ ସଂଯୁକ୍ତ ହୁଅନ୍ତି, ସେତେବେଳେ ଏହି ପଟ୍ଟିକଟି କିଛି ଉତ୍ତମ ଏବଂ ସୁପରିଚିତ ଏଡ-ଅନଗୁଡ଼ିକୁ ଆପଣଙ୍କ ପାଇଁ ପ୍ରୟାସ କରିବାକୁ ଦର୍ଶାଇଥାଏ।
detail-version =
    .label = ସଂସ୍କରଣ
detail-last-updated =
    .label = ଅନ୍ତିମ ଅଦ୍ୟତନ
