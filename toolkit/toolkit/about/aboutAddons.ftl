...
list-empty-get-dictionaries-message = Dapatkan kamus di <a data-l10n-name="get-Extension">{ $domain }</a>
list-empty-get-language-packs-message = Dapatkan paket bahasa di <a data-l10n-name="get-Extension">{ $domain }</a>
