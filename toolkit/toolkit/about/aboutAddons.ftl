...
detail-private-browsing-description = 拡張機能はプライベートウインドウでも動作しますが、ユーザーのオンライン行動にもアクセスできます。<label data-l10n-name="detail-private-browsing-learn-more">詳細情報</label>
...
private-browsing-description =
    拡張機能はプライベートウインドウでの実行がデフォルトで許可されていません。
    つまり、プライベートブラウジング中はこれらの拡張機能が動作しないため、拡張機能はユーザーのオンライン行動にアクセスできません。
    プライベートウインドウでの実行を拡張機能に許可するには、以下の拡張機能カードを選択し、設定を変更してください。
