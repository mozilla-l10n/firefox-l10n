...
private-browsing-description = გაფართოებების გაშვება არაა დაშვებული ნაგულისხმევად პირად ფანჯრებში. რაც ნიშნავს, რომ ისინი არ იმუშავებს პირადი თვალიერებისას და არ ექნება წვდომა თქვენს მოქმედებებზე. ცალკეული გაფართოების დასაშვებად პირად ფანჯრებში, მონიშნეთ ქვემოთ და შეცვალეთ პარამეტრები. <label data-l10n-name="private-browsing-learn-more">ვრცლად.</label>
