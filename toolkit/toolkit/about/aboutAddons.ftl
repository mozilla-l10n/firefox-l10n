...
install-addon-from-file =
    .label = Suiteáil Breiseán Ó Chomhad…
    .accesskey = S
tools-menu =
    .tooltiptext = Uirlisí le haghaidh gach breiseán
show-unsigned-extensions-button =
    .label = Níorbh fhéidir roinnt eisínteachtaí a fhíorú
show-all-extensions-button =
    .label = Taispeáin na heisínteachtaí go léir
debug-addons =
    .label = Dífhabhtaigh Breiseáin
    .accesskey = b
cmd-show-details =
...
discover-title = Cad is Breiseán ann?
discover-description = Is feidhmchláir iad na breiseáin a chuireann ar do chumas { -brand-short-name } a oiriúnú duit féin le feidhmeanna nó stíleanna breise. Bain triail as barra taoibh a spárálann am, fogróir aimsire, nó cuma de réir téama chun do { -brand-short-name } féin a chruthú.
discover-footer = Nuair a bhíonn tú ceangailte leis an Idirlíon, taispeántar cuid de na breiseáin is fearr agus is mó éilimh orthu sa phána seo.
detail-version =
    .label = Leagan
detail-last-updated =
    .label = Nuashonraithe
...
extensions-updates-downloaded =
    .value = Íoslódáladh nuashonruithe na mbreiseán.
