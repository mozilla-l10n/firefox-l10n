...
profiles-cannot-set-as-default-title = Standard kann nicht festgelegt werden
profiles-cannot-set-as-default-message = Das Standardprofil kann für { -brand-short-name } nicht geändert werden.
profiles-yes = ja
profiles-no = nein
