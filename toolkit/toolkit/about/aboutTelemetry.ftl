...
about-telemetry-telemetry-client-doc =
    { "" }
    De <a data-l10n-name="client-doc-link">Firefox Telemetry-clientdokumintaasje</a> befettet definysjes foar konsepten, API-dokumintaasje en gegevensferwizingen.
    { "" }
about-telemetry-telemetry-dashboard =
    { "" }
    Mei de <a data-l10n-name="dashboard-link">Telemetry-dashboerds</a> kinne jo de gegevens fisualisearje dy't Mozilla fia Telemetry ûntfangt.
    { "" }
...
about-telemetry-full-sql-warning =
    { "" }
      NOTE: Trage SQL-debugging is ynskeakele. Folsleine SQL-strings kinne hjirûnder toand wurde, mar se sille net ferstjoerd wurde nei Telemetry.
    { "" }
about-telemetry-fetch-stack-symbols =
    { "" }
      Krij funksjenammen foar stacks
    { "" }
about-telemetry-hide-stack-symbols =
    { "" }
      Toan rûge stackgegevens
    { "" }
