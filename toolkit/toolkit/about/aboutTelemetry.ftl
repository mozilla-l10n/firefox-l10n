...
about-telemetry-show-current-ping-data =
    { "" }
    Δεδομένα τρέχοντος ping
    { "" }
about-telemetry-show-archived-ping-data =
    { "" }
    Αρχειοθετημένα δεδομένα ping
    { "" }
about-telemetry-show-subsession-data =
    { "" }
    Εμφάνιση δεδομένων υποσυνεδρίας
    { "" }
...
about-telemetry-telemetry-client-doc =
    { "" }
    Η <a data-l10n-name="client-doc-link">τεκμηρίωση πελάτη τηλεμετρίας του Firefox</a> περιλαμβάνει ορισμούς για ιδέες, τεκμηρίωση API και αναφορές δεδομένων.
    { "" }
...
about-telemetry-full-sql-warning =
    { "" }
      ΣΗΜΕΙΩΣΗ: Η αργή αποσφαλμάτωση SQL είναι ενεργή. Τα πλήρη νήματα SQL ενδέχεται να εμφανίζονται παρακάτω, αλλά δεν θα υποβάλλονται στην Τηλεμετρία.
    { "" }
about-telemetry-fetch-stack-symbols =
    { "" }
      Λήψη ονομάτων συναρτήσεων για στοίβες
    { "" }
