...
about-telemetry-ping-details-current = Տեղեկատվության յուրաքանչյուր կտոր ուղարկվում է “<a data-l10n-name="ping-link"> pings </a>" միջոցով: Դուք նայում եք ընթացիկ պինգին:
