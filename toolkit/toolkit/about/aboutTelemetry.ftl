...
about-telemetry-telemetry-client-doc =
    { "" }
    <a data-l10n-name="client-doc-link">Дакументацыя кліента тэлеметрыі Firefox</a> змяшчае вызначэнні канцэпцый, дакументацыю па API і даведку па дадзеных.
    { "" }
about-telemetry-telemetry-dashboard =
    { "" }
    <a data-l10n-name="dashboard-link">Панэлі Тэлеметрыі</a> дазваляюць вам візуалізаваць дадзеныя, атрыманыя Mozilla праз тэлеметрыю.
    { "" }
...
about-telemetry-fetch-stack-symbols =
    { "" }
      Атрымаць імёны функцый для стэкаў
    { "" }
about-telemetry-hide-stack-symbols =
    { "" }
      Паказаць сырыя дадзеныя стэка
