...
safe-mode-title = സേഫ് മോഡ് ശ്രമിച്ചുനോക്കുക
restart-in-safe-mode-label = ആഡ്-ഓണുകള്‍ പ്രവര്‍ത്തന രഹിതമാക്കി വീണ്ടും ആരംഭിയ്ക്കുക…
...
multi-process-status-0 = ഉപയോക്താവു് സജ്ജമാക്കി
multi-process-status-1 = സ്വതേ സജ്ജമായി
multi-process-status-2 = പ്രവര്‍ത്തന രഹിതം
multi-process-status-unknown = അവസ്ഥ അറിയില്ല
