...
abuse-report-submit-note = Nota: Não inclua informações pessoais (como nome, endereço de e-mail, número de telefone, endereço físico). A { -vendor-short-name } guarda um registro permanente desses relatos.
