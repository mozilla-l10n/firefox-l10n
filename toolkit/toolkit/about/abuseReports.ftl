...
abuse-report-goback-button = Shkoni mbrapsht
...
abuse-report-damage-reason = Dëmton kompjuterin dhe të dhënat e mia
abuse-report-damage-example = Shembull: Injektoi <em>malware</em> ose vodhi të dhëna
abuse-report-spam-reason = Krijon mesazh të padëshiruar ose reklamë
abuse-report-spam-example = Shembull: Fut reklama në faqe web
abuse-report-settings-reason = Ndryshoi motorin tim të kërkimeve, faqen hyrëse, ose një skedë të re pa ma bërë të ditur apo pyetur
