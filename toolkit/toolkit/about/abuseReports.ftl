...
abuse-report-deceptive-reason = 偽裝成與其無關的東西
abuse-report-deceptive-reason-v2 = 它偽裝成與其無關的東西
abuse-report-deceptive-example = 例如: 在描述中誤導使用者，或使用誤導圖片
abuse-report-broken-reason-extension = 套件無法正常運作、造成網站無法運作、拖慢 { -brand-product-name }
abuse-report-broken-reason-theme = 無法運作或破壞瀏覽器顯示內容
...
abuse-report-policy-reason = 散播仇恨、暴力、非法內容
...
abuse-report-unwanted-reason = 並未安裝此擴充套件，也無法移除
