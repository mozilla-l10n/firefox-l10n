...
blocklist-window =
    .title = सहयुक्तियाँ समस्याएँ उत्पन्न कर सकती हैं
    .style = width: 45em; height: 30em
blocklist-accept =
    .label = { -brand-short-name } फिर आरंभ करें
    .accesskey = R
blocklist-label-summary = { -brand-short-name } ने निर्धारित किया है कि निम्नलिखित सहयुक्तियाँ स्थायित्व व सुरक्षा समस्या उत्पन्न करने के लिए जानी जाती हैं:
