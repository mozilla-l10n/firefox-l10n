...
fx-view-discoverability-title = Không có ý định đóng các thẻ đó?
fx-view-discoverability-subtitle = Tìm và mở lại nó nhanh chóng tại đây. Chúng tôi lưu giữ lịch sử các thẻ đã đóng gần đây cho bạn.
fx-view-discoverability-primary-button-label = Mở { -firefoxview-brand-name }
fx-view-discoverability-secondary-button-label = Bỏ qua
...
sidebar-callout-survey-dissatisfied-2 = Không hài lòng
sidebar-callout-survey-very-dissatisfied-2 = Rất không hài lòng
...
unified-search-callout-secondary-label = Bỏ qua
unified-search-engines-callout-title = Tìm kiếm với lối tắt
unified-search-engines-callout-subtitle = Gõ “@”, tiếp theo là một từ khóa để tìm kiếm lịch sử, dấu trang, thẻ hoặc với công cụ tìm kiếm khác.
unified-search-engines-callout-primary-label = Đã hiểu
actions-callout-title = Hoàn thành các tác vụ phổ biến hoặc truy cập các cài đặt cơ bản
