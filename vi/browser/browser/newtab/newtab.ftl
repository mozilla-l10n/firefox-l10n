...
newtab-appearance-more-themes-button =
    .label = Xem thêm chủ đề
# Title of the full theme selection sub-panel, also used as its back button label.
newtab-appearance-manage-title = Chủ đề { -brand-product-name }
# Header for the list of the user's already-installed themes in the full theme panel.
newtab-appearance-your-themes-header = Chủ đề của bạn
...
newtab-appearance-install-theme-button =
    .label = Cài đặt chủ đề
# Button/link on the full theme panel that opens the complete list of available themes.
newtab-appearance-explore-more-themes-button = Khám phá chủ đề khác
...
newtab-clock-city-fr-marseille = Mạc-xây
...
newtab-clock-city-cn-shanghai = Thượng Hải
newtab-clock-city-cn-beijing = Bắc Kinh
newtab-clock-city-cn-shenzhen = Thâm Quyến
...
newtab-clock-city-jp-osaka = Ōsaka
newtab-clock-city-mx-mexico-city = Thành phố México
...
newtab-clock-city-gb-london = Luân Đôn
...
newtab-clock-city-at-vienna = Viên
...
newtab-clock-city-th-bangkok = Băng Cốc
newtab-clock-city-ng-lagos = Lagos
newtab-clock-city-tw-taipei = Đài Bắc
...
newtab-clock-city-hk-hong-kong = Hồng Kông
...
newtab-clock-city-vn-ho-chi-minh-city = TP Hồ Chí Minh
