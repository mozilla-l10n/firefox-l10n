...
smartwindow-nl-retry-tool-button =
    .label = Thử lại
smartwindow-nl-retry-message = Nếu bạn vẫn muốn đóng các thẻ, hãy chọn <strong>Thử lại</strong> và quyết định lựa chọn của bạn trong bảng vừa hiện ra.
smartwindow-nl-retry-group-tabs-message = Nếu bạn vẫn muốn nhóm các thẻ lại với nhau, hãy chọn <strong>Thử lại</strong> và chọn cái cần nhóm trong bảng vừa mở.
