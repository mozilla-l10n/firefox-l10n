...
helpus-referrals2 = Bạn muốn giúp đỡ? <label data-l10n-name="helpus-donateLink">Quyên gói tài chính</label>, <label data-l10n-name="helpus-shareFirefoxLink">Chia sẻ { -brand-product-name }</label>, hoặc <label data-l10n-name="helpus-getInvolvedLink">trở thành cộng tác viên!</label>
