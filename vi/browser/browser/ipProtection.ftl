...
ipprotection-summer-promo-offramp-default-browser-incentive-description = Đặt { -brand-product-name } làm trình duyệt chính của bạn và khám phá thêm hơn 20 địa điểm bổ sung để duyệt sau ngày 31 tháng 8.
...
ipprotection-recommended-location-button = Địa điểm: Được đề xuất
ipprotection-recommended-location-description = { -brand-product-name } sẽ tìm địa điểm nhanh nhất
ipprotection-recommended-location-badge = MỚI
# Variables
#   $country (string) - The country selected for the VPN server location
ipprotection-location-country-button = Địa điểm: { $country }
...
ipprotection-locations-subview-promo-button = Nhận { -mozilla-vpn-brand-name }
...
ipprotection-open-button = Mở { -brand-product-name }
ipprotection-come-back-title = Quay lại để thử VPN được tích hợp sẵn
ipprotection-message-body-hide-location = Ẩn vị trí của bạn khi duyệt web trong { -brand-product-name } để có thêm quyền riêng tư và kiểm soát.
...
ip-protection-not-opted-in-4 =
    ...
    .message = Duyệt web an toàn hơn nhờ tính năng ẩn vị trí của bạn.
...
#   $usageLeft (string) - The amount of data a user has left in a month (in GB)
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
ip-protection-bandwidth-left-gb-1 = <span data-l10n-name="usage">{ $usageLeft } GB</span> còn lại trong tổng số { $maxUsage } GB
# Variables
#   $usageLeft (string) - The amount of data a user has left in a month (in GB)
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
...
#   $usageLeft (number) - The amount of data a user has left in a month (in MB)
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
ip-protection-bandwidth-left-mb-1 = <span data-l10n-name="usage">{ $usageLeft } MB</span> còn lại trong tổng số { $maxUsage } GB
# Variables
#   $usageLeft (number) - The amount of data a user has left in a month (in MB)
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
...
# Variables
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
vpn-error-page-paused-description = Bạn đã sử dụng hết { $maxUsage } GB dữ liệu VPN. Quyền truy cập sẽ được thiết lập lại vào tháng tới.
vpn-error-page-continue-description = Chọn cách tiếp tục mà không cần VPN
vpn-error-page-keep-browsing = Tiếp tục duyệt web trong phiên này
vpn-error-page-new-session = Bắt đầu phiên mới
