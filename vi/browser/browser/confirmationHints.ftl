...
confirmation-hint-passport-created = Đã lưu hộ chiếu
confirmation-hint-passport-updated = Đã cập nhật hộ chiếu
...
confirmation-hint-extensions-button-hidden = Đã chuyển sang menu
