...
report-broken-site-panel-description =
    .placeholder = Chuyện gì đã xảy ra? Lẽ ra phải xảy ra chuyện gì? Tắt tính năng trình chống theo dõi có giúp ích gì không?
