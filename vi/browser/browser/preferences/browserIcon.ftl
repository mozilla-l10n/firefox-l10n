...
appearance-browser-icon-entry-group =
    .label = Biểu tượng trình duyệt
    .description = Chọn biểu tượng tùy chỉnh cho thanh tác vụ, màn hình nền và menu Start của bạn.
appearance-browser-icon-button =
    .label = Thay đổi biểu tượng trình duyệt
...
appearance-browser-icon-momo =
    .label = Momo
    .description = Được tạo bởi @heyheymomodraws
