...
details-notification-softblocked-extension-disabled =
    .message = Tiện ích mở rộng này vi phạm chính sách của Mozilla và đã bị vô hiệu hóa. Bạn có thể kích hoạt nó, nhưng điều này có thể gây rủi ro.
details-notification-softblocked-extension-enabled =
    .message = Tiện ích mở rộng này vi phạm chính sách của Mozilla. Sử dụng nó có thể gây rủi ro.
details-notification-softblocked-other-disabled =
    .message = Tiện ích này vi phạm chính sách của Mozilla và đã bị vô hiệu hóa. Bạn có thể kích hoạt nó, nhưng điều này có thể gây rủi ro.
details-notification-softblocked-other-enabled =
    .message = Tiện ích này vi phạm chính sách của Mozilla. Sử dụng nó có thể gây rủi ro.
