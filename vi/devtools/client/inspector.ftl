...
colorpicker-tooltip-spectrum-dragger-title = Quang phổ màu
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = Chọn màu trên trang
...
colorpicker-tooltip-color-name-title = Gần nhất với: { $colorName }
