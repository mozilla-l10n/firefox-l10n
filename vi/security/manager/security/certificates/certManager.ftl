...
delete-ssl-override-impact = Nếu bạn xóa một ngoại lệ máy chủ, bạn sẽ khôi phục việc kiểm tra bảo mật thông thường cho máy chủ đó và yêu cầu nó dùng một chứng chỉ hợp lệ.
