...
abuse-report-spam-reason = Rychtuje spam abo reklamy
...
abuse-report-settings-reason = Zmiyniōł moja wyszukowarka, sōmowo strōna abo nowo karta i niy doł ô tym znać ani sie ô to niy spytoł.
...
abuse-report-deceptive-reason = Udowo co inkszego, jak je
...
abuse-report-broken-reason-extension = Niy funguje, psuje strōny abo spōmalo aplikacyjo { -brand-product-name }
abuse-report-broken-reason-theme = Niy funguje abo psuje wyglōnd przeglōndarki
