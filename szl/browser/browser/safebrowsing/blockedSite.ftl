...
safeb-blocked-malware-page-learn-more = Przewiydz sie wiyncyj ô szkodliwyj zawartości neca (bez przikłod ô wirusach i inkszych ôszydnych programach) a ô tym, jak chrōnić swōj kōmputer na <a data-l10n-name='learn_more_link'>StopBadware.org</a>. Przewiydz sie wiyncyj ô ôchrōnie ôd phishingu i ôszydnych programōw w aplikacyji { -brand-short-name } na <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
