...
refresh-unused-profile-infobar-message = Zdowo sie, iże aplikacyjo { -brand-short-name } już kōnsek czasu niy była załōnczano. Chcesz jōm poskludzać, coby fungowała choby blank nowo? A ku tymu: witej nazod!
refresh-reinstalled-profile-infobar-message = Zdowo sie, iże aplikacyjo { -brand-short-name } je przeinstalowano. Chcesz jōm poskludzać, coby fungowała choby blank nowo?
refresh-profile-infobar-button = Ôdświyż aplikacyjo { -brand-short-name }…
    .accesskey = O
