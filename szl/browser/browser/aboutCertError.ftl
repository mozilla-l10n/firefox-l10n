...
cspBlocked-title = Zaszperowane skuli polityki bezpieczyństwa zawartości
xfoBlocked-title = Zaszperowane skuli polityki X-Frame-Options
corruptedContentError-title = Feler: poprzniōno zawartoś
remoteXUL-title = Zdolne XUL
