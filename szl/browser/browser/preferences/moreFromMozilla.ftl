...
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-description = Niych twoje dane robiōm na lepszy internet do wszyskich.
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-description-advanced = Przekoż swoje dane podszukōnkōm, co majōm stworzić bezpieczniyjszy, wiyncyj ôtwarty internet, co pōmogo ludziōm, a niy wielkim korporacyjōm.
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-button-mozilla-rally-2 = Przistōmp do projektu { -rally-short-name }
