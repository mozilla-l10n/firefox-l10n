...
report-broken-site-panel-send-more-info-button =
    .label = Αποστολή περισσότερων πληροφοριών
...
report-broken-site-panel-description =
    .placeholder = Τι συνέβη; Τι έπρεπε να έχει συμβεί; Βοήθησε η απενεργοποίηση της προστασίας από καταγραφή;
...
report-broken-site-panel-blocked-trackers-label2 =
    .label = Αποστολή λίστας στοιχείων που έχουν αποκλειστεί από την προστασία από καταγραφή
report-broken-site-panel-url-input-label =
    .aria-label = URL αναφερόμενης σελίδας
