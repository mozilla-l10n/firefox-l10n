...
edit-profile-page-desktop-shortcut-toggle-2 =
    .label = Δημιουργία συντόμευσης επιφάνειας εργασίας
edit-profile-page-desktop-shortcut-header = Δημιουργία συντόμευσης επιφάνειας εργασίας
edit-profile-page-desktop-shortcut-toggle =
    .aria-label = Δημιουργία συντόμευσης επιφάνειας εργασίας
...
restored-profile-page-header-description = Κάθε προφίλ διατηρεί το μοναδικό ιστορικό περιήγησης και τις ρυθμίσεις του ξεχωριστά από τα υπόλοιπα. Επιπλέον, η ισχυρή προστασία απορρήτου του { -brand-short-name } είναι ενεργή από προεπιλογή.
...
profiles-appmenu-callout-tour-subtitle = Στο μενού ☰, πατήστε το όνομα του προφίλ σας για να δημιουργήσετε ένα άλλο, να επεξεργαστείτε το τρέχον ή να κάνετε εναλλαγή μεταξύ των ψηφιακών ζωών σας.
