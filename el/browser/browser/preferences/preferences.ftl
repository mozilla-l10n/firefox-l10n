...
space-alert-over-5gb-message =
    { PLATFORM() ->
        [windows] Το { -brand-short-name } δεν έχει επαρκή χώρο στον δίσκο. Το περιεχόμενο των ιστοτόπων ενδέχεται να μην εμφανίζεται κανονικά. Μπορείτε να διαγράψετε τα αποθηκευμένα δεδομένα στις Επιλογές > Απόρρητο & ασφάλεια > Cookies και δεδομένα ιστοτόπων.
       *[other] Το { -brand-short-name } δεν έχει επαρκή χώρο στον δίσκο. Το περιεχόμενο των ιστοτόπων ενδέχεται να μην εμφανίζεται κανονικά. Μπορείτε να διαγράψετε τα αποθηκευμένα δεδομένα στις Προτιμήσεις > Απόρρητο & ασφάλεια > Cookies και δεδομένα ιστοτόπων.
    }
