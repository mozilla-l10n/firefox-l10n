...
permissions-site-notification-window =
    ...
    .style = { permissions-window.style }
permissions-site-notification-desc = Οι ακόλουθες ιστοσελίδες έχουν αιτηθεί αποστολή ειδοποιήσεις. Μπορείτε να καθορίσετε σε ποιες ιστοσελίδες επιτρέπεται η αποστολή ειδοποιήσεων. Μπορείτε επίσης να αποκλείσετε νέα αιτήματα ειδοποιήσεων.
