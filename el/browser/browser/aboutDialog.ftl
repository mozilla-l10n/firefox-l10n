...
settings-update-downloading-2 =
    .label = Λήψη ενημέρωσης — { $transfer }

##

update-applying = Εφαρμογή ενημέρωσης…
settings-update-applying =
    .label = Εφαρμογή ενημέρωσης…
...
settings-update-other-instance-handling-updates =
    .label = Το { -brand-short-name } ενημερώνεται από μια άλλη διεργασία
...
settings-update-unsupported = Δεν μπορείτε να εκτελέσετε περαιτέρω ενημερώσεις σε αυτό το σύστημα. <a data-l10n-name="unsupported-link">Μάθετε περισσότερα</a>
...
settings-update-internal-error = Δεν είναι δυνατός ο έλεγχος για ενημερώσεις λόγω εσωτερικού σφάλματος. Οι ενημερώσεις διατίθενται στο <a data-l10n-name="manual-link">{ $displayUrl }</a>
...
helpus-referrals2 = Θέλετε να βοηθήσετε; <label data-l10n-name="helpus-donateLink">Κάντε μια δωρεά</label>, <label data-l10n-name="helpus-shareFirefoxLink">μοιραστείτε το { -brand-product-name }</label> ή <label data-l10n-name="helpus-getInvolvedLink">συμμετάσχετε στο έργο!</label>
