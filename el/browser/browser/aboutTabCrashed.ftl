...
crashed-include-URL = Παραθέστε τα URL των ιστοτόπων όπου ήσασταν όταν το { -brand-short-name } κατέρρευσε.
crashed-email-placeholder = Εισαγάγετε τη διεύθυνση email σας εδώ
crashed-email-me = Ειδοποίηση στο email μου για περισσότερες πληροφορίες
