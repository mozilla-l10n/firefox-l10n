...
about-logins-error-message-duplicate-login-with-link = Υπάρχει ήδη καταχώριση για το { $loginTitle } με αυτό το όνομα χρήστη. <a data-l10n-name="duplicate-link">Μετάβαση στην υπάρχουσα καταχώριση;</a>
...
about-logins-import-dialog-items-modified2 =
    { $count ->
       *[other] <span>Ενημερώθηκαν υπάρχουσες καταχωρίσεις:</span> <span data-l10n-name="count">{ $count }</span>
    }
about-logins-import-dialog-items-no-change2 =
    { $count ->
       *[other] <span>Βρέθηκαν διπλότυπες καταχωρίσεις:</span> <span data-l10n-name="count">{ $count }</span> <span data-l10n-name="meta">(δεν έγινε εισαγωγή)</span>
    }
