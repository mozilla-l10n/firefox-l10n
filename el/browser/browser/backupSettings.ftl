...
settings-data-backup-scheduled-backups-off2 =
    .label = Η δημιουργία αντιγράφου ασφαλείας είναι ΑΝΕΝΕΡΓΗ
...
restore-from-backup-type-group-label =
    .label = Αντικατάσταση τρέχοντος προφίλ;
restore-from-backup-type-replace =
    .label = Αντικατάσταση όλων των δεδομένων με αυτό το αντίγραφο ασφαλείας
restore-from-backup-type-add =
    .label = Διατήρηση δεδομένων και δημιουργία νέου προφίλ
restore-from-backup-profiles-disabled-message = Αυτή η ενέργεια θα αντικαταστήσει όλα τα τρέχοντα δεδομένα του { -brand-short-name } με το αντίγραφο ασφαλείας σας.
