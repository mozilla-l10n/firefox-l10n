...
ipprotection-feature-introduction-link-text-privacy-2 = <a data-l10n-name="learn-more-vpn">Το ενσωματωμένο VPN του { -brand-product-name }</a> προστατεύει την περιήγησή σας. Επιλέξτε ανάμεσα σε πολλαπλές τοποθεσίες για πιο ιδιωτική περιήγηση.
