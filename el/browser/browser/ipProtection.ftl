...
ipprotection-connection-status-paused-title-1 = Το VPN είναι σε παύση
# Variables
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
...
ip-protection-not-opted-in-3 =
    .heading = Δοκιμάστε το ενσωματωμένο VPN του { -brand-short-name }
    .message = Περιηγηθείτε με επιπλέον προστασία αποκρύπτοντας την τοποθεσία σας. Λάβετε { $maxUsage } GB δωρεάν δεδομένων VPN κάθε μήνα.
