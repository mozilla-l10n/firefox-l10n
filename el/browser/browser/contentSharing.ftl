...
content-sharing-modal-description-2 = Συνδεθείτε για να δημιουργήσετε μια σελίδα συνδέσμων προς κοινή χρήση. Δεν είναι δυνατή η επεξεργασία ή η διαγραφή της και λήγει μετά από 7 ημέρες.
content-sharing-modal-description-signed-in = Δημιουργήσαμε μια σελίδα με τους συνδέσμους σας, την οποία μπορείτε να κοινοποιήσετε εύκολα. Δεν είναι δυνατή η επεξεργασία ή η διαγραφή της και λήγει μετά από 7 ημέρες.
