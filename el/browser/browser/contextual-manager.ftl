...
contextual-manager-passwords-origin-field =
    .label = Διεύθυνση ιστοτόπου
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Εισαγάγετε την ακριβή διεύθυνση όπου θα πραγματοποιείτε σύνδεση σε αυτόν τον ιστότοπο.
contextual-manager-passwords-username-field =
    .label = Όνομα χρήστη
contextual-manager-passwords-username-field-description = Εισαγάγετε το όνομα χρήστη, τη διεύθυνση email ή τον αριθμό λογαριασμού που χρησιμοποιείτε για τη σύνδεση.
contextual-manager-passwords-password-field =
    .label = Κωδικός πρόσβασης
contextual-manager-passwords-password-field-description = Εισαγάγετε τον κωδικό πρόσβασης για να συνδεθείτε σε αυτόν τον λογαριασμό.
