...
colorpicker-tooltip-spectrum-dragger-title = Φάσμα
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = Επιλέξτε χρώμα στη σελίδα
...
colorpicker-tooltip-color-name-title = Πλησιέστερα σε: { $colorName }
