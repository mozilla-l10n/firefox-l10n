...
serviceworker-worker-updated = Ενημέρωση: <time>{ DATETIME($date, day: "numeric", hour: "numeric", minute: "numeric", month: "long", second: "numeric", year: "numeric") }</time>
...
session-history-navigate-button-title = Μετάβαση στην καταχώριση «{ $index }» του ιστορικού συνεδρίας
