...
storage-table-type-indexeddb-hint = Δείτε και διαγράψτε τις καταχωρίσεις του IndexedDB επιλέγοντας μια βάση δεδομένων. <a data-l10n-name="learn-more-link">Μάθετε περισσότερα</a>
# Hint shown when the cache storage type is selected. Clicking the link will open
# https://firefox-source-docs.mozilla.org/devtools-user/storage_inspector/cache_storage/
storage-table-type-cache-hint = Δείτε και διαγράψτε τις καταχωρίσεις της κρυφής μνήμης επιλέγοντας έναν αποθηκευτικό χώρο. <a data-l10n-name="learn-more-link">Μάθετε περισσότερα</a>
