...
delete-ssl-cert-title =
    .title = Διαγραφή εξαιρέσεων πιστοποιητικών διακομιστή
delete-ssl-cert-confirm = Θέλετε σίγουρα να διαγράψετε αυτές τις εξαιρέσεις διακομιστή;
delete-ssl-cert-impact = Αν διαγράψετε κάποια εξαίρεση διακομιστή, θα επαναφέρετε τους συνήθεις ελέγχους ασφαλείας για αυτό τον διακομιστή και την απαίτηση για έγκυρο πιστοποιητικό.
...
verify-ssl-server =
    .value = Πιστοποιητικό διακομιστή SSL
verify-ssl-ca =
