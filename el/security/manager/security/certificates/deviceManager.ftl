...
fips-nonempty-primary-password-required = Η λειτουργία FIPS απαιτεί τον ορισμό ενός κύριου κωδικού πρόσβασης για κάθε συσκευή ασφαλείας. Ορίστε τον κωδικό πρόσβασης πριν από την ενεργοποίηση της λειτουργίας FIPS.
unable-to-toggle-fips = Δεν είναι δυνατή η αλλαγή της λειτουργίας FIPS για τη συσκευή ασφαλείας. Προτείνεται να κάνετε έξοδο και επανεκκίνηση της εφαρμογής.
