...
psmerr-hostreusedissuerandserial =
    ...
    Το πιστοποιητικό σας περιέχει τον ίδιο σειριακό αριθμό με ένα άλλο πιστοποιητικό που εκδόθηκε από την αρχή πιστοποιητικού. Αποκτήστε ένα νέο πιστοποιητικό που να περιέχει έναν μοναδικό σειριακό αριθμό.
...
ssl-error-unknown-ca-alert = Ο ομότιμος κόμβος δεν αναγνωρίζει ούτε εμπιστεύεται την αρχή πιστοποιητικών που εξέδωσε το πιστοποιητικό σας.
