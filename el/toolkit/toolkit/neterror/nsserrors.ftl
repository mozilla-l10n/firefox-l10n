...
psmerr-hostreusedissuerandserial =
    ...
    Το πιστοποιητικό σας περιέχει τον ίδιο σειριακό αριθμό με ένα άλλο πιστοποιητικό που εκδόθηκε από την αρχή πιστοποίησης. Αποκτήστε ένα νέο πιστοποιητικό που να περιέχει έναν μοναδικό σειριακό αριθμό.
ssl-error-export-only-server = Δεν είναι δυνατή η ασφαλής επικοινωνία. Ο ομότιμος κόμβος δεν υποστηρίζει κρυπτογράφηση υψηλού βαθμού.
ssl-error-us-only-server = Δεν είναι δυνατή η ασφαλής επικοινωνία. Ο ομότιμος κόμβος απαιτεί κρυπτογράφηση υψηλού βαθμού, η οποία δεν υποστηρίζεται.
ssl-error-no-cypher-overlap = Δεν είναι δυνατή η ασφαλής επικοινωνία με τον ομότιμο κόμβο: κανένας κοινός αλγόριθμος κρυπτογράφησης.
ssl-error-no-certificate = Δεν ήταν δυνατή η εύρεση του απαραίτητου πιστοποιητικού ή κλειδιού για έλεγχο ταυτότητας.
ssl-error-bad-certificate = Δεν είναι δυνατή η ασφαλής επικοινωνία με τον ομότιμο κόμβο: το πιστοποιητικό του κόμβου απορρίφθηκε.
ssl-error-bad-client = Ο διακομιστής συνάντησε εσφαλμένα δεδομένα από το πρόγραμμα-πελάτη.
ssl-error-bad-server = Το πρόγραμμα-πελάτης συνάντησε εσφαλμένα δεδομένα από τον διακομιστή.
ssl-error-unsupported-certificate-type = Μη υποστηριζόμενος τύπος πιστοποιητικού.
ssl-error-unsupported-version = Ο ομότιμος κόμβος χρησιμοποιεί μη υποστηριζόμενη έκδοση του πρωτοκόλλου ασφαλείας.
...
ssl-error-bad-cert-domain = Δεν είναι δυνατή η ασφαλής επικοινωνία με τον ομότιμο κόμβο: το ζητούμενο όνομα τομέα δεν ταιριάζει με το πιστοποιητικό του διακομιστή.
ssl-error-post-warning = Μη αναγνωρίσιμος κωδικός σφάλματος SSL.
ssl-error-ssl2-disabled = Ο ομότιμος κόμβος υποστηρίζει μόνο την έκδοση 2 του SSL, η οποία έχει απενεργοποιηθεί τοπικά.
ssl-error-bad-mac-read = Το SSL έλαβε μια εγγραφή με εσφαλμένο κωδικό ελέγχου ταυτότητας μηνύματος.
ssl-error-bad-mac-alert = Ο ομότιμος κόμβος SSL αναφέρει εσφαλμένο κωδικό ταυτοποίησης μηνύματος.
ssl-error-bad-cert-alert = Ο ομότιμος κόμβος SSL δεν μπορεί να επαληθεύσει το πιστοποιητικό σας.
ssl-error-revoked-cert-alert = Ο ομότιμος κόμβος SSL απέρριψε το πιστοποιητικό σας γιατί έχει ανακληθεί.
ssl-error-expired-cert-alert = Ο ομότιμος κόμβος SSL απέρριψε το πιστοποιητικό σας γιατί έχει λήξει.
ssl-error-ssl-disabled = Αδυναμία σύνδεσης: το SSL είναι ανενεργό.
ssl-error-fortezza-pqg = Αδυναμία σύνδεσης: ο ομότιμος κόμβος SSL βρίσκεται σε άλλο τομέα FORTEZZA.
...
ssl-error-close-notify-alert = Ο ομότιμος κόμβος SSL έχει κλείσει αυτήν τη σύνδεση.
ssl-error-handshake-unexpected-alert = Ο ομότιμος κόμβος SSL δεν περίμενε ένα μήνυμα χειραψίας που έλαβε.
ssl-error-decompression-failure-alert = Ο ομότιμος κόμβος SSL δεν μπόρεσε να αποσυμπιέσει επιτυχώς μια εγγραφή SSL που έλαβε.
ssl-error-handshake-failure-alert = Ο ομότιμος κόμβος SSL δεν μπόρεσε να διαπραγματευτεί ένα αποδεκτό σύνολο παραμέτρων ασφαλείας.
ssl-error-illegal-parameter-alert = Ο ομότιμος κόμβος SSL απέρριψε ένα μήνυμα χειραψίας λόγω μη αποδεκτού περιεχομένου.
ssl-error-unsupported-cert-alert = Ο ομότιμος κόμβος SSL δεν υποστηρίζει πιστοποιητικά του τύπου που έλαβε.
ssl-error-certificate-unknown-alert = Ο ομότιμος κόμβος SSL αντιμετώπισε κάποιο απροσδιόριστο ζήτημα με το πιστοποιητικό που έλαβε.
...
ssl-error-extract-public-key-failure = Το SSL δεν μπόρεσε να εξαγάγει το δημόσιο κλειδί από το πιστοποιητικό του ομότιμου κόμβου.
...
ssl-error-socket-write-failure = Η απόπειρα εγγραφής των κρυπτογραφημένων δεδομένων στη βασική υποδοχή απέτυχε.
...
ssl-error-decryption-failed-alert = Ο ομότιμος κόμβος δεν μπόρεσε να αποκρυπτογραφήσει μια εγγραφή SSL που έλαβε.
ssl-error-record-overflow-alert = Ο ομότιμος κόμβος έλαβε μια εγγραφή SSL που ήταν μεγαλύτερη από το επιτρεπτό.
ssl-error-unknown-ca-alert = Ο ομότιμος κόμβος δεν αναγνωρίζει ούτε εμπιστεύεται την αρχή πιστοποίησης που εξέδωσε το πιστοποιητικό σας.
ssl-error-access-denied-alert = Ο ομότιμος κόμβος έλαβε ένα έγκυρο πιστοποιητικό, αλλά δεν επιτράπηκε η πρόσβαση.
ssl-error-decode-error-alert = Ο ομότιμος κόμβος δεν μπόρεσε να αποκωδικοποιήσει ένα μήνυμα χειραψίας SSL.
ssl-error-decrypt-error-alert = Ο ομότιμος κόμβος αναφέρει αποτυχία επαλήθευσης της υπογραφής ή της ανταλλαγής κλειδιών.
ssl-error-export-restriction-alert = Ο ομότιμος κόμβος αναφέρει ότι η διαπραγμάτευση δεν συμμορφώνεται με τους κανονισμούς εξαγωγής.
ssl-error-protocol-version-alert = Ο ομότιμος κόμβος αναφέρει μη συμβατή ή μη υποστηριζόμενη έκδοση πρωτοκόλλου.
...
ssl-error-internal-error-alert = Ο ομότιμος κόμβος αναφέρει ότι αντιμετώπισε εσωτερικό σφάλμα.
ssl-error-user-canceled-alert = Ο ομότιμος χρήστης ακύρωσε τη χειραψία.
ssl-error-no-renegotiation-alert = Ο ομότιμος κόμβος δεν επιτρέπει την επαναδιαπραγμάτευση των παραμέτρων ασφαλείας SSL.
...
ssl-error-unsupported-extension-alert = Ο ομότιμος κόμβος SSL δεν υποστηρίζει τη ζητούμενη επέκταση TLS hello.
ssl-error-certificate-unobtainable-alert = Ο ομότιμος κόμβος SSL δεν μπόρεσε να λάβει το πιστοποιητικό σας από το παρεχόμενο URL.
ssl-error-unrecognized-name-alert = Ο ομότιμος κόμβος SSL δεν διαθέτει κανένα πιστοποιητικό για το ζητούμενο όνομα DNS.
ssl-error-bad-cert-status-response-alert = Ο ομότιμος κόμβος SSL δεν μπόρεσε να λάβει απόκριση OCSP για το πιστοποιητικό του.
ssl-error-bad-cert-hash-value-alert = Ο ομότιμος κόμβος SSL ανέφερε εσφαλμένη τιμή hash πιστοποιητικού.
...
ssl-error-unsafe-negotiation = Ο ομότιμος κόμβος επιχείρησε να εκτελέσει χειραψία παλαιού στυλ (δυνητικά ευάλωτη).
...
ssl-error-cipher-disallowed-for-version = Ο ομότιμος κόμβος SSL επέλεξε μια σουίτα κρυπτογράφησης που δεν επιτρέπεται για την έκδοση του επιλεγμένου πρωτοκόλλου.
...
ssl-error-unsupported-hash-algorithm = Χρησιμοποιείται μη υποστηριζόμενος αλγόριθμος hash από τον ομότιμο κόμβο TLS.
...
ssl-error-inappropriate-fallback-alert = Ο διακομιστής απέρριψε τη χειραψία, επειδή το πρόγραμμα-πελάτης την υποβάθμισε σε χαμηλότερη έκδοση TLS από αυτήν που υποστηρίζει ο διακομιστής.
...
ssl-error-unsupported-signature-algorithm = Ο ομότιμος κόμβος χρησιμοποίησε έναν μη υποστηριζόμενο συνδυασμό υπογραφής και αλγόριθμου hash.
ssl-error-missing-extended-master-secret = Ο ομότιμος κόμβος προσπάθησε να συνεχίσει χωρίς τη σωστή επέκταση extended_master_secret.
ssl-error-unexpected-extended-master-secret = Ο ομότιμος κόμβος προσπάθησε να συνεχίσει με απρόσμενη επέκταση extended_master_secret.
...
sec-error-bad-signature = Το ομότιμο πιστοποιητικό δεν έχει έγκυρη υπογραφή.
sec-error-expired-certificate = Το ομότιμο πιστοποιητικό έχει λήξει.
sec-error-revoked-certificate = Το ομότιμο πιστοποιητικό έχει ανακληθεί.
sec-error-unknown-issuer = Ο εκδότης του ομότιμου πιστοποιητικού δεν αναγνωρίζεται.
sec-error-bad-key = Το ομότιμο δημόσιο κλειδί δεν είναι έγκυρο.
sec-error-bad-password = Ο κωδικός πρόσβασης που δώσατε είναι εσφαλμένος.
sec-error-retry-password = Ο νέος κωδικός πρόσβασης δεν πληκτρολογήθηκε σωστά. Δοκιμάστε ξανά.
...
sec-error-untrusted-issuer = Ο εκδότης του ομότιμου πιστοποιητικού έχει επισημανθεί ως αναξιόπιστος από τον χρήστη.
sec-error-untrusted-cert = Το ομότιμο πιστοποιητικό έχει επισημανθεί ως αναξιόπιστο από τον χρήστη.
...
sec-error-filing-key = Σφάλμα κατά τη συμπλήρωση του κλειδιού για αυτό το πιστοποιητικό.
...
sec-error-invalid-key = Το κλειδί δεν υποστηρίζει τη λειτουργία που ζητήθηκε.
...
sec-error-invalid-password = Ο κωδικός πρόσβασης που πληκτρολογήσατε δεν είναι έγκυρος. Επιλέξτε έναν άλλο.
sec-error-retry-old-password = Ο παλιός κωδικός πρόσβασης δεν πληκτρολογήθηκε σωστά. Δοκιμάστε ξανά.
sec-error-bad-nickname = Το ψευδώνυμο του πιστοποιητικού είναι ήδη σε χρήση.
sec-error-not-fortezza-issuer = Η ομότιμη αλυσίδα FORTEZZA δεν έχει πιστοποιητικό FORTEZZA.
...
sec-error-ocsp-malformed-request = Ο διακομιστής OCSP διαπίστωσε ότι το αίτημα είναι κατεστραμμένο ή ακατάλληλα μορφοποιημένο.
...
sec-error-libpkix-internal = Προέκυψε εσωτερικό σφάλμα libpkix κατά την επικύρωση του πιστοποιητικού.
...
sec-error-pkcs11-device-error = Μια μονάδα PKCS #11 επέστρεψε CKR_DEVICE_ERROR, πράγμα που σημαίνει ΄ότι προέκυψε πρόβλημα με το διακριτικό ή την υποδοχή.
...
mozilla-pkix-error-ca-cert-used-as-end-entity = Ο διακομιστής χρησιμοποιεί πιστοποιητικό με επέκταση των βασικών περιορισμών, προσδιορίζοντάς το ως αρχή πιστοποίησης. Αυτό δεν πρέπει να συμβαίνει για ένα πιστοποιητικό που έχει εκδοθεί σωστά.
...
xp-sec-fortezza-more-info = Επιλέξτε ένα πρόσωπο για περισσότερες πληροφορίες
