...
details-notification-softblocked-extension-disabled =
    .message = Αυτή η επέκταση παραβιάζει τις πολιτικές της Mozilla και έχει απενεργοποιηθεί. Μπορείτε να την ενεργοποιήσετε, αλλά αυτό ενδέχεται να είναι επικίνδυνο.
...
details-notification-softblocked-other-disabled =
    .message = Αυτό το πρόσθετο παραβιάζει τις πολιτικές της Mozilla και έχει απενεργοποιηθεί. Μπορείτε να το ενεργοποιήσετε, αλλά αυτό ενδέχεται να είναι επικίνδυνο.
