...
about-networking-rcwn-operation = Λειτουργία προσωρινής μνήμης
...
about-networking-rcwn-cache-slow = Αργή μέτρηση προσωρινής μνήμης
about-networking-rcwn-cache-not-slow = Μη αργή μέτρηση προσωρινής μνήμης
