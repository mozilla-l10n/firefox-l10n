...
about-httpsonly-suggestion-box-www-text = Υπάρχει μια ασφαλής έκδοση του <em>www.{ $websiteUrl }</em>. Μπορείτε να επισκεφθείτε αυτήν τη σελίδα αντί του <em>{ $websiteUrl }</em>.
