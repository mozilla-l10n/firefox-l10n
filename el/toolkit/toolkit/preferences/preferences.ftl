...
incorrect-pp = Δεν πληκτρολογήσατε τον σωστό κύριο κωδικό πρόσβασης. Δοκιμάστε ξανά.
...
set-password-new =
    .label = Εισαγάγετε έναν νέο κωδικό πρόσβασης:
...
primary-password-description = Ένας κύριος κωδικός πρόσβασης χρησιμοποιείται για την προστασία ορισμένων ευαίσθητων πληροφοριών, όπως συνδέσεις και κωδικοί πρόσβασης, σε αυτήν τη συσκευή. Εάν δημιουργήσετε έναν κύριο κωδικό πρόσβασης, θα σας ζητηθεί να τον εισαγάγετε μία φορά ανά συνεδρία, όταν το { -brand-short-name } ανακτά αποθηκευμένες πληροφορίες που προστατεύονται από αυτόν τον κωδικό πρόσβασης.
primary-password-warning = Φροντίστε να μην ξεχάσετε τον κύριο κωδικό πρόσβασης που έχετε ορίσει. Διαφορετικά, θα χάσετε την πρόσβαση στις πληροφορίες που προστατεύει σε αυτήν τη συσκευή.
remove-primary-password =
    .title = Αφαίρεση κύριου κωδικού πρόσβασης
remove-primary-password-info =
    .value = Πρέπει να εισαγάγετε τον κύριο κωδικό πρόσβασής σας για να συνεχίσετε.
