...
openpgp-no-sig-info = Αυτό το μήνυμα δεν περιέχει την ψηφιακή υπογραφή του αποστολέα. Η απουσία ψηφιακής υπογραφής σημαίνει ότι το μήνυμα μπορεί να έχει σταλεί από κάποιον που προσποιείται ότι έχει αυτή τη διεύθυνση e-mail. Επίσης, ενδέχεται να έχει αλλοιωθεί το μήνυμα κατά τη μεταβίβαση στο δίκτυο.
