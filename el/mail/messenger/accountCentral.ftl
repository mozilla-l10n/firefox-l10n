...
import-paragraph2 = Το { -brand-short-name } σας επιτρέπει να εισάγετε μηνύματα e-mail, καταχωρήσεις ευρετηρίων διευθύνσεων, συνδρομές ροών, ρυθμίσεις ή/και φίλτρα από άλλα προγράμματα e-mail και συνηθισμένες μορφές ευρετηρίων διευθύνσεων.
