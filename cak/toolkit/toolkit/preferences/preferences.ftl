...
pw-change-ok = Ütz xjal ri ajtij ewan tzij. { pw-empty-warning }
...
pw-not-wanted = ¡Tawak'axaj! Man xawajo' ta xawokisaj jun ajtij ewan tzij.
...
pw-change-failed-title = Sachoj toq nijal ri ewan tzij
pw-remove-button =
    .label = Telesäx el
