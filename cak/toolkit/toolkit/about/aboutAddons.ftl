...
theme-monochromatic-heading = Rutunïk b'onil
# Refers to the button label for the colorways card when a user does not have a colorway theme enabled.
theme-colorways-button = Ketojtob'ëx rutunik b'onil
# Refers to the button label for the colorways card when a user has a colorway theme enabled.
theme-colorways-button-colorway-enabled = Tijal rutunik b'onil
# Variables:
#   $expiryDate (string) - Date on which the colorway collection expires. When formatting this, you may omit the year, only exposing the month and day, as colorway collections will always expire within a year.
colorway-collection-expiry-label = Nik'is { DATETIME($expiryDate, month: "long", day: "numeric") }
