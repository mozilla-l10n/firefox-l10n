...
colorpicker-tooltip-spectrum-dragger-title = Espekto
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = Ticha' b'onil pa ruxaq
...
colorpicker-tooltip-color-name-title = Naqaj chi re: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Ruwa
# A title text for the alpha slider in the color picker tooltip.
colorpicker-tooltip-alpha-slider-title = Q'equmal
