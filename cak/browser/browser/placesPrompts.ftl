...
places-bookmarks-restore-title = Ticha' jun ruwachib'al ri taq yaketal
places-bookmarks-restore-filter-name = JSON
places-bookmarks-restore-format-error = Man nikoch'otäj ta ri ruwäch chi yakb'äl.
places-bookmarks-restore-parse-error = Man ntikïr ta nusamajij ri ruyakb'al ruwachib'al chajinïk.
places-bookmarks-import = Kek'am pe ri taq kiyakb'al yaketal
places-bookmarks-export = Kek'wäx el ri kiyakb'al taq yak'etal
