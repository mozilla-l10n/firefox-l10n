...
firefoxview-tabpickup-header = Ximon ruwi'
firefoxview-tabpickup-description = Kejaq taq ruxaq e k'o pa ch'aqa' chik taq okisaxel.
# Variables:
#  $percentValue (Number): the percentage value for setup completion
firefoxview-tabpickup-progress-label = { $percentValue }% tz'aqät
...
firefoxview-tabpickup-adddevice-primarybutton = Tik'ul { -brand-product-name } richin oyonib'äl
firefoxview-syncedtabs-adddevice-primarybutton = Titojtob'ëx { -brand-product-name } richin oyonib'äl
firefoxview-tabpickup-synctabs-header = Titzij kiximoj ruwi'
firefoxview-tabpickup-synctabs-description = Tiya' q'ij chi re { -brand-short-name } yerukomonij taq ruwi' chi kikojol taq okisaxel.
...
firefoxview-tabpickup-signed-out-description = Richin yatok chik richin ye'atz'ët ri taq ruwi', tatikirisaj molojri'ïl pa { -fxaccount-brand-name }.
