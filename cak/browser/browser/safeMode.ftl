...
troubleshoot-mode-window =
    .title = La nijaq { -brand-short-name } pa Rub'eyal Rusolik K'ayewal?
    .style = max-width: 400px
...
troubleshoot-mode-description = Tokisäx re ütz rub'eyal { -brand-short-name } richin yekanöx taq k'ayewal. Ri taq k'amal chuqa' taq ichinanem xkechup jumej.
skip-troubleshoot-refresh-profile = Chuqa' yatikïr choj yatik'o chuwäch ri rub'eyal rusolik k'ayewal chuqa' ütz nitzolïx { -brand-short-name }.
