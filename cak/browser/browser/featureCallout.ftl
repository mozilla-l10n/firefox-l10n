...
callout-primary-advance-button-label = Jun chik
# Callout dialog primary button to complete the feature tour
callout-primary-complete-button-label = ¡K'o chik wik'in!

## Firefox View feature tour strings

# "Tab pickup" refers to the section in Firefox View that displays open
# tabs from other devices
callout-firefox-view-tab-pickup-title = Katokiyaj pa taq awoyonib'äl akuchi' ye'ak'waj el ri taq ruwi'
