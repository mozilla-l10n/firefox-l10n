...
screenshots-connection-error-details = Tanik'oj awokem pa K'amaya'l. We yatok pa K'amaya'l, rik'in jub'a' xtuya' k'ayewal pa rusamaj ri Firefox taq Chapoj Wachib'äl.
screenshots-login-error-details = Man xkatikïr ta xtayäk ri awachib'al ruma jun ruk'ayewal toq nisamäj ri Firefox Chapoj Wachib'äl. Tatojtob'ej chik pa jun mej.
...
screenshots-self-screenshot-error-title = ¡Man yatikïr ta nawelesaj ruwachib'al jun ruxaq Firefox Chapoj Wachib'äl!
screenshots-empty-selection-error-title = Yalan ko'öl ri acha'oj
screenshots-private-window-error-title = Echupun ri Chapoj taq Wachib'äl pa Ichinan Okem pa K'amaya'l
...
screenshots-generic-error-title = ¡Itz! Itzel xe'el ri Firefox Chapoj Wachib'äl.
