...
pippki-pw-empty-warning = Your stored passwirds and preevat keys willnae be biildit.
...
reset-password-button-label =
    .label = Reset
reset-password-text = If ye reset yer maister passwird, aw yer stored wab and e-mail passwirds, form data, personal certificates, and preevat keys will be forgotten. Are ye shair ye're wantin tae reset yer maister passwird?
reset-primary-password-text = If ye reset yer Primary Passwird, aw yer stored wab and e-mail passwirds,personal certificates, and preevat keys will be forgotten. Are ye shair ye're wantin tae reset yer Primary Passwird?
