...
fp-neterror-denied-port-access = This address yaises a netwark port which is fur ordinar yaised fur purposes ither nor Wab stravaigin. { -brand-short-name } has stappit the request fur tae bield ye.
