...
safeb-blocked-malware-page-error-desc-override = <span data-l10n-name='sitename'>{ $sitename }</span> has been <a data-l10n-name='error_desc_link'>reportit as conteenin uncannie saftware</a>. Ye can <a data-l10n-name='report_detection'>report a detection problem</a> or <a data-l10n-name='ignore_warning_link'>tak nae tent o the risk</a> and gang aheid tae this site that's no sauf.
safeb-blocked-malware-page-error-desc-no-override = <span data-l10n-name='sitename'>{ $sitename }</span> has been <a data-l10n-name='error_desc_link'>reportit as conteenin uncannie saftware</a>. Ye can <a data-l10n-name='report_detection'>report a detection problem</a>.
safeb-blocked-malware-page-learn-more = Lairn mair aboot hairmfu wab content includin viruses and ither malware and how tae bield yer computer at <a data-l10n-name='learn_more_link'>StopBadware.org</a>. Lairn mair aboot { -brand-short-name }’s Phishin and Malware Bieldin at <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
