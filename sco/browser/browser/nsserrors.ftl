...
xp-sec-fortezza-bad-card = Fortezza card hasnae been initialised richt. Please remuive it and gie it back tae yer issuer.
...
sec-error-ocsp-bad-http-response = The OCSP server returned unexpectit/no valid HTTP data.
...
sec-error-ocsp-malformed-response = The repone fae the OCSP server wis camshauchlet or ill-makit.
sec-error-ocsp-unauthorized-response = The signer o the OCSP repone isnae authorized tae gie status fur this certificate.
sec-error-ocsp-future-response = The OCSP repone isnae valid jist yet (conteens a date in the future).
...
sec-error-bad-template = Couldnae decode ASN.1 data. Specified template wisnae valid.
sec-error-crl-not-found = Nae matchin CRL wis fund.
sec-error-reused-issuer-and-serial = Yer ettlin at inbringin a cert wi the same issuer/serial as an existin cert, but that isnae the same cert.
...
sec-error-ocsp-invalid-signing-cert = Invalid OCSP signin certificate in OCSP repone.
...
sec-error-ocsp-responder-cert-invalid = Confeegurt OCSP responder’s certificate isnae valid.
sec-error-ocsp-bad-signature = OCSP repone has a signature that isnae valid.
...
sec-error-bad-crl-dp-url = Invalid or unsupportit URL in CRL distribution pynt nemme.
...
mozilla-pkix-error-not-yet-valid-certificate = The server presentit a certificate that isnae valid jist yet.
mozilla-pkix-error-not-yet-valid-issuer-certificate = A certificate that isnae valid jist yet wis yaised tae issue the server’s certificate.
...
mozilla-pkix-error-validity-too-long = The server presentit a certificate that is valid fur ower lang.
mozilla-pkix-error-required-tls-feature-missing = A needit TLS feature is tint.
mozilla-pkix-error-invalid-integer-encoding = The server presentit a certificate that conteens an invalid encodin o an integer. Common causes include negative serial nummers and negative RSA moduli forby encodins that are mair muckle nor necessar.
