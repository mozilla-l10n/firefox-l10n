...
sec-error-pkcs12-decoding-pfx = No able tae inbring. Decodin mishanter. File no valid.
sec-error-pkcs12-invalid-mac = No able tae inbring. MAC no valid. Wrang passwird or camshauchlet file.
sec-error-pkcs12-unsupported-mac-algorithm = No able tae inbring. MAC algorithm no supportit.
