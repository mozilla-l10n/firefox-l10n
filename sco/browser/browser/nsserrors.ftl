...
ssl-error-bad-handshake-hash-value = Haunshakes hash values received fae peer arenae correct.
...
ssl-error-record-overflow-alert = Peer received an SSL record that wis mair muckle nor permittit.
