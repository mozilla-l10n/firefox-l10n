...
lost = <b>Ye hivnae lost ony personal data or customisations.</b> Gin ye've awready saved information tae Firefox on this computer, it'll aye be there in anither Firefox instawment.
options-title = Whit can I dae noo?
options-do-nothing = Gin ye dinnae dae onythin, yer profile data in { -brand-short-name } will be different fae yer profile data in ither instawments o Firefox.
