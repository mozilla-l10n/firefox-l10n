...
refresh-unused-profile-infobar-message = It luiks like ye hivnae stertit { -brand-short-name } in a wee while. Dae ye want tae clean it up for a fresh oot the box experience? And by the wey, guid tae see ye again!
refresh-reinstalled-profile-infobar-message = Luiks like ye've instawed { -brand-short-name }. Want us tae clean it up for a fresh oot the box experience?
