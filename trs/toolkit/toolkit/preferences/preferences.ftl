...
set-password-old =
    .label = Da’nga’ huì nikājt akuan’ nïn:
set-password-new =
    .label = Gachrūn da’nga’ huì nakàa:
set-password-reenter =
    .label = Gachrūn ñû da’nga’ huìi:
...
remove-password-old =
    .label = Da'nga' huì nikājt akuan' nïn:
remove-password-old-password =
    .value = Da'nga' huì nikājt akuan' nïn:
set-password-not-set =
    .label = Da’nga’ huì nikājt akuan’ nïn:
    .placeholder = (nitāj si nunj)
