...
about-private-browsing-info-bookmarks = Lieszeechen
about-private-browsing-info-searches = Recherchen
about-private-browsing-info-downloads = Downloads
private-browsing-title = Privat surfen
about-private-browsing-info-saved = { -brand-short-name } <strong>gëtt gespäichert</strong> :
about-private-browsing-info-temporary-files = temporär Dateien
