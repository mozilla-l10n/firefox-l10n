...
certmgr-tab-ca =
    .label = Авторитети
certmgr-mine = Имате сертификати од следниве организации кои ве идентификуваат
certmgr-remembered = Овие сертификати се користат за да Ве идентификуваат на мрежни места
certmgr-people = Имате сертфикати кои ги идентификуваат следниве луѓе
certmgr-server = Овие записи ги идентификуваат исклучоците за грешки во сертификатот на серверот
certmgr-ca = Имате сертификати кои ги идентификуваат следниве авторитети
...
delete-ssl-override-title =
    .title = Бришење на исклучок за серверските сертификати
delete-ssl-override-confirm = Сигурно сакате да го избришете овој исклучок за сервери?
delete-ssl-override-impact = Со бришење на исклучок за сервер, ги враќате вообичаените безбедносни проверки за тој сервер и барате тој да користи важечки сертификат.
...
add-exception-domain-mismatch-long = Сертификатот припаѓа на друго место, што може да значи дека некој се обидува да се претстави како ова место.
add-exception-expired-short = Застарени информации
add-exception-expired-long = Сертификатот моментално не е важечки. Можеби е украден или изгубен и можеби некој го користи за лажно претставување на ова место.
add-exception-unverified-or-bad-signature-short = Непознат идентитет
add-exception-unverified-or-bad-signature-long = На сертификатото не му се верува бидејќи не е потврден дека е изаден од организација на која што ѝ се верува и со користење на безбеден потпис.
...
add-exception-checking-long = Се обидувам да ја идентификувам оваа страница…
add-exception-no-cert-short = Нема достапни информации
add-exception-no-cert-long = Не може да се добие статус на идентификација за оваа страница.
