...
about-private-browsing-info-bookmarks = обележувачи
about-private-browsing-info-searches = пребарувања
about-private-browsing-info-downloads = преземања
private-browsing-title = Приватно прелистување
about-private-browsing-info-saved = { -brand-short-name } <strong>ќе ги сочува </strong> вашите:
about-private-browsing-info-temporary-files = привремени датотеки
about-private-browsing-info-cookies = колачиња
