...
crashed-send-report-2 = Испратете автоматизиран извештај урување за да можеме да ги поправиме ваквите грешки.
crashed-comment =
    .placeholder = Дополнителни коментари (коментарите се јавно-видливи)
crashed-include-URL-2 = Вклучете ги URL-ата на мрежните места што ги посетувавте  кога { -brand-short-name } се урна.
...
crashed-auto-submit-checkbox-2 = Ажурирајте ги прилагодувањата за автоматски да се испраќаат извештаи кога { -brand-short-name } ќе се урне.
