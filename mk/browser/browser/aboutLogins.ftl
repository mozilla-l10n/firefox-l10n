...
login-intro-instructions-fxa = Создадете или најавете се на вашето име { -fxaccount-brand-name(capitalization: "sentence") } на уредот каде што се зачувуваат вашите најавувања.
