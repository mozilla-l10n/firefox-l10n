...
devtools-tooltip-learn-more = Дознајте повеќе
...
inactive-css-not-grid-or-flex-container-fix-1 = Обидете се да додадете <strong>display:grid</strong> или <strong>display:flex</strong>.
inactive-css-not-flex-container-fix-1 = Обидете се да додадете <strong>display:flex</strong> или <strong>display:inline-flex</strong>.
inactive-css-not-inline-or-tablecell-fix-1 = Обидете се да додадете <strong>display:inline</strong> или <strong>display:table-cell</strong>.
inactive-css-non-replaced-inline-or-table-row-or-row-group-fix-1 = Обидете се да додадете <strong>display:inline-block</strong> или <strong>display:block</strong>.
inactive-css-non-replaced-inline-or-table-column-or-column-group-fix-1 = Обидете се да додадете <strong>display:inline-block</strong>.
