...
btp-warning-tracker-classified =
    { $gracePeriodSeconds ->
        [one] „{ $siteHost }“ е класифициран како "bounce" програма за следење. Доколку не добие активација од корисник во следната { $gracePeriodSeconds } секунда, неговата состојба ќе биде избришана.
       *[other] „{ $siteHost }“ е класифициран како "bounce" програма за следење. Доколку не добие активација од корисник во следните { $gracePeriodSeconds } секунди, неговата состојба ќе биде избришана.
    }
...
btp-warning-tracker-purged = Состојбата на “{ $siteHost }” неодамна беше избришана бидејќи беше препознаен како „bounce“ програма за следење.
