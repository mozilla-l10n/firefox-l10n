...
cert-error-revoked-certificate = { -brand-short-name } ја блокираше посетатат на ова место бидејќи сертификатот доставен за { $hostname } е повлечен и повеќе не е доверлив.
