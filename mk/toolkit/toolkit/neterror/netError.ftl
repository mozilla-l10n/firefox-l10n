...
# Variables:
# $mitm (String) - The name of the software intercepting communications between you and the website (or “man in the middle”)
certerror-mitm-what-can-you-do-about-it-attack = Ако не знаете за <b>{ $mitm }</b>, тогаш ова може да биде напад и не треба да продолжувате на страницата.
# Variables:
# $mitm (String) - The name of the software intercepting communications between you and the website (or “man in the middle”)
certerror-mitm-what-can-you-do-about-it-attack-sts = Ако не знаете за <b>{ $mitm }</b>, тогаш ова може да биде напад, и нема што да направите за да го посетите местото.
# Variables:
# $hostname (String) - Hostname of the website to which the user was trying to connect.
certerror-what-should-i-do-bad-sts-cert-explanation = <b>{ $hostname }</b> има безбедносна политика наречена HTTP Strict Transport Security (HSTS), што значи дека { -brand-short-name } може да се поврзе само безбедно со него. Не можете да направите исклучок за да ја посетите оваа страница.
cert-error-trust-certificate-transparency-what-can-you-do-about-it = Веројатно ништо, бидејќи веројатно има проблем со самото место.
certerror-blocked-by-corp-headers-description = Понекогаш мрежните места поставуваат заштита за себе и за луѓе како вас од несакани интеракции со други страници.
certerror-coop-learn-more = Дознајте повеќе за Cross Origin Opener Policies (COOP)
certerror-coep-learn-more = Дознајте повеќе за Cross Origin Embedder Policies (COEP)
# Variables:
#   $responsestatus (string) - HTTP response status code (e.g., 500).
#   $responsestatustext (string) - HTTP response status text (e.g., "Internal Server Error").
neterror-response-status-code = Код за грешка: { $responsestatus } { $responsestatustext }

## Felt Privacy V1 Strings

fp-neterror-offline-body-title = Изгледа како да има проблем со Вашата интернет врска
fp-neterror-illustration-alt =
    .alt = Илустрација на лисица која гледа во исклучени мрежни кабли.
...
# Variables:
#   $hostname (String) - Hostname of the website to which the user was trying to connect.
fp-neterror-invalid-header-value-intro = <strong>{ $hostname }</strong> врати заглавие со празни знаци што не е дозволено според стандардите за мрежна безбедност.
fp-neterror-content-encoding-intro = Страницата која се обидувате да ја посетите не може да биде прикажана бидејќи користи неважечка или неподдржана форма на компресија.
