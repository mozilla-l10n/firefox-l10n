...
title = За вмрежување
show-next-time-checkbox = Покажи го предупредувањето следен пат
ok = Во ред
http = HTTP
sockets = Сокети
dns = DNS
...
family = Фамилија
addresses = Адреси
expires = Истекува (секунди)
messages-sent = Испратени пораки
messages-received = Примени пораки
bytes-sent = Испратени бајти
bytes-received = Примени бајти
dns-lookup = Пребарување на DNS
dns-lookup-button = Разреши
dns-domain = Домен:
rcwn = Статистика за RCWN
rcwn-status = Статус на RCWN
rcwn-perf-open = Отворени
rcwn-perf-read = Прочитани
rcwn-perf-write = Запишани
