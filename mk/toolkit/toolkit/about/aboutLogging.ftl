...
about-logging-logging-output-selection = Резултат од бележење
about-logging-logging-to-file = Бележење во датотека
about-logging-logging-to-profiler = Бележење во { -profiler-brand-name }
about-logging-no-log-modules = Ништо
about-logging-no-log-file = Ништо
about-logging-logging-preset-selector-text = Поставки за бележење:
about-logging-with-profiler-stacks-checkbox = Овозможи траги од stack за белешките
about-logging-with-javascript-tracing-checkbox = Овозможи следење на JavaScript
about-logging-menu =
...
about-logging-preset-networking-description = Модули на записникот за дијагноза на мрежни проблеми
about-logging-preset-networking-cookie-label = Колачиња
about-logging-preset-networking-cookie-description = Модули на записникот за дијагноза на проблеми со колачиња
