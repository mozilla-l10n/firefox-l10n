...
pdfjs-views-manager-outlines-title = Преглед на документот
...
pdfjs-views-manager-layers-title = Слоеви
...
pdfjs-views-manager-pages-status-save-as-button-label = Сними како…
# Variables:
