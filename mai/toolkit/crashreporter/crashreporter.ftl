...
crashreporter-title = क्रैश रिपोटर
...
crashreporter-button-details = विवरण...
crashreporter-view-report-title = अंतर्वस्तु रिपोट करू
crashreporter-comment-prompt = टिप्पणी जोड़ू (टिप्पणियाँ सार्वजनिक अछि)
...
crashreporter-button-quit = छोड़ू { -brand-short-name }
crashreporter-button-restart = फेर आरंभ करू { -brand-short-name }
crashreporter-button-ok = बेस
crashreporter-button-close = बन्न करू
# $id (String) - the crash id from the server, typically a UUID
crashreporter-crash-identifier = क्रैश ID: { $id }
