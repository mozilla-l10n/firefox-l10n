...
xslt-parse-failure = एकटा XSLT स्टाइलशीट विश्लेषण विफल.
...
xslt-bad-recursion = XSLT स्टाइलशीट (possibly) पुनरावर्तन समाहित करैत अछि.
xslt-bad-value = XSLT 1.0 मे अवैध मान राखैत अछि.
xslt-nodeset-expected = एकटा XPath अभिव्यक्ति एकटा NodeSet घुरैनाइ प्रत्याशित अछि.
xslt-aborted = XSLT रूपांतरण <xsl:message> क द्वारा रोकल गेल.
...
xslt-unknown-error = एकटा अज्ञात त्रुटि उत्पन्न भेल ({ $errorCode })
