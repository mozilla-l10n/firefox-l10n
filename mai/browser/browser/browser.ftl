...
urlbar-result-menu-button-feedback = फ़ीडबैक
    .title = मेनू खोलू
urlbar-result-menu-learn-more2 = बेसी जानू
    .accesskey = L
urlbar-result-menu-remove-from-history2 = इतिहास सँ मेटाबू
    .accesskey = R
urlbar-result-menu-tip-get-help2 = मदति पाबू
    .accesskey = h
...
urlbar-searchmode-popup-add-engine = जोड़ू“{ $engineName }”
    .title = खोज इंजिन जोड़ू “{ $engineName }”
