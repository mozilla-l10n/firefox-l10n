...
pocket-panel-saved-error-no-internet = अहाँ केँ इंटरनेट सँ कनेक्ट रह पड़त { -pocket-brand-name } केँ सहेजबाक लेल. कृप्या इंटरनेट सँ कनेक्ट करू आओर फिनु कोसिस करू.
pocket-panel-saved-error-remove = एहि पृष्ठ केँ मेटाबए केर कोसिस करै मे त्रुटि भेल.
...
pocket-panel-signup-already-have = पहिले सँ एकटा { -pocket-brand-name } उपयोक्ता अछि?
pocket-panel-signup-learn-more = बेसी जानू
...
pocket-panel-signup-cta-b = आर्टिकिल, वीडियो आओर लिंक सहेजबाक लेल { -pocket-brand-name } बटन केँ क्लिक करू. अहाँ अपन सहेजल सूची कखनो, कोनो डिवाइस पर देखि सकैत छी
...
pocket-panel-home-new-user-message = अपन हाल केर सहेजल एतय देखू.
