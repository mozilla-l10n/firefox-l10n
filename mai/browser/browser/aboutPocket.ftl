...
pocket-panel-saved-error-no-internet = अहाँ केँ इंटरनेट सँ कनेक्ट रह पड़त { -pocket-brand-name } केँ सहेजबाक लेल. कृप्या इंटरनेट सँ कनेक्ट करू आओर फिमु कोसिस करू.
