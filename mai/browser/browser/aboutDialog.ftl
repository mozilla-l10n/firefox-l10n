...
settings-update-checking-for-updates =
    .label = अद्यतनक लेल जाँचि रहल अछि…
...
settings-update-other-instance-handling-updates =
    .label = { -brand-short-name } केँ दोसर इंस्टांस केर द्वारा अद्यतन कएल जाए रहल अछि
...
settings-update-unsupported = अहाँ एहि तंत्र पर आगाँ अद्यतन नहि कए सकैत अछि.<a data-l10n-name="unsupported-link">बेसी जानू</a>
update-restarting = पुन: प्रारंभ भ रहल अछि...
settings-update-restarting =
    .label = पुन: प्रारंभ भ रहल अछि...
...
settings-update-internal-error = आंतरिक त्रुटि के कारण अपडेट जाँचए में अक्षम. अपडेट <a data-l10n-name="manual-link">{ $displayUrl }</a> पर भेटत.
