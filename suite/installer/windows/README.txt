...
SeaMonkey is subject to the terms detailed in the licence agreement
accompanying it.
...
make sure you're running the installation with Administrator privileges.
   ...
   1. Click the link to seamonkey-x.xx.en-GB.win32.installer.exe (or
   ...
   1. Click the link to seamonkey-x.xx.en-GB.win32.zip (or similar file
