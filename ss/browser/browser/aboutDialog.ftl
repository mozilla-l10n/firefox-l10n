...
aboutdialog-update-manual-with-link = Sekukhona lokusha ka<label data-l10n-name="manual-link">{ $displayUrl }</label>
settings-update-manual-with-link = Sekukhona lokusha ka<a data-l10n-name="manual-link">{ $displayUrl }</a>
