...
# This string appears after the following string: "What can you do about it?" (fp-certerror-what-can-you-do)
fp-certerror-unknown-issuer-what-can-you-do-body = น่าจะไม่มีปัญหาอะไร เนื่องจากน่าจะเป็นปัญหากับตัวไซต์มากกว่า แต่ถ้าคุณใช้เครือข่ายองค์กร ทีมช่วยเหลือของคุณอาจจะมีข้อมูลมากกว่านี้ ถ้าคุณกำลังใช้ซอฟต์แวร์แอนติไวรัส ก็อาจจะต้องไปกำหนดค่าใหม่ให้ทำงานกับ { -brand-short-name } ได้
# This string appears after the following string: "What makes the site look dangerous?" (fp-certerror-why-site-dangerous)
