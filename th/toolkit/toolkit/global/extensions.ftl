...
webext-site-perms-description-gated-perms-serial =
    อุปกรณ์เหล่านี้ได้แก่ไมโครคอนโทรลเลอร์ เครื่องพิมพ์ 3 มิติ และอุปกรณ์อื่น ๆ ที่เชื่อมต่อผ่านพอร์ต USB หรือซีเรียล
    
    คุณสามารถเลือกได้ว่าเว็บไซต์สามารถเข้าถึงอุปกรณ์ใดได้บ้าง
    
    เว็บไซต์ไม่สามารถเข้าถึงอุปกรณ์ซีเรียลได้โดยปกติ เนื่องจากการใช้งานที่ไม่เหมาะสมอาจสร้างความเสียหายหรือรุกล้ำความปลอดภัย
