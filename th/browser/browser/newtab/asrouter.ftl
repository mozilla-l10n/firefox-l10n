...
launch-on-login-spotlight-title = ต้องการให้ { -brand-short-name } เปิดขึ้นโดยอัตโนมัติในครั้งถัดไปที่คุณเปิดคอมพิวเตอร์หรือไม่?
launch-on-login-spotlight-startup-checkbox = เปิด { -brand-short-name } เมื่อเริ่มต้นระบบ
launch-on-login-spotlight-pin-taskbar-checkbox = ปักหมุดเข้ากับแถบงาน
# This checkbox label intentionally matches “startup-restore-windows-and-tabs”
# in the Settings (preferences.ftl). Localizers can reuse the existing
# translation suggested by translation memory.
launch-on-login-spotlight-restore-checkbox = เปิดหน้าต่างและแท็บก่อนหน้า
launch-on-login-spotlight-primary-button = บันทึกและปิด { -brand-short-name }
...
set-default-menu-message-split-layout-title =
    { PLATFORM() ->
        [macos] ให้ { -brand-short-name } พร้อมใช้งานทุกเมื่อ
       *[other] เปิดลิงก์ทั้งหมดด้วย { -brand-short-name }
    }
set-default-menu-message-split-layout-subtitle =
    { PLATFORM() ->
        [macos] ตั้งให้เป็นแอปเริ่มต้นและเก็บไว้ใน Dock
       *[other] เรียกดูได้เร็วขึ้น พร้อมการปกป้องความเป็นส่วนตัวโดยอัตโนมัติ
    }
...
set-default-menu-message-primary-button-short-variant = ตั้งให้ { -brand-short-name } เป็นแอปเริ่มต้น
...
app-exit-spotlight-title = เปิด { -brand-short-name } ทุกครั้งที่คุณลงชื่อเข้า Windows หรือไม่?
app-exit-spotlight-checkbox-launch-on-login = เปิด { -brand-short-name } เมื่อเริ่มต้นระบบ
app-exit-spotlight-checkbox-pin-to-taskbar = ปักหมุดเข้ากับแถบงานของคุณ
app-exit-spotlight-primary-button = บันทึกและปิด { -brand-short-name }
