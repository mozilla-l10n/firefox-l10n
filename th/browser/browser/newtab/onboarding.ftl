...
tab-groups-onboarding-create-group-title = ค้นหากลุ่มที่เปิดอยู่ของคุณได้บนแถบแท็บหรือด้วยการค้นหากลุ่มเหล่านั้นในแถบที่อยู่
tab-groups-onboarding-saved-groups-title = หากคุณปิดกลุ่มแท็บ คุณสามารถเปิดใหม่จากที่นี่เมื่อใดก็ได้
tab-groups-onboarding-saved-groups-no-alltabs-button-title = ค้นหากลุ่มแท็บที่เปิดหรือปิดอยู่ของคุณได้ตลอดเวลาด้วยการค้นหาในแถบที่อยู่
