...
vertical-tabs-callout-1-title = รู้สึกว่าแท็บเยอะเกินไปใช่ไหม?
vertical-tabs-callout-1-subtitle = ลองใช้เค้าโครงแท็บแนวตั้งใหม่ของเราเพื่อดูรายการแท็บของคุณอย่างรวดเร็ว ผู้ทดสอบในช่วงแรกรายงานว่าเค้าโครงนี้ช่วยให้แท็บของตนเองดูเป็นระเบียบมากขึ้น คุณสามารถเลือกสลับได้ตลอดเวลา
...
sidebar-customization-callout-2-title = ทำให้แถบข้างของ { -brand-product-name } เป็นของคุณ
sidebar-customization-callout-2-subtitle = เพิ่มและลบเครื่องมือ วางแท็บของคุณในแถบข้าง ลองใช้บอตสนทนา AI ดู คุณจะปรับแต่งแถบข้างของคุณอย่างไรก็ขึ้นอยู่กับคุณ
...
unified-search-callout-secondary-label = ยกเลิก
unified-search-engines-callout-title = ค้นหาด้วยทางลัด
