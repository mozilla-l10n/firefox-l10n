...
protections-panel-not-blocking-why-etp-on-tooltip-label =
    .label = การปิดกั้นรายการเหล่านี้อาจทำให้องค์ประกอบของบางเว็บไซต์เสียหายได้ ถ้าไม่มีตัวติดตาม ปุ่ม ฟอร์ม และช่องข้อมูลสำหรับเข้าสู่ระบบบางส่วนอาจไม่ทำงาน
...
protections-panel-site-not-working-view-issue-list-login-fields = ช่องข้อมูลสำหรับเข้าสู่ระบบ
