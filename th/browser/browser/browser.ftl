...
qrcode-panel-error =
    .message = สร้างคิวอาร์โค้ดไม่สำเร็จ โปรดลองอีกครั้ง
qrcode-copy-button =
    .label = คัดลอก
qrcode-copy-success =
    .message = คัดลอกคิวอาร์โค้ดไปยังคลิปบอร์ดแล้ว
qrcode-copy-error =
    .message = คัดลอกคิวอาร์โค้ดไม่สำเร็จ
qrcode-save-button =
    .label = บันทึก
qrcode-save-success =
    .message = บันทึกคิวอาร์โค้ดเรียบร้อยแล้ว
qrcode-save-error =
    .message = บันทึกคิวอาร์โค้ดไม่สำเร็จ
qrcode-save-title = บันทึกคิวอาร์โค้ด
qrcode-save-filter-png = ภาพ PNG
qrcode-save-filename = qrcode.png
qrcode-window-title = คิวอาร์โค้ด
qrcode-dialog-title = คิวอาร์โค้ด
qrcode-image =
    .aria-label = คิวอาร์โค้ด
qrcode-close-button =
    .aria-label = ปิด
# Variables:
...
reset-pbm-panel-heading2 = ล้างข้อมูลและเริ่มวาระส่วนตัวใหม่เลยหรือไม่?
