...
trustpanel-social-tracking-tab-list-header = ไซต์เหล่านี้กำลังพยายามติดตามคุณ:
...
trustpanel-tracking-cookies-tab-list-header = ไซต์เหล่านี้กำลังพยายามติดตามคุณ:
