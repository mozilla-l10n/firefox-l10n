...
ipprotection-feature-introduction-link-text-captive-portal-1 = <a data-l10n-name="learn-more-vpn">เพิ่มความเป็นส่วนตัวอีกขั้น</a>ด้วยการเลือกตำแหน่งได้หลายแห่งเพื่อซ่อนตำแหน่งที่คุณกำลังเรียกดู
...
ipprotection-summer-promo-offramp-generic-title = ขีดจำกัด VPN ในตัวของคุณจะคืนค่าในวันที่ 1 กันยายน
# Variables
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
ipprotection-summer-promo-offramp-generic-description = ใช้ { $maxUsage } GB และตำแหน่ง 6 จุดเพื่อเพิ่มความเป็นส่วนตัว ทำให้การติดตามการเรียกดูของคุณเป็นไปได้ยาก
...
# Variables
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
ipprotection-summer-promo-offramp-generic-description-default-browser-users-no-upgrade = ใช้ { $maxUsage } GB และตำแหน่งมากกว่า 20 จุดเพื่อเพิ่มความเป็นส่วนตัว ทำให้การติดตามการเรียกดูของคุณเป็นไปได้ยาก
...
ipprotection-summer-promo-offramp-subscriber-title = VPN ในตัวของคุณถูกปรับปรุงให้ดีกว่าเดิม
ipprotection-summer-promo-offramp-subscriber-description = ตอนนี้คุณจะได้รับแบนด์วิดท์ไม่จำกัดและตำแหน่งเพิ่มขึ้นในฐานะผู้สมัครสมาชิก { -mozilla-vpn-brand-name }
...
ipprotection-summer-promo-offramp-default-browser-incentive-title = เก็บตำแหน่ง VPN ในตัวเพิ่มเติมของคุณไว้
ipprotection-summer-promo-offramp-default-browser-incentive-description = เลือก { -brand-product-name } เป็นเบราว์เซอร์หลักของคุณ แล้วคุณจะได้รับตำแหน่งเพิ่มอีกมากกว่า 20 จุดหลังวันที่ 31 สิงหาคม
...
ipprotection-android-promo-callout-primary-button = เข้าใจแล้ว

## Feature discovery callout message advertising a feature where the user can turn on the VPN for specific sites only

ipprotection-site-inclusions-callout-secondary-button-existing-users = ไม่ใช่ตอนนี้
ipprotection-site-inclusions-callout-secondary-button-lapsed-users = ปิด
...
unauthenticated-choose-location-message-1 = เลือกจากหลายตำแหน่ง หรือให้ { -brand-product-name } เลือกตำแหน่งที่เร็วที่สุดให้
...
ipprotection-connection-status-connected-1 = VPN เปิดอยู่
    .aria-label = VPN เปิดอยู่
ipprotection-connection-status-disconnected-1 = VPN ปิดอยู่
    .aria-label = VPN ปิดอยู่
ipprotection-connection-status-excluded-1 = VPN ปิดอยู่สำหรับไซต์นี้
    .aria-label = VPN ปิดอยู่สำหรับไซต์นี้
ipprotection-connection-status-connecting-1 = VPN กำลังเชื่อมต่อ…
    .aria-label = VPN กำลังเชื่อมต่อ…
...
ipprotection-locations-unavailable-label-1 = ไม่พร้อมใช้งาน
    .aria-label = ไม่พร้อมใช้งาน, ปิดใช้งานอยู่
# Label shown next to a VPN location that the user cannot select.
...
ipprotection-connection-status-paused-title-2 = VPN ถูกหยุดชั่วคราว
    .aria-label = VPN ถูกหยุดชั่วคราว
...
ipprotection-connection-status-network-error-title-1 = ตรวจสอบการเชื่อมต่ออินเทอร์เน็ตของคุณ
    .aria-label = ตรวจสอบการเชื่อมต่ออินเทอร์เน็ตของคุณ
ipprotection-connection-status-network-error-description = เชื่อมต่อกับอินเทอร์เน็ต จากนั้นลองเปิด VPN
ipprotection-connection-status-blocked-error-title-1 = VPN ไม่พร้อมใช้งาน
    .aria-label = VPN ไม่พร้อมใช้งาน
...
ipprotection-connection-status-blocked-error-description-1 = กฎหมายและข้อจำกัดในแต่ละพื้นที่อาจจำกัดสถานที่ที่คุณสามารถใช้ VPN ได้ <a data-l10n-name="learn-more-link">เรียนรู้เพิ่มเติม</a>
...
ipprotection-open-button = เปิด { -brand-product-name }
ipprotection-come-back-title = กลับมาลองใช้ VPN ในตัวดู
ipprotection-message-body-hide-location = ซ่อนตำแหน่งของคุณขณะเรียกดูด้วย { -brand-product-name } เพื่อความเป็นส่วนตัวและการควบคุมที่มากขึ้น
ipprotection-connection-status-generic-error-title-1 = ไม่สามารถเชื่อมต่อกับ VPN ได้
    .aria-label = ไม่สามารถเชื่อมต่อกับ VPN ได้
...
#   $usageLeft (string) - The amount of data a user has left in a month (in GB)
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
ip-protection-bandwidth-left-gb-1 = เหลือ <span data-l10n-name="usage">{ $usageLeft } GB</span> จาก { $maxUsage } GB
# Variables
#   $usageLeft (string) - The amount of data a user has left in a month (in GB)
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
...
#   $usageLeft (number) - The amount of data a user has left in a month (in MB)
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
ip-protection-bandwidth-left-mb-1 = เหลือ <span data-l10n-name="usage">{ $usageLeft } MB</span> จาก { $maxUsage } GB
# Variables
#   $usageLeft (number) - The amount of data a user has left in a month (in MB)
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
