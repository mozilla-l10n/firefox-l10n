...
xp-java-delete-privilege-error = ไม่สามารถลบสิทธิ์
...
sec-error-pkcs11-device-error = โมดูล PKCS #11 คืนค่า CKR_DEVICE_ERROR บ่งชี้ว่าปัญหาเกิดขึ้นกับ token หรือ slot
