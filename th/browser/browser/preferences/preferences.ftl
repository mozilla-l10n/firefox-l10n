...
sitedata-delete-on-close-private-browsing3 =
    .message = ตามการตั้งค่าประวัติของคุณ { -brand-short-name } จะลบคุกกี้และข้อมูลไซต์ออกจากวาระของคุณเมื่อปิดเบราว์เซอร์
...
permissions-block-popups-exceptions-button3 =
    .label = จัดการการเปลี่ยนเส้นทาง
    .accesskey = เ
    .searchkeywords = ป๊อปอัป,popups,pop-ups
...
nimbus-rollouts-enabled-description = การเปลี่ยนแปลงจะถูกนำไปใช้จากระยะไกล
...
dns-over-https-group2 =
    ...
    .description = Domain Name System over HTTPS (DoH) จะเข้ารหัสลับ lookup ของไซต์ เพื่อให้เป็นเรื่องยากขึ้นที่ผู้ให้บริการอินเทอร์เน็ตของคุณหรือคนอื่นจะเห็นว่าคุณกำลังจะเยี่ยมชมเว็บไซต์อะไร
