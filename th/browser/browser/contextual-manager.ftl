...
contextual-manager-passwords-origin-field-description = ป้อนที่อยู่จริงที่คุณใช้ลงชื่อเข้าไซต์นี้
contextual-manager-passwords-username-field =
    .label = ชื่อผู้ใช้
contextual-manager-passwords-username-field-description = ป้อนชื่อผู้ใช้ ที่อยู่อีเมล หรือหมายเลขบัญชีที่คุณใช้ลงชื่อเข้า
contextual-manager-passwords-password-field =
    .label = รหัสผ่าน
contextual-manager-passwords-password-field-description = ป้อนรหัสผ่านเพื่อลงชื่อเข้าบัญชีนี้
