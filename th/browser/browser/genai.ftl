...
genai-settings-chat-description = เพิ่มแชตบอตที่ต้องการของคุณลงในแถบด้านข้าง เพื่อให้เข้าถึงได้รวดเร็วขณะที่คุณท่องเว็บ <a data-l10n-name="connect">แบ่งปันความคิดเห็น</a>
genai-settings-chat-choose = เลือกแชตบอต
genai-settings-chat-choose-one-menuitem =
    .label = เลือกมาหนึ่งตัว
genai-settings-chat-links = เมื่อคุณเลือกแชตบอต แสดงว่าคุณยอมรับเงื่อนไขการใช้งานและนโยบายความเป็นส่วนตัวของผู้ให้บริการ
...
genai-settings-chat-localhost-links = นำแชตบอตส่วนตัวในเครื่องของคุณมาเอง เช่น <a data-l10n-name="link1">llamafile</a> จากกลุ่มนวัตกรรมของ { -vendor-short-name }
genai-settings-chat-shortcuts =
    .description = แสดงทางลัดสำหรับประโยคคำสั่งเมื่อคุณเลือกข้อความ { -brand-short-name } จะส่งข้อความ ชื่อหน้า และประโยคคำสั่งไปยังแชตบอต
