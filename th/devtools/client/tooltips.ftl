...
devtools-tooltip-learn-more = เรียนรู้เพิ่มเติม
...
inactive-css-not-grid-or-flex-container = <strong>{ $property }</strong> ไม่มีผลกับอิลิเมนต์นี้เนื่องจากไม่ใช่ตัวบรรจุแบบ flex หรือ grid
inactive-css-not-grid-or-flex-container-or-multicol-container = <strong>{ $property }</strong> ไม่มีผลกับอิลิเมนต์นี้เนื่องจากไม่ใช่ตัวบรรจุแบบ flex, grid หรือแบบหลายคอลัมน์
...
inactive-css-not-grid-or-flex-item = <strong>{ $property }</strong> ไม่มีผลกับอิลิเมนต์นี้เนื่องจากไม่ใช่รายการแบบ grid หรือ flex
inactive-css-not-grid-or-flex-or-absolutely-positioned-item = <strong>{ $property }</strong> ไม่มีผลต่ออิลิเมนต์นี้เนื่องจากไม่ใช่รายการแบบ grid หรือ flex และไม่ใช่อิลิเมนต์ที่ถูกจัดตำแหน่ง
inactive-css-not-grid-or-absolutely-positioned-item = <strong>{ $property }</strong> ไม่มีผลต่ออิลิเมนต์นี้เนื่องจากไม่ใช่รายการแบบ grid และไม่ใช่อิลิเมนต์ที่ถูกจัดตำแหน่ง
inactive-css-not-absolutely-positioned-item = <strong>{ $property }</strong> ไม่มีผลต่ออิลิเมนต์นี้เนื่องจากไม่ใช่อิลิเมนต์ที่ถูกจัดตำแหน่งโดยสัมบูรณ์
inactive-css-no-default-anchor = <strong>{ $property }</strong> ไม่มีผลกับอิลิเมนต์นี้เนื่องจากไม่มีอิลิเมนต์สมอยึดเริ่มต้น
...
inactive-css-not-flex-item = <strong>{ $property }</strong> ไม่มีผลกับอิลิเมนต์นี้เนื่องจากไม่ใช่รายการแบบ flex
inactive-css-not-flex-container = <strong>{ $property }</strong> ไม่มีผลกับอิลิเมนต์นี้เนื่องจากไม่ใช่ตัวบรรจุแบบ flex
...
inactive-css-not-block-container = <strong>{ $property }</strong> ไม่มีผลกับอิลิเมนต์นี้เนื่องจากใช้ได้กับอิลิเมนต์ตัวบรรจุที่เป็น block เท่านั้น
inactive-css-not-block-flex-grid-container = <strong>{ $property }</strong> ไม่มีผลกับอิลิเมนต์นี้เนื่องจากใช้ได้กับอิลิเมนต์ตัวบรรจุที่เป็น block, flex และ grid เท่านั้น
...
inactive-css-no-principal-box = <strong>{ $property }</strong> ไม่มีผลกับอิลิเมนต์นี้เนื่องจากไม่ได้สร้าง principal box
...
inactive-css-not-grid-or-flex-or-absolutely-positioned-item-fix = ลองเพิ่ม <<strong>position:absolute</strong> ไปยังอิลิเมนต์ หรือ <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong> หรือ <strong>display:inline-flex</strong> ไปยังอิลิเมนต์แม่ของอิลิเมนต์ { learn-more }
inactive-css-not-grid-or-absolutely-positioned-item-fix = ลองเพิ่ม <strong>position:absolute</strong> ไปยังอิลิเมนต์ หรือ <strong>display:grid</strong> หรือ <strong>display:inline-grid</strong> ไปยังอิลิเมนต์แม่ของอิลิเมนต์ { learn-more }
inactive-css-not-absolutely-positioned-item-fix = ลองเพิ่ม <strong>position:absolute</strong> ให้กับอิลิเมนต์ { learn-more }
inactive-css-no-default-anchor-fix = ลองเพิ่ม <strong>position-anchor</strong> พร้อมด้วยชื่อสมอยึดที่ถูกต้อง { learn-more }
...
inactive-css-not-block-container-fix = ลองเพิ่ม <strong>display:block</strong>, <strong>display:inline-block</strong> หรือ <strong>display:flow-root</strong> { learn-more }
inactive-css-not-block-flex-grid-container-fix = ลองเพิ่ม <strong>display:block</strong>, <strong>display:inline-block</strong>, <strong>display:flex</strong>, <strong>display:inline-flex</strong>, <strong>display:grid</strong>, <strong>display:inline-grid</strong> หรือ <strong>display:flow-root</strong> { learn-more }
...
inactive-css-column-span-fix-1 = ลองเพิ่ม <strong>column-count</strong> หรือ <strong>column-width</strong> ลงในอิลิเมนต์ระดับบนสุดตัวใดตัวหนึ่ง
inactive-css-not-grid-or-flex-or-absolutely-positioned-item-fix-1 = ลองเพิ่ม <<strong>position:absolute</strong> ไปยังอิลิเมนต์ หรือ <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong> หรือ <strong>display:inline-flex</strong> ไปยังอิลิเมนต์แม่ของอิลิเมนต์
inactive-css-not-grid-or-absolutely-positioned-item-fix-1 = ลองเพิ่ม <strong>position:absolute</strong> ไปยังอิลิเมนต์ หรือ <strong>display:grid</strong> หรือ <strong>display:inline-grid</strong> ไปยังอิลิเมนต์แม่ของอิลิเมนต์
inactive-css-not-absolutely-positioned-item-fix-1 = ลองเพิ่ม <strong>position:absolute</strong> ให้กับอิลิเมนต์
inactive-css-no-default-anchor-fix-1 = ลองเพิ่ม <strong>position-anchor</strong> พร้อมด้วยชื่อสมอยึดที่ถูกต้อง
inactive-css-not-grid-or-flex-item-fix-4 = ลองเพิ่ม <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong> หรือ <strong>display:inline-flex</strong> ไปยังอิลิเมนต์แม่ของอิลิเมนต์
inactive-css-not-grid-item-fix-3 = ลองเพิ่ม <strong>display:grid</strong> หรือ <strong>display:inline-grid</strong> ไปยังอิลิเมนต์แม่ของอิลิเมนต์
inactive-css-not-grid-container-fix-1 = ลองเพิ่ม <strong>display:grid</strong> หรือ <strong>display:inline-grid</strong>
inactive-css-not-flex-item-fix-3 = ลองเพิ่ม <strong>display:flex</strong> หรือ <strong>display:inline-flex</strong> ไปยังอิลิเมนต์แม่ของอิลิเมนต์
inactive-css-not-flex-container-fix-1 = ลองเพิ่ม <strong>display:flex</strong> หรือ <strong>display:inline-flex</strong>
inactive-css-not-inline-or-tablecell-fix-1 = ลองเพิ่ม <strong>display:inline</strong> หรือ <strong>display:table-cell</strong>
inactive-css-non-replaced-inline-or-table-row-or-row-group-fix-1 = ลองเพิ่ม <strong>display:inline-block</strong> หรือ <strong>display:block</strong>
inactive-css-non-replaced-inline-or-table-column-or-column-group-fix-1 = ลองเพิ่ม <strong>display:inline-block</strong>
inactive-css-not-display-block-on-floated-fix-1 = ลองเอา <strong>float</strong> ออกหรือเพิ่ม <strong>display:block</strong>
inactive-css-only-non-grid-or-flex-item-fix-1 = ลองเปลี่ยนค่าของ <strong>display</strong> ของตัวบรรจุของอิลิเมนต์ให้เป็นค่าอื่นที่ไม่ใช่ <strong>flex</strong>, <strong>grid</strong>, <strong>inline-flex</strong> หรือ <strong>inline-grid</strong> หรือเอา <strong>float</strong> ออก
inactive-css-not-block-fix-1 = ลองเพิ่มคุณสมบัติอย่างเช่น <strong>display:block</strong> หรือ <strong>float:left</strong>
inactive-css-not-block-container-fix-1 = ลองเพิ่ม <strong>display:block</strong>, <strong>display:inline-block</strong> หรือ <strong>display:flow-root</strong>
inactive-css-not-block-flex-grid-container-fix-1 = ลองเพิ่ม <strong>display:block</strong>, <strong>display:inline-block</strong>, <strong>display:flex</strong>, <strong>display:inline-flex</strong>, <strong>display:grid</strong>, <strong>display:inline-grid</strong> หรือ <strong>display:flow-root</strong>
inactive-css-not-floated-fix-1 = ลองเพิ่มคุณสมบัติ <strong>float</strong> ด้วยค่าอื่นที่ไม่ใช่ <strong>none</strong>
inactive-css-position-property-on-unpositioned-box-fix-1 = ลองตั้งค่าคุณสมบัติ <strong>position</strong> เป็นอย่างอื่นนอกจาก <strong>static</strong>
inactive-css-only-replaced-elements-fix-1 = ตรวจสอบว่าคุณกำลังเพิ่มคุณสมบัติให้กับอิลิเมนต์ที่ถูกแทนที่
inactive-text-overflow-when-no-overflow-fix-1 = ลองเพิ่ม <strong>overflow:hidden</strong>
inactive-css-no-size-containment-fix-1 = ลองกำหนดคุณสมบัติ <strong>display</strong> เป็นค่าอื่นนอกจาก <strong>none</strong>, <strong>contents</strong>, <strong>table</strong> หรือ <strong>inline-table</strong> และตรวจสอบให้แน่ใจว่าไม่ได้อยู่ภายใน table หรือเซกเมนต์ ruby
inactive-css-not-for-internal-table-elements-fix-1 = ลองตั้งค่าคุณสมบัติ <strong>display</strong> เป็นอย่างอื่นนอกจาก <strong>table-cell</strong>, <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong>, หรือ <strong>table-footer-group</strong>
inactive-css-not-for-internal-table-elements-except-table-cells-fix-1 = ลองตั้งค่าคุณสมบัติ <strong>display</strong> เป็นอย่างอื่นนอกจาก <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong>, หรือ <strong>table-footer-group</strong>
inactive-css-not-table-fix-1 = ลองเพิ่ม <strong>display:table</strong> หรือ <strong>display:inline-table</strong>
inactive-css-collapsed-table-borders-fix-1 = ลองเพิ่ม <strong>border-collapse:separate</strong>
inactive-css-not-table-cell-fix-1 = ลองเพิ่ม <strong>display:table-cell</strong>
inactive-scroll-padding-when-not-scroll-container-fix-1 = ลองเพิ่ม <strong>overflow:auto</strong>, <strong>overflow:scroll</strong> หรือ <strong>overflow:hidden</strong>
inactive-css-border-image-fix-1 = บนอิลิเมนต์ตารางแม่ ให้เอาคุณสมบัติออก หรือเปลี่ยนค่าของ <strong>border-collapse</strong> เป็นค่าอื่น ๆ ที่ไม่ใช่ <strong>collapse</strong>
inactive-css-resize-fix-1 = ลองตั้ง <strong>overflow</strong> เป็นค่าอื่นที่ไม่ใช่ <strong>visible</strong> หรือกำหนดอิลิเมนต์ที่ถูกแทนที่ซึ่งรองรับให้เป็นเป้าหมาย
inactive-css-ruby-element-fix-1 = ลองเปลี่ยน <strong>font-size</strong> ของข้อความ ruby
inactive-css-text-wrap-balance-lines-exceeded-fix-1 = โปรดลองลดจำนวนบรรทัด
inactive-css-text-wrap-balance-fragmented-fix-1 = หลีกเลี่ยงการแยกเนื้อหาของอิลิเมนต์ เช่น โดยการลบคอลัมน์ออก หรือใช้ <strong>page-break-inside:avoid</strong>
inactive-css-no-principal-box-fix-1 = ลองเพิ่มค่า <strong>display</strong> ซึ่งสร้าง principal box เช่น <strong>block</strong>, <strong>inline-block</strong>, <strong>flex</strong> หรือ <strong>grid</strong>
...
css-selector-warning-sibling-combinator-after-scope = Sibling selector ที่อยู่หลัง <strong>:scope</strong> จะไม่เทียบตรงกับอะไรเลย
...
css-selector-container-query-condition-no-container = ไม่พบคอนเทนเนอร์ ‘{ $name }’
