...
colorpicker-tooltip-eyedropper-title = Ընտրել գոյնը էջում
...
colorpicker-tooltip-color-name-title = Մաւտակայ { $colorName }֊ին
...
colorpicker-tooltip-alpha-slider-title = Մգութիւն
