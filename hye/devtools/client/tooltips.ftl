...
devtools-tooltip-learn-more = Իմանալ աւելին
...
inactive-css-not-grid-or-flex-item-fix-3 = Աւելացրէք տարրերի կենտրաւնում <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong> կամ <strong>display:inline-flex</strong>։ { learn-more }
...
inactive-css-not-grid-item-fix-3 = Փորձէք բաղադրիչների վերադասում աւելացնել <strong>ցուցադրել ցանց</strong> կամ <strong>ցուցադրել․ներտողային֊ցանցը</strong>։
inactive-css-not-grid-container-fix-1 = Փորձէք աւելացնել <strong>ցուցադրել․ցանցը</strong> կամ <strong>ցուցադրել․ներտողային-ցանցը</strong>։
inactive-css-not-flex-item-fix-3 = Փորձէք բաղադրիչների վերադասում աւելացնել <strong>ցուցադրել․սնուցիչը</strong> կամ <strong>ցուցադրել․ներտողային-սնուցիչը</strong>։
inactive-css-not-flex-container-fix-1 = Փորձէք աւելացնել <strong>ցուցադրել․սնուցիչը</strong> կամ <strong>ցուցադրել․ներտողային֊սնուցիչը</strong>։
inactive-css-not-inline-or-tablecell-fix-1 = Փորձէք աւելացնել <strong>ցուցադրել․ներտող</strong> կամ <strong>ցուցադրել․աղիւսակի֊վանդակը</strong>։
inactive-css-non-replaced-inline-or-table-row-or-row-group-fix-1 = Փորձէք աւելացնել <strong>ցուցադրել․ներտողային-արգելափակումը</strong> կամ <strong>ցուցադրել․արգելափակումը</strong>։
inactive-css-non-replaced-inline-or-table-column-or-column-group-fix-1 = Փորձէք աւելացնել <strong>ցուցադրել․ներտողային-արգելափակումը</strong>։
inactive-css-not-display-block-on-floated-fix-1 = Փորձէք հեռացնել <strong>լողանցումը</strong> կամ աւելացնել <strong>ցուցադրման․արգելափակումը</strong>։
inactive-css-position-property-on-unpositioned-box-fix-1 = Փործէք  <strong>position</strong> յատկութիւնը սահմանել <strong>static</strong>֊ից տարբեր:
inactive-text-overflow-when-no-overflow-fix-1 = Փորձէք աւելացնել <strong> overflow:hidden </strong>:
inactive-css-not-for-internal-table-elements-fix-1 = Փորձէք դրա <strong> ցուցադրման </strong> գործառոյթը սահմանել այլ բան, քան  <strong>table-cell</strong>, <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong>, կամ <strong>table-footer-group</strong>.
inactive-css-not-for-internal-table-elements-except-table-cells-fix-1 = Փորձէք դրա <strong> ցուցադրման </strong> գործառոյթը սահմանել այլ բան, քան <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong>, կամ <strong>table-footer-group</strong>.
