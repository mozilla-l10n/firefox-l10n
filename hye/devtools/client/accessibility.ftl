...
accessibility-progress-initializing = Սկզբնաւորում…
    .aria-valuetext = Սկզբնաւորում…
...
accessibility-progress-progressbar =
    { $nodeCount ->
        [one] { $nodeCount } հանգոյցի ստուգում
       *[other] { $nodeCount } հանգոյցների ստուգում
    }

accessibility-progress-finishing = Աւարտ…
    .aria-valuetext = Աւարտ…
