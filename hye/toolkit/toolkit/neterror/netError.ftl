...
certerror-page-title = Զգուշացում․ Պոտենցիալ անվտանգութեան վտանգից առաջ
certerror-sts-page-title = Չկապուեց․ Անվտանգութեան հնարաւոր պոտենցիալ
...
neterror-copy-to-clipboard-button = Պատճէնել սեղմատախտակին
neterror-learn-more-link = Իմանալ աւելին…
neterror-open-portal-login-page-button = Բացել ցանց մուտք գործելու էջը
neterror-override-exception-button = Ընդունել վտանգը եւ շարունակել
...
neterror-nss-failure-contact-website = Խնդրում ենք կապնուել կայքի սեփականատերերի հետ՝ նրանց տեղեակ պահելու այս խնդրի մասին։
# Variables:
# $hostname (String) - Hostname of the website to which the user was trying to connect.
...
neterror-corrupted-content-intro = Ընթացիկ էջը չի կարող ցուցադրուել, քանզի տեղի է ունեցել փոխանցման սխալ։
neterror-corrupted-content-contact-website = Կապնուէք վեբ կայքի հեղինակների հետ՝ նրանց այս մասին հաղորդելու համար։
...
neterror-network-protocol-error-intro = Էջը, որ ցանկանում եք դիտել չի կարող ցուցադրուել, քանզի յայտնաբերուել է ցանցի հաղորդակարգի սխալ։
neterror-network-protocol-error-contact-website = Կապնվէք կայքի սեփականատերերի հետ՝  նրանց այդ մասին հաղորդելու համար։
...
# Variables:
# $hostname (String) - Hostname of the website to which the user was trying to connect.
certerror-what-should-i-do-bad-sts-cert-explanation = <b>{ $hostname }</b> ունի անվտանգութեան քաղաքականութիւն, որը կոչուում է HTTP Strict Transport Security (HSTS), ինչը նշանակում է, որ { -brand-short-name } կարող է միայն ապահով կերպով միանալու դրան։ Դուք չէք կարող բացառութիւն աւելացնել այս կայք այցելելու համար։
...
fp-neterror-denied-port-access = Այս հասցէն աւգտագործում է ցանցային մուտք, որը սովորաբար նախատեսուած է զննարկման համար։ { -brand-short-name }-ը չեղարկեց հարցումը՝ Ձեր պաշտպանութեան նկատառումից ելնելով։
