...
experimental-features-firefox-100 =
    .label = { -brand-product-name } 100 Աւգտատէր֊Գործակալ
experimental-features-firefox-100-description = Յաւելման միացման դէպքում՝ { -brand-short-name }-ը կուղարկի կայքերին User-Agent տաւղ, { -brand-product-name }-ի 100 տարբերակի համար։ Գործածէք յաւելումը ստուգելու համար, արդեաւք յաւելուածը կը գործի, եթե { -brand-short-name }-ի տարբերակի թիւը դառնայ եռանիշը։ { -brand-product-name }-ի 100 իրական տարբերակը կը թողարկուի 2022-ի մայիսին, սկսէք ստուգել կայքերը հիմա։
