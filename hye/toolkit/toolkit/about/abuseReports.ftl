...
abuse-report-messagebar-removed-sitepermission2 =
    .message = Շնորհակալ ենք հաշուետուութեան ներկայացման համար: Կայքի արտաւնութիւնների { $addon-name } յաւելումը հեռացուած է։
...
abuse-report-messagebar-action-remove-sitepermission = Այո, ջնջել այն
abuse-report-messagebar-action-keep-sitepermission = Ոչ, պահել դա
...
abuse-report-broken-suggestions-sitepermission =
    Կարծես յայտնաբերել էք վրիպում։ Որպէս յաւելում ներկայացուող զեկոյցին, լաւագոյն տարբերակը կը լինի կայքի մշակմամբ զբաղուող անձի հետ կապի հաստատումը։ 
    <a data-l10n-name="support-link"> Այցելէք </a> կայք՝ մշակողի մասին տեղեկութիւն ստանալու համար։
