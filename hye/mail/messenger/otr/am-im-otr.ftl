...
account-otr-description = { -brand-short-name }-ը աջակցում է մեկը մեւսին վերջաւոր գաղտնագրմամբ հաղորդագրութիւններ: Դա կանխում է երրորդ անձանց զրոյցի գաղտնալսումը: Վերջաւոր գաղտնագրումը կարող է աւգտագործուել միայն այն դէպքում, երբ մեւս անձը նաեւ աւգտագործում է ծրագրակազմ, որն աջակցում է OTR:
...
otr-log =
    .label = Ներառել OTR ծածկագրուած նամակները խաւսակցութեան տեղեկամատեաններում
