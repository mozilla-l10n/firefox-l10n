...
profiles-pane-desc = Ընտրէք տեղադրութիւն, որից ցանկանում եք տեղափոխել
profile-file-picker-dir = Ընտրեք հաշուի պանակ
profile-file-picker-zip = Ընտրել մինչեւ 2 GB  չափ ունեցող zip նիշ
items-pane-title = Ընտրէք, թե ինչ էք տեղափոխելու
items-pane-source = Աղբեւրի գտնուելու վայրը․
...
import-from-addr-book-file-desc = Ընտրէք նիշի այն տեսակը, որն ուզում էք ներմուծել։
...
export-profile-desc = Արտահանել փոստային հաշիւներ, նամակներ, հասցէաագրքեր, կարգաւորումներ դէպի խտացուած (zip) նիշ։ Անհրաժեշտութեան դէպքում կարող էք ներմուծել խտացուած (zip) նիծը՝ Ձեր հաշիւը վերականգնելու համար:
export-profile-desc2 = Եթե Ձեր ընթացիկ հաշիւը 2 ԳԲ-ից մեծ է, առաջարկում ենք ինքներդ կրկնաւրինակել այն:
export-open-profile-folder = Բացել հաշուի թղթապանակը
export-file-picker = Արտահանել խտացուած (zip) նիշ
