...
onboarding-firefox-send-title = Ձեր համաւգտագործած նիշերը պահէք գաղտնի։
onboarding-firefox-send-text2 = Վերբեռնէք Ձեր նիշերը { -send-brand-name }֊ում, որպէսզի դրանք համաւգտագործուեն ծայրից ծայր ծածկագրմամբ եւ ինքնուրոյն սպառուող յղմամբ։
...
return-to-amo-addon-header = Այժմ ստացէք Ձեր <icon></icon><b>{ $addon-name }-ը։</b>
