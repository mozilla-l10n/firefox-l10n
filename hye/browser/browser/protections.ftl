...
passwords-title-logged-in = Գաղտնաբառերի կառավարում
passwords-header-content = { -brand-product-name } -ը ապահով կերպով պահում է գաղտնաբառերը զննարկչում:
...
protection-report-passwords-save-passwords-button = Պահպանել գաղտնաբառերը
    .title = Պահպանել գաղտնաբառերը
