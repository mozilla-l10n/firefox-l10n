...
ssl-error-rx-malformed-client-hello = SSL-ը ստացել է «Յաճախորդի Ողջոյն» ձեռքսեղմման խեղաթիւրուած հաղորդագրութիւն:
ssl-error-rx-malformed-server-hello = SSL-ը ստացել է «Սպասարկչի ողջոյն» ձեռքսեղմման խեղաթիւրուած հաղորդագրութիւն:
