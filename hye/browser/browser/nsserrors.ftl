...
ssl-error-rx-malformed-client-hello = SSL-ը ստացել է սխալ «Յաճախորդի Ողջոյն»-ի ձեռքսեղմման հաղորդագրութիւն:
ssl-error-rx-malformed-server-hello = SSL-ը ստացել է սխալ «Սպասարկչի Ողջոյն»-ի ձեռքսեղմման հաղորդագրութիւն:
ssl-error-rx-malformed-certificate = SSL-ը ստացել է սխալ «Հաւաստագրի» ձեռքսեղմման հաղորդագրութիւն:
ssl-error-rx-malformed-server-key-exch = SSL-ը ստացել է սխալ «Սպասարկչի Բանալիների Փոխանակման» ձեռքսեղմման հաղորդագրութիւն:
