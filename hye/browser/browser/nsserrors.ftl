...
ssl-error-rx-malformed-client-hello = SSL-ը ստացել է «Յաճախորդի Ողջոյն» ձեռքսեղմման սխալ հաղորդագրութիւն:
ssl-error-rx-malformed-server-hello = SSL-ը ստացել է «Սպասարկչի ողջոյն» ձեռքսեղմման սխալ հաղորդագրութիւն:
ssl-error-rx-malformed-certificate = SSL-ը ստացել է «Վկայագրի»  խեղաթիւրուած ձեռքսեղմման հաղորդագրութիւն:
ssl-error-rx-malformed-server-key-exch = SSL-ը ստացել է «Սպասարկչի Բանալիների Փոխանակման» ձեռքսեղմման սխալ հաղորդագրութիւն:
