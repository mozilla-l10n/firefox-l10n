...
safeb-blocked-malware-page-error-desc-override = <span data-l10n-name='sitename'>{ $sitename }</span>-ը <a data-l10n-name='error_desc_link'>զեկուցուել է որպէս վնասագիր պարունակող ծրագրաշար</a>։ Դուք կարող եք <a data-l10n-name='report_detection'>զեկուցել ծագած խնդրի մասին</a> կամ <a data-l10n-name='ignore_warning_link'>անտեսել վտանգը</a> եւ անցնել ոչ անվտանգ կայքին։
safeb-blocked-malware-page-error-desc-no-override = <span data-l10n-name='sitename'>{ $sitename }</span>-ը զեկուցուել է որպէս <a data-l10n-name='error_desc_link'> վնասագիր պարունակող ծրագրաշար</a>։ Դուք կարող եք <a data-l10n-name='report_detection'>զեկուցել ծագած խնդրի մասին</a>։
safeb-blocked-malware-page-learn-more = Իմացէք աւելին վնասակար վեբ բովանդակութեան՝ ներառեալ վիրուսների եւ այլ վնասագրերի մասին, եւ թէ ինչպէս պաշտպանել Ձեր համակարգիչը <a data-l10n-name='learn_more_link'>StopBadware.org</a>-ում։ Իմացէք աւելին { -brand-short-name }-ի Որսալուց եւ վնասագրերից պաշտպանուելու մասին <a data-l10n-name='firefox_support'>support.mozilla.org</a>-ում։
safeb-blocked-malware-page-error-desc-override-sumo = <span data-l10n-name='sitename'> { $sitename } </span> <a data-l10n-name='error_desc_link'> հաղորդուել է, որ վնասակար ծրագրակազմ է պարունակում </a>: Դուք կարող էք <a data-l10n-name='ignore_warning_link'> <a data-l10n-name='ignore_warning_link'> անտեսել վտանգը </a> եւ անցնել այս անապահով կայք:
