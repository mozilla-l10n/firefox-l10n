...
welcome-back-page-info-link = Ձեր հաւելումները եւ հարմարեցումները հեռացուել են եւ դիտարկիչի կարգաւորումները վերակայուել են։ Եթե սա չլուծի խնդիրը, ապա <a data-l10n-name="link-more">մանրամասներ, թե ինչ կարող եք անել։</a>
