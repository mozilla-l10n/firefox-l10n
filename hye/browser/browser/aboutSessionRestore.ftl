...
welcome-back-page-info-link = Ձեր յաւելումները եւ յարմարեցումները հեռացուել են եւ զննարկչի կարգաւորումները վերակայուել են։ Եթե սա չլուծի խնդիրը, ապա <a data-l10n-name="link-more">մանրամասներ, թե ինչ կարող էք անել։</a>
