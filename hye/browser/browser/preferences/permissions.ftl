...
permissions-site-location-disable-desc = Սա կը կանխի ցանկում չնշուած ցանկացած կայքի կողմից ձեր տեղադրութեան վայր մուտքի թոյլտուութեան հարցումը: Ձեր տեղադրութեան հարցման արգելափակումը կարող է ընդհատել կայքի որոշ յատկութիւնները:
