...
policy-DisablePrimaryPasswordCreation = Եթե ճիշտ է, հիմնական գաղտնաբառ չի կարող ստեղծուել։
...
policy-DisableSecurityBypass = Յետ պահել աւգտատիրոջը ընթացիկ անվտանգութեան զգուշացումների շրջանցումից։
policy-DisableSetAsDesktopBackground = Անջատել ցանկի՝ նկարները կարգել որպէս սեղանի խորապատկեր, հրամանը։
policy-DisableSystemAddonUpdate = Յետ պահել զննարկիչը ծրագրային հաւելումների տեղակայումից եւ թարմացումից։
...
policy-ExtensionSettings = Կառաւարել ընդլայնման տեղադրման բոլոր կողմերը։
...
policy-LocalFileLinks = Թոյլատրել յատուկ կայքերին կապուել տեղային նիշքերի հետ։
policy-MasterPassword = Պահանջել կամ կանխել հիմնական գաղտնաբառի աւգտագործումը
policy-ManagedBookmarks = Կազմաձեւում է էջանիշերի ցանկ, որը կառավարուում է կառավարչի կողմից, ում աւգտատէրը չի կարող փոխել։
policy-PrimaryPassword = Պահանջէք կամ կանխէք Հիմնական գաղտնաբառը։
