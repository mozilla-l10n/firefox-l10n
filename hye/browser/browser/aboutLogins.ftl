...
about-logins-import-dialog-error-file-permission-description = { -brand-short-name }֊ը թոյլտուութիւն չունի նիշը կարդալու համար։ Փորձէք փոխել թուլտուութիւնները։
