...
refresh-unused-profile-infobar-message = উপলব্ধ হৈছে আপুনি কিছু সময়ৰ পৰা { -brand-short-name } ব্যৱহাৰ কৰা নাই। আপুনি ইয়াক এটা সতেজ, নতুনৰ নিচিনা অনুভৱৰ বাবে পৰিষ্কাৰ কৰিব বিচাৰে নে? আৰু, পুনৰ স্বাগতম!
