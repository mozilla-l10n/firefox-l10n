...
printui-page-custom-range-input =
    .aria-label = ইচ্ছা অনুসৰি পৃষ্ঠাৰ পৰিসৰ লিখক
...
printui-error-invalid-scale = স্কেল 10 আৰু 200ৰ মাজৰ এটা সংখ্যা হ'ব লাগিব।
printui-error-invalid-margin = অনুগ্ৰহ কৰি বাছনি কৰা কাগজৰ আকাৰৰ বাবে এটা বৈধ সীমা লিখক।
printui-error-invalid-copies = কপি 1 আৰু 10000ৰ মাজৰ এটা সংখ্যা হ'ব লাগিব।
# Variables
# $numPages (integer) - Number of pages
printui-error-invalid-range = পৰিসৰ 1 আৰু { $numPages }ৰ মাজৰ এটা সংখ্যা হ'ব লাগিব।
