...
openpgp-one-recipient-status-instruction2 = For å få den offentlege nøkkelen/dei offentlege nøklane, importer han/dei frå e-posten sendt til deg, og som inkluderer han/dei. Alternativt kan du prøve å finne den offentlege nøkkelen/dei offentlege nøklane i ein katalog.
