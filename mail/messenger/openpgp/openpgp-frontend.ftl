...
openpgp-ctx-verify-att =
    ...
    .accesskey = v
openpgp-has-sender-key = Dit bericht beweert de openbare OpenPGP-sleutel van de afzender te bevatten.
openpgp-be-careful-new-key = Waarschuwing: de nieuwe openbare OpenPGP-sleutel in dit bericht verschilt van de openbare sleutels die u eerder voor { $email } hebt geaccepteerd.
