...
openpgp-broken-exchange-opened = Это сообщение OpenPGP, которое, судя по всему, было искажено MS-Exchange, невозможно восстановить, так как оно было открыто из локального файла. Скопируйте сообщение в почтовую папку, чтобы попробовать произвести автоматическое восстановление.
