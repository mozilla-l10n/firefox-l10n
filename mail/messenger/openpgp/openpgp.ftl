...
openpgp-key-details-key-part-label =
    .label = Klučowy dźěl
openpgp-key-details-attr-ignored = Warnowanje: Tutón kluč snano kaž wočakowne njefunguje, dokelž někotre z jeho kajkosćow su njewěste a móhli so ignorować.
