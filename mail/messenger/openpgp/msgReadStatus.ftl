...
openpgp-sig-uncertain-not-accepted = Este mensaje contiene una firma digital, pero aún no ha decidido si la clave del firmante es aceptable para usted.
openpgp-sig-invalid-rejected = Este mensaje contiene una firma digital, pero se ha decidido previamente rechazar la clave del firmante.
