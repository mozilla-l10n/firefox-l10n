...
info-will-expire = Platnost tohoto klíče je nastavena do { $date }.
...
info-explanation-2 = Pokud chcete tento klíč používat delší dobu, změňte datum jeho platnosti a poté znovu pošlete příslušný veřejný klíč svým konverzačním partnerům.
expire-dont-change =
