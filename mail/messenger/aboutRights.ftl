...
rights-intro-point-3 =
    ...
    και τη διανομή τους.
rights-intro-point-4 = Ο τρόπος χρήσης των προσωπικών σας πληροφοριών και των σχολίων που υποβάλλετε στη { -vendor-short-name } μέσω του { -brand-short-name } περιγράφεται στην <a data-l10n-name="mozilla-privacy-policy-link">Πολιτική απορρήτου του { -brand-short-name }</a>.
