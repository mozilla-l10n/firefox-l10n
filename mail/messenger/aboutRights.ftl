...
rights-intro-point-3 = Деякі можливості { -brand-short-name }, такі як звіти про збої, дозволяють вам надсилати відгук в { -vendor-short-name }. Прийнявши рішення надіслати відгук, ви даєте { -vendor-short-name } дозвіл використовувати його для покращення своїх продуктів, публікувати та поширювати його на своїх сайтах.
