...
about-paragraph-consider-donation = <b>Thunderbird финансируется пользователями, такими как вы! Если вам нравится Thunderbird, пожалуйста, сделайте пожертвование.</b> Лучший способ обеспечить доступность Thunderbird — это <a data-l10n-name="donation-link">сделать пожертвование</a>.
