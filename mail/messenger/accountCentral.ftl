...
import-paragraph2 = { -brand-short-name } საშუალებას გაძლევთ გადმოიტანოთ ფოსტის წერტილები, წიგნაკის ჩანაწერები, გამოწერილი არხები, პარამეტრები და/ან ფილტრები სხვა საფოსტო პროგრამებიდან და გავრცელებული სახის მისამართების წიგნაკებიდან.
