...
chat-description = { -brand-short-name } дозволяє під'єднати декілька облікових записів сервісів для миттєвого обміну повідомленнями, надаючи підтримку різних платформ.
...
import-paragraph = { -brand-short-name } дозволяє імпортувати електронні листи, записи в адресних книгах, підписки на стрічки, налаштування чи/та фільтри з інших поштових програм та поширених форматів адресних книжок.
