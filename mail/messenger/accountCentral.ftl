...
import-paragraph = { -brand-short-name } დაგეხმარებათ პირდაპირ გადმოიტანოთ ფოსტის წერტილები, წიგნაკის ჩანაწერები, გამოწერილი არხები, პარამეტრები და/ან ფილტრები სხვა საფოსტო პროგრამებიდან და გავრცელებული სახის მისამართების წიგნაკებიდან.
