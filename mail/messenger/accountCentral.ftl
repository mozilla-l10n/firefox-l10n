...
import-paragraph2 = { -brand-short-name } låter dig importera e-postmeddelanden, adressboksposter, RSS-prenumeration, inställningar och/eller filter från andra e-postprogram och vanliga adressboksformat.
