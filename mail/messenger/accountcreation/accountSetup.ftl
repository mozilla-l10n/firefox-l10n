...
account-setup-incoming-server-label = Saapuva palvelin
account-setup-outgoing-server-label = Lähtevä palvelin
account-setup-incoming-port-label = Saapuva portti
account-setup-outoing-port-label = Lähtevä portti
