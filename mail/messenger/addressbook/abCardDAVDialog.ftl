...
carddav-experimental-warning = CardDAV podrška u adresaru je eksperimentalna i može trajno oštetiti vaše podatke. Koristite na svoju odgovornost.
carddav-provider-label =
    .value = CardDAV pružatelj usluge:
    .accesskey = p
