...
messenger-languages-window =
    ...
    .style = width: 40em
messenger-languages-description = { -brand-short-name }-i do të shfaqë gjuhën e parë si parazgjedhjen tuaj dhe, në qoftë e nevojshme,  do të shfaqë gjuhë alternative sipas radhës që shfaqen.
