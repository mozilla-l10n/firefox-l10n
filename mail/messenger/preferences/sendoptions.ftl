...
auto-downgrade-label =
    ...
    .accesskey = т
default-html-format-label = Коли надсилаються повідомлення у форматі HTML, якщо вказано, що один або кілька з адресатів не можуть отримувати пошту у форматі HTML:
html-format-ask =
    .label = Запитувати (поштовий клієнт запитає, який формат використовувати)
    .accesskey = З
html-format-convert =
    .label = Перетворити повідомлення на текст
    .accesskey = р
