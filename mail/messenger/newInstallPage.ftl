...
changed-desc-dedicated = 為了讓您更容易、更安全能夠切換各種版本的 { -brand-product-name }（包含 { -brand-product-name }、{ -brand-product-name } Beta、{ -brand-product-name } Daily），這份安裝現在起會使用獨立的設定檔，不會自動生效於其他安裝於這台電腦上的 { -brand-product-name } 當中。
lost = <b>沒有遺失任何個人資料或調整過的設定。</b>若您曾經儲存資訊到這台電腦上的 { -brand-product-name }，該資訊仍然還存在於另一份安裝的版本當中。
