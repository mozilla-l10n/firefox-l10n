...
auth-helpTitle = Axuda para a verificación
auth-questionReceived = Esta é a pregunta feita polo seu contacto:
...
auth-manualVerification = Verificación manual da impresión dixital
auth-questionAndAnswer = Pregunta e resposta
auth-sharedSecret = Segredo compartido
...
auth-qaInstruction = Pense nunha pregunta á que só vostede e o seu contacto coñezan a resposta. Insira a pregunta e a resposta e, a continuación, agarde a que o seu contacto insira a resposta. Se os segredos non coinciden, a canle de comunicación que está a usar pode estar baixo vixilancia.
auth-secretInstruction = Pense nun segredo só coñecido por vostede e o seu contacto. Non empregue a mesma conexión a Internet para intercambiar o segredo. Insira o segredo e logo agarde a que o insira o seu contacto. Se os segredos non coinciden, a canle de comunicación que está a usar pode estar baixo vixilancia.
