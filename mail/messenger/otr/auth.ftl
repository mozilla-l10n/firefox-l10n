...
auth-help = Կոնակտի ինքնության հաստատումը կօգնի հաստատել, որ խոսակցությունը իսկապես մասնավոր է, ինչը երրորդ կողմի համար շատ դժվարացնում է խոսակցությունը գաղտնալսելը կամ շահարկելը:
