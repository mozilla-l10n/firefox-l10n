...
otr-auth =
    .title = Перевірити ідентичність контакту
    .buttonlabelaccept = Перевірити
# Variables:
#   $name (String) - the screen name of a chat contact person
auth-title = Перевірка ідентичності { $name }
# Variables:
...
auth-help = Перевірка ідентичності контакту допомагає впевнитися, що розмова дійсно приватна, дуже ускладнивши стороннім особам можливість перехоплювати або маніпулювати розмовою.
