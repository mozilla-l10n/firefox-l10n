...
auth-help = Перевірка ідентифікатора контакту допомагає впевнитися, що розмова дійсно приватна, дуже ускладнивши стороннім особам можливість перехоплювати або маніпулювати розмовою.
