...
auth-manualVerification = Manuelne přepruwowanje porstoweho wotćišća
auth-questionAndAnswer = Prašenje a wotmołwa
auth-sharedSecret = Dźěleny tajny kluč
...
auth-manualInstruction = Stajće so z wotpohladowanym rozmołwnym partnerom přez někajki awtentifikowany kanal do zwiska, na přikład přez mejlku, kotraž je z OpenPGP signowana abo přez telefon. Dyrbiće swoje porstowe wotćišće wuměnić. (Porstowy wotćišć je kontrolna suma, kotraž zaklučowanski kluč identifikuje.) Jeli porstowy wotćišć trjechi, měl wy deleka w dialogu podać, zo sće porstowy wotćišć přepruwował.
...
auth-qaInstruction = Wumyslće sej prašenje, za kotrež wotmołwu jenož wy a waš kontakt znajetej. Zapodajće prašenje a wotmołwu a čakajće potom, doniž waš kontakt wotmołwu njezapodawa. Jeli sej wotmołwje njewotpowědujetej, so komunikaciski kanal, kotryž wužiwaće, snano wobkedźbuje.

auth-secretInstruction = Wumyslće sej potajnstwo, kotrež jenož wy a waš kontakt znajetej. Njewužiwajće samsny internetny zwisk, zo byšće potajnstwo wuměnił. Zapodajće potajnstwo a čakajće potom, doniž waš kontakt jo njezapodawa. Jeli potajnstwje sej njewotpowědujetej, so komunikaciski kanal, kotryž wužiwaće, snano wobkedźbuje.
