...
# Variables:
#   $name (String) - the screen name of a chat contact person
msgevent-connection_ended = { $name } уже закрыл с вами зашифрованное соединение. Чтобы случайно не отправить сообщение без шифрования, ваше сообщение не было отправлено. Пожалуйста, завершите зашифрованный разговор или перезапустите его.
# Variables:
#   $name (String) - the screen name of a chat contact person
msgevent-setup_error = При настройке конфиденциального разговора с { $name } произошла ошибка.
# Do not translate 'OTR' (name of an encryption protocol)
msgevent-msg_reflected = Вы получаете свои собственные сообщения OTR. Вы либо пытаетесь говорить сами с собой, либо кто-то отбрасывает ваши сообщения обратно к вам.
# Variables:
#   $name (String) - the screen name of a chat contact person
msgevent-msg_resent = Последнее сообщение для { $name } было отправлено повторно.
# Variables:
#   $name (String) - the screen name of a chat contact person
msgevent-rcvdmsg_not_private = Зашифрованное сообщение, полученное от { $name }, не читается, так как в данный момент вы не общаетесь конфиденциально.
# Variables:
#   $name (String) - the screen name of a chat contact person
