...
auth-cancelAccessKey = ქ
auth-cancel-access-key = ქ
auth-error = შეცდომა, პირის ვინაობის დამოწმებისას.
auth-success = პირის ვინაობა წარმატებით დამოწმდა.
auth-successThem = დაკავშირებულმა პირმა წარმატებით დაამოწმა თქვენი ვინაობა. თქვენც შეგიძლიათ სურვილის შემთხვევაში მათი ვინაობის დამოწმება, კითხვების დასმით.
...
# Variables:
#   $name (String) - the screen name of a chat contact person
alert-gone_insecure = დაშიფრული საუბარი პირთან { $name } დასრულებულია.
# Variables:
#   $name (String) - the screen name of a chat contact person
...
state-not_private = მიმდინარე საუბარი არ არის პირადი.
...
state-not_private-label = დაუცველი
...
successThem-title = პირის ვინაობის დამოწმება
