  ...
  - 256 MB RAM
  - 200 MB of free hard disc space
  ...
  Your personal settings, bookmarks, email, passwords etc. are stored in a
  ...
  (like the last root folder used by the Save dialogue) are stored in
  ...
  (including your personal settings, bookmarks, email, passwords etc.),
  follow these steps:
