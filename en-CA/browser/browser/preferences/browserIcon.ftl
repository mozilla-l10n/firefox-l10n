...
appearance-browser-icon-entry-group =
    .label = Browser icon
    .description = Choose a custom icon for your taskbar, desktop and start menu.
appearance-browser-icon-button =
    .label = Change browser icon
...
appearance-browser-icon-requirement =
    .message = Complete and unlock bonus fox icons to personalize { -brand-short-name }.
