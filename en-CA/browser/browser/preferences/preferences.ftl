...
pane-privacy-title2 = Privacy & Security
...
appearance-group =
    ...
    .description = Some websites adapt their colour scheme based on your preferences. Choose which colour scheme you’d like to use for those sites.
