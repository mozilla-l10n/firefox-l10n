...
- Minimum hardware requirements
  ...
  + 40 MiB free hard disc space for installation
...
------------------------------
   ...
   download the .zip file and follow these steps:
     ...
     firefox-x.x.x.en-GB.os2.zip where the "x.x.x" is replaced by the Firefox
     version.
     ...
     below the location you point it to, e.g.
        unzip firefox-3.0.en-GB.os2.zip -d c:\firefox-3.0
