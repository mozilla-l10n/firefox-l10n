...
sandbox-missing-unprivileged-namespaces = Algunas de las funciones de seguridad de { -brand-short-name } pueden ofrecer menos protección bajo tu sistema operativo actual.
