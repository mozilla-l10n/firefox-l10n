...
about-translations-title = Traducciones de { -brand-short-name }
...
about-translations-learn-more-link = Más información
...
about-translations-unsupported-info-button = Más información
# An error message displayed when the language list fails to load.
...
about-translations-detected-language-unsupported-heading-2 = Lo sentimos, todavía no admitimos traducciones de { $language }
...
about-translations-translating-message = Traduciendo…
