...
details-notification-softblocked-extension-disabled =
    .message = Esta extensión viola las políticas de Mozilla y ha sido deshabilitada. La puedes habilitar, pero podría ser riesgoso.
...
details-notification-softblocked-other-disabled =
    .message = Este complemento viola las políticas de Mozilla y ha sido deshabilitada. La puedes habilitar, pero podría ser riesgoso.
