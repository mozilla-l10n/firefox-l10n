...
about-webrtc-debug-mode-toggled-off-state-msg = El registro de ruta puede ser encontrado en: { $path }
about-webrtc-debug-mode-toggled-on-state-msg = Modo de depuración activo, registro de ruta en: { $path }
