...
about-processes-web-isolated-property-with-coop-coep = origen cruzado aislado
...
about-processes-utility-actor-hw-inference = Inferencia acelerada por hardware
