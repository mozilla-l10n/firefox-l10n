...
mailto-handler-picker-window =
    .title = Elige tu app de correo
    .style = min-width: 26em; min-height: 26em;
mailto-handler-picker-subtitle = Selecciona la aplicación que prefieras usar para los enlaces de correo electrónico. Podrás cambiarla más adelante en los Ajustes.
...
mailto-handler-picker-always-ask = Siempre pregúntame cuando haga clic en un enlace de correo electrónico
