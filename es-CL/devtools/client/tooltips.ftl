...
inactive-css-no-default-anchor = <strong>{ $property }</strong> no tiene efecto en este elemento ya que no tiene un elemento de anclaje predeterminado.
...
inactive-css-not-grid-or-flex-or-absolutely-positioned-item-fix = Prueba a añadir <strong>position:absolute</strong> al elemento, o <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong> o <strong>display:inline-flex</strong> al elemento padre. { learn-more }
inactive-css-not-grid-or-absolutely-positioned-item-fix = Prueba a añadir <strong>position:absolute</strong> al elemento, o <strong>display:grid</strong> o <strong>display:inline-grid</strong> al elemento padre. { learn-more }
inactive-css-not-absolutely-positioned-item-fix = Prueba a añadir <strong>position:absolute</strong> al elemento. { learn-more }
inactive-css-no-default-anchor-fix = Prueba a añadir <strong>position-anchor</strong> con un nombre válido de ancla. { learn-more }
...
inactive-css-not-block-flex-grid-container-fix = Intenta añadir <strong>display:block</strong>, <strong>display:inline-block</strong>, <strong>display:flex</strong>, <strong>display:inline-flex</strong>, <strong>display:grid</strong>, <strong>display:inline-grid</strong> o <strong>display:flow-root</strong>. { learn-more }
...
inactive-css-not-grid-or-flex-container-fix-1 = Prueba a añadir <strong>display:grid</strong> o <strong>display:flex</strong>.
inactive-css-not-grid-or-flex-or-block-container-fix-1 = Intenta añadir <strong>display:grid</strong>, <strong>display:flex</strong>, o <strong>display:block</strong>.
inactive-css-not-grid-or-flex-container-or-multicol-container-fix-1 = Intenta añadir ya sea <strong>display:grid</strong>, <strong>display:flex</strong>, o <strong>columns:2</strong>.
...
inactive-css-not-grid-or-flex-or-absolutely-positioned-item-fix-1 = Prueba a añadir <strong>position:absolute</strong> al elemento, o <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong> o <strong>display:inline-flex</strong> al elemento padre.
inactive-css-not-grid-or-absolutely-positioned-item-fix-1 = Prueba a añadir <strong>position:absolute</strong> al elemento, o <strong>display:grid</strong> o <strong>display:inline-grid</strong> al elemento padre.
inactive-css-not-absolutely-positioned-item-fix-1 = Prueba a añadir <strong>position:absolute</strong> al elemento.
inactive-css-no-default-anchor-fix-1 = Prueba a añadir <strong>position-anchor</strong> con un nombre válido de ancla.
...
inactive-css-not-block-container-fix-1 = Intenta añadir <strong>display:block</strong>, <strong>display:inline-block</strong> o <strong>display:flow-root</strong>.
inactive-css-not-block-flex-grid-container-fix-1 = Intenta añadir <strong>display:block</strong>, <strong>display:inline-block</strong>, <strong>display:flex</strong>, <strong>display:inline-flex</strong>, <strong>display:grid</strong>, <strong>display:inline-grid</strong> o <strong>display:flow-root</strong>.
...
inactive-css-position-property-on-unpositioned-box-fix-1 = Intenta establecer la propiedad <strong>position</strong> a algo diferente a <strong>static</strong>.
inactive-css-only-replaced-elements-fix-1 = Asegúrate de añadir la propiedad a un elemento reemplazado.
inactive-text-overflow-when-no-overflow-fix-1 = Prueba a añadir <strong>overflow:hidden</strong>.
inactive-css-no-size-containment-fix-1 = Intenta ajustar su propiedad <strong>display</strong> a algo distinto de <strong>none</strong>, <strong>contents</strong>, <strong>table</strong> o <strong>inline-table</strong> y asegúrate de que no esté dentro de una tabla o segmento de Ruby.
...
inactive-css-not-for-internal-table-elements-except-table-cells-fix-1 = Prueba ajustar su propiedad <strong>display</strong> a algo diferente a <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong> o <strong>table-footer-group</strong>.
