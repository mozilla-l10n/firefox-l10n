...
unified-extensions-empty-reason-zero-extensions-onboarding2 = Unas pocas extensiones dan para mucho
...
unified-extensions-empty-content-explain-extensions-onboarding2 = Tenemos recomendaciones para ayudarte a mejorar la concentración, la privacidad y mucho más.
unified-extensions-empty-content-explain-extensions-onboarding = Personaliza { -brand-short-name } cambiando su apariencia y rendimiento o mejorando la privacidad y la seguridad.
...
unified-extensions-item-messagebar-softblocked2 = { $extensionName } está restringida. Su uso puede ser arriesgado.
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
...
unified-extensions-mb-blocklist-warning-single2 =
    ...
    .message =
        ...
        Puedes habilitarla en los ajustes, pero esto puede ser arriesgado.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a soft-block.
...
unified-extensions-mb-blocklist-warning-multiple2 =
    ...
    .message =
        Algunas de tus extensiones están restringidas y han sido desactivadas.
        Puedes habilitarlas en ajustes, pero esto podría ser arriesgado.
# Variables:
#   $extensionsCount (Number) - Number of extensions disabled through both soft and hard-blocks (always going to be greater than 1)
