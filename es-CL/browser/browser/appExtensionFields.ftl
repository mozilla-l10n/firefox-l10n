...
extension-default-theme-description2 = Un gris-púrpura equilibrado y familiar para un look clásico de { -brand-product-name }.
...
extension-default-theme-name2 = Por defecto
...
extension-nova-flare-name = Llamarada
...
extension-nova-dusk-name = Ocaso
