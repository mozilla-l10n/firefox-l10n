...
fxa-menu-send-to-mobile =
    .label =
        { $tabCount ->
            [1] Enviar { $tabCount } pestaña al móvil
...
fxa-menu-send-to-mobile-connect-device = Conecta un dispositivo para enviar pestañas
# Variables:
#   $tabCount (Number): The number of tabs sent to the device.
...
fxa-menu-send-to-mobile-sign-in = Conectarse para enviar pestañas
