...
start-page-callout-subtitle = Prueba Startpage. Está diseñado para que tus búsquedas sean más privadas desde el principio.
start-page-callout-primary-label = Prueba Startpage
start-page-callout-secondary-label = Ocultar
...
tab-groups-2026-onboarding-callout-title = Reduce el desorden con grupos de pestañas
...
tab-groups-2026-onboarding-callout-subtitle = Agrupa tus pestañas por tarea o tema. Añade más según las necesites.
...
tab-groups-2026-onboarding-cta-button = Empezar un grupo
...
splitview-onboarding-callout-subtitle-1 = Haz clic derecho en esta pestaña y elije “Añadir vista dividida” para ver dos pestañas a la vez.
...
splitview-onboarding-callout-subtitle-2 = Sin ventanas adicionales. Sin cambio de pestañas. Haz clic derecho en esta pestaña y selecciona "Añadir vista dividida".
