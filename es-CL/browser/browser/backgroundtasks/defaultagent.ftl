...
default-browser-notification-privacy-header-text = ¿Permanecer con { -brand-short-name }?
default-browser-notification-privacy-body-text = Tu ajuste predeterminado ha cambiado. Vuelve a { -brand-short-name } para disfrutar de privacidad y protección integradas.
