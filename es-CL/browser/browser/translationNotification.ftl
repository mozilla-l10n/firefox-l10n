...
translation-notification-translating-content =
    .value = Traduciendo contenido de la página…
...
translation-notification-service-unavailable =
    .value = La traducción no está disponible en este momento. Por favor, vuelve a intentarlo más tarde.
...
translation-notification-options-never-for-language =
    .label = Nunca traducir del { $langName }
    .accesskey = N
