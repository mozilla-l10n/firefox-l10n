...
about-private-browsing-learn-more = Aprender más sobre <a data-l10n-name="learn-more">navegación privada</a>.
...
about-private-browsing-note = La navegación privada <strong>no te deja en el anonimato</strong> en internet. Tu empleador o proveedor de servicios de internet todavía puede saber qué páginas visitas.
