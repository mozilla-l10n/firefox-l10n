...
onboarding-live-language-subtitle = { -brand-short-name } está en { $appLanguage } mientras que tu sistema está en { $systemLanguage }.
...
onboarding-live-language-waiting-subtitle = Parece que tus sistema y { -brand-short-name } están usando idiomas diferentes.
