...
launch-on-login-autostart-infobar-message = { -brand-short-name } ahora se abre cuando inicias sesión en Windows. Siempre puedes cambiar esto más adelante en los ajustes.
launch-on-login-autostart-infobar-keep-button = Mantener
    .accesskey = M
...
welcome-back-spotlight-subtitle = Te damos la bienvenida de regreso al único navegador de los grandes que es respaldado por una organización sin fines de lucro. Tomamos medidas adicionales para proteger tus datos estés donde estés.
...
windows-10-eos-global-infobar-title = <strong>Microsoft ya no ofrece soporte para Windows 10.</strong> Haz una copia de seguridad de tu información para preparar { -brand-product-name } para Windows 11.
windows-10-eos-global-infobar-primary-button = Activar respaldos
    .accesskey = T
...
set-default-menu-message-simple-layout-title = { -brand-short-name } no es el navegador predeterminado
set-default-menu-message-simple-layout-title-variant = { -brand-short-name } no es tu navegador principal
set-default-menu-message-row-layout-title = Hacer de { -brand-short-name } tu navegador principal
set-default-menu-message-row-layout-title-variant = Hacer de { -brand-short-name } tu navegador predeterminado
set-default-menu-message-row-layout-subtitle = Obtén velocidad, seguridad y privacidad cada vez que navegas.
set-default-menu-message-row-layout-subtitle-variant =
    { PLATFORM() ->
        [macos] Mantenga { -brand-short-name } al alcance de tus dedos — hazlo tu predeterminado y mantenlo en tu Dock.
       *[other] Mantenga { -brand-short-name } al alcance de tus dedos — hazlo tu predeterminado y mantenlo en tu barra de tareas.
    }
set-default-menu-message-split-layout-title =
    { PLATFORM() ->
        [macos] Mantener { -brand-short-name } al alcance de tus dedos
       *[other] Abrir todos los enlaces con { -brand-short-name }
    }
set-default-menu-message-split-layout-subtitle =
    { PLATFORM() ->
        [macos] hazlo tu predeterminado y mantenlo en tu Dock
       *[other] Disfruta de una navegación más rápida y protección automática de privacidad.
    }
...
set-default-menu-message-primary-button-short-variant = Hacer de { -brand-short-name } el predeterminado

## Firefox Relay 50 Masks Announcement

# "on us" in this context means "for free" or "at no cost"
relay-50-masks-announcement-title = 50 máscaras de correo electrónico, cortesía nuestra
relay-50-masks-announcement-subtitle = Ahora obtienes 50 máscaras gratis (antes eran 5). Usa una por cada cuenta para mantener tu correo electrónico real privado.
...
nova-early-access-infobar-title = <strong>{ -brand-product-name } tendrá una nueva imagen.</strong> Estás viendo una versión preliminar, sin pulir, antes de su lanzamiento a finales de este año.
...
launch-options-spotlight-title-launch-on-login = ¿Deseas abrir { -brand-short-name } cada vez que inicies sesión en Windows?
launch-options-spotlight-title-session-restore = ¿Reabrir la sesión cuando { -brand-short-name } se reinicie?
launch-options-spotlight-checkbox-launch-on-login = Abrir { -brand-short-name } al encender
launch-options-spotlight-checkbox-pin-to-taskbar = Fijar a tu barra de tareas
# Shown on the browser-close prompt only
launch-options-spotlight-checkbox-restore-current = Reabrir las ventanas y pestañas actuales
...
lapsed-user-toast-title = { -brand-product-name } todavía te respalda
lapsed-user-toast-subtitle = Descubre nuevas formas de navegar con más opciones, privacidad y control.
lapsed-user-toast-whats-new-button = Revisa que hay de nuevo
lapsed-user-toast-dismiss-button = Ocultar
...
refresh-unused-profile-infobar-message = Parece que hace tiempo no inicia { -brand-short-name }. ¿Le gustaría limpiarlo para una experiencia fresca, como que fuera nuevo? Y aprovechando, ¡Bienvenido!
refresh-reinstalled-profile-infobar-message = Parece que has reinstalado { -brand-short-name }. ¿Quieres que lo limpiemos para que tengas una experiencia de recién salido de la caja?
