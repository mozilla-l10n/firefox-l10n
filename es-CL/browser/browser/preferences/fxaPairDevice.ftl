...
fxa-qrcode-pair-step2 = 2. Abre el <strong>menú</strong> (<img data-l10n-name="ios-menu-icon"/> en iOS o <img data-l10n-name="android-menu-icon"/> en Android) y toca <strong>Conectarse para sincronizar</strong>
