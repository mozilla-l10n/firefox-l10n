...
appearance-browser-icon-entry-group =
    .description = Elige un ícono personalizado para tu barra de tareas, escritorio y menú de inicio.
    .label = Ícono del navegador
appearance-browser-icon-button =
    .label = Cambiar ícono del navegador
...
appearance-browser-icon-requirement =
    .message = Completa y desbloquea iconos de zorro adicionales para personalizar { -brand-short-name }.
...
appearance-browser-icon-unlocked =
    .message = ¡Has desbloqueado todos los íconos de bonificación!
appearance-browser-icon-set-default-button =
    .label = Establecer como predeterminado
appearance-browser-icon-pin-button =
    .label = Fijar a la barra de tareas
