...
applications-setting =
    .label = Aplicaciones
    .description = Elige cómo { -brand-short-name } maneja los archivos que descargas de la Web o las aplicaciones que usas al navegar.
...
category-passwords-autofill =
    .tooltiptext = Ajustes de contraseñas y autocompletado
