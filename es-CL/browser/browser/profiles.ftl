...
profile-window-checkbox-label-2 =
    .label = Elige un perfil cuando se abra { -brand-short-name }
# This subcopy appears below the checkbox when it is unchecked
profile-window-checkbox-subcopy = { -brand-short-name } se abrirá en tu perfil utilizado más recientemente.
...
restored-profile-page-learn-more = Aprender más
...
profiles-cyan-theme = Celeste
profiles-cyan-theme-title =
    .title = Aplicar tema celeste
...
video-game-controller-avatar = Control de videojuegos
...
profiles-appmenu-callout-tour-title = Tu nuevo perfil está listo para ser usado
...
heart-rate-avatar-tooltip =
    .tooltiptext = Aplicar avatar de frecuencia cardiaca
clock-avatar-tooltip =
    .tooltiptext = Aplicar avatar de reloj
leaf-avatar-tooltip =
    .tooltiptext = Aplicar avatar de hoja
lightbulb-avatar-tooltip =
    .tooltiptext = Aplicar avatar de ampolleta
