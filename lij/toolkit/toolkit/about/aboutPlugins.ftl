...
plugins-openh264-description = Sto plugin o vegne instalou aotomaticamente da Mozilla, in conformitæ co-e specifiche WebRTC, per consentire chiamate con dispositivi che richiedono un codec video H.264. Vixita https://www.openh264.org/ pe amiate o còdice sorgente e descovrî atre cöse in sce l'inplementaçion.
