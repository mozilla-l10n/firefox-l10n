...
screenshots-login-error-details = No poemmo sarvâ a teu inmagine perché gh'é 'n problema co-o serviçio de Firefox Screenshot. Pe piaxei preuva torna dòppo.
...
screenshots-generic-error-title = Ahime mi! Firefox Screeshot o s'é ciantou.
