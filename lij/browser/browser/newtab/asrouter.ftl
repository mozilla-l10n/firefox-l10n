...
refresh-unused-profile-infobar-message = Pâ che { -brand-short-name } o no vegna adeuviou da 'n pö de tenpo. Inandiâ ina operaçion de netezamento pe garantî 'na megio esperiensa? Ah belin, benvegnuo torna chi.
refresh-reinstalled-profile-infobar-message = Pâ che ti aggi instalou torna { -brand-short-name }. Ti veu che niatri scistememmo tutto pe ina neuva esperiensa?
refresh-profile-infobar-button = Repiggia { -brand-short-name }…
    .accesskey = R
