...
colorpicker-tooltip-eyedropper-title = Escolha uma cor na página
...
colorpicker-tooltip-color-name-title = Mais próxima de: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Tonalidade
...
inspector-emulation-panel-toggle =
    .aria-label = Alternar funcionalidades de emulação CSS
    .title = Alternar funcionalidades de emulação CSS
...
inspector-emulation-panel-reduced-motion-reduce = Reduzir
    .aria-label = Ativar emulação de movimento reduzido
# A label text for the no preference for reduced motion emulation radio button option.
inspector-emulation-panel-reduced-motion-no-preference = Sem preferência
    .aria-label = Ativar sem preferência para emulação de movimento reduzido
# A label text for the no reduced motion emulation radio button option (uses user's preference).
inspector-emulation-panel-reduced-motion-none = Sem emulação
    .aria-label = Desativar emulação de movimento reduzido
