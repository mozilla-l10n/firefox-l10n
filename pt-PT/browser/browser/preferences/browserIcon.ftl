...
appearance-browser-icon-entry-group =
    .description = Escolha um ícone personalizado para a sua barra de tarefas, ambiente de trabalho e menu Iniciar.
    .label = Ícone do navegador
appearance-browser-icon-button =
    .label = Alterar ícone do navegador
...
appearance-browser-icon-requirement =
    .message = Preencha e desbloqueie ícones bónus da raposa para personalizar o { -brand-short-name }.
