...
more-from-moz-qr-code-box-firefox-mobile-button = Em vez disso, envie uma mensagem para o seu telemóvel
...
more-from-moz-title2 = Mais de { -vendor-short-name }
    .title = Mais de { -vendor-short-name }
...
more-from-moz-solo-description = Crie o seu site instantaneamente e associe o seu próprio domínio personalizado gratuitamente.
more-from-moz-solo-button = Experimente o { -solo-ai-brand-name }
more-from-moz-solo-title-2 = Criador de sites com IA { -solo-ai-brand-name }
...
more-from-moz-solo-card-1 =
    .description = Crie o seu site instantaneamente e associe o seu próprio domínio personalizado gratuitamente.
    .label = { -solo-ai-brand-name }
more-from-moz-new-products-card2 =
    .description = Explore as nossas tecnologias experimentais e ideias mais recentes .
