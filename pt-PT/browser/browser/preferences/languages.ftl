...
languages-close-key =
    .key = w
languages-description = Por vezes, as páginas web são oferecidas em mais do que um idioma. Escolha os idiomas para apresentar estas páginas, por ordem de preferência
...
browser-languages-update-error =
    .message = O { -brand-short-name } não pode atualizar os seus idiomas neste momento. Verifique que está ligado à internet ou tente novamente.
