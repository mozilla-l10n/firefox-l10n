...
contextual-manager-passwords-origin-field-description = Insira o endereço exato de onde irá iniciar a sessão neste site.
contextual-manager-passwords-username-field =
    .label = Nome de utilizador
contextual-manager-passwords-username-field-description = Insira o nome de utilizador, o endereço de e-mail ou o número da conta que utiliza para iniciar a sessão.
contextual-manager-passwords-password-field =
    .label = Palavra-passe
contextual-manager-passwords-password-field-description = Insira a palavra-passe para iniciar a sessão nesta conta.
