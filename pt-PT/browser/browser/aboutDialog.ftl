...
settings-update-downloading-2 =
    .label = A transferir atualização — { $transfer }

##

update-applying = A aplicar atualização…
settings-update-applying =
    .label = A aplicar atualização…
...
helpus-referrals2 = Quer ajudar? <label data-l10n-name="helpus-donateLink">Faça uma doação </label>, <label data-l10n-name="helpus-shareFirefoxLink">partilhe o { -brand-product-name }</label>, ou <label data-l10n-name="helpus-getInvolvedLink">envolva-se!</label>
helpus-referrals = Quer ajudar? <label data-l10n-name="helpus-donateLink">Faça um donativo</label>, <label data-l10n-name="helpus-shareFirefoxLink">Partilhe o { -brand-short-name }</label>, ou <label data-l10n-name="helpus-getInvolvedLink">envolva-se!</label>
