...
default-browser-notification-privacy-header-text = Continuar com o { -brand-short-name }?
default-browser-notification-privacy-body-text = A sua predefinição foi alterada. Volte ao { -brand-short-name } para privacidade e proteção integradas.
...
default-browser-notification-privacy-no-button-text = Não, obrigado
