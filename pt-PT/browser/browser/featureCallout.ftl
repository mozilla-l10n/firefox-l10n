...
fx-view-discoverability-title = Não queria fechar esse separador?
fx-view-discoverability-subtitle = Encontre e reabra rapidamente aqui. Mantemos um histórico dos seus separadores fechados recentemente para si.
fx-view-discoverability-primary-button-label = Abrir o { -firefoxview-brand-name }
fx-view-discoverability-secondary-button-label = Dispensar

## Split Dismiss Button Labels

# Blocks the message from showing again
split-dismiss-button-dont-show-option-label = Não mostrar esta recomendação novamente
...
sidebar-callout-survey-saved-websites-2 = Acesso rápido aos seus marcadores
...
unified-search-engines-callout-subtitle = Escreva “@” seguido por uma palavra-chave para pesquisar no seu histórico, marcadores, separadores ou com outro motor de pesquisa.
unified-search-engines-callout-primary-label = Percebido
actions-callout-title = Conclua tarefas comuns ou aceda às definições básicas
