...
report-broken-site-panel-description =
    .placeholder = O que aconteceu? O que deveria ter acontecido? Desativar a proteção contra a monitorização ajudou?
...
report-broken-site-panel-blocked-trackers-label =
    .label = Enviar URL bloqueados pela proteção contra a monitorização
