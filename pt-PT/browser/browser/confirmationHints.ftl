...
confirmation-hint-passport-created = Passaporte guardado
confirmation-hint-passport-updated = Passaporte atualizado
...
confirmation-hint-extensions-button-hidden = Movido para o menu
