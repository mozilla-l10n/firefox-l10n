...
smart-window-block-title = { -smart-window-brand-name } ᱟᱠᱚᱴᱟᱢ ᱥᱮ ?
smart-window-block-description-both = ᱱᱚᱣᱟ ᱟᱢᱟᱜ { -smart-window-brand-name } ᱪᱮᱴ ᱠᱚ ᱟᱨ ᱩᱭᱦᱟᱹᱨ ᱠᱚ ᱢᱮᱴᱟᱣ ᱪᱷᱚᱭᱟᱭ ᱾
...
ai-window-activate-link =
    .label = ᱫᱮᱞᱟ ᱮᱛᱦᱚᱵ ᱞᱮᱜᱮ ᱵᱚᱱ
ai-window-personalize-button =
    .label = { -smart-window-brand-name } ᱥᱟᱡᱟᱣᱠᱚ
...
smart-window-model-custom-name =
    .label = ᱢᱳ'ᱰᱮᱞ ᱧᱩᱛᱩᱢ
    .placeholder = ᱫᱟᱹᱭᱠᱟᱹ: glm4
smart-window-model-custom-url =
    .label = ᱢᱳᱰᱮᱞ ᱮᱱᱰᱯᱚᱭᱤᱱᱴ
    .placeholder = ᱫᱟᱹᱭᱠᱟᱹ: http://localhost:11434/v1
smart-window-model-custom-token =
    .label = API ᱪᱟᱹᱵᱤ ᱵᱟᱝᱠᱷᱟᱱ ᱚᱛᱷ ᱴᱚᱠᱮᱱ, ᱡᱩᱫᱤ ᱞᱟᱹᱠᱛᱤᱜ ᱠᱷᱟᱱ
smart-window-model-custom-info =
    .message = ᱡᱚᱠᱷᱚᱱ ᱟᱢ ᱠᱟᱥᱴᱚᱢ ᱢᱚᱰᱮᱞ ᱮᱢ ᱵᱮᱵᱷᱟᱨᱟ, { -smart-window-brand-name } ᱫᱚ ᱟᱥᱟ ᱞᱮᱠᱟ ᱵᱟᱭ ᱠᱟᱹᱢᱤ ᱫᱟᱲᱮᱭᱟᱜᱼᱟ ᱾
smart-window-model-custom-more-link = ᱠᱟᱥᱴᱚᱢ ᱢᱚᱰᱮᱞ ᱠᱚ ᱵᱟᱵᱚᱛ ᱵᱟᱹᱲᱛᱤ
