...
devtools-tooltip-learn-more = ᱰᱷᱮᱨ ᱥᱮᱬᱟᱭ ᱢᱮ
...
inactive-css-not-grid-or-flex-container-fix-1 = <strong>display:grid</strong> ᱥᱮ <strong>display:flex</strong> ᱥᱮᱞᱮᱫ ᱠᱟᱛᱮ ᱧᱮᱞ ᱢᱮ ᱾
inactive-css-not-grid-or-flex-container-or-multicol-container-fix-1 = <strong>display:grid</strong>, <strong>display:flex</strong>, ᱥᱮ <strong>columns:2</strong> ᱥᱮᱞᱮᱫ ᱠᱟᱛᱮ ᱧᱮᱞ ᱢᱮ ᱾
inactive-css-not-multicol-container-fix-1 = <strong>column-count</strong> ᱥᱮ <strong>column-width</strong> ᱥᱮᱞᱮᱫ ᱞᱟᱹᱜᱤᱫ ᱪᱮᱥᱴᱟᱭ ᱢᱮ ᱾
inactive-css-not-grid-or-flex-item-fix-4 = <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong>, ᱥᱮ <strong>display:inline-flex</strong> ᱜᱷᱟᱨᱚᱧᱡᱽ ᱱᱚᱢᱩᱱᱟ ᱨᱮ ᱥᱮᱞᱮᱫ ᱠᱟᱛᱮ ᱧᱮᱞ ᱢᱮ ᱾
inactive-css-not-grid-item-fix-3 = <strong>display:grid</strong> ᱥᱮ <strong>display:inline-grid</strong> ᱜᱷᱟᱨᱚᱧᱡᱽ ᱱᱚᱢᱤᱩᱱᱟ ᱨᱮ ᱥᱮᱞᱮᱫ ᱢᱮ ᱾
inactive-css-not-grid-container-fix-1 = <strong>display:grid</strong> ᱥᱮ <strong>display:inline-grid</strong> ᱥᱮᱞᱮᱫ ᱵᱤᱲᱟᱹᱣ ᱢᱮ ᱾
inactive-css-not-flex-item-fix-3 = <strong>display:flex</strong> ᱥᱮ <strong>display:inline-flex</strong> ᱜᱷᱟᱨᱚᱧᱡᱽ ᱱᱚᱢᱩᱱᱟ ᱨᱮ ᱥᱮᱞᱮᱫ ᱵᱤᱲᱟᱹᱣ ᱢᱮ ᱾
inactive-css-not-flex-container-fix-1 = <strong>display:flex</strong> ᱥᱮ <strong>display:inline-flex</strong> ᱨᱮ ᱥᱮᱞᱮᱫ ᱵᱤᱲᱟᱹᱣ ᱢᱮ ᱾
inactive-css-not-inline-or-tablecell-fix-1 = <strong>display:inline</strong> ᱥᱮ <strong>display:table-cell</strong> ᱥᱮᱞᱮᱫ ᱵᱤᱲᱟᱹᱣ ᱢᱮ ᱾
inactive-css-non-replaced-inline-or-table-row-or-row-group-fix-1 = <strong>display:inline-block</strong> ᱥᱮ <strong>display:block</strong> ᱥᱮᱞᱮᱫ ᱵᱤᱲᱟᱹᱣ ᱢᱮ ᱾
inactive-css-non-replaced-inline-or-table-column-or-column-group-fix-1 = <strong>display:inline-block</strong> ᱥᱮᱞᱮᱫ ᱵᱤᱲᱟᱹᱣ ᱢᱮ ᱾
inactive-css-not-display-block-on-floated-fix-1 = <strong>float</strong> ᱚᱪᱚᱜᱽ ᱥᱮ <strong>display:block</strong> ᱥᱮᱞᱮᱫ ᱵᱤᱲᱟᱹᱣ ᱢᱮ ᱾
inactive-css-position-property-on-unpositioned-box-fix-1 = <strong>static</strong> ᱪᱷᱟᱰᱤ ᱠᱟᱛᱮ ᱡᱟᱦᱱᱟᱜ <strong>position</strong> ᱯᱨᱚᱯᱚᱴᱤ ᱥᱮᱴ ᱠᱟᱛᱮ ᱧᱮᱞ ᱵᱤᱲᱟᱹᱣ ᱢᱮ ᱾
inactive-text-overflow-when-no-overflow-fix-1 = <strong>overflow:hidden</strong> ᱥᱮᱞᱮᱫ ᱵᱤᱲᱟᱹᱣ ᱢᱮ ᱾
inactive-css-not-for-internal-table-elements-fix-1 = <strong>display</strong> ᱯᱨᱚᱯᱚᱴᱤ ᱫᱚ <strong>table-cell</strong>, <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong>, ᱥᱮ <strong>table-footer-group</strong> ᱟᱲᱟᱜ ᱠᱟᱛᱮ ᱟᱨ ᱡᱟᱦᱱᱟᱜ ᱥᱮᱴ ᱠᱟᱛᱮ ᱧᱮᱞ ᱢᱮ ᱾
inactive-css-not-for-internal-table-elements-except-table-cells-fix-1 = <strong>display</strong> ᱯᱨᱚᱯᱚᱴᱤ ᱫᱚ <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong>, ᱥᱮ <strong>table-footer-group</strong> ᱟᱲᱟᱜ ᱠᱟᱛᱮ ᱟᱨ ᱡᱟᱦᱱᱟᱜ ᱥᱮᱴ ᱠᱟᱛᱮ ᱧᱮᱞ ᱢᱮ ᱾
inactive-css-not-table-fix-1 = <strong>display:table</strong> or <strong>display:inline-table</strong> ᱥᱮᱞᱮᱫ ᱵᱤᱲᱟᱹᱣ ᱢᱮ ᱾
inactive-css-not-table-cell-fix-1 = <strong>display:table-cell</strong> ᱥᱮᱞᱮᱫ ᱞᱟᱹᱜᱤᱫ ᱪᱮᱥᱴᱟᱭ ᱢᱮ ᱾
inactive-scroll-padding-when-not-scroll-container-fix-1 = <strong>overflow:auto</strong>, <strong>overflow:scroll</strong>, ᱥᱮ <strong>overflow:hidden</strong> ᱥᱮᱞᱮᱫ ᱵᱤᱲᱟᱹᱣ ᱢᱮ ᱾
inactive-css-border-image-fix-1 = ᱜᱷᱟᱨᱚᱧᱡᱽ ᱴᱮᱵᱩᱞ ᱱᱚᱢᱩᱱᱟ ᱨᱮ, ᱯᱨᱚᱯᱚᱨᱴᱤ ᱚᱪᱚᱜᱽ ᱢᱮ ᱥᱮ <strong>border-collapse</strong> ᱦᱟᱜ ᱮᱞ ᱫᱚ ᱡᱟᱦᱱᱟᱜ ᱮᱴᱟᱜ ᱛᱮ ᱵᱚᱫᱚᱞ ᱢᱮ <strong>collapse</strong> ᱟᱲᱟᱜ ᱠᱟᱛᱮ ᱾
inactive-css-ruby-element-fix-1 = ᱨᱩᱵᱤ ᱚᱞ ᱨᱮᱭᱟᱜ <strong>font-size</strong> ᱵᱚᱫᱚᱞ ᱠᱟᱛᱮ ᱧᱮᱞ ᱢᱮ ᱾
