...
url-classifier-title = URL ᱠᱞᱟᱥᱤᱯᱷᱟᱭᱚᱨ ᱵᱤᱵᱨᱚᱬ
url-classifier-search-title = ᱥᱮᱸᱫᱽᱨᱟ
url-classifier-search-result-title = ᱛᱮᱞᱟᱠᱚ
# Variables:
#   $uri (string) - URI of blocked page
url-classifier-search-result-uri = URI: { $uri }
# Variables:
#   $list (string) - List of tables where the page is blocked
url-classifier-search-result-list = ᱴᱮᱵᱩᱞ ᱠᱚᱣᱟᱜ ᱞᱤᱥᱴᱤ: { $list }
url-classifier-search-input = URL
url-classifier-search-error-invalid-url = ᱵᱷᱩᱞ URL
url-classifier-search-error-no-features = ᱪᱮᱫ ᱦᱚᱸ ᱯᱷᱤᱛᱚᱨᱠᱚ ᱵᱟᱭ ᱵᱟᱪᱷᱟᱣ ᱞᱮᱱᱟ
url-classifier-search-btn = ᱥᱮᱸᱫᱽᱨᱟ ᱮᱛᱦᱚᱵ ᱢᱮ
url-classifier-search-features = ᱯᱷᱤᱪᱚᱨᱠᱚ
url-classifier-search-listType = ᱞᱤᱥᱴᱤ ᱯᱨᱚᱠᱟᱨ
url-classifier-provider-title = ᱮᱢᱤᱡ
url-classifier-provider = ᱮᱢᱤᱡ
url-classifier-provider-last-update-time = ᱢᱟᱲᱟᱝ ᱫᱷᱟᱣᱟᱜ ᱦᱟᱹᱞᱤᱭᱟᱹᱠ ᱚᱠᱛᱚ
url-classifier-provider-next-update-time = ᱤᱱᱟᱹ ᱛᱟᱭᱚᱢᱟᱜ ᱦᱟᱹᱞᱤᱭᱟᱹᱠ ᱚᱠᱛᱚ
