...
update-updateButton =
    ...
    .accesskey = R
update-checkingForUpdates = Nánuka a jiia…
...
update-adminDisabled = Naxi´ñao ña´kuiñi nuu kaa tee nɨnuu
...
helpus = Kuvinu chinei? <label data-l10n-name="helpus-donateLink">Kunimani iin a kuvi</label> a xíín <label data-l10n-name="helpus-getInvolvedLink">náyonika</label>
