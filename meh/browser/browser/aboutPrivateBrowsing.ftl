...
about-private-browsing-info-bookmarks = Daa a ta'an ini noo´o
about-private-browsing-info-title = Síne iin ventana yu'u
about-private-browsing-info-searches = Daa a nnánuku
about-private-browsing-info-downloads = Daa nxinú
private-browsing-title = Navegación yu´u
about-private-browsing-info-saved = { -brand-short-name }<strong>Chuva'a</strong> daa:
about-private-browsing-info-myths = Tu´un nakani jiee nánuku yu'u
about-private-browsing-info-clipboard = tu´un nuu tutu ntɨɨn
...
about-private-browsing-note = A nánuku yu´u <strong> ntu chiyu´u noo´o </strong> nuu Internet. Ñivɨ tatu noo´o jii Internet kuvi kune´ya daa tutu ne´yanu jee nánukunu nuu Internet.
