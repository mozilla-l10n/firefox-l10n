...
about-private-browsing-info-searches = Da nnánuku
about-private-browsing-info-downloads = Da nxinú
private-browsing-title = Navegación yu´u
about-private-browsing-info-saved = { -brand-short-name }<strong>chuva'a</strong> da:
