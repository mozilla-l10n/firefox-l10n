...
fingerprinter-tab-title = Lorgairean-meòir
fingerprinter-tab-content = Cruinnichidh lorgairean-meòir roghainnean on bhrabhsair is on coimpiutair agad airson pròifil a chruthachadh dhiot. Leis an lorg-mheòir digiteach sin, nì iad tracadh ort thar iomadh làrach-lìn. <a data-l10n-name="learn-more-link">Barrachd fiosrachaidh</a>
...
bar-tooltip-fingerprinter =
    .title = Lorgairean-meòir
    .aria-label =
        { $count ->
            [one] { $count } lorgaire-meòir ({ $percentage }%)
            [two] { $count } lorgaire-meòir ({ $percentage }%)
            [few] { $count } lorgairean-meòir ({ $percentage }%)
           *[other] { $count } lorgaire-meòir ({ $percentage }%)
        }
