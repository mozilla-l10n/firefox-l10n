...
newtab-topsites-use-custom-image-link = Cleachd dealbh gnàthaichte
...
newtab-clock-city-fr-paris = Paras
...
newtab-clock-city-cz-prague = Pràg
newtab-clock-city-ar-buenos-aires = Buenos Aires
newtab-clock-city-gr-athens = An Àithne
newtab-clock-city-hu-budapest = Budapest
newtab-clock-city-be-brussels = A' Bhruiseal
...
newtab-clock-city-za-johannesburg = Hannsaborgh
newtab-clock-city-cl-santiago = Santiago
newtab-clock-city-pk-karachi = Karācī
newtab-clock-city-bg-sofia = Sofiya
newtab-clock-city-sg-singapore = Singeapòr
newtab-clock-city-hk-hong-kong = Hong Kong
newtab-clock-city-sa-riyadh = Riyadh
newtab-clock-city-dk-copenhagen = Beirbh
...
newtab-clock-city-ie-dublin = Baile Àtha Cliath
