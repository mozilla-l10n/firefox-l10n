...
policy-DefaultDownloadDirectory = Suidhich pasgan tùsail nan luchdaidhean a-nuas.
...
policy-DownloadDirectory = Suidhich is glais pasgan tùsail nan luchdaidhean a-nuas.
