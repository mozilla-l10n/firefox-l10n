...
qrcode-panel-error =
    .message = Cha b’ urrainn dhuinn còd QR a ghintinn. Feuch ris a-rithist.
qrcode-copy-button =
    .label = Dèan lethbhreac
qrcode-copy-success =
    .message = Chaidh lethbhreac dhen chòd QR a chur air an stòr-bhòrd.
qrcode-copy-error =
    .message = Cha b’ urrainn dhuinn lethbhreac dhen chòd QR a dhèanamh.
qrcode-save-button =
    .label = Sàbhail
qrcode-save-success =
    .message = Chaidh an còd QR a shàbhaladh.
qrcode-save-error =
    .message = Cha b’ urrainn dhuinn an còd QR a shàbhaladh.
qrcode-save-title = Sàbhail an còd QR
qrcode-save-filter-png = Dealbh PNG
qrcode-save-filename = qrcode.png
qrcode-window-title = Còd QR
qrcode-dialog-title = Còd QR
qrcode-image =
    .aria-label = Còd QR
qrcode-close-button =
    .aria-label = Dùin
