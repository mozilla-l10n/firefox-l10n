...
connection-proxy-http-sharing =
    .label = Cleachd am progsaidh seo airson FTP is HTTPS cuideachd
    .accesskey = s
...
connection-proxy-noproxy-localhost-desc = Tha ceanglaichean gu localhost, 127.0.0.1 agus ::1 gun phrogsaidh an-còmhnaidh.
...
connection-dns-over-https-url-item-default =
    ...
    .tooltiptext = Cleachd an URL tùsail airson DNS fhuasgladh thar HTTPS
