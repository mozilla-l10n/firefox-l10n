...
fp-neterror-denied-port-access = Tha an seòladh seo a' cleachdadh port lìonra a chleachdar a chum rudan eile a ghnàth seach brabhsadh-lìn. Sguir { -brand-short-name } dhen iarrtas gus do dhìon.
