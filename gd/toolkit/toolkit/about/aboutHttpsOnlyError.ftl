...
about-httpsonly-insecure-title = Chan eil ceangal tèarainte ri fhaighinn

# Variables:
#   $websiteUrl (String) - Url of the website that failed to load. Example: www.example.com
about-httpsonly-insecure-explanation-unavailable = Tha thu a’ brabhsadh sa mhodh HTTPS a-mhàin ach chan eil tionndadh HTTPS dhe <em>{ $websiteUrl }</em> ri fhaighinn.
about-httpsonly-insecure-explanation-reasons = Tha sinn an dùil nach cuir an làrach-lìn taic ri HTTPS ach dh’fhaoidte gu bheil neach-ionnsaigh a’ bacadh an tionndadh HTTPS dhi.
about-httpsonly-insecure-explanation-exception = Ged nach eil cunnart tèarainteachd mòr ann, ma thadhlas tu air an tionndadh HTTP dhen làrach-lìn, cha bu chòir dhut fiosrachadh dìomhair a chur a-steach, can faclan-faire, puist-d no fiosrachadh cairte-creideis.

about-httpsonly-button-make-exception = Tuigidh mi an cunnart, air adhart dhan làrach leam
