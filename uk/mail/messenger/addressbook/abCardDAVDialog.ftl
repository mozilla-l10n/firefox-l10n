...
carddav-experimental-warning = Підтримка адресної книги CardDAV експериментальна і може безповоротно пошкодити ваші дані. Користуйтеся на свій страх і ризик.
