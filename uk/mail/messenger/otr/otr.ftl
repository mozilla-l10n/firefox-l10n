...
# Variables:
#   $name (String) - the screen name of a chat contact person
msgevent-connection_ended = Зашифроване з'єднання між вами та { $name } вже завершено. Щоб уникнути випадкового надсилання незашифрованого повідомлення, його не було надіслано. Завершіть свою зашифровану розмову або розпочніть її знову.
# Variables:
#   $name (String) - the screen name of a chat contact person
