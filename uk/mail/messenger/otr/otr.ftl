...
msgevent-encryption_required_part1 = Ви намагалися надіслати незашифроване повідомлення до { $name }. Поточні налаштування, забороняють надсилати незашифровані повідомлення.
...
# Variables:
#   $name (String) - the screen name of a chat contact person
msgevent-connection_ended = { $name } вже завершив безпечне з'єднання з вами. Щоб уникнути випадкового надсилання незахищеного повідомлення, повідомлення не було надіслане. Завершіть свою захищену розмову або розпочніть її знову.
# Variables:
#   $name (String) - the screen name of a chat contact person
...
# Variables:
#   $name (String) - the screen name of a chat contact person
msgevent-msg_resent = Останнє повідомлення на адресу { $name } було обурене.
# Variables:
#   $name (String) - the screen name of a chat contact person
