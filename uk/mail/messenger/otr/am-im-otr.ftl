...
otr-encryption-caption = Щоби дозволити іншим підтверджувати ваш ідентифікатор в бесідах з OTR, поділіться власним цифровим відбитком OTR за допомогою іншого каналу зв'язку (поза межами поточного зʼєднання).
...
otr-log =
    .label = Включати зашифровані повідомлення OTR до журналів розмов
