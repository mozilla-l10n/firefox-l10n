...
otr-encryption-caption = Щоби дозволити іншим підтверджувати вашу ідентичність в чатах з OTR, поділіться власним цифровим відбитком OTR за допомогою іншого каналу зв'язку (поза межами поточного підключення).
