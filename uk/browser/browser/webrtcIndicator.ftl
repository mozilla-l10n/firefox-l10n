...
webrtc-reason-for-no-permanent-allow-insecure = Ваше з'єднання з цим сайтом не захищене. Для вашої безпеки { -brand-short-name } дозволить доступ лише для цього сеансу.
