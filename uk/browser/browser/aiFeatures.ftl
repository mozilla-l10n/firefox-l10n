...
smart-window-model-fast-v2 =
    .description = Найкраще підходить для швидких відповідей, коли час має значення. Повна назва: { $model } від { $ownerName }
    .label = { $shortName }: Швидка
smart-window-model-flexible-v2 =
    .description = Готова до виконання різноманітних завдань. Повна назва: { $model } від { $ownerName }
    .label = { $shortName }: Гнучка
smart-window-model-personal-v2 =
    .description = Створена для персоналізованої допомоги різними мовами. Повна назва: { $model } від { $ownerName }
    .label = { $shortName }: Персоналізована
