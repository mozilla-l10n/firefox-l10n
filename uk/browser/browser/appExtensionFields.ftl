...
extension-default-theme-description2 = Збалансовані, знайомі сіро-пурпурові кольори для класичного образу { -brand-product-name }.
...
extension-default-theme-name2 = Типова
# Name for a warm yellow-gold theme. Refers to the color of sunlight.
extension-nova-sun-name = Сонце
...
extension-nova-flame-name = Полум'я
# Name for a bright pink theme. Refers to a burst of light or fire.
extension-nova-flare-name = Сяйво
...
extension-nova-dusk-name = Сутінки
