...
ipprotection-feature-introduction-link-text-captive-portal = Отримайте <a data-l10n-name="learn-more-vpn">додаткову приватність,</a> вибравши одне з 5 розташувань, щоб приховати свої дані.
...
ipprotection-location-selection-callout-description = <a data-l10n-name="learn-more-vpn">Вбудована VPN від { -brand-product-name }</a> дає вам можливість вибрати одне з 5 розташувань власноруч, або дозволити нам вибрати найшвидше.
...
unauthenticated-choose-location-message = Виберіть одне з 5 розташувань або дозвольте { -brand-product-name } вибрати найшвидше.
# Variables
...
ipprotection-connection-status-paused-title-1 = VPN призупинено
# Variables
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
...
ipprotection-connection-status-blocked-error-title = VPN недоступна
...
ip-protection-not-opted-in-2 =
    ...
    .message = Приховуйте своє розташування під час перегляду вебсторінок у { -brand-short-name }. Отримуйте { $maxUsage } ГБ безплатних даних VPN щомісяця.
# Variables
#   $maxUsage (number) - The maximum amount of data a user can use in a month (in GB)
ip-protection-not-opted-in-3 =
    .heading = Спробуйте вбудовану VPN від { -brand-short-name }
    .message = Отримайте додаткову приватність, приховуючи своє розташування під час перегляду інтернету. Отримуйте { $maxUsage } ГБ безплатних даних VPN щомісяця.
