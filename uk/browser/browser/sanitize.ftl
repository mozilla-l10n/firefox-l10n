...
item-site-prefs =
    ...
    .accesskey = Н
item-formdata-prefs =
    .label = Збережена інформація заповнених форм
    .accesskey = і
item-formdata-description = Очищення імен, адрес електронної пошти й інших даних, які ви вводите у форми
...
sanitize-calculating-size = Обчислення…
