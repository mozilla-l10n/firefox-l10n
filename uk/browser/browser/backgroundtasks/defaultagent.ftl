...
default-browser-notification-privacy-header-text = Залишитися з { -brand-short-name }?
default-browser-notification-privacy-body-text = Ваш типовий браузер змінився. Поверніться до { -brand-short-name }, щоб і надалі користуватися перевагами приватності та захисту.
...
default-browser-notification-privacy-no-button-text = Ні, дякую
