...
safeb-blocked-unwanted-page-short-desc = { -brand-short-name } заблокував цю сторінку, тому що вона може спробувати змусити вас встановити програми, які будуть заважати роботі в браузері (наприклад, змінити домівку або показувати зайву рекламу на відвідуваних вами сайтах).
...
safeb-blocked-malware-page-learn-more = Дізнайтеся більше про небезпечний веб-вміст, включаючи віруси та інші зловмисні програми, а також про те, як захистити свій комп'ютер, на сайті <a data-l10n-name='learn_more_link'>StopBadware.org</a>. Дізнайтеся більше про те, як працює захист від зловмисного вмісту в { -brand-short-name } на сайті <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
