...
appearance-browser-icon-entry-group =
    .label = Піктограма браузера
    .description = Оберіть власну піктограму для панелі завдань, робочого столу та меню Пуск.
appearance-browser-icon-button =
    .label = Змінити піктограму браузера
...
appearance-browser-icon-requirement =
    .message = Виконайте дії та розблокуйте додаткові піктограми, щоб персоналізувати { -brand-short-name }.
...
appearance-browser-icon-momo =
    .label = Момо
    .description = Створено @heyheymomodraws
