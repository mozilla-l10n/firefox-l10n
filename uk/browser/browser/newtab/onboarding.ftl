...
# browser.
onboarding-mobile-phone-button = Завантажити мобільний { -brand-short-name }
onboarding-send-tabs-title = Миттєво пересилайте собі вкладки
# "Send Tabs" refers to "Send Tab to Device" feature that appears when opening a
# tab's context menu.
onboarding-send-tabs-text = Надсилання вкладки миттєво пересилає вебсторінки між вашими пристроями без копіювання посилань, не покидаючи { -brand-short-name }.
# "Send Tabs" refers to "Send Tab to Device" feature that appears when opening a
# tab's context menu.
onboarding-send-tabs-text2 = Легко обмінюйтесь сторінками між своїми пристроями без копіювання посилань та не покидаючи { -brand-short-name }.
