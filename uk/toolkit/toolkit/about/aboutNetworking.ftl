...
about-networking-alt-svc-origin = Джерело
about-networking-alt-svc-alternate = Альтернатива
about-networking-alt-svc-alpn = ALPN
about-networking-alt-svc-validated = Перевірено
about-networking-alt-svc-ttl = TTL
about-networking-alt-svc-origin-attributes-suffix = Ключ ізоляції
