...
details-notification-softblocked-extension-disabled =
    .message = Це розширення порушує правила Mozilla, тому його вимкнено. Ви можете ввімкнути його, але це може бути ризиковано.
details-notification-softblocked-extension-enabled =
    .message = Це розширення порушує правила Mozilla. Користуватися ним може бути ризикованим.
details-notification-softblocked-other-disabled =
    .message = Цей додаток порушує правила Mozilla, тому його вимкнено. Ви можете ввімкнути його, але це може бути ризиковано.
details-notification-softblocked-other-enabled =
    .message = Цей додаток порушує правила Mozilla. Користуватися ним може бути ризикованим.
