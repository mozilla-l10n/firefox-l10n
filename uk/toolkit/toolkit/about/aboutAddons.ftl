...
plugins-openh264-description = Цей плагін автоматично встановлений Mozilla для взаємодії зі специфікацією WebRTC та увімкнення викликів WebRTC з пристроями, які потребують відеокодек H.264. Відвідайте https://www.openh264.org/ для перегляду програмного коду кодека та докладної інформації про його застосування.
...
mlmodel-about-inference = { -brand-short-name } використовує це на about:inference
mlmodel-link-preview = { -brand-short-name } використовує це для генерування ключових точок під час перегляду посилань
