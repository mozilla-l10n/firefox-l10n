...
experimental-features-win32k-lockdown-description = Вимкнути використання Win32k API у вкладках браузера. Забезпечує підвищення безпеки, але наразі може бути нестабільним чи проблемним. (Лише Windows)
# JS JIT Warp project
