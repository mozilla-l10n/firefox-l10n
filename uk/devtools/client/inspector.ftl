...
colorpicker-tooltip-spectrum-dragger-title = Спектр
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = Обрати колір на сторінці
...
colorpicker-tooltip-color-name-title = Найближче до: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = Відтінок
# A title text for the alpha slider in the color picker tooltip.
colorpicker-tooltip-alpha-slider-title = Прозорість
# A text for the toggle for the element-specific pseudo-classes panel.
inspector-element-specific-pseudo-classes-heading = Псевдокласи, специфічні для елемента
