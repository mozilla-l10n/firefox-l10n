...
inactive-css-no-size-containment = Властивість <strong>{ $property }</strong> не впливає на цей елемент, тому що він не має обмежень щодо розміру.
...
inactive-css-no-size-containment-fix = Спробуйте встановити для властивості <strong>display</strong> інше значення, ніж <strong>none</strong>, <strong>contents</strong>, <strong>table</strong> або <strong>inline-table </strong> і переконайтеся, що воно не знаходиться в таблиці чи сегменті ruby. { learn-more }
...
inactive-css-not-grid-or-flex-container-or-multicol-container-fix-1 = Спробуйте додати <strong>display:grid</strong>, <strong>display:flex</strong>, або <strong>columns:2</strong>.
inactive-css-not-multicol-container-fix-1 = Спробуйте додати <strong>column-count</strong> або <strong>column-width</strong>.
inactive-css-column-span-fix-1 = Спробуйте додати <strong>column-count</strong> або <strong>column-width</strong> до одного з елементів верхнього рівня.
inactive-css-not-grid-or-flex-or-absolutely-positioned-item-fix-1 = Спробуйте додати <strong>position:absolute</strong> до елемента, або <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong>, або <strong>display:inline-flex</strong> до елемента вищого рівня.
inactive-css-not-grid-or-absolutely-positioned-item-fix-1 = Спробуйте додати <strong>position:absolute</strong> до елемента, або <strong>display:grid</strong>, або <strong>display:inline-grid</strong> до елемента вищого рівня.
inactive-css-not-absolutely-positioned-item-fix-1 = Спробуйте додати <strong>position:absolute</strong> до елемента.
inactive-css-no-default-anchor-fix-1 = Спробуйте додати <strong>position-anchor</strong> з дійсною назвою якоря.
inactive-css-not-grid-or-flex-item-fix-4 = Спробуйте додати <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong>, або <strong>display:inline-flex</strong> до елемента вищого рівня.
...
inactive-text-overflow-when-no-overflow-fix-1 = Спробуйте додати <strong>overflow:hidden</strong>.
inactive-css-no-size-containment-fix-1 = Спробуйте встановити для властивості <strong>display</strong> інше значення, ніж <strong>none</strong>, <strong>contents</strong>, <strong>table</strong> або <strong>inline-table </strong> і переконайтеся, що воно не знаходиться в таблиці чи сегменті ruby.
inactive-css-not-for-internal-table-elements-fix-1 = Спробуйте встановити властивість <strong>display</strong> на щось інше, ніж <strong>table-cell</strong>, <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong>, або <strong>table-footer-group</strong>.
inactive-css-not-for-internal-table-elements-except-table-cells-fix-1 = Спробуйте встановити властивість <strong>display</strong> на щось інше, ніж <strong>table-column</strong>, <strong>table-row</strong>, <strong>table-column-group</strong>, <strong>table-row-group</strong>, або <strong>table-footer-group</strong>.
inactive-css-not-table-fix-1 = Спробуйте додати <strong>display:table</strong> або <strong>display:inline-table</strong>.
inactive-css-collapsed-table-borders-fix-1 = Спробуйте додати <strong>border-collapse:separate</strong>.
inactive-css-not-table-cell-fix-1 = Спробуйте додати <strong>display:table-cell</strong>.
inactive-scroll-padding-when-not-scroll-container-fix-1 = Спробуйте додати <strong>overflow:auto</strong>, <strong>overflow:scroll</strong>, або <strong>overflow:hidden</strong>.
inactive-css-border-image-fix-1 = На елементі таблиці вищого рівня вилучіть властивість або змініть значення для <strong>border-collapse</strong> на інше, ніж <strong>collapse</strong>.
inactive-css-resize-fix-1 = Спробуйте встановити для <strong>overflow</strong> значення, відмінне від <strong>visible</strong>, або націлити на замінений елемент, який це підтримує.
inactive-css-ruby-element-fix-1 = Спробуйте змінити <strong>font-size</strong> тексту ruby.
inactive-css-text-wrap-balance-lines-exceeded-fix-1 = Спробуйте зменшити кількість рядків.
inactive-css-text-wrap-balance-fragmented-fix-1 = Уникайте розділення вмісту елемента, наприклад, видаливши стовпчики або використавши <strong>page-break-inside:avoid</strong>.
inactive-css-no-principal-box-fix-1 = Спробуйте додати значення <strong>display</strong>, яке створює основний блок, наприклад <strong>block</strong>, <strong>inline-block</strong>, <strong>flex</strong> або <strong>grid</strong>.
