...
places-bookmarks-restore-format-error = ಬೆಂಬಲವಿರದ ಕಡತದ ಬಗೆ.
places-bookmarks-restore-parse-error = ಬ್ಯಾಕ್ಅಪ್‌ ಕಡತವನ್ನು ಸಂಸ್ಕರಿಸಲಾಗಿಲ್ಲ.
places-bookmarks-import = ಬುಕ್‌ಮಾರ್ಕುಗಳ ಕಡತವನ್ನು ಆಮದು ಮಾಡಿಕೊ
places-bookmarks-export = ಬುಕ್‌ಮಾರ್ಕುಗಳ ಕಡತವನ್ನು ರಫ್ತು ಮಾಡು
