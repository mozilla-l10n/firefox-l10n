...
search-input-box2 =
    ...
    .style = width: 15.4em
managed-notice = Veb səyyahınız təşkilatınız tərəfindən idarə olunur.
managed-notice-nav =
    .label = Veb səyyahınız təşkilatınız tərəfindən idarə olunur.
