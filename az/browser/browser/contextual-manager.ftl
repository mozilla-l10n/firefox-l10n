...
contextual-manager-passwords-command-settings = Tənzimləmələr
...
contextual-manager-passwords-remove-login-card-cancel-button = Ləğv et
...
contextual-manager-primary-password-reauth-button = Baş parolu daxil edin
