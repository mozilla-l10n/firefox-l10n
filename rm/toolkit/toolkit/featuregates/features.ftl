...
experimental-features-web-gpu =
    .label = WebGPU
experimental-features-web-gpu-description = API experimentala per visualisaziuns graficas e calculaziuns en il web
# The title of the experiment should be kept in English as it may be referenced
# by various online articles and is technical in nature.
experimental-features-avif =
    .label = AVIF
experimental-features-avif-description = Sustegn experimental per AVIF: Format per datotecas da maletg AV1
# The title of the experiment should be kept in English as it may be referenced
# by various online articles and is technical in nature.
