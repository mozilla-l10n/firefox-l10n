...
default-browser-prompt-message-pin-msix = Plazzescha { -brand-short-name } uschia ch’il navigatur è adina per mauns – al definescha sco navigatur da standard ed al fixescha en tia taskbar ed en il menu Start.
...
default-browser-prompt-button-primary-set = Definir sco navigatur principal
