...
protocolhandler-mailto-os-handler-notificationbox = Adina utilisar { -brand-short-name } per avrir colliaziuns che tramettan e-mails?
protocolhandler-mailto-os-handler-yes-confirm = { -brand-short-name } è ussa tia applicaziun predefinida per avrir colliaziuns che tramettan e-mails.
protocolhandler-mailto-os-handler-yes-button = Definir sco standard
protocolhandler-mailto-os-handler-no-button = Betg ussa
...
protocolhandler-mailto-handler-yes-button = Definir sco standard
protocolhandler-mailto-handler-no-button = Betg ussa
