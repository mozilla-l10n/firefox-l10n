...
contextual-manager-passwords-origin-field =
    .label = Adressa da la website
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Endatescha l’adressa exacta per s’annunziar en questa website.
contextual-manager-passwords-username-field =
    .label = Num d'utilisader
contextual-manager-passwords-username-field-description = Endatescha il num d’utilisader, l’adressa dad e-mail u il numer dal conto che ti utiliseschas per s’annunziar.
contextual-manager-passwords-password-field =
    .label = Pled-clav
contextual-manager-passwords-password-field-description = Endatescha il pled-clav per s’annunziar cun quest conto.
