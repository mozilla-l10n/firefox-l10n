...
helpus-referrals2 = Vuls ti gidar? <label data-l10n-name="helpus-donateLink">Fa ina donaziun</label>, <label data-l10n-name="helpus-shareFirefoxLink">parta { -brand-product-name }</label> u <label data-l10n-name="helpus-getInvolvedLink">ta participescha!</label>
