...
plugins-openh264-description = इस प्लगइन मोज़िला WebRTC विनिर्देशन के साथ अनुपालन करने के लिए और h.264 वीडियो कोडेक की आवश्यकता है कि उपकरणों के साथ WebRTC कॉल को सक्षम करने के लिए द्वारा स्वचालित रूप से स्थापित है। कोडेक स्रोत कोड को देखने और कार्यान्वयन के बारे में अधिक जानने के लिए एक https://www.openh264.org/ पर जाएँ।
