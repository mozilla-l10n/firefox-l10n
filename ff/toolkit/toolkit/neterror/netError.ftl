...
neterror-generic-error = { -brand-short-name } horiima loowde ngoo hello.
neterror-load-error-try-again = Ndee lowre ena waawi tawo heɓotaako walla ko nde haljunde. Eto kadi ɗoo e ɓooyde.
neterror-load-error-connection = So a horiima loowde hay so hello, ƴeewto laylaytol ordinateer maa so ena seŋii.
...
neterror-file-not-found-moved = Ƴeewto ngam so fiilde ndee dirtinaaka, innitaaka walla momtaaka.
...
neterror-net-offline = Ñoƴƴu “Fuɗɗito” ngam faytude e mbayka ceŋol kesɗitinaa hello ngoo.
neterror-proxy-resolve-failure-settings = Ƴeewto teelte proxy ɗee ngam yuurnitaade so eɗe peewi.
neterror-proxy-resolve-failure-connection = Ƴeewto so tawii ordinateer maa ena jogii seŋorde moƴƴere.
neterror-proxy-resolve-failure-firewall = So tawii ordinateer walla laylaytol maa koko suraa caggal ɓalal-jaynge, yuurno so { -brand-short-name } ena yamiraa naatde e geese.
neterror-proxy-connect-failure-settings = Ƴeewto teelte proxy ɗee ngam yuurnitaade so eɗe peewi.
neterror-proxy-connect-failure-contact-admin = Jokkondir e jiiloowo laylaytol maa ngam ƴeewde so sarworde proxy ndee ena moƴƴi.
neterror-content-encoding-error = Tiiɗno jokkondir e jeyɓe lowre ndee ngam humpitde-ɓe ɗee caɗeele.
...
neterror-sslv3-used = Humpito ceeɓtoto: SSL_ERROR_UNSUPPORTED_VERSION
# Variables:
# $hostname (String) - Hostname of the website to which the user was trying to connect.
...
fp-neterror-denied-port-access = Ndee ñiiɓirde huutortoo ko poor laylaytol potɗo huutoreede e goɗɗum ko wonaa wanngaade e geese. { -brand-short-name } haaytii jaɓde ɗaɓɓannde ndee ngam kisal maa.
