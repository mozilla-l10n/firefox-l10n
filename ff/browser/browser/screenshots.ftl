...
screenshots-login-error-details = Min mbaawaa daɗndude natal maa sibu saɗeende heɓtiinde sarwiis nattagol yaynirde mo Firefox. Ennditoy ɗoo e ɓooyde.
...
screenshots-self-screenshot-error-title = A waawaa nattoraade yaynirde Firefox ngoo hello!
screenshots-empty-selection-error-title = Ko cuɓi-ɗaa koo ine famɗi no feewi
screenshots-private-window-error-title = Nattal yaynirde ko ko daaƴaa e Fannu Banngagol sutura
screenshots-private-window-error-details = Ay haame e saɗeende ndee. E min ngolloo e gollorgel wonande jame paaɗe.
screenshots-generic-error-title = Natte yaynirde Firefox ko paanɗe.
