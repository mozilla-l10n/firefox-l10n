...
pane-privacy-title2 = Suturo & Kisal
...
applications-setting =
    .label = Jaaɓnirɗe
    .description = Suɓo no { -brand-short-name } waɗdata e piille ɗe ngaawtoto-ɗaa e geese walla jaaɓnirɗe ɗe kuutorto-ɗaa tuma banngagol maa.
