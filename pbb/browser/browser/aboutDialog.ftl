...
settings-update-checking-for-updates =
    .label = Yu'pthewa'ja's pakwesawe'sx…
...
settings-update-downloading-2 =
    .label = Pheu'nxisa's spahtxna ũ'sa—{ $transfer }

##

update-applying = Pheu'nxisa's txi'na ũ'sa…
settings-update-applying =
    .label = Pheu'nxisa's txi'na ũ'sa…
...
settings-update-no-updates-found =
    .label = { -brand-short-name } nãa pheu'nxinxaja
update-otherInstanceHandlingUpdates = { -brand-short-name } txãa pheujna ũ'sa vxitenxa'k
settings-update-other-instance-handling-updates =
    .label = { -brand-short-name } txãa pheujna ũ'sa vxitenxa'k
...
settings-update-unsupported = Ewumeg khukya vxite pheu'nxisa'tx nãa vxisnxite.<a data-l10n-name="unsupported-link">Wejx jisa</a>
