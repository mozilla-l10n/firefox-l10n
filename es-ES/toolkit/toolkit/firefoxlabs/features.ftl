...
experimental-features-newtab-widget-lists-new =
    .label = Listas
experimental-features-newtab-widget-lists-description = Mantenga presente su lista de tareas pendientes al abrir una nueva pestaña. Desde listas de compras hasta listas para preparar el equipaje, haga sus planes en { -brand-product-name }. <a data-l10n-name="connect">Enviar comentarios</a>
# Timer Widget
...
experimental-features-tab-context-menu-description = Un menú contextual más simple al hacer clic con el botón derecho en una pestaña. Está diseñado para que las acciones comunes sean más fáciles de encontrar. <a data-l10n-name="connect">Compartir comentarios</a>
