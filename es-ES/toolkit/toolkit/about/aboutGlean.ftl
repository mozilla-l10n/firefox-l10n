...
about-glean-metrics-table-settings-histograms-box-padding = Márgen de la caja
...
about-glean-metrics-table-settings-timelines-width = Anchura
...
about-glean-enable-new-features-button = Activar nuevas funciones
