...
details-notification-softblocked-extension-disabled =
    .message = Esta extensión viola las políticas de Mozilla y ha sido desactivada. Se puede activar, pero podría ser arriesgado.
...
details-notification-softblocked-other-disabled =
    .message = Este complemento viola las políticas de Mozilla y ha sido desactivado. Se puede activar, pero podría ser arriesgado.
