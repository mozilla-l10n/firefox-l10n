...
plugins-openh264-description = Este plugin se ha instalado automáticamente por Mozilla para cumplir con la especificación WebRTC y para permitir llamadas WebRTC con dispositivos que requieren el códec de vídeo H.264. Visite https://www.openh264.org/ para ver el código fuente del códec y saber más sobre la implementación.
