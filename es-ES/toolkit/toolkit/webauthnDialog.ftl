...
webauthn-related-origin-create-header = { $origin } quiere crear una clave de acceso para { $rpId }.
# Variables:
#   $origin (String): the domain of the site making the request
#   $rpId (String): the related domain the passkey is associated with
webauthn-related-origin-use-header = { $origin } quiere usar una clave de acceso para { $rpId }.
