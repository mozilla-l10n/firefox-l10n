...
btp-warning-tracker-classified =
    { $gracePeriodSeconds ->
        [one] “{ $siteHost }” ha sido clasificado como un bounce tracker. Si no recibe la activación del usuario en el próximo segundo, se eliminará su estado.
...
btp-warning-tracker-purged = El estado de “{ $siteHost }” se ha purgado recientemente porque se detectó como un "bounce tracker"
