...
delete-ca-cert-title =
    .title = Eliminar o dejar de confiar en certificados CA
...
add-exception-domain-mismatch-long = El certificado pertenece a un sitio diferente, lo que podría significar que alguien está intentando hacerse pasar por este sitio.
add-exception-expired-short = Información obsoleta
add-exception-expired-long = El certificado no es actualmente válido. Puede haber sido robado o perdido, y podría estar siendo usado por alguien para hacerse pasar por este sitio.
