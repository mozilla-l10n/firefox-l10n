...
pane-privacy-title2 = Privacidad & Seguridad
...
default-font-2 =
    .label = Tipografía predeterminada
    .accesskey = T
default-font-size-2 =
    .label = Tamaño
    .accesskey = m
...
applications-setting =
    .label = Aplicaciones
    .description = Elija cómo gestiona { -brand-short-name } los archivos que usted descarga de la web o las aplicaciones que usa mientras navega.
