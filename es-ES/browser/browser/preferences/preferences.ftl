...
containers-new-tab-check2 =
    .description = Esto abrirá el menú de contenedores cada vez que presione el botón de abrir nueva pestaña.
...
containers-sites-card-header =
    .description = Elia un contenedor para un sitio y { -brand-short-name } lo utilizará cada vez que se abra el sitio.
...
appearance-window-density-group =
    .description = Ajusta el espacio alrededor de los elementos de la ventana tales como barras de herramientas, pestañas y barra lateral.
