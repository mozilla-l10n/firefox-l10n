...
contextual-manager-passwords-username-field-description = Introduca el nombre de usuario, dirección de correo electrónico o número de cuenta que usa para iniciar sesión.
