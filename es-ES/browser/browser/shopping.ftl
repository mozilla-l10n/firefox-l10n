...
shopping-settings-recommendations-learn-more3 = { -brand-product-name } no comparte datos personales, por lo que estas recomendaciones no le seguirán en Internet. <a data-l10n-name="review-quality-url">Saber más</a>
...
shopping-survey-opted-out-multiselect-label = Por favor, indíquenos por qué desactivó el verificador de reseñas. Seleccione varias opciones si es necesario.
shopping-survey-thanks-title = ¡Gracias por su opinión!
...
shopping-survey-opted-out-check-myself = Prefiero comprobar las reseñas yo mismo
...
#   $secondSite (String) - The second shopping page name
#   $thirdSite (String) - The third shopping page name
shopping-opt-in-integrated-subtitle = Active el Verificador de reseñas de { -brand-product-name } para ver la fiabilidad de las reseñas de un producto antes de comprarlo. Usa tecnología de IA para analizar las revisiones y funciona al comprar en { $firstSite }, { $secondSite } y { $thirdSite }. <a data-l10n-name="learn_more">Saber más</a>
# Description text for regions where we support three sites. Sites are limited to Amazon, Walmart and Best Buy.
# Variables:
#   $firstSite (String) - The first shopping page name
#   $secondSite (String) - The second shopping page name
#   $thirdSite (String) - The third shopping page name
shopping-opt-in-integrated-subtitle-unsupported-site = El verificador de reseñas de { -brand-product-name } ayuda a conocer la fiabilidad de reseñas de un producto antes de comprarlo. Usa tecnología de IA para analizar las revisiones y funciona al comprar en { $firstSite }, { $secondSite } y { $thirdSite }. <a data-l10n-name="learn_more">Conocer más</a>

## Messages for callout for users not opted into the sidebar integrated version of Review Checker.

shopping-callout-opt-in-integrated-headline = ¿Se puede confiar en estas reseñas?
# Appears underneath shopping-opt-in-integrated-headline to answer the question 'Can you trust these reviews?'
shopping-callout-not-opted-in-integrated-paragraph1 = Active el verificador de reseñas desde { -brand-product-name } para averiguarlo. Funciona con tecnología de { -fakespot-brand-full-name } y usa tecnología de IA para analizar las revisiones.
