...
screenshots-request-error-details = ¡Lo sentimos! No hemos podido guardar su captura. Inténtelo más tarde.
screenshots-connection-error-title = No podemos acceder a sus capturas de pantalla.
...
screenshots-login-error-details = No se pudo guardar la captura porque hay un problema con el servicio { -screenshots-brand-name }. Inténtelo más tarde.
...
screenshots-empty-selection-error-title = Su selección es demasiado pequeña
...
screenshots-generic-error-details = No estamos seguros de lo que acaba de pasar. ¿Le importaría volver a intentarlo o hacer una captura de otra página?
