...
profiler-popup-presets-power-label =
    .label = Energía
profiler-popup-presets-debug-description = Preestablecido para depuración en { -brand-shorter-name }. Alta sobrecarga, debe usarse para comprender el comportamiento del navegador y no para mejoras de rendimiento.
