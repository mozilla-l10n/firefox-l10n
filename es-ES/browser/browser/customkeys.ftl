...
customkeys-title = Atajos de teclado
customkeys-search = Buscar:
customkeys-change = Cambiar
customkeys-reset = Restablecer
customkeys-clear = Limpiar
customkeys-new-key = Pulse la nueva tecla:
customkeys-reset-all = Restablecer todos los atajos a sus valores predeterminados
# Variables
...
customkeys-dev-tools = Herramientas para desarrolladores web
customkeys-dev-inspector = Inspector de DOM y estilos
customkeys-dev-webconsole = Consola web
customkeys-dev-debugger = Depurador de JavaScript
...
customkeys-nav-toggle-mute = Activar/Desactivar el audio
customkeys-edit-find-previous = Buscar anterior
customkeys-tools-screenshot = Hacer una captura de pantalla
customkeys-category-navigation-2 =
    .heading = Área de navegación
