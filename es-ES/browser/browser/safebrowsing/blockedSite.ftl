...
safeb-blocked-malware-page-short-desc = { -brand-short-name } ha bloqueado esta página porque puede intentar instalar software malicioso que puede robar o eliminar información personal en su equipo.
...
safeb-blocked-addon-page-learn-more3 = <a data-l10n-name='firefox_support_harmful_addons'>Saber más sobre la protección contra complementos dañinos de { -brand-short-name }</a>.
