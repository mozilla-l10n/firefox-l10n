...
ipprotection-feature-introduction-link-text-privacy-2 = La VPN integrada de <a data-l10n-name="learn-more-vpn">{ -brand-product-name }</a> ayuda a proteger su navegación. Elija entre múltiples ubicaciones para mantener su navegación más privada.
ipprotection-feature-introduction-link-text-privacy-3 = Obtenga <a data-l10n-name="learn-more-vpn">privacidad adicional</a> eligiendo entre múltiples ubicaciones para ocultar desde dónde navega.
...
ipprotection-feature-introduction-title-summer-promo = ¿Tiene planes de viaje? Lleve su privacidad consigo.
...
ipprotection-summer-promo-offramp-subscriber-title = Su VPN integrada ahora es mejor
...
ipprotection-android-promo-callout-title = Lleve consigo la VPN integrada en Android
ipprotection-android-promo-callout-description = Escanee el código QR para obtener { -brand-product-name } para Android y active la VPN integrada para tener más privacidad en cualquier lugar. Próximamente en iOS.
...
unauthenticated-site-rules-message = Controlar qué sitios web usan VPN y cuáles no.
...
site-rules-description-exclusion = La VPN está desactivada para este sitio
# Used in the panel when a user navigates to a site where the VPN is on due to a site inclusion
site-rules-description-inclusion = La VPN está activada para este sitio
...
ipprotection-locations-unavailable-label-1 = No disponible
    .aria-label = No disponible, desactivado
# Label shown next to a VPN location that the user cannot select.
...
ipprotection-connection-status-blocked-error-description-1 = Las leyes y restricciones locales limitan dónde se puede usar la VPN. <a data-l10n-name="learn-more-link">Saber más</a>
...
ip-protection-site-rules-button =
    .description = Establecer reglas para los sitios que requieren mayor privacidad o en los que la VPN debe estar desactivada.
