...
<html>
  <head>
    <title>Datos de rendimiento JavaScript</title>
  </head>
  <style>
    .profile-file-title {
        font-size  : larger;
  ...
  <body>
    <h1>Datos de rendimiento JavaScript</h1>
    <span class="label">Fecha de recogida de datos:</span>
    <span class="value">$full-date</span><br>
    <span class="label">User Agent:</span>
    <span class="value">$user-agent</span><br>
    <span class="label">Versi&oacute;n del depurador JavaScript:</span>
...
@-range-start
      <span class="range-box">
        ...
        [ <a href="#section$section-number-prev">Archivo anterior</a> |
        <a href="#section$section-number-next">Archivo siguiente</a> |
        <a href="#range$section-number:$range-number-prev">Rango anterior</a> |
        <a href="#range$section-number:$range-number-next">Rango siguiente</a> ]
@-item-start
...
@-section-end
    <hr>
    <a href="http://www.mozilla.org/projects/venkman/">No hay trabajo demasiado grande, ni recompensa demasiado grande.</a>
  </body>
</html>
