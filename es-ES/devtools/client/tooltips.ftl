...
inactive-css-not-block-container = <strong>{ $property } </strong> no tiene efecto en este elemento porque solo se aplica a elementos contenedores de tipo block.
inactive-css-not-block-flex-grid-container = <strong>{ $property } </strong> no tiene efecto en este elemento porque solo se aplica a elementos contenedores de tipo block, flex y grid.
...
inactive-css-not-absolutely-positioned-item-fix = Pruebe a añadir <strong>position:absolute</strong> al elemento. { learn-more }
inactive-css-no-default-anchor-fix = Pruebe a añadir <strong>position-anchor</strong> con un nombre válido de ancla. { learn-more }
...
inactive-css-not-block-container-fix = Intente añadir <strong>display:block</strong>, <strong>display:inline-block</strong> o <strong>display:flow-root</strong>. { learn-more }
inactive-css-not-block-flex-grid-container-fix = Intente añadir <strong>display:block</strong>, <strong>display:inline-block</strong>, <strong>display:flex</strong>, <strong>display:inline-flex</strong>, <strong>display:grid</strong>, <strong>display:inline-grid</strong> o <strong>display:flow-root</strong>. { learn-more }
inactive-css-not-floated-fix = Pruebe añadir la propiedad <strong>float</strong> con un valor distinto de <strong>none</strong>. { learn-more }
...
inactive-css-not-grid-or-flex-or-absolutely-positioned-item-fix-1 = Pruebe a añadir <strong>position:absolute</strong> al elemento, o <strong>display:grid</strong>, <strong>display:flex</strong>, <strong>display:inline-grid</strong> o <strong>display:inline-flex</strong> al padre del elemento.
inactive-css-not-grid-or-absolutely-positioned-item-fix-1 = Intente añadir <strong>position:absolute</strong> al elemento, o <strong>display:grid</strong> o <strong>display:inline-grid</strong> al padre del elemento.
inactive-css-not-absolutely-positioned-item-fix-1 = Pruebe a añadir <strong>position:absolute</strong> al elemento.
inactive-css-no-default-anchor-fix-1 = Pruebe a añadir <strong>position-anchor</strong> con un nombre válido de ancla.
...
inactive-css-not-floated-fix-1 = Pruebe añadir la propiedad <strong>float</strong> con un valor distinto de <strong>none</strong>.
...
css-selector-warning-sibling-combinator-after-scope = Los selectores hermanos después de <strong>:scope</strong> nunca coincidirán con nada
