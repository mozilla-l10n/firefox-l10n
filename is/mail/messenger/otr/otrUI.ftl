...
verify-title = Staðfestu auðkenni tengiliðar þíns
error-title = Villa
success-title = Enda-í-enda dulritun
success-them-title = Staðfestu auðkenni tengiliðar þíns
fail-title = Ekki hægt að staðfesta
waiting-title = Staðfestingarbeiðni send
# Do not translate 'OTR' (name of an encryption protocol)
# Variables:
