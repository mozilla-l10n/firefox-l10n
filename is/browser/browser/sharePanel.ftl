...
urlbar-share-button =
    .aria-label = Deila þessari síðu
    .tooltiptext = Deila þessari síðu
share-panel-heading = Deila síðu
...
confirmation-hint-link-copied = Tengill afritaður
