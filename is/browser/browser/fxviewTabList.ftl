...
fxviewtabrow-move-tab-window = Færa yfir í nýjan glugga
    .accesskey = g
fxviewtabrow-send-to-device = Senda til tækis
    .accesskey = n
fxviewtabrow-send-to-mobile = Senda í farsíma
    .accesskey = n
...
fxviewtabrow-send-to-mobile-connect-device = Tengdu tæki til að senda flipa
fxviewtabrow-send-to-mobile-device-missing2 = Sérðu ekki tækið þitt?
fxviewtabrow-send-to-mobile-not-verified = Reikningur er ekki staðfestur
fxviewtabrow-send-to-mobile-verify-account = Staðfestu reikninginn þinn
fxviewtabrow-send-to-mobile-sign-in = Skráðu þig inn til að senda flipa
fxviewtabrow-send-to-mobile-turn-on-sync = Kveiktu á samstillingu til að senda flipa
