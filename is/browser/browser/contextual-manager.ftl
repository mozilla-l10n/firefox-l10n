...
contextual-manager-passwords-origin-field =
    .label = Vistfang vefsvæðis
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Sláðu inn nákvæma vistfangið þar sem þú skráir þig inn á þessa síðu.
contextual-manager-passwords-username-field =
    .label = Notandanafn
contextual-manager-passwords-username-field-description = Settu inn notandanafn, tölvupóstfang eða númer reikningsins sem þú notar til að skrá þig inn.
contextual-manager-passwords-password-field =
    .label = Lykilorð
contextual-manager-passwords-password-field-description = Settu inn lykilorðið sem notað er til að skrá þig inn á þennan reikning.
