...
main-context-menu-open-link-split-view =
    .label = Opna tengil í klofinni sýn
    .accesskey = O
...
main-context-menu-send-to-mobile-2 =
    .label = Senda í farsíma
    .accesskey = n
main-context-menu-send-to-mobile-sign-in = Skráðu þig inn til að senda flipa
main-context-menu-send-to-mobile-enable-sync2 = Virkjaðu samstillingu til að senda flipa
main-context-menu-send-to-mobile-connect-phone2 = Tengdu símann þinn
main-context-menu-send-to-mobile-device-missing2 = Sérðu ekki tækið þitt?
main-context-menu-send-to-mobile-sign-in-from-link = Skráðu þig inn til að senda tengil
main-context-menu-send-to-mobile-sign-in-from-page = Skráðu þig inn til að senda síðu
main-context-menu-send-to-mobile-enable-sync3 = Kveiktu á samstillingu til að senda flipa
main-context-menu-send-to-mobile-enable-sync-from-link = Kveiktu á samstillingu til að senda tengil
main-context-menu-send-to-mobile-enable-sync-from-page = Kveiktu á samstillingu til að senda síðu
main-context-menu-send-to-mobile-connect-phone3 = Tengdu tæki til að senda flipa
main-context-menu-send-to-mobile-connect-phone-from-link = Tengdu tæki til að senda tengil
main-context-menu-send-to-mobile-connect-phone-from-page = Tengdu tæki til að senda síðu
...
main-context-menu-new-feature-badge = Nýtt
