...
appmenu-update-manual =
    .label = Ekki er hægt að uppfæra { -brand-shorter-name } í nýjustu útgáfu.
...
appmenu-update-unsupported =
    .label = { -brand-shorter-name } er ekki hægt að uppfæra í nýjustu útgáfu.
...
appmenu-homepage-controlled =
    .label = Heimasíða þín hefur breyst.
    .buttonlabel = Halda breytingum
    .buttonaccesskey = H
    .secondarybuttonlabel = Slökkva á viðbót
