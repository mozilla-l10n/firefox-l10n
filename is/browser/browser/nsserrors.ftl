...
ssl-error-no-cypher-overlap = Get ekki átt örugg samskipti við jafningja: engin sameiginleg dulritunaralgrím.
...
ssl-error-encryption-failure = Dulritunaralgrím magnkóðunar bilaði fyrir valið dulkóðunarkerfi.
ssl-error-decryption-failure = Dulritunaralgrím magnafkóðunar bilaði fyrir valið dulkóðunarkerfi.
...
ssl-error-no-server-key-for-alg = Netþjónn er ekki með neinn lykil fyrir það algrími lyklaskipta sem reynt var að nota.
...
ssl-error-no-compression-overlap = Get ekki átt örugg samskipti við jafningja: engin þjöppunaralgrím eru sameiginleg.
...
ssl-error-incorrect-signature-algorithm = Rangt undirritunaralgrím var skilgreint í rafrænt undirrituðu einindi.
...
ssl-error-no-supported-signature-algorithm = Ekkert stutt TLS undirskriftaralgrím var skilgreint.
ssl-error-unsupported-signature-algorithm = Jafningi notaði óþekkta samsetningu af undirritun og tætialgrími.
...
sec-error-cert-signature-algorithm-disabled = Skilríkið var undirritað með undirritunaralgrími sem er óvirkt vegna þess að það er ekki öruggt.
...
mozilla-pkix-error-signature-algorithm-mismatch = Undirritunaralgrímið í undirritunarsvæðinu á skilríkinu samsvarar ekki algríminu í signatureAlgorithm reitnum.
