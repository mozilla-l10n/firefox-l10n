...
protocolhandler-mailto-os-handler-notificationbox = Á alltaf að nota { -brand-short-name } til að opna tengla sem senda tölvupóst?
protocolhandler-mailto-os-handler-yes-confirm = { -brand-short-name } er nú sjálfgefið forrit til að opna tengla sem senda tölvupóst.
protocolhandler-mailto-os-handler-yes-button = Setja sem sjálfgefið
protocolhandler-mailto-os-handler-no-button = Ekki núna
...
protocolhandler-mailto-handler-yes-button = Setja sem sjálfgefið
protocolhandler-mailto-handler-no-button = Ekki núna
