...
onboarding-live-language-subtitle = { -brand-short-name } er að nota { $appLanguage } á meðan stýrikerfið þitt er að nota { $systemLanguage }.
onboarding-live-language-switch-button-label = Skipta yfir í { $negotiatedLanguage }
onboarding-live-language-button-label-downloading = Sæki tungumálapakkann fyrir { $negotiatedLanguage }...
onboarding-live-language-waiting-subtitle = Það lítur út fyrir að stýrikerfið þitt og { -brand-short-name } séu að nota mismunandi tungumál.
...
onboarding-live-language-not-now-button-label = Ekki núna
