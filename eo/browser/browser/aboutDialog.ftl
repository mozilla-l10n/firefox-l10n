...
helpus-referrals2 = Ĉu vi volas helpi? <label data-l10n-name="helpus-donateLink">Donacu</label>, <label data-l10n-name="helpus-shareFirefoxLink">diskonigu { -brand-product-name }</label>, aŭ <label data-l10n-name="helpus-getInvolvedLink">partoprenu!</label>
