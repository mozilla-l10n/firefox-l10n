...
upgrade-dialog-new-alt-subtitle = Unue metu <span data-l10n-name="zap">{ -brand-short-name }</span> je unu alklako
...
upgrade-dialog-new-primary-primary-button = Igi { -brand-short-name } mia ĉefa retumilo
    .title = Difini { -brand-short-name } kiel ĉefa retumilo kaj alpingli ĝin al la taska ilaro
upgrade-dialog-new-primary-default-button = Igi { -brand-short-name } mia ĉefa retumilo
upgrade-dialog-new-primary-pin-button = Alpingli { -brand-short-name } al mia taska ilaro
upgrade-dialog-new-primary-pin-alt-button = Alpingli al la taska ilaro
