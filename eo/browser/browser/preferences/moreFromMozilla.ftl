...
more-from-moz-firefox-mobile-description-advanced = Ĉu por bloki spurilojn, ĉu por eviti la ĝenon de aŭtomata ludado, la poŝaparataj retumiloj de { -brand-product-name } laboras senhalte por certi ke vi aliras la bonan interreton.
more-from-moz-mozilla-vpn-title = { -mozilla-vpn-brand-name }
more-from-moz-mozilla-vpn-description = Malkovru aldonan tavolon de protekto kaj anonima retumo.
more-from-moz-mozilla-vpn-description-advanced = { -mozilla-vpn-brand-name } aldonas alian tavolon de protekto kaj anonima retumo. Kaj, malkiel aliaj VPN, ĝi estas sekura kaj ne spuras vian retumon.
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-title = { -rally-brand-name }
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-description = Igu viajn datumojn labori por pli bona interreto por ĉiuj.
# This string is specific to the product Mozilla Rally which is US only.
