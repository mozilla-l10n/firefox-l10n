...
contextual-manager-passwords-origin-field =
    .label = Adreso de retejo
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Tajpu la ekzaktan adreson, kie vi komencos seancon en tiu ĉi retejo.
contextual-manager-passwords-username-field =
    .label = Nomo de uzanto
contextual-manager-passwords-username-field-description = Tajpu la nomon de uzanto, retpoŝtan adreson, aŭ numeron de konto, kiun vi uzos por komenci seancon.
contextual-manager-passwords-password-field =
    .label = Pasvorto
contextual-manager-passwords-password-field-description = Tajpu la pasvorton por komenci seancon per tiu ĉi konto.
