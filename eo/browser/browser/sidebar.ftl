...
sidebar-open-tools-from-sidebar =
    .label = Malfermi ilojn el la flanka strio
...
sidebar-opentabs-preview-heading = Ĵusaj langetoj
...
sidebar-opentabs-title = Malfermitaj langetoj
