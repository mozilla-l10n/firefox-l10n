...
newtab-menu-add-topsite = Aldoni novan ŝparvojon
...
newtab-clock-city-us-san-francisco = San-Francisko
newtab-clock-city-us-san-diego = San-Diego
newtab-clock-city-us-dallas = Dallas
newtab-clock-city-us-houston = Hustono
newtab-clock-city-us-philadelphia = Filadelfio
newtab-clock-city-us-atlanta = Atlanta
newtab-clock-city-us-washington-dc = Vaŝingtono
newtab-clock-city-us-boston = Bostono
newtab-clock-city-us-miami = Miamo
newtab-clock-city-us-seattle = Seattle
newtab-clock-city-us-denver = Denvero
newtab-clock-city-us-honolulu = Honoluluo
newtab-clock-city-us-anchorage = Anchorage
newtab-clock-city-de-berlin = Berlino
newtab-clock-city-de-munich = Munkeno
newtab-clock-city-de-frankfurt = Frankfurto ĉe Majno
newtab-clock-city-de-hamburg = Hamburgo
newtab-clock-city-fr-paris = Parizo
newtab-clock-city-fr-lyon = Liono
newtab-clock-city-fr-marseille = Marsejlo
newtab-clock-city-fr-toulouse = Tuluzo
newtab-clock-city-in-kolkata = Kolkato
newtab-clock-city-in-mumbai = Mumbajo
newtab-clock-city-in-delhi = Delhio
newtab-clock-city-in-bangalore = Bengaluro
newtab-clock-city-cn-shanghai = Ŝanhajo
newtab-clock-city-cn-beijing = Pekino
newtab-clock-city-cn-shenzhen = Ŝenĵeno
newtab-clock-city-br-sao-paulo = San-Paŭlo
newtab-clock-city-br-rio-de-janeiro = Rio-de-Ĵanejro
newtab-clock-city-br-brasilia = Braziljo
newtab-clock-city-id-jakarta = Ĝakarto
newtab-clock-city-id-surabaya = Surabajo
newtab-clock-city-id-makassar = Makassar
newtab-clock-city-ca-toronto = Toronto
newtab-clock-city-ca-montreal = Montrealo
newtab-clock-city-ca-vancouver = Vankuvero
newtab-clock-city-au-sydney = Sidnejo
newtab-clock-city-au-perth = Perto
newtab-clock-city-au-adelaide = Adelajdo
newtab-clock-city-pl-warsaw = Varsovio
newtab-clock-city-pl-krakow = Krakovo
newtab-clock-city-jp-tokyo = Tokio
newtab-clock-city-jp-osaka = Osako
newtab-clock-city-mx-mexico-city = Meksikurbo
newtab-clock-city-mx-guadalajara = Gvadalaharo
newtab-clock-city-it-rome = Romo
newtab-clock-city-it-milan = Milano
newtab-clock-city-ru-moscow = Moskvo
newtab-clock-city-ru-saint-petersburg = Sankt-Peterburgo
newtab-clock-city-gb-london = Londono
newtab-clock-city-gb-birmingham = Birmingham
newtab-clock-city-es-madrid = Madrido
newtab-clock-city-es-barcelona = Barcelono
newtab-clock-city-nl-amsterdam = Amsterdamo
newtab-clock-city-ch-zurich = Zuriko
newtab-clock-city-at-vienna = Vieno
newtab-clock-city-cz-prague = Prago
newtab-clock-city-ar-buenos-aires = Bonaero
newtab-clock-city-gr-athens = Ateno
newtab-clock-city-hu-budapest = Budapeŝto
newtab-clock-city-be-brussels = Bruselo
newtab-clock-city-ua-kyiv = Kievo
newtab-clock-city-fi-helsinki = Helsinko
newtab-clock-city-co-bogota = Bogoto
newtab-clock-city-ph-manila = Manilo
newtab-clock-city-tr-istanbul = Istanbulo
newtab-clock-city-my-kuala-lumpur = Kuala-Lumpuro
newtab-clock-city-eg-cairo = Kairo
newtab-clock-city-se-stockholm = Stokholmo
newtab-clock-city-ro-bucharest = Bukareŝto
newtab-clock-city-th-bangkok = Bankoko
newtab-clock-city-ng-lagos = Lagoso
newtab-clock-city-tw-taipei = Tajpeo
newtab-clock-city-za-johannesburg = Johanesburgo
newtab-clock-city-cl-santiago = Santiago
newtab-clock-city-pk-karachi = Karaĉio
newtab-clock-city-bg-sofia = Sofio
newtab-clock-city-sg-singapore = Singapuro
newtab-clock-city-hk-hong-kong = Honkongo
newtab-clock-city-sa-riyadh = Riado
newtab-clock-city-dk-copenhagen = Kopenhago
newtab-clock-city-pe-lima = Limo
newtab-clock-city-ke-nairobi = Najrobio
newtab-clock-city-nz-auckland = Aŭklando
newtab-clock-city-kr-seoul = Seulo
newtab-clock-city-lt-vilnius = Vilno
newtab-clock-city-ie-dublin = Dublino
newtab-clock-city-ae-dubai = Dubajo
newtab-clock-city-lv-riga = Rigo
newtab-clock-city-pt-lisbon = Lisbono
newtab-clock-city-ir-tehran = Teherano
newtab-clock-city-bd-dhaka = Dako
newtab-clock-city-ec-guayaquil = Guajakilo
