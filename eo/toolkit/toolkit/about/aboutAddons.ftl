...
extensions-warning-imported-addons2 =
    .message = Bonvolu fini la instalon de etendaĵoj, kiuj estis importitaj en { -brand-short-name }.
...
plugins-openh264-description = Tiu ĉi kromprogramo estas aŭtomate instalita de Mozilla por esti konforma kun la specifoj de WebRTC kaj por ebligi vokojn WebRTC kun aparatoj kiuj postulas la videan kodekon H.264. Vizitu https://www.openh264.org/ por vidi la fontan kodon de la kodeko kaj por havi pli da informo pri la aplikado.
