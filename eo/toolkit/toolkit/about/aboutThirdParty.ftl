...
third-party-requires-restart = Por ŝanĝi la blokitajn modulojn de aliaj, { -brand-short-name } devas esti restartigita.
third-party-should-restart-title = Restartigi { -brand-short-name }
third-party-should-restart-ok = Restartigi { -brand-short-name } nun
