...
neterror-search-cta-title = Ne eblas aliri la retejon
...
neterror-search-cta-hint-search = Serĉu la retejon en la reto
...
neterror-search-cta-hint-search-query = Serĉu <strong>“{ $query }”</strong> en la reto
# .tooltiptext doubles as the button's accessible description, so it explains
# that results open in a new tab.
neterror-search-cta-search-button =
    .label = Serĉi
    .tooltiptext = Malfermi rezulton de serĉo en nova langeto
    .accesskey = S
...
neterror-search-cta-error-code = Erarkodo: { $error }
# The search CTA's own "Learn more" link text (no trailing ellipsis).
neterror-search-cta-learn-more = Pli da informo
...
neterror-dns-not-found-hint-check-network-2 = Kontrolu vian retaliron.
neterror-dns-not-found-hint-firewall-2 = Kontrolu ĉu { -brand-short-name } rajtas aliri la reton (vi eble estas konektita, sed malantaŭ retbarilo).
...
fp-neterror-offline-intro-2 = { -brand-short-name } ne povas konektiĝi al la servilo ĉe <strong>{ $hostname }</strong>.
