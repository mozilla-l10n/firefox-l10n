...
datetime-picker-label =
    .aria-label = Elekti daton kaj horon
...
time-spinner-hour-previous =
    .aria-label = Antaŭa horo
time-spinner-hour-next =
    .aria-label = Posta horo
time-spinner-minute-previous =
    .aria-label = Antaŭa minuto
time-spinner-minute-next =
    .aria-label = Posta minuto
time-spinner-second-previous =
    .aria-label = Antaŭa sekundo
time-spinner-second-next =
    .aria-label = Venonta sekundo
time-spinner-millisecond-previous =
    .aria-label = Antaŭa milisekundo
time-spinner-millisecond-next =
    .aria-label = Venonta milisekundo
time-spinner-day-period-previous =
    .aria-label = Antaŭa parto de la tago
time-spinner-day-period-next =
    .aria-label = Venonta parto de la tago
