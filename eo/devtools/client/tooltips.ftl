...
inactive-css-not-absolutely-positioned-item = <strong>{ $property }</strong> ne efikas sur tiu ĉi elemento ĉar ĝi ne estas absolute lokita elemento.
inactive-css-no-default-anchor = <strong>{ $property }</strong> ne efikas sur tiu ĉi elemento pro tio ke ĝi ne havas norman ankran elementon.
...
inactive-css-not-absolutely-positioned-item-fix = Provu aldoni <strong>position:absolute</strong> al la elemento. { learn-more }
inactive-css-no-default-anchor-fix = Provu aldoni <strong>position-anchor</strong> kun valida nomo de ankro. { learn-more }
...
css-selector-container-query-condition-no-container = Neniu ingo ‘{ $name }’ trovita
