...
about-debugging-sidebar-this-firefox2 = Tiu ĉi { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Tiu ĉi { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Agordoj
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-file-transfer = Aktivigu la transmeton de dosieroj kaj certiĝu ke via aparato ne estas en nur-ŝarga reĝimo.
# USB section step by step guide
