...
colorpicker-tooltip-spectrum-dragger-title = Spektro
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = Elekti koloron en paĝo
...
colorpicker-tooltip-color-name-title = Plej proksima al: { $colorName }
