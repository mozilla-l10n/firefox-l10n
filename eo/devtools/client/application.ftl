...
serviceworker-worker-updated = Ĝisdatigita je <time>{ DATETIME($date, day: "numeric", hour: "numeric", minute: "numeric", month: "long", second: "numeric", year: "numeric") }</time>
...
sidebar-item-session-history = Historio de seancoj
    .alt = Emblemo de historio de seancoj
    .title = Historio de seancoj
...
session-history-navigate-button-title = Navigi al elemento de historio { $index }
