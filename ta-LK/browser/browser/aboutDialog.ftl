...
settings-update-no-updates-found =
    .label = { -brand-short-name } இற்றைப்படுத்தப்பட்டுள்ளது

## Variables:
##   $displayUrl (String): URL to page with download instructions. Example: www.mozilla.org/firefox/nightly/

aboutdialog-update-manual-with-link = புதியவை கிடைக்குமிடம்<label data-l10n-name="manual-link">{ $displayUrl }</label>
settings-update-manual-with-link = புதியவை கிடைக்குமிடம்<a data-l10n-name="manual-link">{ $displayUrl }</a>

##

# Variables:
#   $channel (String): description of the update channel (e.g. "release", "beta", "nightly" etc.)
aboutdialog-channel-description = நீங்கள் தற்போது<label data-l10n-name="current-channel">{ $channel }</label>அலைவரிசையை புதுப்பிக்க.
