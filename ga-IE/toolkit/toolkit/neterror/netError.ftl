...
fp-neterror-denied-port-access = Úsáideann an seoladh seo port líonra a úsáidtear de ghnáth le haghaidh cúiseanna seachas brabhsáil. Chealaigh { -brand-short-name } d'iarratas ar mhaithe le do shlándáil.
