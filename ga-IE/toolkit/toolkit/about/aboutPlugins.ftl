...
plugins-openh264-description = Suiteálann Mozilla an breiseán seo go huathoibríoch chun sonraíocht WebRTC a chomhlíonadh, agus chun glaonna WebRTC a chumasú ar ghléasanna a dteastaíonn an codec físe H.264 uathu.  Tabhair cuairt ar https://www.openh264.org/ le cód foinseach an codec a fheiceáil agus le tuilleadh eolais a fháil faoin chur i bhfeidhm.
