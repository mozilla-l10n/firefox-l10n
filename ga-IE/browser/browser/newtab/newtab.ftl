...
newtab-clock-city-id-jakarta = Iacárta
...
newtab-clock-city-pl-warsaw = Vársá
newtab-clock-city-pl-krakow = Kraków
newtab-clock-city-jp-tokyo = Tóiceo
newtab-clock-city-jp-osaka = Ósaca
newtab-clock-city-mx-mexico-city = Cathair Mheicsiceo
newtab-clock-city-mx-guadalajara = Guadalajara
newtab-clock-city-it-rome = an Róimh
newtab-clock-city-it-milan = Milano
newtab-clock-city-ru-moscow = Moscó
newtab-clock-city-ru-saint-petersburg = Cathair Pheadair
newtab-clock-city-gb-london = Londain
newtab-clock-city-gb-birmingham = Birmingham
newtab-clock-city-es-madrid = Maidrid
newtab-clock-city-es-barcelona = Barcelona
newtab-clock-city-nl-amsterdam = Amstardam
newtab-clock-city-ch-zurich = Zürich
newtab-clock-city-at-vienna = Vín
newtab-clock-city-cz-prague = Prág
newtab-clock-city-ar-buenos-aires = Buenos Aires
newtab-clock-city-gr-athens = an Aithin
newtab-clock-city-hu-budapest = Búdaipeist
newtab-clock-city-be-brussels = Cathair na Bruiséile
newtab-clock-city-ua-kyiv = Cív
newtab-clock-city-fi-helsinki = Heilsincí
newtab-clock-city-co-bogota = Bogatá
newtab-clock-city-ph-manila = Mainile
newtab-clock-city-tr-istanbul = Iostanbúl
newtab-clock-city-my-kuala-lumpur = Kuala Lumpur
newtab-clock-city-eg-cairo = Caireo
newtab-clock-city-se-stockholm = Stócólm
newtab-clock-city-ro-bucharest = Búcairist
newtab-clock-city-th-bangkok = Bancác
...
newtab-clock-city-bg-sofia = Sóifia
newtab-clock-city-sg-singapore = Singeapór
newtab-clock-city-hk-hong-kong = Hong Cong
newtab-clock-city-sa-riyadh = Riyadh
newtab-clock-city-dk-copenhagen = Cóbanhávan
newtab-clock-city-pe-lima = Líoma
newtab-clock-city-ke-nairobi = Nairobi
newtab-clock-city-nz-auckland = Auckland
newtab-clock-city-kr-seoul = Súl
newtab-clock-city-lt-vilnius = Vilnias
newtab-clock-city-ie-dublin = Baile Átha Cliath
newtab-clock-city-ae-dubai = Dubai
newtab-clock-city-lv-riga = Ríge
newtab-clock-city-pt-lisbon = Liospóin
