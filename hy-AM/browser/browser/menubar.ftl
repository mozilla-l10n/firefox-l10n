...
menu-application-set-as-default =
    .label = Սահմանել { -brand-shorter-name }-ը որպես սկզբնադիր դիտարկիչ
...
menu-bookmarks-remote-tabs-promo =
    .label = Համաժամեցրեք էջանիշները բջջայինի հետ
menu-bookmark-tab =
