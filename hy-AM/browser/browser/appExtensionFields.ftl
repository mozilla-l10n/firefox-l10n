...
extension-default-theme-description2 = Հավասարակշռված, ծանոթ մոխրագույն-մանուշակագույն՝ դասական { -brand-product-name } տեսքի համար։
