...
pocket-panel-saved-error-generic = Սխալ՝ { -pocket-brand-name }-ում պահելիս:
...
pocket-panel-saved-error-not-saved = Էջը չի պահվել
pocket-panel-saved-error-no-internet = { -pocket-brand-name }-ում պահելու համար պետք է միացած լինեք համացանցին: Խնդրում ենք ստուգել կապը համացանցին և կրկին փորձել:
...
pocket-panel-saved-page-saved = Պահված է { -pocket-brand-name }-ում
...
pocket-panel-saved-save-tags = Պահել
pocket-panel-saved-saving-tags = Պահում է…
...
pocket-panel-signup-tagline = Պահեք հոդվածներ և տեսանյութեր { -brand-product-name }-ից՝ դրանք հետագայում ցանկացած սարքից, ցանկացած ժամանակ { -pocket-brand-name }-ում դիտելու համար:
pocket-panel-signup-tagline-story-one = Սեղմեք { -pocket-brand-name } կոճակը՝ պահելու համար { -brand-product-name }-ից ցանկացած հոդված, տեսանյութ կամ էջ:
pocket-panel-signup-tagline-story-two = Դիտեք { -pocket-brand-name }-ում ցանկացած սարքից, ցանկացած ժամանակ:
pocket-panel-signup-cta-a-fix = Ձեր պահման կոճակը համացանցի համար
