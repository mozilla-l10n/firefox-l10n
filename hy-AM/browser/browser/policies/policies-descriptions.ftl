...
policy-Cookies = Թույլատրել կամ մերժել կայքերը՝ կայելով թխուկները:
...
policy-DisableSafeMode = Անջատել գործառույթն անվտանգ աշխատակերպում վերագործարկելու համար։ Նշում․ անվտանգ աշխատակերպ մուտք գործելու համար օգտագործե՛ք Shift ստեղը, որը կարող է անջատված լինել միայն Windows-ում՝ օգտագործելով խմբային քաղաքականությունը։
