...
customize-mode-uidensity-menu-compact-unsupported =
    .label = Կոմպակտ (չի աջակցվում)
    .tooltiptext = Կոմպակտ (չի աջակցվում)
    .accesskey = Կ
customize-mode-undo-cmd =
    .label = Հետարկել
customize-mode-uidensity-link = Պատուհանների խտության կարգավորումներ
customize-mode-lwthemes-link-2 = Կառավարել ոճերը
customize-mode-lwthemes-link = Կառավարել ոճերը
