...
main-context-menu-open-link-split-view =
    .label = Բացել հղումը տրոհված տեսքով
    .accesskey = M
...
main-context-menu-send-to-mobile-2 =
    ...
    .accesskey = n
main-context-menu-send-to-mobile-sign-in = Մուտք գործեք՝ ներդիրներ ուղարկելու համար
...
main-context-menu-send-to-mobile-sign-in-from-link = Մուտք գործեք՝ հղում ուղարկելու համար
main-context-menu-send-to-mobile-sign-in-from-page = Մուտք գործեք՝ էջ ուղարկելու համար
main-context-menu-send-to-mobile-enable-sync3 = Միացնել համաժամեցումը՝ ներդիրներ ուղարկելու համար
main-context-menu-send-to-mobile-enable-sync-from-link = Միացրեք համաժամեցումը՝ հղում ուղարկելու համար
main-context-menu-send-to-mobile-enable-sync-from-page = Միացրեք համաժամեցումը՝ էջ ուղարկելու համար
...
main-context-menu-link-send-to-mobile =
    .label = Ուղարկել հղումը բջջայինին
    .accesskey = n
...
main-context-menu-pdfjs-save-page =
    .label = Պահպանել ընտրությունը որպես…
