...
default-browser-notification-privacy-header-text = Մնա՞լ { -brand-short-name }-ի հետ։
default-browser-notification-privacy-body-text = Ձեր լռելյայն արժեքը փոխվել է։ Վերադարձեք { -brand-short-name }՝ ներկառուցված գաղտնիության և պաշտպանության համար։
...
default-browser-notification-privacy-no-button-text = Ոչ, շնորհակալ եմ
