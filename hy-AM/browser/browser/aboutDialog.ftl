...
settings-update-checking-failed =
    .label = Չի ստացվում ստուգել թարմացումների առկայությունը:
update-otherInstanceHandlingUpdates = { -brand-short-name }-ը թարմացվել է այլ օրինակի կողմից
settings-update-other-instance-handling-updates =
    .label = { -brand-short-name }-ը թարմացվել է այլ օրինակի կողմից
...
settings-update-unsupported = Չեք կարող կատարել հետագա թարմացումներ այս համակարգում:<a data-l10n-name="unsupported-link">Իմանալ ավելին</a>
