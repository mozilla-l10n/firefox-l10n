...
mr2022-onboarding-existing-pin-subtitle = Գործարկեք ավելի առողջ համացանց ցանկացած վայրից մեկ սեղմումով: Մեր վերջին թարմացումը հագեցած է նոր բաներով, որոնք մենք կարծում ենք, որ դուք կպաշտեք:
