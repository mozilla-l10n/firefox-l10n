...
confirmation-hint-password-saved = Գաղտնաբառը պահվել է։
confirmation-hint-password-created = Գաղտնաբառը պահվեց
...
confirmation-hint-passport-created = Անձնագիր պահպանված է
confirmation-hint-passport-updated = Անձնագիր թարմացված է
