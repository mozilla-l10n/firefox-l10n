...
certmgr-people = Դուք ունեք պահված արտոնաթղթեր, որոնք այս անձանց նույնացնում են։
certmgr-ca = Դուք ունեք պահված վկայագրեր, որոնք այս հեղինակությունները նույնացնում են։
