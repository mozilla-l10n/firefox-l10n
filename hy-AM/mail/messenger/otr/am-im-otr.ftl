...
otr-encryption-caption = Որպեսզի մյուսներին հնարավորություն տաք հաստատել ձեր ինքնությունը OTR խոսակցություններում, համօգտագործեք ձեր սեփական OTR մատնահետքը`օգտագործելով արտաքին (արտաքին խմբից) հաղորդակցման ալիք:
...
otr-requireEncryption =
    .label = Պահանջել վերաջոր գաղտնագրում՝ մեկը մյուսին երկխոսություններում
otr-verifyNudge =
