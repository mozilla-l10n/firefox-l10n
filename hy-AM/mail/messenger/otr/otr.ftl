...
# Variables:
#   $name (String) - the screen name of a chat contact person
msgevent-connection_ended = { $name }-ն արդեն փակել է իրենց գաղտնագրված կապը ձեզ հետ: Խուսափելու համար առանց գաղտնագրման պատահաբար հաղորդագրություն ուղարկելուց, ձեր հաղորդագրությունը չի ուղարկվել: Խնդրում ենք ավարտել ձեր գաղտնագրված խոսակցությունը կամ վերագործարկեք այն:
# Variables:
#   $name (String) - the screen name of a chat contact person
