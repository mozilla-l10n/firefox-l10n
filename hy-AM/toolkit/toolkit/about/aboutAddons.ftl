...
plugins-openh264-description = Այս բաղադրիչը ինքնաբար տեղադրված է Mozilla-ի կողմից և համապատասխանում է WebRTC բնութագրին և WebRTC-ը միացնելու համար կանչում է սարքեր, որոնք պահանջում են H.264 տեսանյութի կոդեկ: Այցելեք https://www.openh264.org/ կայք՝ դիտելու համար կոդեկի բնագիրը:
...
find-more-extensions-promo =
    .heading = Գտեք ձեր հաջորդ սիրելի ընդլայնումը
    .message = Անհատականացրեք { -brand-product-name }-ը կենտրոնացման, գաղտնիության, գնումների և այլնի գործիքներով։
