...
debug-addons =
    .label = Վրիպազերծել հավելումները
    .accesskey = պ
cmd-show-details =
...
discover-description = Հավելումները կիրառություններ են, որոնք ձեզ թույլ են տալիս անհատականացնել { -brand-short-name }-ը  առավել ֆունցիոնալությամբ կամ ոճով: Փորձեք ժամանակ տնտեսող վահանակը, եղանակի տեղեկատուն կամ այլ թեմատիկ տեսք` { -brand-short-name }-ը ձեր սեփականը դարձնելու համար:
discover-footer = Երբ դուք մուտք գործեք համացանց, այս վահանակը կցուցադրի լավագույն և ամենատարածված հավելումները, որպեսզի դուք դրանք փորձարկեք:
detail-version =
    .label = Տարբերակ
detail-last-updated =
...
detail-private-browsing-description2 = Թույլտվության դեպքում մասնավոր զննարկելիս երկարաձգումը հասանելի կլինի ձեր առցանց գործողություններին։<label data-l10n-name="detail-private-browsing-learn-more"> Իմացեք ավելին</label>
# Some add-ons may elect to not run in private windows by setting incognito: not_allowed in the manifest.  This
# cannot be overridden by the user.
detail-private-disallowed-label = Թույլատրված չէ անձնական պատուհանում
detail-private-disallowed-description = Այս ընդլայնումը չի գործում մասնավոր դիտելիս։<label data-l10n-name="detail-private-browsing-learn-more"> Իմացեք ավելին </label>
...
manage-extensions-shortcuts =
    .label = Կառավարեք ընդարձակման դյուրացումները
    .accesskey = S
...
addons-enabled-heading = Միացրած
addons-disabled-heading = Անջատած
extension-enabled-heading = Միացրած
extension-disabled-heading = Անջատած
theme-enabled-heading = Միացրած
theme-disabled-heading = Անջատած
plugin-enabled-heading = Միացրած
plugin-disabled-heading = Անջատած
dictionary-enabled-heading = Միացրած
dictionary-disabled-heading = Անջատած
locale-enabled-heading = Միացրած
locale-disabled-heading = Անջատած
...
addon-badge-private-browsing-allowed =
    .title = Թույլատրել գաղտնի պատուհաններում
# This is the tooltip text for the private browsing badge in about:addons. The
# badge is the private browsing icon included next to the extension's name.
