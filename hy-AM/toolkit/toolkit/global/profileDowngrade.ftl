...
profiledowngrade-sync = { -brand-product-name }-ի հին տարբերակի օգտագործումը կարող է վնասել գոյություն ունեցող { -brand-product-name }-ի հաշվում արդեն պահված էջանիշերը և դիտարման պատմությունը։ Ձեր տեղեկությունը պաշտպանելու համար, ստեղծեք նոր հաշիվ { -brand-short-name }-ի այս տեղադրման համար։ Դուք կարող եք միշտ մուտք գործել { -fxaccount-brand-name }-ի հետ Ձեր էջանիշերը և դիտարկման պատմությունը հաշիվների միջև համաժամեցնելու համար։
