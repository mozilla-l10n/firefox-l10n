...
main-context-menu-open-link =
    .label = Òbriga l'enllaç
    .accesskey = Ò
main-context-menu-open-link-new-tab =
    .label = Òbriga l'enllaç en una pestanya nova
    .accesskey = t
main-context-menu-open-link-container-tab =
    .label = Obre l'enllaç en una pestanya de contenidor nova
    .accesskey = b
main-context-menu-open-link-new-window =
    .label = Òbriga l'enllaç en una finestra nova
    .accesskey = f
main-context-menu-open-link-new-private-window =
    .label = Òbriga l'enllaç en una finestra privada nova
    .accesskey = p
...
main-context-menu-frame-open-tab =
    .label = Òbriga el marc en una pestanya nova
    .accesskey = t
main-context-menu-frame-open-window =
    .label = Òbriga el marc en una finestra nova
    .accesskey = Ò
