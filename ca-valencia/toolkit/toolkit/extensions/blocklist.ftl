...
blocklist-hard-blocked = Estos complements tenen un alt risc de provocar problemes d'estabilitat o seguretat i s'han blocat; però cal reiniciar per inhabilitar-los completament.
blocklist-soft-blocked = Per a la vostra protecció, és molt recomanable que reinicieu el navegador amb estos complements inhabilitats.
