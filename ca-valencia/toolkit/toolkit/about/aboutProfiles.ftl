...
profiles-flush-failed = Un error inesperat ha impedit que es guarden els vostres canvis.
...
profiles-in-use-profile = Este perfil s'usa en una altra aplicació i no es pot suprimir.
...
profiles-delete-profile-failed-message = S'ha produït un error en intentar suprimir este perfil.
profiles-opendir =
    { PLATFORM() ->
