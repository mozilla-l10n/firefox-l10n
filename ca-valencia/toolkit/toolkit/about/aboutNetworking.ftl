...
title = Quant al trànsit de xarxa
warning = Esta funció és molt experimental. No la utilitzeu sense la supervisió d'un adult.
show-next-time-checkbox = Mostra'm este avís la propera vegada
ok = D'acord
http = HTTP
sockets = Sòcols
dns = DNS
...
refresh = Actualitza
auto-refresh = Actualitza automàticament cada 3 segons
...
messages-received = Missatges rebuts
...
set-log-modules = Defineix els mòduls de registre
start-logging = Inicia el registre
stop-logging = Para el registre
