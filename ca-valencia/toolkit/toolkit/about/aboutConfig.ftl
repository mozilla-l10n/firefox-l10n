...
config-about-warning-text = Canviar estos paràmetres avançats pot ser perillós per a l'estabilitat, la seguretat i el rendiment de l'aplicació. Només hauríeu de continuar si sabeu què esteu fent.
config-about-warning-button =
    .label = Accepte el risc!
config-about-warning-checkbox =
    .label = Mostra'm este avís la propera vegada
config-search-prefs =
    .value = Cerca:
    .accesskey = r
config-focus-search =
