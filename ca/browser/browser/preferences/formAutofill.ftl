...
address-capture-edit-address-link = Edita l'adreça
...
autofill-card-search-term-credit-cards = targetes de crèdit, crèdit, targetes, targetes de dèbit, dèbit, cartera, pagament
...
autofill-add-passport-title = Afegeix passaport
# The dialog title for editing a passport in browser preferences.
autofill-edit-passport-title = Edita el passaport
...
autofill-passport-issue-date = Data d'emissió
# Heading shown above the passport expiration date fields.
autofill-passport-expiry-date = Data de venciment
...
passport-capture-save-doorhanger-header = Voleu desar el passaport?
passport-capture-save-doorhanger-description = Deseu la informació al { -brand-short-name } per poder emplenar els formularis ràpidament.
...
passport-capture-never-save-button =
    .label = No guardis mai els passaports
    .accessKey = N
