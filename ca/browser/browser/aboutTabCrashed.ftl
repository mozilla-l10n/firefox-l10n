...
crashed-request-report-title = Informa d'aquesta pestanya
...
crashed-include-URL = Inclou els URL dels llocs que estàveu visitant quan el { -brand-short-name } ha fallat.
...
crashed-request-auto-submit-title = Informa de les pestanyes en segon pla
