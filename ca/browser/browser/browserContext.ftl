...
main-context-menu-send-to-mobile-2 =
    ...
    .accesskey = E
main-context-menu-send-to-mobile-sign-in = Inicieu la sessió per enviar pestanyes
main-context-menu-send-to-mobile-enable-sync2 = Activeu la sincronització per enviar una pestanya
...
main-context-menu-send-to-mobile-sign-in-from-link = Inicieu la sessió per enviar un enllaç
main-context-menu-send-to-mobile-sign-in-from-page = Inicieu la sessió per enviar una pàgina
