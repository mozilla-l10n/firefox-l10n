...
safeb-blocked-phishing-page-error-desc-override = S'ha informat que <span data-l10n-name='sitename'>{ $sitename }</span> <a data-l10n-name='error_desc_link'>és un lloc maliciós</a>. Podeu <a data-l10n-name='report_detection'>informar d'un error en la detecció</a> o <a data-l10n-name='ignore_warning_link'>ignorar el risc</a> i visitar aquest lloc insegur.
...
safeb-blocked-phishing-page-learn-more = Per obtenir més informació sobre els llocs maliciosos i la pesca electrònica (phishing), visiteu <a data-l10n-name='learn_more_link'>www.antiphishing.org</a>. Per obtenir més informació sobre la protecció contra la pesca electrònica i el programari maliciós del { -brand-short-name }, visiteu <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
safeb-blocked-malware-page-error-desc-override = S'ha informat que <span data-l10n-name='sitename'>{ $sitename }</span> <a data-l10n-name='error_desc_link'>conté programari maliciós</a>. Podeu <a data-l10n-name='report_detection'>informar d'un error en la detecció</a> o <a data-l10n-name='ignore_warning_link'>ignorar el risc</a> i visitar aquest lloc insegur.
