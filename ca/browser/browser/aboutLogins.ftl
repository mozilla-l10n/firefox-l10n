...
login-intro-instructions-fxa = Creeu un { -fxaccount-brand-name(capitalization: "sentence") } o inicieu-hi la sessió des del dispositiu on teniu desats els vostres inicis de sessió.
