...
extension-default-theme-description2 = Un gris-porpra equilibrat i familiar per a un aspecte clàssic del { -brand-product-name }.
...
extension-default-theme-name2 = Per defecte
