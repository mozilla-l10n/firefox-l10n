...
split-dismiss-button-dont-show-option =
    .label = No tornis a mostrar aquesta recomanació
# Dismisses message and reduces frequency of message
split-dismiss-button-show-fewer-option =
    .label = Mostra menys recomanacions
...
taskbar-tabs-social-callout-subtitle = Inicieu les vostres xarxes socials com una aplicació en una finestra simplificada protegida per { -brand-short-name }.
taskbar-tabs-chat-callout-title = Xategeu des de la barra de tasques
taskbar-tabs-chat-callout-subtitle = Inicieu els vostres llocs de xat com una aplicació en una finestra simplificada protegida per { -brand-short-name }.
taskbar-tabs-email-callout-title = Tingueu el correu electrònic a la barra de tasques
taskbar-tabs-email-callout-subtitle = Inicieu el vostre correu web com una aplicació en una finestra simplificada protegida per { -brand-short-name }.
taskbar-tabs-media-callout-title = Torneu a la transmissió des de la barra de tasques
taskbar-tabs-media-callout-subtitle = Inicieu els vostres llocs de transmissió com una aplicació en una finestra simplificada protegida per { -brand-short-name }.
...
windows-10-eos-sync-split-dismiss-button-show-fewer-option =
    .label = Mostra menys recomanacions
windows-10-eos-sync-dismiss-button-label = Descarta
windows-10-eos-sync-callout-primary-advance-button-label = Següent

## Link Preview Onboarding message callout strings

link-preview-onboarding-callout-title = Novetat: Feu clic i manteniu premut per previsualitzar els enllaços
link-preview-onboarding-callout-description = Vegeu una descripció breu, el temps de lectura i més informació per decidir si val la pena fer clic en un enllaç. També disponible fent clic amb el botó dret.
...
tab-groups-2026-onboarding-callout-title = Reduïu el desordre amb grups de pestanyes
...
tab-groups-2026-onboarding-callout-subtitle = Agrupeu les pestanyes per tasca o tema. Arrossegueu-ne més sobre la marxa.
...
tab-groups-2026-onboarding-cta-button = Inicia un grup
