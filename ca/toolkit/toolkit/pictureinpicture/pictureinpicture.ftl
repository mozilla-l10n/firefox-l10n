...
pictureinpicture-playback-rate-panel-accessible = Configuració de la velocitat de reproducció
pictureinpicture-playback-rate-label = Velocitat de reproducció
