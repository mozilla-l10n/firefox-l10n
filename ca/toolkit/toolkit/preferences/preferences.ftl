...
set-password-reenter =
    .label = Torneu a introduir la contrasenya:
...
primary-password-required-by-policy = La vostra organització sol·licita que tingueu una contrasenya principal per desar noms d'usuari i contrasenyes.
...
remove-primary-password-info =
    .value = Heu d'introduir la vostra contrasenya actual per a continuar.
remove-info =
