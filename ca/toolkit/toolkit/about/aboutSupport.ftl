...
gpu-active = Activa
webgl1-wsiinfo = Informació WSI del controlador WebGL 1
webgl1-renderer = Renderitzador del controlador WebGL 1
webgl1-version = Versió del controlador WebGL 1
webgl1-driver-extensions = Extensions del controlador WebGL 1
webgl1-extensions = Extensions WebGL 1
webgl2-wsiinfo = Informació WSI del controlador WebGL 2
webgl2-renderer = Renderitzador del controlador WebGL 2
webgl2-version = Versió del controlador WebGL 2
webgl2-driver-extensions = Extensions del controlador WebGL 2
...
gpu-device-reset = Restableix el dispositiu
gpu-device-reset-button = Inicia el restabliment del dispositiu
uses-tiling = Fa servir mosaics
content-uses-tiling = Fa servir mosaics (contingut)
...
sandbox-proc-type-file = contingut del fitxer
