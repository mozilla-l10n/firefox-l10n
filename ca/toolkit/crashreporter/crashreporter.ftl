...
crashreporter-branded-title = Generador d'informes de fallada del { -brand-short-name }
crashreporter-apology = Ho lamentem
crashreporter-crashed-and-restore = El { -brand-short-name } ha tingut un problema i ha fallat. S'intentarà recuperar les vostres pestanyes i finestres quan es reiniciï.
crashreporter-plea = Per ajudar-nos a diagnosticar i resoldre el problema, podeu enviar-nos un informe de fallada.
crashreporter-information = Aquesta aplicació s'executa després d'una fallada per informar del problema a { -vendor-short-name }. No s'hauria d'executar directament.
crashreporter-error = El { -brand-short-name } ha tingut un problema i ha fallat. Malauradament, el generador d'informes de fallada no ha pogut trametre'n un informe.
crashreporter-error-details-header = Detalls:
...
crashreporter-loading-details = S'està carregant…
