...
account-setup-privacy-footnote = Les vostres credencials s’utilitzaran d’acord amb la nostra <a data-l10n-name="privacy-policy-link">política de privadesa</a> i només es desaran localment en el vostre ordinador.
