...
storage-table-type-cookies-hint = Pregledaj i uredi kolačiće odabirom hosta. <a data-l10n-name="learn-more-link">Saznaj više</a>
# Hint shown when the local storage type is selected. Clicking the link will open
# https://firefox-source-docs.mozilla.org/devtools-user/storage_inspector/local_storage_session_storage/
storage-table-type-localstorage-hint = Pregledaj i uredi lokalno spremište odabirom hosta. <a data-l10n-name="learn-more-link">Saznaj više</a>
# Hint shown when the session storage type is selected. Clicking the link will open
# https://firefox-source-docs.mozilla.org/devtools-user/storage_inspector/local_storage_session_storage/
storage-table-type-sessionstorage-hint = Pregledaj i uredi spremište sesije odabirom hosta. <a data-l10n-name="learn-more-link">Saznaj više</a>
