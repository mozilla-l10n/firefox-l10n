...
btp-warning-tracker-classified =
    { $gracePeriodSeconds ->
        [one] „{ $siteHost }” je klasificiran kao „bounce” program za praćenje. Ako ga korisnik ne aktivira unutar { $gracePeriodSeconds } sekunde, njegovo će se stanje izbrisati.
        [few] „{ $siteHost }” je klasificiran kao „bounce” program za praćenje. Ako ga korisnik ne aktivira unutar { $gracePeriodSeconds } sekunde, njegovo će se stanje izbrisati.
       *[other] „{ $siteHost }” je klasificiran kao „bounce” program za praćenje. Ako ga korisnik ne aktivira unutar { $gracePeriodSeconds } sekundi, njegovo će se stanje izbrisati.
    }
...
btp-warning-tracker-purged = Stanje domene „{ $siteHost }” je nedavno potpuno izbrisano jer je otkrivena kao „bounce” program za praćenje.
