...
permission-dialog-description = Dopustiti ovoj stranici otvaranje { $scheme } poveznice?
...
permission-dialog-description-app = Dopustiti ovoj stranici otvaranje { $scheme } poveznice pomoću aplikacije { $appName }?
