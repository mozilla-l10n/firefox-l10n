...
set-password-old =
    .label = Trenutačna lozinka:
set-password-new =
    .label = Upiši novu lozinku:
set-password-reenter =
    .label = Ponovo upiši novu lozinku:
...
primary-password-admin = Za spremanje prijava i lozinki, administrator zahtijeva da postaviš primarnu lozinku.
...
remove-primary-password-info =
    .value = Za nastavak moraš unijeti svoju trenutnu lozinku.
remove-info =
