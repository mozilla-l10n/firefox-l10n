...
preferences-doh-default-detailed-desc-2 = Koristi standarni DNS ako postoji problem s pružateljem sigurnog DNS-a
...
preferences-doh-setting-enabled =
    ...
    .accesskey = i
preferences-doh-enabled-desc = Ti određuješ kada koristiti sigurni DNS i odaberi svog pružatelja usluge.
preferences-doh-enabled-detailed-desc-1 = Koristi odabranog pružatelja usluge
preferences-doh-enabled-detailed-desc-2 = Koristi samo standarni DNS aki postoji problem sa sigurnim DNS-om
...
preferences-doh-setting-off =
    .label = Isključeno
    .accesskey = I
preferences-doh-off-desc = Koristi standarni DNS server
