...
preferences-doh-default-detailed-desc-2 = Koristi standarni DNS ako postoji problem sa pružateljem usluge sigurnog DNS-a
...
preferences-doh-enabled-detailed-desc-2 = Koristi samo standarni DNS ukoliko postoji problem sa sigurnim DNS-om
