...
callout-primary-advance-button-label = Dalje
...
callout-firefox-view-tab-pickup-subtitle = Preuzmi otvorene kartice sa svog mobitela i otvori ih ovdje za pregledavanje bez prekida.
...
callout-pdfjs-draw-body-a = Označi PDF datoteke, zatim spremi promjene.
# “Mark up” refers to the process of “annotating” or adding free hand text or diagramming to the document.
...
start-page-callout-title = Želiš li isprobati novo pretraživanje usmjereno na privatnost?
start-page-callout-subtitle = Isprobaj Startpage. Osmišljen je kako bi tvoja pretraživanja od samog početka bila privatnija.
...
fxa-adoption-passwords-title = Lozinka je spremljena. Izradimo sigurnosnu kopiju lozinke.
fxa-adoption-passwords-subtitle = Zaštiti svoje lozinke sinkronizacijom s uređajima pomoću šifriranja.
# Opens Mozilla accounts sign-up page
fxa-adoption-passwords-primary-button-label = Registriraj se
...
taskbar-tabs-chat-callout-subtitle = Pokreni svoje stranice za čavrljanje kao aplikaciju u pojednostavljenom prozoru, koje štiti { -brand-short-name }.
...
windows-10-eos-sync-callout-primary-advance-button-label = Dalje

## Link Preview Onboarding message callout strings

link-preview-onboarding-callout-title = Novo: klikni i drži za pregled poveznica
link-preview-onboarding-callout-description = Pogledaj kratki opis, vrijeme čitanja i još toga za odlučivanje isplati li se kliknuti poveznicu. Dostupno i klikom desne tipke miša.
...
tab-groups-2026-onboarding-callout-title = Smanji nered pomoću grupa kartica
...
tab-groups-2026-onboarding-callout-subtitle = Grupiraj svoje kartice prema zadatku ili temi. Dovuci ih tijekom korištenja.
...
tab-groups-2026-onboarding-cta-button = Započni grupu
