...
firefoxview-syncedtabs-signin-description = Za prikaz kartica s bilo kojeg uređaja na kojem koristiš { -brand-product-name } prijavi se na svoj račun. Ako nemaš račun, pomoći ćemo ti pri registraciji.
