...
firefoxview-syncedtabs-signin-header = Preuzmi kartice od bilo kuda
firefoxview-syncedtabs-signin-description = Da biste vidjeli svoje kartice gdje god koristite { -brand-product-name }, prijavite se u svoj račun. Ako nemate račun, provest ćemo vas kroz korake za prijavu.
...
firefoxview-syncedtabs-adddevice-description = Za prikaz kartica s bilo kojeg mjesta na kojem koristiš { -brand-product-name }, prijavi se na svim svojim uređajima. Saznaj kako <a data-l10n-name="url">povezati dodatne uređaje</a>.
...
firefoxview-mobile-promo-header = Preuzmi kartice sa svog mobitela ili tableta
firefoxview-mobile-promo-description = Za pregled najnovijih mobilnih kartica prijavite se na { -brand-product-name } na iOSu ili Androidu.
