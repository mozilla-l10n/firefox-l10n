...
crashed-include-URL-2 = Uključi URL-ove stranica koje su bile otvorene kada se { -brand-short-name } srušio
...
crashed-auto-submit-checkbox-2 = Ažuriraj postavke za automatsko slanje izvješća kada se { -brand-short-name } sruši
