...
genai-settings-chat-claude-links = Odabirom Anthropic Claude prihvaćaš <a data-l10n-name="link1">uvjete usluge za potrošače</a>, <a data-l10n-name="link2">politiku korištenja</a> i <a data-l10n-name="link3">politiku privatnosti</a> tvrtke Anthropic.
