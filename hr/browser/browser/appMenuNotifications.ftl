...
appmenu-update-restart =
    ...
    .secondarybuttonlabel = Ne sada
    .secondarybuttonaccesskey = N
appmenu-update-restart-message = Nakon brzog ponovnog pokretanja, { -brand-shorter-name } će vratiti sve vaše otvorene kartice i prozore koji se ne nalaze u privatnom pregledavanju.
