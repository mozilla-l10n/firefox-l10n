...
about-private-browsing-learn-more = Saznajte više o <a data-l10n-name="learn-more">Privatno pretraživanje</a>.
...
privatebrowsingpage-open-private-window-label = Otvori privatni prozor
    .accesskey = p
about-private-browsing-info-notsaved = Kada pretražujete u privatnom prozoru, { -brand-short-name } <strong>ne sprema</strong>:
...
about-private-browsing-info-myths = Česti mitovi o privatnom pretraživanju
...
about-private-browsing-note = Privatno pretraživanje <strong>vas ne čini anonimnim</strong> na Internetu. Vaš poslodavac ili pružatelj Internet usluga svejedno može pratiti koje stranice posjećujete.
