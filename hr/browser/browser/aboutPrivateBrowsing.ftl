...
about-private-browsing-hide-activity = Sakrij svoju aktivnost i mjesto svuda gdje pregledavaš
about-private-browsing-get-privacy = Zaštiti svoju privatnost svugdje gdje pregledavaš
about-private-browsing-hide-activity-1 = Sakrij svoju aktivnost pregledavanja pomoću { -mozilla-vpn-brand-name }. Jedan klik stvara sigurnu vezu, čak i putem javne WiFi mreže.
