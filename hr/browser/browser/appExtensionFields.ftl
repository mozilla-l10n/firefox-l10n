...
extension-default-theme-description2 = Uravnotežena, poznata sivo-ljubičasta za klasičan { -brand-product-name } izgled.
...
extension-default-theme-name2 = Zadano
# Name for a warm yellow-gold theme. Refers to the color of sunlight.
extension-nova-sun-name = Sunce
...
extension-nova-flare-name = Baklja
...
extension-nova-dusk-name = Sumrak
