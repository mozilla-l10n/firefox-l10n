...
settings-update-downloading-2 =
    .label = Zladënk aktualizacje — { $transfer }

##

update-applying = Instalacjô aktualizacje…
settings-update-applying =
    .label = Instalacjô aktualizacje…
...
settings-update-no-updates-found =
    .label = Program { -brand-short-name } je zaktualniony
update-otherInstanceHandlingUpdates = { -brand-short-name } je zaktualniany
settings-update-other-instance-handling-updates =
    .label = { -brand-short-name } je zaktualniany
...
settings-update-unsupported = Ni mòżesz dali zaktualniac negò systemù. <a data-l10n-name="unsupported-link">Wëdowiedzë sã wicy</a>
