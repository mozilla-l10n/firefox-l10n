...
certmgr-edit-ca-cert2 =
    ...
    .title = Labot CA sertifikātu uzticamības iestatījumus
certmgr-edit-cert-edit-trust = Labot uzticamības iestatījumus:
certmgr-edit-cert-trust-ssl =
    .label = Šis sertifikāts var identificēt tīmekļvietnes.
