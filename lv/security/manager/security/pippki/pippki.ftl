...
download-cert-message = Tiek vaicāts uzticēties jaunai sertifikātu autoritātei (CA).
download-cert-trust-ssl =
    .label = Uzticēties šai CA tīmekļa vietņu identificēšanai.
download-cert-trust-email =
    .label = Uzticēties šai CA epasta lietotāju identificēšanai.
download-cert-message-desc = Pirms uzticēšanās šai CA jebkādam nolūkam, vajadzētu izpētīt tās sertifikātu un sertifikātu izsniegšanas pamatnostādnes un procedūras (ja pieejamas).
...
client-auth-cert-remember-label = Atcerēties šo izvēli:
