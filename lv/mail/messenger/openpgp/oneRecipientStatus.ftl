...
openpgp-one-recipient-status-instruction1 = Lai adresātam nosūtītu no gala līdz galam šifrētu vēstuli, jums jāiegūst viņa OpenPGP publiskā atslēga un jāatzīmē tā kā pieņemta.
