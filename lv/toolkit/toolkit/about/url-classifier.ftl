...
url-classifier-provider-last-update-status = Pēdējās atjaunināšanas stāvoklis
...
url-classifier-cache-prefix = Priedēklis
...
url-classifier-debug-file = Pašreizējā žurnāla datne:
