...
ssl-error-decompression-failure-alert = SSL partneris nevarēja sekmīgi atspiest saņemto SSL ierakstu.
...
ssl-error-generate-random-failure = SSL saskārās ar tā gadījuma skaitļu veidotāja kļūmi.
...
ssl-error-pub-key-size-limit-exceeded = SSL serveris mēģināja izmantot pašmāju raudzes publisko atslēgu ar izguves šifrētāju.
...
ssl-error-session-key-gen-failure = Klientam neizdevās izveidot SSL sesijas atslēgas.
ssl-error-no-server-key-for-alg = Serverim nav atslēga mēģinātajam atslēgu apmaiņas algoritmam.
ssl-error-token-insertion-removal = PKCS#11 pilnvara tika ievietota vai noņemta darbības norises laikā.
...
ssl-error-export-restriction-alert = Partneris ziņo, ka vienošanās neatbilst izgūšanas nosacījumiem.
...
ssl-error-no-renegotiation-alert = Partneris nepieļauj atkārtu vienošanos par SSL drošības raksturvērtībām.
...
ssl-error-unsafe-negotiation = Līdzinieks mēģināja vecā veida (iespējami ievainojamu) rokasspiedienu.
...
sec-error-expired-issuer-certificate = Sertifikāta izdevēja sertifikātam ir beidzies derīgums. Jāpārbauda sistēmas datums un laiks.
sec-error-crl-expired = Sertifikāta izdevēja CRL ir beidzies derīgums. Tas ir jāatjaunina vai jāpārbauda sistēmas datums un laiks.
...
sec-error-krl-expired = Šīs vietnes sertifikāta KRL ir beidzies derīgums.
...
sec-error-no-token = Drošības karte vai pilnvara nepastāv, tā ir jāinicializē vai tā tika noņemta.
...
sec-error-exporting-certificates = Kļūda sertifikātu izgūšanas mēģinājumā.
sec-error-importing-certificates = Kļūda sertifikātu ievietošanas mēģinājumā.
sec-error-pkcs12-decoding-pfx = Nevar ievietot. Atkodēšanas kļūda. Datne nav derīga.
sec-error-pkcs12-invalid-mac = Nevar ievietot. Nederīgs MAC. Nederīga parole vai bojāta datne.
sec-error-pkcs12-unsupported-mac-algorithm = Nevar ievietot. MAC algoritms nav atbalstīts.
sec-error-pkcs12-unsupported-transport-mode = Nevar ievietot. Tiek atbalstīti tikai paroles veseluma un privātuma režīmi.
sec-error-pkcs12-corrupt-pfx-structure = Nevar ievietot. Bojāta datņu uzbūve.
sec-error-pkcs12-unsupported-pbe-algorithm = Nevar ievietot. Šifrēšanas algoritms nav atbalstīts.
sec-error-pkcs12-unsupported-version = Nevar ievietot. Datnes versija nav atbalstīta.
sec-error-pkcs12-privacy-password-incorrect = Nevar ievietot. Nepareiza privātuma parole.
sec-error-pkcs12-cert-collision = Nevar ievietot. Šāds segvārds datubāzē jau pastāv.
sec-error-user-cancelled = Lietotājs nospieda atcelt.
sec-error-pkcs12-duplicate-data = Nav ievietots, jau ir datubāzē.
...
sec-error-pkcs12-unable-to-import-key = Nevar ievietot. Kļūda privātās atslēgas ievietošanas mēģinājumā.
sec-error-pkcs12-importing-cert-chain = Nevar ievietot. Kļūda sertifikāta ķēdes ievietošanas mēģinājumā.
sec-error-pkcs12-unable-to-locate-object-by-name = Nav iespējams izgūt. Pēc segvārda nevar atrast sertifikātu vai atslēgu.
sec-error-pkcs12-unable-to-export-key = Nav iespējams izgūt. Privāto atslēgu nevarēja atrast vai izgūt.
sec-error-pkcs12-unable-to-write = Nav iespējams izgūt. Izguves datnē nav iespējams rakstīt.
sec-error-pkcs12-unable-to-read = Nevar ievietot. Nevar nolasīt ievietošanas datni.
sec-error-pkcs12-key-database-not-initialized = Nav iespējams izgūt. Atslēgu datubāze ir bojāta vai izdzēsta.
sec-error-keygen-fail = Nevar izveidot publiskās/privātās atslēgas pāri.
...
sec-error-module-stuck = PKCS #11 moduli nevar noņemt, jo tas vēl tiek izmantots.
...
sec-error-reused-issuer-and-serial = Tu mēģini ievietot sertifikātu ar tādu pašu izdevēju / sērijas numuru kā jau esošam sertifikātam, bet tas nav tas pats.
...
sec-error-crl-import-failed = Kļūda CRL ievietošanas mēģinājumā.
sec-error-expired-password = Ir beidzies paroles derīgums.
sec-error-locked-password = Parole ir slēgta.
...
xp-java-remove-principal-error = Nevarēja noņemt pilnvarotāju
xp-java-delete-privilege-error = Nevar nodzēst privilēģiju
xp-java-cert-not-exists-error = Pilnvarotājam nav sertifikāta
