...
datetime-picker-label =
    .aria-label = Izvēlieties datumu un laiku
...
date-spinner-label =
    .aria-label = Izvēlieties mēnesi un gadu

## Text of the clear button

date-picker-clear-button = Notīrīt
...
time-spinner-hour-previous =
    .aria-label = Iepriekšējā stunda
time-spinner-hour-next =
    .aria-label = Nākamā stunda
time-spinner-minute-previous =
    .aria-label = Iepriekšējā minūte
time-spinner-minute-next =
    .aria-label = Nākamā minūte
time-spinner-day-period-previous =
    .aria-label = Iepriekšējais dienas periods
time-spinner-day-period-next =
    .aria-label = Nākamais dienas periods
