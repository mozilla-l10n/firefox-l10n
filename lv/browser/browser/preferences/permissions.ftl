...
permissions-close-key =
    .key = w
permissions-address = Tīmekļvietnes adrese
    .accesskey = T
permissions-block =
    .label = Liegt
    .accesskey = L
...
permissions-status =
    .label = Stāvoklis
permissions-remove =
    .label = Noņemt tīmekļvietni
    .accesskey = Z
permissions-remove-all =
    .label = Noņemt visas tīmekļvietnes
    .accesskey = k
...
permissions-exceptions-etp-window2 =
    ...
    .title = Uzlabotās pretizsekošanas aizsardzības izņēmumi
permissions-exceptions-manage-etp-desc = Var norādīt, kurās vietnēs ir izslēgta uzlabotā pretizsekošanas aizsardzība. Jāieraksta tieša tās vietnes adrese, kuru ir vēlēšanās pārvaldīt, un pēc tam jāklikšķina uz “Pievienot izņēmumu”.
...
permissions-site-notification-window2 =
    ...
    .style = { permissions-window2.style }
permissions-site-notification-desc = Šīs tīmekļvietnes ir pieprasījušas sūtīt paziņojumus. Var norādīt, kurām tīmekļvietnēm ir atļauts sūtīt paziņojumus. Tāpat var liegt jaunus pieprasījumus, kuros tiek lūgts atļaut paziņojumu sūtīšanu.
