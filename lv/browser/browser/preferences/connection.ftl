...
connection-proxy-autologin =
    ...
    .tooltip = Šī iespēja nemanot autentificēs Tevi starpniekserveros, kuriem ir saglabāti pieteikšanās dati. Ja autentifikācija neizdosies, tiks parādīta uzvedne.
    .accesskey = i
