...
connection-proxy-autologin =
    .label = Nevaicāt autentificēties, ja ir saglabāta parole
    .tooltip = Šī iespēja nemanot autentificēs Tevi starpniekserveros, kuriem ir saglabāti pieteikšanās dati. Ja autentifikācija neizdosies, tiks parādīts autentificēšanās logs.
    .accesskey = i
