...
security-tab =
    ...
    .accesskey = S
security-view =
    .label = Apskatīt sertifikātu
    .accesskey = A
security-view-unknown = Nezināms
    .value = Nezināms
security-view-identity =
    .value = Tīmekļvietnes identitāte
...
security-view-qwac =
    .label = Apskatīt kvalificētu sertifikātu
    .accesskey = k
security-view-privacy-history-value = Vai es šo tīmekļvietni šodien jau apmeklēju?
...
security-view-privacy-clearsitedata =
    ...
    .accesskey = N
security-view-privacy-passwords-value = Vai saglabāju kādas paroles šai tīmekļvietnei?
security-view-privacy-viewpasswords =
    .label = Apskatīt saglabātās paroles
    .accesskey = s
...
page-info-security-no-owner =
    .value = Šī tīmekļvietne nepiedāvā informāciju par savu īpašnieku.
...
media-dimensions-scaled =
    .value = { $dimx }px × { $dimy }px (tālummainīts uz { $scaledx }px × { $scaledy }px)
