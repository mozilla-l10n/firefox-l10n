...
import-from-opera-gx =
    .label = Opera GX
    .accesskey = G
no-migration-sources = Nevarēja atrast nevienu programmu, kas saturētu grāmatzīmes, vēsturi vai paroļu datus.
import-source-page-title = Ievietot iestatījumus un datus
...
import-migrating-description = Šobrīd tiek ievietoti sekojošie vienumi...
import-select-profile-page-title = Izvēlieties profilu
import-select-profile-description = Ir pieejami šie profili, no kuriem ievietot:
import-done-page-title = Importēšana ir pabeigta
import-done-description = Šie vienumi tika sekmīgi ievietoti:
...
browser-data-session-checkbox =
    .label = Logi un cilnes
browser-data-session-label =
    .value = Logi un cilnes
browser-data-payment-methods-checkbox =
    .label = Maksājumu veidi
browser-data-payment-methods-label =
    .value = Maksājumu veidi
