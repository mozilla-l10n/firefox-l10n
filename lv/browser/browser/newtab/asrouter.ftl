...
refresh-unused-profile-infobar-message = Šķiet { -brand-short-name } nav kādu laiku izmantots. Vai vēlaties to atjaunot uz tīru un svaigu stāvokli, kā sākumā? Un jā, mēs priecājamies Jūs redzēt atpakaļ!
