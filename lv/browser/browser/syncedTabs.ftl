...
synced-tabs-sidebar-tabsnotsyncing = Ieslēdz cilņu vienādošanu, lai redzētu cilnes no citām savām ierīcēm.
...
synced-tabs-turn-on-sync = Ieslēgt vienādošanu
# Context for hovering over the close tab button that will
# send a push to the device to close said tab
# Variables
# $deviceName - the name of the device the user is closing a tab for
synced-tabs-context-close-tab = Aizvērt cilni ierīcē { $deviceName }
