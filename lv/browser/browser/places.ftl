...
places-maintenance-button =
    .label = Ievietošana un dublēšana
    .tooltiptext = Grāmatzīmju ievietošana un dublēšana
    .accesskey = I
places-cmd-backup =
    .label = Dublēt...
    .accesskey = I
...
places-import-bookmarks-from-html =
    .label = Ievietot grāmatzīmes no HTML…
    .accesskey = I
places-export-bookmarks-to-html =
    .label = Izgūt grāmatzīmes kā HTML…
    .accesskey = I
places-import-other-browser =
    .label = Ievietot datus no cita pārlūka…
    .accesskey = a
