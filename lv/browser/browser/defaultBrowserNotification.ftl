...
default-browser-notification-message = <strong>Vai iestatīt { -brand-short-name } kā noklusējuma pārlūkprogrammu?</strong> Pārlūkojiet ātri, droši un privāti ikreiz, kad izmantojat tīmekli.
...
default-browser-prompt-title-pin = Vai iestatīt { -brand-short-name } par galveno pārlūkprogrammu?
default-browser-prompt-message-pin = Turi { -brand-short-name } sev tuvumā — padari to par noklusējuma pārlūku un piespraud to uzdevumjoslai!
default-browser-prompt-message-pin-msix = Turi { -brand-short-name } sev tuvumā — padari to par noklusējuma pārlūku un piespraud to uzdevumjoslai un sākuma izvēlnei!
default-browser-prompt-message-pin-mac = Turi { -brand-short-name } sev tuvumā — padari to par noklusējuma pārlūku un turi to Dock!
