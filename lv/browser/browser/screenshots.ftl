...
screenshots-connection-error-details = Lūgums pārbaudīt savienojumu ar internetu. Ja var izveidot savienojumu ar internetu, var gadīties, ka ir radies īslaicīgs sarežģījums ar pakalpojumu { -screenshots-brand-name }.
