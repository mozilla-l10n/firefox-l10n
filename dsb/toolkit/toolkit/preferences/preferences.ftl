...
set-password-old =
    .label = Tuchylne gronidło:
set-password-new =
    .label = Zapódajśo nowe gronidło:
...
primary-password-warning = Pšosym zawěsććo, až markujośo se głowne gronidło, kótarež sćo stajił. Jolic zabydnjośo swójo głowne gronidło, njamóžośo na z tym šćitane informacije na toś tom rěźe pśistup měś.
