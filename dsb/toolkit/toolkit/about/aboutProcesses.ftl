...
about-processes-web-isolated-property-private = priwatne
about-processes-web-isolated-property-serviceworker = serviceworker
about-processes-web-isolated-property-jit-disabled = JIT znjemóžnjony
about-processes-web-isolated-property-with-coop-coep = cross-origin izolěrowany
...
about-processes-utility-actor-pkcs11-module = Pomocnik wěstotnego modula
about-processes-utility-actor-hw-inference = Pśez hardware póspěšona inferenca
