...
details-notification-softblocked-extension-disabled =
    .message = Toś to rozšyrjenje se pśeśiwo pšawidłam Mozilla pśejźo a jo se znjemóžniło. Móžośo jo zmóžniś, ale to jo snaź riskantne.
...
details-notification-softblocked-other-disabled =
    .message = Toś ten dodank se pśeśiwo pšawidłam Mozilla pśejźo a jo se znjemóžnił. Móžośo jen zmóžniś, ale to jo snaź riskantne.
