...
about-logging-logging-preset-selector-text = Pśednastajenje za protokolěrowanje:
about-logging-with-profiler-stacks-checkbox = Štapjelowe pśeslědowanja za protokolowe powěźeńki zmóžniś
