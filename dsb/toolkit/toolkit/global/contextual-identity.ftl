...
user-context-shopping-panel-item = Nakupowanje
    .accesskey = N
user-context-new-tab-panel-item = Nowy rejtarik
    .accesskey = N
user-context-add-container-panel-item = Nowy kontejner pśidaś
    .accesskey = N
user-context-manage-containers-panel-item = Kontejnery zastojaś
    .accesskey = K
