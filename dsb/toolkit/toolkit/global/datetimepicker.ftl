...
time-spinner-hour-previous =
    .aria-label = Pjerwjejšna góźina
time-spinner-hour-next =
    .aria-label = Pśiduca góźina
time-spinner-minute-previous =
    .aria-label = Pjerwjejšna minuta
time-spinner-minute-next =
    .aria-label = Pśiduca minuta
time-spinner-second-previous =
    .aria-label = Pjerwjejšna sekunda
time-spinner-second-next =
    .aria-label = Pśiduca sekunda
time-spinner-millisecond-previous =
    .aria-label = Pjerwjejšna milisekunda
time-spinner-millisecond-next =
    .aria-label = Pśiduca milisekunda
time-spinner-day-period-previous =
    .aria-label = Pjerwjejšny dnjowny wótrězk
time-spinner-day-period-next =
    .aria-label = Pśiducy dnjowny wótrězk
