...
ssl-error-rx-unknown-record-type = SSL jo dostał datowu sajźbu z njeznatym wopśimjeśowym typom.
...
ssl-error-renegotiation-not-allowed = Znowegojadnanje na toś tom SSL-sokeśe njejo dowólone.
...
sec-error-io = Zapódawańska/wudawańska zmólka jo za wěstotnu awtorizaciju nastała.
...
sec-error-input-len = wěstotna biblioteka jo měła zmólku zapódawańskeje dłujkosći.
...
sec-error-expired-issuer-certificate = Certifikat certifikatowego wudawarja jo pśepadnjony. Pśekontrolěrujśo datum a cas swójogo systema.
sec-error-crl-expired = CRL za wudawarja certifikata jo pśepadnjona. Aktualizěrujśo ju abo pśekontrolěrujśo datum a cas swójogo systema.
