...
serviceworker-worker-updated = <time>{ DATETIME($date, day: "numeric", hour: "numeric", minute: "numeric", month: "long", second: "numeric", year: "numeric") }</time> zaktualizěrowany
...
sidebar-item-session-history = Pósejźeńska historija
    .alt = Symbol za Pósejźeńska historija
    .title = Pósejźeńska historija
...
session-history-navigate-button-title = K zapiskoju { $index } pósejźeńskeje historije nawigěrowaś
