...
contextual-manager-passwords-origin-field =
    .label = Adresa websedła
    .placeholder = https://www.example.com
contextual-manager-passwords-origin-field-description = Zapódajśo eksaktnu adresu, źož se pla toś togo sedła pśizjawjaśo.
contextual-manager-passwords-username-field =
    .label = Wužywaŕske mě
contextual-manager-passwords-username-field-description = Zapódajśo wužywaŕske mě, e-mailowu adresu abo kontowy numer, kótaryž wužywaśo, aby se pśizjawił.
contextual-manager-passwords-password-field =
    .label = Gronidło
contextual-manager-passwords-password-field-description = Zapódajśo gronidło, aby se pla toś togo konta pśizjawił.
