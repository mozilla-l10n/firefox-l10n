...
# Shown when no trackers have been blocked yet today.
newtab-privacy-empty-state = { -brand-short-name } pśeslědowaki awtomatiski blokěrujo, aby wěcej aktiwity priwatne wóstało.
# "A running tally" is an informal way to say a total that keeps updating as it goes.
# Here we are referring to the number of trackers blocked, which increases as the user browses.
# An alternative can be "See a running total here"
newtab-privacy-empty-state-tally = Lejśo aktualnu cełkownu licbu.

## Privacy widget — Enhanced Tracking Protection off state

# Shown when the user has turned off the Enhanced Tracking Protection setting.
newtab-privacy-etp-off-faster-browsing = Malsnjejše pśeglědowanje. Mjenjej pśeslědowakow.
newtab-privacy-etp-off-turn-on-tracking = Zmóžniśo šćit slědowanja w nastajenjach, aby blokěrowanje zachopił.
...
newtab-recent-searches-tab-recent = Nejnowše pytanja
...
newtab-recent-searches-trending-attribution = pśez { $engine }
# Relative time shown for a search made less than a minute ago.
newtab-recent-searches-just-now = Rowno
...
newtab-topsites-use-custom-image-link = Swójski wobraz wužywaś
...
newtab-customize-panel-back-button =
    .aria-label = Slědk k Pśiměriś
    .title = Slědk k Pśiměriś
...
newtab-wallpaper-your-images = Waše wobraze
...
newtab-wallpaper-your-images-folder =
    .aria-label = Waše wobraze, slězynowe wobraze, kótarež sćo składł
...
newtab-wallpaper-remove-image-numbered =
    .aria-label = Wobraz { $number } wótwónoźeś
    .title = Wobraz { $number } wótwónoźeś
newtab-wallpaper-remove-image-title = Wobraz wótwónoźeś?
# "This action" refers to removing a saved wallpaper image.
newtab-wallpaper-remove-image-body = Toś ta akcija njedajo se anulěrowaś.
newtab-wallpaper-remove-image-confirm = Wótwónoźeś
newtab-wallpaper-remove-image-cancel = Pśetergnuś
...
newtab-topic-navigation-more-button = Wěcej
...
newtab-widget-lists-change-list =
    .aria-label = Lisćinu změniś
    .title = Lisćinu změniś
...
newtab-widget-section-show-widgets =
    .aria-label = Wótrězk asistentow pokazaś
    .title = Asistenty pokazaś
...
newtab-nova-customization-callout-message = Wuslěźćo swětłe abo śamne drastwy a slězynowe wobraze, kótarež wam zmóžnjaju, { -brand-product-name } pó wašych žycenjach wugótowaś.
newtab-nova-customization-callout-primary-button =
    .label = Wubjeŕśo swój wenkowny naglěd
...
newtab-clock-widget-add-custom = “{ $city }” ako swójski zeger pśidaś
# Text field for the display name of a user-added custom clock.
newtab-clock-widget-custom-city-input =
    .aria-label = Mě města
    .label = Mě města
    .placeholder = Mě toś togo zegera
# Searchable time-zone field shown when adding a custom clock. The user
# types a city they know and picks it to set the clock's time zone.
newtab-clock-widget-custom-timezone-input =
    .aria-label = Casowa cona
    .label = Casowa cona
    .placeholder = Pó měsće, casowej conje abo wótchylenju UTC pytaś
newtab-clock-widget-custom-zone-results =
    .aria-label = Wuslědki casoweje cony
# Shown in the time-zone picker when the search matches no time zones.
newtab-clock-widget-custom-zone-no-results = Žedne wótpowědne casowe cony
# Returns from the custom clock form back to the city search.
newtab-clock-widget-custom-back = Slědk
...
newtab-clock-city-de-berlin = Barliń
newtab-clock-city-de-munich = München
newtab-clock-city-de-frankfurt = Frankfurt nad Mainom
...
newtab-clock-city-lt-vilnius = Wilna
...
newtab-clock-city-vn-ho-chi-minh-city = Ho-Chi-Minh-město
