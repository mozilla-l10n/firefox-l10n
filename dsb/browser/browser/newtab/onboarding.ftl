...
onboarding-animation-pause-button =
    .aria-label = Animaciju zastajiś
onboarding-animation-play-button =
    .aria-label = Animaciju wótgraś
...
onboarding-checklist-remove =
    .label = Kontrolnu lisćinu wótwónoźeś
onboarding-checklist-remove-2 = Kontrolnu lisćinu wótwónoźeś
...
smartwindow-onboarding-subtitle = Zespominajśo, pśirownajśo a stajśo pšašanja, bźez togo aby se komuźił.
