...
extension-default-theme-description2 = Wuwažona, derje znata šero-purpurowa za klasiski naglěd { -brand-product-name }.
...
extension-nova-tide-name = Pśilew
