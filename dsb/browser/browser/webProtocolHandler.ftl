...
protocolhandler-mailto-os-handler-notificationbox = Pśecej { -brand-short-name } wužywaś, aby wótkaze wócynił, kótarež mejlki sćelu?
...
protocolhandler-mailto-handler-yes-button = Ako standard wužywaś
protocolhandler-mailto-handler-no-button = Nic něnto
