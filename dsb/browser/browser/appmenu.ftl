...
fxa-menu-sync-your-data = Synchronizěrujśo swóje daty
...
fxa-menu-sync-status-turn-on-button =
    .label = Zmóžniś
fxa-menu-sync-status-turn-on-button-aria-label = Zmóžniś
...
appmenu-sync-promo-signin =
    .heading = Wóstańśo synchrony na wšych rědach
appmenu-sync-promo-signin-cta = Pśizjawiś
appmenu-sync-promo-turnonsync =
    .heading = Synchronizěrujśo swóje rejtariki a historiju
appmenu-sync-promo-turnonsync-cta = Synchronizaciju zmóžniś
# This refers to getting tabs from your mobile device via sync
appmenu-sync-promo-connectdevice =
    .heading = Wobstarajśo se swóje mobilne rejtariki
appmenu-sync-promo-connectdevice-cta = Rěd zwězaś
appmenu-bookmarks-sync-promo-turnonsync =
    .heading = Wzejśo swóje cytańske znamjenja sobu
# This refers to having your bookmarks available on your mobile device via sync
appmenu-bookmarks-sync-promo-connectdevice =
    .heading = Wzejśo swóje cytańske znamjenja na droze
...
# use the browser. "Share" here means recommending or referring the browser
appmenu-referrals =
    .label = { -brand-shorter-name } źěliś
    .accesskey = l
appmenu-get-help =
...
appmenuitem-vpn-description5 = Dostańśo pśidatny šćit na rědach
...
fxa-menu-create-profile-description = Źaržćo swóje cytańske znamjenja, gronidła a historiju separatne za źěło a wósobinske pśeglědowanje.
fxa-menu-create-profile-confirm =
    .label = Nowy profil załožyś
fxa-menu-create-profile-learn-more =
    .label = Co su profile?
# Button in the account menu that links to the Referrals page
appmenuitem-share-firefox-title2 = { -brand-product-name } źěliś
# Button in the account menu that links to the Referrals page
appmenuitem-share-firefox-title = { -brand-short-name } źěliś
appmenuitem-share-firefox-description = Pśepšosujśo někogo, aby wobglědowak wubrał, kótaryž priwatnosć na prědne městno staja
appmenu-profiles-2 =
    .label = Profile
