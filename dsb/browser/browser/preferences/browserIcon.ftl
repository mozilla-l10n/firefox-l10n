...
appearance-browser-icon-entry-group =
    .label = Symbol wobglědowaka
    .description = Wubjeŕśo swójski symbol za swóju nadawkowu rědku, desktop a startowy meni.
appearance-browser-icon-button =
    .label = Symbol wobglědowaka změniś
...
appearance-browser-icon-requirement =
    .message = Wudopołniśo a wótblokěrujśo bonusowe lišcyne symbole, aby { -brand-short-name } personalizěrował.
...
appearance-browser-icon-momo =
    .label = Momo
    .description = Wót @heyheymomodraws napórany
