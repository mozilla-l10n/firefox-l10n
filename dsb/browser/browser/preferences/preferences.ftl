...
applications-setting =
    .label = Nałoženja
    .description = Wubjeŕśo, kak { -brand-short-name } ma z datajami wobchadaś, kótarež z interneta ześěgujośo abo z nałoženjami, kótarež pśi pśeglědowanju wužywaśo.
...
home-prefs-content-header2 = Wopśimjeśe { -firefox-home-brand-name }
...
history-remember-label2 = { -brand-short-name } buźo
# This label is followed, on the same line, by a dropdown list of options
# (Remember history, etc.).
# In English it visually creates a full sentence, e.g.
# "Firefox will" + "Remember history".
...
nimbus-rollouts-enabled-description = Změny budu se zdaloka nałožowaś.
