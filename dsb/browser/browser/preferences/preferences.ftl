...
tls-key-logging-notice-nav =
    .label = Nałoženje abo słužba móžo waš skoděrowany wobchad wiźeś.
category-list =
...
settings-keyboard-shortcuts-group =
    .description = Kontrolěrujśo, kak z { -brand-short-name } gibjośo a z nim interagěruośo.
...
personal-info-group =
    .label = Wósobinske informacije
autofill-personal-info-checkbox-message =
    .label = Wósobinske  informacije składowaś a awtomatiski wupołniś
autofill-personal-info-manage-button =
    .label = Wósobinske informacije zastojaś
...
preferences-doh-radio-group =
    .aria-label = DNS pśez HTTPS zmóžniś z pomocu:
...
preferences-ai-controls-speech-recognition-control =
    .description = Powědanje lokalnje transkriběrowaś.
    .label = Spóznaśe powědanja
preferences-ai-controls-sidebar-chatbot-group-3 =
    .description = Wobchowajśo chatbot we wócyma, gaž pśeglědujośo. Wubjeŕśo z někotarych póbitowarjow a změńśo kuždy cas.
    .label = Póbitowarje chatbot KI w bocnicy
preferences-ai-controls-sidebar-chatbot-group-2 =
    .description = Wobchowajśo chatbot w póglěźe, gaž pśeglědujośo. Wubjeŕśo z Anthropic Claude, ChatGPT, Copilot, Google Gemini a Mistral Vibe.
    .label = Póbitowarje chatbot KI w bocnicy
...
preferences-ai-controls-block-confirmation-speech-recognition = Spóznaśe powědanja
...
preferences-etp-level-radio-group =
    .aria-label = Pólěpšony slědowański šćit
...
preferences-etp-tracker-count-enabled =
    .label = Pśeslědowaki pokazaś, kótarež su w adresowem pólu blokěrowane
...
preferences-etp-custom-cookie-behavior-block-cross-site-tracking-cookies =
    .label = Sedła pśesegajuce slědujuce cookieje blokěrowaś
...
security-privacy-issue-warning-doh2 =
    .description = DNS pśez HTTPS pomaga pśed seśowym póbitowarjom schowaś, kótare sedła cośo se woglědaś.
    .label = DNS pśez HTTPS jo znjemóžnjony
security-privacy-issue-warning-ech2 =
    .description = Skoděrowany klient Hello pomaga pśed seśowym póbitowarjom schowaś, kótare sedła cośo se woglědaś.
    .label = Skoděrowany klient Hello jo znjemóžnjony
