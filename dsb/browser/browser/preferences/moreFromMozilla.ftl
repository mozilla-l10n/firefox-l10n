...
more-from-moz-title2 = Wěcej wót { -vendor-short-name }
    .title = Wěcej wót { -vendor-short-name }
...
more-from-moz-thunderbird-description = Dermotna e-mail, kalendaŕ a kontakty – na waš nałog organizěrowane.
more-from-moz-thunderbird-button = { -thunderbird-brand-short-name } wobstaraś
...
more-from-moz-new-products-description = Wuslěźćo nejnowše produkty { -vendor-short-name }.
more-from-moz-new-products-button = Woglědajśo se nowe produkty
