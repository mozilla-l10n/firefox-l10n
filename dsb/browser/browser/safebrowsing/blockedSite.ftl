...
safeb-blocked-phishing-page-short-desc = { -brand-short-name } jo toś ten bok blokěrował, dokulaž mógał was zawjedowaś, něco tšašne cynił, ako na pśikład software instalěrowaś abo wósobinske daty ako gronidła abo kreditowe kórty pśeraźiś.
