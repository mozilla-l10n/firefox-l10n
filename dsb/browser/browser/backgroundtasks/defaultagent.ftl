...
default-browser-notification-header-text = { -brand-short-name } dalej wužywaś?
default-browser-notification-body-text = Waš standardny wobglědowak jo se njedawno změnił. Pótusniśo, aby { -brand-short-name } do standarda wótnowił.
