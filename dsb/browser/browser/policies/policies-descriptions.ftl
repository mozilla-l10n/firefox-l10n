...
policy-DisableDefaultBrowserAgent = Haćće standardny agent wobhladowaka při wuwjedźenju akcijow. To je jenož za Windows k dispoziciji; druhe platformy agent nimaja.
