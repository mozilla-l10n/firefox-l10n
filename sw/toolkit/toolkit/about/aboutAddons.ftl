...
install-addon-from-file =
    .label = Sakinisha Vifaa vya nyongeza Kutoka kwa Fail…
    .accesskey = S
tools-menu =
    .tooltiptext = Zana za vifaa vyote vya nyongeza
cmd-show-details =
...
discover-title = Kifaa cha nyongeza ni nini?
discover-description = Vifaa vya nyongeza ni programu-tumizi ambazo hukuruhusu kubinafsisha { -brand-short-name } na utenda kazi wa ziada au staili. Jaribu mwambaa upande unaohifadhi wakati, kiarifisho cha hali ya hewa, au mwoneko mandhari kujenga { -brand-short-name } yako mwenyewe.
discover-footer = Wakatu imeunganishwa kwa mtandao, kidirisha hiki kitaonekana vifaa vya nyongeza bora zaidi na vinavyojulikana zaidi kwako ili uvijaribu.
detail-version =
    .label = Toleo
detail-last-updated =
