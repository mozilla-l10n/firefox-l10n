...
<html>
  <head>
    <title>Dati profiling JavaScript</title>
  </head>
  <style>
    .profile-file-title {
        font-size  : larger;
  ...
  <body>
    <h1>Dati profiling JavaScript</h1>
    <span class="label">Data di raccolta:</span>
    <span class="value">$full-date</span><br>
    <span class="label">User Agent:</span>
    <span class="value">$user-agent</span><br>
    <span class="label">Versione Debugger JavaScript:</span>
    <span class="value">$venkman-agent</span><br>
    <span class="label">Ordinati per:</span>
...
@-range-start
      <span class="range-box">
        ...
        [ <a href="#section$section-number-prev">File precedente</a> |
        <a href="#section$section-number-next">File successivo</a> |
        <a href="#range$section-number:$range-number-prev">Intervallo precedente</a> |
        <a href="#range$section-number:$range-number-next">Intervallo successivo</a> ]
@-item-start
...
@-section-end
    <hr>
    <a href="http://www.mozilla.org/projects/venkman/">Nessun progetto &egrave; troppo grande, nessun prezzo &egrave; troppo elevato.</a>
  </body>
</html>
