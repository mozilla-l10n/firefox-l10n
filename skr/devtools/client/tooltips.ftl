...
inactive-css-not-for-internal-table-elements-fix = ایندی <strong>ڈسپلے</strong> پراپرٹی کوں <strong>ٹیبل سیل</strong>، <strong>ٹیبل کالم</strong>، <strong>ٹیبل قطار</strong> دے علاوہ کہیں ٻئی چیز تے سیٹ کرݨ دی کوشش کرو۔ تکڑا>ٹیبل-کالم-گروپ</strong>، <strong>ٹیبل-رو-گروپ</strong>، یا <strong>ٹیبل-فوٹر-گروپ</strong>۔ { learn-more }
