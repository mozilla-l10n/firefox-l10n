...
policy-DisablePocket = ویب ورقیاں کوں Pocket وِچ ہتھیکڑا کرݨ کیتے خصوصیت کوں غیر فعال کرو۔
...
policy-FirefoxHome = فائر فاکس ہوم کوں ترتیب ݙیو۔
policy-FirefoxHome2 = { -firefox-home-brand-name } کوں ترتیب ݙیو۔
policy-FlashPlugin = فلیش پلگ ان دے استعمال دی اجازت ݙیو یا انکار کرو۔
