...
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-description = اپݨے ڈیٹا کوں ہر ہک کیتے بہتر انٹرنیٹ کیتے استعمال کرو۔
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-description-advanced = اپݨا ڈیٹا ریسرچ اسٹڈیز کیتے عطیہ کرو جیڑھا ہک محفوظ، زیادہ کھلا انٹرنیٹ بݨاوݨ کیتے کم کریندے پئے ہن جیڑھا لوکاں دی مدد کریندا ہے، نہ کہ Big Tech۔
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-button-mozilla-rally-2 = { -rally-short-name } شامل تھیوو
