...
pp-empty-warning = تہاݙے محفوظ کردہ پاس ورڈز تے پرائیویٹ کنجیاں محفوظ کائنا ہوسن۔
pp-erased-ok = تساں آپݨا منڈھلا پاس ورڈ مٹا ݙتا ہے۔ { pp-empty-warning }
pp-not-wanted = چتاوݨی: تساں منڈھلا پاس ورڈ استعمال نہ کرݨ دا فیصلہ کیتا ہے۔ { pp-empty-warning }
