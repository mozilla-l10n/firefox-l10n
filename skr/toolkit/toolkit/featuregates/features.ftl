...
experimental-features-css-constructable-stylesheets =
    .label = CSS: قابل تعمیر سٹائل شیٹاں
experimental-features-css-constructable-stylesheets-description = <a data-l10n-name="mdn-cssstylesheet">CSSStyleSheet</a> انٹرفیس وِچ کنسٹرکٹر دے وادھے دے نال نال متعدد متعلقہ تبدیلیاں شیٹ کوں شامل کیتے بغیر براہ راست نویاں سٹائل شیٹاں بݨاوݨ ممکن بݨیندیاں ہن۔ ایچ ٹی ایم ایل ایہ <a data-l10n-name="mdn-shadowdom">Shadow DOM</a> دے نال استعمال کیتے دوبارہ قابل استعمال سٹائل شیٹس بݨاوݨ ٻہوں آسان بݨیندا ہے۔ ودھیک تفصیلاں کیتے <a data-l10n-name="bugzilla"> بگ 1520690</a> ݙیکھو۔
...
experimental-features-cookie-samesite-lax-by-default2 =
    .label = کوکیاں: SameSite=Lax بذریعہ ڈیفالٹ
experimental-features-cookie-samesite-lax-by-default2-description = کوکیاں کوں بطور ڈیفالٹ "SameSite=Lax" سمجھو جے کوئی "SameSite" وصف متعین نہیں کیتا ڳیا۔ ڈیولپرز کوں واضح طور تے "SameSite=None" دا دعویٰ کریندے ہوئے غیر محدود استعمال دے موجودہ جمود دا انتخاب کرݨا چاہیدا ہے۔
# Do not translate 'SameSite', 'Lax' and 'None'.
...
experimental-features-cookie-samesite-schemeful =
    .label = کوکیاں: سکیم فل SameSite
experimental-features-cookie-samesite-schemeful-description = ہک ای ڈومین دیاں کوکیاں دا علاج کرو، لیکن مختلف سکیماں دے نال (جیویں http://example.com تے https://example.com) کوں ہک ای سائٹ دے بجائے کراس سائٹ دے طور تے۔ سیکیورٹی کوں بہتر بݨیندا ہے، لیکن ممکنہ طور تے بھڄ ترٹ کوں متعارف کریندا ہے۔
