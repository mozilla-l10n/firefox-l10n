...
colorpicker-tooltip-spectrum-dragger-title = 스펙트럼
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = 페이지에서 색상 선택
...
colorpicker-tooltip-color-name-title = 가장 가까운 색상: { $colorName }
# A title text for the hue slider in the color picker tooltip.
colorpicker-tooltip-hue-slider-title = 색상
...
inspector-emulation-panel-toggle =
    .title = CSS 에뮬레이션 기능 전환
    .aria-label = CSS 에뮬레이션 기능 전환
inspector-emulation-panel-color-scheme = 색 구성표 에뮬레이션
# A label text for the print emulation options
inspector-emulation-panel-print = 사용함
    .aria-label = 인쇄 매체 에뮬레이션 사용
# A label text for the light color scheme emulation radio button option.
inspector-emulation-panel-color-scheme-light = 밝게
    .aria-label = 밝은 색상 구성표 에뮬레이션을 사용
