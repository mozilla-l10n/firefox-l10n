...
plugins-openh264-description = 이 플러그인은 WebRTC 표준을 따르고 H.264 동영상 코덱을 필요로 하는 기기로 부터의 WebRTC 통신을 활성화하기 위해서 Mozilla에 의해서 설치되었습니다. 코덱 소스 코드와 구현에 대한 내용을 확인하기 위해서는 https://www.openh264.org/ 를 방문하세요.
...
mlmodel-addon-detail-last-used-label = 최근 사용
...
find-more-addons-promo =
    .heading = 나만의 { -brand-product-name } 스타일 만들기
    .message = 필요와 취향에 맞게 도구와 스타일을 추가하세요.
find-more-addons-promo-open-amo-button = 확장 기능 및 테마 살펴보기
