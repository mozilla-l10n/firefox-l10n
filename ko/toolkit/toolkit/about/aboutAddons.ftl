...
details-notification-softblocked-extension-disabled =
    .message = 이 확장 기능은 Mozilla 정책을 위반하여 비활성화되었습니다. 활성화 할 수 있지만, 위험 할 수 있습니다.
details-notification-softblocked-extension-enabled =
    .message = 이 확장 기능은 Mozilla의 정책을 위반합니다. 위험 할 수 있습니다.
details-notification-softblocked-other-disabled =
    .message = 이 부가 기능은 Mozilla 정책을 위반하여 비활성화되었습니다. 활성화 할 수 있지만, 위험 할 수 있습니다.
details-notification-softblocked-other-enabled =
    .message = 이 부가 기능은 Mozilla의 정책을 위반합니다. 위험 할 수 있습니다.
