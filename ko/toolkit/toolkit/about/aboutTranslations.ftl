...
about-translations-title = { -brand-short-name } 번역
...
about-translations-detected-language-unsupported-heading-2 = 죄송합니다. 아직 { $language } 번역은 지원하지 않습니다
about-translations-detected-language-unsupported-heading-unknown-2 = 죄송합니다. 아직 이 언어 번역은 지원하지 않습니다
