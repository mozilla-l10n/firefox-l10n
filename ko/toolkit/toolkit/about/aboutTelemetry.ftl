...
about-telemetry-addon-details-section = 부가 기능 상세
about-telemetry-captured-stacks-section = 스택 캡처
about-telemetry-late-writes-section = 최종 작성
about-telemetry-raw-payload-section = 원본 페이로드
about-telemetry-raw = 원본 JSON
about-telemetry-full-sql-warning = 주의E: 느린 SQL 디버깅이 시작합니다. 전체 SQL 문자열이 표시되나 데이터 측정에는 포함되지 않습니다.
about-telemetry-fetch-stack-symbols = 스택에 대한 함수 이름 가져오기
about-telemetry-hide-stack-symbols = 원본 스택 데이터 보기
...
about-telemetry-settings-explanation = 텔레메트리가 { about-telemetry-data-type }를 모으고 있고 업로드는 <a data-l10n-name="upload-link">{ about-telemetry-upload-type }</a>입니다.
# Variables:
...
about-telemetry-addon-table-details = 상세
# Variables:
#   $addonProvider (String): the name of an Add-on Provider (e.g. “XPI”, “Plugin”)
about-telemetry-addon-provider = { $addonProvider } 제작
about-telemetry-keys-header = 프로퍼티
...
about-telemetry-error-fetching-symbols = 심볼을 가져오는데 오류가 생겼습니다. 인터넷 연결을 확인해 보시고 다시 시도해 주십시오.
...
about-telemetry-origin-count = 카운트
# Variables:
#   $telemetryServerOwner (String): the value of the toolkit.telemetry.server_owner preference. Typically "Mozilla"
