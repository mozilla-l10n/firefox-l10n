...
crashreporter-crash-message = { -brand-short-name }에 문제가 있어 충돌이 발생했습니다
...
crashreporter-error = { -brand-short-name }에 문제가 있어 충돌이 발생했습니다. 불행하게도 충돌 보고자는 이 충돌에 대한 보고서를 제출할 수 없습니다.
