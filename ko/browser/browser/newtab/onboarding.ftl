...
tab-groups-onboarding-create-group-title = 탭 표시줄이나 주소 표시줄에서 검색하여 열려 있는 그룹을 찾으세요.
tab-groups-onboarding-saved-groups-title = 탭 그룹을 닫으면, 여기에서 언제든지 다시 열 수 있습니다.
tab-groups-onboarding-saved-groups-no-alltabs-button-title = 주소 표시줄에서 검색하여 언제든지 열려 있거나 닫은 탭 그룹을 찾으세요.
