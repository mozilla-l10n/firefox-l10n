...
identity-credential-policy-description = { $provider } 계정으로 { $host }에 로그인하면 해당 계정의 <label data-l10n-name="privacy-url">개인정보처리방침</label> 및 <label data-l10n-name="tos-url">이용 약관</label>이 적용됩니다.
