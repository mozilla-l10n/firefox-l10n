...
urlbar-searchmode-dropmarker2 =
    .title = 검색 엔진 선택
urlbar-searchmode-bookmarks4 = 북마크
urlbar-searchmode-tabs4 = 탭
urlbar-searchmode-history4 = 기록
urlbar-searchmode-actions4 = 작업
...
urlbar-searchmode-popup-search-settings2 = 검색 설정
urlbar-searchmode-popup-settings2 = 설정
...
urlbar-view-context-menu-open-in-private-window =
    ...
    .accesskey = P
urlbar-view-context-menu-open-in-tab2 = 새 탭에서 열기
    .accesskey = w
urlbar-view-context-menu-open-in-container-tab2 = 새 컨테이너 탭에서 열기
    .accesskey = i
urlbar-view-context-menu-open-in-window2 = 새 창에서 열기
    .accesskey = N
...
urlbar-trust-icon-trackers-blocked-longform-label = 추적기 { $count }개 차단됨
