...
fx-view-discoverability-title = 탭을 닫으려는 거 아니신가요?
fx-view-discoverability-subtitle = 여기에서 빠르게 찾아서 다시 엽니다. 최근에 닫은 탭의 기록이 유지됩니다.
fx-view-discoverability-primary-button-label = { -firefoxview-brand-name } 열기
fx-view-discoverability-secondary-button-label = 닫기
...
login-status-advisory-title = 로그아웃되었습니다. 계정 아이콘을 눌러서 로그인하세요.

## Bookmarks toolbar callout strings

bookmarks-toolbar-callout-1-title = 이 사이트를 북마크 도구 모음에 추가하시겠습니까?
bookmarks-toolbar-callout-1-subtitle = 빠르게 접근할 수 있도록 북마크가 주소 표시줄 바로 아래에 저장됩니다.
bookmarks-toolbar-callout-1-primary-button-label = 북마크 추가
...
sidebar-callout-survey-dissatisfied-2 = 불만족
sidebar-callout-survey-very-dissatisfied-2 = 매우 불만족
...
sidebar-callout-survey-split-view = 두 웹 사이트를 나란히 분할해서 보기
