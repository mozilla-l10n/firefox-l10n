...
default-browser-notification-privacy-header-text = { -brand-short-name }를 계속 사용하시겠습니까?
default-browser-notification-privacy-body-text = 기본값이 변경되었습니다. { -brand-short-name }로 돌아와서 사생활 보호와 보호 기능을 경험하세요.
default-browser-notification-header-text = { -brand-short-name }를 계속 사용하시겠습니까?
default-browser-notification-body-text = 최근에 기본 브라우저가 변경되었습니다. { -brand-short-name }를 기본 브라우저로 복원하려면 탭하세요.
default-browser-notification-yes-button-text = 예
default-browser-notification-privacy-no-button-text = 아니요
