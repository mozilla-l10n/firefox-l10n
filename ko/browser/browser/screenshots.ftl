...
screenshots-request-error-details = 죄송합니다. 스크린샷을 저장하지 못했습니다. 잠시 후에 다시 시도해주세요.
screenshots-connection-error-title = 스크린샷에 접속할 수 없습니다.
screenshots-connection-error-details = 인터넷 연결 상태를 확인해주세요. 만약 인터넷이 연결돼있다면, { -screenshots-brand-name } 서비스에 잠깐 문제가 있을 수도 있습니다.
screenshots-login-error-details = { -screenshots-brand-name } 서비스에 잠시 문제가 있어 저장에 실패했습니다. 잠시 후에 다시 시도해주세요.
screenshots-unshootable-page-error-title = 이 페이지를 캡처할 수 없습니다.
