...
contextual-manager-passwords-origin-field-description = 이 사이트에 로그인할 정확한 주소를 입력하세요.
contextual-manager-passwords-username-field =
    .label = 사용자 이름
contextual-manager-passwords-username-field-description = 사용자 이름, 이메일 주소 또는 로그인할 때 사용한 계정 번호를 입력하세요.
contextual-manager-passwords-password-field =
    .label = 비밀번호
contextual-manager-passwords-password-field-description = 이 계정에 로그인하려면 비밀번호를 입력하세요.
