...
settings-update-unsupported = 이 시스템에서는 더 이상 업데이트를 할 수 없습니다.<a data-l10n-name="unsupported-link">더 알아보기</a>
...
settings-update-internal-error = 내부 오류로 인해 업데이트를 확인할 수 없습니다. <a data-l10n-name="manual-link">{ $displayUrl }</a>에서 업데이트  가능합니다.
...
helpus-referrals2 = 도움을 주고 싶으신가요? <label data-l10n-name="helpus-donateLink">기부하기</label>, <label data-l10n-name="helpus-shareFirefoxLink">{ -brand-product-name } 추천하기</label>, 또는 <label data-l10n-name="helpus-getInvolvedLink">참여하기</label>
helpus-referrals = 도움을 주고 싶으신가요? <label data-l10n-name="helpus-donateLink">기부하기</label>, <label data-l10n-name="helpus-shareFirefoxLink">{ -brand-short-name } 추천하기</label>, 또는 <label data-l10n-name="helpus-getInvolvedLink">참여하기</label>
