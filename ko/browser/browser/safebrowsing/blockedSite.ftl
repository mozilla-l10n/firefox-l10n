...
safeb-blocked-malware-page-learn-more = <a data-l10n-name='learn_more_link'>StopBadware.org</a>에서 바이러스와 다른 악성코드를 포함하고 있는 유해한 웹 콘텐츠와 컴퓨터를 보호하는 방법에 대해 더 알아보세요. <a data-l10n-name='firefox_support'>support.mozilla.org</a>에서 { -brand-short-name }의 피싱과 악성코드 방지에 대해 더 알아보세요.
