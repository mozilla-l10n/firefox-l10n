...
item-history-and-downloads =
    .label = 방문 및 다운로드 기록
    .accesskey = B
item-history-and-downloads-description = 검색, 사이트 및 다운로드 기록을 지웁니다.
item-history-form-data-downloads =
    .label = 기록
    .accesskey = H
item-history-form-data-downloads-description = 사이트 및 다운로드 기록과 저장된 양식 정보 및 검색을 지웁니다.
item-cookies =
    .label = 쿠키
    .accesskey = C
# Variables:
...
item-cookies-site-data =
    .label = 쿠키 및 사이트 데이터
    .accesskey = e
item-cookies-site-data-description = 사이트에서 로그아웃되거나 장바구니를 비우게 될 수 있습니다.
item-active-logins =
    .label = 활성 로그인
    .accesskey = L
item-cache =
...
item-formdata-prefs =
    .label = 저장된 양식 정보
    .accesskey = o
item-site-prefs-description = 권한 및 사이트 설정을 원래대로 재설정합니다.
