...
failed-pp-change = Klarte ikke endre primærpassordet.
incorrect-pp = Du skrev ikke inn riktig gjeldende primærpassord. Prøv igjen.
...
pp-not-wanted = Advarsel! Du har valgt å ikke bruke et primærpassord. { pp-empty-warning }
pp-change2empty-in-fips-mode = Du er for tiden i FIPS-modus. FIPS krever at du bruker et primærpassord.
...
primary-password-admin = Administratoren din krever at du har et primærpassord for å lagre passord.
