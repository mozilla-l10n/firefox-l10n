...
neterror-search-cta-intro2 = Klarte ikke å koble til serveren på <strong>{ $hostname }</strong>.
...
neterror-search-cta-offline = Du ser ut til å være frakoblet. Koble til igjen og prøv på nytt.
...
neterror-search-cta-learn-more = Les mer
...
neterror-sslkeylogging-warning =
    .heading = Tilkoblingen er kanskje ikke privat
    .message = En app eller tjeneste kan se den krypterte trafikken din fra dette nettstedet.
