...
about-httpsonly-insecure-explanation-unavailable = Du surfer i moduset «Bare HTTPS» (HTTPS-Only), og en sikker HTTPS-versjon av <em>{ $websiteUrl }</em> er ikke tilgjengelig.
...
# Variables:
#   $websiteUrl (String) - Url of the website that failed to load. Example: www.example.com
about-httpsonly-explanation-unavailable = Du surfer i moduset «Bare HTTPS» (HTTPS-Only), og en sikker HTTPS-versjon av <em>{ $websiteUrl }</em> er ikke tilgjengelig.
