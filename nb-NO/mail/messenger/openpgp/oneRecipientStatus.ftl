...
openpgp-one-recipient-status-instruction2 = For å få den offentlige nøkkelen, importer dem fra e-post de har sendt til deg, og som inkluderer den. Alternativt kan du prøve å finne den offentlige nøkkelen i en katalog.
