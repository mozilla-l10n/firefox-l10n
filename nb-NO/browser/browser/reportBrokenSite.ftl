...
report-broken-site-panel-url-label = Nettadresse til nettstedet som ikke fungerer
...
report-broken-site-panel-reason-optional-label = Hva er ødelagt? (valgfritt)
...
report-broken-site-panel-description =
    .placeholder = Hva skjedde? Hva burde ha skjedd? Hjalp det å slå av sporingsbeskyttelsen?
...
report-broken-site-panel-blocked-trackers-description = Utvidet sporingsbeskyttelse kan blokkere sporere og skript som enkelte nettsteder trenger for å fungere ordentlig.
