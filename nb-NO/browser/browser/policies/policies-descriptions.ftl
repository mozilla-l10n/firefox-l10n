...
policy-ClearOnShutdown = Fjern nettleserdata når { -brand-short-name } lukkes.
...
policy-DefaultBrowserSettingEnabled = Kontroller om brukeren kan angi { -brand-short-name } som standardnettleser.
...
policy-DisableLaunchOnLogin = Hindre at { -brand-short-name } starter automatisk når brukeren logger inn.
