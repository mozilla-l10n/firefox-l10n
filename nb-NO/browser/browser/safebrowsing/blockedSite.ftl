...
safeb-blocked-phishing-page-short-desc = { -brand-short-name } blokkert denne siden fordi det kan få deg til å gjøre noe farlig som å installere programvare eller avsløre personlig informasjon som passord eller kredittkort.
safeb-blocked-malware-page-short-desc = { -brand-short-name } blokkert denne siden fordi den kan forsøke å installere skadelig programvare som kan stjele eller slette personlig informasjon på datamaskinen din.
