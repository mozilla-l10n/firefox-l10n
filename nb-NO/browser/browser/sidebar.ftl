...
sidebar-show-preview-on-hover =
    .label = Vis forhåndsvisning når du holder musepekeren over
...
sidebar-opentabs-preview-heading = Nylige faner
...
sidebar-opentabs-title = Åpne faner
