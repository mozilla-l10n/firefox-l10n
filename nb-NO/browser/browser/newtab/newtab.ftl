...
newtab-privacy-etp-off-faster-browsing = Raskere surfing. Færre sporere.
newtab-privacy-etp-off-turn-on-tracking = Slå på sporingsbeskyttelse i innstillingene for å starte blokkering.
...
newtab-privacy-message-info-3 = Mange nettsteder har sporere som gjør at selskaper du aldri har besøkt, kan følge deg på nettet.
newtab-privacy-message-info-3-cta = Vis beskyttelser
newtab-privacy-message-info-4 = Når du velger { -brand-short-name }, velger du beskyttelse som standard.
newtab-privacy-message-info-4-cta = Vis beskyttelser
newtab-privacy-message-info-5 = Blokkerte sporere betyr at færre selskaper kan følge deg på tvers av nettsteder.
newtab-privacy-message-info-5-cta = Vis beskyttelser
newtab-privacy-message-info-6 = Behold kontrollen over dataene dine med { -brand-short-name }. Vi selger dem aldri, men det kan andre nettlesere gjøre.
...
newtab-stocks-search-button =
    .label = Søk
    .title = Søk etter navn eller symbol
    .aria-label = Søk etter navn eller symbol
...
newtab-stocks-list-watchlist = Overvåkningsliste
...
newtab-stocks-add-to-watchlist =
    .aria-label = Legg til { $name } i overvåkningslisten
    .title = Legg til { $name } i overvåkningslisten
# Tooltip and screen-reader label for the button that removes a stock from the watchlist.
# The button shows only an icon and never renders visible text.
# Variables:
#   $name (String) - the fund/ETF name.
newtab-stocks-remove-from-watchlist =
    .aria-label = Fjern { $name } fra overvåkningslisten
    .title = Fjern { $name } fra overvåkningslisten
...
# Variables:
#   $name (String) - the fund/ETF name.
newtab-stocks-in-watchlist = { $name } er på overvåkningslisten din
# Announced to screen readers after a stock is added to the watchlist.
# Variables:
#   $name (String) - the fund/ETF name.
newtab-stocks-added-to-watchlist = La til { $name } på overvåkningslisten
# Announced to screen readers after a stock is removed from the watchlist.
# Variables:
#   $name (String) - the fund/ETF name.
newtab-stocks-removed-from-watchlist = Fjernet { $name } fra overvåkningslisten
...
newtab-stocks-search-input =
    .aria-label = Søk etter navn eller symbol
    .placeholder = Søk etter navn eller symbol
...
newtab-spaces-tab-stories = Artikler
newtab-spaces-tab-widgets = Widgeter
...
newtab-topsites-use-custom-image-link = Bruk et tilpasset bilde
...
newtab-carousel-pause =
    .aria-label = Sett automatisk avspilling på pause
# Button that resumes autoplay on the carousel.
newtab-carousel-play =
    .aria-label = Gjenoppta automatisk avspilling
...
newtab-appearance-explore-more-themes-button = Utforsk flere temaer
