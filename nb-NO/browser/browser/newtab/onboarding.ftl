...
onboarding-live-language-subtitle = { -brand-short-name } bruker { $appLanguage } mens systemet ditt bruker { $systemLanguage }.
onboarding-live-language-switch-button-label = Bytt til { $negotiatedLanguage }
onboarding-live-language-button-label-downloading = Laster ned språkpakken for { $negotiatedLanguage }…
onboarding-live-language-waiting-subtitle = Det ser ut til at systemet ditt og { -brand-short-name } bruker forskjellige språk.
...
onboarding-live-language-not-now-button-label = Ikke nå
