...
launch-on-login-spotlight-title = Åpne { -brand-short-name } neste gang datamaskinen starter opp?
launch-on-login-spotlight-startup-checkbox = Start { -brand-short-name } ved oppstart
launch-on-login-spotlight-pin-taskbar-checkbox = Fest til oppgavelinjen
# This checkbox label intentionally matches “startup-restore-windows-and-tabs”
# in the Settings (preferences.ftl). Localizers can reuse the existing
# translation suggested by translation memory.
launch-on-login-spotlight-restore-checkbox = Åpne tidligere vinduer og faner
launch-on-login-spotlight-primary-button = Lagre og lukk { -brand-short-name }
...
windows-10-eos-global-infobar-title = <strong>Microsoft støtter ikke lenger Windows 10.</strong> Sikkerhetskopier informasjonen din for å gjøre { -brand-product-name } klar for Windows 11.
windows-10-eos-global-infobar-primary-button = Slå på sikkerhetskopiering
    .accesskey = S
windows-10-eos-global-infobar-learn-more-link = Les mer
    .accessKey = L
...
nova-early-access-infobar-title = <strong>{ -brand-product-name } får et nytt utseende.</strong> Du ser en tidlig og uferdig versjon før lanseringen senere i år.
nova-early-access-share-feedback-link = Del tilbakemelding
    .accesskey = D
nova-early-access-infobar-primary-button = Jeg forstår
    .accesskey = J
...
lapsed-user-toast-title = { -brand-product-name } passer fortsatt på deg
lapsed-user-toast-subtitle = Sjekk ut nye måter du kan surfe på med flere valgmuligheter, mer personvern og kontroll.
lapsed-user-toast-whats-new-button = Se hva som er nytt
...
refresh-unused-profile-infobar-message = Det ser ut som du ikke har startet { -brand-short-name } på en stund. Vil du renske den slik at du får en frisk, som-ny opplevelse? Og forresten, velkommen tilbake!
refresh-reinstalled-profile-infobar-message = Ser ut som at du har installert { -brand-short-name } på nytt. Vil du at vi skal rydde opp slik at du får en frisk, som-ny-opplevelse?
refresh-profile-infobar-button = Nullstill { -brand-short-name } …
    .accesskey = u
