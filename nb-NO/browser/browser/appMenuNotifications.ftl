...
appmenu-update-other-instance =
    ...
    .secondarybuttonlabel = Ikke nå
    .secondarybuttonaccesskey = n
appmenu-update-other-instance-message = En ny { -brand-shorter-name }-oppdatering er tilgjengelig, men den kan ikke installeres fordi en annen kopi av { -brand-shorter-name } kjører. Lukk den for å fortsette oppdateringen, eller velg å oppdatere uansett (den andre kopien fungerer kanskje ikke riktig før du starter den på nytt).
