...
extension-default-theme-description2 = En balansert, velkjent grålilla farge for et klassisk { -brand-product-name }-utseende.
...
extension-nova-tide-name = Tidevann
