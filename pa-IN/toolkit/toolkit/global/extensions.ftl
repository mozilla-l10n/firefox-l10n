...
webext-site-perms-header-with-gated-perms-serial = ਇਹ ਐਡ-ਆਨ ਤੁਹਾਡੇ ਸੀਰੀਅਸ ਡਿਵਾਈਸਾਂ ਵਾਸਤੇ { $hostname } ਨੂੰ ਪਹੁੰਚ ਦਿੰਦੀ ਹੈ।
...
webext-site-perms-description-gated-perms-webserial =
    ਇਹ ਉਹ ਡਿਵਾਈਸ ਜਿਵੇਂ ਮਾਈਕਰੋ-ਕੰਟਰੋਲਰ, 3ਡੀ ਪਰਿੰਟਰ ਅਤੇ ਹੋਰ ਡਿਵਾਈਸ ਹਨ, ਜੋ ਕਿ USB, ਸੀਰੀਅਸ ਪੋਰਟ, ਬਲੂਟੁੱਥ ਰਾਹੀਂ ਕਨੈਕਟ ਹੁੰਦੇ ਹਨ।
    
    ਤੁਸੀਂ ਚੁਣ ਸਕਦੇ ਹੋ ਕਿ ਕਿਹੜੇ ਡਿਵਾਈਸਾਂ ਨੂੰ ਵੈੱਬਸਾਈਟ ਪਹੁੰਚ ਕਰ ਸਕਦੀ ਹੈ।
    
    ਵੈੱਬਸਾਈਟਾਂ ਨੂੰ ਅਕਸਰ ਸੀਰੀਅਸ ਡਿਵਾਈਸਾਂ ਲਈ ਪਹੁੰਚ ਦੀ ਮਨਜ਼ੂਰ ਨਹੀਂ ਹੁੰਦੀ ਹੈ। ਅਢੁੱਕਵੀਂ ਵਰਤੋਂ ਨਾਲ ਨੁਕਸਾਨ ਜਾਂ ਸੁਰੱਖਿਆ ਨਾਲ ਸਮਝੌਤਾ ਹੋ ਸਕਦਾ ਹੈ।
webext-site-perms-description-gated-perms-serial =
    ਇਹ ਉਹ ਡਿਵਾਈਸ ਜਿਵੇਂ ਮਾਈਕਰੋ-ਕੰਟਰੋਲਰ, 3ਡੀ ਪਰਿੰਟਰ ਅਤੇ ਹੋਰ ਡਿਵਾਈਸ ਹਨ, ਜੋ ਕਿ USB ਜਾਂ ਸੀਰੀਅਸ ਪੋਰਟ ਰਾਹੀਂ ਕਨੈਕਟ ਹੁੰਦੇ ਹਨ।
...
webext-site-perms-serial = ਸੀਰੀਅਲ ਡਿਵਾਈਸਾਂ ਲਈ ਪਹੁੰਚ
