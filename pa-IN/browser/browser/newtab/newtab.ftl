...
# Shown when no trackers have been blocked yet today.
newtab-privacy-empty-state = ਤੁਹਾਡੀਆਂ ਸਰਗਰਮੀ ਨੂੰ ਵੱਧ ਪ੍ਰਾਈਵੇਟ ਰੱਖਣ ਲਈ { -brand-short-name } ਆਪਣੇ-ਆਪ ਹੀ ਟਰੈਕਰਾਂ ਉੱਤੇ ਪਾਬੰਦੀ ਲਾਉਂਦਾ ਹੈ।
# "A running tally" is an informal way to say a total that keeps updating as it goes.
# Here we are referring to the number of trackers blocked, which increases as the user browses.
# An alternative can be "See a running total here"
newtab-privacy-empty-state-tally = ਮੌਜੂਦਾ ਅੰਕੜਿਆਂ ਨੂੰ ਇੱਥਏ ਵੇਖੋ।
...
newtab-stocks-list-markets = ਬਾਜ਼ਾਰ
    .label = ਬਾਜ਼ਾਰ
...
newtab-stocks-list-watchlist = ਨਿਗਰਾਨ-ਸੂਚੀ
    .label = ਨਿਗਰਾਨ-ਸੂਚੀ
# Context menu item that opens the stock search (by company name or ticker symbol).
newtab-stocks-menu-search-stocks = ਨਾਂ ਜਾਂ ਨਿਸ਼ਾਨ ਨਾਲ ਲੱਭੋ
...
newtab-stocks-search-input =
    ...
    .placeholder = ਨਾਂ ਜਾਂ ਨਿਸ਼ਾਨ ਨਾਲ ਲੱਭੋ
...
newtab-wallpaper-add-an-image = ਚਿੱਤਰ ਨੂੰ ਜੋੜੋ
...
newtab-wallpaper-your-images = ਤੁਹਾਡੇ ਚਿੱਤਰ
...
newtab-wallpaper-your-images-folder =
    .aria-label = ਤੁਹਾਡੇ ਚਿੱਤਰ, ਵਾਲਪੇਪਰ, ਜੋ ਤੁਸੀਂ ਸੰਭਾਲੇ ਹਨ
...
newtab-wallpaper-your-images-item-numbered = ਚਿੱਤਰ { $number }
...
newtab-section-unfollow-topic =
    .aria-label = { $topic } ਨੂੰ ਅਣ-ਫ਼ਾਲੋ ਕਰੋ
# Variables:
...
newtab-section-block-cancel-button = ਰੱਦ ਕਰੋ
...
newtab-toast-widgets-hidden =
    .message = ਵਿਜੈਟ ਨੂੰ ਕਿਸੇ ਵੀ ਵੇਲੇ ਵਾਪਸ ਜੋੜ ਲਈ ਪਿਨਸਲ ਵਾਲੇ ਆਈਕਾਨ ਨੂੰ ਚੁਣੋ।
# Variables:
#   $topic (string) - Topic that the user has followed
newtab-section-toast-follow =
    .message = ਤੁਸੀਂ ਹੁਣ { $topic } ਨੂੰ ਫ਼ਾਲੋ ਕਰ ਰਹੇ ਹੋ।
# Variables:
#   $topic (string) - Topic that the user has unfollowed
newtab-section-toast-unfollow =
    .message = ਤੁਸੀਂ { $topic } ਨੂੰ ਫ਼ਾਲੋ ਨਹੀਂ ਕਰ ਰਹੇ ਹੋ।
# Variables:
#   $topic (string) - Topic that the user has blocked
newtab-section-toast-block =
    .message = ਤੁਸੀਂ ਹੁਣ { $topic } ਬਾਰੇ ਲੇਖ ਨਹੀਂ ਵੇਖੋਗੇ।
...
newtab-widget-lists-celebration-headline = ਵਧੀਆ ਕੰਮ
newtab-widget-lists-celebration-subhead = ਸਭ ਨੂੰ ਮਿਟਾਓ
...
newtab-clock-city-us-san-diego = ਸਾਨ ਦੀਏਗੋ
newtab-clock-city-us-dallas = ਡਾਲਸ
newtab-clock-city-us-houston = ਹੂਸਟਨ
newtab-clock-city-us-philadelphia = ਫਿਲਾਡੇਲਫਿਆ
...
newtab-clock-city-us-anchorage = ਐਂਕਰੇਜ
newtab-clock-city-de-berlin = ਬਰਲਿਨ
newtab-clock-city-de-munich = ਮਿਊਨਿਖ
newtab-clock-city-de-frankfurt = ਫ਼ਰਾਂਕਫ਼ੁਰਟ
newtab-clock-city-de-hamburg = ਹਾਮਬੁਰਗ
newtab-clock-city-fr-paris = ਪੈਰਿਸ
newtab-clock-city-fr-lyon = ਲਿਓਂ
newtab-clock-city-fr-marseille = ਮਾਰਸੇਈ
newtab-clock-city-fr-toulouse = ਟੁਲੂਜ਼
newtab-clock-city-in-kolkata = ਕੋਲਕਾਤਾ
newtab-clock-city-in-mumbai = ਮੁੰਬਈ
newtab-clock-city-in-delhi = ਦਿੱਲੀ
newtab-clock-city-in-bangalore = ਬੰਗਲੌਰ
newtab-clock-city-cn-shanghai = ਸ਼ੰਘਾਈ
newtab-clock-city-cn-beijing = ਬੀਜਿੰਗ
newtab-clock-city-cn-shenzhen = ਸ਼ੈਨਜ਼ੈਨ
newtab-clock-city-br-sao-paulo = ਸਾਓ ਪਾਓਲੋ
...
newtab-clock-city-ca-vancouver = ਵੈਨਕੂਵਰ
newtab-clock-city-au-sydney = ਸਿਡਨੀ
newtab-clock-city-au-perth = ਪਰਥ
newtab-clock-city-au-adelaide = ਐਡਲੇਡ
newtab-clock-city-pl-warsaw = ਵਾਰਸਾ
newtab-clock-city-pl-krakow = ਕਰਾਕੋਵ
newtab-clock-city-jp-tokyo = ਟੋਕੀਓ
newtab-clock-city-jp-osaka = ਓਸਾਕਾ‎
newtab-clock-city-mx-mexico-city = ਮੈਕਸੀਕੋ ਸ਼ਹਿਰ
newtab-clock-city-mx-guadalajara = ਗੁਆਦਾਲਾਹਾਰਾ
newtab-clock-city-it-rome = ਰੋਮ
newtab-clock-city-it-milan = ਮਿਲਾਨ
newtab-clock-city-ru-moscow = ਮਾਸਕੋ
newtab-clock-city-ru-saint-petersburg = ਸੇਂਟ ਪੀਟਰਸਬਰਗ
newtab-clock-city-gb-london = ਲੰਦਨ
newtab-clock-city-gb-birmingham = ਬਰਮਿੰਘਮ
newtab-clock-city-es-madrid = ਮਾਦਰਿਦ
newtab-clock-city-es-barcelona = ਬਾਰਸੀਲੋਨਾ‎
newtab-clock-city-nl-amsterdam = ਅਮਸਤਰਦਮ
newtab-clock-city-ch-zurich = ਜਿਊਰਿਖ
newtab-clock-city-at-vienna = ਵਿਆਨਾ
newtab-clock-city-cz-prague = ਪ੍ਰਾਗ
newtab-clock-city-ar-buenos-aires = ਬੁਏਨਸ ਆਇਰਸ
newtab-clock-city-gr-athens = ਐਥਨਜ਼
newtab-clock-city-hu-budapest = ਬੁਦਾਪੈਸਤ
newtab-clock-city-be-brussels = ਬਰੱਸਲਸ
newtab-clock-city-ua-kyiv = ਕੀਵ
newtab-clock-city-fi-helsinki = ਹੈਲਸਿੰਕੀ
newtab-clock-city-co-bogota = ਬੋਗੋਤਾ
newtab-clock-city-ph-manila = ਮਨੀਲਾ
newtab-clock-city-tr-istanbul = ਇਸਤਾਂਬੁਲ
newtab-clock-city-my-kuala-lumpur = ਕੁਆਲਾ ਲਮਪੁਰ
newtab-clock-city-eg-cairo = ਕੈਰੋ
newtab-clock-city-se-stockholm = ਸਟਾਕਹੋਮ
newtab-clock-city-ro-bucharest = ਬੁਖ਼ਾਰੈਸਟ
newtab-clock-city-th-bangkok = ਬੈਂਕਾਕ
newtab-clock-city-ng-lagos = ਲਾਗੋਸ
newtab-clock-city-tw-taipei = ਤਾਈਪਈ
newtab-clock-city-za-johannesburg = ਜੋਹਾਨਿਸਬਰਗ
newtab-clock-city-cl-santiago = ਸਾਂਤਿਆਗੋ
newtab-clock-city-pk-karachi = ਕਰਾਚੀ
newtab-clock-city-bg-sofia = ਸੋਫ਼ੀਆ
newtab-clock-city-sg-singapore = ਸਿੰਘਾਪੁਰ
newtab-clock-city-hk-hong-kong = ਹਾਂਗ ਕਾਂਗ
newtab-clock-city-sa-riyadh = ਰਿਆਧ
newtab-clock-city-dk-copenhagen = ਕੋਪਨਹੈਗਨ
newtab-clock-city-pe-lima = ਲੀਮਾ
newtab-clock-city-ke-nairobi = ਨੈਰੋਬੀ
newtab-clock-city-nz-auckland = ਆਕਲੈਂਡ
newtab-clock-city-kr-seoul = ਸਿਓਲ
newtab-clock-city-lt-vilnius = ਵਿਲਨਸ
newtab-clock-city-ie-dublin = ਡਬਲਿਨ
newtab-clock-city-ae-dubai = ਦੁਬਈ
newtab-clock-city-lv-riga = ਰੀਗਾ
newtab-clock-city-pt-lisbon = ਲਿਸਬਨ
newtab-clock-city-ir-tehran = ਤਹਿਰਾਨ
newtab-clock-city-bd-dhaka = ਢਾਕਾ
newtab-clock-city-ec-guayaquil = ਗੁਆਇਆਕੀਲ
newtab-clock-city-vn-ho-chi-minh-city = ਹੋ ਚੀ ਮਿਨ੍ਹ ਸਿਟੀ
newtab-clock-city-np-kathmandu = ਕਾਠਮਾਂਡੂ
newtab-clock-city-mm-yangon = ਰੰਗੂਨ
