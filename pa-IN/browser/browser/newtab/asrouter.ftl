...
cfr-cookie-banner-handling-body-variant-1 = { -brand-short-name } ਨੂੰ ਤੁਹਾਡੇ ਲਈ ਆਪਣੇ-ਆਪ ਹੀ ਕੂਕੀ ਪੌਪ-ਅੱਪ ਲਈ ਕਾਰਵਾਈ ਕਰਨ ਦਿਓ ਤਾਂ ਕਿ ਤੁਸੀਂ ਬਿਨਾਂ ਰੁਕਾਵਟ ਦੇ ਬਰਾਊਜ਼ ਕਰ ਸਕੋ। ਜਦੋਂ ਵੀ ਸੰਭਵ ਹੁੰਦਾ ਹੈ ਤਾਂ { -brand-short-name } ਸਭ ਬੇਨਤੀਆਂ ਨੂੰ ਰੱਦ ਕਰੇਗਾ, ਜੇ ਨਾ ਸਕੇ ਤਾਂ ਮਨਜ਼ੂਰ ਕਰਦਾ ਹੈ।
...
cfr-cookiebanner-body-variant-1 = { -brand-short-name } ਨੂੰ ਤੁਹਾਡੇ ਲਈ ਆਪਣੇ-ਆਪ ਹੀ ਕੂਕੀ ਪੌਪ-ਅੱਪ ਲਈ ਕਾਰਵਾਈ ਕਰਨ ਦਿਓ ਤਾਂ ਕਿ ਤੁਸੀਂ ਬਿਨਾਂ ਰੁਕਾਵਟ ਦੇ ਬਰਾਊਜ਼ ਕਰ ਸਕੋ। ਜਦੋਂ ਵੀ ਸੰਭਵ ਹੁੰਦਾ ਹੈ ਤਾਂ { -brand-short-name } ਸਭ ਬੇਨਤੀਆਂ ਨੂੰ ਰੱਦ ਕਰੇਗਾ।
...
cfr-cookiebanner-body-variant-2 = ਜਦ ਵੀ ਸੰਭਵ ਹੋਵੇ ਤਾਂ { -brand-short-name } ਨੂੰ ਵੈਬਸਾਈਟ ਦੀ ਕੂਕੀ ਸਹਿਮਤੀ ਬੇਨਤੀ ਨੂੰ ਨਾਂਹ ਕਰਨ ਨਾਲ ਤੁਹਾਨੂੰ ਦਿਸਣ ਵਾਲੇ ਕੂਕੀ ਬੈਨਰਾਂ ਦੀ ਗਿਣਤੀ ਘੱਟਦੀ ਹੈ।
