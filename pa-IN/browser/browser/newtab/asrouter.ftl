...
launch-on-login-spotlight-title = ਅਗਲੀ ਵਾਰ ਜਦ ਤੁਸੀਂ ਆਪਣਾ ਕੰਪਿਊਟਰ ਬਣਾਉਣ ਤਾਂ { -brand-short-name } ਨੂੰ ਖੋਲ੍ਹਣਾ ਹੈ?
launch-on-login-spotlight-startup-checkbox = ਸ਼ੁਰੂ ਵੇਲੇ { -brand-short-name } ਨੂੰ ਚਲਾਓ
launch-on-login-spotlight-pin-taskbar-checkbox = ਟਾਸਕਬਾਰ ਵਿੱਚ ਟੰਗੋ
# This checkbox label intentionally matches “startup-restore-windows-and-tabs”
# in the Settings (preferences.ftl). Localizers can reuse the existing
# translation suggested by translation memory.
launch-on-login-spotlight-restore-checkbox = ਪਿਛਲੀਆਂ ਵਿੰਡੋਆਂ ਤੇ ਟੈਬਾਂ ਨੂੰ ਖੋਲ੍ਹੋ
launch-on-login-spotlight-primary-button = ਸੰਭਾਲੋ ਅਤੇ { -brand-short-name } ਨੂੰ ਬੰਦ ਕਰੋ
...
windows-10-eos-callout-addons-subtitle = ਇਹ ਇਕਸਟੈਨਸ਼ਨਾਂ ਤੁਹਾਡੇ ਕੰਮ ਦੀ ਸਮਰੱਥਾ ਵਧਾਉਣ, ਸੁਰੱਖਿਅਤ ਰੱਖਣ ਅਤੇ ਧਿਆਨ ਭਕਟਣ ਤੋਂ ਰੋਕਣ ਲਈ ਚੁਣੀਆਂ ਗਈਆਂ ਹਨ।
...
windows-10-eos-sync-callout-addons-subtitle = ਆਪਣੀਆਂ { -brand-product-name } ਨੂੰ ਆਪਣੇ ਨਾਲ ਰੱਖਣ ਲਈ, ਭਾਵੇਂ ਕਿ ਡਿਵਾਈਸ ਵੀ ਬਦਲ ਲਵੋ, ਹੁਣੇ ਸਿੰਕ ਕਰੋ।
...
windows-10-eos-global-infobar-title = <strong>Microsoft ਹੁਣ ਵਿੰਡੋ 10 ਲਈ ਸਹਿਯੋਗੀ ਨਹੀਂ ਰਹੀ ਹੈ।</strong> ਵਿੰਡੋ 11 ਵਾਸਤੇ { -brand-product-name } ਨੂੰ ਤਿਆਰ ਕਰਨ ਲਈ ਆਪਣੀ ਜਾਣਕਾਰੀ ਦਾ ਬੈਕਅੱਪ ਲਵੋ।
windows-10-eos-global-infobar-primary-button = ਬੈਕਅੱਪ ਚਾਲੂ ਕਰੋ
    .accesskey = T
windows-10-eos-global-infobar-learn-more-link = ਹੋਰ ਜਾਣੋ
    .accessKey = L
...
relay-50-masks-announcement-title = 50 ਈਮੇਲ ਮਾਸਕ ਸਾਡੇ ਵਲੋਂ
relay-50-masks-announcement-subtitle = ਤੁਸੀਂ ਹੁਣ 50 ਮੁਫ਼ਤ ਮਾਸਕ (5 ਤੋਂ ਵਧਾ ਕੇ) ਮਾਸਕ ਲੈ ਸਕਦੇ ਹੋ। ਆਪਣੇ ਅਸਲ ਈਮੇਲ ਨੂੰ ਪ੍ਰਾਈਵੇਟ ਰੱਖਣ ਵਾਸਤੇ ਹਰ ਖਾਤੇ ਲਈ ਇੱਕ ਨੂੰ ਵਰਤੋਂ।
relay-50-masks-announcement-primary-button = { -relay-brand-name } ਉੱਤੇ ਜਾਓ
    .accesskey = G
relay-50-masks-announcement-secondary-button = ਖ਼ਾਰਜ ਕਰੋ
    .accesskey = D

## Nova Early Access Infobar

nova-early-access-infobar-title = <strong>{ -brand-product-name } ਦੀ ਨਵੀਂ ਦਿੱਖ ਆ ਰਹੀ ਹੈ।</strong> ਤੁਸੀਂ ਇਸ ਸਾਲ ਬਾਦ ਵਿੱਚੋਂ ਰੀਲਿਜ਼ ਹੋਣ ਵਾਲਾ ਅਧੂਰਾ ਵਰਜ਼ਨ ਦੀ ਝਲਕ ਵੇਖ ਰਹੇ ਹੋ।
nova-early-access-share-feedback-link = ਸੁਝਾਅ ਸਾਂਝੇ ਕਰੋ
    .accesskey = S
