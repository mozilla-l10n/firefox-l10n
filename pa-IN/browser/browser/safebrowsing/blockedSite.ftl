...
safeb-blocked-addon-page-title = ਤੁਹਾਡੀ ਸੁਰੱਖਿਆ ਲਈ ਸਾਈਟ ਉੱਤੇ ਪਾਬੰਦੀ ਲਾਈ
...
safeb-blocked-addon-page-error-desc-override = <strong>ਇਸ ਸਾਈਟ ਉੱਤੇ ਪਾਬੰਦੀ ਕਿਓ ਲਾਈ ਸੀ?</strong>
safeb-blocked-addon-page-error-desc2-override = <strong>{ $sitename }</strong> ਧੋਖੇਥੜੀ ਅਤੇ ਖ਼ਤਰਨਾਕ ਸਰਗਰਮੀਆਂ ਨਾਲ ਜੁੜੀ ਹੋਈ ਹੋ ਸਕਦੀ ਹੈ।
safeb-blocked-addon-page-error-desc3-override = <strong>ਇਸ ਬਾਰੇ ਤੁਸੀਂ ਕੀ ਕਰ ਸਕਦੇ ਹੋ?</strong>
safeb-blocked-addon-page-error-desc4-override = ਇਸ ਨੂੰ ਫੇਰ ਵਾਪਰਨ ਤੋਂ ਰੋਕਣ ਲਈ ਤੁਸੀਂ about:addons ਵਿੱਚੋਂ<strong>{ $addonName }</strong> ਨੂੰ ਹਟਾਓ ਜਾਂ ਅਸਮਰੱਥ ਕਰ ਸਕਦੇ ਹੋ।
safeb-blocked-addon-page-learn-more3 = <a data-l10n-name='firefox_support_harmful_addons'>{ -brand-short-name }ਦੀ ਨੁਕਸਾਨਦੇਹ ਐਡ-ਆਨ ਸੁਰੱਖਿਆ ਬਾਰੇ ਹੋਰ ਜਾਣੋ</a>।
safeb-blocked-addon-page-learn-more = <a data-l10n-name='firefox_support'>{ -brand-short-name } ਦੀ ਫਿੰਸ਼ਿੰਗ ਅਤੇ ਮਾਲਵੇਅਰ ਸੁਰੱਖਿਆ ਬਾਰੇ ਹੋਰ ਜਾਣੋ</a>।
