...
settings-update-internal-error = ਅੰਦਰੂਨੀ ਗ਼ਲਤੀ ਕਰਕੇ ਅੱਪਡੇਟਾਂ ਭਾਲਣ ਤੋੰ ਅਸਮਰੱਥ। ਅੱਪਡੇਟਾਂ <a data-l10n-name="manual-link">{ $displayUrl }</a> ਉੱਤੇ ਮੌਜੂਦ ਹਨ।
...
helpus-referrals2 = ਮਦਦ ਚਾਹੀਦੀ ਹੈ? <label data-l10n-name="helpus-donateLink">ਦਾਨ ਕਰੋ</label>, <label data-l10n-name="helpus-shareFirefoxLink">{ -brand-product-name }ਨੂੰ ਸਾਂਝਾ ਕਰੋ</label>, ਜਾਂ <label data-l10n-name="helpus-getInvolvedLink">ਹਿੱਸਾ ਲਵੋ!</label>
helpus-referrals = ਮਦਦ ਚਾਹੀਦੀ ਹੈ? <label data-l10n-name="helpus-donateLink">ਦਾਨ ਕਰੋ</label>, <label data-l10n-name="helpus-shareFirefoxLink">{ -brand-short-name }ਨੂੰ ਸਾਂਝਾ ਕਰੋ</label>, ਜਾਂ <label data-l10n-name="helpus-getInvolvedLink">ਹਿੱਸਾ ਲਵੋ!</label>
