...
urlbar-share-button =
    .aria-label = ਇਸ ਸਫ਼ੇ ਨੂੰ ਸਾਂਝਾ ਕਰੋ
    .tooltiptext = ਇਸ ਸਫ਼ੇ ਨੂੰ ਸਾਂਝਾ ਕਰੋ
share-panel-heading = ਸਫ਼ਾ ਸਾਂਝਾ ਕਰੋ
...
confirmation-hint-link-copied = ਲਿੰਕ ਨੂੰ ਕਾਪੀ ਕੀਤਾ
...
share-panel-os-share-2 =
    .label =
        { PLATFORM() ->
            [windows] Windows ਨਾਲ ਸਾਂਝਾ ਕਰੋ…
            [macos] Mac ਨਾਲ ਸਾਂਝਾ ਕਰੋ…
           *[other] …ਨਾਲ ਸਾਂਝਾ ਕਰੋ
        }
