...
upgrade-dialog-new-alt-subtitle = <span data-l10n-name="zap">{ -brand-short-name }</span> ਬਣਾ ਕੇ ਸ਼ੁਰੂ ਕਰੋ, ਸਿਰਫ਼ ਇੱਕ ਹੀ ਕਲਿੱਕ ਨਾਲ
...
upgrade-dialog-new-primary-primary-button = { -brand-short-name } ਨੂੰ ਆਪਣਾ ਮੂਲ ਬਰਾਊਜ਼ਰ ਬਣਾਓ
    .title = { -brand-short-name } ਨੂੰ ਆਪਣਾ ਮੂਲ ਬਰਾਊਜ਼ਰ ਬਣਾਓ ਤੇ ਟਾਸਕ-ਬਾਰ ਵਿੱਚ ਟੰਗੋ
upgrade-dialog-new-primary-default-button = { -brand-short-name } ਨੂੰ ਮੇਰੇ ਮੂਲ ਬਰਾਊਜ਼ਰ ਬਣਾਓ
upgrade-dialog-new-primary-pin-button = { -brand-short-name } ਨੂੰ ਮੇਰੀ ਟਾਸਕਬਾਰ ਵਿੱਚ ਟੰਗੋ
upgrade-dialog-new-primary-pin-alt-button = ਟਾਸਕਬਾਰ ਵਿੱਚ ਟੰਗੋ
