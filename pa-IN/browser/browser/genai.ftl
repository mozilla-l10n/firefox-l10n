...
genai-settings-chat-choose-one-menuitem =
    .label = ਕੋਈ ਚੁਣੋ
genai-settings-chat-links = ਚੈਟ-ਬੋਟ ਦੀ ਚੋਣ ਕਰਕੇ ਤੁਸੀਂ ਪੂਰਕ ਦੀਆਂ ਵਰਤਣ ਦੀਆਂ ਸ਼ਰਤਾਂ ਅਤੇ ਪਰਦੇਦਾਰੀ ਨੀਤੀ ਨਾਲ ਸਹਿਮਤ ਹੁੰਦੇ ਹੋ।
...
genai-settings-chat-shortcuts =
    .description = ਜਦੋਂ ਵੀ ਤੁਸੀਂ ਲਿਖਤ ਨੂੰ ਚੁਣੋ ਤਾਂ ਪੁੱਛਣ ਲਈ ਸ਼ਾਰਟਕੱਟ ਦਿਖਾਉਂਦਾ ਹੈ। { -brand-short-name } ਲਿਖਤ, ਸਫ਼ੇ ਦੇ ਟਾਈਟਲ, ਪਰਾਉਂਟ ਨੂੰ ਚੈਟ-ਬੋਟ ਨੂੰ ਭੇਜਦਾ ਹੈ।
    .label = ਚੁਣੀ ਲਿਖਤ ਲਈ ਪਰਾਉਂਟ ਵੇਖਾਓ
