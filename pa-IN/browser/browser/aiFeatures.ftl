...
ai-window-smart-cursor-in-smart-window =
    .description = ਸਾਰ, ਸਮਝਾਓ ਅਤੇ ਹੋਰ ਚੀਜ਼ਾਂ ਲਈ ਫੌਰੀ ਪਹੁੰਚ ਲਵੋ
    .label = ਜਦੋਂ ਲਿਖਤ ਚੁਣੀ ਜਾ ਰਹੀ ਹੋਵੇ ਤਾਂ ਸ਼ਾਰਟਕੱਟ ਵੇਖਾਓ
...
smart-window-model-flexible-v2 =
    .description = ਕਈ ਕਿਸਮ ਦੇ ਕੰਮਾਂ ਲਈ ਤਿਆਰ: ਪੂਰਾ ਨਾਂ { $ownerName } ਵਲੋਂ { $model }
    .label = { $shortName }: ਅਨੁਕੂਲ
smart-window-model-personal-v2 =
    .description = ਵੱਖ-ਵੱਖ ਭਾਸ਼ਾਵਾਂ ਤੋਂ ਨਿੱਜੀ ਮਦਦ ਲੈਣ ਲਈ ਬਣਾਇਆ। ਪੂਰਾ ਨਾਂ:: { $ownerName } ਵਲੋਂ { $model }
    .label = { $shortName }: ਨਿੱਜੀ
