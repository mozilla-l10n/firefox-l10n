...
login-app-promo-title = जताततै तपाईंको पासवर्ड लिनुहोस्
login-app-promo-subtitle = नि: शुल्क { -lockwise-brand-name } अनुप्रयोग पाउनुहोस्
...
menu-menuitem-android-app = { -lockwise-brand-short-name } एन्ड्रोइडको लागी
menu-menuitem-iphone-app = { -lockwise-brand-short-name } आईफोन र आईप्याड को लागी
