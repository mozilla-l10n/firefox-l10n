...
safeb-blocked-harmful-page-title = O seguinte site pode conter malware
safeb-blocked-phishing-page-short-desc = { -brand-short-name } bloqueou esta página porque ela pode enganá-lo a fazer algo perigoso como instalar software ou revelar informações pessoais como senhas ou números de cartões de crédito.
...
safeb-blocked-harmful-page-short-desc = O { -brand-short-name } bloqueou esta página porque ela pode tentar instalar aplicativos perigosos que roubem ou excluam suas informações (por exemplo, fotos, senhas, mensagens e cartões de crédito).
...
safeb-blocked-phishing-page-error-desc-override = <span data-l10n-name='sitename'>{ $sitename }</span> foi <a data-l10n-name='error_desc_link'>denunciado como um site enganoso</a>. Você pode <a data-l10n-name='report_detection'>relatar um problema de detecção</a> ou <a data-l10n-name='ignore_warning_link'>ignorar o risco</a> e ir para este site inseguro.
...
safeb-blocked-malware-page-error-desc-override = O site <span data-l10n-name='sitename'>{ $sitename }</span> foi <a data-l10n-name='error_desc_link'>denunciado por conter programas maliciosos</a>. Você pode <a data-l10n-name='report_detection'>relatar um problema de detecção</a> ou <a data-l10n-name='ignore_warning_link'>ignorar o risco</a> e visitar o site inseguro.
...
safeb-blocked-malware-page-learn-more = Saiba mais sobre conteúdo web prejudicial, incluindo vírus e outros códigos maliciosos (malware), e como proteger seu computador em <a data-l10n-name='learn_more_link'>StopBadware.org</a>. Saiba mais sobre proteção contra phishing e malware do { -brand-short-name } em <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
safeb-blocked-unwanted-page-error-desc-override = <span data-l10n-name='sitename'>{ $sitename }</span> foi <a data-l10n-name='error_desc_link'>denunciado por conter software prejudicial</a>. Você pode <a data-l10n-name='ignore_warning_link'>ignorar o risco</a> e ir para este site inseguro.
...
safeb-blocked-unwanted-page-learn-more = Saiba mais sobre software nocivo e indesejável no <a data-l10n-name='learn_more_link'>Política de Software Indesejável</a>. Saiba mais sobre Proteção contra Malware e Fraude online do { -brand-short-name } em <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
safeb-blocked-harmful-page-error-desc-override = <span data-l10n-name='sitename'>{ $sitename }</span> foi <a data-l10n-name='error_desc_link'>denunciado por conter um aplicativo potencialmente prejudicial</a>. Você pode <a data-l10n-name='ignore_warning_link'>ignorar o risco</a> e ir para este site inseguro.
