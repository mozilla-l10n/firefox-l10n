...
firefoxview-syncedtabs-synctabs-header-2 = A sincronização de abas está desativada
firefoxview-syncedtabs-synctabs-description-2 = Ative novamente a sincronização para ter todas as suas abas de outros dispositivos.
