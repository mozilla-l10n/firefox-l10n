...
extension-default-theme-description2 = Um cinza-roxo familiar e equilibrado em um visual clássico do { -brand-product-name }.
...
extension-default-theme-name2 = Padrão
...
extension-nova-flare-name = Brilho
