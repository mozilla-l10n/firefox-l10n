...
appmenu-nova-update-promo =
    .message = Instale uma nova versão do { -brand-short-name }. Suas abas são restauradas.
appmenu-nova-update-link = Reiniciar para atualizar
...
appmenu-profile-current-in-use = Perfil em uso
appmenu-profiles-2 =
    .label = Perfis
