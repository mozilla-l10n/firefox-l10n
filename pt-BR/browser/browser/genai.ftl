...
genai-settings-chat-lechat-links-2 = Ao escolher o Mistral Vibe, você declara que concorda com os <a data-l10n-name="link1">termos do serviço</a> e a <a data-l10n-name="link2">política de privacidade</a> da Mistral AI.
...
genai-shortcut-button-2 =
    ...
    .tooltiptext = Consultar { $provider }
# $engine (string) - name of the search engine
# $selection (string) - the selected text, truncated
genai-shortcut-search-button =
    .aria-label = Pesquisar “{ $selection }” no { $engine }
    .tooltiptext = Pesquisar “{ $selection }” no { $engine }
...
genai-menu-choose-chatbot =
    .label = Escolher um chatbot de inteligência artificial
...
# “Summarize Page” should be consistent with the translation for the string genai-menu-summarize-page
genai-chatbot-summarize-sidebar-generic-subtitle = Clique com o botão direito do mouse no botão com estrela do painel lateral e escolha “Resumir página”. Na primeira vez, você também deve escolher um chatbot de inteligência artificial.
