...
crashed-send-report = Envie um relato automatizado de travamento para que possamos corrigir problemas como este.
...
crashed-include-URL-2 = Incluir as URLs dos sites em que você estava quando o { -brand-short-name } travou
crashed-email-placeholder = Digite aqui seu endereço de email
crashed-email-me = Enviar um email quando mais informações estiverem disponíveis
