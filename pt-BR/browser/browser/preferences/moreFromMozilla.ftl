...
more-from-moz-solo-title = Inteligência artificial do { -solo-ai-brand-name }
...
more-from-moz-solo-card =
    ...
    .description = Explore nossas ideias e tecnologias experimentais mais recentes.
more-from-moz-new-products-card =
    .label = Novos produtos da { -vendor-short-name }
    .description = Descubra os produtos mais recentes da { -vendor-short-name }.
