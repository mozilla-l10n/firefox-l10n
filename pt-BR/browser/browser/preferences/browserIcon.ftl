...
appearance-browser-icon-entry-group =
    ...
    .description = Escolha um ícone personalizado para barra de tarefas, área de trabalho e menu Iniciar.
appearance-browser-icon-button =
    .label = Mudar ícone do navegador
...
appearance-browser-icon-pin-button =
    .label = Fixar na barra de tarefas
...
appearance-browser-icon-momo =
    .label = Momo
    .description = Criado por @heyheymomodraws
