...
address-capture-edit-address-link = Editar endereço
...
autofill-country-warning-message-2 = O preenchimento automático de formulários atualmente só está disponível em alguns países
...
autofill-passport-expiry-date = Data de validade
...
passport-capture-save-doorhanger-header = Salvar passaporte?
passport-capture-save-doorhanger-description = Salvar informações no { -brand-short-name } para poder preencher formulários rapidamente.
...
passport-capture-never-save-button =
    .label = Nunca salvar passaportes
    .accessKey = N
