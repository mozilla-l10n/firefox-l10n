...
tls-key-logging-notice-nav =
    .label = Um aplicativo ou serviço pode ver seu tráfego criptografado.
category-list =
...
containers-external-links-check =
    .label = Não usar contêineres em links abertos de aplicativos externos
    .accesskey = N
...
containers-sites-card-header =
    .description = Escolha um contêiner para um site e o { -brand-short-name } o usará toda vez que o site for aberto.
    .label = Contêineres de sites especificos
...
containers-site-container-select = Contêiner de { $site }
...
preferences-doh-radio-group =
    .aria-label = Ativar DNS sobre HTTPS usando:
...
preferences-ai-controls-speech-recognition-control =
    .description = Transcrever fala localmente.
    .label = Reconhecimento de voz
preferences-ai-controls-sidebar-chatbot-group-3 =
    .description = Manter um chatbot ao alcance enquanto navega. Escolha entre vários provedores e mude quando quiser.
    .label = Provedores de chatbot de inteligência artificial no painel lateral
preferences-ai-controls-sidebar-chatbot-group-2 =
    .description = Manter um chatbot à vista enquanto navega. Escolher Anthropic Claude, ChatGPT, Copilot, Google Gemini ou Mistral Vibe.
    .label = Provedores de chatbot de inteligência artificial no painel lateral
...
preferences-etp-level-radio-group =
    .aria-label = Proteção aprimorada contra rastreamento
...
preferences-etp-tracker-count-enabled =
    .label = Mostrar rastreadores bloqueados na barra de endereços
...
preferences-etp-custom-cookie-behavior-block-cross-site-tracking-cookies =
    .label = Bloquear cookies de rastreamento entre sites
...
security-privacy-issue-warning-doh2 =
    .description = DNS sobre HTTPS ajuda a ocultar de seu provedor de internet quais sites você visita.
    .label = DNS sobre HTTPS está desativado
security-privacy-issue-warning-ech2 =
    .description = Encrypted Client Hello ajuda a ocultar de seu provedor de internet quais sites você visita.
    .label = Encrypted Client Hello está desativado
...
referrals-section-header =
    .description = Convidar a usar o navegador que põe a privacidade em primeiro lugar.
    .label = Recomendar o { -brand-short-name }
...
referrals-section-header2 =
    .description = Convidar a usar o navegador que põe a privacidade em primeiro lugar.
    .label = Recomendar o { -brand-product-name }
# Link that opens the referral page, where the user can invite others to
# use the browser. "Share" here means recommending or referring the browser
referrals-link2 =
    .label = Recomendar o { -brand-product-name }
