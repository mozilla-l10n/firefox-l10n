...
default-browser-notification-privacy-header-text = Permanecer com o { -brand-short-name }?
default-browser-notification-privacy-body-text = Seu navegador padrão foi alterado. Volte ao { -brand-short-name } para ter privacidade e proteção integradas.
