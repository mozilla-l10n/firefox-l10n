...
xfoBlocked-title = Bloqueada pela política X-Frame-Options
...
certerror-mitm-title = Software está impedindo que o { -brand-short-name } se conecte com segurança com este site
