...
appmenu-addon-post-install-message-with-data-collection = Atualize permissões e preferências de dados quando quiser nas <a data-l10n-name="settings-link">configurações da extensão</a>.
