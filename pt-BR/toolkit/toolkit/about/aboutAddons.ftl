...
details-notification-hard-blocked-extension =
    .message = Esta extensão foi bloqueada por violar diretivas da Mozilla e foi desativada.
...
details-notification-soft-blocked-extension-disabled =
    .message = Esta extensão está restrita por violar diretivas da Mozilla e foi desativada. Você tem opção de ativar, mas pode ser arriscado.
