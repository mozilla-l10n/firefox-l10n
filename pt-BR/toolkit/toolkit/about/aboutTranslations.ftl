...
about-translations-title = Tradução no { -brand-short-name }
...
about-translations-detected-language-unsupported-heading-2 = Desculpe, ainda não oferecemos suporte a tradução de { $language }
about-translations-detected-language-unsupported-heading-unknown-2 = Desculpe, ainda não oferecemos suporte a tradução deste idioma
...
about-translations-translating-message = Traduzindo…
