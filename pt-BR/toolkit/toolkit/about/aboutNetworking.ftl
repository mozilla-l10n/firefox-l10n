...
about-networking-ssl-tokens-summary-certs = Certificados armazenados: { $references } ({ $totalBytes } B), únicos: { $distinct } ({ $distinctBytes } B)
...
about-networking-networkid-status-known = Status do link de rede é conhecido
