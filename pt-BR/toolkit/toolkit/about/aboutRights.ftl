...
rights-intro-point-5-unbranded = Se este produto incorporar serviços web, quaisquer termos do serviço aplicáveis ao(s) serviço(s) devem possuir um link para a seção <a data-l10n-name="mozilla-website-services-link">serviços web</a>.
...
enableSafeBrowsing-label = Bloquear conteúdo perigoso e malicioso
rights-safebrowsing-term-4 = O Safe Browsing agora está desativado
rights-locationawarebrowsing = <strong>Navegação sensível à localização: </strong>é sempre alertado antes. Nenhuma informação de localização é enviada sem a sua autorização. Caso deseje desabilitar totalmente esta funcionalidade, siga este passos:
