...
key-wizard-warning = <b>Se você já tem uma chave pessoal</b> deste endereço de e-mail, deve importar a chave. Caso contrário, não terá acesso a seus e-mails criptografados salvos, nem poderá ler e-mails criptografados recebidos de pessoas que ainda estão usando sua chave.
