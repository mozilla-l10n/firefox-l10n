...
colorpicker-tooltip-eyedropper-title = Selecionar uma cor na página
...
colorpicker-tooltip-color-name-title = Mais próximo de: { $colorName }
...
inspector-split-orientation-button-title = Layout de painéis
...
inspector-emulation-panel-toggle =
    .aria-label = Ativar/desativar recursos de emulação com CSS
    .title = Ativar/desativar recursos de emulação com CSS
...
inspector-emulation-panel-reduced-motion-no-preference = Sem preferências
    .aria-label = Ativar sem preferências em emulação de movimento reduzido
