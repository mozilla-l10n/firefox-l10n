...
serviceworker-worker-updated = Atualizado em <time>{ DATETIME($date, day: "numeric", hour: "numeric", minute: "numeric", month: "long", second: "numeric", year: "numeric") }</time>
...
session-history-navigate-button-title = Navegar para o item { $index } do histórico de sessão
