...
certerror-unknown-issuer-what-can-you-do-about-it-website = সমস্যাটি ওয়েবসাইটের নিজের হওয়ার সম্ভাবনা সবচেয়ে বেশি, আর এটি সমাধান করার জন্য আপনার করার কিছু নেই।
certerror-unknown-issuer-what-can-you-do-about-it-contact-admin = আপনি যদি কোনও কর্পোরেট নেটওয়ার্কে থাকেন বা এন্টি-ভাইরাস সফটওয়্যার ব্যবহার করেন, তাহলে সহায়তার জন্য আপনি সাপোর্ট টিমের সাথে কথা বলতে পারেন। আপনি সেই ওয়েবসাইট এর প্রশাসককেও সমস্যা সম্পর্কে অবহিত করতে পারেন।
# Variables:
# $hostname (String) - Hostname of the website to which the user was trying to connect.
# $now (Date) - The current datetime, to be formatted as a date
