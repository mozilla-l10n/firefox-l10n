...
taskbar-tabs-email-callout-subtitle-v3 = ウェブメールを { -brand-short-name } により保護されたウィンドウでアプリのように起動します
taskbar-tabs-media-callout-title-v3 = タスクバーから動画をストリーミング再生
taskbar-tabs-media-callout-subtitle-v3 = 動画サイトを { -brand-short-name } により保護されたウィンドウでアプリのように起動します
taskbar-tabs-value-prop-callout-title-v3 = お気に入りのサイトをタスクバーにピン留め
taskbar-tabs-value-prop-callout-subtitle-v3 = どんなウェブサイトでも  { -brand-short-name } により保護されたウィンドウでアプリのように起動します
taskbar-tabs-gaming-callout-title-v3 = タスクバーからいつでもゲームサイトへ
taskbar-tabs-gaming-callout-subtitle-v3 = ゲームサイトを { -brand-short-name } により保護されたウィンドウでアプリのように起動します
