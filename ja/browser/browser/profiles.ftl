...
new-profile-page-header-description = 各プロファイルには、それぞれ独立した閲覧履歴と設定が保持されています。さらに、{ -brand-short-name } の強力なプライバシー保護が既定で有効です。
...
restored-profile-page-header-description = 各プロファイルには、それぞれ独立した閲覧履歴や設定が保持されています。さらに、{ -brand-short-name } の強力なプライバシー保護機能が既定で有効です。
...
delete-profile-windows = 開いているウィンドウ
