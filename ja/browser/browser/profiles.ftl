...
new-profile-page-header-description = それぞれのプロファイルに、他のプロファイルとは独立した閲覧履歴や設定が保持されます。また、{ -brand-short-name } の強力なプライバシー保護が既定で有効です。
...
copied-profile-page-header-description = 既存のデータと設定を新しいプロファイルにコピーしました。プロファイルに名前を付け、お好みのテーマを選んで設定してください。
restored-profile-page-header = 復元したプロファイルのカスタマイズ
restored-profile-page-header-description = 各プロファイルは他のプロファイルと分けて保存されたユニークな閲覧履歴と設定を保持しています。さらに、{ -brand-short-name } の強力なプライバシー保護は既定でオンになっています。
...
delete-profile-windows = ウィンドウを開く
...
profiles-appmenu-callout-tour-title = 新しいプロファイルの準備ができています
# "Spin up another" means creating another profile, “Hop between your digital lives" is referring to switching between different profiles such as work, personal, etc.
profiles-appmenu-callout-tour-subtitle = メニュー ☰ でプロファイル名をクリックすると、新しいプロファイルの作成やプロファイルの編集、別のプロファイルへの切り替えができます。
