...
preferences-colors-description = ウェブサイトのテキスト、背景、リンクについて { -brand-short-name } の既定の配色を上書きします。
...
appearance-window-density-touch =
    .label = タッチ
    .description = 大きなウィンドウ要素とクリック対象でタッチ画面用に最適化されます
...
preferences-ai-controls-blocked-message =
    .message = 現在の AI 支援が既定でブロックされます。特定の機能のブロック解除は、以下から設定してください。
