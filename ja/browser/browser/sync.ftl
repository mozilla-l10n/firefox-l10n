...
sync-profile-different-account-description = データの整合性と安全を保つには、{ -brand-product-name } プロファイルごとに 1 個のアカウントと同期するようにしてください。{ $acctEmail } でログインし、新しいプロファイルを作成してください。
# Dialog 1 - different account signing in with merge option
sync-profile-different-account-title-merge = プロファイルが別のアカウントと同期しています
# Variables:
#   $acctEmail (String) - Email of the account signing into sync.
#   $profileName (String) - Name of the current profile
sync-profile-different-account-description-merge = データの整合性と安全を保つため、新しいプロファイルを作成して { $acctEmail } でログインすることをおすすめします。このプロファイルでの同期を続ける場合、両方のアカウントからのデータが “{ $profileName }” 上で永久に併合されます。
