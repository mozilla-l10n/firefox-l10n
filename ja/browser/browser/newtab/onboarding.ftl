...
onboarding-checklist-set-default = { -brand-short-name } を既定のブラウザーに設定する
...
onboarding-minimal-tabs-tooltip =
    .title = ブラウザーウィンドウの側面に沿って、タブを最小化されたサイドバー内に小さなアイコンのように表示します。
# Description for minimal tabs image
onboarding-minimal-tabs-description =
    .aria-description = ブラウザーウィンドウの側面に沿って、タブを最小化されたサイドバー内に小さなアイコンのように表示します。
