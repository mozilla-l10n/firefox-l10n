...
contextual-manager-passwords-export-os-auth-dialog-message-win = パスワードをエクスポートするには、Windows でのあなたの資格情報を入力してください。これはあなたのアカウントのセキュリティを保護します。
...
contextual-manager-passwords-import-file-picker-title = パスワードをインポート
...
contextual-manager-passwords-import-learn-more = パスワードのインポートについての詳細
contextual-manager-passwords-export-success-heading =
    .heading = パスワードをエクスポートしました
contextual-manager-passwords-export-success-button = 完了
# Export passwords to file dialog
contextual-manager-export-passwords-dialog-title = パスワードをファイルにエクスポートしますか？
# This string recommends to the user that they delete the exported password file that is saved on their local machine.
contextual-manager-export-passwords-dialog-message = エクスポート後は、この端末を使用する他者がパスワードを見ることがないようにファイルを削除しておくことをおすすめします。
