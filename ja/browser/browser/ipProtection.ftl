...
ipprotection-feature-introduction-link-text-private-browsing-2 = 新たな <a data-l10n-name="learn-more-vpn">組み込み VPN</a> を利用すると、プライベートウィンドウであっても、あなたの現在位置を隠してユーザーデータを保護します。
ipprotection-feature-introduction-description-private-browsing = プライベートウィンドウであっても、ユーザーの現在位置を隠してブラウジングのプライバシー保護を強化します。
...
ipprotection-feature-introduction-link-text-captive-portal-1 = いくつかの場所から選んで現在位置を隠して <a data-l10n-name="learn-more-vpn">プライバシー保護を強化</a> しましょう。
...
ipprotection-feature-introduction-button-open-vpn = VPN を開く
...
ipprotection-summer-promo-offramp-set-to-default-primary-button = 既定に設定
...
ipprotection-open-button = { -brand-product-name } を開く
ipprotection-come-back-title = もう一度、組み込み VPN を試しませんか？
ipprotection-message-body-hide-location = { -brand-product-name } の接続元を隠してプライバシー保護とコントロールを強化します。
