...
language-name-cu = 古期教会スラブ語
language-name-cv = チュヴァシュ語
...
language-name-lb = ルクセンブルグ語
language-name-lg = ガンダ語
language-name-li = リグリア語
language-name-lij = リグーリア語
...
language-name-sk = スロヴァキア語
language-name-sl = スロヴェニア語
