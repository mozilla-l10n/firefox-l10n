...
submit-crash-button-failure-label = شکست خرد
crashes-submitted-label = خراویا گوزارش وابیڌه
date-submitted-heading = تاریخ فشناڌن
view-crash-button-label = نما
no-reports-label = گوزارش خراوی تا سکو نفشناڌه.
