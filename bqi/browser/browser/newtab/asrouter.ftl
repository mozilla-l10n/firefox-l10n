...
fox-doodle-pin-headline = خش وورگشتین
fox-doodle-pin-secondary = سکو ن
...
device-migration-fxa-spotlight-heavy-user-primary-button = ناهاڌن پا کار
device-migration-fxa-spotlight-sync-primary-button = ناهاڌن پا کار
...
launch-on-login-infobar-reject-button = سکو ن
    .accesskey = N
...
root-certificate-windows-background-notification-learn-more-button = قلوه دووسته بۊین
root-certificate-windows-background-notification-update-button = ورۊ رسۊوی { -brand-short-name }
...
windows-10-eos-feature-toast-whats-new-button = چیا نۊ ن بنیرین
windows-10-eos-feature-toast-dismiss-button = رڌ کردن

## Windows 10 EoS Global Infobar

windows-10-eos-global-infobar-learn-more-link = قلوه دووسته بۊین
    .accessKey = L
