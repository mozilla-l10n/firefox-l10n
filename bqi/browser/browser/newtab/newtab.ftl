...
newtab-wallpaper-firefox-desert-light = رۊوایی ک من بیابووݩ رۊشنا ادونه
...
newtab-clock-widget-custom-back = وورگشتن
# Curated World Clock city names. The value is the city name shown on the
# clock; translate to your locale's usual spelling for the city.
newtab-clock-city-us-new-york = نیویورک
newtab-clock-city-us-los-angeles = لوس آنجلس
...
newtab-clock-city-us-washington-dc = واشینگتون، دی. سی.
...
newtab-clock-city-us-anchorage = ٱنکوریج
...
newtab-clock-city-ru-moscow = موسکو
...
newtab-clock-city-my-kuala-lumpur = کۊالالامپۊر
newtab-clock-city-eg-cairo = قاهره
newtab-clock-city-se-stockholm = استکهلم
newtab-clock-city-ro-bucharest = بۊخارست
...
newtab-clock-city-bg-sofia = سوفیه
newtab-clock-city-sg-singapore = سنگاپۊر
newtab-clock-city-hk-hong-kong = هونگ کونگ
newtab-clock-city-sa-riyadh = ریاز
newtab-clock-city-dk-copenhagen = کوپنهاگ
...
newtab-clock-city-lt-vilnius = ویلنیۊس
newtab-clock-city-ie-dublin = دۊبلین
newtab-clock-city-ae-dubai = دوبی
newtab-clock-city-lv-riga = ریگا
newtab-clock-city-pt-lisbon = لیسبون
newtab-clock-city-ir-tehran = تؽرووݩ
...
newtab-clock-city-np-kathmandu = کاتماندۊ
