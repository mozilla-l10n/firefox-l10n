...
pane-downloads3 =
    .heading = دانلودا
pane-accessibility-title = دسرسی پزیری
    .title = { pane-accessibility-title }
pane-languages-title2 = زووا
    .title = زووا
...
extension-controlling-privacy-containers = <img data-l10n-name="icon"/> <strong>{ $name }</strong> بلگه یل هامل ن اخو.
...
home-prefs-recent-activity-description = پسند وابیڌه یلی ز وبگه یل وو موئتوا هیم دمۊوی
...
containers-add-button2 =
    .label = ٱووردن هامل نۊ
    .accesskey = A
containers-new-tab-check3 =
    .label = سی هر بلگه نۊ، ی هامل پسند کۊنین
    .accesskey = S
