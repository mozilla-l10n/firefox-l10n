...
appmenu-nova-update-title = سی ورۊ رسۊوی { -brand-short-name } ز نۊ ره‌س ونین
appmenu-nova-update-description = بلگه یل ایسا دووارته واز ابۊن.
appmenu-nova-fxa-sign-in = و من ٱووڌن
appmenu-nova-switch-device-promo =
    .message = من هیم رۊزا ی دسگا نۊ استۊوین؟ { -brand-short-name } ن وا خوتووݩ بوورین!
...
fxa-menu-manage-sync-settings =
    .label = دؽوۉداری سامووا هوم گوم کردن
fxa-menu-add-device =
    .label = ٱووردن دسگا
fxa-menu-manage-devices =
    .label = دؽوۉداری دسگا یل ایسا
fxa-menu-device-missing =
    .label = دسگا خوتووه نیبینین؟
...
profiler-popup-button-capturing =
    .label = پوروفایل ساز
    .tooltiptext = پوروفایل ساز هونی ی پوروفایل سبت اکونه
