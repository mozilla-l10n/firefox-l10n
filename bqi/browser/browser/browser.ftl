...
urlbar-result-menu-remove-from-history2 = وورداشتن ز ویرگار
    .accesskey = R
urlbar-result-menu-tip-get-help2 = گرؽڌن هیاری
    .accesskey = h
urlbar-result-menu-dismiss-suggestion2 = رڌ ای پؽشنهاڌ
    .accesskey = D
urlbar-result-menu-manage-firefox-suggest2 = دؽوۉداری { -firefox-suggest-brand-name }
    .accesskey = M
...
quickactions-cmd-colorpicker = پسند کون رنگ، قتره چکووݩ، پسند رنگ
...
quickactions-mute = بؽ دونگ کردن بلگه یلی ک آرنگ پشک اکونن
...
quickactions-editpdf = کۊشیڌن آلشتگر PDF
...
identity-custom-root = گوواهیِ ای منپیز، و دست سادرکوننده ای وورکل وابیڌه ک سی مۊزیلا قابل و شناسایی نؽ.
...
identity-description-passive-loaded = منپیز ایسا سیخومی نؽ وو دووسمندیایی ک وا وبگه یک رسۊوی اکۊنین، دیرووݩ ترن ک بوینن سووݩ.
identity-description-passive-loaded-insecure2 = ای وبگه موئتوایی داره ک ٱمن نؽڌن (جۊر شؽوات).
...
browser-import-button2 =
    .label = ٱووردن نشووکا
    .tooltiptext = نشووکا ن ز گشت گر دیری و { -brand-short-name } و من بیارین.
bookmarks-toolbar-empty-message = سی دسرسی زل تر، نشووکا خوته ایچونا من نوار ٱوزار نشووکا بنه.<a data-l10n-name="manage-bookmarks">دؽوۉداری نشووکا…</a>
...
sharing-warning-window = ایسا هونی { -brand-short-name } ن یک رسۊوی اکۊنین. آڌۊمیل دی ترن مجال آلشت داڌن بلگه یل، هونووݩ ن بوینن.
sharing-warning-screen = ایسا هونی پوی بلگه نمایش خوتووݩ ن یک رسۊوی اکۊنین. آڌۊمیل دی ترن مجال آلشت داڌن بلگه یل، هونووݩ ن بوینن.
sharing-warning-proceed-to-tab =
    .label = رئڌن و بلگه
sharing-warning-disable-for-session =
    .label = قیر فعال کردن زفت وابیڌن یک رسۊوی سی ای نشست
...
urlbar-result-action-move-tab-to-split-view = جاگورو بلگه و هالت نما تقسیم وابیڌه
...
urlbar-result-explanation-bookmarked = نشووک ناهاڌه وابیڌه { $date }
...
urlbar-result-realtime-opt-in-dismiss-all2 = ای پؽشنهاڌا ن نشووݩ مڌه
# This string is shown in the result menu.
urlbar-result-menu-dont-show-market2 = پؽشنهاڌا بازار ن نشووݩ مڌه
...
urlbar-searchmode-bookmarks4 = نشووکا
urlbar-searchmode-tabs4 = بلگه یل
urlbar-searchmode-history4 = ویرگار
urlbar-searchmode-actions4 = کارا
...
urlbar-searchmode-popup-search-settings2 = پیتینیڌن سامووا
urlbar-searchmode-popup-settings2 = سامووا
...
urlbar-view-context-menu-open-in-private-window =
    ...
    .accesskey = P
urlbar-view-context-menu-open-in-tab2 = گۊشیڌن من بلگه نۊ
    .accesskey = w
urlbar-view-context-menu-open-in-container-tab2 = گۊشیڌن من بلگه هامل نۊ
    .accesskey = i
urlbar-view-context-menu-open-in-window2 = گۊشیڌن من نیمدری نۊ
    .accesskey = N
...
toolbar-button-tab-groups =
    .label = بونکۊیل بلگه
    .tooltiptext = نشووݩ داڌن بونکۊیل بلگه ایسا
...
navbar-library =
    .label = کتاو هووه
    .tooltiptext = نیشتن ویرگار، نشووکا زفت وابیڌه وو مووردا دیری
navbar-search =
    .title = پیتینیڌن
...
restore-session-startup-suggestion-message = <strong>اخۊین بلگه یل پؽشی ن بۊگۊشین؟</strong> ترین نشست پؽشی خوتووݩ ن ز نومگه { -brand-short-name } <img data-l10n-name="icon"/>، من بشن ویرگار وورگنین.
...
# Variables:
#   $agentName (String): The name of the DLP agent that is connected
content-analysis-panel-text-styled = سازمووݩ ایسا <b>{ $agentName }</b> ن سی زفت وابیڌن ری و ری ز دست داڌن داده یل و کار ابره. <a data-l10n-name="info">قلوه دووسته بۊین</a>
...
firefox-relay-offer-why-to-use-relay = ماسکا ایمن ایما ک و کار گرؽڌن سووݩ آسووݩ هڌ، هۊویت ایسا ن زفت اکونه وو وا بؽڌار کردن نشۊوی ایمیل ایسا ز هرزنومه یل جلاوگری اکونن.
# Variables:
