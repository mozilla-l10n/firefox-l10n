...
ai-window-open-sidebar =
    .description = نشووݩ داڌن نوار کلی دستیار من هر بلگه نۊ. هر سا خاستین ترین هو ن بووندین.
    .label = گۊشیڌن خوتکار دستیار
ai-window-smart-cursor-in-smart-window =
    .description = دسرسی زل و خولاسه کردن، تووزیهات وو مووردا قلوه.
    .label = نشووݩ داڌن ره نهنگا مجال پسند هؽل
