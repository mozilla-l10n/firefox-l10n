...
extension-default-theme-description2 = ی رنگ خاکستری-بناوش موتعادل وو آشنا سی شؽواتی کلاسیک { -brand-product-name }.
