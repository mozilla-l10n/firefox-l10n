...
about-private-browsing-search-banner-title = { $engineName } موتور پیتینیڌن پؽش فرز ایسا من نیمدری یل سیخومی هڌ
about-private-browsing-search-banner-description =
    { PLATFORM() ->
        [windows] سی پسند ی موتور پیتینیڌن دیری و <a data-l10n-name="link-options">گۊزینه یل</a> بروین
       *[other] سی پسند ی موتور پیتینیڌن دیری و <a data-l10n-name="link-options">ترجیهات</a> بروین
    }
