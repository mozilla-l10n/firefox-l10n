...
restore-from-backup-support-link1 = چ چیه ز نۊ وورکل بۊ؟
...
backup-service-error-unsupported-version =
    .heading = ای فایل کار نؽکونه
    .message = فایلی ک پسند کردین وا ای نوسخه ز { -brand-short-name } سازگار نؽ. فایل دیری ن پسند کۊنین وو دووارته امتهووݩ کۊنین.
# The backup file cannot be restored. The currently running application is not
# the same application that created the backup file (e.g. Firefox cannot
# restore a Thunderbird profile backup).
backup-service-error-unsupported-application =
    .heading = ای فایل کار نؽکونه
    .message = فایلی ک پسند کردین و دست { -brand-short-name } وورکل نوابیڌه. فایل دیری ن پسند کۊنین وو دووارته امتهووݩ کۊنین.
# Recovery from backup did not succeed. Potential causes could be file system
# errors, internal code errors, decryption errors, etc.
backup-service-error-recovery-failed =
    .heading = { -brand-short-name } نترست وورگنه
    .message = { -brand-short-name } ن دووارته ره ونین وو دووارته قپ ریت کۊنین نوسخه لادرار خوتووݩ ن وورگنین.
# There was some error in the backup service but we don't have a more specific
# idea of what went wrong
backup-service-error-went-wrong2 =
    .heading = ای بوۊمی، موشکلؽ من لادراری گرؽڌن بی.
    .message = چن دیقه دی دووارته امتهووݩ کۊنین.
...
backup-error-retry = موشکلؽ پؽش ٱووڌه. دووارته امتهووݩ کۊنین.
