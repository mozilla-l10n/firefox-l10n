...
certmgr-title =
    .title = دؽوۉدار گوواهی
certmgr-tab-mine =
    .label = گوواهی یل ایسا
certmgr-tab-remembered =
    .label = تسمیما ائراز هۊویت
certmgr-tab-people =
    .label = آڌۊمی یل
certmgr-tab-servers =
    .label = سرورا
certmgr-edit-cert-edit-trust = آلشت سامووا ائتماد:
certmgr-cert-host =
    .label = میزبووݩ
certmgr-cert-name =
    .label = نوم گوواهی
...
certmgr-delete-builtin =
    .label = پاک کردن یا بؽ ائتمادی…
    .accesskey = D
certmgr-backup =
    .label = لادراری گرؽڌن…
    .accesskey = B
certmgr-backup-all =
    .label = لادراری گرؽڌن ز پوی…
    .accesskey = k
certmgr-restore =
    .label = و من ٱووردن…
    .accesskey = m
