...
about-private-browsing-info-saved = { -brand-short-name } <strong>اطلاعات زیر را ذخیره خواهد کرد</strong>:
...
about-private-browsing-search-banner-title = { $engineName } موتور جست‌وجو پیش‌فرض شما در پنجره‌های ناشناس است
