...
about-private-browsing-info-downloads = tải xuống
private-browsing-title = Duyệt web riêng tư
about-private-browsing-info-saved = { -brand-short-name } <strong>sẽ lưu</strong> của bạn:
about-private-browsing-info-myths = Những lầm tưởng phổ biến về duyệt web riêng tư
about-private-browsing-info-clipboard = văn bản được sao chép
about-private-browsing-info-temporary-files = tập tin tạm
