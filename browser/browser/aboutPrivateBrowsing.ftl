...
about-private-browsing-info-description-simplified = { -brand-short-name } удаляет историю поиска и посещений при закрытии всех приватных окон, но это не делает вас анонимным.
