...
about-private-browsing-get-privacy = Получите защиту приватности в любой точке Интернета
about-private-browsing-hide-activity-1 = Скройте активность и местоположение в Интернете с помощью { -mozilla-vpn-brand-name }. Одним щелчком мыши создавайте безопасное соединение, даже при использовании общедоступного Wi-Fi.
