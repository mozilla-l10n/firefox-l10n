...
tracking-protection-start-tour = Seo mar a dh’obraicheas e
about-private-browsing-note = Cha dèan brabhsadh prìobhaideach <strong>do-fhaicsinneach thu</strong> air an eadar-lìon. Chì an solaraiche-lìn no am fastaiche agad fhathast na duilleagan air an tadhail thu.
