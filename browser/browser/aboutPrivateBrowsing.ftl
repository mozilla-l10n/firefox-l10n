...
about-private-browsing-info-description-simplified = { -brand-short-name } vymaže históriu vyhľadávania a prehliadania po zatvorení všetkých súkromných okien, ale tým sa nestanete anonymným.
