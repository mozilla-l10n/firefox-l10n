...
about-private-browsing-info-searches = guetes
about-private-browsing-info-downloads = descargues
private-browsing-title = Restolar en privao
about-private-browsing-info-saved = { -brand-short-name } <strong>va guardar</strong> :
about-private-browsing-info-temporary-files = ficheros temporales
