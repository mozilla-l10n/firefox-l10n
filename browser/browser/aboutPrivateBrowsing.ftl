...
about-private-browsing-search-banner-description =
    { PLATFORM() ->
        [windows] หากต้องการเลือกเครื่องมือค้นหาอื่น ให้ไปที่ <a data-l10n-name="link-options">ตัวเลือก</a>
       *[other] หากต้องการเลือกเครื่องมือค้นหาอื่น ให้ไปที่ <a data-l10n-name="link-options">การกำหนดลักษณะ</a>
    }
