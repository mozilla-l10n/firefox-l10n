...
about-private-browsing-info-saved = { -brand-short-name } <strong>akan menyimpan</strong> :
...
about-private-browsing-note = Penjelajahan Pribadi <strong>tidak membuat Anda menjadi anonim</strong> di Internet. Kantor atau penyedia layanan jasa internet Anda mungkin tetap dapat mengetahui laman apa yang Anda kunjungi.
