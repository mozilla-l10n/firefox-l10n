...
privatebrowsingpage-open-private-window-label = افتح نافذة خاصة
    .accesskey = خ
about-private-browsing-info-notsaved = عندما تتصفح في نافذة خاصة، <strong>لا يحفظ</strong> فَيَرفُكس:
...
content-blocking-description = تستخدم بعض المواقع متعقّبات تُراقب نشاطك وأنت تجوب الإنترنت. في النوافذ الخاصة، ميزة فَيَرفُكس لحجب المحتوى تمنع تلقائيا العديد من المتعقّبات التي تجمع المعلومات عن سلوكك في تصفح الوِب.
