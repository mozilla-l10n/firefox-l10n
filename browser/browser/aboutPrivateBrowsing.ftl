...
content-blocking-description = 一部のウェブサイトはインターネット上の行動を監視するトラッカーを使用しています。プライベートウインドウでは、{ -brand-short-name } コンテンツブロッキングが、インターネット上の行動を情報収集する多くのトラッカーを自動的にブロックします。
