...
about-unloads-column-sortweight = Secondary Weight
    .title = Nếu có, các thẻ được sắp xếp theo giá trị này sau khi được sắp xếp theo base weight. Giá trị bắt nguồn từ việc sử dụng bộ nhớ của tab và số lượng các quá trình.
