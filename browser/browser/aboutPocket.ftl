...
pocket-panel-home-my-list = La meva llista
pocket-panel-home-welcome-back = Ben tornat
pocket-panel-home-paragraph = Podeu utilitzar el { -pocket-brand-name } per explorar i desar pàgines web, articles, vídeos i podcasts, o bé revisitar allò que ja heu llegit.
