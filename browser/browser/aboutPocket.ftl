...
pocket-panel-saved-removed-updated = הדף הוסר מרשימת השמורים שלי
...
pocket-panel-signup-cta-b-updated = ניתן ללחוץ על כפתור ה־{ -pocket-brand-name } כדי לשמור מאמרים, סרטונים וקישורים. ניתן גם לצפות ברשימת השמורים שלך בכל מכשיר, בכל זמן.
...
pocket-panel-signup-cta-c-updated = הצגת רשימת השמורים בכל מכשיר, בכל זמן.
...
pocket-panel-header-my-saves = הצגת רשימת השמורים שלי
