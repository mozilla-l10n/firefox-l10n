...
customize-mode-menu-and-toolbars-header = Перацягніце ўлюбёныя элементы на паліцу інструментаў або ў меню перапаўнення.
...
customize-mode-overflow-list-description = Перацягніце элементы сюды, каб трымаць іх пад рукой, але не на паліцы інструментаў…
