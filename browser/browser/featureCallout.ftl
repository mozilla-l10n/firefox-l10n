...
callout-pdfjs-edit-body-a = გამოიყენეთ { -brand-short-name } და შიგვე შეავსეთ კითხვარები, დაურთეთ შენიშვნები ან მოხაზეთ ტექსტი.
callout-pdfjs-edit-body-b = ნუღარ მოიძიებთ ინტერნეტში უფასოდ ჩასწორების საშუალებებს. გამოიყენეთ { -brand-short-name } და აქვე შეავსეთ კითხვარები, დაურთეთ შენიშვნები ან მოხაზეთ ტექსტი.
