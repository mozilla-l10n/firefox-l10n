...
upgrade-dialog-theme-keep = Сохранить предыдущую
    .title = Использовать тему, которую вы установили перед обновлением { -brand-short-name }
upgrade-dialog-theme-primary-button = Сохранить тему
