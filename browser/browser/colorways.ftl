...
colorway-collection-independent-voices = დამოუკიდებელი ხმა
colorway-collection-independent-voices-description = ფერს შეუძლია ღირებულებებზე ზეგავლენა. თითოეული ახალი შეფერილობა ეძღვნება მათ, ვინც ხმას იმაღლებს და ცდილობს, მსოფლიო მეტად უკეთესი გახადოს.
# Used as a subheading for the colorway collection card in about:addons
colorway-collection-independent-voices-short-description = ფერები, რომლებიც ცვლის ღირებულებებს.
...
innovator-colorway-description = ყველაფრისადმი თქვენი ახლებური ხედვა უკეთესობისკენ ცვლის გარშემომყოფთა ცხოვრებას.
