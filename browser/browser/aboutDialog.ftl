...
update-internal-error2 = Ներքին սխալի պատճառով հնարավոր չէ ստուգել թարմացումների առկայությունը: Թարմացումները հասանելի են <label data-l10n-name="manual-link">
