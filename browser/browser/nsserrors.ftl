...
ssl-error-bad-cert-alert = SSL සාමානයට ඔබගේ සහතිකය සත්‍යාපනය කිරීමට නොහැකිය.
...
ssl-error-rx-unexpected-cert-verify = සහතිකය සත්‍යාපනය කරන අතට අත දීමේ අනපේක්‍ෂිත පණිවිඩයක් SSL වෙත ලැබුණි.
...
ssl-error-sign-hashes-failure = ඔබගේ සහතිකය සත්‍යාපනය කිරීමට අවශ්‍ය දත්ත අංකිතව අත්සන් කළ නොහැකිය.
