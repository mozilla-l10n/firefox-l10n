...
protocolhandler-mailto-os-handler-notificationbox = Haluatko käyttää { -brand-short-name }ia sähköpostia lähettävien linkkien avaamiseen?
protocolhandler-mailto-os-handler-yes-confirm = { -brand-short-name } on nyt oletussovellus sähköpostin lähettävien linkkien avaamiseen.
protocolhandler-mailto-os-handler-yes-button = Aseta oletukseksi
protocolhandler-mailto-os-handler-no-button = Ei nyt
...
protocolhandler-mailto-handler-yes-button = Aseta oletukseksi
protocolhandler-mailto-handler-no-button = Ei nyt
