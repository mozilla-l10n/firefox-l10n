...
crashed-include-URL = Uključi URL-ove otvorenih stranica prije rušenja { -brand-short-name }a.
crashed-include-URL-2 = Uključi URL-ove otvorenih stranica prije rušenja { -brand-short-name }a.
