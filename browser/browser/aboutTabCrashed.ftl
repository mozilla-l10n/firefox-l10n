...
crashed-single-offer-help-message = Escolher { crashed-restore-tab-button } para recarregar a página.
crashed-multiple-offer-help-message = Escolher { crashed-restore-tab-button } ou { crashed-restore-all-button } para recarregar a(s) página(s).
