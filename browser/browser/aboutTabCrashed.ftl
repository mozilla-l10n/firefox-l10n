...
crashed-include-URL = { -brand-short-name } çöktüğünde açık olan sitelerin adreslerini de gönder.
...
crashed-email-me = Daha fazla bilgi ortaya çıktığında bana e-posta gönder
...
crashed-auto-submit-checkbox = { -brand-short-name } çöktüğünde çökme raporlarını kendiliğinden göndermek üzere ayarla.
