...
crashed-send-report = Автоматично изпращане на доклад за срива, за да отстраним подобни проблеми
...
crashed-include-URL = Включване на адресите на отворените страници, когато { -brand-short-name } се срина
crashed-include-URL-2 = Включване адресите на отворените страници при сриване на { -brand-short-name }
crashed-email-placeholder = Въведете адреса на своята ел. поща
crashed-email-me = Изпращане на имейл, когато има повече информация
...
crashed-auto-submit-checkbox = Променяне на настройките, така че докладите за срив на { -brand-short-name } да бъдат изпращани автоматично
