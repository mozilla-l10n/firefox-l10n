...
crashed-send-report = Trimite automat un raport de defecțiuni să putem rezolva problemele de acest gen.
crashed-comment =
    .placeholder = Adaugă un comentariu (comentariile sunt vizibile publicului)
crashed-include-URL = Include URL-ul siteurilor pe care erai când { -brand-short-name } s-a închis neașteptat.
crashed-email-placeholder = Introdu-ți adresa de e-mail aici
crashed-email-me = Trimite-mi e-mail când sunt mai multe informații disponibile
...
crashed-auto-submit-checkbox = Actualizează preferințele pentru a trimite automat rapoarte când { -brand-short-name } se închide neașteptat.
