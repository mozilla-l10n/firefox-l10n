...
crashed-include-URL = Συμπεριλάβετε τα URLs των ιστοσελίδων όπου ήσασταν όταν το { -brand-short-name } κατέρρευσε.
...
crashed-auto-submit-checkbox = Ενημερώστε τις προτιμήσεις για αυτόματη υποβολή αναφορών όταν το { -brand-short-name } καταρρεύσει.
