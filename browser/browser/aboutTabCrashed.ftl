...
crashed-include-URL-2 = Zahrnúť adresy URL stránok, na ktorých ste boli pri zlyhaní { -brand-short-name(case: "gen") }
...
crashed-auto-submit-checkbox-2 = Aktualizovať predvoľby na automatické odosielanie hlásení pri zlyhaní prehliadača { -brand-short-name }
