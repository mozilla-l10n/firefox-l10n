...
crashed-single-offer-help-message = Націсніце { crashed-restore-tab-button } , каб перазагрузіць старонку.
crashed-multiple-offer-help-message = Націсніце { crashed-restore-tab-button } ці { crashed-restore-all-button } , каб перазагрузіць старонку/старонкі.
