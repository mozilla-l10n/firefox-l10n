...
crashed-send-report = Cuir aithisg fhèin-obrachail mun tuisleadh seo ach an urrainn dhuinn duilgheadasan mar seo a chàradh.
...
crashed-include-URL = Gabh a-staigh URLaichean nan làraichean air an robh thu nuair a thuislich { -brand-short-name }.
