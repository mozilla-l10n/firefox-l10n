...
crashed-send-report = Envia un informe de fallada automàtic per ajudar a corregir errors com aquest.
...
crashed-email-placeholder = Introduïu la vostra adreça electrònica aquí
...
crashed-auto-submit-checkbox = Actualitza les preferències per tal que s'enviïn informes automàticament en produir-se una fallada del { -brand-short-name }.
