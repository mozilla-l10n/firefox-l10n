...
crashed-send-report = Надішліть автоматичний звіт про збій, щоб ми могли виправити подібні помилки.
crashed-comment =
    .placeholder = Необов'язковий коментар (коментарі бачать всі)
crashed-include-URL = Включити URL-адреси сайтів, які були відкриті в момент збою { -brand-short-name }.
crashed-email-placeholder = Введіть свою адресу е-пошти
crashed-email-me = Повідомити мене, коли стане доступно більше інформації
...
crashed-auto-submit-checkbox = Змініть налаштування для автоматичного надсилання звітів про збої { -brand-short-name }.
