...
crashed-single-offer-help-message = Odaberite { crashed-restore-tab-button } kako biste ponovno učitali stranicu.
crashed-multiple-offer-help-message = Odaberite { crashed-restore-tab-button } ili { crashed-restore-all-button } kako biste ponovno učitali stranicu/stranice.
...
crashed-include-URL = Uključi URL-ove stranica na kojima ste bili kada se { -brand-short-name } srušio.
crashed-email-placeholder = Ovdje upišite vašu adresu elektroničke pošte
crashed-email-me = Pošalji mi obavijest elektroničkom poštom kada bude dostupno više informacija
crashed-report-sent = Izvještaj rušenja je već poslan. Hvala vam što ste pomogli unaprijediti { -brand-short-name }!
