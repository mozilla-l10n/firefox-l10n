...
onboarding-browse-privately-button = プライベートウインドウを開く
...
onboarding-import-browser-settings-title = ブックマークやパスワードなどを読み込む
onboarding-import-browser-settings-text = すぐに飛び込もう - Chrome からサイトと設定を簡単に持ち込めます。
onboarding-import-browser-settings-button = Chrome からデータを読み込む
