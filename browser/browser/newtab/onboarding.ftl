...
onboarding-fxa-text = Crea un { -fxaccount-brand-name(capitalization: "lowercase") } e sincronizza segnalibri, password e schede aperte su tutti i dispositivi in cui utilizzi { -brand-short-name }.
