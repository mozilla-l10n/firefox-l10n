...
onboarding-live-language-subtitle = { -brand-short-name } brûkt { $appLanguage }, wylst jo systeem { $systemLanguage } brûkt.
onboarding-live-language-switch-button-label = Wikselje nei { $negotiatedLanguage }
onboarding-live-language-button-label-downloading = It taalpakket downloade foar { $negotiatedLanguage }...
onboarding-live-language-waiting-subtitle = It liket derop dat jo systeem en { -brand-short-name } ferskillende talen brûke.
...
onboarding-live-language-not-now-button-label = No net
