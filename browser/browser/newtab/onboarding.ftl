...
onboarding-live-language-subtitle = { -brand-short-name } { $appLanguage } ama sisteminiz { $systemLanguage }.
onboarding-live-language-switch-button-label = { $negotiatedLanguage } diline geç
onboarding-live-language-button-label-downloading = { $negotiatedLanguage } dil paketi indiriliyor…
onboarding-live-language-waiting-subtitle = Sisteminiz ve { -brand-short-name } farklı diller kullanıyor.
...
onboarding-live-language-not-now-button-label = Daha sonra
