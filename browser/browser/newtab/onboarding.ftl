...
onboarding-live-language-subtitle = { -brand-short-name } { $appLanguage } ari da erabiltzen; zure sistema, aldiz, { $systemLanguage }.
onboarding-live-language-switch-button-label = Aldatu { $negotiatedLanguage } hizkuntzara
onboarding-live-language-button-label-downloading = { $negotiatedLanguage } hizkuntzarako paketea deskargatzen…
onboarding-live-language-waiting-subtitle = Badirudi zure sistema eta { -brand-short-name } hizkuntza desberdinak ari direla erabiltzen.
...
onboarding-live-language-not-now-button-label = Une honetan ez
