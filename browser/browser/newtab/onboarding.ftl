...
onboarding-fxa-text = Luo { -fxaccount-brand-name } -tili ja synkronoi kirjanmerkit, salasanat ja avoimet välilehdet kaikkialla, missä käytät { -brand-short-name }ia.
