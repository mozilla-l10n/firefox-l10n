...
onboarding-live-language-subtitle = Mae { -brand-short-name } yn defnyddio { $appLanguage } tra bod eich system yn defnyddio { $systemLanguage }.
onboarding-live-language-switch-button-label = Newid i { $negotiatedLanguage }
onboarding-live-language-button-label-downloading = Wrthi'n llwytho i lawr y pecyn iaith ar gyfer { $negotiatedLanguage }…
onboarding-live-language-waiting-subtitle = Mae'n edrych fel bod eich system a { -brand-short-name } yn defnyddio ieithoedd gwahanol.
...
onboarding-live-language-not-now-button-label = Nid nawr
