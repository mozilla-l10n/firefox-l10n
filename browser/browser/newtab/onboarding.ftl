...
onboarding-live-language-subtitle = { -brand-short-name } es en { $appLanguage } mentre que lo sistèma es en { $systemLanguage }.
onboarding-live-language-switch-button-label = Passar en { $negotiatedLanguage }
onboarding-live-language-button-label-downloading = Telecargament del paquet lingüistic en { $negotiatedLanguage }…
onboarding-live-language-waiting-subtitle = Sembla que lo sistèma e { -brand-short-name } utilizan de lengas diferentas.
...
onboarding-live-language-not-now-button-label = Pas ara
