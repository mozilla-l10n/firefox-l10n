...
onboarding-live-language-subtitle = { -brand-short-name } käyttää kieltä { $appLanguage } kun järjestelmäsi käyttää kieltä { $systemLanguage }.
onboarding-live-language-switch-button-label = Vaihda kieleen { $negotiatedLanguage }
onboarding-live-language-button-label-downloading = Ladataan kielen { $negotiatedLanguage } kielipakettia…
onboarding-live-language-waiting-subtitle = Vaikuttaa siltä, että järjestelmäsi ja { -brand-short-name } käyttävät eri kieliä.
...
onboarding-live-language-not-now-button-label = Ei nyt
