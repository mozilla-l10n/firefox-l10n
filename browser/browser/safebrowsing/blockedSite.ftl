...
safeb-blocked-unwanted-page-learn-more = Pelajari lebih lanjut tentang perangkat lunak berbahaya dan tidak diinginkan di <a data-l10n-name='learn_more_link'>Unwanted Software Policy</a>. Pelajari lebih lanjut tentang Perlindungan Pengelabuan dan Perangkat Perusak di <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
