...
safeb-blocked-malware-page-error-desc-no-override = <span data-l10n-name='sitename'>{ $sitename }</span> is <a data-l10n-name='error_desc_link'>rapportearre as in website dy't kweawollende software befettet</a>. Jo kinne <a data-l10n-name='report_detection'>in deteksjeprobleem rapportearje</a>.
safeb-blocked-malware-page-learn-more = Lâs mear oer skeadlike webynhâd, wêrûnder firussen en oare malware, en it beskermjen fan jo kompjûter op <a data-l10n-name='learn_more_link'>StopBadware.org</a>. Lês mear oer beskerming tsjin phishing en malware fan { -brand-short-name } op <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
