...
safeb-blocked-phishing-page-learn-more = Lleei más tocante a los sitios engañosos y el phishing en <a data-l10n-name='learn_more_link'>www.antiphishing.org</a>. Por embargu, si tamién quies lleer más tocante a la proteición escontra'l malware y phishing de { -brand-short-name }, visita <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
