...
safeb-blocked-malware-page-error-desc-override-sumo = Mae <span data-l10n-name='sitename'>{ $sitename }</span> y hysbys <a data-l10n-name='error_desc_link'>fel gwefan sy'n cynnwys meddalwedd niweidiol</a>. Gallwch <a data-l10n-name='ignore_warning_link'>anwybyddu'r perygl</a> a mynd i'r wefan anniogel hon.
safeb-blocked-malware-page-error-desc-no-override-sumo = Mae <span data-l10n-name='sitename'>{ $sitename }</span> yn hysbys <a data-l10n-name='error_desc_link'>fel gwefan sy'n cynnwys meddalwedd niweidiol</a>.
