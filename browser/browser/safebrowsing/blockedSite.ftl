...
safeb-blocked-unwanted-page-learn-more = Saznajte više o štetnom i neželjenom softveru na stranici <a data-l10n-name='learn_more_link'>politike o neželjenom softveru</a>. Saznajte više o { -brand-short-name } zaštiti od phishinga i štetnog softvera na <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
