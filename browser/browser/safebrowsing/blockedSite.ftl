...
safeb-blocked-malware-page-error-desc-no-override = <span data-l10n-name='sitename'>{ $sitename }</span> відомий <a data-l10n-name='error_desc_link'>як такий, що містить зловмисні програми</a>. Ви можете <a data-l10n-name='report_detection'>повідомити про невідповідність цієї інформації</a>.
safeb-blocked-malware-page-learn-more = Дізнайтеся більше про небезпечний вебвміст, включно з вірусами та іншими зловмисними програмами, а також про те, як захистити свій комп'ютер, на сайті <a data-l10n-name='learn_more_link'>StopBadware.org</a>. Дізнайтеся більше про те, як працює захист від зловмисного вмісту в { -brand-short-name } на сайті <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
