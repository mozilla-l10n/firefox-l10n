...
safeb-blocked-malware-page-error-desc-override = <span data-l10n-name='sitename'>{ $sitename }</span> fue <a data-l10n-name='error_desc_link'>reportado por contener software malicioso</a>. Puede <a data-l10n-name='report_detection'>informar sobre un problema de detección</a> o <a data-l10n-name='ignore_warning_link'>ignorar el riesgo</a> y visitar el sitio que no es seguro.
safeb-blocked-malware-page-error-desc-no-override = <span data-l10n-name='sitename'>{ $sitename }</span> fue <a data-l10n-name='error_desc_link'>reportado por contener software malicioso</a>. Puede <a data-l10n-name='report_detection'>reportar un problema de detección</a>.
