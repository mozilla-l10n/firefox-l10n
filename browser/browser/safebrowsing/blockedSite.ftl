...
safeb-blocked-malware-page-error-desc-no-override = <span data-l10n-name='sitename'>{ $sitename }</span> đã <a data-l10n-name='error_desc_link'>báo cáo là có chứa phần mềm độc hại</a>. Bạn có thể <a data-l10n-name='report_detection'>báo cáo một vấn đề phát hiện</a>.
safeb-blocked-malware-page-learn-more = Tìm hiểu thêm về nội dung trang web độc hại, bao gồm cả virus và các phần mềm độc hại và làm thế nào để bảo vệ máy tính của bạn tại <a data-l10n-name='learn_more_link'>StopBadware.org</a>. Tìm hiểu thêm về chính sách bảo vệ sự lừa đảo và phần mềm độc hại tại <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
