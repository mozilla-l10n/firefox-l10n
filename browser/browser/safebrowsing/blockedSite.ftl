...
safeb-blocked-unwanted-page-short-desc = 브라우징 경험을 해칠 수 있는 프로그램을 설치하도록 속일 수 있기 때문(예를 들어 첫페이지를 바꾸거나 방문한 사이트에 광고를 추가)에 { -brand-short-name }가 이 페이지를 차단하였습니다.
...
safeb-blocked-phishing-page-learn-more = <a data-l10n-name='learn_more_link'>www.antiphishing.org</a>에서 의심가는 사이트와 피싱에 대해서 알아보세요. <a data-l10n-name='firefox_support'>support.mozilla.org</a>에서 { -brand-short-name }의 피싱과 악성코드 방지에 대해 알아보세요.
...
safeb-blocked-malware-page-learn-more = <a data-l10n-name='learn_more_link'>StopBadware.org</a>에서 바이러스와 다른 악성코드를 포함하고 있는 웹 콘텐츠에 대한 내용과 컴퓨터를 보호하는 방법에 대해 알아보세요. <a data-l10n-name='firefox_support'>support.mozilla.org</a>에서 { -brand-short-name }의 피싱과 악성코드 방지에 대해 알아보세요.
safeb-blocked-unwanted-page-error-desc-override = <span data-l10n-name='sitename'>{ $sitename }</span> 사이트가 <a data-l10n-name='error_desc_link'>위험한 소프트웨어를 포함</a>하고 있는 것으로 보고 되었습니다. <a data-l10n-name='ignore_warning_link'>위험을 무시</a>하고 안전하지 않은 사이트로 진행할 수 있습니다.
safeb-blocked-unwanted-page-error-desc-no-override = <span data-l10n-name='sitename'>{ $sitename }</span> 사이트가 <a data-l10n-name='error_desc_link'>위험한 소프트웨어를 포함</a>하고 있는 것으로 보고 되었습니다.
safeb-blocked-unwanted-page-learn-more = <a data-l10n-name='learn_more_link'>원치 않는 소프트웨어 정책</a>에서 위험한 원치 않는 소프트웨어에 대해 알아보세요. <a data-l10n-name='firefox_support'>support.mozilla.org</a>에서 { -brand-short-name }의 피싱과 악성코드 방지에 대해 알아보세요.
...
safeb-blocked-harmful-page-learn-more = <a data-l10n-name='firefox_support'>support.mozilla.org</a>에서 { -brand-short-name }의 피싱과 악성코드 방지에 대해 알아보세요.
