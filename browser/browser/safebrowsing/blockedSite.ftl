...
safeb-blocked-malware-page-error-desc-override = Par lapu <span data-l10n-name='sitename'>{ $sitename }</span> ir saņemti <a data-l10n-name='error_desc_link'>ziņojumi, ka tā satur kaitīgu programmatūru</a>. Varat <a data-l10n-name='report_detection'>ziņot par kļūdu</a> vai <a data-l10n-name='ignore_warning_link'>ignorēt šo paziņojumu</a> un doties uz nedrošo lapu.
safeb-blocked-malware-page-error-desc-no-override = Par lapu <span data-l10n-name='sitename'>{ $sitename }</span> ir saņemti <a data-l10n-name='error_desc_link'>ziņojumi, ka tā satur kaitīgu programmatūru</a>. Jūs varat <a data-l10n-name='report_detection'>ziņot par kļūdu</a>.
safeb-blocked-malware-page-learn-more = Uzziniet vairāk par vīrusiem un kaitniecisku programmatūru, kā arī to kā pasargāt sevi no briesmām <a data-l10n-name='learn_more_link'>StopBadware.org</a>. Uzziniet vairāk par { -brand-short-name } aizsardzībām <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
