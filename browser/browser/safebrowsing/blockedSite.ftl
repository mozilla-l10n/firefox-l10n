...
safeb-blocked-malware-page-error-desc-no-override = Stránka <span data-l10n-name='sitename'>{ $sitename }</span> bola <a data-l10n-name='error_desc_link'> nahlásená ako stránka so škodlivým softvérom</a>. Môžete nahlásiť <a data-l10n-name='report_detection'>chybu v detekcii</a>.
safeb-blocked-malware-page-learn-more = Ďalšie informácie o škodlivom obsahu na webe, ako sú vírusy a ďalší malvér a o tom, ako chrániť svoj počítač nájdete na <a data-l10n-name='learn_more_link'>StopBadware.org</a>. Ďalšie informácie o ochrane pred phishingom a malvérom v aplikácii { -brand-short-name } nájdete na <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
...
safeb-blocked-unwanted-page-learn-more = Ďalšie informácie o škodlivom a nechcenom softvére nájdete na stránke <a data-l10n-name='learn_more_link'>Unwanted Software Policy</a>. Ďalšie informácie o ochrane pred phishingom a malvérom v aplikácii { -brand-short-name } nájdete na <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
