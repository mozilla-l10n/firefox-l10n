...
safeb-blocked-malware-page-error-desc-no-override = Stran <span data-l10n-name='sitename'>{ $sitename }</span> je bila <a data-l10n-name='error_desc_link'>prijavljena, da vsebuje zlonamerno programsko opremo</a>. Lahko <a data-l10n-name='report_detection'>nam sporočite napačno prijavo</a>.
safeb-blocked-malware-page-learn-more = Na <a data-l10n-name='learn_more_link'>StopBadware.org</a> lahko izveste več o škodljivi spletni vsebini, vključno z virusi in drugo zlonamerno programsko opremo, in kako zaščititi svoj računalnik. Več o { -brand-short-name }ovi zaščiti pred ribarjenjem in zlonamerno programsko opremo lahko izveste na <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
