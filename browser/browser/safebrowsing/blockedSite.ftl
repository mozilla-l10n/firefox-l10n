...
safeb-blocked-malware-page-learn-more = Aprenètz-ne mai suls contenguts perilhoses e los autres logicials dangeiroses e cossí protegir vòstre ordenador en consultar <a data-l10n-name='learn_more_link'>StopBadware.org</a>. Per ne saber mai sul sistèma de proteccion de { -brand-short-name } consultatz <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
