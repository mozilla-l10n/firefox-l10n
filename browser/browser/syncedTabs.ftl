...
synced-tabs-sidebar-openprefs = Otwórz ustawienia synchronizacji
synced-tabs-sidebar-tabsnotsyncing = Włącz synchronizację kart, aby wyświetlać listę otwartych na innych urządzeniach.
...
synced-tabs-context-manage-devices =
    ...
    .accesskey = Z
fxa-sign-in = Zaloguj się do synchronizacji
