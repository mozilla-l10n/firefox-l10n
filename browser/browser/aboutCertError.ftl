...
cert-error-mitm-mozilla = { -brand-short-name } o l'é fæto da Mozilla che a l'é 'na òrganizaçion sensa fin de goâgno ch'a gestisce 'n schedaio de outoritæ de certificaçion (CA) averto. Sto schedaio CA o l'agiutta a garantî che e outoritæ de certificaçion vadan derê a-e mêgio pratiche pe-a seguessa di utenti.
