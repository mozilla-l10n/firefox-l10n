...
cert-error-not-yet-valid-now = वेबसाईट आपली ओळख प्रमाणपत्राद्वारे सिद्ध करतात जे निश्चित कालावधीसाठी वैध असतात. { $hostname } साठीचे प्रमाणपत्र { $not-after-local-time } पर्यंत वैध राहणार नाही.
# Variables:
