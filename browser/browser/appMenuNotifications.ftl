...
appmenu-update-manual =
    .label = { -brand-shorter-name } -ის უახლეს ვერსიამდე განახლება ვერ ხერხდება.
    .buttonlabel = { -brand-shorter-name } -ის ჩამოტვირთვა
    .buttonaccesskey = ჩ
    .secondarybuttonlabel = ახლა არა
    .secondarybuttonaccesskey = ა
appmenu-update-manual-message = ჩამოტვირთეთ { -brand-shorter-name } -ის ახალი ვერსია და ჩვენ დაგეხმარებით მის დაყენებაში.
appmenu-update-whats-new =
    .value = იხილეთ სიახლეები.
