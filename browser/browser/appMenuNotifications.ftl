...
appmenu-update-available-message2 = Ladda ner den senaste versionen av { -brand-shorter-name }.
appmenu-update-manual2 =
    ...
    .secondarybuttonlabel = Ignorera
    .secondarybuttonaccesskey = g
appmenu-update-manual-message2 = { -brand-shorter-name } kunde inte uppdateras automatiskt. Ladda ner den nya versionen — du förlorar inte sparad information eller anpassningar.
