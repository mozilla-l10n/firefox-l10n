...
appmenu-update-manual =
    ...
    .secondarybuttonlabel = Ne sada
    .secondarybuttonaccesskey = N
appmenu-update-manual-message = Preuzmite novu { -brand-shorter-name } instalaciju i pomoći ćemo vam ga instalirati.
...
appmenu-update-unsupported-message = Najnovija { -brand-shorter-name } verzija nije podržana na tvom sustavu.
appmenu-update-restart =
    .label = Ponovno pokrenite za ažuriranje { -brand-shorter-name }a
    .buttonlabel = Ponovo pokreni i obnovi
    .buttonaccesskey = r
    .secondarybuttonlabel = Ne sada
    .secondarybuttonaccesskey = N
appmenu-update-restart-message = Nakon brzog ponovnog pokretanja, { -brand-shorter-name } će vratiti sve tvoje otvorene kartice i prozore koji se ne nalaze u modusu privatnog pregledavanja.
