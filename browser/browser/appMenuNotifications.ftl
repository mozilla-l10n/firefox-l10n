...
appmenu-update-restart =
    ...
    .secondarybuttonlabel = ไม่ใช่ตอนนี้
    .secondarybuttonaccesskey = ม
appmenu-update-restart-message = หลังจากเริ่มการทำงานใหม่อย่างรวดเร็ว { -brand-shorter-name } จะเรียกคืนแท็บและหน้าต่างที่เปิดอยู่ทั้งหมดของคุณที่ไม่ได้อยู่ในโหมดการท่องเว็บแบบส่วนตัว
