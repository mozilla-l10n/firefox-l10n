...
appmenu-update-available-message2 = Preuzmi najnoviju verziju { -brand-shorter-name }a.
...
appmenu-update-restart-message2 = Nabavi najnoviju verziju { -brand-shorter-name }a. Otvorene kartice i prozori bit će vraćeni.
