...
appmenu-update-restart2 =
    ...
    .secondarybuttonlabel = Ignorieren
    .secondarybuttonaccesskey = I
appmenu-update-restart-message2 = Holen Sie sich die neueste Version von { -brand-shorter-name }. Offene Tabs und Fenster werden wiederhergestellt.
