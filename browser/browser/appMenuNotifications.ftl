...
appmenu-update-restart =
    ...
    .secondarybuttonlabel = Не сейчас
    .secondarybuttonaccesskey = е
appmenu-update-restart-message = После быстрого перезапуска { -brand-shorter-name } восстановит все открытые вкладки и окна, которые не были открыты в приватном режиме.
