...
appmenu-update-manual =
    .label = { -brand-shorter-name }a ni mogoče posodobiti na najnovejšo različico.
...
appmenu-update-unsupported =
    .label = { -brand-shorter-name }a ni mogoče posodobiti na najnovejšo različico.
    .buttonlabel = Več o tem
    .buttonaccesskey = V
    .secondarybuttonlabel = Zapri
    .secondarybuttonaccesskey = Z
appmenu-update-unsupported-message = Najnovejša različica { -brand-shorter-name }a ni podprta v vašem sistemu.
