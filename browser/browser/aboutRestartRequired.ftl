...
restart-required-intro = Abbiamo appena installato un aggiornamento. Fai clic su Riavvia { -brand-short-name } per portare a termine l’installazione.
restart-required-intro-brand = Un aggiornamento di { -brand-short-name } è appena stato installato in background. Fai clic su Riavvia { -brand-short-name } per portare a termine l’installazione.
