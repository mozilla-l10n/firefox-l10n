...
restart-required-intro = We hebben zojuist een update op de achtergrond uitgevoerd. Klik op { -brand-short-name } herstarten om het toepassen ervan
    te voltooien.
restart-required-intro-brand = { -brand-short-name } is zojuist op de achtergrond bijgewerkt. Klik op { -brand-short-name } herstarten om het toepassen van de update
    te voltooien.
