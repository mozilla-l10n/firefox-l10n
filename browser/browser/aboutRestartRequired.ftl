...
restart-required-heading = Zum Weiterverwenden von { -brand-short-name } neu starten
restart-required-intro = Eine Aktualisierung für { -brand-short-name } startete im Hintergrund. Sie müssen neu starten, um die Aktualisierung abzuschließen.
