...
monitor-partial-breaches-title =
    { $numBreaches ->
        [one] { $numBreachesResolved } de { $numTotalBreaches } filtración marcada como resuelta
       *[other] { $numBreachesResolved } de { $numTotalBreaches } filtraciones marcadas como resueltas
    }
# Variables:
