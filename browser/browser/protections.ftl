...
protection-report-etp-card-content-custom-not-blocking = Všechny ochrany jsou v tuto chvíli vypnuté. V nastavení aplikace { -brand-short-name } vyberte, které sledovací prvky chcete blokovat.
