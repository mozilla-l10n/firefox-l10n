...
fxa-signout-dialog-heading = האם להתנתק מ{ -fxaccount-brand-name(case: "the") }?
...
fxa-signout-checkbox =
    .label = מחיקת נתונים ממכשיר זה (כניסות, ססמאות, היסטוריה, סימניות ועוד).
fxa-signout-dialog =
    .title = התנתקות מ{ -fxaccount-brand-name(case: "a") }
    .style = min-width: 375px;
    .buttonlabelaccept = התנתקות
