...
fxa-signout-dialog-heading = Sortir da { -fxaccount-brand-name }?
...
fxa-signout-checkbox =
    .label = Stizzar las datas da quest apparat (datas d'annunzia, pleds-clav, cronologia, segnapaginas etc.).
fxa-signout-dialog =
    .title = Sortir da { -fxaccount-brand-name }
