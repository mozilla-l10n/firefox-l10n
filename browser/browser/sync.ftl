...
fxa-disconnect-dialog-body = Το { -brand-product-name } θα αποσυνδεθεί από τον λογαριασμό σας, αλλά δεν θα διαγράψει κανένα δεδομένο περιήγησης σε αυτήν τη συσκευή.
