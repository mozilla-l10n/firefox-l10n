...
fxa-toolbar-sync-syncing-tabs =
    .label = Tabbladen synchroniseren…
fxa-toolbar-sync-syncing2 = Synchroniseren…
sync-disconnect-dialog-title = Verbinding met { -sync-brand-short-name } verbreken?
...
fxa-disconnect-dialog-title = Verbinding met { -brand-product-name } verbreken?
fxa-disconnect-dialog-body = { -brand-product-name } verbreekt de verbinding met uw account, maar zal geen navigatiegegevens op dit apparaat verwijderen.
sync-disconnect-dialog-button = Verbinding verbreken
fxa-signout-dialog-heading = Afmelden bij { -fxaccount-brand-name }?
...
fxa-signout-checkbox =
    .label = Gegevens (aanmeldingen, wachtwoorden, geschiedenis, bladwijzers, enz.) van dit apparaat verwijderen.
fxa-signout-dialog =
