...
places-forget-about-this-site-confirmation-message = ამ ქმედებით მოცილდება ყველა მონაცემი, რომელთაც იყენებდა { $hostOrBaseDomain }, მათ შორის ისტორია, პაროლები, ფუნთუშები, მომარაგებული ფაილები და შიგთავსის პარამეტრები. ნამდვილად გსურთ, განაგრძოთ?
