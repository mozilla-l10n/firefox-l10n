...
webrtc-microphone-button =
    .title = Tha am micreofon agad 'ga cho-roinneadh. Dèan briogadh airson an co-roinneadh a stiùireadh.
webrtc-camera-button =
    .title = Tha an camara agad ’ga cho-roinneadh. Dèan briogadh airson an co-roinneadh a stiùireadh.
