...
webrtc-microphone-button =
    .title = Esteu compartint el micròfon. Feu clic aquí per controlar què voleu compartir.
webrtc-camera-button =
    .title = Esteu compartint la càmera. Feu clic aquí per controlar què voleu compartir.
webrtc-minimize =
