...
profiler-popup-presets-firefox-platform-description = Priporočena prednastavitev za razhroščevanje platforme Firefox.
profiler-popup-presets-firefox-platform-label =
    .label = Firefox: platforma
profiler-popup-presets-firefox-front-end-description = Priporočena prednastavitev za razhroščevanje čelnega dela Firefoxa.
profiler-popup-presets-firefox-front-end-label =
    .label = Firefox: čelni del
profiler-popup-presets-firefox-graphics-description = Priporočena prednastavitev za raziskovanje učinkovitosti grafike Firefoxa.
