...
profiler-popup-presets-graphics-description = Rhagosodiad ar gyfer ymchwilio i wallau graffeg yn { -brand-shorter-name }.
profiler-popup-presets-graphics-label =
    .label = Graffigau
profiler-popup-presets-media-description2 = Rhagosodiad ar gyfer ymchwilio i wallau sain a fideo yn { -brand-shorter-name }.
