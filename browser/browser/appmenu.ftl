...
profiler-popup-presets-graphics-description = Predvoľby pre ladenie grafických chýb v prehliadači { -brand-shorter-name }.
profiler-popup-presets-graphics-label =
    .label = Grafika
profiler-popup-presets-media-description2 = Predvoľby pre ladenie chýb zvuku a videa v prehliadači { -brand-shorter-name }.
