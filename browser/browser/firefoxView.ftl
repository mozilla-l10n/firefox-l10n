...
firefoxview-tabpickup-adddevice-primarybutton = Получите { -brand-product-name } для мобильных устройств
...
firefoxview-tabpickup-sync-error-description = { -brand-short-name } не удаётся соединиться со службой прямо сейчас. Попробуйте снова через некоторое время.
...
firefoxview-mobile-promo-primarybutton = Получите { -brand-product-name } для мобильных устройств
...
firefoxview-closed-tabs-collapse-button =
    .title = Показать или скрыть список недавно закрытых вкладок
