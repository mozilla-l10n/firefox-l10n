...
firefoxview-tabpickup-network-offline-header = Проверьте подключение к Интернету
...
firefoxview-mobile-promo-header = Берите вкладки с телефона или планшета
...
firefoxview-pickup-tabs-badge = Посещена последней
# Variables:
