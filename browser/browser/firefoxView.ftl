...
firefoxview-tabpickup-sync-error-header = სინქრონიზაციის სიძნელეს წავაწყდით
firefoxview-tabpickup-sync-error-description = { -brand-short-name } ამჟამად ვერ ახერხებს მომსახურებასთან წვდომას. კვლავ სცადეთ ცოტა ხნის შემდეგ.
