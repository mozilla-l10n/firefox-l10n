...
firefoxview-tabpickup-adddevice-primarybutton = Download { -brand-product-name } foar mobyl
firefoxview-tabpickup-synctabs-header = Skeakelje ljepblêdsyngronisaasje yn…
firefoxview-tabpickup-synctabs-description = { -brand-short-name } tastean om ljepblêden te dielen tusken apparaten.
firefoxview-tabpickup-synctabs-learn-how = Mear ynfo
firefoxview-tabpickup-synctabs-primarybutton = Syngronisearje iepen ljepblêden
...
firefoxview-tabpickup-sync-error-description = { -brand-short-name } kin de tsjinst no net berikke. Probearje it oer in pear mominten nochris.
...
firefoxview-mobile-promo-description = Om jo lêste mobile ljepblêden te besjen, meld jo oan by { -brand-product-name } op iOS of Android.
firefoxview-mobile-promo-primarybutton = Download { -brand-product-name } foar mobyl
