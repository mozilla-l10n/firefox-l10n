...
policy-BackgroundAppUpdate = ჩართვა ან გამორთვა ფონური განმაახლებლის, რომლითაც ახლდება ბრაუზერი, როცა გამორთულია.
...
policy-MasterPassword = მოთხოვნა ან არიდება მთავარი პაროლის გამოყენების.
...
policy-NoDefaultBookmarks = ნაგულისხმევი სანიშნების, რომლებითაც ახლად დაყენებული { -brand-short-name } არის წარმოდგენილი და გონიერი სანიშნების (ხშირად მონახულებული, უახლესი ჭდეების) შეზღუდვა. შენიშვნა: ეს დებულება გამოსადეგია, ახალი პროფილის პირველ გაშვებამდე.
