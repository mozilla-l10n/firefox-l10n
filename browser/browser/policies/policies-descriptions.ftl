...
policy-DisableThirdPartyModuleBlocking = Emboyke poruháragui ani ojoko ta’ãha mbohapyháva oikekuaáva { -brand-short-name } mba’eapópe.
policy-DisplayBookmarksToolbar = Ehechauka Techaukaha rembiporu renda ijypykue rupi.
