...
policy-Bookmarks = Ствараць закладкі ў панэлі закладак, меню закладак, або ў азначаных каталогах унутры іх.
...
policy-DisableDeveloperTools = Забараніць доступ да інструментаў распрацоўшчыка.
...
policy-ShowHomeButton = Паказваць кнопку "Дадому" на панэлі інструментаў.
