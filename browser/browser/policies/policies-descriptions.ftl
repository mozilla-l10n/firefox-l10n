...
policy-AppAutoUpdate = Увімкнути або вимкнути автоматичне оновлення { -brand-short-name }.
policy-AppUpdateURL = Встановити власну URL-адресу для оновлення { -brand-short-name }.
...
policy-DisableSystemAddonUpdate = Не дозволяти { -brand-short-name } встановлювати й оновлювати системні додатки.
...
policy-RequestedLocales = Встановити перелік запитуваних мов для { -brand-short-name } в бажаному порядку.
policy-SanitizeOnShutdown2 = Очищати дані навігації при виході з { -brand-short-name }.
