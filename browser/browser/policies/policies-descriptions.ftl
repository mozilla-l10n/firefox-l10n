...
policy-DisablePocket = Pocket પર વેબપૃષ્ઠને સાચવવા માટેની સુવિધાને અક્ષમ કરો.
policy-DisablePrivateBrowsing = ખાનગી બ્રાઉઝિંગ અક્ષમ કરો.
policy-DisableProfileImport = બીજા બ્રાઉઝરમાંથી માહિતી આયાત કરવા માટે મેનુ આદેશ અક્ષમ કરો.
