...
policy-Permissions2 = Настраивает разрешения для камеры, микрофона, местоположения, уведомлений и автозапуска.
...
policy-UserMessaging = Не показывать определенные сообщения пользователю.
