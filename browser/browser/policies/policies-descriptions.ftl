...
policy-AppUpdateURL = Definir uma URL personalizada de atualização de aplicação.
...
policy-DisableFirefoxStudies = Impedir o { -brand-short-name } de participar em testes.
...
policy-DisableProfileRefresh = Desativar o botão Renovar { -brand-short-name } na página about:support.
