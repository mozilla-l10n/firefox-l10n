...
policy-OfferToSaveLogins = Imponha a definição para permitir que { -brand-short-name } ofereça a memorização de credenciais e palavras-passe guardadas. São aceites ambos os valores, "true" e "false".
