...
extension-default-theme-name-auto = ธีมของระบบ — อัตโนมัติ
...
extension-firefox-compact-light-description = ธีมที่มีแบบแผนชุดสีสว่าง
extension-firefox-compact-dark-name = มืด
extension-firefox-compact-dark-description = ธีมที่มีแบบแผนชุดสีมืด
