...
login-intro-instructions-fxa = Crie ou inicie a sessão na sua { -fxaccount-brand-name(capitalization: "sentence") } no dispositivo onde as suas credenciais estão guardadas
