...
login-intro-instructions-fxa = Crea una { -fxaccount-brand-name(capitalization: "sentence") } o anicia sesión nel preséu onde se guarden los tos anicios de sesión
