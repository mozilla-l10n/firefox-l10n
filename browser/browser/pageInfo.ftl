...
security-view-privacy =
    .value = 개인 정보 및 기록
security-view-privacy-history-value = 이 웹사이트를 이전에 방문한 적이 있습니까?
security-view-privacy-sitedata-value = 이 웹사이트가 내 컴퓨터에 정보를 저장합니까?
security-view-privacy-clearsitedata =
    .label = 쿠키 및 사이트 데이터 삭제
    .accesskey = C
security-view-privacy-passwords-value = 이 웹사이트에 비밀번호를 저장한 적이 있습니까?
