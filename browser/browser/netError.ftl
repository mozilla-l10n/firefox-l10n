...
dns-not-found-with-suggestion = Oeddech chi'n bwriadu mynd i <a data-l10n-name="website">{ $hostAndPath }</a>?
dns-not-found-hint-header = <strong>Os ydych chi wedi rhoi'r cyfeiriad cywir, gallwch:</strong>
