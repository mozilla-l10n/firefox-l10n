...
preferences-doh-setting-strict =
    ...
    .accesskey = M
preferences-doh-strict-desc = { -brand-short-name } budźe přeco wěsty DNS wužiwać. Budźeće warnowanje wěstotneho rizika widźeće, prjedy hač waš systemowy DNS wužiwamy.
