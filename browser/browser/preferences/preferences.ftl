...
content-blocking-custom-desc = Vyberte, co chcete blokovat.
...
content-blocking-tracking-protection-all-detected-trackers-label =
    ...
    .accesskey = s
content-blocking-tracking-protection-new-description = Blokovat všechny známé sledovací prvky (může omezit fungování některých stránek).
