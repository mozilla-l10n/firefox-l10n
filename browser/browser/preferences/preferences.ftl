...
performance-use-recommended-settings-checkbox =
    ...
    .accesskey = U
performance-use-recommended-settings-desc = Essas configurações são adaptadas ao hardware e sistema operacional do computador. Desmarque para configurar aceleração de hardware e número de processos.
