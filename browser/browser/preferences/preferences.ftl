...
home-new-windows-tabs-description = Elija lo que ve cuando abre su página de inicio y ventanas y pestañas nuevas
...
forms-remember-logins =
    .label = Recordar inicios de sesión y contraseñas para sitios
    .accesskey = R
forms-exceptions =
    .label = Excepciones…
    .accesskey = x
...
tracking-description = La Protección contra rastreo bloquea los rastreadores de Internet que recolectan sus datos de navegación a lo largo de múltiples sitios web. <a>Conocer más sobre la protección de rastreo y privacidad</a>
