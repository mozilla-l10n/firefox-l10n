...
permissions-block-autoplay-media =
    ...
    .accesskey = b
permissions-block-autoplay-media-menu = Při pokusu o automatické přehrávání médií se zvukem
permissions-block-autoplay-media-exceptions =
    .label = Výjimky…
    .accesskey = y
autoplay-option-ask =
    .label = se zeptat na povolení
autoplay-option-allow =
    .label = jej vždy povolit
autoplay-option-block =
    .label = jej vždy zablokovat
