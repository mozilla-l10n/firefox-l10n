...
search-one-click-desc = Wählen Sie eine der Suchmaschinen, die unterhalb der Adress- bzw. Suchleiste angezeigt werden, nachdem Sie das Schlüsselwort eingegeben haben.
