...
sitedata-option-block-cross-site-tracking-cookies-including-social-media =
    .label = Cookies zur seitenübergreifenden Aktivitätenverfolgung — enthält Cookies für soziale Netzwerke
sitedata-option-block-cross-site-cookies-including-social-media =
    .label = Seitenübergreifende Cookies — enthält Cookies für soziale Netzwerke
...
content-blocking-cross-site-cookies = Seitenübergreifende Cookies
...
content-blocking-and-isolating-etp-warning-description-2 = Diese Einstellung kann dazu führen, dass einige Websites nicht korrekt Inhalte anzeigen oder funktionieren. Wenn eine Website defekt zu sein scheint, möchten Sie möglicherweise den Schutz vor Aktivitätenverfolgung für diese Website deaktivieren, um alle Inhalte zu laden.
