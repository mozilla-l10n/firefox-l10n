...
content-blocking-fastblock-option-disabled =
    .label = Không bao giờ chặn
content-blocking-tracking-protection-label = Trình theo dõi
    .accesskey = T
content-blocking-tracking-protection-description = Chặn tất cả trình theo dõi đã biết (Lưu ý: một số trang web có thể không tải được).
content-blocking-tracking-protection-option-enabled =
    .label = Luôn chặn
content-blocking-tracking-protection-option-pbm =
    .label = Chỉ chặn trong cửa sổ duyệt web riêng tư
