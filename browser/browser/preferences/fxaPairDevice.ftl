...
fxa-pair-device-dialog-sync =
    .style = width: 32em;
fxa-qrcode-pair-title = Szinkronizálja a telefonján vagy a táblagépén lévő { -brand-product-name }ot
fxa-qrcode-pair-step1 = 1. Nyissa meg a { -brand-product-name }ot a mobileszközén.
