...
more-from-moz-firefox-mobile-description-advanced = Seurainten estämisestä aina median automaattisen toistamisen estämiseen, { -brand-product-name }-mobiiliselaimet varmistavat, että saat hyvän internetin.
more-from-moz-mozilla-vpn-title = { -mozilla-vpn-brand-name }
more-from-moz-mozilla-vpn-description = Löydä lisätty taso anonyymiä selaamista ja suojausta.
more-from-moz-mozilla-vpn-description-advanced = { -mozilla-vpn-brand-name } lisää kerroksen anonyymiä selaamista ja suojausta. Ja toisin kuin jotkin muut VPN:t, se on turvallinen eikä seuraa toimintaasi.
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-title = { -rally-brand-name }
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-description = Aseta datasi paremman internetin luomiseksi kaikille.
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-description-advanced = Lahjoita datasi tutkimuksiin, jotka pyrkivät luomaan turvallisemman ja avoimemman internetin, joka auttaa ihmisiä, ei pelkkiä Big Tech -yhtiöitä.
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-button-mozilla-rally-2 = Liity { -rally-short-name }yn
