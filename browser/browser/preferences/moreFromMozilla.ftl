...
more-from-moz-firefox-mobile-description-advanced = Desde bloquear rastreadores hasta frenar las molestias de reproducción automática, los navegadores móviles de { -brand-product-name } trabajan horas extra para asegurarse de que estás recibiendo un buen Internet.
more-from-moz-mozilla-vpn-title = { -mozilla-vpn-brand-name }
more-from-moz-mozilla-vpn-description = Descubre una capa adicional de protección y navegación anónimas.
more-from-moz-mozilla-vpn-description-advanced = { -mozilla-vpn-brand-name } añade otra capa de protección y navegación anónimas. Y, a diferencia de otros VPN, es seguro y no rastrea tu actividad.
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-title = { -rally-brand-name }
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-description = Pon tus datos a trabajar por un Internet mejor para todos.
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-description-advanced = Dona tus datos para estudios de investigación que trabajen para crear un Internet más seguro y abierto, que ayude a la gente, no a las grandes empresas.
# This string is specific to the product Mozilla Rally which is US only.
