...
more-from-moz-mozilla-vpn-description-advanced = { -mozilla-vpn-brand-name } pridáva ďalšiu vrstvu anonymného prehliadania a ochrany. A na rozdiel od niektorých iných sietí VPN je bezpečná a nesleduje vašu aktivitu.
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-title = { -rally-brand-name }
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-description = Využite svoje dáta a vytvorte lepší internet pre všetkých.
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-description-advanced = Darujte svoje údaje výskumným štúdiám zameraným na vytvorenie bezpečnejšieho a otvorenejšieho internetu, ktorý pomáha ľuďom, nie veľkým korporáciám.
# This string is specific to the product Mozilla Rally which is US only.
