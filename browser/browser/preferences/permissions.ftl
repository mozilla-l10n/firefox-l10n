...
permissions-site-notification-disable-desc = По този начин ще попречите на страниците, които не са в списъка да искат разрешение да изпращат известия. Спирането на известията може да попречи на някои страници да функционират правилно.
...
permissions-site-location-disable-desc = По този начин ще попречите на страниците, които не са в списъка да искат разрешение за достъп до местоположението. Спирането достъпа до местоположението ви може да попречи на някои страници да функционират правилно.
...
permissions-site-camera-disable-desc = По този начин ще попречите на страниците, които не са в списъка да искат разрешение за достъп до камерата. Спирането на достъпа да камерата ви може да попречи на някои страници да функционират правилно.
...
permissions-site-microphone-disable-desc = По този начин ще попречите на страниците, които не са в списъка да искат разрешение за достъп до микрофона. Спирането на достъпа да микрофона ви може да попречи на някои страници да функционират правилно.
