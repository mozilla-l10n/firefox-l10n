...
permissions-exceptions-https-only-desc2 = ඔබට නිශ්චිත වියමන අඩවි සඳහා HTTPS-පමණි ප්‍රකාරය අක්‍රිය කිරීමට හැකිය. { -brand-short-name } එම අඩවි වෙත සම්බන්ධතාවය ආරක්‍ෂිත HTTPS සඳහා උත්ශ්‍රේණි නොකරනු ඇත.
