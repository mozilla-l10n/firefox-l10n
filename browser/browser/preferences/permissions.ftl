...
permissions-site-notification-window =
    ...
    .style = { permissions-window.style }
permissions-site-notification-desc = Οι ακόλουθοι ιστότοποι έχουν αιτηθεί την αποστολή ειδοποιήσεων. Μπορείτε να καθορίσετε σε ποιους ιστοτόπους επιτρέπεται η αποστολή ειδοποιήσεων. Μπορείτε επίσης να αποκλείσετε τα νέα αιτήματα ειδοποιήσεων.
...
permissions-site-xr-window =
    ...
    .style = { permissions-window.style }
permissions-site-xr-desc = Οι ακόλουθοι ιστότοποι έχουν αιτηθεί πρόσβαση στις συσκευές εικονικής πραγματικότητάς σας. Μπορείτε να καθορίσετε σε ποιους επιτρέπεται η πρόσβαση στις συσκευές εικονικής πραγματικότητάς σας. Μπορείτε επίσης να αποκλείσετε νέα αιτήματα για πρόσβαση στις συσκευές εικονικής πραγματικότητάς σας.
permissions-site-xr-disable-label =
    .label = Αποκλεισμός νέων αιτημάτων για πρόσβαση στις συσκευές εικονικής πραγματικότητάς σας
permissions-site-xr-disable-desc = Αυτό θα εμποδίσει όλους τους ιστοτόπους που δεν αναγράφονται παραπάνω να αιτηθούν άδεια για πρόσβαση στις συσκευές εικονικής πραγματικότητάς σας. Ο αποκλεισμός της πρόσβασης στις συσκευές εικονικής πραγματικότητάς σας ενδέχεται να διακόψει ορισμένες λειτουργίες των ιστοτόπων.
