...
identity-https-only-label2 = Dizze website automatysk nei in befeilige ferbining upgrade
...
identity-https-only-info-turn-on3 = Skeakelje upgrades nei HTTPS foar dizze website yn as jo wolle dat { -brand-short-name } wannear mooglik de ferbining upgradet.
