...
identity-description-active-blocked2 = { -brand-short-name } heeft onderdelen van deze pagina die niet beveiligd zijn geblokkeerd.
...
identity-description-passive-loaded-insecure2 = Deze website bevat inhoud die niet beveiligd is (zoals afbeeldingen).
identity-description-passive-loaded-mixed2 = Hoewel { -brand-short-name } bepaalde inhoud heeft geblokkeerd, staat er nog steeds inhoud op de pagina die niet beveiligd is (zoals afbeeldingen).
