...
identity-https-only-info-turn-off2 = Als de website niet lijkt te werken, dan kunt u de Alleen-HTTPS-modus voor deze website uit te schakelen en de pagina te vernieuwen met het onveilige HTTP.
