...
identity-permissions-storage-access-hint = Αυτά τα μέρη μπορούν να χρησιμοποιήσουν cookie μεταξύ ιστοσελίδων και δεδομένα ιστοσελίδων όσο βρίσκεστε σε αυτόν τον ιστότοπο.
...
identity-clear-site-data =
    .label = Διαγραφή cookie και δεδομένων ιστοσελίδας…
