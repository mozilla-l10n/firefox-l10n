...
restore-session-startup-suggestion-message = <strong>Abrir abas anteriores?</strong> Você pode restaurar a sessão anterior no menu <img data-l10n-name="icon"/> do { -brand-short-name }, em Histórico.
