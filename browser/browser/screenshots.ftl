...
screenshots-context-menu = Hacer captura de pantalla
...
screenshots-self-screenshot-error-title = ¡No se puede hacer una captura de la página de { -screenshots-brand-name }!
