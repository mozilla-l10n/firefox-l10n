...
screenshots-request-error-details = 죄송합니다! 스크린샷을 저장하지 못했습니다. 나중에 다시 시도해 주세요.
...
screenshots-login-error-details = { -screenshots-brand-name } 서비스에 문제가 있어 스크린샷을 저장할 수 없었습니다. 나중에 다시 시도해 주세요.
