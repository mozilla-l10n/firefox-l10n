...
screenshots-connection-error-details = Comprueba la conexón a internet, por favor. Si yes a conectate a internet, quiciabes heba un problema temporal col serviciu de { -screenshots-brand-name }.
...
screenshots-generic-error-details = Nun tamos seguros de lo qu'asocedió. ¿Importaríate retentalo o facer una captura nuna páxina diferente?
