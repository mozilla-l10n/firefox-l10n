...
screenshots-context-menu = ეკრანისთვის სურათის გადაღება
screenshots-my-shots-button = ჩემი გადაღებულები
screenshots-instructions = გადაადგილეთ ან დააწკაპეთ გვერდზე სივრცის მოსანიშნად. გასაუქმებლად დააჭირეთ ESC-ს.
...
screenshots-connection-error-details = გთხოვთ შეამოწმოთ ქსელთან კავშირი. თუ ინტერნეტში თავისუფლად გადიხართ, ე.ი. Firefox Screenshot-ის მომსახურებას აქვს დროებითი პრობლემა.
...
screenshots-unshootable-page-error-title = ამ გვერდისთვის სურათის გადაღება ვერ ხერხდება.
screenshots-unshootable-page-error-details = ეს არ არის ჩვეულებრივი ვებგვერდი, ამიტომაც შეუძლებელია სურათის გადაღება.
screenshots-self-screenshot-error-title = { -screenshots-brand-name }-ის გვერდისთვის სურათის გადაღება არ შეგიძლიათ!
