...
screenshots-notification-image-copied-details = Sua captura de tela foi copiada para a área de transferência. Pressione { screenshots-meta-key }-V para colar.
...
screenshots-private-window-error-title = As capturas de tela é desativadas no modo de navegação privativa
