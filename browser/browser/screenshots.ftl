...
screenshots-connection-error-details = Пожалуйста, проверьте соединение с Интернетом. Если у вам удаётся войти в Интернет, то возможно, возникла временная проблема со службой Скриншотов Firefox.
screenshots-login-error-details = Мы не можем сохранить ваш снимок, так как возникла проблема с сервисом Скриншотов Firefox. Пожалуйста, попробуйте позже.
...
screenshots-self-screenshot-error-title = Вы не можете сделать скриншот страницы Скриншотов Firefox.
screenshots-empty-selection-error-title = Выбрана слишком небольшая область
screenshots-generic-error-title = Ого! Скриншоты Firefox вышли из строя.
