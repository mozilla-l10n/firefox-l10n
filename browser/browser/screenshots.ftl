...
screenshots-connection-error-details = Lütfen internet bağlantınızı kontrol edin. İnternete bağlanabiliyorsanız Firefox Screenhosts hizmeti ile ilgili geçici bir sorun olabilir.
screenshots-login-error-details = Firefox Screenshosts hizmetinde bir sorun yaşandığı için ekran görüntünüzü kaydedemedik. Lütfen daha sonra yeniden deneyin.
...
screenshots-private-window-error-title = Gizli Gezinti modunda Screenshosts özelliği kullanılamaz
...
screenshots-generic-error-title = Firefox Screenshosts kafayı yedi!
