...
screenshots-download-button = Ladda ner
screenshots-download-button-tooltip = Ladda ner skärmbild
...
screenshots-private-window-error-title = Skärmbilder är inaktiverad i privat surfläge
