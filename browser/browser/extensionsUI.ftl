...
webext-quarantine-confirmation-line-2 = Разрешите это расширение, если вы доверяете ему чтение и изменение ваших данных на сайтах, ограниченных { -vendor-short-name }.
