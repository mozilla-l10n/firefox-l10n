...
safe-mode-description-details = Els complements i els paràmetres personalitats s'inhabilitaran temporalment, i és possible que algunes característiques del { -brand-short-name } no funcionin com ho farien normalment.
...
troubleshoot-mode-description = Utilitzeu aquest mode especial del { -brand-short-name } per diagnosticar problemes. Les vostres extensions i personalitzacions es desactivaran temporalment.
