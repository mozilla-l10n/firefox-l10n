...
new-install-sync-first = Χρησιμοποιείτε για πρώτη φορά τον συγχρονισμό; Θα πρέπει να συνδεθείτε σε κάθε εγκατάσταση του Firefox για να συγχρονίσετε τα δεδομένα σας.
