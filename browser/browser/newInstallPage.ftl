...
changed-desc-dedicated = Aby bylo možné bezpečně používat více instalací Firefoxu najednou (finální verze Firefoxu, ESR, betaverze, Firefox Developer Edition a Nightly), tato instalace nyní používá vlastní profil. Automaticky už tedy nesdílí uložená data s ostatními instalacemi.
