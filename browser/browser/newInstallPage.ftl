...
options-use-sync = Jeśli chcesz, aby dane profilu były takie same we wszystkich instalacjach Firefoksa, to możesz skorzystać z usługi { -fxaccount-brand-name }, aby je synchronizować.
