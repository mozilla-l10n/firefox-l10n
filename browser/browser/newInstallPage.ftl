...
new-install-sync-first = Používate synchronizáciu prvýkrát? Ak chcete synchronizovať svoje informácie, musíte sa prihlásiť v každej inštalácii prehliadača Firefox.
