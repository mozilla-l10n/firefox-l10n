...
options-use-sync = Profileko datuak berdinak izatea nahi baduzu Firefoxen instalazio guztietan, { -fxaccount-brand-name(kasua: "a") } erabil dezakezu hauek sinkronizatuta mantentzeko.
resources = Baliabideak:
support-link = Profilen kudeatzailea erabiltzea - laguntza artikulua
sync-header = Hasi saioa edo sortu { -fxaccount-brand-name(kasua: "a") }
...
new-install-sync-first = Lehenengo aldia da sinkronizazioa erabiltzen? Zure informazioa sinkronizatzeko, saioa hasi behar duzu Firefoxen instalazio guztietan.
