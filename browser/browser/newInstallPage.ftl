...
new-install-sync-first = Es lo primièr còp qu’utilizatz la sincronizacion ? Vos cal iniciar una session sus cada installacion de Firefox per sincronizar vòstras informacions.
