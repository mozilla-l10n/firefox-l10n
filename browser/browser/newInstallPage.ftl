...
changed-desc-profiles = ეს დაყენებული { -brand-short-name } ახალი პროფილითაა. პროფილი წარმოადგენს ფაილების კრებულს, სადაც Firefox ინახავს ისეთ მონაცემებს, როგორიცაა სანიშნები, პაროლები და მომხმარებლის პარამეტრები.
changed-desc-dedicated = Firefox-ის სხვადასხვა დაყენებულ ვერსიებს შორის (როგორიცაა Firefox, Firefox ESR, Firefox Beta, Firefox Developer Edition და Firefox Nightly) მარტივად და უსაფრთხოდ გადასართავად, მოცემული ვერსია უკვე იყენებს განცალკევებულ პროფილს. შენახული მონაცემები, Firefox-ის დანარჩენ დაყენებულ ვერსიებთან არ იქნება თავისით გაზიარებული.
...
options-do-nothing = თუ არაფერს მოიმოქმედებთ, თქვენი პროფილის მონაცემები { -brand-short-name }-ისთვის განსხვავებული იქნება Firefox-ის სხვა დაყენებული ვერსიებისგან.
