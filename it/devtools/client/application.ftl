...
serviceworker-worker-updated = Ultimo aggiornamento: <time>{ DATETIME($date, day: "numeric", hour: "numeric", year: "numeric", month: "long", minute: "numeric", second: "numeric") }</time>
