...
colorpicker-tooltip-spectrum-dragger-title = Spettro
# A title text for the eyedropper in the color picker tooltip.
colorpicker-tooltip-eyedropper-title = Seleziona un colore nella pagina
...
colorpicker-tooltip-color-name-title = Colore più simile: { $colorName }
...
inspector-emulation-panel-toggle =
    .aria-label = Attiva/disattiva funzioni di emulazione CSS
    .title = Attiva/disattiva funzioni di emulazione CSS
inspector-emulation-panel-color-scheme = Emulazione combinazione di colori
# A label text for the print emulation options
inspector-emulation-panel-print = Attiva
    .aria-label = Attiva emulazione dei supporti di stampa
# A label text for the light color scheme emulation radio button option.
inspector-emulation-panel-color-scheme-light = Chiara
    .aria-label = Attiva emulazione della combinazione di colori chiari
# A label text for the dark color scheme emulation radio button option.
inspector-emulation-panel-color-scheme-dark = Scura
    .aria-label = Attiva emulazione della combinazione di colori scuri
...
inspector-emulation-panel-reduced-motion-reduce = Riduci
    .aria-label = Attiva emulazione della riduzione del movimento
# A label text for the no preference for reduced motion emulation radio button option.
inspector-emulation-panel-reduced-motion-no-preference = Nessuna preferenza
    .aria-label = Nessuna preferenza per l’emulazione della riduzione del movimento
