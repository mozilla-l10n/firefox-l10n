...
about-httpsonly-insecure-explanation-unavailable = Stai navigando in modalità “solo HTTPS” (HTTPS-Only) e non è disponibile una versione sicura HTTPS di <em>{ $websiteUrl }</em>.
...
about-httpsonly-explanation-unavailable = Stai navigando in modalità “solo HTTPS” (HTTPS-Only) e non è disponibile una versione sicura HTTPS di <em>{ $websiteUrl }</em>.
