...
about-glean-enable-new-features-promo =
    .message = Stiamo lavorando per aggiungere nuove funzioni. Sono ancora in fase di sviluppo, ma fai clic sul pulsante di azione per attivarle.
    .heading = Presto arriveranno nuove funzionalità!
