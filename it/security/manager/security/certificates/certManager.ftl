...
exception-mgr-extra-button =
    ...
    .accesskey = C
exception-mgr-supplemental-warning = Banche, negozi e altri siti pubblici attendibili non chiederanno di fare questa operazione.
...
add-exception-unverified-or-bad-signature-long = Il certificato non è attendibile in quanto non è possibile verificare che sia stato emesso da un’autorità riconosciuta utilizzando una firma sicura.
