...
report-broken-site-panel-url-label = URL del sito non funzionante
...
report-broken-site-panel-reason-checkout-moz-box-button =
    .label = Non è possibile pagare, completare il check-out o fare acquisti
...
report-broken-site-panel-reason-media-moz-box-button =
    .label = I video non vengono riprodotti o caricati
report-broken-site-panel-reason-content-moz-box-button =
    .label = Mancano dei contenuti
report-broken-site-panel-reason-account-moz-box-button =
    .label = Impossibile accedere o registrarsi
