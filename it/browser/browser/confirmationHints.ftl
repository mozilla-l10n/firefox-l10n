...
confirmation-hint-passport-created = Passaporto salvato
confirmation-hint-passport-updated = Passaporto aggiornato
confirmation-hint-pin-tab = Appuntata
confirmation-hint-pin-tab-description = Fai clic con il tasto destro per rilasciare la scheda.
