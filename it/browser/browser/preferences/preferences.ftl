...
preferences-collection-description = Ci impegniamo a fornirti la possibilità di scegliere e raccogliamo solo dati minimali per migliorare { -brand-product-name } per tutti.
