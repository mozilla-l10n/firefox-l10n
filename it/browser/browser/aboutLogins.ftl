...
about-logins-edit-login-os-auth-dialog-message = Verificare la proprià identità per modificare le credenziali salvate.
# This message can be seen by attempting to edit a login in about:logins
...
about-logins-reveal-password-os-auth-dialog-message = Verificare la proprià identità per mostrare la password salvata.
# This message can be seen by attempting to reveal a password in about:logins
# On MacOS, only provide the reason that account verification is needed. Do not put a complete sentence here.
about-logins-reveal-password-os-auth-dialog-message-macosx = mostrare la password salvata

# This message can be seen by attempting to copy a password in about:logins
about-logins-copy-password-os-auth-dialog-message = Verificare la proprià identità per copiare la password salvata.
# This message can be seen by attempting to copy a password in about:logins
# On MacOS, only provide the reason that account verification is needed. Do not put a complete sentence here.
