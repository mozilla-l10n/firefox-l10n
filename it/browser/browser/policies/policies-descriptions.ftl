...
policy-ClearOnShutdown = Cancella i dati di navigazione alla chiusura di { -brand-short-name }.
...
policy-CNSA2KeyAgreementEnabled = Attiva l’accordo di chiavi CNSA 2.0 ML-KEM-1024 per TLS.
