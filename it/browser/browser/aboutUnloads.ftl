...
about-unloads-last-updated = Ultimo aggiornamento: { DATETIME($date, day: "numeric", hour: "numeric", year: "numeric", month: "numeric", hour12: "false", minute: "numeric", second: "numeric") }
