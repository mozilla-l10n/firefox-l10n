...
## Privacy widget tracker count
## The primary content shown above the rotating "tip" message. The tracker number itself
## is rendered separately (static); these strings supply the labels with plurals.

# Appears below a large number indicating the number of trackers blocked today
# Variables:
...
# Second line of the primary content, shown under the large tracker-count
# number and "Trackers blocked today". It counts the sites those trackers were
# blocked on. The English is shortened from "Blocked across { $count } sites" —
# translate it that fuller way if the short fragment doesn't work in your language.
# Variables:
#   $count (number) - Number of sites visited
...
# Shown in the Privacy widget when no trackers have been blocked yet.
newtab-privacy-empty = { -brand-short-name } blocca gli elementi traccianti mentre navighi. Li vedrai qui.

## Privacy widget messages: Stay informed
## Rotating messages shown in the Privacy widget (feature highlight: "Stay informed").
## Variables used by some messages: $count (number) - a tracker count;
## $website (string) - a website / domain name.
## Some messages include a link span rendered as <a data-l10n-name="link">…</a>.

newtab-privacy-message-informed-1 = Gli elementi traccianti monitorano le tue attività su diversi siti. { -brand-short-name } ne blocca automaticamente la maggior parte.
newtab-privacy-message-informed-2 = <a data-l10n-name="link">Bloccare gli elementi traccianti</a> impedisce alle aziende di monitorare la tua attività online.
newtab-privacy-message-informed-3 = <a data-l10n-name="link">Molti siti utilizzano elementi traccianti</a>, così aziende che non hai mai visitato possono monitorare la tua attività online.
newtab-privacy-message-informed-4 = Scegliere { -brand-short-name } significa <a data-l10n-name="link">scegliere una maggiore protezione per impostazione predefinita</a>.
newtab-privacy-message-informed-5 = Bloccando i traccianti, riduci il numero di aziende che possono seguirti da un sito all’altro.
newtab-privacy-message-informed-6 = Noi non vendiamo mai i tuoi dati. Altri browser, invece, potrebbero farlo.
newtab-privacy-message-informed-7 = Scopri di più sulla privacy di { -brand-short-name }.
newtab-privacy-message-informed-8 = Scopri in breve come { -brand-short-name } contribuisce a proteggere la tua privacy.
# Variables:
#   $count (number) - Number of trackers blocked
newtab-privacy-message-informed-9 =
    { $count ->
        [one] { -brand-short-name } ha bloccato { $count } elemento tracciante che aumentava il consumo energetico del dispositivo.
       *[other] { -brand-short-name } ha bloccato { $count } elementi traccianti che aumentavano il consumo energetico del dispositivo.
    }
# "top trackers" means the trackers that were blocked most often (by count) for
# this user over the past week; they originated from the given website.
# Variables:
#   $website (string) - A website / domain name
newtab-privacy-message-informed-10 = I <a data-l10n-name="link">principali elementi traccianti che abbiamo bloccato</a> per te questa settimana provenivano da { $website }.
newtab-privacy-message-informed-11 = Hai un piano dati limitato? Il blocco degli elementi traccianti di { -brand-short-name } può aiutarti a risparmiare dati e a evitare costi extra.
newtab-privacy-message-informed-12 = Quando <a data-l10n-name="link">{ -brand-short-name } blocca gli elementi traccianti</a>, hai più banda disponibile per ascoltare musica e guardare video senza interruzioni.

## Privacy widget messages: Boost your protection
## Rotating messages shown in the Privacy widget (feature highlight: "Boost your protection").

newtab-privacy-message-boost-1 = Salva le tue password in { -brand-short-name }, così sarà più facile utilizzare credenziali complesse e univoche ovunque.
newtab-privacy-message-boost-2 = <a data-l10n-name="link">Ricevi avvisi in { -monitor-brand-short-name }</a> per scoprire se il tuo indirizzo email è coinvolto in una violazione di dati.
newtab-privacy-message-boost-3 = Tutela le tue informazioni personali con il <a data-l10n-name="link">monitoraggio gratuito delle violazioni di dati</a> per un massimo di 20 indirizzi email.
newtab-privacy-message-boost-4 = <a data-l10n-name="link">Accedi a { -brand-short-name }</a> per proteggere con la crittografia segnalibri, password e schede su tutti i tuoi dispositivi.
newtab-privacy-message-boost-5 = Stai facendo acquisti su una rete Wi-Fi pubblica? <a data-l10n-name="link">Usare una VPN</a> può offrire una protezione aggiuntiva.
newtab-privacy-message-boost-6 = Sei connesso al Wi-Fi dell’aeroporto? Proteggi la tua navigazione <a data-l10n-name="link">attivando la VPN integrata</a>.
newtab-privacy-message-boost-7 = <a data-l10n-name="link">Attiva la VPN integrata</a> per una protezione aggiuntiva e per rendere la tua posizione più privata.
newtab-privacy-message-boost-8 = Usa una finestra anonima per navigare in modo più sicuro su un computer condiviso.
newtab-privacy-message-boost-9 = Condividi il tuo indirizzo email reale solo con le persone di cui ti fidi; <a data-l10n-name="link">usa un alias di posta elettronica</a> per iscriverti ai servizi.
newtab-privacy-message-boost-10 = <a data-l10n-name="link">Crea un alias di posta elettronica</a> per tenere il tuo indirizzo reale al sicuro dallo spam.
newtab-privacy-message-boost-11 = Ricevi <a data-l10n-name="link">50 alias di posta elettronica gratuiti in { -brand-short-name }</a>. Usane uno diverso per ogni account e proteggi il tuo indirizzo email reale.

## Privacy widget messages: Feel protected
## Rotating messages shown in the Privacy widget (feature highlight: "Feel protected").

newtab-privacy-message-feel-1 = Continua a navigare, { -brand-short-name } continuerà a bloccare.
newtab-privacy-message-feel-2 = { -brand-short-name } è sostenuto da { -vendor-short-name }, un’organizzazione senza fini di lucro dedicata a costruire un Web migliore.
newtab-privacy-message-feel-3 = { -vendor-short-name } ha realizzato { -brand-short-name } per mettere le persone e la privacy al primo posto sul Web.

## Privacy widget messages: Celebrate small wins
## Rotating messages shown in the Privacy widget (feature highlight: "Celebrate small wins").

# Variables:
#   $count (number) - Number of trackers blocked this week
newtab-privacy-message-celebrate-1 =
    { $count ->
        [one] Questa settimana <a data-l10n-name="link">hai bloccato { $count } elemento tracciante</a>. Continua così per proteggere la tua privacy online.
       *[other] Questa settimana <a data-l10n-name="link">hai bloccato { $count } elementi traccianti</a>. Continua così per proteggere la tua privacy online.
    }
# Variables:
#   $count (number) - Number of trackers blocked this month
newtab-privacy-message-celebrate-2 =
    { $count ->
        [one] <a data-l10n-name="link">{ $count } elemento tracciante bloccato</a> questo mese. Un importante passo avanti per impedire alle aziende di tracciarti online.
       *[other] <a data-l10n-name="link">{ $count } elementi traccianti bloccati</a> questo mese. Un importante passo avanti per impedire alle aziende di tracciarti online.
    }
# Variables:
#   $count (number) - Number of trackers blocked this year
newtab-privacy-message-celebrate-3 =
    { $count ->
        [one] Quest’anno hai <a data-l10n-name="link">bloccato { $count } elemento tracciante</a>. Un anno davvero efficace per la tua privacy.
       *[other] Quest’anno hai <a data-l10n-name="link">bloccato { $count } elementi traccianti</a>. Un anno davvero efficace per la tua privacy.
    }
# "in your den" refers to keeping things private — it's a play on words
# referring to a fox's home, called a "den" in English
newtab-privacy-message-celebrate-4 = Con { -brand-short-name }, una parte maggiore di ciò che fai online resta solo tua.
newtab-privacy-message-celebrate-5 = Sei sulla buona strada: meno elementi traccianti vuol dire più privacy.
newtab-privacy-message-celebrate-6 = Hai bloccato <a data-l10n-name="link">1.000 elementi traccianti</a>. La tua privacy è sempre più nelle tue mani.
# Variables:
#   $count (number) - Number of consecutive days protected. Only fires at 3, 5,
#                     or 7 days.
newtab-privacy-message-celebrate-days =
    { $count ->
       *[other] <a data-l10n-name="link">Sei protetto</a> da { $count } giorni consecutivi.
    }
