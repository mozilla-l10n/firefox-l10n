...
mr2022-onboarding-privacy-segmentation-image-alt =
    .aria-label = Due mani con pelle di colore chiaro e scuro si danno il cinque
...
onboarding-easy-setup-security-and-privacy-subtitle = Il nostro browser, supportato da un’organizzazione senza fini di lucro, aiuta a bloccare le aziende che, di nascosto, cercano di seguire le tue attività sul Web.
...
smartwindow-onboarding-title = Rendi { -smart-window-brand-name(form: "uppercase-singular") } il tuo punto di partenza
