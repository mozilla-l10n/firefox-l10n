...
fxa-menu-sync-your-data = Sincronizza i tuoi dati
...
fxa-menu-sync-status-turn-on-button =
    .label = Attiva
fxa-menu-sync-status-turn-on-button-aria-label = Attiva
...
appmenu-fxa-sign-in-promo-heading2 = Sincronizza i tuoi dati ovunque
appmenu-fxa-sign-in-promo-link = Accedi
appmenu-fxa-sign-in-promo-dismiss-button =
    .aria-label = Chiudi il messaggio di accesso
    .title = Chiudi
# Sign-in promo shown in the app menu when signed out and no menu message or
# update banner is present, prompting the user to sign in and sync.
appmenu-fxa-sign-in-promo-heading = Accedi per sincronizzare
appmenu-fxa-sign-in-promo-message = Accedi ai tuoi dati ovunque ti trovi
...
appmenuitem-vpn-description5 = Protezione aggiuntiva su tutti i tuoi dispositivi
# Shown in place of appmenuitem-vpn-title2 when the user has signed up for VPN.
appmenuitem-vpn-title-signed-in1 = Scarica { -mozilla-vpn-brand-name }
...
appmenuitem-share-firefox-title2 = Condividi { -brand-product-name }
appmenuitem-share-firefox-description = Invita qualcuno a scegliere il browser che mette la privacy al primo posto
appmenu-profiles-2 =
    .label = Profili
