...
tab-group-editor-color-selector-blue = Blu
tab-group-editor-color-selector-purple = Viola
tab-group-editor-color-selector-cyan = Ciano
tab-group-editor-color-selector-orange = Arancio
tab-group-editor-color-selector-yellow = Giallo
tab-group-editor-color-selector-pink = Rosa
tab-group-editor-color-selector-green = Verde
tab-group-editor-color-selector-gray = Grigio
tab-group-editor-color-selector-red = Rosso
