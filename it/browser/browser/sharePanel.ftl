...
share-panel-heading = Condividi pagina
...
confirmation-hint-link-copied = Link copiato
...
share-panel-os-share-2 =
    .label =
        { PLATFORM() ->
            [windows] Condividi tramite Windows…
            [macos] Condividi tramite Mac…
           *[other] Condividi tramite…
        }
