...
default-browser-notification-privacy-header-text = Rimani con { -brand-short-name }?
default-browser-notification-privacy-body-text = Il tuo browser predefinito è cambiato. Torna a { -brand-short-name } per privacy e protezione integrate.
