...
expand-on-hover-message =
    .heading = Espansione al passaggio del mouse disponibile a breve
    .message = In un prossimo aggiornamento potrai espandere la barra laterale passandoci il mouse sopra.
