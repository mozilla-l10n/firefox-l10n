...
extension-default-theme-description2 = Un grigio-viola equilibrato e familiare con l’aspetto classico di { -brand-product-name }.
...
extension-nova-dusk-name = Crepuscolo
...
extension-nova-ash-name = Cenere
