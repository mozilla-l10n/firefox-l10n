...
aiwindow-firstrun-title = Benvenuto in { -smart-window-brand-name(capitalization: "uppercase") }
...
aiwindow-firstrun-memories-subtitle = La funzione { -smart-window-brand-name(capitalization: "uppercase") } può apprendere dalle tue chat, dalla navigazione o da entrambe per creare memorie. Queste memorie rendono le risposte sempre più utili col passare del tempo.
...
aiwindow-firstrun-memories-choose-label = Scegli da cosa può imparare la funzione { -smart-window-brand-name(capitalization: "uppercase") }
...
smart-window-default-promo-message = { -brand-short-name } aprire automaticamente { -smart-window-brand-name }.
...
aiwindow-feedback-disclaimer = Inviando, condividi il tuo feedback e questa chat per aiutare { -brand-shorter-name } a migliorare la funzione { -smart-window-brand-name(capitalization: "uppercase") }. Le altre tue chat restano private. <a data-l10n-name="learn-more">Scopri di più</a>
