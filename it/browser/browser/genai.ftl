...
genai-settings-chat-description = Aggiungi il tuo chatbot preferito alla barra laterale per un rapido accesso mentre navighi. <a data-l10n-name="connect">Condividi feedback</a>
