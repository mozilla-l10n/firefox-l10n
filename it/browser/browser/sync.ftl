...
fxa-menu-send-to-mobile =
    .label =
        { $tabCount ->
            [1] Invia a dispositivo mobile
           *[other] Invia { $tabCount } schede a dispositivo mobile
        }
...
fxa-menu-signed-out-title = Accedi per sincronizzare
fxa-menu-signed-out-description = Sei disconnesso
